  ...
  return (
    <div style={{ background: '#1a1a2e', borderBottom: '2px solid #E85D26', overflow: 'hidden', padding: '10px 0', whiteSpace: 'nowrap' }}>
      <div style={{
        ...
        <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: '18px', marginRight: '60px' }}>★★★★★★★★★★</span>

        <span style={{ color: '#FBBF24', fontWeight: 'bold', fontSize: '14px', marginRight: '60px' }}>☕ This site is free &amp; run by one person</span>
        <span style={{ color: 'white', fontSize: '14px', marginRight: '60px' }}>If it helped you, buy me a coffee for 40฿ — scroll down to support the site 🙏</span>
