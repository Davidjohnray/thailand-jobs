...
const TOPIC = 'Using Your Phone in Public'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    id: 1,
    question: 'How do you think smartphones have changed the way people interact with each other in public?',
    tip: 'Compare behaviour before and after smartphones. Consider both positive and negative changes. Think about eye contact, conversation, social awareness.',
    example: 'I think one of the most noticeable changes is... On the positive side... however, some people would argue that...',
    targetBand: 'Band 7+ tip: Use language of change and contrast — "has significantly altered", "whereas previously", "to a considerable extent"',
  },
  {
    id: 2,
    question: 'Do you think there should be rules about phone use in certain public places? Why or why not?',
    tip: 'Discuss specific places where rules might be needed — cinemas, hospitals, restaurants, public transport. Weigh freedom vs consideration for others.',
    example: 'I think rules would be appropriate in some places such as... though I believe people should have the freedom to... because...',
    targetBand: 'Band 7+ tip: Use conditional language — "provided that", "as long as", "it would be reasonable to suggest that"',
  },
  {
    id: 3,
    question: 'Some people say we are becoming too dependent on our phones. Do you agree?',
    tip: 'Give a clear position and support it. Think about what would happen without phones, the impact on memory, social skills, and mental health.',
    example: 'To some extent I agree because... However, I think dependency is not always negative — for example... The key issue is...',
    targetBand: 'Band 7+ tip: Show nuance — avoid just agreeing or disagreeing. Use "to a certain extent", "it depends on how we define", "while there is merit in this view"',
  },
  {
    id: 4,
    question: 'How do you think phone use in public will change over the next 20 years?',
    tip: 'Speculate about the future. Think about wearable technology, augmented reality, social norms changing. Use future language and hedging.',
    example: 'I think it is quite likely that... We may well see a situation where... though it is hard to predict whether...',
    targetBand: 'Band 7+ tip: Use speculation language — "is likely to", "it seems probable that", "one can envisage a scenario where"',
  },
]
...
export default function PhonePart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/phone-habits/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/phone-habits/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Engagement tip:</strong> Phone habits is a topic all students relate to — encourage personal examples before moving to abstract discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate — half the class argues phones should be banned in restaurants, the other half disagrees.</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q4 (future of phone use) is excellent for a Writing Task 2 essay — assign as homework.</p>
            </div>
          </div>
        )}
        ...
        {feedback && (
          <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '16px' }}>
            ...
            <div style={{ background: '#f0fdf4', borderRadius: '10px', padding: '16px 18px', border: '1px solid #bbf7d0', marginBottom: '16px' }}>
              ...
              {modelBandView === '7' && (
                <div>
                  <p style={{ fontSize: '11px', color: '#166534', margin: '0 0 8px', fontWeight: '600' }}>Clear opinion, well developed, considers other views, uses academic vocabulary naturally.</p>
