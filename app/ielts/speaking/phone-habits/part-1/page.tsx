...
const QUESTIONS = [
  {
    id: 1,
    question: 'How often do you use your phone when you are out in public?',
    tip: 'Give a clear answer about frequency, then explain what you mainly use it for. Use phrases like "quite often", "constantly", "only when necessary".',
    example: 'I use my phone quite a lot when I am out because... / I try not to use it too much in public, mainly just for...',
  },
  {
    id: 2,
    question: 'What do you usually use your phone for when you are away from home?',
    tip: 'Name 2–3 specific uses and explain each briefly. Think about maps, messaging, social media, payments, music.',
    example: 'Probably the thing I use it most for is... I also use it to... and occasionally...',
  },
  {
    id: 3,
    question: 'Do you think people use their phones too much in public places? Why?',
    tip: 'Give your opinion clearly then back it up. Think about restaurants, public transport, social situations.',
    example: 'Yes, I do think so because... / I think it depends on the situation — for example...',
  },
  {
    id: 4,
    question: 'Have you ever been in a situation where someone\'s phone use was rude or annoying? What happened?',
    tip: 'Use past tense to describe a specific experience. Include where it happened, what the person did, and how you felt.',
    example: 'Yes, I remember once when I was... and the person next to me... It was quite frustrating because...',
  },
]
...
export default function PhonePart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students to share their phone screen time before starting — creates personal engagement.</p>
              ...
              <p style={{ margin: 0 }}><strong>Board work:</strong> Write vocabulary upgrades on the board and drill in new sentences.</p>
            </div>
          </div>
        )}
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/phone-habits/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
