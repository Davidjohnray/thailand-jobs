...
const CUE_CARD = {
  title: 'Describe a time when you used your phone in a way that was very helpful.',
  bullets: [
    'what you were doing or where you were',
    'why you needed to use your phone',
    'what you used it for',
    'and explain why it was so useful in that situation',
  ],
}
...
export default function PhonePart2Page() {
  ...
  function startRecording() {
    ...
    r.onresult = (e: SpeechRecognitionEvent) => {
      let t = ''; for (let i = 0; i < e.results.length; i++) t += e.results[i][0].transcript; setAnswer(t)
    }
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/phone-habits/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
          {hasAccess && (
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Before starting:</strong> Ask students to think of a real example from their own life — personal examples score better in Part 2.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Classroom discussion:</strong> Compare Band 6 vs Band 7–8 model answers. Ask students to identify specific vocabulary and grammar differences.</p>
        ...
        {feedback && (
          <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '16px' }}>
            ...
            <div style={{ background: '#f0fdf4', borderRadius: '10px', padding: '16px 18px', border: '1px solid #bbf7d0', marginBottom: '16px' }}>
              ...
              {modelBandView === '7' && (
                <div>
                  <p style={{ fontSize: '11px', color: '#166534', margin: '0 0 8px', fontWeight: '600' }}>Wider vocabulary, varied grammar, well-developed with feelings and specific details.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          <Link href="/ielts/speaking/phone-habits/part-1" style={{ padding: '12px 20px', borderRadius: '8px', border: '1px solid #e2e8f0', background: 'white', color: '#1a1a2e', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>← Part 1</Link>
          <Link href="/ielts/speaking/phone-habits/part-3" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 3 →</Link>
        </div>
