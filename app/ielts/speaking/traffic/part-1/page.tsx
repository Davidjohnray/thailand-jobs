...
const QUESTIONS = [
  {
    ...
    tip: 'Name your main method of transport and give a reason why you choose it — convenience, cost, distance, or habit.',
    example: 'I usually travel by... because it\'s... / Most days I... although sometimes I...',
  },
  {
    id: 2,
    question: 'Is traffic a problem in the area where you live?',
    tip: 'Give a clear answer (yes/no/sometimes) then add detail — when it\'s worst, why it happens, how it affects you.',
    example: 'Yes, traffic can be quite bad, especially... This is mainly because... It usually means that I...',
  },
  {
    id: 3,
    question: 'What kind of public transport is available where you live?',
    tip: 'List the options available — buses, trains, motorbike taxis, ferries — and briefly say how reliable or convenient they are.',
    example: 'Where I live there is... It\'s generally... although sometimes...',
  },
  {
    id: 4,
    question: 'Have you ever experienced a really bad traffic jam?',
    tip: 'Use past tense to describe a specific occasion. Include where you were going, how long it took, and how you felt.',
    example: 'Yes, I remember once when... It took about... I felt...',
  },
]
...
export default function TrafficPart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/traffic/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students how they got to class today and how long it took — an easy, relevant way to start the topic.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Transport vocabulary (commute, rush hour, congestion, public transport, gridlock) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/traffic/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
