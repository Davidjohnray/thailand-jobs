...
const TOPIC = 'Traffic & Getting Around'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    id: 1,
    question: 'How does traffic congestion affect people\'s quality of life in cities?',
    tip: 'Discuss specific effects — stress, lost time, pollution, health, work-life balance. Give examples from cities you know.',
    example: 'I think traffic congestion has a major impact on... For example, people who commute by car often... whereas...',
    targetBand: 'Band 7+ tip: Use cause-and-effect language — "this leads to", "as a result", "this can have a knock-on effect on"',
  },
  {
    id: 2,
    question: 'Do you think public transport systems will improve in the future? Why or why not?',
    tip: 'Discuss trends in technology and city planning. Use future and speculative language. Consider examples of cities that have improved transport.',
    example: 'I think it is quite likely that... Many cities have already started to... This could mean that...',
    targetBand: 'Band 7+ tip: Use speculation — "is likely to", "could potentially", "there is a real possibility that"',
  },
  {
    id: 3,
    question: 'What can governments do to reduce traffic problems in big cities?',
    tip: 'Discuss both infrastructure solutions (public transport, cycle lanes) and policy solutions (congestion charges, restrictions). Be specific rather than vague.',
    example: 'One option governments have is to... Another approach could be... However, this might lead to...',
    targetBand: 'Band 7+ tip: Use modal verbs for recommendations — "could", "should", "might consider"',
  },
  {
    id: 4,
    question: 'Some people say that working from home could reduce traffic problems. Do you agree?',
    tip: 'Give a clear position and support it. Think about the effects of remote work on commuting patterns, but also its limitations.',
    example: 'To a large extent I agree, because... If more people worked from home... However, not everyone is able to...',
...
export default function TrafficPart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/traffic/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/traffic/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (public transport future):</strong> A topical issue — connect to any recent local transport news (new BTS/MRT lines, road projects) for richer discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues working from home significantly reduces traffic, the other half argues it has limited impact or creates new problems (isolation, unequal access to remote jobs).</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (government solutions) is excellent for a Writing Task 2 problem-solution essay — assign as homework.</p>
            </div>
          </div>
        )}
