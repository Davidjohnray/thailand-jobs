...
const QUESTIONS = [
  {
    id: 1,
    question: 'Do you usually pay with cash, or do you prefer cards and mobile payments?',
    tip: 'Give a clear preference and a reason — convenience, habit, security, or what is widely accepted where you live.',
    example: 'I usually pay by... because it\'s... / I still use cash for... but for everything else I tend to...',
  },
  {
    id: 2,
    question: 'How has the way people pay for things changed in recent years?',
    tip: 'Mention specific changes — QR codes, mobile wallets, contactless cards. Compare to how things used to be.',
    example: 'In the past, most people used to... but nowadays... For example, I\'ve noticed that even small shops now...',
  },
  {
    id: 3,
    question: 'Do you think mobile payment apps are convenient? Why or why not?',
    tip: 'Give a clear opinion and support it with reasons — speed, ease, security concerns, reliance on phone battery/signal.',
    example: 'Yes, I find them really convenient because... Although sometimes... can be an issue.',
  },
  {
    id: 4,
    question: 'Have you ever had a problem when trying to pay digitally?',
    tip: 'Use past tense to describe a specific situation — a failed payment, no signal, app not working. Explain what happened and how you solved it.',
    example: 'Yes, I remember once when... The app wouldn\'t... so in the end I had to...',
  },
]
...
export default function CashlessPaymentsPart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/cashless-payments/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students to check their wallets — how much cash do they have right now? An easy, personal entry point.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Payment vocabulary (contactless, mobile wallet, QR code, transaction, top up) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/cashless-payments/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
