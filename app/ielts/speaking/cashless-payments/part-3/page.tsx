...
const QUESTIONS = [
  {
    id: 1,
    question: 'What are the advantages and disadvantages of a cashless society?',
    tip: 'Discuss both sides — advantages (speed, convenience, record-keeping) and disadvantages (privacy, technical failures, exclusion). Give examples to support your points.',
    example: 'There are several advantages, such as... However, there can also be downsides, for example...',
    targetBand: 'Band 7+ tip: Use balancing language — "on the positive side", "that said", "a potential drawback is"',
  },
  {
    id: 2,
    question: 'Do you think cash will disappear completely in the future?',
    tip: 'Discuss trends towards digital payments, but also reasons cash might continue to be used. Use speculative language.',
    example: 'I think it\'s quite likely that... However, it seems unlikely that... completely, because...',
    targetBand: 'Band 7+ tip: Use speculation — "is likely to", "could potentially", "there is a real possibility that"',
  },
  {
    id: 3,
    question: 'How might cashless payments affect older people or those without access to technology?',
    tip: 'Discuss specific challenges — unfamiliarity with apps, lack of smartphones, exclusion from services. Consider possible solutions too.',
    example: 'I think this could be a real problem for... For example, some older people may find it difficult to... One solution could be...',
    targetBand: 'Band 7+ tip: Use modal verbs and hedging — "could be problematic", "might struggle with", "may need additional support"',
  },
  {
    id: 4,
    question: 'Some people say that going cashless makes people spend more money. Do you agree?',
    tip: 'Give a clear position and support it. Think about psychological factors — feeling money leave your hand vs tapping a card — and any counterarguments.',
    example: 'I tend to agree with this view, because... When people pay digitally, they often... However, it could also be argued that...',
...
export default function CashlessPaymentsPart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/cashless-payments/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/cashless-payments/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (cash disappearing):</strong> A topical issue — ask students which places near them still require cash (street food stalls, markets) for richer, more authentic discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues cashless payments make people overspend, the other half argues budgeting apps actually help people track spending better.</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (older people and technology access) is excellent for a Writing Task 2 problem-solution essay — assign as homework.</p>
            </div>
          </div>
        )}
