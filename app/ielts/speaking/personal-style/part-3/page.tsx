...
const TOPIC = 'Personal Style & Fashion'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    id: 1,
    question: 'Why do you think fashion trends change so quickly?',
    tip: 'Discuss factors such as media, celebrities, social media, and the fashion industry\'s business model. Give examples to support your points.',
    example: 'I think there are several reasons for this. Firstly... Social media also plays a role, because...',
    targetBand: 'Band 7+ tip: Use listing and linking language — "firstly", "in addition", "another factor is"',
  },
  {
    id: 2,
    question: 'Do you think social media has influenced how people dress?',
    tip: 'Discuss the role of influencers, online shopping, and exposure to global trends. Consider both positive and negative effects.',
    example: 'I definitely think so. For example, platforms like... have made it easier for people to... However, this can also lead to...',
    targetBand: 'Band 7+ tip: Use comparison and contrast — "compared to the past", "whereas before", "this is not the case for everyone"',
  },
  {
    id: 3,
    question: 'What impact does the fashion industry have on the environment?',
    tip: 'Discuss issues such as fast fashion, waste, and resource use. You can also mention efforts to make fashion more sustainable.',
    example: 'The fashion industry has a significant impact on... For instance... However, some companies have started to...',
    targetBand: 'Band 7+ tip: Use cause-and-effect language — "this leads to", "as a result", "this can have a knock-on effect on"',
  },
  {
    id: 4,
    question: 'Some people say that school uniforms should be compulsory. Do you agree?',
    tip: 'Give a clear position and support it. Think about the benefits (equality, discipline, identity) and possible drawbacks (self-expression, cost).',
    example: 'I tend to agree with this view, because... Uniforms can help to... However, it could also be argued that...',
...
export default function PersonalStylePart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/personal-style/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/personal-style/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (social media influence):</strong> A topical issue — ask students whether they follow fashion influencers or accounts online for richer, more authentic discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues school uniforms should be compulsory, the other half argues students should be free to choose what they wear.</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (fashion industry and the environment) is excellent for a Writing Task 2 problem-solution essay — assign as homework.</p>
            </div>
          </div>
        )}
