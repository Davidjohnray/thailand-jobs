...
const QUESTIONS = [
  {
    ...
    tip: 'Describe your general approach to clothing — casual, formal, practical, colourful. Give a brief example.',
    example: 'I would say my style is fairly... For example, I usually wear...',
  },
  {
    id: 2,
    question: 'Do you enjoy shopping for clothes?',
    tip: 'Give a clear yes/no answer and a reason — enjoyment, convenience, cost. You can mention online vs in-store shopping.',
    example: 'Yes, I really enjoy it because... / Not particularly, mainly because... although I do like...',
  },
  {
    id: 3,
    question: 'Has your style changed since you were younger?',
    tip: 'Compare your style now with the past. Use past and present tenses together.',
    example: 'Yes, definitely. When I was younger, I used to... but now I prefer...',
  },
  {
    id: 4,
    question: 'Do you think it is important to dress well for work or school?',
    tip: 'Give a clear opinion and support it — first impressions, confidence, professionalism, comfort.',
    example: 'Yes, I think it\'s quite important because... Although, at the same time...',
  },
]
...
export default function PersonalStylePart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/personal-style/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students to describe what they're wearing today and why they chose it — an easy, immediate entry point.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Fashion vocabulary (casual, formal, trend, outfit, to suit someone) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/personal-style/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
