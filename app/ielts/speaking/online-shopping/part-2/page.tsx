...
const CUE_CARD = {
  title: 'Describe a purchase you made online that you were either very happy or very disappointed with.',
  bullets: [
    'what you bought and where you bought it from',
    'why you decided to buy it online',
    'what happened when it arrived or after you bought it',
    'and explain why you felt happy or disappointed with the experience',
  ],
}
...
type Feedback = {
  ...
  vocabularyUpgrades: VocabUpgrade[]; roundingOffResponse: string
}
...
export default function OnlineShoppingPart2Page() {
    ...
    <main style={{ minHeight: '100vh', background: '#f8fafc', padding: '24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Before starting:</strong> Ask students to think of a real example — a good or bad online purchase. Personal stories score higher in Part 2.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Emotions matter:</strong> Part 2 scoring rewards personal reaction. Remind students to include how they felt, not just what happened.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Extension:</strong> Use the rounding-off question for a brief class discussion before Part 3.</p>
              <p style={{ margin: 0 }}><strong>Board work:</strong> Write vocabulary upgrades — consumer, transaction, platform, reliable, fraudulent — and drill in sentences.</p>
            </div>
          </div>
        )}
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          <Link href="/ielts/speaking/online-shopping/part-1" style={{ padding: '12px 20px', borderRadius: '8px', border: '1px solid #e2e8f0', background: 'white', color: '#1a1a2e', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>← Part 1</Link>
          <Link href="/ielts/speaking/online-shopping/part-3" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 3 →</Link>
        </div>
      </div>
    </main>
  )
