...
const QUESTIONS = [
  {
    id: 1,
    question: 'Do you do much online shopping? What do you usually buy?',
    tip: 'Give a clear answer about frequency then name 2–3 specific types of things you buy. Add a brief reason for each.',
    example: 'Yes, I shop online quite regularly — mainly for... I also tend to buy... online because...',
  },
  {
    id: 2,
    question: 'Do you prefer shopping online or going to a physical shop? Why?',
    tip: 'Give a clear preference then support it with 2–3 reasons. You can mention both sides briefly before giving your view.',
    example: 'I generally prefer... because... though I do sometimes go to a shop when...',
  },
  {
    id: 3,
    question: 'Have you ever had a problem with something you bought online? What happened?',
    tip: 'Use past tense to describe a specific experience. Include what you bought, what went wrong, and how you dealt with it.',
    example: 'Yes, there was one time when I ordered... and it arrived... I had to... which was quite...',
  },
  {
    id: 4,
    question: 'Do you think online shopping is safe? Why or why not?',
    tip: 'Give your opinion with reasons. Think about payment security, scams, counterfeit products, and trusted platforms.',
    example: 'I think it can be safe if you use... though there are risks such as... I always make sure to...',
  },
]
...
export default function OnlineShoppingPart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/online-shopping/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students to name the last thing they bought online and why — instantly personal and engaging.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Online shopping has rich vocabulary — delivery, refund, checkout, reviews, platform. Encourage students to use these naturally.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Extension:</strong> After Q2, ask students to compare two specific platforms (e.g. Lazada vs Shopee) — good for fluency practice.</p>
              <p style={{ margin: 0 }}><strong>Board work:</strong> Write vocabulary upgrades from feedback and drill in new sentences.</p>
            </div>
          </div>
        )}
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/online-shopping/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
      </div>
    </main>
