...
const TOPIC = 'Online Shopping Habits'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    id: 1,
    question: 'How do you think the growth of online shopping has affected traditional high street shops and markets?',
    tip: 'Discuss both positive and negative effects. Think about job losses, convenience, changing consumer behaviour, and the survival of specialist or local shops.',
    example: 'I think the impact has been significant — on one hand... however, some businesses have managed to survive by...',
    targetBand: 'Band 7+ tip: Use cause and effect language — "has led to a significant decline in", "has had a knock-on effect on", "as a direct consequence of"',
  },
  {
    id: 2,
    question: 'Do you think online shopping has made people more materialistic? Why or why not?',
    tip: 'Give a clear position and support it. Think about impulse buying, easy access to goods, advertising algorithms, and consumerism.',
    example: 'There is certainly an argument to be made that... I think the key issue is... because...',
    targetBand: 'Band 7+ tip: Show balanced thinking — "while it is tempting to conclude that...", "the reality is more nuanced", "this is partly true, however..."',
  },
  {
    id: 3,
    question: 'What responsibilities do you think online retailers have towards their customers and towards society?',
    tip: 'Think about data protection, environmental impact, fair wages for workers, honest advertising, and protecting vulnerable consumers.',
    example: 'I believe retailers have a responsibility to... Beyond their customers, they also have a broader obligation to... because...',
    targetBand: 'Band 7+ tip: Use obligation language — "have an obligation to", "bear responsibility for", "are accountable for", "ought to be held to account"',
  },
  {
    id: 4,
    question: 'How do you think shopping habits might change over the next 20 years with advances in technology?',
    tip: 'Speculate about the future — AI recommendations, drone delivery, virtual reality shopping, cashless payments, same-day delivery. Use future and hedging language.',
    example: 'I think it is likely that... One area where we might see significant change is... though it is hard to predict whether...',
    targetBand: 'Band 7+ tip: Use speculation — "it is conceivable that", "one could envisage", "advances in... are likely to result in", "it remains to be seen whether"',
  },
]
...
type Feedback = {
  bandScore: number; summary: string; whatWentWell: string; improvements: string
  modelAnswerBand6: string; modelAnswerBand7: string
  vocabularyUpgrades: VocabUpgrade[]; followUpQuestion: string; discussionPhrase: string
}
...
export default function OnlineShoppingPart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/online-shopping/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/online-shopping/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            {hasAccess && <button onClick={() => setShowTeacherMode(!showTeacherMode)} style={{ padding: '6px 14px', borderRadius: '6px', border: '1px solid #e2e8f0', background: showTeacherMode ? '#1e3a5f' : 'white', color: showTeacherMode ? 'white' : '#555', fontSize: '12px', fontWeight: '600', cursor: 'pointer' }}>👨‍🏫 Teacher Mode</button>}
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q1 is excellent:</strong> The impact on traditional shops is very relatable in Thailand — students can draw on personal experience of local markets vs online platforms.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class debate idea:</strong> Split class into online retailers vs traditional shop owners and debate Q3 on responsibilities.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Board work:</strong> Write discussion phrase from feedback. Have students use it immediately in a new sentence on a different topic.</p>
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q2 (materialism) and Q4 (future of shopping) both make excellent Writing Task 2 essay topics — assign one as homework.</p>
            </div>
          </div>
        )}
