...
const QUESTIONS = [
  {
    id: 1,
    question: 'Have you ever worked or studied with people from other countries?',
    tip: 'Give a clear yes/no answer, then add detail — where, who, and what it was like.',
    example: 'Yes, I have. For example... / Not really, although I have met people from...',
  },
  {
    id: 2,
    question: 'What do you think people should know before working with people from different cultures?',
    tip: 'Mention 2-3 things — communication styles, customs, attitudes to time or hierarchy. Be specific.',
    example: 'I think it\'s important to understand... For example, in some cultures... whereas in others...',
  },
  {
    id: 3,
    question: 'Do you think it is important to learn about other cultures? Why?',
    tip: 'Give a clear opinion and support it with a reason — work, travel, communication, respect.',
    example: 'Yes, I think it\'s really important because... It helps you to...',
  },
  {
    id: 4,
    question: 'Have you ever experienced a cultural misunderstanding?',
    tip: 'Use past tense to describe a specific situation. Explain what happened and what you learned from it.',
    example: 'Yes, I remember once when... At first I didn\'t realise that... but afterwards I understood...',
  },
]
...
export default function DifferentCulturesPart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/different-cultures/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students about a foreign colleague, classmate, or friend they have — an easy, personal entry point.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Cross-cultural vocabulary (customs, etiquette, hierarchy, diversity, misunderstanding) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/different-cultures/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
