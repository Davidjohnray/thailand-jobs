...
const TOPIC = 'Working with Different Cultures'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    id: 1,
    question: 'What are the benefits and challenges of working in multicultural teams?',
    tip: 'Discuss both sides — benefits (diverse perspectives, creativity) and challenges (communication, different expectations). Give examples to support your points.',
    example: 'There are several benefits, such as... However, there can also be challenges, for example...',
    targetBand: 'Band 7+ tip: Use balancing language — "on the positive side", "that said", "a potential drawback is"',
  },
  {
    id: 2,
    question: 'Do you think globalization is making cultures more similar? Why or why not?',
    tip: 'Discuss examples — food, media, fashion, language — but also consider counter-examples where local cultures remain distinct.',
  ...
  {
    id: 3,
    question: 'How can workplaces become more culturally diverse and inclusive?',
    tip: 'Discuss specific strategies — hiring practices, training, communication policies, flexible cultural accommodations. Be specific rather than vague.',
    example: 'One way companies can do this is by... Another approach could be... This would help to...',
    targetBand: 'Band 7+ tip: Use modal verbs for recommendations — "could", "should", "might consider"',
  },
  {
    id: 4,
    question: 'Some people say that learning about other cultures should be a compulsory part of education. Do you agree?',
    tip: 'Give a clear position and support it. Think about the benefits for students and any practical challenges of making it compulsory.',
    example: 'I tend to agree with this view, because... If students learn about other cultures from a young age... However, one challenge might be...',
...
export default function DifferentCulturesPart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/different-cultures/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/different-cultures/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (globalization):</strong> A topical issue — ask students for examples of global brands or media in Thailand for richer, more authentic discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues cultural education should be compulsory, the other half argues it should remain optional or informal.</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (workplace diversity) is excellent for a Writing Task 2 opinion essay — assign as homework.</p>
            </div>
          </div>
        )}
