...
const QUESTIONS = [
  {
    id: 1,
    question: 'Do you enjoy learning languages? Why or why not?',
    tip: 'Give a clear opinion and a reason. Mention a specific language if it helps make your answer more personal.',
    example: 'Yes, I really enjoy it because... / Not particularly, mainly because... although I do think it\'s useful for...',
  },
  {
    id: 2,
    question: 'What languages have you studied, and which was the most difficult?',
    tip: 'Name the languages, then focus on one and explain what made it difficult — grammar, pronunciation, vocabulary, writing system.',
    example: 'I have studied... I found... the most challenging because...',
  },
  {
    id: 3,
    question: 'How do you usually try to improve your English?',
    tip: 'Mention 2-3 specific methods — apps, watching films, speaking practice, reading. Be specific rather than general.',
    example: 'I try to... For example, I often... I also find it helpful to...',
  },
  {
    id: 4,
    question: 'Have you ever had an experience where speaking another language helped you?',
    tip: 'Use past tense to describe a specific situation — travel, work, meeting someone — where the language made a difference.',
    example: 'Yes, I remember once when... Because I could speak..., I was able to...',
  },
]
...
export default function LanguageLearningPart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/language-learning/part-3" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 3</Link>
          </div>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students what languages are spoken in their family or community — a natural, personal entry point.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Language-learning vocabulary (fluent, pronunciation, vocabulary, grammar, immersion, mother tongue) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/language-learning/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
