...
export default function LanguageLearningPart2Page() {
    ...
    <main style={{ minHeight: '100vh', background: '#f8fafc', padding: '24px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Before starting:</strong> Ask students to think of a language connected to travel, family heritage, or a personal interest (music, films, gaming) — these give richer, more motivated answers.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Encourage words like "fluent," "immersion," "mother tongue," "to pick up a language," and "to brush up on" — these are common in higher-band answers on this topic.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          <Link href="/ielts/speaking/language-learning/part-1" style={{ padding: '12px 20px', borderRadius: '8px', border: '1px solid #e2e8f0', background: 'white', color: '#1a1a2e', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>← Part 1</Link>
          <Link href="/ielts/speaking/language-learning/part-3" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 3 →</Link>
        </div>
      </div>
    </main>
  )
