...
const TOPIC = 'Learning a New Language'
const THINK_TIME = 30
const SPEAK_TIME = 90
...
const QUESTIONS = [
  {
    ...
    tip: 'Discuss different factors — age, exposure, motivation, learning methods, natural aptitude. Give examples to support your points.',
    example: 'I think there are several reasons for this. Firstly... Secondly... Some people also benefit from...',
    targetBand: 'Band 7+ tip: Use listing and linking language — "firstly", "in addition", "another factor is"',
  },
  {
    id: 2,
    question: 'Do you think technology has changed the way people learn languages? How?',
    tip: 'Discuss apps, AI tools, online resources, and how they compare to traditional classroom learning. Consider both advantages and limitations.',
    example: 'Technology has had a huge impact on... For instance, apps such as... allow people to... However, this doesn\'t necessarily mean...',
    targetBand: 'Band 7+ tip: Use comparison and contrast — "compared to", "unlike traditional methods", "whereas in the past"',
  },
  {
    id: 3,
    question: 'Should children start learning a foreign language at primary school? Why or why not?',
    tip: 'Give a clear position. Discuss benefits (cognitive development, easier pronunciation at a young age) and possible drawbacks (curriculum pressure, resources).',
    example: 'In my opinion... One of the main advantages of starting early is... On the other hand, some people argue that...',
    targetBand: 'Band 7+ tip: Use modal verbs and hedging — "should ideally", "it might be argued that", "this could potentially"',
  },
  {
    id: 4,
    question: 'Some people say that everyone will use translation apps in the future, so learning languages will become unnecessary. Do you agree?',
    tip: 'Give a clear position and support it. Consider what translation apps can and cannot replace — cultural understanding, relationships, fluency in real-time conversation.',
    example: 'I don\'t fully agree with this view, because... While translation apps are useful for..., they cannot replace... Having said that...',
    targetBand: 'Band 7+ tip: Show nuance — "to a certain extent", "while this is true, it is also worth noting that", "this is not without its limitations"',
  },
]
...
export default function LanguageLearningPart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/language-learning/part-1" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 1</Link>
            <Link href="/ielts/speaking/language-learning/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (technology and learning):</strong> A topical issue — ask students which apps or tools they personally use for English practice for richer, more authentic discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues translation apps will make language learning unnecessary, the other half argues human language skills will always matter.</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (children and early language learning) is excellent for a Writing Task 2 opinion essay — assign as homework.</p>
            </div>
          </div>
        )}
