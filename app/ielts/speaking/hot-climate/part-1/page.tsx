...
const QUESTIONS = [
  {
    id: 1,
    question: 'What is the weather usually like in the place where you live?',
    tip: 'Describe the general climate, then add detail about a specific season or time of year.',
    example: 'It\'s usually quite hot and humid where I live, especially during... / The weather varies a lot depending on the season — in...',
  },
  {
    id: 2,
    question: 'How do you usually cope with hot weather?',
    tip: 'Give 2-3 specific strategies — clothing, drinks, activities, staying indoors, air conditioning.',
    example: 'I try to... I also make sure to... Another thing I do is...',
  },
  {
    id: 3,
    question: 'Do you prefer hot weather or cold weather? Why?',
    tip: 'Give a clear preference and support it with reasons. You can briefly mention the downsides of the other option.',
    example: 'I definitely prefer... because... Although I do find that... can be a problem when...',
  },
  {
    id: 4,
    question: 'Have you ever experienced extremely hot weather? What happened?',
    tip: 'Use past tense to describe a specific time. Include where you were, how hot it was, and how it affected you.',
    example: 'Yes, I remember once when... It was so hot that... I had to...',
  },
]
...
export default function HotClimatePart1Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Warm-up:</strong> Ask students to describe today's weather, then compare it to their favourite season — easy entry point for everyone.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Vocabulary focus:</strong> Weather and climate vocabulary (humid, scorching, mild, monsoon) is high-frequency in IELTS — encourage natural use throughout.</p>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'space-between', marginTop: '8px' }}>
          ...
          {currentQ < QUESTIONS.length - 1 ? (
            ...
            <Link href="/ielts/speaking/hot-climate/part-2" style={{ padding: '12px 24px', borderRadius: '8px', background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', fontSize: '14px', fontWeight: 'bold', textDecoration: 'none' }}>Continue to Part 2 →</Link>
          )}
        </div>
