...
const QUESTIONS = [
  {
    id: 1,
    question: 'How do you think climate affects the way people live their daily lives?',
    tip: 'Discuss specific aspects of daily life — working hours, social activities, diet, clothing, architecture. Give examples from hot and cold climates.',
    example: 'I think climate has a huge influence on... For example, in hot countries people often... whereas in colder regions...',
    targetBand: 'Band 7+ tip: Use comparative language — "tends to be", "is more likely to", "in contrast to"',
  },
  {
    id: 2,
    question: 'Do you think extreme heat will become a bigger problem in the future? Why or why not?',
    tip: 'Discuss climate change and its likely effects. Use future and speculative language. Consider impacts on health, agriculture, and cities.',
    example: 'I think it is highly likely that... Scientists have predicted that... This could lead to...',
    targetBand: 'Band 7+ tip: Use speculation — "is likely to", "could potentially", "there is a real possibility that"',
  },
  {
    id: 3,
    question: 'What can governments and individuals do to help people cope with rising temperatures?',
    tip: 'Discuss both large-scale (government) and small-scale (individual) solutions. Be specific rather than vague.',
    example: 'On a government level, measures such as... could be introduced. At an individual level, people can...',
    targetBand: 'Band 7+ tip: Use modal verbs for recommendations — "could", "should", "might consider"',
  },
  {
    id: 4,
    question: 'Some people say that air conditioning has changed society. Do you agree?',
    tip: 'Give a clear position and support it. Think about how air conditioning has affected work patterns, urban design, energy use, and daily routines.',
    example: 'To a large extent I agree, because... Air conditioning has made it possible for... However, it has also led to...',
...
export default function HotClimatePart3Page() {
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <Link href="/ielts/speaking/hot-climate/part-2" style={{ color: '#94a3b8', fontSize: '13px', textDecoration: 'none' }}>Part 2</Link>
        ...
        {showTeacherMode && (
          <div style={{ background: '#1e3a5f', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', color: 'white' }}>
            ...
            <div style={{ fontSize: '13px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)' }}>
              ...
              <p style={{ margin: '0 0 6px' }}><strong>Q2 (climate change):</strong> A topical issue — connect to recent extreme weather events students may have experienced or seen in the news for richer discussion.</p>
              <p style={{ margin: '0 0 6px' }}><strong>Class activity:</strong> After AI feedback, do a class debate on Q4 — half the class argues air conditioning has been mostly positive for society, the other half argues it has caused problems (energy use, social isolation, urban heat islands).</p>
              ...
              <p style={{ margin: 0 }}><strong>Extension:</strong> Q3 (government and individual solutions) is excellent for a Writing Task 2 problem-solution essay — assign as homework.</p>
            </div>
          </div>
        )}
