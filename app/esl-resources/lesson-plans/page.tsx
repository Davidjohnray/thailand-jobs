...
export default function LessonPlansPage() {
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f8f9fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <div style={{ background: 'linear-gradient(135deg, #7C3AED 0%, #E85D26 100%)', padding: '60px 24px', textAlign: 'center', color: 'white' }}>
        <div style={{ fontSize: '48px', marginBottom: '12px' }}>📋</div>
        <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 12px' }}>Lesson Plans</h1>
        <p style={{ fontSize: '16px', opacity: 0.9, maxWidth: '520px', margin: '0 auto' }}>Ready-to-teach plans for Pre-K through Secondary — print and teach, no prep needed</p>
      </div>
