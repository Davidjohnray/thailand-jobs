...
const VOCAB = [
  { word: 'Breakfast', meaning: 'The first meal of the day — in the morning', emoji: '🍳' },
  { word: 'Lunch', meaning: 'The meal you eat at midday', emoji: '🍱' },
  { word: 'Dinner', meaning: 'The meal you eat in the evening', emoji: '🍽️' },
  { word: 'Hungry', meaning: 'You want to eat — your stomach is empty', emoji: '😋' },
  { word: 'Delicious', meaning: 'Very, very tasty — it tastes wonderful', emoji: '😍' },
  { word: 'Cook', meaning: 'To make food using heat — to prepare a meal', emoji: '👨‍🍳' },
]

const QUESTIONS = [
  { q: 'What does Tom eat for breakfast?', options: ['Rice and soup', 'Eggs and toast', 'Noodles'], answer: 1, emoji: '🍳' },
  { q: 'What does Tom drink every morning?', options: ['Juice', 'Water', 'Milk'], answer: 2, emoji: '🥛' },
  { q: 'When does Tom eat lunch?', options: ['At 11 o\'clock', 'At 12 o\'clock', 'At 2 o\'clock'], answer: 1, emoji: '🕛' },
  { q: 'Who cooks dinner?', options: ['Tom', 'Tom\'s father', 'Tom\'s mother'], answer: 2, emoji: '👩‍🍳' },
  { q: 'What is Tom\'s favourite food?', options: ['Pizza', 'Noodles', 'Rice'], answer: 1, emoji: '🍜' },
]

const PASSAGE = `My name is Tom.
I eat three meals every day.
In the morning, I eat breakfast.
I eat eggs and toast.
I also drink a glass of milk.
...
I eat noodles two times a week.
They are delicious!
I love food.`

const LISTENING_SCRIPT = `Tom eats three meals every day. He eats eggs and toast for breakfast. He drinks milk every morning. He eats lunch at 12 o'clock. His mother cooks dinner. His favourite food is noodles.`
...
export default function MyFoodPage() {
  ...
  const [writing, setWriting] = useState({ breakfast: '', favourite: '', meals: '' })
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(255,255,255,0.25)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Food</span>
                <span style={{ background: 'rgba(255,255,255,0.15)', color: 'white', fontSize: '12px', fontWeight: '600', padding: '4px 12px', borderRadius: '20px' }}>Lesson 4</span>
              </div>
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px' }}>My Food</h1>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Learn to talk about meals, food and what you like to eat every day.</p>
            </div>
          </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        {section === 'warmup' && (
          <div style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ padding: '24px 28px' }}>
              <p style={{ color: '#555', fontSize: '15px', marginBottom: '20px', lineHeight: '1.6' }}>Ask your student these questions. Short answers are fine.</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  { q: 'Are you hungry now?', hint: 'e.g. Yes, I am! / No, I\'m not.' },
                  { q: 'What do you eat for breakfast?', hint: 'e.g. I eat rice. / I eat eggs.' },
                  { q: 'What is your favourite food?', hint: 'e.g. My favourite food is _____ .' }
                ].map((item, i) => (
          ...
          <div style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            <div style={{ background: 'linear-gradient(135deg, #3b82f622, #3b82f608)', borderLeft: '5px solid #3b82f6', padding: '20px 24px', display: 'flex', gap: '14px', alignItems: 'center', flexWrap: 'wrap' }}>
              <div style={{ flex: 1 }}>
                ...
                <h2 style={{ color: '#1a1a2e', fontSize: '20px', fontWeight: 'bold', margin: 0 }}>📖 My Food</h2>
              </div>
          ...
          <div style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ padding: '24px 28px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '20px' }}>
                {[
                  { label: 'What does Tom eat for breakfast?', key: 'q1' as const, placeholder: 'e.g. Eggs and toast' },
                  { label: 'What is Tom\'s favourite food?', key: 'q2' as const, placeholder: 'e.g. Noodles' }
                ].map((item, i) => (
          ...
          <div style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ padding: '24px 28px' }}>
              <div style={{ background: '#f0fdf4', borderRadius: '14px', padding: '16px 20px', border: '2px solid #86efac', marginBottom: '20px' }}>
                ...
                <div style={{ color: '#14532d', fontSize: '16px', fontWeight: '700', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>I eat rice for lunch.<br />My favourite food is noodles.</div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '24px' }}>
                {[
                  { q: 'What do you eat for breakfast?', hint: 'I eat _____ for breakfast.', emoji: '🍳' },
                  { q: 'What is your favourite food?', hint: 'My favourite food is _____ .', emoji: '❤️' },
                  { q: 'Who cooks food in your home?', hint: '_____ cooks food in my home.', emoji: '👨‍🍳' }
                ].map((item, i) => (
        ...
        {section === 'writing' && (
          <div style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ padding: '24px 28px' }}>
              <p style={{ color: '#555', fontSize: '15px', marginBottom: '20px' }}>Complete the sentences about <strong>your own</strong> food.</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' }}>
                {[
                  { label: 'I eat', suffix: 'for breakfast.', key: 'breakfast' as const, placeholder: 'e.g. rice / eggs / toast', emoji: '🍳' },
                  { label: 'My favourite food is', suffix: '.', key: 'favourite' as const, placeholder: 'e.g. noodles / pizza / sushi', emoji: '❤️' },
                  { label: 'I eat', suffix: 'meals every day.', key: 'meals' as const, placeholder: 'e.g. two / three', emoji: '🍽️' }
                ].map(item => (
              ...
              <div style={{ background: '#1a1a2e', borderRadius: '16px', padding: '24px' }}>
                ...
                {['Read a short text about food and meals ✅', 'Understand basic food vocabulary ✅', 'Answer simple comprehension questions ✅', 'Talk about your own meals and favourite food ✅'].map((item, i) => (
