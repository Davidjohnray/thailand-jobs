...
const VOCAB = [
  ...
  { word: 'Mother', meaning: 'Mom', emoji: '👩' },
  { word: 'Sister', meaning: 'Girl sibling', emoji: '👧' },
  { word: 'Brother', meaning: 'Boy sibling', emoji: '👦' },
  { word: 'Together', meaning: 'With each other', emoji: '🤝' },
]

const QUESTIONS = [
  { q: 'How many people are in the family?', options: ['Three', 'Four', 'Five'], answer: 1, emoji: '👨‍👩‍👧‍👦' },
  { q: 'Where does the father work?', options: ['At home', 'In a school', 'In an office'], answer: 2, emoji: '💼' },
  { q: 'How old is the sister?', options: ['8 years old', '9 years old', '10 years old'], answer: 2, emoji: '👧' },
  { q: 'What does the family do on the weekend?', options: ['Works', 'Eats dinner and watches TV', 'Goes to school'], answer: 1, emoji: '📺' },
  { q: 'Does the writer love their family?', options: ['Yes', 'No'], answer: 0, emoji: '❤️' },
]

const PASSAGE = `I have a small family.
There are four people in my family.
My family is my father, mother, sister, and me.
...
She is 10 years old.
She is a student.
We like to play and talk together.
On the weekend, my family is together.
We eat dinner and watch TV.
