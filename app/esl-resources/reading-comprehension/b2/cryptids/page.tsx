...
const PARTS = [
  {
    number: 1, title: 'What Is a Cryptid?', emoji: '🦶', color: '#854d0e',
    text: `A cryptid is a creature whose existence has been claimed by witnesses or documented in local folklore, but which has not been confirmed by mainstream science. The term comes from the Greek word "kryptos," meaning hidden, and was coined in 1983 by the zoologist John Wall. The study of such creatures is called cryptozoology — a field that occupies an uneasy position between legitimate zoological inquiry and paranormal belief, and whose practitioners range from rigorous field researchers to enthusiastic amateurs.\n\nThe world's catalogue of cryptids is remarkably rich and geographically diverse. Every inhabited region of the planet has its own legendary animals: the Yeti of the Himalayas, the Bunyip of Australia, the Mokele-mbembe of the Congo, the Chupacabra of Latin America, the Kraken of Scandinavian seas. Some cryptids are described as surviving examples of animals thought to be extinct. Others appear to be entirely new species. And some seem to defy biological explanation altogether — creatures with characteristics that no known animal possesses.\n\nThe two most famous cryptids in the English-speaking world are Bigfoot — also called Sasquatch — a large, bipedal, ape-like creature said to inhabit the forests of the Pacific Northwest of North America, and the Loch Ness Monster, an aquatic creature of disputed size and form, reported since at least the sixth century from the waters of a deep freshwater lake in the Scottish Highlands.\n\nWhat makes cryptids culturally significant is not simply the question of whether they exist. It is what our responses to that question reveal about the relationship between human beings and the natural world — our desire to believe in the undiscovered, our willingness to interpret ambiguous evidence in ways that confirm existing beliefs, and our enduring fascination with the idea that the world is larger and stranger than science has yet confirmed.`,
    vocab: [
      { word: 'Cryptid', definition: 'A creature whose existence is claimed but not confirmed by mainstream science.' },
      { word: 'Zoologist', definition: 'A scientist who studies animals, their behaviour, classification, and biology.' },
      { word: 'Bipedal', definition: 'Walking on two legs, as humans do, rather than on four.' },
      { word: 'Ambiguous', definition: 'Open to more than one interpretation; not clear or definite in meaning.' },
    ],
    questions: [
      { n: 1, q: 'Does your culture or country have its own cryptid or legendary creature? What is it, and what do people believe about it?' },
      { n: 2, q: 'Why do you think every inhabited region of the world has its own mysterious legendary animal?' },
      { n: 3, q: 'The passage says cryptid stories reveal something about "our desire to believe in the undiscovered." Do you think this desire is a strength or a weakness of human nature?' },
    ]
  },
  {
    number: 2, title: 'Bigfoot and the Loch Ness Monster', emoji: '🦕', color: '#713f12',
    text: `Bigfoot first entered popular culture in 1958, when a California newspaper published an account of a construction worker who had found enormous humanoid footprints near his worksite in the forests of northern California. The story spread rapidly, and sightings multiplied. By the 1960s, Bigfoot had become one of the most recognisable figures in American popular mythology. The creature is typically described as standing between two and three metres tall, covered in dark hair, with a strong odour and the ability to move silently through dense forest.\n\nThe most significant piece of evidence for Bigfoot's existence remains a short piece of film shot in 1967 by two men named Roger Patterson and Bob Gimlin in the forests near Bluff Creek, California. The footage, known as the Patterson-Gimlin film, appears to show a large, upright, hairy creature walking away from the camera and looking back briefly before disappearing into the trees. The film has been scrutinised by scientists, special effects professionals, and anthropologists for more than fifty years. Some experts have concluded it shows a genuine unknown primate; others are equally convinced it shows a man in a gorilla suit. No consensus has ever been reached.\n\nThe Loch Ness Monster has a longer documented history. The earliest written account dates to 565 CE, when the Irish monk St. Columba reportedly encountered a creature in the River Ness and commanded it to retreat. The modern phenomenon began in 1933, when a local newspaper reported that a couple had seen an enormous creature thrashing in the loch. The story triggered a media frenzy that has never fully subsided. Dozens of photographs have been taken over the decades, the most famous of which — the so-called "Surgeon's Photograph" of 1934, appearing to show a long-necked creature emerging from the water — was revealed in 1994 to be a hoax, constructed from a toy submarine fitted with a sculpted head.\n\nDespite the exposure of the most famous evidence as fraudulent, sightings of Loch Ness creatures continue to be reported. A 2018 environmental DNA survey of the loch found no evidence for the presence of a large unknown vertebrate. The researchers suggested that the most likely explanation for reported sightings was large eels.`,
    vocab: [
      { word: 'Humanoid', definition: 'Having a form or appearance resembling that of a human being.' },
      { word: 'Primate', definition: 'A member of the order of mammals that includes humans, apes, and monkeys.' },
      { word: 'Vertebrate', definition: 'An animal with a backbone, such as a fish, amphibian, reptile, bird, or mammal.' },
      { word: 'Environmental DNA', definition: 'Genetic material collected from environmental samples such as water or soil, used to detect the presence of species.' },
    ],
    questions: [
      { n: 4, q: 'The Patterson-Gimlin film has never been definitively proven real or fake after 50+ years. What does this tell us about the limits of forensic analysis?' },
      { n: 5, q: 'The "Surgeon\'s Photograph" was revealed as a hoax. How do you think this revelation affected public belief in the Loch Ness Monster?' },
      { n: 6, q: 'Environmental DNA surveys can detect species by their genetic traces in water. Does this kind of evidence seem more reliable to you than eyewitness accounts? Why?' },
    ]
  },
  {
    number: 3, title: 'Why Do People Keep Searching?', emoji: '🔦', color: '#92400e',
    text: `The scientific consensus on cryptids like Bigfoot and the Loch Ness Monster is overwhelmingly sceptical. No physical evidence — a body, bones, definitive biological samples — has ever been produced for any major cryptid. The ecological argument against large unknown megafauna in well-mapped regions like the Scottish Highlands or the forests of the Pacific Northwest is compelling: a breeding population of large animals would require substantial territory, leave physical traces, and be subject to death from old age and predation, producing remains that would eventually be discovered. The absence of such remains is, for most scientists, conclusive.\n\nYet people continue to search. Amateur investigators spend their weekends in forests with cameras and plaster casting kits. Organised expeditions deploy camera traps, sonar equipment, and, more recently, environmental DNA sampling across vast stretches of remote terrain. Crowdfunding campaigns raise significant sums for cryptid research. Why?\n\nPart of the answer is that genuine zoological discoveries continue to occur. The gorilla was not confirmed by Western science until 1902. The giant squid, long dismissed as a sailor's fantasy, was first photographed alive in 2004. The coelacanth — a fish believed extinct for 65 million years — was found living off the coast of South Africa in 1938. These discoveries, cited endlessly in cryptozoological literature, provide a real foundation for the argument that large unknown animals might yet exist in unexplored or under-explored regions.\n\nBut psychology also plays a role. Cognitive biases — particularly confirmation bias, which leads people to seek and remember evidence that supports an existing belief — are well documented and particularly relevant to cryptid investigation. A misshapen tree root becomes a footprint; a submerged log becomes a long neck breaking the surface; a brief glimpse of something dark and large in poor light becomes a Sasquatch. Human pattern recognition, extraordinary in most contexts, can be a liability when applied to ambiguous phenomena in emotionally charged situations.`,
    vocab: [
      { word: 'Megafauna', definition: 'Large animals, especially those that are significant in size relative to other species in an ecosystem.' },
      { word: 'Predation', definition: 'The natural process by which one animal hunts, kills, and eats another.' },
      { word: 'Confirmation bias', definition: 'The tendency to search for and favour information that confirms what one already believes.' },
      { word: 'Cognitive', definition: 'Relating to mental processes such as thinking, reasoning, perceiving, and remembering.' },
    ],
    questions: [
      { n: 7, q: 'The gorilla, giant squid, and coelacanth were all confirmed long after being dismissed. Does this make you more sympathetic to cryptozoology? Why or why not?' },
      { n: 8, q: 'Can you think of a time when you experienced confirmation bias — believing something because you wanted it to be true? How did you recognise it?' },
      { n: 9, q: 'The ecological argument says a breeding population of large animals would leave physical traces. How strong do you find this argument against the existence of Bigfoot or Nessie?' },
    ]
  },
  {
    number: 4, title: 'What Cryptids Tell Us About Ourselves', emoji: '🧠', color: '#78350f',
    text: `Whatever the ultimate verdict on the physical existence of creatures like Bigfoot and the Loch Ness Monster, cryptids are genuinely revealing objects of study — not because they prove the existence of unknown animals, but because they illuminate the psychology of belief, the sociology of communities, and the cultural function of mystery.\n\nCryptid belief frequently clusters around specific geographical communities. Bigfoot sightings are concentrated in the Pacific Northwest, where the creature has become deeply embedded in regional identity — featured in tourist attractions, local businesses, and public art. The Loch Ness Monster is the economic engine of an entire tourist industry in the Scottish Highlands. In both cases, the cryptid has moved from a claim about biology to a claim about place — a way of saying that this landscape is special, ancient, and not yet fully known. Challenging the creature's existence can feel, to local communities, like challenging the significance of their home.\n\nFrom an anthropological perspective, cryptids serve many of the same functions as mythological creatures in earlier cultures. They embody fears — of the wilderness, of what lies beneath dark water, of the limits of human control over nature. They also embody hopes — that the world remains larger and more surprising than our maps suggest, that discovery is still possible, and that not everything has been catalogued, classified, and domesticated by science.\n\nPerhaps most significantly, the persistence of cryptid belief in the age of satellite imaging, environmental DNA analysis, and camera-equipped smartphones raises genuinely interesting epistemological questions. If these creatures existed, we would almost certainly know by now. That we do not know — that the question remains officially open — suggests that the search for cryptids is not fundamentally about zoology. It is about something deeper: the human need to believe that the world still holds secrets, and that we might be the ones to find them.`,
    vocab: [
      { word: 'Illuminate', definition: 'To make something clearer or easier to understand; to shed light on a topic or question.' },
      { word: 'Anthropological', definition: 'Relating to anthropology — the study of human societies, cultures, and their development.' },
      { word: 'Epistemological', definition: 'Relating to epistemology — the branch of philosophy concerned with how we know what we know.' },
      { word: 'Domesticated', definition: 'Tamed or made familiar; brought under human control or understanding.' },
    ],
    questions: [
      { n: 10, q: 'The passage argues that cryptids serve a cultural function similar to mythological creatures. Do you agree? Can you think of examples from your own culture?' },
      { n: 11, q: 'The Loch Ness Monster is described as "the economic engine" of local tourism. Does commercial interest affect how seriously you take eyewitness reports from that area?' },
      { n: 12, q: 'The passage ends by saying the search for cryptids is about "the human need to believe the world still holds secrets." Is this a need you recognise in yourself? Is it a healthy one?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Cryptids — Bigfoot, the Loch Ness Monster and Why People Keep Searching". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#fefce8', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #fde68a' }}>💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your full answer, then tap <strong>⏹ Stop & Send</strong>.</div>}
      {messages.length > 0 && (
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && <div style={{ background: '#fefce8', border: '1px solid #fde68a', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}><span style={{ color: color, fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>🌍 Translation</span>{m.translation}</div>}
              </div>
            </div>
          ))}
...
export default function CryptidsPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1c0a00 0%, #78350f 50%, #92400e 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#854d0e', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B2 Upper Intermediate</span>
                <span style={{ background: 'rgba(133,77,14,0.6)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Cryptids — Bigfoot, Nessie and Why People Keep Searching</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Hidden creatures, blurry photographs, enormous footprints — and the surprisingly deep human psychology behind the search for animals science says don't exist.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#854d0e', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#854d0e' : '#e5e7eb', background: speed === s.value ? '#854d0e' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#fefce8', padding: '8px 28px', borderBottom: '1px solid #fde68a' }}>
              <span style={{ color: '#713f12', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#854d0e' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#fefce8', border: '1px solid #fde68a', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#713f12', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: `rgba(133,77,14,0.15)`, border: `1px solid rgba(133,77,14,0.3)`, borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#fcd34d', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#854d0e', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fde68a', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#fefce8', color: '#713f12', border: '2px solid #fde68a', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fefce8', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fde68a', color: '#9ca3af', fontSize: '15px' }}>{translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}</div>
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#fefce8', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fde68a' }}>
                  <div style={{ color: '#713f12', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>📖 English Definition</div>
                  <span style={{ color: '#374151', fontSize: '16px', lineHeight: '1.6' }}>{lookupDef}</span>
                </div>
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#fefce8', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fcd34d' }}>
                    <div style={{ color: '#854d0e', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>{currentLang?.label} Translation</div>
