...
const PARTS = [
  {
    number: 1,
    title: 'What Is the Digital Nomad Economy?',
    emoji: '💻',
    color: '#3b82f6',
    text: `A digital nomad is someone who works remotely using the internet, often while travelling or living in different countries. The concept is not new — freelancers and location-independent workers have existed for decades. However, the COVID-19 pandemic fundamentally changed the relationship between work and location. As millions of office workers were forced to work from home, many realised that physical presence in an office was not always necessary. When restrictions lifted, some chose not to return. Instead, they packed their laptops and began working from cafés, co-working spaces, and apartments in countries they had always wanted to explore.\n\nThis shift gave rise to what economists now call the digital nomad economy — a growing ecosystem of remote workers, freelancers, entrepreneurs, and companies that support their lifestyle. Estimates suggest there are now over 35 million digital nomads worldwide, a figure that has more than tripled since 2019. Supporting industries have grown rapidly alongside them: co-working space providers, travel insurance companies, remote job platforms, and online communities all serve this expanding market. For many countries, attracting digital nomads has become a deliberate economic strategy.`,
    vocab: [
      { word: 'Remote work', definition: 'Working from a location other than a central office — often from home or while travelling.' },
      { word: 'Ecosystem', definition: 'A network of interconnected businesses, services and people that support each other.' },
      { word: 'Freelancer', definition: 'A self-employed person who works for multiple clients rather than one employer.' },
      { word: 'Location-independent', definition: 'Able to work from any place — not tied to a specific office or city.' },
    ],
    questions: [
      { n: 1, q: 'How did the pandemic permanently change attitudes toward office work?' },
      { n: 2, q: 'Is the freedom to work anywhere a privilege or a realistic option for most workers?' },
      { n: 3, q: 'What kinds of jobs are best suited to the digital nomad lifestyle?' },
    ]
  },
  {
    number: 2,
    title: 'Popular Destinations and What Attracts Nomads',
    emoji: '🗺️',
    color: '#8b5cf6',
    text: `Digital nomads do not choose their destinations randomly. Several key factors influence where they go: cost of living, internet reliability, visa accessibility, safety, climate, and the presence of an existing nomad community. Cities like Lisbon, Chiang Mai, Medellín, Bali, and Tbilisi have become internationally recognised nomad hubs, each offering an attractive combination of affordability, connectivity, and lifestyle quality.\n\nIn response to this demand, governments around the world have introduced dedicated digital nomad visas. Countries including Portugal, Germany, Costa Rica, Indonesia, and the United Arab Emirates now offer legal pathways for remote workers to live and work within their borders for extended periods — typically six months to two years. These visas are designed to attract people who earn income from abroad, meaning they bring money into the local economy without competing for local jobs. For smaller or developing economies, this is particularly appealing. However, critics point out that not all nomads contribute meaningfully to local communities, and concerns have grown about whether these programmes genuinely benefit ordinary residents or primarily serve a wealthy, mobile elite.`,
    vocab: [
      { word: 'Hub', definition: 'A centre of activity — a place where many people with similar interests or work gather.' },
      { word: 'Visa accessibility', definition: 'How easy it is for foreign nationals to obtain legal permission to stay in a country.' },
      { word: 'Connectivity', definition: 'The quality and availability of internet and transport links in a place.' },
      { word: 'Elite', definition: 'A small group of people with special privileges, advantages, or high social status.' },
    ],
    questions: [
      { n: 4, q: 'Should governments actively compete to attract digital nomads, or focus on local workers?' },
      { n: 5, q: 'What responsibilities do digital nomads have toward the communities they live in?' },
      { n: 6, q: 'Is a digital nomad visa a genuine economic policy or mainly a marketing strategy?' },
    ]
  },
  {
    number: 3,
    title: 'Impact on Local Economies and Communities',
    emoji: '🏘️',
    color: '#f59e0b',
    text: `The arrival of large numbers of digital nomads has a measurable impact on local economies, though the effects are not always straightforward. On the positive side, nomads typically spend significantly on accommodation, food, transport, and leisure — often at higher rates than local residents. They may also bring international skills, networks, and ideas that can stimulate local business development. Co-working spaces, international cafés, and English-language services have flourished in many nomad-popular cities.\n\nHowever, a pattern of negative consequences has emerged in several popular destinations. Rising rents are the most commonly reported problem. When a neighbourhood becomes attractive to well-paid foreign workers, property owners often increase prices, pricing out local families who have lived there for generations. This process, sometimes called gentrification, has caused significant tension in cities including Lisbon, Barcelona, and Oaxaca. Additionally, some critics argue that digital nomadism can create a two-speed city — where expensive international cafés and co-working spaces exist alongside ordinary residents who see little direct benefit. Balancing openness to nomads with protection of local housing and culture remains a significant policy challenge.`,
    vocab: [
      { word: 'Gentrification', definition: 'The process by which wealthier newcomers change a neighbourhood, often raising costs and displacing existing residents.' },
      { word: 'Stimulate', definition: 'To encourage growth or activity — to make something develop more quickly.' },
      { word: 'Flourish', definition: 'To grow successfully and strongly — to thrive in good conditions.' },
      { word: 'Policy challenge', definition: 'A difficult problem that requires government decisions and careful management to solve.' },
    ],
    questions: [
      { n: 7, q: 'How should cities manage the tension between welcoming newcomers and protecting existing residents?' },
      { n: 8, q: 'Is gentrification always negative, or can it bring genuine improvements to an area?' },
      { n: 9, q: 'Who should be responsible for managing the effects of digital nomadism — governments, companies, or individuals?' },
    ]
  },
  {
    number: 4,
    title: 'The Future of the Digital Nomad Economy',
    emoji: '🌐',
    color: '#22c55e',
    text: `The digital nomad economy shows no sign of shrinking. Remote work technology continues to improve, with faster internet, better collaboration tools, and increasingly sophisticated project management platforms making distributed teams more viable than ever. Major corporations including Airbnb, Spotify, and Dropbox have adopted permanent remote or hybrid work policies, signalling that location flexibility is becoming a standard professional expectation rather than an exceptional perk.\n\nAt the same time, the movement faces real challenges. Tax regulations remain complex — most countries require workers to pay income tax based on where they are physically located, creating legal and financial complications for frequent movers. Loneliness and lack of community are also commonly reported difficulties; constantly changing environments can make it hard to build lasting relationships or a stable support network. Finally, there are deeper philosophical questions about what the widespread adoption of this lifestyle would mean for cities, families, and social cohesion. Whether the digital nomad economy evolves into a mainstream work model or remains a niche lifestyle for a relatively small group may depend on how well societies, companies, and individuals navigate these unresolved tensions.`,
    vocab: [
      { word: 'Hybrid work', definition: 'A working arrangement combining some time in the office with remote working from home or elsewhere.' },
      { word: 'Social cohesion', definition: 'The sense of connection, trust, and shared identity that holds a community or society together.' },
      { word: 'Niche', definition: 'Appealing to a small, specific group rather than the general population.' },
      { word: 'Perk', definition: 'An additional benefit or advantage that comes with a job, beyond the basic salary.' },
    ],
    questions: [
      { n: 10, q: 'Will remote and nomadic work become the norm, or will offices make a permanent comeback?' },
      { n: 11, q: 'How can digital nomads build a sense of community and belonging despite constant movement?' },
      { n: 12, q: 'Should companies be required to pay tax in the countries where their remote employees live and work?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "The Digital Nomad Economy". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function DigitalNomadEconomyPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(135deg, #0f2027 0%, #203a43 50%, #2c5364 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(139,92,246,0.6)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Work & Business</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Digital Nomad Economy</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Work from Anywhere — explore the rise of location-independent work, its impact on cities and communities, and what the future holds for remote workers worldwide.</p>
            </div>
          </div>
