...
const PARTS = [
  { number: 1, title: 'World Cup 2026 — What\'s Happening Now', emoji: '⚽', color: '#22c55e',
    text: `The FIFA World Cup 2026 is just weeks away, set to be the biggest ever with 48 teams playing across the United States, Canada, and Mexico. The expanded format means more matches and more opportunities for surprises. Current odds and expert predictions suggest a competitive field with Spain and France topping the list as favorites to win the title. Analysts point to Spain's success in recent major tournaments and France's deep squad as reasons for their strong market positions. Meanwhile, teams like England, Brazil, and Argentina also remain strong contenders, each with impressive histories and quality players.\n\nThe World Cup begins on June 11, and fans around the world are already debating which team might lift the trophy in July.`,
    vocab: [
      { word: 'Expanded format', definition: 'A changed structure that includes more teams or games than before — here, 48 teams instead of 32.' },
      { word: 'Contenders', definition: 'Teams or people who have a realistic chance of winning a competition.' },
      { word: 'Squad depth', definition: 'Having many strong players in a team, not just a few stars — good backup options for every position.' },
      { word: 'Odds', definition: 'A number used by analysts and betting companies to show how likely something is to happen.' },
    ],
    questions: [
      { n: 1, q: 'Which part of the World Cup build-up do you find most exciting — the teams, players, or fans? Why?' },
      { n: 2, q: 'Do you think having 48 teams makes the tournament more interesting or too long? Explain your opinion.' },
      { n: 3, q: 'Should host nations be included automatically, even if their team is weaker? Why or why not?' },
    ]
  },
  { number: 2, title: 'Why Certain Teams Are Favorites', emoji: '🏆', color: '#f59e0b',
    text: `Many expert predictions show Spain and France as the most likely winners. Spain's combination of experienced players and tactical balance gives them an edge, while France benefits from strong squad depth and world-class talent across multiple positions. England's young generation and attacking options also place them among the favourites, and South American teams such as Brazil and Argentina bring flair and winning tradition to the competition.\n\nHosting the tournament gives the U.S. Men's National Team a chance to shine, with strong odds of advancing well into the knockout rounds, although they are not among the top favorites to win outright. The expanded format, which allows more teams from each group to progress, could also benefit surprise challengers and "dark horse" nations who perform well in key matches.`,
    vocab: [
      { word: 'Tactical balance', definition: 'A team\'s ability to play well in both attack and defence — being organised and flexible.' },
      { word: 'Flair', definition: 'A natural and exciting style of playing — creative, skillful and entertaining football.' },
      { word: 'Dark horse', definition: 'A team that is not expected to win but could surprise everyone with a strong performance.' },
      { word: 'Knockout rounds', definition: 'The stages of a tournament where losing one match means you are eliminated from the competition.' },
    ],
    questions: [
      { n: 4, q: 'Do you think favorites always have the best chance of winning, or can underdogs succeed? Why?' },
      { n: 5, q: 'Is it fair to judge teams by odds before the tournament starts? Explain your opinion.' },
      { n: 6, q: 'How important is it for a host nation to succeed in a World Cup?' },
    ]
  },
  { number: 3, title: 'History and Pressure in Major Tournaments', emoji: '📖', color: '#ef4444',
    text: `History shows that being the pre-tournament favorite does not guarantee success. In past World Cups, highly ranked teams have sometimes been eliminated early, while underdogs have advanced deep into the knockout stages. Some favorites in previous tournaments did not reach the final despite high expectations, reminding fans that a single match can change the narrative quickly.\n\nThe World Cup's long history of surprises — from unexpected quarterfinalists to shock champions — means that predictions are always tentative. Some fans believe that passion, team spirit, and momentum matter just as much as individual talent or historical rankings. This makes the tournament unpredictable and thrilling for viewers, regardless of pre-tournament predictions.`,
    vocab: [
      { word: 'Guarantee', definition: 'To make something certain — a promise that a result or outcome will definitely happen.' },
      { word: 'Narrative', definition: 'The story or interpretation people use to understand events — how something is described or perceived.' },
      { word: 'Tentative', definition: 'Not certain or final — something said carefully because it might change or be wrong.' },
      { word: 'Momentum', definition: 'The energy and confidence a team builds from a series of good performances or results.' },
    ],
    questions: [
      { n: 7, q: 'What matters more in a big tournament — talent or teamwork? Why?' },
      { n: 8, q: 'Do you enjoy watching upsets in sports? Why or why not?' },
      { n: 9, q: 'Can pressure from expectations affect how a team performs? Explain your view.' },
    ]
  },
  { number: 4, title: 'What Fans and Analysts Are Saying', emoji: '🌍', color: '#3b82f6',
    text: `As the tournament approaches, fans and analysts around the world debate who will lift the trophy. Some focus on individual stars and their potential impact, while others talk about squad depth or tactical approaches. There is also discussion about how the expanded format and group draw can influence outcomes, with some groups seen as easier or harder than others.\n\nThe global nature of the World Cup means cultural pride, local support, and the emotional connection of fans play a huge role beyond statistics or odds. Many supporters feel that the unpredictability of football — where one game can change everything — is what makes the World Cup one of the most watched sporting events in the world.`,
    vocab: [
      { word: 'Unpredictability', definition: 'The quality of being impossible to know in advance — you cannot tell what will happen next.' },
      { word: 'Cultural pride', definition: 'A strong feeling of respect and honour for your country, language, or traditions.' },
      { word: 'Intuition', definition: 'A feeling about something that comes without logical reasoning — a gut instinct.' },
      { word: 'Influence', definition: 'To have an effect on something or someone — to change or shape an outcome.' },
    ],
    questions: [
      { n: 10, q: 'Do you think fans\' emotions and support can influence a team\'s performance? Why?' },
      { n: 11, q: 'How much do you rely on expert predictions versus your own intuition when thinking about sports outcomes?' },
      { n: 12, q: 'What makes the World Cup more exciting than other tournaments, in your opinion?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "FIFA World Cup 2026". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function WorldCup2026Page() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(135deg, #064e3b 0%, #065f46 50%, #047857 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(245,158,11,0.8)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Sports</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>FIFA World Cup 2026</h1>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The biggest tournament in football history — explore the build-up, the favorites, the pressure, and what fans around the world are saying.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#22c55e' : '#e5e7eb', background: translationLang !== 'none' ? '#f0fdf4' : 'white', color: translationLang !== 'none' ? '#15803d' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
          ...
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#f0fdf4', padding: '8px 28px', borderBottom: '1px solid #bbf7d0' }}>
              <span style={{ color: '#15803d', fontSize: '12px', fontWeight: '600' }}>
                ...
                {translationLang !== 'none' && <span style={{ color: '#166534' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && (
                          <div style={{ marginTop: '8px', background: `rgba(${part.color === '#22c55e' ? '34,197,94' : part.color === '#f59e0b' ? '245,158,11' : part.color === '#ef4444' ? '239,68,68' : '59,130,246'},0.15)`, border: `1px solid rgba(${part.color === '#22c55e' ? '34,197,94' : part.color === '#f59e0b' ? '245,158,11' : part.color === '#ef4444' ? '239,68,68' : '59,130,246'},0.3)`, borderRadius: '10px', padding: '10px 14px' }}>
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #bbf7d0', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#f0fdf4', color: '#15803d', border: '2px solid #bbf7d0', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#f0fdf4', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bbf7d0' }}>
                  <div style={{ color: '#15803d', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>📖 English Definition</div>
