...
const PARTS = [
  { number: 1, title: 'The Growth of Online Learning', emoji: '🌐', color: '#3b82f6',
    text: `Online learning platforms have changed how people study and develop skills. Students can access courses, videos, and assignments through the internet, often from anywhere in the world. These platforms offer subjects ranging from languages and business to science and technology.\n\nThe growth of online learning has been accelerated by global events and advances in digital technology. For many learners, online education provides opportunities that were previously unavailable.`,
    vocab: [
      { word: 'Platform', definition: 'A digital service or website that provides tools and content for a specific purpose — like learning.' },
      { word: 'Accelerated', definition: 'Made to happen faster or grow more quickly than expected.' },
      { word: 'Assignments', definition: 'Tasks or pieces of work given to students to complete as part of a course.' },
      { word: 'Opportunities', definition: 'Chances or situations that make it possible to do or achieve something.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think online learning has become so popular?' },
      { n: 2, q: 'Is online learning suitable for all subjects?' },
      { n: 3, q: 'Would you choose online learning over classroom learning? Why?' },
    ]
  },
  { number: 2, title: 'Flexibility and Accessibility', emoji: '⏱️', color: '#8b5cf6',
    text: `One major advantage of online learning platforms is flexibility. Learners can study at their own pace and choose when and where to learn. This is especially helpful for working adults or people with family responsibilities.\n\nOnline courses are often more affordable than traditional education, making learning accessible to a wider audience. However, this flexibility also requires strong self-discipline, which not all students find easy.`,
    vocab: [
      { word: 'Flexibility', definition: 'The ability to change or adapt easily — choosing when, where and how to do something.' },
      { word: 'Accessible', definition: 'Easy to reach, use, or obtain — available to a wide range of people.' },
      { word: 'Self-discipline', definition: 'The ability to control your own behaviour and stay focused without being told to.' },
      { word: 'Affordable', definition: 'Reasonably priced — not too expensive for most people to pay.' },
    ],
    questions: [
      { n: 4, q: 'Who benefits most from flexible learning?' },
      { n: 5, q: 'Is self-discipline more important in online or classroom learning?' },
      { n: 6, q: 'Should education always be affordable, even if quality changes?' },
    ]
  },
  { number: 3, title: 'Challenges and Limitations', emoji: '⚠️', color: '#f59e0b',
    text: `Despite many benefits, online learning platforms also face challenges. Some students feel isolated without face-to-face interaction, and others struggle with motivation. Technical problems, such as poor internet access, can also limit learning.\n\nTeachers may find it harder to measure student engagement online. Without direct interaction, it can be difficult to know whether students truly understand the material.`,
    vocab: [
      { word: 'Isolated', definition: 'Feeling alone or separated from others — cut off from social contact.' },
      { word: 'Motivation', definition: 'The desire or reason to do something — the drive to keep working towards a goal.' },
      { word: 'Engagement', definition: 'The level of interest and involvement a student shows in their learning.' },
      { word: 'Material', definition: 'The content or subject matter that students are expected to learn or study.' },
    ],
    questions: [
      { n: 7, q: 'How important is social interaction in learning?' },
      { n: 8, q: 'Can online platforms replace teachers completely?' },
      { n: 9, q: 'What problems have you experienced with online learning?' },
    ]
  },
  { number: 4, title: 'The Future of Education', emoji: '🚀', color: '#22c55e',
    text: `Many experts believe the future of education will combine online and classroom learning. This blended approach allows students to benefit from flexibility while maintaining personal interaction. Technology such as AI may also personalize learning paths for students.\n\nAs online platforms continue to improve, education may become more global and inclusive. However, ensuring quality, fairness, and equal access will remain important challenges.`,
    vocab: [
      { word: 'Blended learning', definition: 'An approach that combines online and face-to-face classroom teaching.' },
      { word: 'Personalize', definition: 'To adapt something to suit an individual\'s specific needs or preferences.' },
      { word: 'Inclusive', definition: 'Including and welcoming everyone, regardless of background or ability.' },
      { word: 'Equal access', definition: 'The principle that everyone should have the same opportunity to use or benefit from something.' },
    ],
    questions: [
      { n: 10, q: 'Is blended learning the best solution for education?' },
      { n: 11, q: 'How might technology change the role of teachers?' },
      { n: 12, q: 'What skills will future students need most?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "Online Learning Platforms". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function OnlineLearningPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e3a5f 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(139,92,246,0.7)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Technology</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Online Learning Platforms</h1>
              <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>How the internet is changing education — explore flexibility, access, challenges, and the future of learning.</p>
            </div>
          </div>
