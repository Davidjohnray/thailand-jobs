...
const PARTS = [
  {
    number: 1, title: 'What Is a Time Slip?', emoji: '⏳', color: '#8b5cf6',
    text: `A time slip is a reported phenomenon in which a person — or group of people — apparently experiences a brief, involuntary displacement into a different historical period. Unlike a dream or a hallucination, a time slip is described by those who report it as vivid, physical, and completely indistinguishable from ordinary waking reality. The person does not feel they are imagining anything; they feel they have, for a brief moment, genuinely entered a different time.\n\nTypically, the experience begins suddenly and without warning. A person walking down a familiar street or through a well-known building finds that the surroundings have subtly but profoundly changed. The architecture is different. The people they encounter are dressed in clothing from another era. The vehicles, the sounds, the smells — everything feels authentic and entirely real. Then, just as suddenly, the experience ends, and the person finds themselves back in their own time, often in precisely the same physical location.\n\nTime slips are distinct from other paranormal experiences in several important ways. They do not typically involve fear or the sense of a supernatural presence. They are not associated with sleep, drugs, or altered mental states. And crucially, they are sometimes reported by more than one person simultaneously — which, if true, would appear to rule out purely subjective psychological explanations.\n\nAccounts of time slip experiences appear throughout recorded history, across many different cultures, and in many different locations. While mainstream science does not accept them as genuine temporal phenomena, they continue to be reported with striking consistency, and the cases that involve multiple independent witnesses have proven particularly difficult to dismiss.`,
    vocab: [
      { word: 'Involuntary', definition: 'Done without conscious choice or intention; happening without the person deciding to do it.' },
      { word: 'Displacement', definition: 'Being moved from one place or time to another, often without warning.' },
      { word: 'Phenomenon', definition: 'A fact, event, or situation that is observed to exist or happen, especially one whose cause is uncertain.' },
      { word: 'Temporal', definition: 'Relating to time — in physics and philosophy, connected to the nature or experience of time.' },
    ],
    questions: [
      { n: 1, q: 'Before reading this, had you ever heard of time slips? What was your initial reaction to the concept?' },
      { n: 2, q: 'Why do you think the fact that some time slips are reported by multiple people simultaneously makes them harder to dismiss?' },
      { n: 3, q: 'How would you react if you suddenly found yourself in what appeared to be a different historical period? What would you do?' },
    ]
  },
  {
    number: 2, title: 'Famous Cases', emoji: '🏰', color: '#7c3aed',
    text: `The most extensively documented time slip case in the English-speaking world is that of Charlotte Anne Moberly and Eleanor Jourdain, two highly educated English academics who visited the Palace of Versailles in France in August 1901. Walking through the gardens near the Petit Trianon — the small palace used by Marie Antoinette — they reported that the atmosphere changed suddenly and dramatically. They described a feeling of oppressive stillness and unreality, and encountered several individuals dressed in eighteenth-century clothing who appeared entirely solid and real. One woman, whom they later became convinced was Marie Antoinette herself, was seated sketching in the garden. Both women independently wrote accounts of their experience, which they later published as a book entitled "An Adventure."\n\nTheir accounts were remarkably consistent with each other, and several of the details they described — including a small bridge and a kiosk that no longer existed — were later verified through historical research as accurately reflecting the layout of the Versailles gardens in the late eighteenth century. Sceptics have argued that the women might have encountered historical re-enactors, or that their accounts were influenced by prior research. However, the women maintained until their deaths that what they experienced was entirely real.\n\nAnother frequently cited case is that of two British couples who in 1979 reported stopping at a hotel near Montelimar in France, whose decor, staff clothing, and general atmosphere appeared to belong to the 1950s. When they attempted to return to the same hotel the following day, it had completely vanished. They could not find any trace of the building, its staff, or the name they had seen on the sign.\n\nIn Liverpool, England — a city that has generated a disproportionate number of reported time slips — several independent witnesses have described walking into Bold Street in the city centre and finding themselves briefly transported to the 1950s or 1960s, complete with period shops, vehicles, and pedestrians.`,
    vocab: [
      { word: 'Extensively', definition: 'In a thorough and detailed way, covering a wide area or many aspects.' },
      { word: 'Oppressive', definition: 'Causing a feeling of heaviness, discomfort, or anxiety — as if a weight is pressing down.' },
      { word: 'Sceptics', definition: 'People who doubt or question claims, especially those that cannot be easily verified.' },
      { word: 'Disproportionate', definition: 'Too large or too small in relation to something else; not matching what would be expected.' },
    ],
    questions: [
      { n: 4, q: 'Which of the cases described do you find most compelling? What makes it particularly convincing or unconvincing?' },
      { n: 5, q: 'The Moberly-Jourdain case involved two educated academics. Does a witness\'s background affect how seriously you take their account? Why?' },
      { n: 6, q: 'Why do you think a city like Liverpool might generate more time slip reports than other places? What factors might be involved?' },
    ]
  },
  {
    number: 3, title: 'Scientific and Psychological Explanations', emoji: '🔬', color: '#6d28d9',
    text: `Mainstream science does not recognise time slips as genuine temporal phenomena, and for understandable reasons: the concept appears to violate fundamental principles of physics, and there is no physical evidence — photographs, artefacts, or corroborating documentation — that has survived any reported time slip experience. Nevertheless, scientists and psychologists have proposed several explanations for why these experiences are reported.\n\nOne prominent explanation involves the concept of cryptomnesia — unconscious memory. Under this theory, a person may have encountered descriptions or images of a historical period through reading, films, or conversations, and forgotten the source entirely. When certain environmental triggers activate these buried memories, the brain may generate an experience so vivid and detailed that it feels entirely real. This theory has the advantage of being grounded in well-documented psychological mechanisms, but it struggles to account for cases involving multiple simultaneous witnesses.\n\nAnother explanation focuses on temporal lobe activity. The temporal lobes of the brain — located on the sides of the skull, behind the temples — are associated with memory, perception, and the processing of sensory information. Mild epileptic activity or other disturbances in this region can produce profoundly realistic experiences that feel utterly distinct from dreams or imagination. Some researchers have suggested that environmental factors — electromagnetic fields generated by geological features, for instance — could potentially trigger such activity in susceptible individuals.\n\nA third category of explanation draws on theories in quantum physics. Some physicists have speculated that time may not be the fixed, linear phenomenon that ordinary experience suggests, and that under certain conditions, different temporal states could theoretically coexist or intersect. While this idea is far from accepted scientific consensus, it has been used to provide a theoretical framework within which time slips might, in principle, be considered physically possible.`,
    vocab: [
      { word: 'Cryptomnesia', definition: 'A psychological phenomenon where a forgotten memory returns without being recognised as a memory.' },
      { word: 'Corroborating', definition: 'Providing evidence that confirms or supports a statement, theory, or finding.' },
      { word: 'Temporal lobe', definition: 'A region of the brain involved in processing memory, language, and sensory experiences.' },
      { word: 'Consensus', definition: 'General agreement among a group of people, especially experts in a particular field.' },
    ],
    questions: [
      { n: 7, q: 'Which scientific explanation do you find most persuasive — cryptomnesia, temporal lobe activity, or quantum physics? Why?' },
      { n: 8, q: 'Why do you think the presence of multiple simultaneous witnesses is such a significant challenge for psychological explanations?' },
      { n: 9, q: 'Does the absence of physical evidence automatically mean a phenomenon is not real? How should we evaluate experiences that leave no physical trace?' },
    ]
  },
  {
    number: 4, title: 'What Time Slips Tell Us', emoji: '🧠', color: '#5b21b6',
    text: `Whether or not time slips represent genuine temporal displacement, the phenomenon raises profound and genuinely interesting questions about the nature of human consciousness, the reliability of perception, and the relationship between individual experience and objective reality.\n\nThe consistency of time slip reports across centuries and cultures is itself remarkable. People who have never heard of the concept report experiences that share a distinctive and recognisable pattern: the sudden change of atmosphere, the encounter with period-appropriate clothing and architecture, the absence of any sense of fear or unreality during the experience itself, and the abrupt return to the present. This consistency suggests, at minimum, that whatever produces the experience is tapping into something fundamental about the way human beings process and interpret the world around them.\n\nTime slips also highlight the extent to which we take for granted the solidity and reliability of our ordinary experience. We assume, without examining the assumption, that what we perceive corresponds directly and accurately to an external reality. But perception is an active process of interpretation, not a passive recording. The brain constantly fills in gaps, makes predictions, and constructs a model of the world that is convincing but not infallible. Time slip experiences — whatever their ultimate cause — remind us of how easily that model can be destabilised.\n\nFor some people, reported time slip experiences carry a more personal significance. Several individuals who have described such experiences report that they changed their understanding of time, history, and human continuity in ways that proved meaningful and lasting. Whatever science eventually concludes about their physical reality, the experiences themselves — the sudden, disorienting encounter with what feels like a living past — appear to be genuinely transformative for those who have them.`,
    vocab: [
      { word: 'Consciousness', definition: 'The state of being aware of and able to think about one\'s own existence, thoughts, and surroundings.' },
      { word: 'Infallible', definition: 'Incapable of making mistakes or being wrong; perfectly reliable.' },
      { word: 'Destabilised', definition: 'Made uncertain, unsteady, or less secure — had its normal functioning disrupted.' },
      { word: 'Transformative', definition: 'Causing a complete or dramatic change in someone\'s character, understanding, or situation.' },
    ],
    questions: [
      { n: 10, q: 'The passage argues that perception is "an active process of interpretation, not a passive recording." Do you agree? What are the implications of this?' },
      { n: 11, q: 'If a time slip experience changed a person\'s understanding of time and history in a meaningful way, does it matter whether the experience was "real"?' },
      { n: 12, q: 'What do you think time slip reports, taken together, reveal about human nature — our relationship to the past, to memory, or to the unknown?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Time Slips — People Who Claim to Have Briefly Entered the Past". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#faf5ff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && (
        <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #ede9fe' }}>
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && (
                  <div style={{ background: '#faf5ff', border: '1px solid #ede9fe', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}>
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid #ede9fe', display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
...
export default function TimeSlipsPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0f0720 0%, #2e1065 50%, #4c1d95 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#8b5cf6', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B2 Upper Intermediate</span>
                <span style={{ background: 'rgba(139,92,246,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Time Slips</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Walking into the past — the people who claim to have briefly stepped into a different historical era, and what science makes of their accounts.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#8b5cf6', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#8b5cf6' : '#e5e7eb', background: translationLang !== 'none' ? '#faf5ff' : 'white', color: translationLang !== 'none' ? '#6d28d9' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#faf5ff', padding: '8px 28px', borderBottom: '1px solid #ede9fe' }}>
              <span style={{ color: '#6d28d9', fontSize: '12px', fontWeight: '600' }}>
                ✍️ Highlight any word or phrase to hear it and see its meaning
                {translationLang !== 'none' && <span style={{ color: '#8b5cf6' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
                    ...
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && (
                          <div style={{ marginTop: '6px', background: '#faf5ff', border: '1px solid #ede9fe', borderRadius: '8px', padding: '8px 12px' }}>
                            <span style={{ color: '#6d28d9', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
            ...
            <div style={{ background: '#1a1a2e', padding: '20px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                ...
                <span style={{ color: '#c4b5fd', fontWeight: 'bold', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>Discussion Questions</span>
              </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && (
                          <div style={{ marginTop: '8px', background: 'rgba(139,92,246,0.15)', border: '1px solid rgba(139,92,246,0.3)', borderRadius: '10px', padding: '10px 14px' }}>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#8b5cf6', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #ede9fe', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#faf5ff', color: '#6d28d9', border: '2px solid #ede9fe', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #ede9fe', color: '#9ca3af', fontSize: '15px' }}>
                {translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}
              </div>
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #ede9fe' }}>
                ...
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #c4b5fd' }}>
