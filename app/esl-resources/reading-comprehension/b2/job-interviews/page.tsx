...
const PARTS = [
  {
    number: 1, title: 'Preparing for a Job Interview in English', emoji: '📋', color: '#3b82f6',
    text: `A job interview in English presents a unique set of challenges for non-native speakers. Beyond the normal pressure of wanting to make a good impression, candidates must also think quickly in a second language, understand questions that may be phrased in unfamiliar ways, and express their experience and personality clearly under time pressure. The good news is that thorough preparation can dramatically reduce anxiety and improve performance — and most interview questions follow predictable patterns that can be researched and practised in advance.\n\nBefore any interview, experienced candidates research the company carefully: its products or services, recent news, company culture, and the specific requirements of the role. This research serves two purposes. First, it allows you to tailor your answers to show that you understand what the company needs. Second, it demonstrates genuine interest — interviewers can almost always tell whether a candidate has prepared. You should also prepare a concise personal introduction — often called an "elevator pitch" — that summarises who you are, what you have achieved, and why you are the right person for this role. This is typically the answer to the classic opening question: "Tell me about yourself."`,
    vocab: [
      { word: 'Thorough', definition: 'Complete and careful — covering every detail without missing anything important.' },
      { word: 'Tailor', definition: 'To adapt something specifically for a particular purpose or audience — to customise.' },
      { word: 'Elevator pitch', definition: 'A short, persuasive summary of who you are and what you offer — designed to make a strong first impression.' },
      { word: 'Demonstrate', definition: 'To show clearly through your actions or words — to prove something by example.' },
    ],
    questions: [
      { n: 1, q: 'How do you prepare for a job interview? What do you research beforehand?' },
      { n: 2, q: 'Is a job interview in English more difficult than in your first language? What are the main challenges?' },
      { n: 3, q: 'How important is first impression in an interview — can you recover from a bad start?' },
    ]
  },
  {
    number: 2, title: 'Answering Common Interview Questions', emoji: '💬', color: '#8b5cf6',
    text: `Most job interviews include a set of predictable question types that candidates can prepare for in advance. Competency-based questions ask you to describe specific situations from your past experience: "Tell me about a time when you had to deal with a difficult colleague" or "Describe a situation where you had to work under pressure." The most effective way to answer these questions is using the STAR method — Situation, Task, Action, Result. You briefly describe the context, explain what you needed to do, describe the specific actions you took, and finish with a clear, measurable result.\n\nOther common question types include motivational questions ("Why do you want to work here?"), strengths and weaknesses questions, and future-focused questions ("Where do you see yourself in five years?"). For weaknesses, the most respected approach is to identify a genuine area for improvement while showing that you are actively working on it — for example: "I have sometimes found it difficult to delegate, but I have been working on this by..." Saying "I work too hard" or "I am a perfectionist" is widely considered a weak answer and may actually harm your chances. Interviewers want to see self-awareness, honesty, and a growth mindset.`,
    vocab: [
      { word: 'Competency-based', definition: 'Focused on specific skills and behaviours — questions that ask for real examples from past experience.' },
      { word: 'STAR method', definition: 'A structured way to answer interview questions: Situation, Task, Action, Result.' },
      { word: 'Delegate', definition: 'To assign tasks to other people — to trust others to handle responsibilities you could do yourself.' },
      { word: 'Growth mindset', definition: 'The belief that abilities can be developed through effort — being open to learning and improvement.' },
    ],
    questions: [
      { n: 4, q: 'Have you ever used the STAR method? Do you think it is effective?' },
      { n: 5, q: 'How do you answer the "What is your greatest weakness?" question honestly without hurting your chances?' },
      { n: 6, q: 'Is it better to give rehearsed answers or speak naturally in an interview? What are the risks of each?' },
    ]
  },
  {
    number: 3, title: 'Language, Tone and Body Language', emoji: '🎭', color: '#f59e0b',
    text: `The language you use in an interview signals your professionalism and communication skills as much as the content of your answers. Vague or overly casual responses — "I kind of managed the project" or "it went pretty well" — create a weak impression. Precise, confident language — "I led a team of six and delivered the project two weeks ahead of schedule" — communicates competence and credibility. Using quantifiable results wherever possible makes your achievements concrete and memorable.\n\nBody language is equally important. Research consistently shows that non-verbal signals — posture, eye contact, facial expression, and the firmness of a handshake — significantly influence how interviewers perceive candidates. In most English-speaking business cultures, maintaining moderate eye contact, sitting upright, and smiling naturally are associated with confidence and engagement. Nervousness is normal and most interviewers expect it; what they are looking for is the candidate's ability to manage it professionally. Pausing briefly before answering a difficult question — rather than rushing into an uncertain response — actually signals thoughtfulness rather than weakness.`,
    vocab: [
      { word: 'Vague', definition: 'Unclear and imprecise — not giving enough specific detail to be convincing.' },
      { word: 'Quantifiable', definition: 'Able to be measured with numbers — results expressed as figures, percentages or timeframes.' },
      { word: 'Credibility', definition: 'The quality of being trusted and believed — being seen as reliable and competent.' },
      { word: 'Competence', definition: 'The ability to do something well — having the skills and knowledge required for a task.' },
    ],
    questions: [
      { n: 7, q: 'How do you make your answers sound more specific and impressive without exaggerating?' },
      { n: 8, q: 'How much does body language affect your impression of someone in an interview?' },
      { n: 9, q: 'Is it acceptable to pause and think before answering, or does silence make you seem unprepared?' },
    ]
  },
  {
    number: 4, title: 'Questions to Ask and Following Up', emoji: '🎯', color: '#22c55e',
    text: `At the end of most interviews, candidates are invited to ask questions. This is not optional — it is an important part of the interview. Candidates who say "No, I think you've covered everything" often appear unengaged or unprepared. Thoughtful questions signal genuine interest in the role and the company, and also give you valuable information to help you decide whether this is the right position for you. Strong questions might include: "What does success look like in this role in the first six months?", "What are the main challenges the team is currently facing?", or "How would you describe the management style here?"\n\nAfter the interview, sending a brief follow-up email within 24 hours is standard practice in many English-speaking business cultures. This email should thank the interviewer for their time, briefly reaffirm your interest in the role, and — if relevant — mention one specific point from the conversation that reinforced your enthusiasm. This final step is often overlooked by candidates, yet it creates a positive final impression and keeps your application at the top of the interviewer's mind. Even if you are ultimately unsuccessful, a professional follow-up maintains the relationship for future opportunities.`,
    vocab: [
      { word: 'Unengaged', definition: 'Not showing interest or enthusiasm — appearing disconnected from the conversation.' },
      { word: 'Reaffirm', definition: 'To confirm or state something again — to make clear that you still believe or want something.' },
      { word: 'Enthusiasm', definition: 'Strong interest and excitement — showing that you genuinely care about something.' },
      { word: 'Overlooked', definition: 'Not noticed or considered — something that is missed or forgotten.' },
    ],
    questions: [
      { n: 10, q: 'What questions do you think are most important to ask at the end of an interview?' },
      { n: 11, q: 'Is sending a follow-up email after an interview common in your country? Does it make a difference?' },
      { n: 12, q: 'What do you think is the single most important thing a candidate can do to succeed in an English interview?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Job Interviews in English". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Job Interviews in English</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Get the Job — master the preparation, language and strategies needed to succeed in professional job interviews in English.</p>
            </div>
          </div>
