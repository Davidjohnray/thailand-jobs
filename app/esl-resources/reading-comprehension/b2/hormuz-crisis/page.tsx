...
const PARTS = [
  {
    number: 1, title: 'The Chokepoint', emoji: '🚢', color: '#dc2626',
    text: `The Strait of Hormuz is a narrow waterway between Iran and Oman, connecting the Persian Gulf to the open ocean. It is only 54 kilometres wide at its narrowest point — roughly the distance from one side of a medium-sized city to the other. Yet this tiny strip of water is arguably the single most strategically important location on Earth.\n\nApproximately 25% of the world's maritime oil trade passes through the Strait of Hormuz every day. That is roughly 21 million barrels of oil — enough to fill more than 1,300 Olympic swimming pools — flowing through a channel so narrow that ships must travel in designated lanes just two miles wide. Saudi Arabia, Iraq, Kuwait, the UAE, and Qatar all export the vast majority of their oil through this single waterway. If the strait is blocked, the global economy suffers within hours.\n\nSince February 2026, that is exactly what has happened. Following the US and Israeli military strikes against Iran, the Iranian Revolutionary Guard Corps effectively closed the strait to commercial shipping, mining the waterway, boarding merchant vessels, and attacking ships that attempted to pass without Iranian authorisation. The result has been the most significant disruption to global energy supplies since the 1973 oil crisis.\n\nThis week, Iran and Oman announced they had reached an agreement on a proposed shipping corridor that would partially reopen the strait. But the deal — which Iran insists must be on its terms — falls far short of the free navigation that existed before the war. The world's most important waterway remains, for now, under Iranian control.`,
    vocab: [
      { word: 'Chokepoint', definition: 'A narrow passage through which traffic must pass — blocking it can disrupt movement for everyone.' },
      { word: 'Maritime', definition: 'Relating to the sea, ships, and shipping — connected to ocean trade and navigation.' },
      { word: 'Designated', definition: 'Officially chosen or assigned for a particular purpose — marked out.' },
      { word: 'Authorisation', definition: 'Official permission to do something — approval from someone in control.' },
    ],
    questions: [
      { n: 1, q: '25% of the world oil passes through a waterway only 54km wide. What does this concentration of trade in one location mean for global security?' },
      { n: 2, q: 'Iran effectively closed the strait after being attacked. Is controlling a shipping lane a legitimate form of self-defence or an act of economic warfare?' },
      { n: 3, q: 'The new deal would reopen the strait partly, but on Iran terms. Should any single country control a waterway this important?' },
    ]
  },
  {
    number: 2, title: 'Why One Strait Matters So Much', emoji: '🛢️', color: '#b91c1c',
    text: `The Strait of Hormuz is not the only maritime chokepoint in the world, but it is the most consequential. Understanding why requires understanding how the global economy depends on a surprisingly small number of narrow waterways.\n\nGlobal trade is overwhelmingly maritime — roughly 80% of all goods traded internationally travel by ship. These ships follow established routes that pass through a handful of critical chokepoints: the Strait of Hormuz (oil), the Suez Canal (Europe-Asia trade), the Panama Canal (Atlantic-Pacific trade), the Strait of Malacca (Southeast Asian trade), and the Bab el-Mandeb strait (Red Sea access). If any of these passages is disrupted, the effects ripple across the global economy.\n\nThe world discovered this in 2021, when a single container ship — the Ever Given — became stuck in the Suez Canal for six days, blocking approximately 12% of global trade and costing an estimated 9.6 billion dollars per day. That was an accident. The Hormuz closure is deliberate — and its effects have been far more severe.\n\nOil prices spiked by more than 40% in the weeks following the closure. Countries that depend heavily on Gulf oil — including Japan, South Korea, India, and many European nations — scrambled to find alternative supplies. Petrol prices rose worldwide. The cost of shipping insurance through the region increased tenfold. And the secondary effects — higher transport costs, more expensive manufacturing, rising food prices — spread across every sector of every economy.\n\nThe Hormuz crisis has exposed a vulnerability that economists and security analysts have warned about for decades: the global economy is built on the assumption that a few narrow waterways will always remain open. When that assumption fails, there is no backup plan.`,
    vocab: [
      { word: 'Consequential', definition: 'Having important results or effects — significant enough to change outcomes.' },
      { word: 'Ripple', definition: 'To spread outward in waves — effects that move from one area to many others.' },
      { word: 'Scrambled', definition: 'Rushed urgently to do something — acted quickly under pressure.' },
      { word: 'Vulnerability', definition: 'A weakness that could be exploited or that makes you at risk of harm.' },
    ],
    questions: [
      { n: 4, q: '80% of global trade travels by ship through a handful of narrow waterways. Is this level of concentration dangerous? What alternatives exist?' },
      { n: 5, q: 'One ship blocking the Suez Canal for six days cost 9.6 billion dollars per day. What does this tell us about how fragile global trade is?' },
      { n: 6, q: 'Oil prices rose 40% after the Hormuz closure. How has this affected people in your country? Who suffers most from rising energy prices?' },
    ]
  },
  {
    number: 3, title: 'The Deal Taking Shape', emoji: '🤝', color: '#991b1b',
    text: `The agreement between Iran and Oman on a proposed shipping corridor represents progress — but it is far from the resolution that global markets are hoping for.\n\nUnder the emerging deal, a single two-way shipping corridor would be established through the strait, replacing the pre-war arrangement of separate inbound and outbound lanes. Iran insists that this corridor must pass partly through Iranian territorial waters, giving Tehran effective oversight of all commercial traffic. Iran would provide security, demining, and maritime services — and, critically, would retain the right to inspect vessels and deny passage to ships it considers threatening.\n\nThe United States has rejected any arrangement that gives Iran control over the strait, arguing that the Strait of Hormuz is an international waterway subject to the principle of "transit passage" — the right of all ships to pass through international straits freely without interference. This principle is enshrined in the United Nations Convention on the Law of the Sea, which Iran signed but has interpreted differently from Western nations.\n\nFor Iran, control of the strait has become a matter of national pride and strategic leverage. Iranian officials have stated publicly that the pre-war status quo — in which the strait was effectively an open highway — will not return. "Iran is the dominant power in these waters," said a member of the Iranian negotiating team. "The arrangements must reflect this reality."\n\nFor the rest of the world, the question is whether to accept Iranian terms to restore oil flows, or to resist and risk a prolonged energy crisis. Neither option is attractive — and both carry enormous economic and geopolitical consequences.`,
    vocab: [
      { word: 'Territorial waters', definition: 'The area of sea within a country borders, over which that country has sovereignty and control.' },
      { word: 'Transit passage', definition: 'The legal right of ships to pass through international straits without being stopped or inspected.' },
      { word: 'Leverage', definition: 'Power or influence used to achieve a desired outcome — a bargaining advantage.' },
      { word: 'Status quo', definition: 'The existing situation — the way things were before a change occurred.' },
    ],
    questions: [
      { n: 7, q: 'Iran wants to control shipping through the strait. The US says it should be free passage. Who has the stronger legal and moral argument?' },
      { n: 8, q: 'Should the world accept Iranian terms to restore oil flows, or resist and face higher energy prices? What would you choose?' },
      { n: 9, q: 'Iran says control of the strait is a matter of national pride. How does national pride affect international negotiations? Is it helpful or harmful?' },
    ]
  },
  {
    number: 4, title: 'Lessons for a Connected World', emoji: '🌐', color: '#7f1d1d',
    text: `The Hormuz crisis offers several important lessons about the world we live in — lessons that extend far beyond oil and shipping.\n\nThe first lesson is about interdependence. In a globalised economy, what happens in a narrow waterway between Iran and Oman affects petrol prices in Bangkok, food costs in Nairobi, and factory output in Stuttgart. We are all connected — and the connections are often invisible until something goes wrong. Most people filling their cars with petrol have no idea that their fuel passed through a 54-kilometre-wide strait on the other side of the world.\n\nThe second lesson is about the energy transition. The Hormuz crisis has strengthened the argument for renewable energy — not just because of climate change, but because of energy security. Countries that generate electricity from solar, wind, and nuclear power are not affected by the closure of an oil shipping lane. The countries most hurt by the Hormuz crisis are those most dependent on imported fossil fuels. Moving to domestic renewable energy reduces vulnerability to geopolitical disruption.\n\nThe third lesson is about the fragility of systems we take for granted. Global trade, energy supplies, food systems, and financial markets all depend on infrastructure, agreements, and relationships that most people never think about. The Strait of Hormuz was open for decades, and everyone assumed it always would be. The same assumption applies to undersea internet cables, GPS satellites, semiconductor supply chains, and countless other systems that modern life depends on. The Hormuz crisis is a reminder that assumptions about stability can be shattered overnight.\n\nThe strait will eventually reopen — in some form, on some terms. But the world it reopens into will be different from the one that existed before it closed. The illusion that global trade flows are permanent and untouchable has been permanently broken.`,
    vocab: [
      { word: 'Interdependence', definition: 'When countries, systems, or people depend on each other — mutual reliance.' },
      { word: 'Energy transition', definition: 'The global shift from fossil fuels to renewable energy sources like solar and wind.' },
      { word: 'Fragility', definition: 'The quality of being easily broken or damaged — weakness and vulnerability.' },
      { word: 'Illusion', definition: 'A false belief or impression — something that seems real but is not.' },
    ],
    questions: [
      { n: 10, q: 'The passage says most people have no idea their fuel passed through a 54km strait. Does knowing this change how you think about global trade?' },
      { n: 11, q: 'Countries using renewable energy are not affected by oil shipping disruptions. Is energy security a stronger argument for renewables than climate change?' },
      { n: 12, q: 'What other systems do we take for granted that could be disrupted overnight? How should societies prepare for this kind of shock?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Strait of Hormuz Crisis</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Iran and Oman reached a deal on shipping through the world most important waterway. Why one narrow strait controls 25% of global oil and what happens when it closes.</p>
            </div>
          </div>
