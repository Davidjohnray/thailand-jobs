...
const PARTS = [
  {
    number: 1, title: 'The Missing Moon', emoji: '❓', color: '#dc2626',
    text: `Venus is the most Earth-like planet in our solar system — similar in size, mass, and composition. Yet it has no moon. Earth has one. Mars has two. Even Pluto has five. Venus, spinning alone in the inner solar system, has none.\n\nThis has puzzled planetary scientists for decades. A new study published this week offers a dramatic explanation: Venus may once have had a moon — and it swallowed it.\n\nThe research, based on computer simulations of the early solar system, proposes that a massive collision — similar to the one believed to have created Earth Moon — knocked debris into orbit around Venus approximately 4 billion years ago. This debris coalesced into a moon that orbited Venus for hundreds of millions of years.\n\nBut unlike Earth Moon, which is slowly moving away from us, Venus moon spiralled inward — drawn closer and closer by tidal forces until it crashed into the planet surface. The collision would have been catastrophic — releasing enough energy to melt the planet surface and potentially contributing to the runaway greenhouse effect that makes Venus the hottest planet in the solar system today.\n\nThe theory is not proven. But it elegantly explains several Venus mysteries: why it has no moon, why it rotates backwards (the collision could have reversed its spin), and why its surface appears to have been completely resurfaced relatively recently in geological terms.`,
    vocab: [
      { word: 'Coalesced', definition: 'Came together to form a single mass — separate pieces merging into one.' },
      { word: 'Tidal forces', definition: 'Gravitational pull that causes objects to stretch, deform, or change orbit over time.' },
      { word: 'Runaway greenhouse effect', definition: 'When heat-trapping gases cause temperatures to rise uncontrollably — a feedback loop of warming.' },
      { word: 'Resurfaced', definition: 'The surface was completely remade — volcanic activity or impacts replaced the old surface with new material.' },
    ],
    questions: [
      { n: 1, q: 'Venus may have swallowed its own moon. What does this tell us about the violence of planetary history?' },
      { n: 2, q: 'The moon spiralled inward instead of outward. Why does direction matter in orbital mechanics?' },
      { n: 3, q: 'The collision may explain why Venus rotates backwards. How can one event billions of years ago explain what we see today?' },
    ]
  },
  {
    number: 2, title: 'Earth Evil Twin', emoji: '👯', color: '#b91c1c',
    text: `Venus is sometimes called Earth "evil twin" — and the comparison reveals how small differences in planetary history can produce radically different outcomes.\n\nBoth planets formed at approximately the same time, from the same materials, in the same region of the solar system. They are nearly the same size — Venus diameter is 95% of Earth. Their masses are similar. Their compositions are similar. If you were designing planets from a blueprint, you might expect them to turn out the same.\n\nBut they could not be more different. Earth has liquid water, a breathable atmosphere, moderate temperatures, and abundant life. Venus has a surface temperature of 465 degrees Celsius (hot enough to melt lead), an atmosphere of carbon dioxide 90 times denser than Earth, clouds of sulphuric acid, and no liquid water anywhere on its surface.\n\nWhat went wrong? The leading theory involves a runaway greenhouse effect. Early Venus may have had oceans — computer models suggest it could have maintained liquid water for up to 2 billion years. But at some point, warming caused by increasing carbon dioxide triggered a feedback loop: higher temperatures evaporated water, water vapour trapped more heat, temperatures rose further, more water evaporated, until the oceans were gone and the atmosphere became the crushing, superheated blanket we see today.\n\nThe moon-swallowing theory adds another dimension. If a catastrophic collision melted Venus surface and released enormous amounts of carbon dioxide from the rock, it could have initiated or accelerated the greenhouse runaway — turning a potentially habitable world into the hellscape next door.`,
    vocab: [
      { word: 'Blueprint', definition: 'A detailed plan or design — the template from which something is built.' },
      { word: 'Sulphuric acid', definition: 'A highly corrosive chemical — the clouds of Venus are made of this extremely dangerous substance.' },
      { word: 'Feedback loop', definition: 'A cycle where the output reinforces the input — each step makes the next step stronger.' },
      { word: 'Habitable', definition: 'Suitable for life — having conditions that living things can survive in.' },
    ],
    questions: [
      { n: 4, q: 'Earth and Venus started nearly identical but ended completely different. What does this tell us about how small changes produce huge outcomes?' },
      { n: 5, q: 'Venus may have had oceans for 2 billion years. What happened to them? Could Earth face the same fate?' },
      { n: 6, q: 'Venus is called Earth evil twin. If you could visit for one hour (safely), what would you want to see?' },
    ]
  },
  {
    number: 3, title: 'Why Moons Matter', emoji: '🌙', color: '#991b1b',
    text: `The Venus moon theory raises an intriguing question: does Earth owe its habitability partly to having the right kind of moon?\n\nEarth Moon — formed when a Mars-sized body crashed into the early Earth approximately 4.5 billion years ago — does far more than light up the night sky. It stabilises Earth axial tilt, keeping seasons relatively consistent over millions of years. Without the Moon, Earth axis would wobble chaotically, producing extreme climate swings that could make complex life impossible.\n\nThe Moon also drives ocean tides, which create the intertidal zones — the boundary between sea and land — that many biologists believe played a crucial role in the evolution of life from water to land. And the energy from tidal friction between the Earth and Moon slows Earth rotation, giving us longer days — which may have influenced the evolution of photosynthesis.\n\nIf Venus moon spiralled inward instead of outward, Venus lost all of these stabilising effects. Without tidal stabilisation, Venus axis could have wobbled erratically. Without a moon to slow its rotation, Venus should spin faster — but instead it rotates extremely slowly and backwards, which the collision theory might explain.\n\nThe implication is remarkable: the difference between a habitable world and a hellscape may depend partly on whether your moon goes the right way. Earth Moon moved outward, stabilising the planet and enabling life. Venus moon moved inward, destroyed itself, and may have contributed to making the planet uninhabitable. Same physics. Different direction. Opposite outcomes.`,
    vocab: [
      { word: 'Axial tilt', definition: 'The angle at which a planet axis is tilted relative to its orbit — this creates seasons.' },
      { word: 'Intertidal zones', definition: 'The areas of coastline that are underwater at high tide and exposed at low tide.' },
      { word: 'Photosynthesis', definition: 'The process by which plants convert sunlight into energy — the basis of most life on Earth.' },
      { word: 'Erratically', definition: 'In an unpredictable, irregular way — without pattern or consistency.' },
    ],
    questions: [
      { n: 7, q: 'Earth Moon stabilises our climate and drives tides. Do we owe our existence partly to having the right moon?' },
      { n: 8, q: 'Same physics, different direction, opposite outcomes. What does this tell us about how chance shapes the universe?' },
      { n: 9, q: 'Without the Moon, Earth seasons would be chaotic. How would unpredictable seasons affect civilisation?' },
    ]
  },
  {
    number: 4, title: 'What Venus Teaches Earth', emoji: '🌍', color: '#7f1d1d',
    text: `The study of Venus is not just planetary science — it is a cautionary tale for Earth.\n\nVenus shows us what happens when a greenhouse effect runs out of control. The physics that turned Venus into a 465-degree oven are the same physics that are warming Earth right now — carbon dioxide trapping heat in the atmosphere. The scale is different (Earth warming is measured in degrees, not hundreds of degrees) and the mechanisms differ (Earth warming is caused by burning fossil fuels, not volcanic catastrophe). But the underlying principle is identical: more carbon dioxide means more heat.\n\nNo serious scientist believes Earth will become Venus. Our planet is further from the Sun, has less volcanic activity, and has mechanisms — particularly the carbon cycle and the oceans — that regulate atmospheric carbon dioxide. But Venus demonstrates that these mechanisms have limits. Push them too far, and the system can tip into a new, irreversible state.\n\nThe Venus moon theory adds a philosophical dimension. Our planet habitability may depend on factors that were determined billions of years ago by random events — a collision that created the Moon, an orbit at just the right distance from the Sun, a magnetic field generated by a molten iron core. We did not earn these conditions. We inherited them. And the question of whether we will preserve them — or squander them — is the most important question our species faces.\n\nVenus once had oceans. It may have had a moon. It may even have had conditions suitable for life. Now it is a scorched, crushing, acid-soaked wasteland. The universe does not guarantee that habitable planets stay habitable. That is our responsibility — and ours alone.`,
    vocab: [
      { word: 'Cautionary tale', definition: 'A story that serves as a warning — showing what can go wrong.' },
      { word: 'Irreversible', definition: 'Cannot be undone — a change that is permanent once it happens.' },
      { word: 'Squander', definition: 'To waste something valuable through carelessness — throwing away what you were given.' },
      { word: 'Wasteland', definition: 'A barren, empty landscape where nothing can survive — a destroyed environment.' },
    ],
    questions: [
      { n: 10, q: 'Venus shows what happens when greenhouse effects run out of control. Is Earth at risk of a similar fate?' },
      { n: 11, q: 'We inherited a habitable planet through random cosmic events. Does this change how you think about environmental responsibility?' },
      { n: 12, q: 'Venus may have once had oceans and possibly life. Now it is a wasteland. What is the most important lesson Venus teaches Earth?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Venus May Have Swallowed Its Own Moon". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function VenusMoonPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Venus May Have Swallowed Its Own Moon</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>New research suggests Venus once had a moon that spiralled inward and was swallowed by the planet. The violent history of our solar system and why Venus became Earth evil twin.</p>
            </div>
          </div>
