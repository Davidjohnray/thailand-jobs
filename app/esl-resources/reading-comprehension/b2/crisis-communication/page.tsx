...
const PARTS = [
  {
    number: 1, title: 'Why Delivering Bad News Is So Difficult', emoji: '😰', color: '#f59e0b',
    text: `Every professional will, at some point in their career, need to deliver bad news. This could mean telling a colleague that their project has been cancelled, informing a team that redundancies are coming, explaining to a client that a deadline has been missed, or telling an employee that their performance is not meeting expectations. Despite how common these situations are, most people find them extremely uncomfortable — and handle them poorly as a result.\n\nThe discomfort comes from several sources. Most people naturally want to be liked and respected, and delivering bad news risks damaging relationships and reputation. There is also a tendency to blame the messenger — the person who delivers bad news often receives some of the negative emotion that the news itself generates. Additionally, many professionals simply have not been trained in this skill, which means they develop bad habits: avoiding the conversation altogether, softening the message so much it loses clarity, or over-explaining in a way that comes across as defensive.\n\nResearch in organisational psychology suggests that the way bad news is delivered has a significant impact on how it is received. The same piece of information — for example, that a person's role is being made redundant — can be communicated in a way that feels respectful and honest, or in a way that feels cold, cowardly, or disrespectful. The outcome for the organisation can be very different depending on which approach is taken.\n\nDeveloping the language and strategies to deliver bad news well is therefore not just a communication skill — it is a leadership skill that affects trust, morale, and the long-term culture of an organisation.`,
    vocab: [
      { word: 'Redundancy', definition: 'The situation where an employee\'s job is eliminated, usually for business reasons.' },
      { word: 'Messenger', definition: 'The person who delivers a message — sometimes blamed for the content of bad news.' },
      { word: 'Defensive', definition: 'Behaving as if you are protecting yourself from criticism or blame.' },
      { word: 'Morale', definition: 'The level of confidence, enthusiasm, and satisfaction within a group or team.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever had to deliver bad news at work or in your personal life? How did you handle it?' },
      { n: 2, q: 'Why do you think people tend to avoid difficult conversations rather than having them directly?' },
      { n: 3, q: 'Can you think of a time when bad news was delivered to you in a way that felt respectful? What made the difference?' },
    ]
  },
  {
    number: 2, title: 'Common Mistakes and What to Avoid', emoji: '⚠️', color: '#d97706',
    text: `The most common mistake when delivering bad news is delay. Many managers and professionals postpone difficult conversations for days, weeks, or even months, hoping the situation will somehow resolve itself or that they will find the right moment. In most cases, delay makes things worse. The person who needs to hear the news continues to operate on false assumptions, and when they do eventually learn the truth, they often feel doubly betrayed — both by the news itself and by the fact that it was hidden from them.\n\nAnother frequent mistake is what communication experts call "burying the lede" — placing the key information at the end of a long, winding explanation, usually in an attempt to soften the impact. This approach often backfires. The recipient senses that something is wrong from the very beginning, spends the entire conversation in a state of anxiety waiting for the bad news, and may actually feel relieved once it is finally delivered — only to then feel manipulated by the roundabout approach.\n\nThe opposite problem is being too blunt. Delivering bad news without empathy or context — for example, simply saying "your contract won't be renewed" and ending the conversation — leaves people feeling dismissed and disrespected. Even when the news is unavoidable, people need to feel that the person delivering it understands the impact on them and takes it seriously.\n\nFinally, many people try to end difficult conversations on a forced positive note. Phrases like "but look on the bright side" or "I'm sure something better will come along" can feel trivialising and insincere when someone has just received genuinely difficult news. Acknowledging that the news is hard — and allowing the person to feel that — is often more respectful than rushing to reassure.`,
    vocab: [
      { word: 'Burying the lede', definition: 'Hiding the most important information at the end, rather than stating it clearly upfront.' },
      { word: 'Backfire', definition: 'To have the opposite effect to what was intended, making things worse.' },
      { word: 'Empathy', definition: 'The ability to understand and share the feelings of another person.' },
      { word: 'Trivialising', definition: 'Making something seem less serious or important than it really is.' },
    ],
    questions: [
      { n: 4, q: 'Have you ever experienced someone "burying the lede" — hiding the key point until the very end? How did it feel?' },
      { n: 5, q: 'Why do you think managers often delay having difficult conversations? What are the consequences?' },
      { n: 6, q: 'Is it ever appropriate to try to end a difficult conversation on a positive note? When, and when not?' },
    ]
  },
  {
    number: 3, title: 'A Framework for Delivering Bad News', emoji: '📋', color: '#b45309',
    text: `Communication professionals and management trainers have developed several frameworks for delivering bad news effectively. While no single approach works in every situation, most successful frameworks share a number of common principles.\n\nThe first principle is to be direct and timely. Do not delay beyond what is necessary to gather the facts and choose the right setting. Deliver the news in a private, face-to-face conversation wherever possible — not by email, text message, or in a group setting. Begin the conversation clearly, so the recipient understands within the first few sentences that difficult news is coming, rather than being kept in suspense.\n\nThe second principle is to separate fact from judgement. When explaining why the bad news has occurred, stick to the facts of the situation and avoid language that places blame unnecessarily. "The company has decided to restructure this department" is factual; "your team has underperformed" is a judgement and will provoke a defensive response.\n\nThe third principle is to give space for the emotional response. After delivering the key information, stop talking. Many people fill silences with more explanation, which can come across as defensive or dismissive. Allow the person to process what they have heard, express their reaction, and ask questions. Listen carefully and acknowledge what they say before responding.\n\nFinally, be clear about next steps. Ambiguity about what happens next increases anxiety. Even if all the details are not yet known, explain what will happen, when it will happen, and who they should contact if they have further questions. This gives the person a sense of structure and demonstrates that they are being treated with respect.`,
    vocab: [
      { word: 'Framework', definition: 'A structured plan or set of principles used as a guide for doing something.' },
      { word: 'Restructure', definition: 'To reorganise a company or department, often resulting in job changes or losses.' },
      { word: 'Provoke', definition: 'To cause a strong reaction, especially a negative or emotional one.' },
      { word: 'Ambiguity', definition: 'Uncertainty or vagueness — when something can be understood in more than one way.' },
    ],
    questions: [
      { n: 7, q: 'Which of the four principles do you think is most important? Why?' },
      { n: 8, q: 'Why is it important to separate facts from judgements when delivering bad news?' },
      { n: 9, q: 'Why do you think people fill silences with extra talking when they feel uncomfortable? Is this effective?' },
    ]
  },
  {
    number: 4, title: 'Crisis Communication at the Organisational Level', emoji: '🏢', color: '#92400e',
    text: `When bad news affects not just one person but an entire organisation — a data breach, a product failure, a financial crisis, or a public scandal — the stakes of communication become significantly higher. Organisational crisis communication is a specialist field, but the core principles remain the same: be honest, be timely, be direct, and take responsibility.\n\nOne of the most studied examples of good crisis communication is the Johnson & Johnson Tylenol recall of 1982. When it was discovered that some bottles of Tylenol had been poisoned — causing several deaths — the company immediately recalled all products nationwide, communicated transparently with the public, and worked closely with authorities. The response was praised as a model of responsible corporate behaviour and Johnson & Johnson recovered its market position relatively quickly.\n\nIn contrast, poor crisis communication — particularly when organisations attempt to conceal or minimise a problem — almost always makes things worse. When the truth eventually emerges, the cover-up becomes the bigger story. The Volkswagen emissions scandal of 2015 is a well-known example: the company initially denied wrongdoing, and when the full extent of the deception was revealed, the damage to trust and reputation was far greater than if the company had been transparent from the beginning.\n\nFor individuals at every level of an organisation, the lesson is the same. Whether you are a manager telling one employee that their role no longer exists, or a CEO addressing thousands of stakeholders during a corporate crisis, the foundation of effective communication remains honesty, clarity, and respect for the people receiving the news.`,
    vocab: [
      { word: 'Data breach', definition: 'An incident where private or confidential information is accessed without authorisation.' },
      { word: 'Transparent', definition: 'Open, honest, and easy to understand — not hiding important information.' },
      { word: 'Conceal', definition: 'To hide something deliberately, especially information that should be known.' },
      { word: 'Stakeholder', definition: 'Anyone with an interest or involvement in an organisation — employees, customers, investors.' },
    ],
    questions: [
      { n: 10, q: 'Why do you think companies often try to hide or minimise bad news rather than being transparent?' },
      { n: 11, q: 'Can you think of an example of a company or organisation that handled a crisis well or badly? What happened?' },
      { n: 12, q: 'Do you think honesty in business communication is always the best policy, even when it is damaging? Why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a professional Business English conversation coach helping a B2 level student practise English discussion skills. The reading topic is "Crisis Communication — Delivering Bad News at Work". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use natural, professional B2-level English. Always end with one thoughtful follow-up question to extend the discussion. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the end. Be encouraging and professional.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Crisis Communication — Delivering Bad News at Work</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Redundancies, project failures, corporate scandals — the language and strategies professionals need when things go wrong.</p>
            </div>
          </div>
