...
const PARTS = [
  {
    number: 1, title: 'The Rise of Remote Work', emoji: '🏠', color: '#f59e0b',
    text: `Remote work — the practice of doing your job from outside a traditional office — has become one of the most significant workplace shifts of the twenty-first century. While working from home was already growing before 2020, the global pandemic accelerated this change dramatically. Millions of office workers around the world were suddenly required to work from home, and many companies discovered that their employees could remain productive outside the office.\n\nBefore the pandemic, remote work was seen by many organisations as a privilege reserved for senior employees or as an occasional flexibility — something you might do once a week, not every day. The technology existed to support it — video calls, cloud storage, and collaboration tools had been available for years — but the culture and mindset had not caught up. Managers often felt that visibility in the office was a sign of commitment and hard work.\n\nThe forced experiment of the pandemic changed these assumptions. Companies that had resisted remote work for years found themselves managing fully distributed teams with varying degrees of success. Some thrived; others struggled. But the experience demonstrated that remote work was viable at a scale nobody had previously imagined.\n\nToday, the debate is no longer whether remote work is possible, but how to do it well. Many companies now offer hybrid arrangements — a combination of office and home working — as the standard model. Understanding the language, challenges, and best practices of remote work has become an essential professional skill.`,
    vocab: [
      { word: 'Distributed', definition: 'Spread across different locations, rather than gathered in one place.' },
      { word: 'Hybrid', definition: 'A combination of two things — in work, a mix of office and remote working.' },
      { word: 'Viable', definition: 'Capable of working successfully; practical and achievable.' },
      { word: 'Visibility', definition: 'How easily someone or something can be seen — in work, being noticed by managers.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever worked or studied remotely? What were the advantages and disadvantages?' },
      { n: 2, q: 'Why do you think some managers prefer employees to be in the office, even when remote work is possible?' },
      { n: 3, q: 'Do you think the pandemic permanently changed attitudes towards remote work? How?' },
    ]
  },
  {
    number: 2, title: 'Communication Challenges and Solutions', emoji: '💬', color: '#d97706',
    text: `One of the biggest challenges of remote work is communication. In a traditional office, information flows naturally through informal conversations — a quick question at someone's desk, an overheard discussion in the corridor, or a spontaneous meeting in the kitchen. When teams work remotely, these informal channels disappear, and communication requires much more deliberate effort.\n\nAsynchronous communication — messages, emails, and documents that do not require an immediate response — becomes the primary way teams exchange information. This can be efficient, as people can respond when it suits them, but it also creates risks. Tone is harder to read in written messages, and misunderstandings are more common. A comment that would sound perfectly normal in person can seem cold or critical in an email.\n\nOver-reliance on video calls is another common problem. Some companies replace every informal conversation with a video meeting, leading to what many people call "Zoom fatigue" — the exhaustion that comes from spending too many hours on camera. Research suggests that video calls require more mental effort than face-to-face communication, partly because people have to consciously maintain eye contact and process visual information that would normally happen automatically.\n\nThe most effective remote teams tend to establish clear communication norms. They agree on which tool to use for which type of message — for example, instant messaging for quick questions, email for formal communication, and video calls for complex discussions or relationship building. They also create regular check-ins and structured opportunities for team members to connect, which helps prevent the isolation that remote workers often report.`,
    vocab: [
      { word: 'Asynchronous', definition: 'Not happening at the same time — messages sent and read at different times.' },
      { word: 'Spontaneous', definition: 'Happening naturally without being planned in advance.' },
      { word: 'Deliberate', definition: 'Done consciously and intentionally, not by accident or habit.' },
      { word: 'Norms', definition: 'Accepted standards of behaviour that are typical in a group or organisation.' },
    ],
    questions: [
      { n: 4, q: 'Have you ever experienced a misunderstanding in a written message? What happened and how was it resolved?' },
      { n: 5, q: 'Do you prefer synchronous (real-time) or asynchronous (delayed) communication at work or school? Why?' },
      { n: 6, q: 'What communication rules would you set if you were managing a remote team?' },
    ]
  },
  {
    number: 3, title: 'Productivity, Trust and Wellbeing', emoji: '⚖️', color: '#b45309',
    text: `A persistent concern among managers is whether remote employees are as productive as those in the office. Studies on this question have produced mixed results. Some research suggests that remote workers are actually more productive than office workers, partly because they have fewer interruptions and no commute. Others find that productivity depends heavily on the individual, the type of work, and the home environment.\n\nThe issue of trust is closely connected to productivity. Some managers find it difficult to trust employees they cannot see. This can lead to micromanagement — closely monitoring every task and requiring frequent check-ins — which can damage morale and actually reduce productivity. The most successful remote-working cultures are built on output rather than presence: employees are evaluated on what they achieve, not on how many hours they appear to be online.\n\nWellbeing is another critical factor. Remote work removes the social interaction that many people value about their jobs. Without the daily contact with colleagues, some remote workers report feeling isolated, disconnected from their team, and uncertain about their place in the organisation. The boundary between work and personal life can also become blurred when the office is at home, leading to longer working hours and difficulty switching off.\n\nOrganisations that manage remote work well invest in regular social events, mental health support, and clear policies about working hours and availability. They recognise that an employee who is happy and healthy will ultimately perform better than one who is productive in the short term but burning out.`,
    vocab: [
      { word: 'Micromanagement', definition: 'Controlling every small detail of someone\'s work, leaving them little independence.' },
      { word: 'Morale', definition: 'The level of confidence, enthusiasm, and satisfaction in a group of people.' },
      { word: 'Blurred', definition: 'Made unclear or less distinct — when two things become mixed together.' },
      { word: 'Burnout', definition: 'A state of physical and emotional exhaustion caused by long-term overwork or stress.' },
    ],
    questions: [
      { n: 7, q: 'Do you think you are more or less productive when working from home compared to an office or school? Why?' },
      { n: 8, q: 'How would you feel if your manager closely monitored your activity while you worked remotely? Is this reasonable?' },
      { n: 9, q: 'What strategies would you use to maintain a healthy work-life balance when working from home?' },
    ]
  },
  {
    number: 4, title: 'The Future of Work', emoji: '🔮', color: '#92400e',
    text: `The debate about remote work is not simply about where people sit — it reflects deeper questions about the nature of work, management, and organisational culture. As companies decide how to structure their workplaces in the coming years, they are grappling with fundamental tensions between flexibility and collaboration, autonomy and accountability, and individual preference and business need.\n\nSome companies — particularly in the technology sector — have embraced fully remote models. They hire the best talent regardless of location and argue that this gives them a competitive advantage. Other organisations, especially those in finance, law, and manufacturing, have pushed strongly for a return to the office, arguing that collaboration, mentoring, and company culture suffer when people are not physically together.\n\nThe employees most affected by these decisions are often those earlier in their careers. Junior employees tend to benefit greatly from being in the office — they learn by observation, build relationships through informal contact, and receive feedback more naturally. Senior employees, who already have established networks and deep expertise, may lose less from working remotely.\n\nLooking ahead, technology will continue to shape the remote work landscape. Improvements in virtual reality and AI tools may make remote collaboration feel more natural and less isolating. However, most experts agree that human connection — the kind that comes from sharing a physical space — will remain valuable and irreplaceable in many contexts. The companies that thrive will be those that find the right balance for their specific culture, industry, and people.`,
    vocab: [
      { word: 'Autonomy', definition: 'The freedom to make your own decisions and work independently.' },
      { word: 'Accountability', definition: 'Being responsible for your actions and results, and accepting consequences.' },
      { word: 'Mentoring', definition: 'Guiding and supporting a less experienced person in their career or skills.' },
      { word: 'Irreplaceable', definition: 'So valuable or unique that it cannot be substituted or done without.' },
    ],
    questions: [
      { n: 10, q: 'Do you think fully remote companies have an advantage over office-based ones? In what ways?' },
      { n: 11, q: 'If you were starting a new job, would you prefer to work in an office, remotely, or hybrid? Why?' },
      { n: 12, q: 'What aspects of human connection at work do you think technology will never be able to replace?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a professional Business English conversation coach helping a B2 level student practise English discussion skills. The reading topic is "Remote Work and the Future of Work". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use natural, professional B2-level English. Always end with one thoughtful follow-up question to extend the discussion. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the end. Be encouraging and professional.`
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && (
                  <div style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}>
...
export default function RemoteWorkPage() {
  ...
  const handleLookup = async (text: string) => {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ system: isPhrase ? `You are an English dictionary for B2 business learners. Respond with ONLY one sentence (max 20 words) explaining what the phrase means in a professional context. No extra text.` : `You are an English dictionary for B2 business learners. Respond with ONLY one sentence (max 15 words) defining this word simply. No extra text.`, messages: [{ role: 'user', content: isPhrase ? `What does "${text}" mean?` : `Define: "${text}"` }] }) })
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1c1007 0%, #78350f 50%, #92400e 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#f59e0b', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B2 Upper Intermediate</span>
                <span style={{ background: 'rgba(245,158,11,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Business English</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Remote Work and the Future of Work</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From pandemic necessity to permanent strategy — explore the opportunities, challenges, and hard questions raised by the remote work revolution.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#f59e0b', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
          ...
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#fffbeb', padding: '8px 28px', borderBottom: '1px solid #fde68a' }}>
              <span style={{ color: '#92400e', fontSize: '12px', fontWeight: '600' }}>
                ...
                {translationLang !== 'none' && <span style={{ color: '#d97706' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
                    ...
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && (
                          <div style={{ marginTop: '6px', background: '#fffbeb', border: '1px solid #fde68a', borderRadius: '8px', padding: '8px 12px' }}>
                            <span style={{ color: '#92400e', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
            ...
            <div style={{ background: '#1a1a2e', padding: '20px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                ...
                <span style={{ color: '#fcd34d', fontWeight: 'bold', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>Discussion Questions</span>
              </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && (
                          <div style={{ marginTop: '8px', background: 'rgba(245,158,11,0.15)', border: '1px solid rgba(245,158,11,0.3)', borderRadius: '10px', padding: '10px 14px' }}>
                            <span style={{ color: '#fcd34d', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#f59e0b', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fde68a', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#fffbeb', color: '#92400e', border: '2px solid #fde68a', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fffbeb', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fde68a', color: '#9ca3af', fontSize: '15px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#fffbeb', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fcd34d' }}>
                    <div style={{ color: '#d97706', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>{currentLang?.label} Translation</div>
