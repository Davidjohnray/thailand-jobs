...
const PARTS = [
  {
    number: 1, title: 'Fighting Fire with Technology', emoji: '🛰️', color: '#dc2626',
    text: `This week, Greece tested a new satellite-based wildfire detection system that could change how countries fight one of the deadliest consequences of climate change. The system uses artificial intelligence to analyse satellite images in near-real-time, detecting fires within minutes of ignition — far faster than traditional methods that rely on human observers, phone calls from the public, or smoke being visible from fire stations.\n\nGreece has been devastated by wildfires in recent years. In 2023, the country experienced its largest recorded wildfire — a blaze that burned for 17 days, destroyed more than 93,000 hectares of land (an area larger than the city of Berlin), and killed at least 28 people. In 2018, a fire in the seaside town of Mati killed 104 people in just a few hours. Every summer, Greek firefighters face an increasingly desperate battle against fires that are becoming more frequent, more intense, and harder to control.\n\nThe new system works by combining satellite imagery with AI algorithms that can distinguish between normal heat signatures — like sunlight on a rooftop or a legitimate campfire — and the specific patterns associated with an uncontrolled fire. When the AI identifies a potential fire, it automatically alerts emergency services with the exact location and estimated size of the blaze.\n\nThe speed advantage is significant. Traditional fire detection in rural areas can take 30 minutes to an hour — and in that time, a fire in dry, windy conditions can grow from a manageable spot fire to an unstoppable inferno. The satellite system aims to reduce detection time to less than five minutes, giving firefighters a crucial head start.`,
    vocab: [
      { word: 'Ignition', definition: 'The moment something catches fire — the very start of a fire.' },
      { word: 'Near-real-time', definition: 'Almost immediately — with only a very short delay between an event happening and it being detected.' },
      { word: 'Heat signatures', definition: 'Patterns of heat that can be detected by sensors — different objects produce different heat patterns.' },
      { word: 'Inferno', definition: 'A very large, dangerous, out-of-control fire — an extremely intense blaze.' },
    ],
    questions: [
      { n: 1, q: 'AI can now detect wildfires from satellite images within minutes. How could this technology save lives compared to traditional detection methods?' },
      { n: 2, q: 'Greece lost 93,000 hectares in one fire in 2023. For context, that is larger than Berlin. How do you visualise destruction on this scale?' },
      { n: 3, q: 'The system aims to reduce detection time from 30 minutes to 5 minutes. Why are those 25 minutes so critical in fighting a wildfire?' },
    ]
  },
  {
    number: 2, title: 'The Mediterranean Fire Crisis', emoji: '🔥', color: '#b91c1c',
    text: `Greece is not alone. The entire Mediterranean region — southern Europe, North Africa, and the Middle East — is experiencing a wildfire crisis that scientists say is directly linked to climate change.\n\nThe Mediterranean climate, characterised by hot, dry summers and mild, wet winters, has always been fire-prone. But rising temperatures are extending the fire season, reducing soil moisture, and creating conditions in which fires burn hotter and spread faster than ever before. The European Forest Fire Information System reported that the area burned by wildfires in Europe in 2023 was 50% above the 20-year average.\n\nPortugal, Spain, Italy, Turkey, and Algeria have all experienced devastating fire seasons in recent years. In 2017, fires in Portugal killed more than 100 people. In 2021, Turkey experienced its worst fires on record, with flames reaching the outskirts of tourist resorts and forcing evacuations. In 2023, fires in Algeria killed more than 30 people.\n\nThe causes are interconnected. Climate change makes the landscape drier and more flammable. Urban sprawl pushes communities into fire-prone areas. Agricultural abandonment — the trend of people leaving rural areas and moving to cities — means that land that was once actively managed is now covered in dry, untended vegetation that acts as fuel. And in some cases, arson plays a role — deliberately set fires account for a significant proportion of European wildfires.\n\nThe economic costs are staggering. The EU spent more than 4 billion euros on wildfire suppression in 2023 alone. The indirect costs — damaged property, lost tourism revenue, health effects from smoke, environmental destruction — are many times higher.`,
    vocab: [
      { word: 'Fire-prone', definition: 'An area that is likely to experience fires — naturally at risk of burning.' },
      { word: 'Flammable', definition: 'Easy to set on fire — burns quickly and intensely.' },
      { word: 'Agricultural abandonment', definition: 'When farmers leave rural land and it becomes unmanaged — often growing into dense, fire-prone vegetation.' },
      { word: 'Arson', definition: 'The crime of deliberately setting fire to property — starting a fire on purpose.' },
    ],
    questions: [
      { n: 4, q: 'Wildfires in Europe are 50% worse than the 20-year average. What is driving this increase beyond just higher temperatures?' },
      { n: 5, q: 'When people leave rural areas, the abandoned land becomes fire-prone. How does urbanisation indirectly cause wildfires?' },
      { n: 6, q: 'The EU spent 4 billion euros on fire suppression in one year. Should this money be spent on prevention instead? What would prevention look like?' },
    ]
  },
  {
    number: 3, title: 'Technology as a Force Multiplier', emoji: '💻', color: '#991b1b',
    text: `Greece is not the only country exploring technological solutions to the wildfire crisis. Around the world, a new generation of tools is transforming how fires are detected, monitored, and fought.\n\nDrones are increasingly used for aerial surveillance of fire-prone areas, carrying thermal cameras that can detect hot spots invisible to the human eye. In California, the utility company PG&E operates a network of more than 1,400 cameras positioned on hilltops and towers, monitored by AI systems that scan for smoke 24 hours a day. Australia has developed predictive models that use weather data, vegetation maps, and historical fire patterns to identify areas at highest risk before fires start.\n\nOnce a fire is detected, technology helps firefighters respond more effectively. Real-time wind and weather data, combined with terrain mapping and fire behaviour models, allow commanders to predict how a fire will spread and position resources accordingly. Aircraft equipped with infrared cameras can see through smoke to map the fire perimeter accurately. Communication systems ensure that ground crews, aircraft, and command centres can coordinate in real time.\n\nArtificial intelligence is the thread that connects all of these technologies. AI can process vast amounts of satellite, weather, and sensor data simultaneously — far more than any human team could analyse. It can identify patterns, make predictions, and generate recommendations in seconds. In the context of wildfire, where minutes can determine whether a fire is contained or becomes catastrophic, this speed is transformative.\n\nBut technology is not a substitute for the fundamental changes needed to address the wildfire crisis. Better detection and response save lives and reduce damage — but they do not prevent fires from starting. For that, the world needs to address climate change, improve land management, and rethink how and where communities are built.`,
    vocab: [
      { word: 'Force multiplier', definition: 'Something that dramatically increases effectiveness — making existing resources much more powerful.' },
      { word: 'Thermal cameras', definition: 'Cameras that detect heat rather than visible light — they can see hot objects in darkness or through smoke.' },
      { word: 'Predictive models', definition: 'Computer programmes that use data to forecast what will happen in the future.' },
      { word: 'Perimeter', definition: 'The outer edge or boundary of an area — in firefighting, the outer edge of the fire.' },
    ],
    questions: [
      { n: 7, q: 'AI cameras in California scan for smoke 24 hours a day. Is this a better system than relying on humans to report fires? What are the limitations?' },
      { n: 8, q: 'Technology can detect and fight fires better, but it cannot prevent them. What is more important — better response or better prevention?' },
      { n: 9, q: 'Could the technology Greece is testing be used in Thailand or other Southeast Asian countries that face fire seasons? What would need to be adapted?' },
    ]
  },
  {
    number: 4, title: 'Prevention, Adaptation, or Both?', emoji: '🌿', color: '#7f1d1d',
    text: `The Greek satellite system represents one side of the wildfire response: adaptation — using technology and better systems to live with a problem we cannot eliminate. But many experts argue that adaptation alone is insufficient without addressing the underlying cause: climate change.\n\nThe relationship between climate change and wildfires is well established. Higher temperatures dry out vegetation, creating more fuel. Reduced rainfall extends the fire season. More intense heatwaves create the conditions for fires to ignite and spread. Climate models project that the area burned by wildfires in southern Europe could increase by 40-100% by 2050 under current emissions trajectories.\n\nPrevention takes many forms. At the global level, reducing greenhouse gas emissions remains the most important intervention — but also the slowest, requiring decades of coordinated international action. At the local level, prescribed burning (deliberately setting small fires to remove dry fuel), creating firebreaks around communities, and enforcing building codes that require fire-resistant materials can all reduce risk.\n\nLand management is crucial. The indigenous peoples of Australia, North America, and other regions used fire as a land management tool for thousands of years — burning small areas strategically to prevent larger, uncontrollable fires. Modern fire management is increasingly incorporating these traditional practices, recognising that preventing all fires — as many Western countries tried to do throughout the 20th century — actually makes the problem worse by allowing fuel to accumulate.\n\nThe Greek satellite system will save lives. But the fires it detects will keep coming — more frequently, more intensely, and over a longer season — until the world addresses the climate change that is making them worse. Technology buys time. It does not solve the problem.`,
    vocab: [
      { word: 'Emissions trajectories', definition: 'The projected path of greenhouse gas output over time — how much pollution we expect to produce.' },
      { word: 'Prescribed burning', definition: 'Deliberately setting controlled fires to remove dry vegetation and reduce the risk of larger wildfires.' },
      { word: 'Firebreaks', definition: 'Gaps in vegetation created deliberately to stop or slow the spread of fire.' },
      { word: 'Incorporating', definition: 'Including something as part of a larger system — bringing traditional knowledge into modern practice.' },
    ],
    questions: [
      { n: 10, q: 'Wildfires in southern Europe could increase by 40-100% by 2050. What would this mean for tourism, agriculture, and communities in the region?' },
      { n: 11, q: 'Indigenous peoples used prescribed burning for thousands of years. Why did modern Western countries stop doing this? What can we learn from indigenous fire management?' },
      { n: 12, q: 'The passage says technology buys time but does not solve the problem. Do you agree? Can technology ever truly solve a problem caused by human behaviour?' },
    ]
  },
]
...
export default function GreeceFiresPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Greece Uses AI Satellites to Fight Wildfires</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Greece tested a satellite system that detects wildfires within minutes using AI. The Mediterranean fire crisis, technology as a force multiplier, and why prevention still matters most.</p>
            </div>
          </div>
