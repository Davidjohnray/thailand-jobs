...
const PARTS = [
  {
    number: 1, title: 'The Diplomatic Earthquake', emoji: '⚡', color: '#dc2626',
    text: `The United Kingdom announced this week a major reset of its relationship with Israel — using language that shocked diplomats on both sides. Foreign Secretary David Lammy described Israel occupation of the West Bank as "a system of apartheid" and announced that Britain would ban all imports from Israeli settlements in occupied Palestinian territory.\n\nThe move puts the UK alongside France, Canada, and several other Western nations that have taken similar steps in recent months. But Britain decision carries particular weight because of the country historical role in the region — it was a British document, the 1917 Balfour Declaration, that first endorsed the creation of a Jewish homeland in Palestine.\n\nIsrael response was immediate and furious. The government closed the British consulate in East Jerusalem and recalled its ambassador from London for consultations. Prime Minister Netanyahu described the British action as "a reward for terrorism" and accused the UK of "capitulating to antisemitic pressure."\n\nThe diplomatic fallout is significant. The UK has been one of Israel closest allies for decades. British-Israeli intelligence cooperation, trade relations, and cultural ties have been deep and longstanding. The settlement ban — and particularly the use of the word "apartheid" — represents a rupture that will be difficult to repair.`,
    vocab: [
      { word: 'Apartheid', definition: 'A system of institutionalised racial or ethnic segregation and discrimination.' },
      { word: 'Settlements', definition: 'Communities built by Israel on land occupied during the 1967 war — considered illegal under international law.' },
      { word: 'Capitulating', definition: 'Giving in to pressure — surrendering or accepting demands you previously resisted.' },
      { word: 'Rupture', definition: 'A sudden break in a relationship — a dramatic split that is hard to fix.' },
    ],
    questions: [
      { n: 1, q: 'The UK used the word "apartheid" to describe Israel occupation. Why is this word so powerful and controversial?' },
      { n: 2, q: 'Israel closed the British consulate in response. Is this proportionate, or an overreaction?' },
      { n: 3, q: 'Britain endorsed the creation of Israel in 1917. Does this history give it a special responsibility?' },
    ]
  },
  {
    number: 2, title: 'What Are Settlements?', emoji: '🏘️', color: '#b91c1c',
    text: `To understand the settlement ban, you need to understand one of the longest-running disputes in international law.\n\nIn 1967, Israel captured the West Bank, East Jerusalem, the Gaza Strip, and the Golan Heights during the Six-Day War. Under international law — specifically the Fourth Geneva Convention — an occupying power is prohibited from transferring its own civilian population into occupied territory. Despite this, successive Israeli governments have built settlements in the West Bank and East Jerusalem, moving more than 700,000 Israeli citizens onto land that the international community considers Palestinian.\n\nThe International Court of Justice ruled in 2004 that the settlements are illegal. The United Nations General Assembly has passed dozens of resolutions condemning them. And virtually every country in the world — including, until recently, the United States — has maintained that settlements violate international law.\n\nIsrael disagrees. It argues that the West Bank is "disputed" rather than "occupied" territory, that Jewish people have historical and religious connections to the land, and that the settlements are necessary for security. Some Israeli politicians have called for the permanent annexation of the West Bank.\n\nThe settlements are not just a legal issue — they are a practical obstacle to peace. They fragment Palestinian territory, making a contiguous Palestinian state increasingly difficult to establish. Each new settlement makes the two-state solution — the framework that has guided peace negotiations for decades — less viable.`,
    vocab: [
      { word: 'Geneva Convention', definition: 'International treaties that set rules for war and occupation — protecting civilians.' },
      { word: 'Annexation', definition: 'Formally taking control of territory and declaring it part of your country.' },
      { word: 'Contiguous', definition: 'Connected and unbroken — territory that forms one continuous piece.' },
      { word: 'Two-state solution', definition: 'The proposal for Israel and Palestine to exist as two independent countries side by side.' },
    ],
    questions: [
      { n: 4, q: '700,000 Israelis live in settlements that most countries consider illegal. Why has this been allowed to continue for decades?' },
      { n: 5, q: 'Settlements fragment Palestinian territory. How does geography affect the possibility of peace?' },
      { n: 6, q: 'Israel says the land is disputed, not occupied. The rest of the world disagrees. Who decides?' },
    ]
  },
  {
    number: 3, title: 'A Shifting Consensus', emoji: '🌍', color: '#991b1b',
    text: `The UK decision reflects a broader shift in how Western countries relate to Israel — a shift accelerated dramatically by the Gaza war.\n\nFor decades, Western governments maintained a careful balance: they criticised settlements diplomatically while maintaining close economic and military ties with Israel. This approach — often described as "words without consequences" — allowed governments to express disapproval without disrupting the relationship.\n\nThe Gaza war has broken this balance. The scale of civilian casualties — more than 60,000 Palestinians killed according to health authorities — has pushed public opinion in many Western countries to a point where the old approach is no longer politically sustainable. Large-scale protests, campus movements, and electoral pressure have forced governments to take more concrete action.\n\nThe settlement ban is one such action. By restricting imports from settlements, countries create an economic cost for Israel continued occupation — making it more expensive to maintain settlements and potentially disincentivising future expansion.\n\nBut the ban also carries risks. It could push Israel further toward unilateral action — annexing the West Bank without negotiation. It could strengthen hardliners within Israeli politics who argue that the international community is biased against Israel. And it could damage relationships that Western countries need for other priorities — intelligence sharing, counter-terrorism cooperation, and regional stability.\n\nThe diplomatic landscape is changing. The question is whether these changes bring peace closer or push it further away.`,
    vocab: [
      { word: 'Consensus', definition: 'General agreement — when most people or countries share the same position.' },
      { word: 'Sustainable', definition: 'Able to continue without causing damage — maintainable over time.' },
      { word: 'Disincentivising', definition: 'Making something less attractive — creating reasons not to do it.' },
      { word: 'Hardliners', definition: 'People who hold extreme positions and refuse to compromise.' },
    ],
    questions: [
      { n: 7, q: 'The old approach was "words without consequences." Why is this no longer enough for many governments?' },
      { n: 8, q: 'Settlement bans could push Israel toward annexation. Do sanctions sometimes backfire?' },
      { n: 9, q: 'Public opinion shifted after the Gaza war. How does public pressure change government foreign policy?' },
    ]
  },
  {
    number: 4, title: 'Justice, Peace, or Both?', emoji: '⚖️', color: '#7f1d1d',
    text: `The UK settlement ban raises a question that has haunted the Israel-Palestine conflict for decades: can there be peace without justice?\n\nThose who support the ban argue that settlements are illegal, that the occupation causes immense suffering, and that ignoring these facts in the name of diplomatic convenience is not neutrality — it is complicity. Justice requires acknowledging that something wrong is happening and taking action to stop it. The ban, however limited, is a step toward that justice.\n\nThose who oppose the ban argue that isolating Israel makes peace less likely, not more. Peace requires both sides at the table, and punitive measures push Israel away from negotiation. The path to peace, they argue, runs through engagement, not confrontation.\n\nThe deeper tension is between two values that both sides claim to support. Justice demands accountability — that illegal actions have consequences. Peace demands compromise — that both sides accept outcomes they find unfair. These values are not always compatible. Insisting on full justice can make peace impossible. Accepting peace without justice can leave wounds that never heal.\n\nFor the millions of Palestinians living under occupation, justice and peace are not abstract concepts. They are daily realities — checkpoints, land confiscation, restricted movement, and the constant uncertainty of life under military control. For Israeli citizens, security and recognition are equally concrete — the fear of attack, the desire for legitimacy, and the conviction that their state has a right to exist.\n\nThe settlement ban will not resolve this conflict. Nothing this simple ever could. But it has forced the world to choose a position — and that, at least, is honest.`,
    vocab: [
      { word: 'Complicity', definition: 'Being involved in wrongdoing by failing to act — silent partnership in something wrong.' },
      { word: 'Punitive', definition: 'Designed to punish — measures intended to impose a cost for bad behaviour.' },
      { word: 'Confiscation', definition: 'Taking property away from someone by authority — seizing land or possessions.' },
      { word: 'Legitimacy', definition: 'The right to exist and be recognised — being accepted as lawful and proper.' },
    ],
    questions: [
      { n: 10, q: 'Can there be peace without justice? Or does insisting on justice make peace impossible?' },
      { n: 11, q: 'Palestinians live under occupation. Israelis fear for their security. Can both sides be right?' },
      { n: 12, q: 'The ban forced countries to choose a position. Is taking sides more honest than pretending to be neutral?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "UK Bans Israeli Settlement Imports in Major Reset". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function UKIsraelPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>UK Bans Israeli Settlement Imports in Major Reset</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The UK joined France and Canada in banning imports from Israeli West Bank settlements. Israel closed the British consulate in response. A diplomatic earthquake and what it means.</p>
            </div>
          </div>
