...
const PARTS = [
  {
    number: 1, title: 'Welcome Back to the Gate', emoji: '🚪', color: '#dc2626',
    text: `Starting this week — just days before the 25th anniversary of the September 11 attacks — the Transportation Security Administration announced that some people without plane tickets will once again be allowed past security and into airport gate areas at selected US airports.\n\nFor anyone born after 2001, this might seem unremarkable. But for older Americans, it is a significant symbolic moment. Before 9/11, airports were open places. Families walked loved ones to the gate and watched their plane take off. Friends met arriving passengers as they stepped off the jet bridge. Children pressed their faces against the glass and watched planes taxi. The gate area was part of the airport experience — not a restricted zone.\n\nAll of that ended on September 11, 2001. Within days of the attacks, access to gate areas was restricted to ticketed passengers only. Security checkpoints — which had previously been minimal — became elaborate screening systems involving body scanners, shoe removal, liquid restrictions, and bag searches. The open, welcoming airport became a security facility.\n\nThe new programme is limited. Only certain airports participate. Visitors must register in advance and pass a background check. They cannot carry bags through security. And the programme can be suspended at any time. It is a cautious, partial opening — not a return to the pre-9/11 world. But for many Americans, it feels like a small step back toward normality after 25 years of security that changed how the world travels.`,
    vocab: [
      { word: 'TSA', definition: 'Transportation Security Administration — the US agency responsible for airport security, created after 9/11.' },
      { word: 'Jet bridge', definition: 'The enclosed walkway connecting the airport terminal to the aircraft door.' },
      { word: 'Background check', definition: 'An investigation into a person history to determine if they are a security risk.' },
      { word: 'Screening', definition: 'The process of checking passengers and their belongings for prohibited items.' },
    ],
    questions: [
      { n: 1, q: 'Before 9/11, families could walk to the gate. Would you like this experience, or do you prefer the security we have now?' },
      { n: 2, q: 'It took 25 years to partially reopen gate areas. Why did it take so long?' },
      { n: 3, q: 'The programme requires background checks for visitors. Is this the right balance between openness and security?' },
    ]
  },
  {
    number: 2, title: 'How 9/11 Changed Travel', emoji: '🛃', color: '#b91c1c',
    text: `The September 11 attacks transformed air travel more profoundly than any other single event in aviation history. The changes affected every country, every airline, and every passenger — and most of them are still in place 25 years later.\n\nBefore 9/11, you could arrive at an airport 30 minutes before a domestic flight and walk straight to the gate. Security consisted of a basic metal detector and an X-ray machine for carry-on bags. Passengers could carry scissors, small knives, and bottles of water. Cockpit doors were unlocked. And the idea that an airport needed armed guards, body scanners, and explosive-detection equipment seemed absurdly excessive.\n\nThe post-9/11 security regime was built in layers. Cockpit doors were reinforced and locked. The TSA was created — a new federal agency with more than 60,000 employees. Passengers were required to remove shoes (after the 2001 "shoe bomber" attempt) and surrender liquids over 100ml (after a 2006 plot to use liquid explosives). Air marshals — armed law enforcement officers posing as passengers — were placed on thousands of flights.\n\nThe costs are staggering. The TSA alone costs approximately 10 billion dollars per year. Airlines spend additional billions on their own security measures. And passengers collectively spend millions of hours per year in security lines — time that has an economic value estimated at more than 30 billion dollars annually.\n\nThe question that security experts still debate is whether the system is proportionate to the threat — or whether the enormous investment in airport security has created "security theatre" that makes people feel safe without significantly reducing risk.`,
    vocab: [
      { word: 'Security regime', definition: 'The complete system of security measures in place — all the rules and procedures together.' },
      { word: 'Air marshals', definition: 'Armed law enforcement officers who fly on commercial flights disguised as ordinary passengers.' },
      { word: 'Proportionate', definition: 'In proper proportion to the threat — the right amount of response, not too much or too little.' },
      { word: 'Security theatre', definition: 'Security measures that create the appearance of safety without significantly reducing actual risk.' },
    ],
    questions: [
      { n: 4, q: 'Airport security costs 10 billion dollars a year plus 30 billion in passenger time. Is this proportionate to the threat?' },
      { n: 5, q: 'The term "security theatre" suggests some measures make us feel safe without actually protecting us. Can you think of examples?' },
      { n: 6, q: 'Before 9/11, you could carry a knife on a plane. Does knowing this shock you? How quickly do abnormal things become normal?' },
    ]
  },
  {
    number: 3, title: 'The Security Paradox', emoji: '🔒', color: '#991b1b',
    text: `Airport security illustrates a paradox that applies to security in general: the better it works, the harder it is to justify.\n\nSince 9/11, there has not been a successful hijacking of a commercial aircraft in the United States. Supporters of the current security system point to this as evidence that it works — the massive investment has prevented further attacks and saved lives.\n\nBut critics argue that the absence of attacks does not prove the security system prevented them. It might mean that the threat was overestimated, that terrorists shifted to other targets, or that the most effective changes (reinforced cockpit doors, alert passengers) would have worked without the elaborate screening system. You cannot prove a negative — you cannot prove that something would have happened if you had not prevented it.\n\nThis creates a political problem. If security is relaxed and an attack occurs, the political consequences are catastrophic — careers end, governments fall, and the public demands even more security. If security is maintained at enormous cost and no attack occurs, nobody thanks the system — they either assume the threat was not real or take the safety for granted. The incentive structure pushes permanently toward more security, never less — regardless of whether the additional security is effective.\n\nThe TSA gate-opening programme is a rare exception — a small, cautious step in the direction of proportionality. But it has taken 25 years, and the step is so small and so hedged with restrictions that it barely changes the passenger experience. The direction of security policy, for a quarter of a century, has been in one direction only: more.`,
    vocab: [
      { word: 'Paradox', definition: 'A situation that seems contradictory — two things that should not both be true but are.' },
      { word: 'Prove a negative', definition: 'To show that something did not happen — logically impossible because absence of evidence is not evidence of absence.' },
      { word: 'Incentive structure', definition: 'The system of rewards and punishments that shapes how people and organisations behave.' },
      { word: 'Proportionality', definition: 'Making the response match the scale of the threat — not too much, not too little.' },
    ],
    questions: [
      { n: 7, q: 'No hijacking has occurred since 9/11. Does this prove the security system works, or that the threat was overstated?' },
      { n: 8, q: 'Politicians face disaster if security is relaxed and an attack happens. How does this create a one-way ratchet toward more security?' },
      { n: 9, q: 'Is the current level of airport security proportionate? What would you change, if anything?' },
    ]
  },
  {
    number: 4, title: '25 Years of Taking Off Your Shoes', emoji: '👟', color: '#7f1d1d',
    text: `The TSA gate-opening programme arrives just as the United States marks the 25th anniversary of 9/11 — a moment that invites reflection on what has been gained and lost in the name of security.\n\nWhat was gained is clear: a security system that has prevented hijackings, intercepted threats, and given travellers a degree of confidence that the person sitting next to them has been screened. This is not nothing. Air travel is safer today than it was on September 10, 2001.\n\nWhat was lost is harder to quantify but equally real. The ease and joy of air travel. The ability to say goodbye at the gate and watch a plane take off. The presumption that travellers are innocent until proven otherwise, rather than suspects to be screened. The billions of dollars and millions of hours spent on security that could have been spent on other things. And the erosion of privacy that 9/11 accelerated — not just at airports but across every aspect of life.\n\nFor younger readers who have never known anything different, the current system feels normal. Removing your shoes, surrendering your water bottle, and standing in a body scanner is just what you do at an airport. The idea that it could be different — that it once was different — may seem as strange as the idea of flying without a seatbelt.\n\nBut normal is not the same as inevitable. Every security measure is a choice — a decision that the benefits outweigh the costs. The small gate-opening programme is a reminder that choices can be revisited, that security can evolve, and that 25 years of doing something one way does not mean we must do it that way forever.\n\nThe shoes come off. The liquids go in the bag. The scanner hums. And somewhere, a grandmother walks to a gate to watch her grandchild plane take off — for the first time in 25 years. Progress, as always, is measured in small steps.`,
    vocab: [
      { word: 'Presumption of innocence', definition: 'The principle that people are considered innocent until proven guilty — a foundation of justice.' },
      { word: 'Erosion', definition: 'Gradual wearing away — losing something slowly over time without noticing.' },
      { word: 'Inevitable', definition: 'Certain to happen — something that cannot be avoided or prevented.' },
      { word: 'Revisited', definition: 'Looked at again — reconsidering a decision that was made in the past.' },
    ],
    questions: [
      { n: 10, q: 'Younger people think airport security is normal. Older people remember when it was different. What happens when unusual things become normal?' },
      { n: 11, q: 'A grandmother can walk to a gate to watch her grandchild plane take off — for the first time in 25 years. Why does this small moment matter?' },
      { n: 12, q: '25 years of doing something one way does not mean we must do it forever. What other security measures should be revisited?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "TSA Opens Airport Gates Again — 25 Years After 9/11". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function TSAGatesPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>TSA Opens Airport Gates Again — 25 Years After 9/11</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>For the first time since September 11 2001, people without plane tickets can go to airport gates in the US. How one morning 25 years ago changed how the world travels.</p>
            </div>
          </div>
