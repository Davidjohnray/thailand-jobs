...
const CATEGORIES = [
  {
    ...
    lessons: [
      ...
      { id: 'youngest-planet-born', title: 'Astronomers Find the Youngest Known Planet', emoji: '🪐', description: 'A World Being Born', detail: 'A Jupiter-sized planet less than a million years old — a cosmic baby. Watching a planet form and what it teaches us about how worlds are made.', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-09-22' },
      { id: 'screwworm-returns-us', title: 'The Flesh-Eating Parasite the US Eradicated Is Back', emoji: '🪱', description: 'The Parasite That Came Back', detail: 'The screwworm was eradicated in 1982 using sterile flies. Now it has returned. Climate change, complacency, and the fragility of biological victory.', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-09-22' },
      { id: 'venus-swallowed-moon', title: 'Venus May Have Swallowed Its Own Moon', emoji: '🌕', description: 'The Missing Moon Mystery', detail: 'Venus once had a moon that spiralled inward and was swallowed. Earth evil twin, why moons matter, and what Venus teaches us about our own planet.', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-09-22' },
      { id: 'house-votes-end-iran-war', title: 'US House Votes to End Iran War — Again', emoji: '🏛️', description: 'Three Votes, Zero Effect', detail: 'Congress voted to end the Iran war for the third time. The President ignores it. The constitutional crisis of a war nobody authorised.', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-09-17' },
      { id: 'trump-ai-hoax', title: 'Trump Calls AI Regulation a HOAX', emoji: '🤖', description: 'The President vs Silicon Valley', detail: 'Days after AI CEOs warned about dangers, Trump rejected regulation as a conspiracy. The China factor, the pattern, and who governs the ungoverned.', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-09-17' },
      { id: 'sahel-terror-record', title: 'Sahel Terror Hits Record — 25 Years After 9/11', emoji: '🌍', description: 'The War That Moved', detail: 'Islamist violence in Africa Sahel is at historic highs. 25 years after the War on Terror began, terrorism has not been defeated — it has moved.', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-09-17' },
      { id: 'brics-summit-delhi', title: 'BRICS Summit in New Delhi — A New World Order?', emoji: '🌐', description: 'The Alternative Table', detail: 'Modi hosted Putin and Xi as BRICS expands to 46% of world population. Trade, investment, and whether the bloc can challenge Western dominance.', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-09-14' },
      { id: 'ai-ceos-slow-down', title: 'AI CEOs Call for Development to Slow Down', emoji: '⏸️', description: 'The People Building AI Say Stop', detail: 'Anthropic and OpenAI CEOs told the Senate that AI is moving too fast. The prisoner dilemma, what they fear, and who decides the future.', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-09-14' },
      { id: 'houthis-red-sea-island', title: 'Houthis Capture Red Sea Island', emoji: '🏝️', description: 'A Second Shipping Chokepoint Under Threat', detail: 'Houthi rebels seized a strategic island in the Bab el-Mandeb Strait. Both Middle East shipping lanes now at risk and the vulnerability of everything.', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-09-14' },
      { id: 'uk-israel-settlements', title: 'UK Bans Israeli Settlement Imports', emoji: '🇬🇧', description: 'A Diplomatic Earthquake', detail: 'The UK called Israel occupation apartheid and banned settlement imports. Israel closed the British consulate. A diplomatic rupture and what it means.', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-09-10' },
      { id: 'somali-pirates-return', title: 'Somali Pirates Return as Chaos Spreads', emoji: '🏴‍☠️', description: 'Pirates Are Back', detail: 'Piracy off Somalia has surged to decade-high levels driven by the Iran war and political collapse. How chaos in one region creates crime in another.', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-09-10' },
      { id: 'tsa-gates-open-911', title: 'TSA Opens Airport Gates — 25 Years After 9/11', emoji: '✈️', description: '25 Years of Taking Off Your Shoes', detail: 'For the first time since 9/11, non-passengers can go to airport gates. How one morning changed how the world travels, and the security paradox.', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-09-10' },
