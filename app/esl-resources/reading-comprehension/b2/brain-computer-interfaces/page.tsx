...
const PARTS = [
  {
    number: 1, title: 'Reading the Brain', emoji: '📡', color: '#6366f1',
    text: `Every thought you have, every movement you make, and every emotion you feel is the result of electrical signals passing between billions of neurons in your brain. These signals create patterns — specific, measurable patterns that modern technology is increasingly able to detect, interpret, and even respond to. The field that studies how to connect human brains directly to computers is called brain-computer interface technology, or BCI — and it is developing faster than almost anyone predicted.\n\nThe idea is not new. Scientists first recorded electrical activity in the human brain in 1924, using a device called an electroencephalogram, or EEG. For decades, EEGs were used primarily for medical diagnosis — detecting epilepsy, sleep disorders, and brain injuries. But researchers gradually realised that the electrical patterns detected by EEGs contained information that could, in theory, be decoded — translated from brain activity into commands that a computer could understand.\n\nThe first practical brain-computer interfaces appeared in the 1990s. They were crude by modern standards — patients with severe paralysis could use them to move a cursor on a screen by concentrating intensely on specific thoughts. The process was slow, exhausting, and imprecise. But it proved something revolutionary: that a human thought, with no physical movement whatsoever, could directly control a machine.\n\nSince then, the technology has advanced dramatically. Modern BCIs can allow paralysed patients to type words, control robotic arms, and even browse the internet using only their thoughts. In 2024, a patient with a Neuralink chip implanted in his brain was able to play video games and use a computer at speeds approaching those of a person using a mouse — a milestone that attracted worldwide attention.`,
    vocab: [
      { word: 'Neurons', definition: 'Nerve cells in the brain and body that carry electrical signals — the basic units of the nervous system.' },
      { word: 'Electroencephalogram', definition: 'A medical device that detects and records electrical activity in the brain using sensors on the scalp.' },
      { word: 'Paralysis', definition: 'The inability to move part or all of the body, usually caused by injury to the brain or spinal cord.' },
      { word: 'Milestone', definition: 'An important event or achievement that marks a significant point of progress.' },
    ],
    questions: [
      { n: 1, q: 'A paralysed patient can now control a computer with their thoughts. How does this make you feel about the potential of technology?' },
      { n: 2, q: 'The first BCIs in the 1990s were slow and crude. What does the speed of progress since then suggest about where the technology might be in 20 years?' },
      { n: 3, q: 'Would you be comfortable having a chip implanted in your brain if it gave you new abilities? What would concern you most?' },
    ]
  },
  {
    number: 2, title: 'Healing the Body', emoji: '🏥', color: '#4f46e5',
    text: `The most immediately compelling applications of brain-computer interfaces are medical. For people living with severe disabilities — paralysis, locked-in syndrome, loss of speech, or loss of limb function — BCIs offer the possibility of restoring abilities that injury or disease has taken away.\n\nOne of the most remarkable achievements has been in restoring communication. Patients with amyotrophic lateral sclerosis, known as ALS or motor neurone disease — a condition that progressively destroys the ability to move, speak, and eventually breathe — have used BCIs to type messages by thinking about the letters they want to select. For patients who have lost all ability to communicate physically, this technology is not a convenience — it is a lifeline.\n\nResearchers are also working on BCIs that can restore movement. By implanting electrodes in the motor cortex — the part of the brain that controls voluntary movement — and connecting them to robotic limbs or electrical stimulators attached to paralysed muscles, scientists have enabled patients with spinal cord injuries to reach for objects, grasp cups, and even take assisted steps. The movements are still slower and less precise than natural movement, but they are improving rapidly.\n\nAnother promising area is the treatment of neurological and psychiatric conditions. Deep brain stimulation — a technique in which electrodes are implanted in specific brain regions — is already used to treat Parkinson's disease, severe depression, and obsessive-compulsive disorder. Researchers are exploring whether more advanced BCIs could provide even more precise and effective treatment by reading brain activity in real time and adjusting stimulation accordingly.`,
    vocab: [
      { word: 'Locked-in syndrome', definition: 'A condition where a person is fully conscious but cannot move or speak — trapped inside their body.' },
      { word: 'Motor cortex', definition: 'The part of the brain responsible for planning and controlling voluntary body movements.' },
      { word: 'Electrodes', definition: 'Small devices that detect or deliver electrical signals, often implanted in the brain or attached to the body.' },
      { word: 'Neurological', definition: 'Relating to the nervous system — the brain, spinal cord, and nerves.' },
    ],
    questions: [
      { n: 4, q: 'BCIs can help ALS patients communicate by thinking about letters. Why is this described as a lifeline rather than just a convenience?' },
      { n: 5, q: 'Paralysed patients can now grasp cups and take steps using BCIs. How do you think this changes their daily life and sense of independence?' },
      { n: 6, q: 'BCIs might treat depression and OCD by stimulating specific brain regions. Does this excite you or concern you? Why?' },
    ]
  },
  {
    number: 3, title: 'Beyond Medicine', emoji: '🚀', color: '#4338ca',
    text: `While the medical applications of BCIs are the most immediately important, some companies and researchers are looking further ahead — towards a future in which brain-computer interfaces are used not just to restore lost abilities, but to enhance healthy ones.\n\nNeuralink, the company founded by Elon Musk, has been the most visible advocate of this vision. Musk has described a future in which healthy people choose to have brain chips implanted to improve their memory, accelerate their learning, communicate telepathically with other chip users, and even merge human intelligence with artificial intelligence. These claims are highly speculative and many neuroscientists are sceptical about whether they are achievable — but they have attracted enormous public attention and investment.\n\nLess dramatically, non-invasive BCIs — devices that read brain activity from outside the skull, without surgery — are already being marketed for consumer use. EEG headbands that claim to improve meditation, focus, and sleep quality are available commercially. Gaming companies are developing controllers that respond to brain signals. Researchers are exploring whether BCIs could allow people to control smart home devices, compose music, or create digital art using only their thoughts.\n\nThe military applications of BCIs are also being actively researched. The US military's Defense Advanced Research Projects Agency has invested heavily in BCI research, with programmes aimed at creating soldiers who can communicate silently, control drones with their thoughts, and process information faster than is currently possible. The ethical implications of militarised brain technology are significant and largely unexamined.`,
    vocab: [
      { word: 'Telepathically', definition: 'Communicating thoughts directly from one mind to another without speaking or writing.' },
      { word: 'Speculative', definition: 'Based on guesses or theories rather than proven facts — not yet confirmed.' },
      { word: 'Non-invasive', definition: 'Not requiring surgery or cutting the body — working from outside.' },
      { word: 'Implications', definition: 'The possible effects or consequences of something — what might happen as a result.' },
    ],
    questions: [
      { n: 7, q: 'Elon Musk wants healthy people to have brain chips for enhancement. Would you choose to have one? What ability would you most want to improve?' },
      { n: 8, q: 'EEG headbands for meditation and focus are already available. Do you think these products genuinely work, or are they mostly marketing?' },
      { n: 9, q: 'The military is researching BCIs for soldiers. What ethical concerns does this raise? Should there be limits on military brain technology?' },
    ]
  },
  {
    number: 4, title: 'The Ethics of Reading Minds', emoji: '⚖️', color: '#3730a3',
    text: `As brain-computer interface technology advances, it raises ethical questions that society has never had to confront before. The most fundamental is this: if a device can read your brain activity, who owns that data?\n\nBrain data is the most intimate information imaginable. It reveals not just what you are doing, but what you are thinking, feeling, and intending. If a company that manufactures a brain implant has access to your neural data, it potentially knows more about you than you know about yourself. The privacy implications are without precedent in human history.\n\nThere are also questions of equity. If BCIs can genuinely enhance cognitive abilities — improving memory, focus, or processing speed — they will initially be available only to those who can afford them. This could create a new form of inequality in which the wealthy have access to cognitive enhancement that is unavailable to everyone else — a gap not just in wealth or education, but in the fundamental capacity of the human mind.\n\nConsent is another critical concern. A person who has a brain chip implanted for medical reasons — to treat paralysis, for example — may not have meaningfully consented to having their brain data collected, analysed, and potentially shared. The line between treatment and surveillance becomes blurred when the treatment device is also a data collection tool.\n\nFinally, there is the question of identity. If a device can influence your thoughts, moods, and decisions — even in subtle ways — are you still fully yourself? When a deep brain stimulator changes a patient's personality or emotional responses, as has been documented in some cases, the philosophical question of where the person ends and the machine begins becomes genuinely difficult to answer.\n\nBrain-computer interfaces have the potential to transform medicine, communication, and human capability. But they also have the potential to reshape what it means to be human — and that is a conversation that needs to happen now, before the technology outpaces our ability to govern it.`,
    vocab: [
      { word: 'Neural', definition: 'Relating to nerves or the nervous system, especially the brain.' },
      { word: 'Precedent', definition: 'Something that has happened before and can be used as an example or guide for the future.' },
      { word: 'Equity', definition: 'Fairness — ensuring that everyone has equal access to opportunities and resources.' },
      { word: 'Surveillance', definition: 'Closely watching or monitoring someone, usually without their full knowledge or consent.' },
    ],
    questions: [
      { n: 10, q: 'If a company makes your brain implant, should they have access to your brain data? Who should own your thoughts?' },
      { n: 11, q: 'If BCIs can enhance intelligence but only the wealthy can afford them, what happens to equality? How should society respond?' },
      { n: 12, q: 'If a device changes your personality or emotions, are you still fully yourself? Where does the person end and the machine begin?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Brain-Computer Interfaces</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Chips in brains, thoughts controlling computers, paralysed patients typing with their minds. The technology that connects human brains directly to machines is no longer science fiction.</p>
            </div>
          </div>
