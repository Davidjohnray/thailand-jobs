...
const PARTS = [
  {
    number: 1, title: 'The Expedition', emoji: '🏔️', color: '#0ea5e9',
    text: `In January 1959, a group of ten experienced young hikers set out on a ski trek through the northern Ural Mountains in the Soviet Union — a remote, inhospitable region in what is now Russia. The group was led by Igor Dyatlov, a 23-year-old student and experienced outdoorsman from the Ural Polytechnic Institute in the city of Sverdlovsk. The other members of the expedition were fellow students and graduates, all of them seasoned winter hikers who had completed challenging expeditions before. One member withdrew due to illness before the group reached the mountains, leaving nine.\n\nThe route they had planned was demanding but not considered extraordinary for hikers of their experience. They intended to reach the summit of Otorten, a peak whose name translates, ominously in retrospect, as "Don't go there" in the local Mansi language. The journey would take approximately three weeks, and the group maintained a diary and took photographs throughout, documenting their progress with the cheerfulness and camaraderie typical of Soviet student expeditions of the era.\n\nOn 28 January, the group made camp on the slopes of a mountain called Kholat Syakhl — which means "Dead Mountain" in Mansi. The following day, bad weather caused them to veer off course slightly as they attempted to cross the mountain pass. Rather than descend to a sheltered forest valley to camp, which would have been safer, they decided to continue across the exposed slope and pitch their tent there for the night, intending to complete the crossing the following morning.\n\nThat decision was the last documented action of the Dyatlov group. None of the nine hikers survived. What happened on the slope of Dead Mountain that night has never been definitively explained, and the case has become one of the most enduring and troubling unsolved mysteries of the twentieth century.`,
    vocab: [
      { word: 'Inhospitable', definition: 'Harsh and difficult to survive in; not welcoming or favourable to human life.' },
      { word: 'Seasoned', definition: 'Experienced and skilled, having done something many times before.' },
      { word: 'Camaraderie', definition: 'A feeling of trust, friendship, and mutual support among a group of people.' },
      { word: 'Definitively', definition: 'In a way that is final and certain, leaving no possibility of doubt.' },
    ],
    questions: [
      { n: 1, q: 'The group was experienced and well-prepared. Does this make the outcome more or less disturbing to you? Why?' },
      { n: 2, q: 'The mountains had names meaning "Don\'t go there" and "Dead Mountain." Would this affect your decision to hike there?' },
      { n: 3, q: 'Why do you think the group chose to camp on the exposed slope rather than descend to the sheltered valley?' },
    ]
  },
  {
    number: 2, title: 'The Discovery', emoji: '❄️', color: '#0284c7',
    text: `When the Dyatlov group failed to return on schedule, a search and rescue operation was launched. On 26 February 1959 — nearly a month after the group had last been seen — rescuers found the tent on the slope of Kholat Syakhl. What they found was deeply disturbing and entirely without precedent in the history of Soviet mountaineering accidents.\n\nThe tent had been cut open from the inside. The hikers had apparently slashed their way out through the canvas rather than using the entrance. Their boots and most of their outer clothing were still inside the tent. Despite temperatures that night estimated to have been as low as minus thirty degrees Celsius, the hikers had fled into the snow in their socks, or barefoot, wearing only their undergarments or light indoor clothing.\n\nThe bodies were found gradually, over the following weeks and months. The first five were discovered relatively close to the tent, in the direction of a nearby tree line. Two of them were found at the remains of a small fire, their hands burned as if they had been trying to maintain it while suffering from extreme cold. The other three were found between the fire and the tent, apparently having turned back towards it.\n\nThe last four bodies were not found until May, buried under several metres of snow in a ravine some distance from the tree line. These four had died under circumstances that were, if anything, even more perplexing. Three of them had suffered severe internal injuries — broken ribs and, in one case, a fractured skull — of a kind that a Soviet forensic expert compared to the force of a car crash. Yet their skin showed no corresponding external wounds. One of the women was missing her tongue, eyes, and part of her lips.`,
    vocab: [
      { word: 'Unprecedented', definition: 'Never having happened or existed before; completely new and without any prior example.' },
      { word: 'Undergarments', definition: 'Clothing worn under other clothes and directly against the skin, such as underwear.' },
      { word: 'Ravine', definition: 'A deep, narrow valley with steep sides, usually formed by water erosion.' },
      { word: 'Forensic', definition: 'Relating to the use of scientific methods to investigate crimes or causes of death.' },
    ],
    questions: [
      { n: 4, q: 'Which detail from the discovery do you find most disturbing or inexplicable? Why?' },
      { n: 5, q: 'The tent was cut from the inside. What does this suggest about the state of mind of the hikers at that moment?' },
      { n: 6, q: 'How do you explain the severe internal injuries with no external wounds? What might cause something like that?' },
    ]
  },
  {
    number: 3, title: 'The Theories', emoji: '🔍', color: '#0369a1',
    text: `The Dyatlov Pass Incident — named after the expedition leader — has generated a remarkable number of competing theories over the more than six decades since the deaths. The original Soviet investigation concluded only that the hikers had died as a result of "an unknown compelling force," which satisfied almost nobody and fuelled speculation for generations.\n\nThe most widely discussed natural explanation involves an avalanche. Proponents of this theory argue that the hikers may have been woken by the sound or early movement of an avalanche and fled the tent in panic, cutting through the canvas to escape more quickly. The internal injuries found on the four bodies in the ravine could potentially be consistent with being buried and compressed by heavy snow. However, critics point out that the slope where the tent was pitched was not steep enough to generate a typical avalanche, and the tent itself showed no signs of having been struck by snow.\n\nAnother natural theory involves infrasound — low-frequency sound waves generated by wind moving across certain mountain formations. Research has shown that infrasound at certain frequencies can induce feelings of extreme panic, anxiety, and even hallucinations in humans. If the hikers were suddenly exposed to intense infrasound, it could theoretically explain why they fled the tent in a state of apparent terror without taking any logical precautions.\n\nMore exotic theories have included testing of secret Soviet military weapons, encounters with escaped prisoners from nearby Gulag labour camps, and — inevitably — UFOs. A photograph found among the group's recovered film appeared to show a bright, glowing orb in the night sky, which adherents of the UFO theory have pointed to as evidence of an extraterrestrial encounter. Sceptics have attributed the image to a double exposure or a rocket test.\n\nIn 2019, the Russian government reopened the investigation and concluded that the most likely cause was an avalanche-like snow slab — a dense layer of snow that can slide without warning on certain slopes. The conclusion was accepted by some researchers and rejected by others.`,
    vocab: [
      { word: 'Proponents', definition: 'People who support and argue in favour of a particular theory, idea, or course of action.' },
      { word: 'Infrasound', definition: 'Sound waves at frequencies below the range of human hearing, which can affect mood and perception.' },
      { word: 'Hallucinations', definition: 'Experiences of seeing, hearing, or feeling things that are not actually present.' },
      { word: 'Adherents', definition: 'People who believe in and support a particular idea, theory, or set of beliefs.' },
    ],
    questions: [
      { n: 7, q: 'Which theory do you find most convincing — avalanche, infrasound, military testing, or something else? Why?' },
      { n: 8, q: 'Why do you think the Russian government waited until 2019 to reopen the investigation? Does the delay make you more or less sceptical of the conclusion?' },
      { n: 9, q: 'At what point does a mystery become so complex that the simplest explanation is no longer satisfying? Is the Dyatlov case an example of this?' },
    ]
  },
  {
    number: 4, title: 'Why the Case Still Matters', emoji: '🧊', color: '#075985',
    text: `More than sixty years after the deaths on Dead Mountain, the Dyatlov Pass Incident continues to attract researchers, journalists, documentary makers, and amateur investigators from around the world. The case has spawned numerous books, a major Russian film, a Netflix documentary, and an almost inexhaustible stream of online analysis. What is it about this particular case that makes it so compelling?\n\nPart of the answer lies in the identities of the victims. These were not anonymous individuals but a well-documented group of intelligent, capable young people who kept detailed records of their journey. Their diaries and photographs give the case a human dimension that makes the abruptness of their deaths all the more shocking. We know who they were, what they were thinking in the days before they died, and we can see their faces. This makes it personal in a way that many historical mysteries are not.\n\nThe geographical and political context adds another layer of complexity. The Ural Mountains in 1959 were deep within Soviet territory, and the Soviet government's handling of the case was characterised by the opacity and information control typical of the era. Files were classified, witnesses were reportedly told not to speak about what they had seen, and the area around Dyatlov Pass was closed to hikers for three years after the incident. This atmosphere of secrecy has inevitably encouraged conspiracy theories, many of which may be entirely unfounded but are difficult to disprove.\n\nUltimately, the Dyatlov Pass Incident endures because it confronts us with the possibility that intelligent, experienced, well-prepared human beings can be destroyed by something that leaves no clear explanation. It is a reminder that the natural world — and perhaps human experience itself — contains phenomena that our current frameworks of knowledge are not always adequate to explain. And that reminder, however uncomfortable, is one that many people find genuinely difficult to ignore.`,
    vocab: [
      { word: 'Inexhaustible', definition: 'Available in such large quantities that it cannot be used up; seemingly endless.' },
      { word: 'Opacity', definition: 'The quality of being difficult to understand or see through; a lack of transparency.' },
      { word: 'Conspiracy', definition: 'A secret plan by a group of people to do something harmful or illegal, often involving cover-ups.' },
      { word: 'Phenomena', definition: 'The plural of phenomenon — observable facts or events, especially unusual or unexplained ones.' },
    ],
    questions: [
      { n: 10, q: 'Why do you think the Soviet government\'s secrecy around the case has made it harder, not easier, to accept the official conclusions?' },
      { n: 11, q: 'The passage says the case "confronts us with the possibility that intelligent, experienced people can be destroyed by something that leaves no clear explanation." Does this idea disturb you? Why?' },
      { n: 12, q: 'Is there value in continuing to investigate cold cases like Dyatlov Pass, or does there come a point when resources should be directed elsewhere? How do you decide?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "The Dyatlov Pass Incident — Nine Hikers, One Unsolved Mystery". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#f0f9ff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && (
        <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #e0f2fe' }}>
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && (
                  <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}>
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid #e0f2fe', display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
...
export default function DyatlovPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0c1a2e 0%, #0c4a6e 50%, #075985 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(14,165,233,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Dyatlov Pass Incident</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>In February 1959, nine experienced Soviet hikers were found dead on a remote mountain slope. Their tent had been cut open from the inside. No satisfactory explanation has ever been given.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#0ea5e9', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#0ea5e9' : '#e5e7eb', background: translationLang !== 'none' ? '#f0f9ff' : 'white', color: translationLang !== 'none' ? '#0369a1' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#f0f9ff', padding: '8px 28px', borderBottom: '1px solid #bae6fd' }}>
                    ...
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && (
                          <div style={{ marginTop: '6px', background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: '8px', padding: '8px 12px' }}>
                            <span style={{ color: '#0369a1', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
            ...
            <div style={{ background: '#1a1a2e', padding: '20px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                ...
                <span style={{ color: '#7dd3fc', fontWeight: 'bold', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>Discussion Questions</span>
              </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#0ea5e9', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #bae6fd', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#f0f9ff', color: '#0369a1', border: '2px solid #bae6fd', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#f0f9ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bae6fd', color: '#9ca3af', fontSize: '15px' }}>
                {translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}
              </div>
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#f0f9ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bae6fd' }}>
                ...
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#f0f9ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #7dd3fc' }}>
                    <div style={{ color: '#0284c7', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>{currentLang?.label} Translation</div>
