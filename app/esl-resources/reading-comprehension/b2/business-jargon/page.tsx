...
const PARTS = [
  {
    number: 1, title: 'What Is Business Jargon — and Why Does It Exist?', emoji: '💼', color: '#6366f1',
    text: `Business jargon — the specialised vocabulary, buzzwords, and phrases used in corporate and professional environments — is one of the most distinctive features of modern workplace communication. Walk into any international business meeting and you are likely to hear people "touching base", "circling back", "taking things offline", "moving the needle", "boiling the ocean", or asking whether something will "gain traction." To someone unfamiliar with this language, these phrases can sound baffling. To an experienced professional, they are simply part of the everyday vocabulary of work.\n\nJargon exists for several reasons. At its best, it provides a useful shorthand — shared terminology that allows colleagues to communicate complex ideas quickly without lengthy explanation. The phrase "let's take this offline" communicates in four words what might otherwise require a full sentence: "this conversation is too detailed and specific to continue in a large group meeting — let's discuss it separately afterwards." Technical jargon in fields like finance, law, medicine, or technology serves a genuine purpose by providing precise language for concepts that need precision. The problem arises when jargon is used not to communicate more clearly but to sound authoritative, signal membership of a group, or — more cynically — to obscure the fact that nothing meaningful is being said.`,
    vocab: [
      { word: 'Buzzword', definition: 'A fashionable word or phrase used in a particular field — often overused to the point of losing meaning.' },
      { word: 'Shorthand', definition: 'A quick way of expressing something — using fewer words to convey an idea both parties already understand.' },
      { word: 'Authoritative', definition: 'Sounding knowledgeable and confident — appearing to be an expert or person of importance.' },
      { word: 'Obscure', definition: 'To make something unclear or difficult to understand — hiding meaning behind complex or vague language.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever been in a meeting where jargon made it harder to understand what was being said? What happened?' },
      { n: 2, q: 'Do you think jargon makes people sound more professional, or does it often hide a lack of real substance?' },
      { n: 3, q: 'Is there jargon specific to your industry or workplace that outsiders would not understand?' },
    ]
  },
  {
    number: 2, title: 'The Most Common Jargon — Decoded', emoji: '🔍', color: '#8b5cf6',
    text: `Some business jargon has become so widespread that it appears across virtually every industry and organisation. Understanding these phrases — and knowing when to use them appropriately — is an important part of professional fluency in English. "Low-hanging fruit" refers to the easiest tasks or opportunities that can be achieved quickly with minimal effort — the things you do first before tackling harder problems. "Bandwidth" in a business context has nothing to do with internet speed — it means a person's capacity or availability: "I don't have the bandwidth for that project right now" means "I'm too busy." "Synergy" — one of the most mocked pieces of business jargon — describes the idea that two things working together produce a better result than either could achieve alone, though it is so overused that it has largely lost meaning.\n\n"Pivot" — originally a basketball term — means to make a significant change in direction, usually in response to new information or market conditions. "Disruptive" describes a product, service, or company that fundamentally changes an industry, often by challenging established players with a new approach. "Scalable" describes something that can grow efficiently without proportionally increasing costs — a key concept in technology businesses. "Pain points" are the specific problems or frustrations that customers experience, which a product or service is designed to solve. Learning this vocabulary is not just about understanding what people say — it is about being able to participate confidently in conversations where these terms appear constantly.`,
    vocab: [
      { word: 'Low-hanging fruit', definition: 'The easiest and most immediately available opportunities — tasks that can be completed quickly with little effort.' },
      { word: 'Pivot', definition: 'A significant change in business direction or strategy — responding to new information by changing approach.' },
      { word: 'Scalable', definition: 'Able to grow efficiently — a system or business that can expand without costs growing at the same rate.' },
      { word: 'Pain points', definition: 'Specific problems or frustrations that customers experience — the issues a product or service aims to solve.' },
    ],
    questions: [
      { n: 4, q: 'Which of these jargon terms do you already use or hear at work? Do you find them useful or annoying?' },
      { n: 5, q: 'Why do you think "synergy" and similar words get mocked so often? What makes jargon become meaningless?' },
      { n: 6, q: 'If a colleague used all these terms in one meeting, what would your impression of them be?' },
    ]
  },
  {
    number: 3, title: 'When Jargon Becomes a Problem', emoji: '⚠️', color: '#f59e0b',
    text: `While some jargon serves a genuine communicative purpose, it can also become a serious barrier — particularly in international and multicultural workplaces. For non-native English speakers, dense jargon in meetings, emails, and presentations can make it genuinely difficult to follow what is being discussed, even for people with strong general English skills. An email asking someone to "circle back after we've had a chance to socialise the deck with key stakeholders and get their buy-in before we move to the next deliverable" is not clearer than plain English — it is significantly more confusing, even for many native speakers.\n\nResearch in business communication has also identified a phenomenon sometimes called "jargon inflation" — the tendency for jargon to spread and multiply until it becomes the default mode of communication, even when plain English would be faster, clearer, and more respectful of the listener's time. Some critics argue that the overuse of jargon in corporate environments reflects a deeper cultural problem: an obsession with appearing busy, strategic, and sophisticated rather than simply communicating well. The irony is that the clearest, most confident communicators — those whose ideas are genuinely strong — rarely need to hide behind jargon. The ability to explain a complex idea in simple, direct language is a mark of real mastery, not a sign of unsophistication.`,
    vocab: [
      { word: 'Socialise the deck', definition: 'Business jargon meaning to share a presentation with key people before a formal meeting to get early feedback.' },
      { word: 'Buy-in', definition: 'Agreement and support from key people — getting others to commit to an idea or plan.' },
      { word: 'Jargon inflation', definition: 'The tendency for specialist language to multiply and spread until it dominates all communication.' },
      { word: 'Mastery', definition: 'A very high level of skill or understanding — expert command of a subject or ability.' },
    ],
    questions: [
      { n: 7, q: 'Have you ever felt excluded from a conversation because of jargon you didn\'t understand? How did it feel?' },
      { n: 8, q: 'Do you agree that people who use a lot of jargon are sometimes hiding a lack of real ideas? Give an example.' },
      { n: 9, q: 'Should companies have policies encouraging plain English in communication? Would it actually work?' },
    ]
  },
  {
    number: 4, title: 'Navigating Jargon — When to Use It and When to Avoid It', emoji: '🧭', color: '#22c55e',
    text: `The most effective professional communicators are those who can move fluidly between jargon and plain English depending on their audience. In a meeting of industry insiders, using appropriate technical vocabulary signals competence and fluency — it shows you belong and understand the field. In a presentation to a mixed audience that includes non-specialists, clients from different industries, or international colleagues, the same vocabulary can alienate and confuse. Audience awareness — adjusting your language to suit who you are speaking to — is one of the fundamental skills of professional communication.\n\nWhen you encounter jargon you do not understand, the most professional response is almost always to ask for clarification. Many people stay silent in meetings when they do not understand something, worried that asking will make them seem less competent. In practice, the opposite is often true — asking a clear, well-phrased question demonstrates engagement and confidence. "Could you explain what you mean by 'boiling the ocean' in this context?" or "I want to make sure I've understood — when you say 'moving the needle', what specific outcome are you referring to?" are entirely professional questions. Finally, if you find yourself using a piece of jargon and cannot immediately explain in plain words what you mean by it, that is usually a signal that the jargon is doing the work that a clear thought should be doing instead.`,
    vocab: [
      { word: 'Fluidly', definition: 'Smoothly and easily — moving between different styles without difficulty or interruption.' },
      { word: 'Alienate', definition: 'To make someone feel excluded or disconnected — causing people to feel unwelcome or left out.' },
      { word: 'Audience awareness', definition: 'Understanding who you are communicating with and adapting your language and style accordingly.' },
      { word: 'Clarification', definition: 'An explanation that makes something clearer — asking someone to explain what they mean more precisely.' },
    ],
    questions: [
      { n: 10, q: 'Do you feel confident asking for clarification when you don\'t understand something in a meeting? What stops you?' },
      { n: 11, q: 'Is it possible to be taken seriously in a corporate environment without using any jargon at all?' },
      { n: 12, q: 'What is the single most useful piece of business jargon you know — and what plain English phrase could replace it?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Understanding Business Jargon". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function BusinessJargonPage() {
  ...
  const handleLookup = async (text: string) => {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ system: isPhrase ? `You are a business English dictionary for B2 learners. Respond with ONLY one sentence (max 25 words) explaining what the phrase means in a business context. No extra text.` : `You are a business English dictionary for B2 learners. Respond with ONLY one sentence (max 20 words) defining this word simply. No extra text.`, messages: [{ role: 'user', content: isPhrase ? `What does "${text}" mean in business?` : `Define: "${text}"` }] }) })
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Understanding Business Jargon</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Synergy, Pivot, Low-Hanging Fruit — decode the most common corporate buzzwords, understand when jargon helps and when it hurts, and learn to communicate with real clarity.</p>
            </div>
          </div>
