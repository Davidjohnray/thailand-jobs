...
const PARTS = [
  {
    number: 1, title: 'Banning the Future', emoji: '🚫', color: '#dc2626',
    text: `This week, US lawmakers introduced legislation that would permanently ban the development of artificial superintelligence — AI systems that exceed human-level intelligence across all domains — and impose an immediate pause on development of the most advanced AI models.\n\nThe proposal comes days after OpenAI released GPT-6, its most powerful model yet. OpenAI itself classified the model\'s cybersecurity capabilities as "Critical" — meaning it could potentially be used to conduct sophisticated cyberattacks. The release sharpened a debate that has been building for years: is AI development moving faster than humanity\'s ability to control it?\n\nThe proposed ban distinguishes between narrow AI — systems designed for specific tasks, like translating languages or recommending movies — and artificial general intelligence (AGI) or superintelligence, which would match or exceed human thinking across all areas. The bill would ban only the latter, while imposing new safety requirements on the former.\n\nSupporters argue that superintelligent AI poses an existential risk — a threat to the very existence of humanity. If an AI system becomes smarter than all humans combined and pursues goals misaligned with human welfare, the consequences could be catastrophic and irreversible. Better to ban it now, they argue, than to build it and discover the risks too late.\n\nCritics counter that banning a technology that does not yet exist is both premature and counterproductive — it could push research into countries with fewer safety standards while doing nothing to address the risks of AI systems that already exist.`,
    vocab: [
      { word: 'Superintelligence', definition: 'AI that surpasses human intelligence in every domain — smarter than all humans combined.' },
      { word: 'Existential risk', definition: 'A threat that could end human civilisation or cause permanent, catastrophic harm.' },
      { word: 'Misaligned', definition: 'Not matching — when AI goals do not align with what humans actually want.' },
      { word: 'Premature', definition: 'Too early — acting before enough information is available to make a good decision.' },
    ],
    questions: [
      { n: 1, q: 'Can you ban a technology that does not exist yet? Is this wise caution or premature panic?' },
      { n: 2, q: 'OpenAI classified GPT-6 cybersecurity capabilities as Critical. Should companies be allowed to release systems they consider dangerous?' },
      { n: 3, q: 'If the US bans superintelligence research, it could move to China. Does this make a ban pointless?' },
    ]
  },
  {
    number: 2, title: 'The Race to Superintelligence', emoji: '🏎️', color: '#b91c1c',
    text: `The debate over an AI ban is taking place against a backdrop of intense competition between AI companies and between nations.\n\nOpenAI, Google DeepMind, Anthropic, Meta, and dozens of smaller companies are racing to build increasingly powerful AI systems. Each new model is more capable than the last. GPT-6 can write code, conduct research, browse the internet, and execute multi-step tasks with minimal human oversight. The gap between what AI can do today and what it could not do five years ago is staggering.\n\nThe competition is driven partly by commercial incentives — the company that builds the most powerful AI stands to dominate the technology industry. But it is also driven by a genuine belief among many researchers that powerful AI could solve humanity\'s greatest challenges — curing diseases, reversing climate change, eliminating poverty.\n\nThe national dimension adds urgency. The United States and China are engaged in an AI race that mirrors the Cold War\'s nuclear competition. Both countries see AI supremacy as essential to economic and military dominance. This framing makes unilateral restrictions politically difficult — if the US slows down, China gains an advantage.\n\nCritics of the race frame the situation differently. Racing to build the most powerful technology in history without adequate safety measures, they argue, is like racing to build a nuclear reactor without knowing how to prevent a meltdown. Speed and power are not the same as wisdom and safety.`,
    vocab: [
      { word: 'Staggering', definition: 'Astonishing — so great or dramatic that it is hard to believe.' },
      { word: 'Supremacy', definition: 'Being the most powerful — having dominance over competitors.' },
      { word: 'Unilateral', definition: 'Done by one side only — action taken by one country without agreement from others.' },
      { word: 'Meltdown', definition: 'A catastrophic failure — originally a nuclear reactor accident, now used broadly for any disaster.' },
    ],
    questions: [
      { n: 4, q: 'Companies race to build powerful AI because of profit and because they believe it could solve major problems. Are both motivations valid?' },
      { n: 5, q: 'The US-China AI race mirrors the Cold War nuclear competition. Is this comparison accurate? What are the similarities and differences?' },
      { n: 6, q: 'Racing to build powerful technology without safety measures is like building a reactor without knowing how to prevent meltdown. Do you agree?' },
    ]
  },
  {
    number: 3, title: 'Can You Regulate What You Do Not Understand?', emoji: '📋', color: '#991b1b',
    text: `One of the fundamental challenges of AI regulation is that the people writing the laws often do not understand the technology they are trying to regulate.\n\nThis is not unique to AI. Regulators have struggled with every transformative technology — from the printing press to nuclear energy to the internet. But AI presents a particular challenge because the technology is advancing so rapidly that regulations written today may be obsolete by the time they are implemented.\n\nThe proposed superintelligence ban illustrates this difficulty. The bill defines superintelligence as AI that "exceeds human cognitive abilities across all domains." But what does "exceeds" mean? GPT-6 already outperforms most humans at many cognitive tasks — writing, coding, analysis, and pattern recognition. It underperforms at others — physical reasoning, common sense, and emotional understanding. Is it "superintelligent"? The answer depends on how you define the term — and the bill\'s definition is vague enough to encompass systems that may be built within a few years.\n\nThe AI industry itself is divided. Some researchers — including prominent figures like Geoffrey Hinton and Yoshua Bengio — have called for stronger regulation, arguing that the risks are real and urgent. Others — including many AI company executives — argue that regulation will stifle innovation, push research overseas, and prevent the development of beneficial applications.\n\nThe honest position is uncertainty. Nobody — not the regulators, not the researchers, not the company executives — knows exactly how powerful AI will become, how quickly it will get there, or what the consequences will be. Legislating in the face of such profound uncertainty is uncomfortable but necessary.`,
    vocab: [
      { word: 'Obsolete', definition: 'No longer useful or relevant — outdated and replaced by something newer.' },
      { word: 'Cognitive', definition: 'Relating to thinking, reasoning, understanding, and mental processes.' },
      { word: 'Stifle', definition: 'To suppress or prevent — holding back growth or progress.' },
      { word: 'Profound', definition: 'Very deep and significant — affecting the most fundamental aspects of something.' },
    ],
    questions: [
      { n: 7, q: 'Regulators often do not understand the technology they regulate. How can this problem be solved?' },
      { n: 8, q: 'AI experts themselves disagree about regulation. How should policymakers decide when the experts cannot agree?' },
      { n: 9, q: 'Legislating under uncertainty is uncomfortable but necessary. Do you agree? Is it better to act too early or too late?' },
    ]
  },
  {
    number: 4, title: 'The Biggest Question', emoji: '🌍', color: '#7f1d1d',
    text: `The proposal to ban superintelligence forces humanity to confront a question it has never had to answer before: should there be a technology that we choose not to build?\n\nThroughout history, humans have built every technology they have been capable of building. Nuclear weapons, biological weapons, surveillance systems, genetic modification — each was developed because it could be, even when many people argued it should not be. The idea that we would voluntarily stop developing a technology — not because we cannot build it, but because we choose not to — has no real precedent.\n\nThe argument for restraint is compelling. If superintelligent AI poses even a small probability of catastrophic harm, the expected cost — probability multiplied by impact — is enormous. When the potential impact is the end of human civilisation, even a 1% probability demands extreme caution.\n\nThe argument against restraint is equally compelling. AI could cure diseases that kill millions. It could solve climate change. It could eliminate poverty. Banning its development means accepting that these problems will persist — and that the people suffering from them will continue to suffer because others decided the risks were too high.\n\nThe proposed ban will almost certainly not pass in its current form. But the debate it has sparked is the most important conversation humanity can have. What kind of future do we want? How much risk are we willing to accept? And who gets to decide?\n\nThese are not technical questions. They are human questions — about values, priorities, and the kind of world we want to leave to the next generation. The technology is new. The questions are as old as civilisation itself.`,
    vocab: [
      { word: 'Precedent', definition: 'A previous example that sets a pattern — something that has happened before.' },
      { word: 'Restraint', definition: 'The act of holding back — choosing not to do something you are capable of doing.' },
      { word: 'Catastrophic', definition: 'Causing sudden, extreme disaster — the worst possible outcome.' },
      { word: 'Persist', definition: 'To continue existing — problems that remain unsolved.' },
    ],
    questions: [
      { n: 10, q: 'Should there be technologies we choose not to build? Has humanity ever successfully done this?' },
      { n: 11, q: 'AI could cure diseases or destroy civilisation. How do you weigh potential benefits against existential risks?' },
      { n: 12, q: 'Who gets to decide the future of AI — companies, governments, or the public? What would a democratic process look like?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "US Lawmakers Propose Ban on Superintelligent AI". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function AISuperBanPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US Lawmakers Propose Ban on Superintelligent AI</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>As OpenAI releases GPT-6, US lawmakers propose banning artificial superintelligence entirely. Can you ban a technology that does not exist yet, and should you try?</p>
            </div>
          </div>
