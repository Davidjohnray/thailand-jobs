...
const PARTS = [
  {
    number: 1, title: 'The Ancient Origins of the Olympics', emoji: '🏛️', color: '#f59e0b',
    text: `The Olympic Games are often described as the world's greatest sporting event, but their origins stretch back more than two and a half thousand years. The ancient Games were held at Olympia, a sacred site in western Greece, beginning around 776 BC. They were dedicated to Zeus, the chief god of the Greek pantheon, and formed part of a religious festival held every four years. Athletes travelled from across the Greek world to compete, and during the Games a period of truce was observed — wars were temporarily suspended so that competitors and spectators could travel safely.\n\nThe ancient Olympics were very different from the modern version. Only free Greek men were permitted to compete, and women were not allowed even to watch certain events. The programme was limited — early Games featured only a single footrace, before gradually expanding to include wrestling, chariot racing, the long jump, discus, and javelin. Victory brought enormous honour and reward: winners received an olive wreath and were celebrated as heroes in their home cities, sometimes receiving free meals for life and other privileges. The Games continued for over a thousand years before the Roman Emperor Theodosius I banned them in 393 AD, viewing them as a pagan practice incompatible with Christianity.`,
    vocab: [
      { word: 'Sacred', definition: 'Connected to a god or religion and deserving great respect — regarded as holy or spiritually significant.' },
      { word: 'Pantheon', definition: 'All the gods of a particular religion or mythology — the group of most important or celebrated figures in a field.' },
      { word: 'Truce', definition: 'A temporary agreement to stop fighting — a period of peace between opponents, often to allow a specific event to take place.' },
      { word: 'Pagan', definition: 'Relating to religious beliefs outside the main world religions — used historically to describe pre-Christian Greek and Roman worship.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think sport and religion were so closely connected in ancient Greek society? Is there still a connection between sport and culture or identity today?' },
      { n: 2, q: 'The ancient Olympics excluded women and non-Greeks. How does this reflect the society of the time, and how has sport changed in terms of inclusion since then?' },
      { n: 3, q: 'Do you think the idea of an Olympic truce — pausing conflicts during the Games — could have any relevance or symbolic value in the modern world?' },
    ]
  },
  {
    number: 2, title: 'The Revival and Growth of the Modern Olympics', emoji: '🔁', color: '#0ea5e9',
    text: `After fifteen centuries, the Olympic Games were reborn. A French educator named Pierre de Coubertin believed that international sporting competition could promote peace, physical education, and cross-cultural understanding. His efforts led to the first modern Olympic Games, held in Athens in 1896, with fourteen nations and around 250 athletes competing in forty-three events. The revival was not without controversy — some Greeks felt the Games should remain permanently in Athens — but Coubertin's vision of a travelling international competition prevailed.\n\nThroughout the twentieth century, the Olympics grew into a vast global spectacle. The 1936 Berlin Games, hosted by Nazi Germany, became politically charged when the Black American athlete Jesse Owens won four gold medals, directly challenging the host nation's ideology of racial superiority. The Cold War years saw the Games become a battleground for geopolitical rivalry, culminating in the American-led boycott of the 1980 Moscow Olympics and the Soviet-led counter-boycott of the 1984 Los Angeles Games. Women's participation expanded gradually — women first competed in 1900, but it was not until the 2012 London Games that every competing nation included female athletes for the first time.`,
    vocab: [
      { word: 'Revival', definition: 'The process of something becoming active, popular, or important again after a period of being forgotten or abandoned.' },
      { word: 'Spectacle', definition: 'A visually impressive or remarkable event — something dramatic and large-scale that attracts widespread attention.' },
      { word: 'Geopolitical', definition: 'Relating to the influence of geography and international politics on each other — how location and power interact globally.' },
      { word: 'Boycott', definition: 'A refusal to buy, use, or participate in something as a form of protest — withdrawing involvement to apply pressure.' },
    ],
    questions: [
      { n: 4, q: 'Pierre de Coubertin believed sport could promote international peace. Do you think the Olympic Games achieve this goal today, or has politics undermined the ideal?' },
      { n: 5, q: 'Jesse Owens\' performance in 1936 is often described as one of the most powerful moments in sporting history. Why do you think sport can sometimes challenge political ideologies more effectively than words?' },
      { n: 6, q: 'Should countries ever boycott the Olympics as a political statement? What are the arguments for and against this approach?' },
    ]
  },
  {
    number: 3, title: 'The Olympics in the Modern Era', emoji: '🏅', color: '#22c55e',
    text: `The modern Olympic Games have become one of the most commercially powerful events on the planet. Television rights, corporate sponsorship, and global broadcasting deals generate billions of dollars every four years. The International Olympic Committee, which governs the Games, has been both praised for expanding access to sport and criticised for corruption, lack of transparency, and the enormous financial burden placed on host cities. Several cities that hosted the Games — including Athens in 2004 and Rio de Janeiro in 2016 — were left with expensive stadiums and infrastructure that proved difficult to maintain or repurpose.\n\nThe inclusion of new sports has also been a subject of ongoing debate. In recent Games, skateboarding, surfing, sport climbing, and breaking have been added to the programme alongside traditional disciplines — a decision some see as a welcome effort to attract younger audiences, and others view as a dilution of the Games' identity. Doping — the use of prohibited performance-enhancing substances — has cast a shadow over the Olympics for decades. The Russian state-sponsored doping scandal, which led to many Russian athletes being banned or competing under a neutral flag, demonstrated how deeply the problem of cheating had penetrated elite sport at a national level.`,
    vocab: [
      { word: 'Corporate sponsorship', definition: 'Financial support provided by a company to an event or organisation in exchange for advertising and brand association.' },
      { word: 'Transparency', definition: 'The quality of being open, honest, and easy to understand — operating without secrecy or hidden processes.' },
      { word: 'Dilution', definition: 'The process of making something weaker or less effective by adding things to it — reducing the quality or purity of something.' },
      { word: 'Doping', definition: 'The use of banned substances or methods by athletes to improve performance — a form of cheating in competitive sport.' },
    ],
    questions: [
      { n: 7, q: 'Should the Olympic Games be permanently hosted in one location — such as Greece — rather than moving to a new city every four years? What would be the advantages and disadvantages?' },
      { n: 8, q: 'Do you think adding sports like skateboarding and breaking strengthens or weakens the Olympic brand? Where should the line be drawn between traditional and new sports?' },
      { n: 9, q: 'How should the Olympics deal with doping? Is lifetime bans the right approach, or should athletes who serve their ban be allowed to return and compete?' },
    ]
  },
  {
    number: 4, title: 'Sport, Identity, and the Future of the Games', emoji: '🌏', color: '#8b5cf6',
    text: `Beyond competition, the Olympics have always been about identity — national pride, cultural representation, and the human desire to test the limits of physical achievement. For many athletes, representing their country at the Games is the pinnacle of a sporting career, regardless of whether they win a medal. For smaller or less wealthy nations, a single Olympic medal can become a source of enormous national pride and inspire generations of future athletes.\n\nLooking ahead, the Olympic movement faces both opportunities and challenges. Climate change is already affecting host city selection — winter sports venues are increasingly threatened by lack of natural snow, and some traditional host regions may no longer be viable within decades. Growing calls for gender equality, athlete welfare, and LGBTQ+ inclusion have pushed the IOC to update its policies, though campaigners argue that progress remains slow. The 2024 Paris Games and the upcoming Los Angeles 2028 Games are both attempting to position sustainability and social inclusion as central themes. Whether the Olympics can adapt fast enough to remain relevant, inspire the world, and live up to the ideals of its founders — or whether it will increasingly be defined by politics, money, and scandal — remains one of sport's most fascinating open questions.`,
    vocab: [
      { word: 'Pinnacle', definition: 'The highest or most successful point of something — the peak of achievement in a career or field.' },
      { word: 'Viable', definition: 'Capable of working successfully — practical and able to be done or used effectively given the circumstances.' },
      { word: 'Sustainability', definition: 'The ability to continue over the long term without causing permanent damage to the environment or society.' },
      { word: 'Welfare', definition: 'The health, happiness, and general wellbeing of a person or group — their overall quality of life and protection from harm.' },
    ],
    questions: [
      { n: 10, q: 'Is national pride at the Olympics a positive or negative force? Can it bring people together, or does it sometimes encourage unhealthy nationalism?' },
      { n: 11, q: 'How should the Olympics balance commercial interests with the original ideals of amateur competition, peace, and international friendship?' },
      { n: 12, q: 'Overall, do you think the Olympic Games will still be relevant and inspiring in fifty years\' time? What would need to change — or stay the same — for that to happen?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "The Olympic Games — History and the Modern Era". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function OlympicsPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #7C3AED 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(245,158,11,0.7)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Sport & Society</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Olympic Games — History, Politics, and the Modern Era</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Faster, Higher, Stronger — explore the ancient origins of the Olympics, how the Games were reborn, and the complex role they play in our world today.</p>
            </div>
          </div>
