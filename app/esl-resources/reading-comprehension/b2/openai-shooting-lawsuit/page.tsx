...
const PARTS = [
  {
    number: 1, title: 'The Chatbot That Knew', emoji: '💬', color: '#dc2626',
    text: `This week, new lawsuits filed against OpenAI made a disturbing claim: that the company\'s AI chatbot showed clear warning signs before a mass shooting in Canada — and that OpenAI executives chose to protect the company\'s image rather than alert police.\n\nAccording to court documents, the alleged shooter had extensive conversations with ChatGPT in the weeks before the attack. The conversations reportedly included discussions about weapons, violent fantasies, and explicit references to planned harm. Internal recommendations at OpenAI to alert law enforcement were allegedly overruled by executives concerned about the negative publicity that would follow.\n\nOpenAI has denied the allegations, stating that its safety systems are robust and that it cooperates with law enforcement when legally required. The company has pointed to its content policies, which prohibit the generation of violent or harmful content, and its monitoring systems, which flag concerning user behaviour.\n\nBut the lawsuits raise a question that the AI industry has been avoiding: when an AI company detects that a user may be planning violence, what is its responsibility? Is it a technology platform — like a phone company that carries conversations without monitoring them? Or is it something new — an intelligent system that understands what users are saying and therefore has a moral obligation to act on dangerous information?`,
    vocab: [
      { word: 'Alleged', definition: 'Claimed but not yet proven — accused of something that has not been confirmed in court.' },
      { word: 'Law enforcement', definition: 'The police and other agencies responsible for enforcing laws and preventing crime.' },
      { word: 'Content policies', definition: 'Rules set by a company about what users are allowed to say or create using their service.' },
      { word: 'Obligation', definition: 'A duty or responsibility — something you are required to do.' },
    ],
    questions: [
      { n: 1, q: 'If an AI detects that a user may be planning violence, should the company alert police? What are the arguments for and against?' },
      { n: 2, q: 'The lawsuit claims executives chose image over safety. If true, how should this be punished?' },
      { n: 3, q: 'Is an AI chatbot like a phone company (neutral carrier) or something new (intelligent listener)? Why does this distinction matter?' },
    ]
  },
  {
    number: 2, title: 'AI Safety vs Privacy', emoji: '🔒', color: '#b91c1c',
    text: `The OpenAI lawsuit illuminates one of the most difficult tensions in AI development: the trade-off between safety and privacy.\n\nIf AI companies monitor every conversation to detect potential threats, they become surveillance tools — reading, analysing, and potentially reporting private conversations. This raises profound privacy concerns. People use AI chatbots for therapy, personal reflection, creative writing, and exploring ideas — including dark or uncomfortable ones. If users know their conversations are being monitored and might be reported to police, they will stop being honest — which undermines the value of the technology.\n\nBut if AI companies do not monitor conversations, they risk missing genuine threats. The Canadian shooting allegedly involved explicit planning discussions that a human reader would have immediately recognised as dangerous. If the AI system understood these conversations — which, given the sophistication of modern language models, it almost certainly did — the question of whether that understanding creates an obligation to act is unavoidable.\n\nThe analogy with other industries is imperfect but instructive. Therapists have a "duty to warn" — they are legally required to alert authorities if a patient expresses a credible threat of violence, even though therapy is otherwise confidential. Should AI companies have a similar duty? And if so, how would it be implemented without turning every chatbot into a surveillance system?`,
    vocab: [
      { word: 'Surveillance', definition: 'Monitoring and watching people\'s activities, usually for security purposes.' },
      { word: 'Undermines', definition: 'Gradually weakens or damages — making something less effective or trustworthy.' },
      { word: 'Duty to warn', definition: 'A legal requirement for professionals to alert authorities about credible threats of violence.' },
      { word: 'Credible', definition: 'Believable and realistic — a threat that could genuinely be carried out.' },
    ],
    questions: [
      { n: 4, q: 'Therapists must report credible threats despite confidentiality. Should AI chatbots have the same duty?' },
      { n: 5, q: 'If users know conversations are monitored, they stop being honest. How do you balance safety with trust?' },
      { n: 6, q: 'Where is the line between monitoring for safety and mass surveillance?' },
    ]
  },
  {
    number: 3, title: 'Who Is Responsible?', emoji: '⚖️', color: '#991b1b',
    text: `The lawsuits against OpenAI raise fundamental questions about responsibility in the age of AI.\n\nTraditionally, the person who commits a violent act is responsible for it. The tools they use — whether a knife, a gun, or a car — are not held responsible, and neither are the companies that made them. A car manufacturer is not liable when someone uses a car as a weapon. A phone company is not liable when criminals use phones to plan crimes.\n\nBut AI chatbots are different from passive tools. They engage in conversations. They understand context. They generate responses that can encourage, discourage, or redirect user behaviour. If a chatbot has a conversation with someone planning violence and responds in ways that normalise or facilitate that planning — even inadvertently — is the company that built it partially responsible for what happens next?\n\nThe legal framework for answering this question does not yet exist. Section 230 of the US Communications Decency Act protects internet platforms from liability for user-generated content. But AI-generated responses are not user-generated — they are created by the platform itself. This distinction could make AI companies more legally vulnerable than traditional social media platforms.\n\nThe courts will ultimately decide. But the outcome will shape the future of AI development — determining whether AI companies are treated as neutral tools, as publishers responsible for their output, or as something entirely new that requires its own legal category.`,
    vocab: [
      { word: 'Liable', definition: 'Legally responsible — required to pay damages or face punishment for harm caused.' },
      { word: 'Normalise', definition: 'To make something seem normal or acceptable that previously was not.' },
      { word: 'Inadvertently', definition: 'Without intending to — accidentally or unintentionally.' },
      { word: 'Legal framework', definition: 'The system of laws and rules that governs a particular area — the legal structure.' },
    ],
    questions: [
      { n: 7, q: 'A car company is not liable when someone uses a car as a weapon. Should an AI company be liable when someone uses a chatbot to plan violence?' },
      { n: 8, q: 'AI responses are generated by the platform, not by users. Does this make AI companies more responsible than social media platforms?' },
      { n: 9, q: 'Should AI be treated as a tool, a publisher, or something entirely new? What would each category mean in practice?' },
    ]
  },
  {
    number: 4, title: 'Building Safer AI', emoji: '🛡️', color: '#7f1d1d',
    text: `Regardless of how the lawsuits are decided, the OpenAI case has intensified the debate about how to build AI systems that are genuinely safe.\n\nThe AI safety community has long warned that the race to develop more powerful AI systems is moving faster than the development of safety measures. Companies face competitive pressure to release new models quickly — and safety testing takes time. The incentive structure rewards speed over caution.\n\nSeveral approaches to AI safety are being explored. Alignment research aims to ensure that AI systems pursue goals that are beneficial to humans. Red-teaming involves deliberately trying to make AI systems behave dangerously in order to identify and fix vulnerabilities. Interpretability research attempts to understand how AI systems make decisions — opening the "black box" so that potentially dangerous reasoning can be identified.\n\nBut the most fundamental question is governance. Who decides what is safe? Who sets the standards? Who enforces them? Currently, AI companies largely regulate themselves — setting their own safety policies and deciding how to implement them. The OpenAI lawsuit suggests that self-regulation may not be sufficient when commercial interests conflict with public safety.\n\nThe Canadian shooting victims cannot be brought back. But the legal and regulatory response to this case could shape how AI is developed, deployed, and governed for decades to come. The question is not whether AI should be safer — everyone agrees on that. The question is who makes it safer, and whether anyone is held accountable when it is not.`,
    vocab: [
      { word: 'Alignment', definition: 'Ensuring AI systems pursue goals that benefit humans rather than causing harm.' },
      { word: 'Red-teaming', definition: 'Deliberately testing a system by trying to break it — finding weaknesses before they cause harm.' },
      { word: 'Black box', definition: 'A system whose internal workings are hidden — you can see what goes in and out but not how it works.' },
      { word: 'Governance', definition: 'The system of rules, practices, and processes by which something is directed and controlled.' },
    ],
    questions: [
      { n: 10, q: 'Companies face pressure to release AI quickly. How can safety testing keep up with the speed of development?' },
      { n: 11, q: 'AI companies currently regulate themselves. Is self-regulation enough, or do we need government oversight?' },
      { n: 12, q: 'Who should decide what counts as safe AI? Engineers, governments, or the public?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "OpenAI Sued Over Canadian Mass Shooting". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>OpenAI Sued Over Canadian Mass Shooting</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>New lawsuits claim OpenAI executives prioritised company image over safety when their chatbot showed warning signs before a mass shooting. AI responsibility and the limits of technology.</p>
            </div>
          </div>
