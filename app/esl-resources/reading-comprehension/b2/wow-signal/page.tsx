...
const PARTS = [
  {
    number: 1, title: 'A Signal from the Deep', emoji: '📡', color: '#6366f1',
    text: `On the night of 15 August 1977, a radio telescope at the Ohio State University in the United States picked up an extraordinary signal from space. The telescope, nicknamed "Big Ear," was part of a programme called SETI — the Search for Extraterrestrial Intelligence — which had been systematically scanning the sky for unusual radio transmissions since the 1960s. The signal that arrived that night was unlike anything the programme had ever recorded.\n\nThe astronomer on duty, Jerry Ehman, was reviewing the computer printout of the telescope's data several days later when he noticed the anomaly. The signal appeared as a sequence of alphanumeric characters — the shorthand used by the programme to represent signal strength — and the sequence was so dramatically different from the background noise of space that Ehman circled it in red pen and wrote a single word in the margin: "Wow!"\n\nThat annotation gave the signal its name. The Wow! Signal, as it became known, remains to this day the strongest candidate for an artificial extraterrestrial radio transmission ever detected. It has never been satisfactorily explained, and despite decades of effort by radio astronomers around the world, it has never been detected again.\n\nThe signal lasted 72 seconds — the maximum duration for which Big Ear could observe any point in the sky as Earth rotated — and then it was gone. In those 72 seconds, it demonstrated several characteristics that made it deeply interesting to scientists. Understanding why requires a brief explanation of what SETI was looking for, and why this signal appeared to fit the profile so precisely.`,
    vocab: [
      { word: 'Alphanumeric', definition: 'Consisting of both letters and numbers, used together as a coding system.' },
      { word: 'Anomaly', definition: 'Something that deviates from what is standard, normal, or expected.' },
      { word: 'Artificial', definition: 'Made or produced by human beings or, in this context, by intelligent beings, rather than occurring naturally.' },
      { word: 'Duration', definition: 'The length of time that something lasts or continues.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think Jerry Ehman\'s single word "Wow!" became so famous? What does it suggest about how he felt in that moment?' },
      { n: 2, q: 'SETI has been scanning for signals since the 1960s. Does the length of the search make a single unexplained signal more or less significant to you?' },
      { n: 3, q: 'The signal has never been detected again. Does this absence make it more mysterious or less convincing as evidence of extraterrestrial life?' },
    ]
  },
  {
    number: 2, title: 'What Made the Signal So Unusual', emoji: '🔭', color: '#4f46e5',
    text: `To understand why the Wow! Signal was so remarkable, it helps to know what SETI scientists were looking for. The programme was based on a theoretical argument made in 1959 by physicists Giuseppe Cocconi and Philip Morrison, who proposed that any technologically advanced civilisation wishing to communicate across interstellar distances would most logically use radio waves — specifically at a frequency associated with hydrogen, the most abundant element in the universe. This frequency, known as the hydrogen line, sits at 1420 megahertz, and it was considered the most logical "cosmic watering hole" — a frequency that any intelligent species in the galaxy would recognise as meaningful.\n\nThe Wow! Signal arrived at almost exactly the hydrogen line frequency. This alone made it immediately interesting. But it had several other properties that distinguished it from natural sources of radio emission. It was narrowband — meaning it occupied an extremely narrow range of frequencies, which is characteristic of artificial transmissions and very unusual in natural phenomena. It was also powerful, registering at roughly 30 times the intensity of the background noise of space. And it appeared to come from a fixed point in space, consistent with a source far beyond our solar system.\n\nPerhaps most intriguingly, the signal displayed a characteristic rise-and-fall pattern in intensity that was entirely consistent with the way Big Ear's beam would scan across a fixed point in space as the Earth rotated. In other words, it behaved exactly as a genuine signal from a distant, fixed cosmic source should behave — not like local interference, not like a satellite, and not like any known natural phenomenon.\n\nThe combination of these properties led many astronomers to conclude — cautiously — that the Wow! Signal was the most compelling candidate for an artificial extraterrestrial transmission ever detected. The scientific consensus has never gone further than that.`,
    vocab: [
      { word: 'Interstellar', definition: 'Existing or occurring between stars, in the vast space that separates stellar systems.' },
      { word: 'Hydrogen line', definition: 'A specific radio frequency (1420 MHz) associated with hydrogen atoms, considered significant in SETI research.' },
      { word: 'Narrowband', definition: 'Occupying a very small range of frequencies, typical of artificial transmissions rather than natural sources.' },
      { word: 'Interference', definition: 'In radio, unwanted signals that disrupt or distort a legitimate transmission.' },
    ],
    questions: [
      { n: 4, q: 'Why do you think scientists chose the hydrogen line frequency as the most logical channel for interstellar communication?' },
      { n: 5, q: 'The signal was narrowband, powerful, and came from a fixed point in space. Which of these properties do you find most significant? Why?' },
      { n: 6, q: 'Scientists say the Wow! Signal was the "most compelling candidate" for alien contact, but no more. Why do you think scientists are so careful with their language in situations like this?' },
    ]
  },
  {
    number: 3, title: 'The Search for an Explanation', emoji: '🔍', color: '#4338ca',
    text: `In the decades since 1977, astronomers have made numerous attempts to re-detect the Wow! Signal. The Ohio State University Big Ear telescope itself was demolished in 1997 to make way for a golf course — a fact that many in the SETI community found painful — but other, more powerful instruments have since been pointed at the region of sky from which the signal appeared to originate.\n\nDespite extensive searches using some of the world's most sensitive radio telescopes, including the Arecibo Observatory in Puerto Rico before its collapse in 2020, and the FAST telescope in China — currently the world's largest radio dish — the signal has never been detected again. This non-repetition is both the most frustrating and the most significant feature of the case. A genuine transmission from an extraterrestrial civilisation might be expected to repeat, if it is a deliberate beacon, or to be detectable on further observation, if it is a continuous broadcast. The silence since 1977 remains unexplained.\n\nIn 2016, a team of researchers proposed a natural explanation for the signal. They suggested that it could have been caused by two comets passing through the field of view of the telescope at the time, their hydrogen clouds producing a brief, intense radio emission at the hydrogen line frequency. The comets in question had indeed been in the relevant region of the sky at the time, and the team published their findings in a peer-reviewed journal.\n\nThe cometary hypothesis was met with significant scepticism from many astronomers, however, who pointed out that comets had never been observed producing radio emissions of the intensity and narrowband characteristics of the Wow! Signal. The debate continues, and the most honest summary of the current scientific position remains what it has been for nearly fifty years: we do not know what caused the Wow! Signal.`,
    vocab: [
      { word: 'Demolished', definition: 'Deliberately destroyed or knocked down, usually a building or structure.' },
      { word: 'Beacon', definition: 'A signal or light used to guide or attract attention, especially over long distances.' },
      { word: 'Cometary', definition: 'Relating to comets — icy bodies that travel through the solar system, sometimes developing bright tails.' },
      { word: 'Hypothesis', definition: 'A proposed explanation for something, which has not yet been fully proven or accepted.' },
    ],
    questions: [
      { n: 7, q: 'The Big Ear telescope was demolished to build a golf course. What does this suggest about the priorities of the institutions involved? How does it make you feel?' },
      { n: 8, q: 'The comet hypothesis has been challenged by many astronomers. How should scientists decide between competing explanations when neither is fully proven?' },
      { n: 9, q: 'The signal has not repeated in nearly 50 years. Does this make an extraterrestrial explanation less likely, or are there scenarios in which a non-repeating signal could still be artificial?' },
    ]
  },
  {
    number: 4, title: 'What the Wow! Signal Means for Humanity', emoji: '🌌', color: '#3730a3',
    text: `The Wow! Signal occupies a unique position in the history of science and human culture. It is not proof of extraterrestrial intelligence — no serious scientist has ever claimed it is. But it is the closest thing to such proof that humanity has ever encountered, and its implications — both scientific and philosophical — are profound.\n\nFrom a purely scientific perspective, the signal demonstrates that SETI is not a merely theoretical enterprise. Something unusual happened at Big Ear on 15 August 1977. Whatever its cause, it falls outside the range of phenomena that our current understanding can definitively explain. This matters because it means the search is real, the instruments are capable of detecting anomalies, and the universe appears to contain signals that do not behave like noise. The argument for continuing and expanding the search gains force from the existence of the Wow! Signal, even though — or perhaps precisely because — it remains unexplained.\n\nPhilosophically, the signal raises questions that go to the very heart of what it means to be human. We are a species that has existed for a cosmic eyeblink, on a small planet orbiting an unremarkable star in one of hundreds of billions of galaxies. The Fermi Paradox — the observation that a universe as old and large as ours should, statistically, be teeming with intelligent life, and yet we appear to have found no evidence of any — has no satisfying answer. The Wow! Signal does not resolve the paradox, but it opens a door.\n\nFor 72 seconds in 1977, something in deep space produced a signal that matched, in almost every measurable respect, what scientists had theorised an extraterrestrial transmission would look like. Whether it was the product of an alien civilisation, a comet, or something else entirely, those 72 seconds changed the way many scientists and thinkers understood the question of whether we are alone. That question remains open. The Wow! Signal reminds us that it is not merely philosophical — it is scientific, and it is real.`,
    vocab: [
      { word: 'Enterprise', definition: 'A project or activity, especially one that requires effort and involves risk or uncertainty.' },
      { word: 'Fermi Paradox', definition: 'The contradiction between the high probability of extraterrestrial life and the lack of evidence for it.' },
      { word: 'Teeming', definition: 'Full of or swarming with a large number of people or things; abundantly populated.' },
      { word: 'Cosmic eyeblink', definition: 'A metaphor for an extremely short period of time relative to the age of the universe.' },
    ],
    questions: [
      { n: 10, q: 'The passage says the Wow! Signal "is the closest thing to proof of extraterrestrial intelligence that humanity has ever encountered." Does this statement surprise you? How does it change how you think about the signal?' },
      { n: 11, q: 'The Fermi Paradox asks why, if the universe should be full of intelligent life, we have found no evidence of any. What is your personal answer to the Fermi Paradox?' },
      { n: 12, q: 'If the Wow! Signal were definitively confirmed as an extraterrestrial transmission tomorrow, how do you think it would change human society, politics, and religion?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "The Wow! Signal — The Most Compelling Evidence of Alien Contact Ever Recorded". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#eef2ff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && (
        <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #c7d2fe' }}>
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && (
                  <div style={{ background: '#eef2ff', border: '1px solid #c7d2fe', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}>
...
export default function WowSignalPage() {
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(99,102,241,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Wow! Signal</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>For 72 seconds in 1977, a radio telescope detected something from deep space that matched, almost perfectly, what an alien transmission would look like. It has never been detected again.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#6366f1' : '#e5e7eb', background: translationLang !== 'none' ? '#eef2ff' : 'white', color: translationLang !== 'none' ? '#3730a3' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
        ...
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#eef2ff', padding: '8px 28px', borderBottom: '1px solid #c7d2fe' }}>
              <span style={{ color: '#3730a3', fontSize: '12px', fontWeight: '600' }}>
                    ...
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && (
                          <div style={{ marginTop: '6px', background: '#eef2ff', border: '1px solid #c7d2fe', borderRadius: '8px', padding: '8px 12px' }}>
                            <span style={{ color: '#3730a3', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
