...
const PARTS = [
  {
    number: 1, title: 'Why Email Writing Matters More Than Ever', emoji: '📧', color: '#3b82f6',
    text: `Despite the rise of instant messaging platforms such as Slack, Microsoft Teams, and WhatsApp, email remains the dominant form of written professional communication in most organisations worldwide. A working professional in an international business environment may send and receive dozens of emails every day — to clients, colleagues, managers, suppliers, and partners across different countries, time zones, and cultures. The quality of those emails directly affects how the sender is perceived: their professionalism, competence, and attention to detail.\n\nFor non-native English speakers, writing professional emails in English presents particular challenges. The conventions of professional email writing are not simply about grammar and vocabulary — they involve tone, register, structure, and cultural expectations that vary significantly between different English-speaking contexts. An email that seems appropriately direct and efficient to an Australian reader may seem rude to a Japanese recipient. An email that feels warmly polite in a Southeast Asian context may appear unnecessarily indirect to a British manager who simply wants a clear answer. Developing a confident, flexible email writing style — one that communicates clearly while adapting appropriately to its audience — is therefore one of the most practically valuable Business English skills a professional can develop.`,
    vocab: [
      { word: 'Dominant', definition: 'Most important or powerful — the form that is used most widely above all others.' },
      { word: 'Register', definition: 'The level of formality in language — professional register is more formal than casual conversation.' },
      { word: 'Convention', definition: 'An accepted way of doing something — the standard practices everyone in a context follows.' },
      { word: 'Competence', definition: 'The ability to do something well — being skilled and capable in a particular area.' },
    ],
    questions: [
      { n: 1, q: 'How many professional emails do you send or receive in a typical day? Do you find writing them easy or difficult?' },
      { n: 2, q: 'Has a poorly written email ever caused a misunderstanding or problem for you at work? What happened?' },
      { n: 3, q: 'Do you think email etiquette is different in your country compared to Western business contexts?' },
    ]
  },
  {
    number: 2, title: 'Structure, Subject Lines and Opening Phrases', emoji: '📐', color: '#8b5cf6',
    text: `A well-written professional email follows a clear and logical structure. It begins with an appropriate greeting, states its purpose quickly and clearly, provides the necessary information or request, and closes with a professional sign-off. Readers of business emails are typically busy — they want to understand immediately what an email is about and what, if anything, they need to do. An email that buries its main point in the third paragraph, or that requires the reader to scroll through background information before reaching the actual request, wastes time and risks being misread or ignored.\n\nThe subject line is one of the most important elements of any professional email, yet it is often treated as an afterthought. A vague subject line — "Question" or "Follow up" — gives the reader no useful information and makes the email harder to find later. A specific, informative subject line — "Request for Q3 budget approval by Friday 15 June" or "Meeting rescheduled: Team review now Thursday 3pm" — tells the reader immediately what the email contains and what action may be required. Opening phrases set the tone for everything that follows: "I hope this email finds you well" is widely used but increasingly considered overly formal and impersonal in many contexts; "I'm writing to confirm our meeting next Tuesday" or "Further to our conversation yesterday" gets straight to the point while remaining professional.`,
    vocab: [
      { word: 'Sign-off', definition: 'The closing phrase before your name in an email — "Best regards", "Kind regards", "Yours sincerely".' },
      { word: 'Afterthought', definition: 'Something added at the last moment without careful consideration — not given enough attention.' },
      { word: 'Vague', definition: 'Unclear and imprecise — not giving enough information to be useful.' },
      { word: 'Bury', definition: 'To hide something among other content — burying the main point means putting it where it is hard to find.' },
    ],
    questions: [
      { n: 4, q: 'How do you write your subject lines? Have you ever changed your approach after realising they were unclear?' },
      { n: 5, q: 'How quickly do you state your purpose in an email? Do you warm up first or get straight to the point?' },
      { n: 6, q: 'Which email opening do you prefer — "I hope this email finds you well" or something more direct? Why?' },
    ]
  },
  {
    number: 3, title: 'Tone, Politeness and Saying Difficult Things', emoji: '⚖️', color: '#f59e0b',
    text: `One of the most nuanced aspects of professional email writing is calibrating the right tone for each situation. Too formal and the email can feel cold, distant, or bureaucratic. Too casual and it may undermine the writer's authority or appear unprofessional to the reader. The right tone depends on the relationship between sender and recipient, the culture of the organisation, the seriousness of the topic, and the national or cultural background of the reader. Generally speaking, it is safer to begin a new professional relationship with a more formal tone and adjust toward informality as familiarity develops.\n\nAmong the most challenging emails to write are those that carry difficult messages — a complaint, a refusal, a request that has not been fulfilled, or a sensitive piece of feedback. Native English speakers use a range of softening strategies to deliver difficult messages professionally. Passive voice can soften the attribution of responsibility: "The invoice appears to have been sent to the wrong address" is less confrontational than "You sent the invoice to the wrong address." Modal verbs add politeness: "I would be grateful if you could..." is softer than "Please..." Phrases like "I understand that..." or "I appreciate that..." acknowledge the other person's situation before stating a difficulty. Learning these strategies allows non-native speakers to handle sensitive situations in writing without coming across as either aggressive or overly apologetic.`,
    vocab: [
      { word: 'Nuanced', definition: 'Having subtle differences that are important to understand — not straightforward or simple.' },
      { word: 'Calibrating', definition: 'Carefully adjusting something to the right level — finding the perfect balance for a specific situation.' },
      { word: 'Confrontational', definition: 'Likely to cause conflict or argument — aggressive or challenging in tone.' },
      { word: 'Modal verbs', definition: 'Auxiliary verbs like could, would, might — used to express possibility, politeness or uncertainty.' },
    ],
    questions: [
      { n: 7, q: 'Have you ever received an email that seemed rude even though it may not have been intended that way? What made it feel that way?' },
      { n: 8, q: 'How do you write an email to complain about something professionally without sounding aggressive?' },
      { n: 9, q: 'Is it ever appropriate to use passive voice to avoid assigning blame in a professional email? Give an example.' },
    ]
  },
  {
    number: 4, title: 'Reply Times, CC Etiquette and Common Mistakes', emoji: '🕐', color: '#22c55e',
    text: `Beyond the content of emails themselves, professional email culture involves a set of unwritten norms about behaviour that vary between organisations and industries. Reply time expectations differ significantly: in some organisations, a reply within one hour is considered standard; in others, 24 hours is acceptable. Not replying at all — even to say that you have received an email and will respond in detail shortly — is almost always considered unprofessional. A brief acknowledgement: "Thank you for your email — I'll come back to you by end of day Thursday" costs almost nothing to write and prevents the sender from wondering whether their message was received.\n\nThe use of CC (carbon copy) and BCC (blind carbon copy) is another area where professionals frequently make mistakes. CC should be used sparingly — adding people to CC unnecessarily fills their inboxes with irrelevant correspondence and can create confusion about who is responsible for taking action. Reply all is one of the most frequently misused functions in professional email: sending a lengthy reply to every person who was CC'd on an email when only the original sender needs your response wastes everyone's time and is widely considered poor email etiquette. Finally, proofreading remains essential — a single typo in a client email, a misplaced decimal point in a figure, or an accidentally sent draft can undermine weeks of careful relationship-building. In professional communication, the details always matter.`,
    vocab: [
      { word: 'Acknowledgement', definition: 'A message confirming that something has been received — letting someone know you have seen their email.' },
      { word: 'Sparingly', definition: 'In small amounts and only when necessary — not overusing something.' },
      { word: 'Etiquette', definition: 'The accepted rules of polite behaviour in a particular social or professional context.' },
      { word: 'Proofreading', definition: 'Carefully reading text to find and correct errors before sending or publishing.' },
    ],
    questions: [
      { n: 10, q: 'How quickly do you typically reply to professional emails? Do you think your reply time is appropriate?' },
      { n: 11, q: 'Have you ever made an embarrassing mistake in a professional email — a wrong recipient, a typo, or a missing attachment?' },
      { n: 12, q: 'What is the single most important piece of advice you would give to someone who wants to improve their professional email writing?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Writing Professional Emails in English". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function ProfessionalEmailsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Writing Professional Emails</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Clear, Confident, Professional — master the structure, tone and strategies needed to write effective emails in any business context.</p>
            </div>
          </div>
