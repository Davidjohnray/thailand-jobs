...
const PARTS = [
  {
    number: 1, title: 'Three Votes, Zero Effect', emoji: '🗳️', color: '#dc2626',
    text: `The United States House of Representatives voted this week — for the third time — to end the war on Iran. Seven Republican members crossed party lines to join Democrats in passing the resolution. It was the most bipartisan war-ending vote since the early days of the Iraq War. And it will almost certainly change nothing.\n\nThe resolution, passed under the War Powers Act, directs the President to withdraw US forces from hostilities with Iran within 30 days. Previous identical resolutions passed the House in March and June. Both times, the Senate failed to hold a vote, effectively killing the measure. Even if the Senate does vote this time, President Trump has indicated he would veto the resolution — and there are not enough votes to override a veto.\n\nThe result is a constitutional paradox: a majority of the elected representatives of the American people have voted to end a war that the President started without congressional authorisation. But the President has the power to ignore them. The war continues. People continue to die. And the institution that the Constitution designates as the sole authority to declare war is powerless to stop one.\n\nFor critics of executive power, this is the most serious constitutional crisis since Watergate. For supporters of the President, it is simply the Commander-in-Chief exercising his authority to defend the nation. The gap between these two positions may define American politics for a generation.`,
    vocab: [
      { word: 'Bipartisan', definition: 'Supported by members of both political parties — crossing party lines.' },
      { word: 'War Powers Act', definition: 'A US law that limits the President ability to commit forces to combat without Congress approval.' },
      { word: 'Veto', definition: 'The President power to reject a law passed by Congress.' },
      { word: 'Commander-in-Chief', definition: 'The supreme military commander — in the US, the President.' },
    ],
    questions: [
      { n: 1, q: 'Congress has voted three times to end the war and been ignored. What does this say about the balance of power in the US?' },
      { n: 2, q: 'The Constitution says only Congress can declare war. The President started this one without permission. Is this legal?' },
      { n: 3, q: 'Is this a constitutional crisis, or just normal politics? Where is the line?' },
    ]
  },
  {
    number: 2, title: 'The War Powers Question', emoji: '📜', color: '#b91c1c',
    text: `The US Constitution is clear: Congress has the power to declare war. The President commands the military. This division was deliberate — the Founding Fathers wanted to prevent any single individual from taking the country to war on their own.\n\nBut in practice, this system has been eroding for decades. No American president has asked Congress for a formal declaration of war since World War II. Korea, Vietnam, Iraq, Afghanistan, Libya, Syria — all were fought without declarations of war. Presidents have used various legal justifications — UN resolutions, congressional authorisations short of declarations, and claims of executive authority — to bypass the constitutional requirement.\n\nThe War Powers Act of 1973 was supposed to fix this. Passed after the Vietnam War, it requires the President to notify Congress within 48 hours of committing forces and limits deployments to 60 days without congressional authorisation. But presidents of both parties have ignored or worked around the law, and no court has ever enforced it.\n\nThe Iran war has pushed this constitutional ambiguity to its breaking point. The President ordered strikes on Iran without consulting Congress. He has continued the war for months without authorisation. And when Congress votes to end it, he ignores the vote. The system designed to prevent one person from waging war alone has comprehensively failed.`,
    vocab: [
      { word: 'Founding Fathers', definition: 'The political leaders who created the United States Constitution in the 1780s.' },
      { word: 'Eroding', definition: 'Gradually being worn away — losing strength and effectiveness over time.' },
      { word: 'Ambiguity', definition: 'Unclear meaning — when something can be interpreted in more than one way.' },
      { word: 'Comprehensively', definition: 'Completely and thoroughly — in every aspect.' },
    ],
    questions: [
      { n: 4, q: 'No US president has formally declared war since WWII. Every war since has been fought without one. Does this matter?' },
      { n: 5, q: 'The War Powers Act was supposed to limit presidential war powers. It has never been enforced. Why not?' },
      { n: 6, q: 'Should one person have the power to start a war? How should democracies make decisions about going to war?' },
    ]
  },
  {
    number: 3, title: 'Congress vs the President', emoji: '⚔️', color: '#991b1b',
    text: `The Iran war vote exposes a deeper problem in American democracy: the growing imbalance between presidential and congressional power.\n\nOver the past century, power has shifted steadily from Congress to the President. Executive orders bypass legislation. Emergency declarations bypass congressional spending decisions. And the national security apparatus — the CIA, NSA, Pentagon, and intelligence community — answers to the President, not to Congress.\n\nCongress has contributed to its own weakness. Rather than asserting its constitutional authority, it has repeatedly delegated power to the executive branch — passing broad authorisations that give presidents flexibility to act without returning for permission. The 2001 Authorisation for Use of Military Force — passed after 9/11 to target al-Qaeda — has been used to justify military operations in more than a dozen countries over 25 years. Congress never intended such broad application, but it never revoked the authorisation either.\n\nThe result is a system in which the President functions as something close to an elected monarch in foreign affairs — making war, signing treaties, and directing foreign policy with minimal congressional input. The Iran war is the most extreme example yet, but it is the product of a long trend rather than a sudden departure.\n\nSome scholars argue that strong presidential war powers are necessary in a world of rapid threats. Others argue that unchecked executive power is exactly what the Constitution was designed to prevent. The House vote this week represents the legislative branch asserting its relevance — and being reminded of its impotence.`,
    vocab: [
      { word: 'Executive orders', definition: 'Presidential directives that have the force of law without requiring congressional approval.' },
      { word: 'Delegated', definition: 'Transferred authority to someone else — giving away power that was originally yours.' },
      { word: 'Revoked', definition: 'Cancelled or taken back — withdrawing something that was previously granted.' },
      { word: 'Impotence', definition: 'Powerlessness — the inability to act effectively despite wanting to.' },
    ],
    questions: [
      { n: 7, q: 'Power has shifted from Congress to the President over a century. Is this reversible?' },
      { n: 8, q: 'The 2001 authorisation for Afghanistan has been used to justify wars in 12+ countries. Should old laws expire?' },
      { n: 9, q: 'Should the President be an "elected monarch" in foreign affairs, or should Congress have equal power?' },
    ]
  },
  {
    number: 4, title: 'What Democracy Requires', emoji: '🌍', color: '#7f1d1d',
    text: `The three failed votes to end the Iran war teach a lesson that extends far beyond American politics: democracy requires more than elections. It requires institutions that function, powers that are balanced, and leaders who respect the rules even when breaking them is convenient.\n\nElections give people a voice. But between elections, that voice is expressed through institutions — legislatures, courts, regulatory bodies, and the rule of law. When these institutions are weakened — when the President can ignore Congress, when courts are packed with loyalists, when regulatory agencies are gutted — elections become less meaningful. You can vote, but the people you elect cannot govern.\n\nThis pattern is visible in democracies around the world. In Hungary, Poland, Turkey, and elsewhere, elected leaders have systematically weakened the institutions that check their power — while maintaining the appearance of democracy through regular elections. The US, long considered the gold standard of democratic governance, is now exhibiting similar symptoms.\n\nThe Iran war vote is a small but telling indicator. A majority of elected representatives voted to end a war. The President ignored them. If a democracy cannot control when its military kills people in its name, what can it control?\n\nThe answer depends on what citizens demand. Institutional strength is not automatic — it is maintained by people who insist on it. The House members who voted to end the war may not have succeeded, but they placed their opposition on the record. History will judge whether their colleagues — and the American public — cared enough to join them.`,
    vocab: [
      { word: 'Institutions', definition: 'The organisations and systems that make government work — courts, legislatures, agencies.' },
      { word: 'Packed', definition: 'Filled with political allies — appointing supporters to positions of power.' },
      { word: 'Gutted', definition: 'Stripped of resources and effectiveness — hollowed out from the inside.' },
      { word: 'Exhibiting', definition: 'Showing or displaying — demonstrating symptoms or characteristics.' },
    ],
    questions: [
      { n: 10, q: 'Democracy requires more than elections. What else does it need to function properly?' },
      { n: 11, q: 'Leaders in Hungary, Turkey, and elsewhere weaken institutions while keeping elections. Is this still democracy?' },
      { n: 12, q: 'If a democracy cannot control when its military kills people, what can it control? How do you answer this question?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "US House Votes to End Iran War — For the Third Time". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function HouseIranPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US House Votes to End Iran War — For the Third Time</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Congress voted to end the war on Iran for the third time. The President ignores it. The constitutional crisis of a war that nobody authorised and nobody can stop.</p>
            </div>
          </div>
