...
const PARTS = [
  {
    number: 1, title: 'The Reporter Who Knew Too Much', emoji: '💣', color: '#dc2626',
    text: `In 2017, Daphne Caruana Galizia — Malta\'s most famous investigative journalist — was killed by a car bomb as she drove near her home. She was 53 years old. Her murder shocked Europe and became a symbol of the dangers facing journalists who expose corruption.\n\nCaruana Galizia had spent decades investigating corruption in Malta — a tiny Mediterranean island nation with a population of just 500,000. Her blog, "Running Commentary," exposed connections between Maltese politicians, organised crime, and international money laundering. She was hated by the powerful people she wrote about, and loved by the ordinary Maltese citizens who relied on her reporting.\n\nThis week, a jury in Malta acquitted Yorgen Fenech — a wealthy businessman accused of ordering her assassination. Fenech, who had been in custody since 2019, was found not guilty despite what prosecutors described as overwhelming evidence. The verdict has been met with outrage by press freedom organisations worldwide.\n\nFor Caruana Galizia\'s family, the acquittal is devastating. Her sons, who have continued her investigative work, described the verdict as "a message to anyone who wants to silence a journalist: in Malta, you can get away with it." For the broader journalism community, the case raises alarming questions about whether justice is achievable when the people accused of crimes are wealthier and more powerful than the institutions meant to hold them accountable.`,
    vocab: [
      { word: 'Investigative journalist', definition: 'A reporter who conducts deep, long-term research to expose hidden wrongdoing.' },
      { word: 'Acquitted', definition: 'Found not guilty by a court — cleared of criminal charges.' },
      { word: 'Money laundering', definition: 'The process of making illegally obtained money appear legitimate.' },
      { word: 'Accountability', definition: 'Being held responsible for actions — facing consequences for wrongdoing.' },
    ],
    questions: [
      { n: 1, q: 'A journalist was killed by a car bomb for exposing corruption. What does this tell us about the risks of investigative journalism?' },
      { n: 2, q: 'The accused businessman was acquitted despite what prosecutors called overwhelming evidence. What could explain this?' },
      { n: 3, q: 'Her sons said the verdict means you can get away with silencing journalists in Malta. Do you agree with their assessment?' },
    ]
  },
  {
    number: 2, title: 'Why Journalists Die', emoji: '🎤', color: '#b91c1c',
    text: `Daphne Caruana Galizia is far from the only journalist killed for doing their job. According to the Committee to Protect Journalists, more than 1,600 journalists have been killed worldwide since 1992. In the vast majority of cases, the killers are never brought to justice.\n\nJournalists are killed because they threaten the interests of powerful people. When a reporter exposes corruption, the corrupt official loses money, power, or freedom. When a journalist reveals links between politicians and organised crime, careers are destroyed. When an investigative report uncovers human rights abuses, governments face international pressure. For people with enough power and enough to lose, silencing a journalist can seem like a rational — if horrifying — calculation.\n\nThe countries where journalists face the greatest danger are those where corruption is widespread, the rule of law is weak, and press freedom protections are inadequate. Mexico, the Philippines, Pakistan, Somalia, and Syria are consistently among the most dangerous countries for journalists. But Caruana Galizia\'s murder showed that even in Europe — which prides itself on press freedom — journalists are not safe when they challenge the wrong people.\n\nMalta, despite being an EU member state, has been criticised for years for its weak anti-corruption institutions, its opaque business environment, and its failure to protect journalists. The acquittal of Fenech reinforces these criticisms and raises questions about whether small countries with concentrated economic and political power can maintain independent justice systems.`,
    vocab: [
      { word: 'Impunity', definition: 'Freedom from punishment — being able to act without facing consequences.' },
      { word: 'Rule of law', definition: 'The principle that everyone is subject to the law equally — no one is above it.' },
      { word: 'Opaque', definition: 'Not transparent — difficult to see through or understand, often deliberately hidden.' },
      { word: 'Concentrated', definition: 'Gathered in a small area or among few people — not spread out.' },
    ],
    questions: [
      { n: 4, q: '1,600 journalists killed since 1992 and most killers never caught. Why does journalism remain so dangerous?' },
      { n: 5, q: 'Malta is in the EU but failed to protect a journalist or convict her alleged killer. Should the EU intervene?' },
      { n: 6, q: 'Small countries with concentrated power struggle with independent justice. Is size a factor in corruption?' },
    ]
  },
  {
    number: 3, title: 'Press Freedom Under Pressure', emoji: '📊', color: '#991b1b',
    text: `The Malta case is part of a global trend: press freedom is declining worldwide. According to Reporters Without Borders, the situation for journalism has deteriorated in 70% of countries over the past five years.\n\nThe threats to press freedom take many forms. In authoritarian countries, journalists are imprisoned, tortured, and killed. China holds more journalists in prison than any other country. Russia has effectively eliminated independent media. In Saudi Arabia, the murder of journalist Jamal Khashoggi inside the Saudi consulate in Istanbul in 2018 demonstrated that some governments will pursue critical journalists even in foreign countries.\n\nIn democracies, the threats are subtler but still serious. Politicians who describe the media as "the enemy of the people" undermine public trust in journalism. Defamation lawsuits — sometimes called "SLAPP suits" — are used by wealthy individuals and corporations to silence critical reporting through the threat of expensive legal action. And the economic collapse of traditional media means that many newsrooms lack the resources for the kind of long-term investigative journalism that holds the powerful to account.\n\nThe digital age has created new threats. Online harassment, doxxing, and coordinated abuse campaigns target journalists — particularly women journalists — with the goal of driving them out of the profession. Social media algorithms amplify misinformation while devaluing careful, fact-based reporting.\n\nDaphne Caruana Galizia\'s murder and the acquittal of her alleged killer are extreme examples. But they exist on a spectrum of threats that is making journalism harder, more dangerous, and less viable as a profession — at precisely the time when the world needs it most.`,
    vocab: [
      { word: 'Authoritarian', definition: 'A system where one leader or party holds total power and limits individual freedoms.' },
      { word: 'SLAPP suits', definition: 'Lawsuits designed to silence critics by burdening them with the cost of legal defence.' },
      { word: 'Doxxing', definition: 'Publishing someone private information online to intimidate or endanger them.' },
      { word: 'Algorithms', definition: 'Mathematical rules that social media platforms use to decide what content to show users.' },
    ],
    questions: [
      { n: 7, q: 'Press freedom has declined in 70% of countries. Why is this happening and what are the consequences?' },
      { n: 8, q: 'Rich people use expensive lawsuits to silence journalists. How can reporters be protected from this?' },
      { n: 9, q: 'Online harassment targets journalists, especially women. How does this affect what stories get reported?' },
    ]
  },
  {
    number: 4, title: 'Why It Matters to You', emoji: '🌍', color: '#7f1d1d',
    text: `You might wonder why the murder of a journalist on a small Mediterranean island matters to you. The answer is that press freedom affects everyone — including people who never read a newspaper.\n\nJournalists are the immune system of democracy. They detect problems — corruption, abuse, incompetence — and alert the public. Without them, the powerful operate without oversight. Taxpayer money is stolen. Environmental regulations are ignored. Public health is compromised. The things that affect your daily life — the quality of your food, the safety of your roads, the honesty of your government — depend partly on journalists doing their job.\n\nWhen journalists are killed, imprisoned, or silenced, the diseases they would have detected go undiagnosed. Corruption thrives. Abuses continue. And the people who suffer most are ordinary citizens who depend on public institutions to work properly.\n\nThe Malta acquittal sends a chilling message: that in some places, the powerful can silence their critics and face no consequences. But it also sends another message — less visible but equally important. Caruana Galizia\'s sons continue her work. Other Maltese journalists have taken up her investigations. Press freedom organisations worldwide have rallied behind her legacy.\n\nDaphne Caruana Galizia was killed because she believed that the truth matters more than the comfort of the powerful. The acquittal of her alleged killer does not change that belief. It strengthens it. Because every time a journalist is silenced and someone else picks up the story, it proves that the truth is harder to kill than any one person.`,
    vocab: [
      { word: 'Immune system', definition: 'The body defence against disease — here used as a metaphor for journalism protecting democracy.' },
      { word: 'Oversight', definition: 'Supervision and monitoring — watching to ensure rules are followed and power is not abused.' },
      { word: 'Chilling', definition: 'Frightening in a way that discourages action — creating fear that prevents people from speaking up.' },
      { word: 'Legacy', definition: 'What someone leaves behind — the lasting impact of their life and work.' },
    ],
    questions: [
      { n: 10, q: 'The passage calls journalists the immune system of democracy. Do you agree? What happens when this system fails?' },
      { n: 11, q: 'Her sons continue her investigations. Is this brave, foolish, or both?' },
      { n: 12, q: 'The truth is harder to kill than any one person. Do you believe this? What gives you hope — or doubt?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Malta Journalist Murder — Acquittal Shocks Europe". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function MaltaJournalistPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Malta Journalist Murder — Acquittal Shocks Europe</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A businessman was acquitted of ordering the car-bomb murder of journalist Daphne Caruana Galizia. Press freedom, corruption, and what happens when the powerful escape justice.</p>
            </div>
          </div>
