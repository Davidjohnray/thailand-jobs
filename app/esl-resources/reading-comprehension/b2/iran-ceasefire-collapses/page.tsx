...
const PARTS = [
  {
    number: 1, title: 'The Deal Falls Apart', emoji: '💥', color: '#dc2626',
    text: `This week, the 60-day ceasefire between the United States and Iran expired without a new agreement. The White House announced it would not seek an extension. President Trump called on Tehran to "put up the white flag of surrender." Iran's Foreign Ministry responded by declaring a shift to a "fully offensive" military posture. After weeks of cautious diplomacy, both sides are back on a war footing.\n\nThe collapse was not unexpected. The ceasefire, brokered in June with Omani mediation, was always fragile — a pause rather than a resolution. Its terms required both sides to freeze military operations while negotiators worked on a comprehensive deal covering Iran's nuclear programme, the Strait of Hormuz, and the withdrawal of US forces from the region. None of these issues were resolved.\n\nThe immediate consequences are serious. The US Navy is helping tankers sneak through the Strait of Hormuz by turning off ship transponders — an extraordinary measure that reveals how restricted the waterway remains. Oil prices spiked on the news. The USS Abraham Lincoln is finally heading home, but other naval assets remain deployed. And Treasury Secretary Bessent announced what he called "the greatest coordinated economic isolation in history" — comprehensive sanctions targeting Iran and any country that trades with it.\n\nFor the millions of people in the region, the collapse of the ceasefire means a return to uncertainty, fear, and the constant possibility of escalation into full-scale war.`,
    vocab: [
      { word: 'Ceasefire', definition: 'An agreement to temporarily stop fighting — a pause in a conflict.' },
      { word: 'War footing', definition: 'A state of readiness for military action — prepared for conflict.' },
      { word: 'Transponders', definition: 'Electronic devices on ships that broadcast their identity and location.' },
      { word: 'Sanctions', definition: 'Economic punishments imposed on a country to pressure it to change behaviour.' },
    ],
    questions: [
      { n: 1, q: 'The ceasefire expired and both sides returned to hostile positions. Was the ceasefire a failure, or did it buy valuable time?' },
      { n: 2, q: 'The US is helping tankers sneak through Hormuz with transponders off. What does this tell us about the current situation?' },
      { n: 3, q: 'Trump told Iran to surrender. Iran declared offensive posture. How does this language make peace harder to achieve?' },
    ]
  },
  {
    number: 2, title: 'Economic Warfare', emoji: '💰', color: '#b91c1c',
    text: `With military options limited and public appetite for a ground war virtually nonexistent, the US has turned to its most powerful non-military weapon: economic warfare.\n\nThe new sanctions target not just Iran but any country that does business with it — a strategy called "secondary sanctions." In practice, this means that a Chinese company buying Iranian oil, a Turkish bank processing Iranian transactions, or an Indian refinery importing Iranian crude could all face American penalties. The message is stark: "You are either with us or against us."\n\nThe impact on Iran's economy has been devastating. The Iranian rial has lost more than 60% of its value since the conflict began. Inflation has soared. Basic goods — food, medicine, fuel — have become unaffordable for millions of ordinary Iranians. Youth unemployment, already high, has worsened dramatically.\n\nBut sanctions are a blunt instrument. They hurt ordinary people far more than the leaders they are designed to pressure. Iranian elites have access to foreign bank accounts, black market goods, and smuggling networks. Iranian citizens do not. The humanitarian cost of sanctions — measured in hunger, untreated illness, and economic despair — falls disproportionately on those with the least power to change their government's behaviour.\n\nThe effectiveness of sanctions as a tool for changing regime behaviour is hotly debated among scholars. Cuba, North Korea, and Russia have all endured decades of sanctions without changing course. Whether Iran will be different remains to be seen.`,
    vocab: [
      { word: 'Secondary sanctions', definition: 'Penalties imposed on third countries that do business with the targeted country.' },
      { word: 'Rial', definition: 'The currency of Iran — its value has collapsed under sanctions pressure.' },
      { word: 'Blunt instrument', definition: 'A tool that is not precise — causing widespread damage rather than targeted impact.' },
      { word: 'Regime', definition: 'A government, especially one that is authoritarian or unelected.' },
    ],
    questions: [
      { n: 4, q: 'Secondary sanctions punish countries that trade with Iran. Is it fair to force other countries to choose sides?' },
      { n: 5, q: 'Sanctions hurt ordinary Iranians more than leaders. Is this acceptable collateral damage, or is it morally wrong?' },
      { n: 6, q: 'Cuba and North Korea endured decades of sanctions without changing. Will Iran be different? Why or why not?' },
    ]
  },
  {
    number: 3, title: 'The Regional Fallout', emoji: '🌍', color: '#991b1b',
    text: `The collapse of the US-Iran ceasefire does not just affect America and Iran — it sends shockwaves across the entire Middle East and beyond.\n\nIn Yemen, Houthi rebels — long supported by Iran — have clashed with Yemeni government forces in the largest-scale fighting since the 2022 truce. The fighting threatens to reignite a civil war that has already killed more than 150,000 people and created one of the world's worst humanitarian crises.\n\nIn the Gulf states — Saudi Arabia, the UAE, Kuwait, Qatar, and Bahrain — the conflict creates an impossible dilemma. These countries depend on American military protection but also need stable relations with Iran, their neighbour across the water. A wider war would threaten their oil exports, their economies, and potentially their physical safety.\n\nFor countries further afield, the primary concern is energy. Oil prices have remained elevated since the Hormuz crisis began, adding to inflationary pressures worldwide. For oil-importing countries like Thailand, Japan, and India, higher energy prices translate directly into higher costs for transport, manufacturing, and food — affecting every citizen.\n\nThe ceasefire's collapse also damages the credibility of diplomacy itself. If a deal brokered with international mediation can expire without replacement, what incentive do other countries in other conflicts have to negotiate? The failure sends a message that might makes right — and that agreements are only as strong as the willingness of the strongest party to honour them.`,
    vocab: [
      { word: 'Fallout', definition: 'The negative consequences that spread outward from a central event.' },
      { word: 'Reignite', definition: 'To start again after a period of calm — bringing a conflict back to life.' },
      { word: 'Inflationary', definition: 'Causing prices to rise across the economy — reducing the value of money.' },
      { word: 'Credibility', definition: 'The quality of being believed and trusted — whether people take you seriously.' },
    ],
    questions: [
      { n: 7, q: 'The Yemen war may restart because of the US-Iran conflict. How do conflicts in one country spread to others?' },
      { n: 8, q: 'Gulf states need both US protection and Iranian stability. How do small countries navigate between two powerful enemies?' },
      { n: 9, q: 'If ceasefire deals can expire without replacement, does this discourage future negotiations?' },
    ]
  },
  {
    number: 4, title: 'What Comes Next?', emoji: '🔮', color: '#7f1d1d',
    text: `The US-Iran conflict has reached a dangerous inflection point. The ceasefire is over. Sanctions are tightening. Military forces remain deployed. And neither side shows any willingness to compromise.\n\nThree scenarios are possible. The first is a return to the negotiating table — perhaps after both sides have demonstrated sufficient strength to satisfy domestic audiences. This is the optimistic scenario, and it requires both governments to prioritise pragmatism over pride.\n\nThe second is a prolonged cold war — ongoing sanctions, periodic military provocations, and a permanently restricted Strait of Hormuz. This scenario is manageable but costly, particularly for oil-importing nations and for ordinary Iranians living under economic siege.\n\nThe third is escalation — a miscalculation, a provocation that goes too far, or a deliberate decision to use force that triggers a wider war. This scenario would be catastrophic for the region and potentially for the global economy.\n\nHistory offers both hope and warning. The US and the Soviet Union avoided nuclear war during the Cold War through a combination of deterrence, communication, and luck. The US and Iran have fewer communication channels, less mutual understanding, and operate in a region where miscalculation is more likely. The guardrails that prevented catastrophe during the Cold War may not exist here.\n\nThe 60-day ceasefire bought time. That time has now expired. What happens next depends on decisions being made this week in Washington and Tehran — decisions that will affect the price of oil in Bangkok, the safety of shipping in the Gulf, and the lives of millions of people who have no say in the matter.`,
    vocab: [
      { word: 'Inflection point', definition: 'A critical moment where the direction of events could change dramatically.' },
      { word: 'Pragmatism', definition: 'A practical, realistic approach — focusing on what works rather than what is ideal.' },
      { word: 'Deterrence', definition: 'Preventing action by making the consequences so severe that the risk is not worth taking.' },
      { word: 'Guardrails', definition: 'Safety mechanisms that prevent situations from getting out of control.' },
    ],
    questions: [
      { n: 10, q: 'Three scenarios: negotiation, cold war, or escalation. Which do you think is most likely? Which would you prefer?' },
      { n: 11, q: 'The US and Soviet Union avoided nuclear war partly through luck. Should global security depend on luck?' },
      { n: 12, q: 'Decisions in Washington and Tehran affect oil prices in Bangkok. How should countries with no say in the conflict protect themselves?' },
    ]
  },
]
...
export default function IranCeasefirePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US-Iran Ceasefire Collapses</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The 60-day ceasefire expired. Trump told Iran to surrender. Iran declared offensive posture. Economic warfare, regional fallout, and what comes next.</p>
            </div>
          </div>
