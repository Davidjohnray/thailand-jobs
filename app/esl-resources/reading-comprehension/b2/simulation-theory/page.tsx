...
const PARTS = [
  {
    number: 1, title: 'The Idea That Everything Is Code', emoji: '💻', color: '#06b6d4',
    text: `Imagine that the universe you are experiencing right now — every sensation, every memory, every apparently solid object — is not physically real, but is instead a computational simulation running on an enormously powerful computer. Imagine that the physical laws of the universe are simply the rules of this simulation's programming, the way gravity or electromagnetism behave determined by lines of code rather than by any fundamental natural order. Imagine, finally, that you and every other conscious being in this simulated universe have no idea that this is the case — that the simulation is so seamlessly constructed that there is no discernible difference, from the inside, between simulated experience and real experience.\n\nThis is the Simulation Theory — or more precisely, the simulation hypothesis — and it is not the premise of a science fiction novel, though it has inspired many. It is a philosophical argument, advanced most rigorously by the Swedish philosopher Nick Bostrom in a landmark 2003 paper, and subsequently embraced — with varying degrees of seriousness — by some of the most prominent scientists, technologists, and philosophers working today.\n\nThe idea is not new. Versions of it appear in ancient Hindu and Buddhist philosophy, which describe the material world as "maya" — illusion. Descartes entertained a version of it in the seventeenth century when he imagined an "evil demon" systematically deceiving him about the nature of reality. The twentieth century produced Plato's cave as a standard philosophical metaphor for the possibility that our perceived reality is merely a shadow of something deeper. What is new about the contemporary simulation hypothesis is that it is grounded not in metaphysics or religion, but in the logic of computation — and that the computational power required to run such a simulation is, at least theoretically, achievable.`,
    vocab: [
      { word: 'Hypothesis', definition: 'A proposed explanation that can be tested — a starting point for further investigation.' },
      { word: 'Computational', definition: 'Relating to the use of computers or mathematical calculation to process information.' },
      { word: 'Discernible', definition: 'Able to be recognised or distinguished; noticeable to the senses or mind.' },
      { word: 'Metaphysics', definition: 'The branch of philosophy concerned with the fundamental nature of reality and existence.' },
    ],
    questions: [
      { n: 1, q: 'Before reading this, had you heard of the simulation hypothesis? Did you find it plausible, ridiculous, or somewhere in between?' },
      { n: 2, q: 'Ancient Hindu and Buddhist philosophy also questioned whether the material world is real. Does this make the simulation hypothesis feel more or less credible to you?' },
      { n: 3, q: 'If the simulated world is completely indistinguishable from a "real" one, does the distinction between them actually matter? Why or why not?' },
    ]
  },
  {
    number: 2, title: 'The Bostrom Argument', emoji: '🧮', color: '#0891b2',
    text: `Nick Bostrom's 2003 paper, "Are You Living in a Computer Simulation?", presented the simulation hypothesis not as a speculative fantasy but as a logical argument with three possible conclusions, at least one of which, he argued, must be true.\n\nThe first possibility is that virtually all civilisations at our current level of technological development go extinct before reaching the level of computational power required to run detailed simulations of conscious beings. The second possibility is that technologically advanced civilisations exist but choose not to run such simulations — perhaps for ethical reasons, or because the practice becomes illegal or taboo. The third possibility is that we are almost certainly living in a simulation right now.\n\nBostrom's reasoning is as follows. Assume that at least some technologically advanced civilisations survive long enough to develop the computational power to run "ancestor simulations" — detailed simulations of the minds of beings like us. Assume further that these civilisations choose to run many such simulations — perhaps as historical research, as entertainment, or for reasons we cannot anticipate. If this is the case, then the number of simulated conscious beings in the universe would vastly outnumber the number of "original" conscious beings existing in physical reality. A randomly selected conscious being — like you — would therefore be far more likely to be simulated than real.\n\nThe argument is logically structured so that if you reject the third conclusion — that we are probably simulated — you must accept one of the first two: either almost all civilisations destroy themselves before achieving sufficient computational power, or almost all advanced civilisations choose never to run ancestor simulations. Both alternatives carry their own unsettling implications. The first suggests that technological civilisations are almost inevitably self-destructive. The second raises profound questions about why advanced beings would choose not to simulate their ancestors — and what that choice might tell us about the nature of consciousness and ethics.`,
    vocab: [
      { word: 'Speculative', definition: 'Based on guesswork or incomplete information; not yet proven or established.' },
      { word: 'Taboo', definition: 'Something that is avoided or forbidden for social, cultural, or moral reasons.' },
      { word: 'Ancestor simulation', definition: 'A hypothetical detailed computer simulation of conscious beings from an earlier period of history.' },
      { word: 'Implication', definition: 'A conclusion or consequence that can be drawn from a statement or argument, even if not stated directly.' },
    ],
    questions: [
      { n: 4, q: 'Of Bostrom\'s three possibilities, which do you find most plausible? Which do you find most disturbing?' },
      { n: 5, q: 'If advanced civilisations could run ancestor simulations but chose not to, what ethical reasons might explain that decision?' },
      { n: 6, q: 'The argument suggests that technological civilisations may be "almost inevitably self-destructive." Does this idea concern you when you look at the state of the world today?' },
    ]
  },
  {
    number: 3, title: 'Evidence, Physics, and the Limits of the Argument', emoji: '⚛️', color: '#0e7490',
    text: `Since Bostrom's paper, researchers have explored whether there might be any empirical evidence for or against the simulation hypothesis — any features of our universe that would be consistent with it being computationally generated rather than physically fundamental.\n\nSome physicists have noted that the universe appears to behave in ways that are suggestive, at least metaphorically, of digital computation. Quantum mechanics — the physics of the very small — describes the universe in terms of discrete, quantised states rather than continuous values. Particles are not smeared across space as continuous waves; they exist in specific, countable states, as if represented by discrete units of information. The universe also appears to have a maximum speed — the speed of light — and maximum information density, features that some have compared to the processing limits of a computational system.\n\nOther physicists have proposed what they call the "computational universe" hypothesis — the idea that the universe is not described by mathematics, but actually is mathematics, or information, at its most fundamental level. This is distinct from the simulation hypothesis, but philosophically adjacent to it.\n\nCritics of the simulation hypothesis argue that it is ultimately unfalsifiable — there is no experiment that could definitively prove or disprove it, because any evidence we gather is itself part of the simulation. This places it outside the domain of conventional science, which requires hypotheses to be testable in principle. Others argue that the computational analogy is misleading: the universe does not actually behave like a computer; quantum phenomena are not literally digital; and the apparent similarities are the result of humans reaching for familiar metaphors rather than genuine structural parallels.\n\nElon Musk, Jeff Bezos, and several prominent physicists have publicly expressed belief that the probability of us living in base reality — actual, non-simulated physical reality — is extremely low. Others, equally prominent, have dismissed the hypothesis as philosophically incoherent. The debate remains genuinely open.`,
    vocab: [
      { word: 'Empirical', definition: 'Based on observation and evidence rather than theory or logic alone.' },
      { word: 'Quantised', definition: 'Existing in discrete, separate units rather than as a continuous range of values.' },
      { word: 'Unfalsifiable', definition: 'Impossible to disprove through any experiment or observation; not testable by scientific methods.' },
      { word: 'Incoherent', definition: 'Unclear, illogical, or impossible to understand because the parts do not fit together properly.' },
    ],
    questions: [
      { n: 7, q: 'The hypothesis is described as "unfalsifiable." Should science concern itself with ideas that cannot be tested? Where is the line between philosophy and science?' },
      { n: 8, q: 'Quantum mechanics describes the universe in discrete states. Do you find this a meaningful parallel to digital computation, or a misleading analogy?' },
      { n: 9, q: 'Prominent figures like Elon Musk believe we are probably in a simulation. Does the identity of the believer affect how seriously you take an idea? Should it?' },
    ]
  },
  {
    number: 4, title: 'If It\'s True, Does It Matter?', emoji: '🌀', color: '#155e75',
    text: `Suppose, for the sake of argument, that the simulation hypothesis is correct. Suppose that the universe you experience is computationally generated, that the physical laws governing it are lines of code in a programme running on some inconceivably powerful machine, and that the beings responsible for running the simulation — sometimes called the "simulators" — exist in a deeper layer of reality that we cannot access or even perceive. What, if anything, would change?\n\nFor some people, the answer is: nothing meaningful. The simulation, if it exists, is perfectly consistent and perfectly real in every sense that matters to us. Pain is pain whether it is generated by nerve endings in a physical body or by code in a computational substrate. Love, beauty, curiosity, suffering — all the things that give human life its texture and significance — are no less genuine for being simulated. The philosopher David Chalmers has argued that if the simulation is perfect and consistent, there is no meaningful sense in which the simulated world is "less real" than any other possible reality. He calls this position "virtual realism."\n\nFor others, the implications are more troubling. If we are simulated, then we are, in a sense, subject to the will of the simulators in the way that characters in a video game are subject to the will of the player. The simulation could be paused, altered, or terminated without our consent or even our awareness. Our sense of agency — the feeling that our choices are genuinely our own — might be illusory in a deeper sense than ordinary philosophical discussions of free will suggest.\n\nThe simulation hypothesis also raises theological questions. A simulator capable of creating a universe of conscious beings would, in many respects, resemble the God of classical theology — omnipotent, omniscient with respect to the simulation, and the ultimate source of existence for everything within it. Whether this is a comforting or a disturbing idea depends, perhaps, on what one believes about the nature and intentions of the simulator. And on that question, the simulation hypothesis offers no guidance at all.`,
    vocab: [
      { word: 'Substrate', definition: 'The underlying layer or material on which something is built or operates.' },
      { word: 'Agency', definition: 'The capacity to act independently and make free choices; the ability to determine one\'s own actions.' },
      { word: 'Omnipotent', definition: 'Having unlimited power; able to do anything.' },
      { word: 'Theological', definition: 'Relating to theology — the study of the nature of God and religious belief.' },
    ],
    questions: [
      { n: 10, q: 'David Chalmers argues that a perfect simulation is no less real than physical reality. Do you agree? What would it mean for something to be "real" in this context?' },
      { n: 11, q: 'The passage compares a simulator to God. Do you find this comparison meaningful, disturbing, or simply interesting as a philosophical puzzle?' },
      { n: 12, q: 'If you became convinced tomorrow that you were living in a simulation, how do you think it would change the way you live your life — if at all?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "The Simulation Theory — Are We Living Inside a Computer?". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function SimulationTheoryPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #021013 0%, #0e4f5e 50%, #0e7490 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#06b6d4', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B2 Upper Intermediate</span>
                <span style={{ background: 'rgba(6,182,212,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Simulation Theory</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Are we living inside a computer? A serious philosophical argument — endorsed by physicists and philosophers — that our entire reality may be a computational simulation.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#06b6d4', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#06b6d4' : '#e5e7eb', background: speed === s.value ? '#06b6d4' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#ecfeff', padding: '8px 28px', borderBottom: '1px solid #a5f3fc' }}>
              <span style={{ color: '#0e7490', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#06b6d4' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#ecfeff', border: '1px solid #a5f3fc', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#0e7490', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(6,182,212,0.15)', border: '1px solid rgba(6,182,212,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#67e8f9', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#06b6d4', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #a5f3fc', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#ecfeff', color: '#0e7490', border: '2px solid #a5f3fc', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#ecfeff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #a5f3fc' }}>
                  <div style={{ color: '#0e7490', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>📖 English Definition</div>
