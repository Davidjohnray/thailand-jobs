...
const PARTS = [
  {
    number: 1, title: 'A Book Unlike Any Other', emoji: '📖', color: '#8b5cf6',
    text: `Housed in the Beinecke Rare Book and Manuscript Library at Yale University in the United States, the Voynich Manuscript is one of the most tantalising unsolved puzzles in the history of human knowledge. It is a handwritten book of approximately 240 pages, illustrated with hundreds of detailed drawings of plants, astronomical diagrams, figures bathing in strange liquid pools, and what appear to be maps of the night sky. Every single page is covered in a flowing, elegant script that no scholar in more than a century of determined effort has been able to decipher.\n\nThe manuscript takes its name from Wilfrid Voynich, a Polish-American antique book dealer who purchased it in 1912 from a Jesuit college in Italy. He spent the rest of his life trying to decode it, without success. After his death the manuscript passed through several hands before eventually being donated to Yale, where it has been studied ever since.\n\nRadiocarbon dating carried out in 2009 established that the vellum — the treated animal skin on which the text is written — dates to the early fifteenth century, most likely between 1404 and 1438. This places its creation in the late medieval period, several decades before the invention of the printing press. The ink used for the illustrations has been dated to the same period, suggesting that the book was created, not merely written on, at that time.\n\nWhat makes the Voynich Manuscript so remarkable is not simply that it is old, or that it is illustrated, or that its script is unfamiliar. Hundreds of medieval manuscripts share these qualities. What makes it unique is that despite being subjected to the most sophisticated analytical techniques available to modern science and linguistics, its text has never been read by anyone alive today.`,
    vocab: [
      { word: 'Tantalising', definition: 'Extremely interesting or tempting in a way that is frustrating because it remains just out of reach.' },
      { word: 'Decipher', definition: 'To succeed in understanding something that is written in a code or in an unclear way.' },
      { word: 'Vellum', definition: 'A fine material made from the skin of a calf or other animal, used for writing before paper became common.' },
      { word: 'Radiocarbon dating', definition: 'A scientific method used to determine the age of ancient objects by measuring the decay of a radioactive form of carbon.' },
    ],
    questions: [
      { n: 1, q: 'What is your initial reaction to the idea of a 600-year-old book that nobody has ever been able to read? Does it excite or frustrate you?' },
      { n: 2, q: 'Why do you think the Voynich Manuscript has attracted so much attention compared to other undeciphered ancient texts?' },
      { n: 3, q: 'If you discovered an object that no expert could explain, how would you feel about the possibility that it might never be understood?' },
    ]
  },
  {
    number: 2, title: 'What Does the Manuscript Contain?', emoji: '🌿', color: '#7c3aed',
    text: `Scholars who have studied the Voynich Manuscript have organised its contents into several distinct sections, based on the types of illustrations that appear alongside the text. Understanding these sections is important, because they suggest — though do not prove — what the book was intended to be used for.\n\nThe largest section, sometimes called the "herbal" section, consists of drawings of plants accompanied by blocks of text. The plants depicted are highly detailed and appear to be drawn from observation rather than imagination. However, none of the approximately 130 plant species illustrated can be definitively matched to any known plant, either living or extinct. Some researchers have suggested they could be stylised versions of real plants; others believe they may be entirely fictitious species.\n\nA second section contains circular diagrams that appear to represent astronomical or astrological charts. Some of these diagrams contain what look like zodiac symbols, and several feature figures that are clearly human in form. Whether these diagrams were intended for scientific, religious, or magical purposes is unknown.\n\nPerhaps the most visually striking section is one sometimes called the "balneological" section — from the Latin word for bathing. It depicts dozens of nude figures, mostly female, sitting or standing in pools and channels of liquid connected by elaborate pipe-like structures. The meaning of these images has generated enormous speculation. Some researchers have proposed they depict medical treatments; others have suggested cosmological diagrams; others still have seen in them early attempts to illustrate the circulatory system of the human body.\n\nA final section contains dense blocks of text with no illustrations at all. This section has been particularly resistant to analysis, offering no visual clues to guide interpretation.`,
    vocab: [
      { word: 'Herbal', definition: 'Relating to herbs and plants, especially those used in medicine or cooking.' },
      { word: 'Definitively', definition: 'In a way that is final and certain, leaving no room for doubt.' },
      { word: 'Astrological', definition: 'Relating to astrology — the belief that the positions of stars and planets influence human affairs.' },
      { word: 'Balneological', definition: 'Relating to bathing, especially the therapeutic use of baths in medicine.' },
    ],
    questions: [
      { n: 4, q: 'Which section of the manuscript do you find most intriguing — the plants, the astronomical diagrams, or the bathing figures? Why?' },
      { n: 5, q: 'Why do you think the manuscript\'s authors might have drawn plants that cannot be identified as real species?' },
      { n: 6, q: 'If the balneological section depicts medical treatments, what does this suggest about medical knowledge in the fifteenth century?' },
    ]
  },
  {
    number: 3, title: 'The Theories and the Codebreakers', emoji: '🔐', color: '#6d28d9',
    text: `The Voynich Manuscript has attracted some of the most brilliant minds in the history of cryptography — the science of codes and ciphers. During the Second World War, professional codebreakers who had successfully cracked Nazi Germany's Enigma machine and Japan's Purple cipher turned their attention to the manuscript in their spare time and came away defeated. The American cryptologist William Friedman, regarded by many as the greatest codebreaker in history, spent years working on the manuscript and concluded only that the script was likely an artificial language constructed according to a logical but unprecedented system.\n\nOver the decades, an extraordinary range of theories has been proposed. Some researchers have argued that the manuscript is written in an encrypted natural language — perhaps an early form of Latin, Hebrew, or Arabic with letters systematically replaced by invented symbols. Others have suggested it could be a constructed philosophical language, designed to organise all human knowledge according to a logical system — a concept that fascinated several thinkers of the Renaissance period.\n\nA third category of theory holds that the manuscript is not a cipher at all, but rather a natural language that simply has not been identified — perhaps a dialect or regional language that left no other written record, or possibly a language deliberately invented to prevent outsiders from reading the text.\n\nIn 2019, a British researcher named Gerard Cheshire claimed to have decoded the manuscript, identifying the language as "proto-Romance" — an ancestor of modern Spanish, Italian, French and Portuguese. His claim attracted significant media attention but was rapidly dismissed by professional linguists, who pointed out numerous methodological errors and the absence of peer review. The manuscript, as of today, remains entirely unread.`,
    vocab: [
      { word: 'Cryptography', definition: 'The science and practice of writing and solving codes and ciphers.' },
      { word: 'Cipher', definition: 'A secret method of writing in which letters or symbols are substituted for the real ones.' },
      { word: 'Unprecedented', definition: 'Never done or known before; without any previous example.' },
      { word: 'Peer review', definition: 'The evaluation of a piece of academic work by other experts in the same field before publication.' },
    ],
    questions: [
      { n: 7, q: 'Why do you think the Voynich Manuscript defeated even the world\'s greatest wartime codebreakers?' },
      { n: 8, q: 'What does the rapid dismissal of Cheshire\'s 2019 claim tell us about how scientific and academic communities evaluate new discoveries?' },
      { n: 9, q: 'If you were a cryptographer, which theory about the manuscript\'s language would you find most convincing? Why?' },
    ]
  },
  {
    number: 4, title: 'Hoax, Mystery or Lost Knowledge?', emoji: '🎭', color: '#5b21b6',
    text: `The most provocative theory about the Voynich Manuscript is also the most deflating: that it is a hoax. The most prominent advocate of this position is Gordon Rugg, a British computer scientist who argued in a 2004 paper that the manuscript's text could have been generated using a simple medieval device called a Cardan grille — a card with holes cut in it that is moved across a table of syllables to produce pseudo-random combinations. According to Rugg, a clever forger could have created the appearance of a complex, meaningful language without that language actually containing any meaning at all.\n\nThe hoax hypothesis would explain several puzzling features of the manuscript: why no one has ever decoded it, why the plant illustrations don't match real species, and why some sections seem to repeat the same patterns with small variations. It would also explain why no other document in any language has ever been found that references the manuscript or its supposed author.\n\nHowever, critics of the hoax theory argue that it would have required an enormous investment of time and artistic skill for a result that benefited the creator very little — the manuscript appears to have sat largely unread in a Jesuit archive for centuries before Voynich purchased it. If it was a forgery designed to deceive a wealthy buyer, it was spectacularly unsuccessful as a commercial enterprise.\n\nToday, with advances in artificial intelligence and machine learning offering powerful new tools for linguistic analysis, researchers continue to find new patterns in the text. Some AI studies have found statistical properties in the manuscript's text that resemble natural language rather than random noise — suggesting that, whatever it is, the manuscript is not entirely without structure or meaning. The search continues. And until it ends, the Voynich Manuscript remains the world's most mysterious book.`,
    vocab: [
      { word: 'Provocative', definition: 'Causing strong reactions or debate; intended to make people think or respond strongly.' },
      { word: 'Hoax', definition: 'A deliberate deception or trick intended to make people believe something false.' },
      { word: 'Pseudo-random', definition: 'Appearing to be random but actually generated by a specific, hidden process or rule.' },
      { word: 'Statistical properties', definition: 'Mathematical characteristics of a set of data, such as patterns in frequency or distribution.' },
    ],
    questions: [
      { n: 10, q: 'Does the hoax theory make the Voynich Manuscript more or less interesting to you? Would knowing it was a hoax be disappointing?' },
      { n: 11, q: 'What does the manuscript\'s continued resistance to AI analysis suggest about the limits of machine intelligence?' },
      { n: 12, q: 'Some mysteries may never be solved. Is it important to keep trying, or should resources be directed elsewhere? How do you decide?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "The Voynich Manuscript — the World's Most Mysterious Book". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Voynich Manuscript</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A 600-year-old illustrated book written in an unknown script that no cryptographer, linguist, or AI has ever been able to read.</p>
            </div>
          </div>
