...
const PARTS = [
  {
    number: 1, title: 'Death by a Thousand Drones', emoji: '🔋', color: '#dc2626',
    text: `Ukrainian drone strikes are transforming the war in Crimea — and potentially changing the nature of warfare itself. This week, reports confirmed that sustained drone attacks are causing power outages, fuel shortages, and disruptions to cellphone service across the Russian-occupied peninsula. Russia seized Crimea in 2014, but now its hold on the territory is being challenged — not by a conventional military invasion, but by small, cheap, unmanned aircraft that strike day and night.\n\nThe strategy is elegant in its simplicity. Rather than attempting to retake Crimea through a costly ground offensive — which Ukraine lacks the resources to mount — Ukrainian forces are systematically targeting the infrastructure that makes Russian occupation viable: power stations, fuel depots, military bases, radar installations, and the Kerch Bridge that connects Crimea to mainland Russia.\n\nThe drones used are remarkably inexpensive. Many cost less than 50,000 dollars — a fraction of the price of a single cruise missile. Some are essentially modified civilian drones equipped with explosives. Others are more sophisticated, capable of flying hundreds of kilometres and navigating autonomously using GPS. Ukraine has developed a domestic drone manufacturing industry that now produces thousands of units per month.\n\nThe results have been devastating for Russia. Multiple military airfields have been damaged. A naval base was struck, damaging warships. Fuel storage facilities have been destroyed, creating shortages that affect both military operations and civilian life. The psychological impact on Russian forces and the civilian population in Crimea is significant — nobody knows when or where the next strike will come.`,
    vocab: [
      { word: 'Sustained', definition: 'Continuing over a long period without stopping — persistent and ongoing.' },
      { word: 'Conventional', definition: 'Traditional or standard — using established methods rather than new or unusual ones.' },
      { word: 'Viable', definition: 'Capable of working successfully — practical and sustainable.' },
      { word: 'Autonomously', definition: 'Operating independently without human control — making decisions on its own.' },
    ],
    questions: [
      { n: 1, q: 'Ukraine is using cheap drones instead of expensive missiles. How does this change the economics of warfare?' },
      { n: 2, q: 'The strategy targets infrastructure rather than territory. Why might making occupation unviable be more effective than a ground invasion?' },
      { n: 3, q: 'Drones that cost 50,000 dollars can damage assets worth millions. What does this asymmetry mean for military planning?' },
    ]
  },
  {
    number: 2, title: 'The Drone Revolution', emoji: '🤖', color: '#b91c1c',
    text: `The Ukraine war has become the world's first full-scale drone war — and it is providing a preview of what future conflicts will look like.\n\nBoth sides use drones extensively. Ukraine pioneered the use of modified commercial drones for surveillance and attacks. Russia has deployed Iranian-made Shahed drones — large, one-way attack drones that fly to their targets and explode on impact. Both sides use first-person-view drones — small quadcopters piloted remotely by operators wearing video goggles — to hunt individual vehicles and soldiers with extraordinary precision.\n\nThe implications for the future of warfare are profound. Drones are cheap to produce, difficult to defend against, and do not risk the life of the operator. A country that might not be able to afford a modern air force can build thousands of attack drones for a fraction of the cost. This democratisation of airpower fundamentally changes the balance between offence and defence — making it much harder for any military force to concentrate troops, vehicles, or supplies without being detected and attacked.\n\nThe ethical dimensions are equally significant. Drone warfare removes the operator from the physical battlefield, potentially lowering the psychological barrier to killing. Autonomous drones that select and engage targets without human intervention raise fundamental questions about accountability — if a drone kills a civilian, who is responsible? The programmer? The commander? The algorithm?\n\nThe Ukraine conflict is being studied intensely by military planners worldwide. The lessons being learned — about drone manufacturing, tactics, electronic warfare countermeasures, and the integration of drones with conventional forces — will shape military doctrine for decades to come.`,
    vocab: [
      { word: 'Asymmetry', definition: 'A lack of balance or equality between two sides — one side having an advantage the other lacks.' },
      { word: 'Democratisation', definition: 'Making something available to everyone — not just the wealthy or powerful.' },
      { word: 'Accountability', definition: 'Being held responsible for outcomes — who answers when something goes wrong.' },
      { word: 'Doctrine', definition: 'Official principles and strategies that guide how a military operates.' },
    ],
    questions: [
      { n: 4, q: 'Cheap drones can give small countries airpower they could never afford with traditional aircraft. How does this change global military balance?' },
      { n: 5, q: 'If an autonomous drone kills a civilian, who is responsible — the programmer, the commander, or the algorithm?' },
      { n: 6, q: 'Both sides use first-person-view drones to hunt individual soldiers. How does this change the experience of being a soldier?' },
    ]
  },
  {
    number: 3, title: 'Crimea Under Pressure', emoji: '🔥', color: '#991b1b',
    text: `For the approximately 2.4 million people living in Crimea, the drone campaign is creating conditions that increasingly resemble a siege — a slow, grinding pressure that degrades the quality of daily life without the dramatic destruction of a conventional battle.\n\nPower outages have become routine. When Ukrainian drones destroy transformer stations or power plants, entire cities go dark for hours or days. Hospitals switch to backup generators. Traffic lights stop working. Businesses close. In summer, the loss of air conditioning is uncomfortable. In winter, the loss of heating can be dangerous.\n\nFuel shortages affect everything. When fuel depots are destroyed, petrol stations run dry, public transport is reduced, and the cost of goods transported by truck increases. Food prices have risen sharply in Crimea over the past year — partly due to supply disruptions caused by drone strikes on transport infrastructure.\n\nThe civilian population is caught in the middle. Most residents of Crimea are ethnic Russians who supported — or at least accepted — the 2014 annexation. They did not choose this war, and many feel abandoned by both sides. Russia portrays the drone strikes as terrorism. Ukraine argues that Crimea is occupied Ukrainian territory and that targeting military infrastructure is legitimate. For the people living there, the distinction between "military" and "civilian" infrastructure blurs when the same power station serves both a military base and a hospital.\n\nThe moral complexity of targeting infrastructure that serves both military and civilian purposes is one of the most difficult ethical questions in modern warfare — and it has no easy answer.`,
    vocab: [
      { word: 'Siege', definition: 'Surrounding a place and cutting off supplies to force it to surrender — sustained pressure over time.' },
      { word: 'Degrades', definition: 'Gradually makes worse — reduces quality or effectiveness over time.' },
      { word: 'Annexation', definition: 'Taking control of territory by force and declaring it part of your country.' },
      { word: 'Dual-use', definition: 'Serving both military and civilian purposes — infrastructure used by both soldiers and ordinary people.' },
    ],
    questions: [
      { n: 7, q: 'A power station serves both a military base and a hospital. Is it a legitimate military target? How do you decide?' },
      { n: 8, q: 'Crimea residents did not choose this war but live with its consequences. What responsibility do governments have to civilians in occupied territory?' },
      { n: 9, q: 'The drone campaign resembles a siege. Is making life unbearable for civilians a legitimate way to pressure an occupying force to leave?' },
    ]
  },
  {
    number: 4, title: 'What Drones Mean for the World', emoji: '🌐', color: '#7f1d1d',
    text: `The drone war in Ukraine is not just a chapter in the Russia-Ukraine conflict — it is a preview of the future of warfare that affects every country on Earth.\n\nThe proliferation of drone technology means that the ability to conduct aerial attacks is no longer limited to wealthy nations with expensive air forces. Iran, Turkey, China, and dozens of other countries now manufacture military drones that are exported worldwide. Non-state actors — from Hezbollah to the Houthi rebels in Yemen — have used drones to attack targets that would previously have been beyond their reach. The barrier to entry for aerial warfare has collapsed.\n\nThis has profound implications for defence. Traditional air defence systems — designed to shoot down fast-moving aircraft and missiles — struggle against swarms of slow, low-flying drones that cost less than the missiles used to destroy them. A country could exhaust its air defence ammunition shooting down drones that cost a fraction of the interceptors used against them. Developing effective, affordable counter-drone technology is now one of the highest priorities for military planners worldwide.\n\nThe implications extend beyond the military. The same drone technology used for warfare can be used for surveillance, border control, policing, and potentially terrorism. The attack on Saudi Arabia's Aramco oil facility in 2019 — conducted by drones that evaded one of the most expensive air defence systems in the world — demonstrated that critical infrastructure anywhere in the world is vulnerable to drone attack.\n\nThe drones over Crimea this week are not just weapons in a war. They are harbingers of a new era — one in which the sky belongs to machines, and the rules of conflict must be rewritten from the ground up.`,
    vocab: [
      { word: 'Proliferation', definition: 'Rapid increase and spread — when something multiplies and becomes widely available.' },
      { word: 'Non-state actors', definition: 'Groups that are not governments but have political or military influence — militias, terrorist groups.' },
      { word: 'Interceptors', definition: 'Missiles or weapons designed to destroy incoming threats — defensive weapons.' },
      { word: 'Harbingers', definition: 'Signs or warnings of what is coming — things that indicate future developments.' },
    ],
    questions: [
      { n: 10, q: 'Cheap drones can now attack targets that previously only expensive air forces could reach. How does this change global security?' },
      { n: 11, q: 'The same drone technology used in war can be used for terrorism. How should governments regulate drone technology without blocking legitimate uses?' },
      { n: 12, q: 'The passage calls drones over Crimea harbingers of a new era. Do you agree? How will drone warfare change the world in the next 20 years?' },
    ]
  },
]
...
export default function CrimeaDronesPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Ukrainian Drones Change the War</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Cheap drones are causing power outages and fuel shortages across Russian-occupied Crimea. The drone revolution, the ethics of targeting infrastructure, and what it means for the future of war.</p>
            </div>
          </div>
