...
const PARTS = [
  {
    number: 1, title: 'What is Business Negotiation?', emoji: '🤝', color: '#3b82f6',
    text: `Negotiation is one of the most important skills in any business environment. Whether you are agreeing on a price with a supplier, finalising a contract with a client, or discussing terms with a business partner, the ability to negotiate effectively can have a significant impact on your organisation's success. Unlike an argument, a good negotiation aims for a result that both sides find acceptable — what is often called a win-win outcome.\n\nSuccessful negotiators share several common qualities. They prepare thoroughly before entering discussions, understanding not only what they want but also what the other party is likely to need. They listen carefully, ask good questions, and remain calm under pressure. They also know when to be firm and when to show flexibility. In international business, cultural awareness adds another layer of complexity — attitudes toward directness, hierarchy, and relationship-building vary significantly across cultures, and failing to understand these differences can cause negotiations to fail even when both sides want the same outcome.`,
    vocab: [
      { word: 'Supplier', definition: 'A company or person that provides goods or services to another business.' },
      { word: 'Win-win outcome', definition: 'A result where both sides benefit — neither party feels they have lost.' },
      { word: 'Flexibility', definition: 'The willingness to change or adapt — being open to different solutions or approaches.' },
      { word: 'Cultural awareness', definition: 'Understanding and respecting the differences in customs, values, and behaviour across cultures.' },
    ],
    questions: [
      { n: 1, q: 'What qualities do you think are most important in a successful negotiator?' },
      { n: 2, q: 'Have you ever had to negotiate in English? What was challenging about it?' },
      { n: 3, q: 'How does your culture approach negotiation differently from Western business culture?' },
    ]
  },
  {
    number: 2, title: 'Key Phrases and Strategies at the Table', emoji: '💬', color: '#8b5cf6',
    text: `Knowing the right language is essential in a negotiation. Experienced negotiators use specific phrases to open discussions positively, make proposals, push back on offers, and move toward agreement. For example, instead of saying "no" directly, skilled negotiators often use softer language: "That's a little outside our budget" or "We'd need to see some movement on price before we can agree to that." This approach keeps the conversation open and avoids damaging the relationship.\n\nAnchoring is one of the most well-known negotiation strategies. This means making the first offer, which tends to set the psychological reference point for the rest of the discussion. Research suggests that the side which anchors first often achieves a better final result. Another common technique is bundling — rather than negotiating each point separately, experienced negotiators group multiple issues together. This creates more room for trade-offs: you might accept a lower price in exchange for faster payment terms, or agree to a longer contract in return for a discount. Understanding these techniques — and recognising them when the other side uses them — gives you a significant advantage.`,
    vocab: [
      { word: 'Proposal', definition: 'A formal suggestion or offer made during a negotiation — the first step toward an agreement.' },
      { word: 'Anchoring', definition: 'Setting the first number or position in a negotiation, which influences the final outcome.' },
      { word: 'Trade-off', definition: 'Accepting something less desirable in exchange for something you want more — a compromise.' },
      { word: 'Bundling', definition: 'Combining several negotiation points together to create flexibility and room for agreement.' },
    ],
    questions: [
      { n: 4, q: 'Why is it often better to avoid saying "no" directly in a negotiation?' },
      { n: 5, q: 'Is anchoring — making the first offer — always an advantage? When might it backfire?' },
      { n: 6, q: 'Can you think of a situation where bundling issues together would be a useful strategy?' },
    ]
  },
  {
    number: 3, title: 'Handling Pressure and Difficult Moments', emoji: '⚡', color: '#f59e0b',
    text: `Every negotiation has moments of tension. The other side may make a demand that seems unreasonable, use silence as a pressure tactic, or threaten to walk away. How you respond in these moments often determines the final result. Experienced negotiators learn to manage their emotional reactions, take time to think before responding, and avoid making concessions under pressure that they will later regret.\n\nSilence is one of the most powerful — and underused — tools in negotiation. When the other side makes an offer, many people feel uncomfortable with silence and rush to respond. Skilled negotiators are comfortable waiting. A pause gives you time to think and often puts pressure on the other party to soften their position. Another important skill is knowing your BATNA — Best Alternative To a Negotiated Agreement. This is what you will do if the negotiation fails completely. Knowing your BATNA clearly gives you confidence, because you know exactly how far you can go before it is better to walk away.`,
    vocab: [
      { word: 'Concession', definition: 'Something you give up or agree to in a negotiation — a point you accept to reach agreement.' },
      { word: 'Tactic', definition: 'A planned action or method used to achieve a goal — a specific move in a negotiation.' },
      { word: 'BATNA', definition: 'Best Alternative To a Negotiated Agreement — your best option if the negotiation breaks down.' },
      { word: 'Leverage', definition: 'The power or advantage you have in a negotiation — factors that strengthen your position.' },
    ],
    questions: [
      { n: 7, q: 'How do you personally react when someone uses silence as a pressure tactic?' },
      { n: 8, q: 'Why is knowing your BATNA so important before entering a negotiation?' },
      { n: 9, q: 'Is it ever right to walk away from a negotiation? What would make you do that?' },
    ]
  },
  {
    number: 4, title: 'Closing the Deal and Writing the Contract', emoji: '✍️', color: '#22c55e',
    text: `Reaching a verbal agreement is only part of the process. In business, the negotiation is not truly finished until the terms have been written down and signed. Contracts protect both parties by making the agreed terms clear and legally binding. A well-written contract covers price, payment terms, delivery schedules, quality standards, and what happens if either party fails to meet their obligations — a clause known as a remedy or penalty provision.\n\nThe closing stage of a negotiation requires its own skills. Experienced negotiators watch for signals that the other side is ready to agree — they may start using more positive language, ask practical questions about delivery or timelines, or show a visible change in body language. When these signals appear, it is important to move toward closing rather than continuing to push for more concessions, which can cause the deal to collapse at the last moment. After signing, the relationship continues — how you behave after a contract is signed will influence whether the other party wants to do business with you again.`,
    vocab: [
      { word: 'Legally binding', definition: 'Enforced by law — both parties are required to keep their promises or face legal consequences.' },
      { word: 'Obligations', definition: 'Duties or responsibilities — things you are required to do under an agreement.' },
      { word: 'Penalty provision', definition: 'A clause in a contract that states what happens if one party fails to meet their obligations.' },
      { word: 'Closing', definition: 'The final stage of a negotiation where both sides agree and confirm the deal.' },
    ],
    questions: [
      { n: 10, q: 'Why is a written contract important even when both sides already trust each other?' },
      { n: 11, q: 'What signals tell you that the other side is ready to close a deal?' },
      { n: 12, q: 'How important is the relationship after signing — does it change how you negotiate?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Negotiating Prices and Contracts". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function NegotiatingContractsPage() {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: isPhrase ? `You are a business English dictionary for B2 learners. Respond with ONLY one sentence (max 25 words) explaining what the phrase means in a business context. No extra text.`
              : `You are a business English dictionary for B2 learners. Respond with ONLY one sentence (max 20 words) defining this word in a business context. No extra text.`,
            messages: [{ role: 'user', content: isPhrase ? `What does "${text}" mean in business?` : `Define: "${text}"` }],
          }),
        })
        const data = await res.json()
        ...
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: `You are a language learning assistant for B2 Business English students. Respond ONLY with valid JSON (no markdown, no backticks): {"definition": "one simple English sentence max 20 words", "translation": "the word/phrase in ${translationLang} with a brief explanation in ${translationLang}, max 30 words"}`,
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #1a1a2e 100%)', padding: '56px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Negotiating Prices and Contracts</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The Art of the Deal — master the language, strategies, and skills needed to negotiate effectively in professional business settings.</p>
            </div>
          </div>
