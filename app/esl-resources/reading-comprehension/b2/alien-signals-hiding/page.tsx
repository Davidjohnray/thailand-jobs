...
const PARTS = [
  {
    number: 1, title: 'Listening to the Wrong Channel', emoji: '📡', color: '#dc2626',
    text: `For more than 60 years, scientists have been listening for signals from extraterrestrial civilisations — and hearing nothing. This silence, known as the "Great Silence" or the Fermi Paradox, is one of the most puzzling questions in science. This week, a new study suggested a possible explanation: we may have been listening on the wrong frequencies.\n\nThe Search for Extraterrestrial Intelligence — SETI — has traditionally focused on a relatively narrow band of radio frequencies, particularly around 1.4 gigahertz, sometimes called the "water hole" because it sits near the natural emission frequency of hydrogen. Scientists chose this frequency because it is relatively quiet — free from natural interference — and because any technologically advanced civilisation would presumably know this.\n\nBut the new research, published in a major astronomy journal, argues that a vast range of higher frequencies has been almost entirely unexplored. Using archived data from radio telescopes, the researchers found that more than 99% of the usable radio spectrum has never been systematically searched for artificial signals. We have been looking through a keyhole when the entire door was open.\n\nThe implication is tantalising: alien signals could already exist in data we have collected but never properly analysed. The universe might not be silent at all — we might simply not have been listening carefully enough.`,
    vocab: [
      { word: 'Extraterrestrial', definition: 'From outside Earth — relating to life or things beyond our planet.' },
      { word: 'Fermi Paradox', definition: 'The contradiction between the high probability of alien life and the lack of any evidence for it.' },
      { word: 'Frequencies', definition: 'The rate at which radio waves vibrate — different channels on the electromagnetic spectrum.' },
      { word: 'Tantalising', definition: 'Exciting but just out of reach — suggesting something wonderful that has not yet been confirmed.' },
    ],
    questions: [
      { n: 1, q: 'We have searched less than 1% of the radio spectrum for alien signals. Does this change how you think about the silence?' },
      { n: 2, q: 'The study says alien signals might already exist in data we have not properly analysed. How does it feel to know the answer might already be sitting in a computer?' },
      { n: 3, q: 'Do you believe intelligent life exists elsewhere in the universe? Why or why not?' },
    ]
  },
  {
    number: 2, title: 'The Scale of the Search', emoji: '🌌', color: '#b91c1c',
    text: `To understand why finding alien signals is so difficult, you need to appreciate the scale of the challenge.\n\nThe observable universe contains approximately two trillion galaxies. Each galaxy contains hundreds of billions of stars. Many of those stars have planets. The Milky Way alone — our home galaxy — contains an estimated 100 to 400 billion stars, and recent discoveries suggest that most of them have at least one planet.\n\nSearching for a signal from an alien civilisation in this vastness is often compared to looking for a needle in a haystack. But the analogy is inadequate. It is more like looking for a specific needle in a haystack the size of the Earth — while not knowing what the needle looks like, which direction to look, or whether needles even exist.\n\nThe SETI project has examined approximately 1,000 star systems in detail — out of hundreds of billions. It has listened on a fraction of the available frequencies. It has assumed that alien civilisations would communicate using radio waves — an assumption that may be wrong. More advanced civilisations might use lasers, gravitational waves, neutrinos, or communication methods we have not yet imagined.\n\nThe Drake Equation — a formula devised in 1961 to estimate the number of detectable civilisations in our galaxy — produces wildly different results depending on the assumptions used. Estimates range from zero (we are alone) to millions (the galaxy is teeming with life). The honest answer is that we do not know — and the new study suggests we have barely begun to look.`,
    vocab: [
      { word: 'Observable universe', definition: 'The part of the universe that we can detect from Earth — limited by the speed of light.' },
      { word: 'Analogy', definition: 'A comparison between two things to help explain an idea.' },
      { word: 'Gravitational waves', definition: 'Ripples in space-time caused by massive objects moving — predicted by Einstein.' },
      { word: 'Teeming', definition: 'Full of — crowded with large numbers of something.' },
    ],
    questions: [
      { n: 4, q: 'We have examined 1,000 star systems out of hundreds of billions. Is our search really big enough to conclude anything?' },
      { n: 5, q: 'Aliens might communicate using methods we cannot imagine. How do you search for something you cannot define?' },
      { n: 6, q: 'The Drake Equation gives answers from zero to millions. What does this range tell us about the limits of our knowledge?' },
    ]
  },
  {
    number: 3, title: 'What If We Find Something?', emoji: '🔊', color: '#991b1b',
    text: `The SETI community has a protocol for what to do if a genuine extraterrestrial signal is detected. It involves verification by independent observatories, notification of the United Nations, and a period of international consultation before any response is sent. But the reality of detecting alien life would be far messier than any protocol can anticipate.\n\nThe first challenge would be verification. Radio telescopes occasionally detect signals that look promising but turn out to be natural phenomena, equipment glitches, or human-made interference. In 1977, astronomer Jerry Ehman detected a strong narrowband signal from the constellation Sagittarius and wrote "Wow!" in the margin of the computer printout. The signal was never detected again, and its origin remains unexplained — but most scientists believe it was not alien.\n\nIf a signal were confirmed as artificial and extraterrestrial, the impact on human society would be profound. Religions would need to reconcile their teachings with the existence of non-human intelligence. National boundaries and rivalries would seem absurd in the context of a universe containing other minds. The philosophical implications — are we special? Are we alone? What is our place in the cosmos? — would reshape human thought in ways that are impossible to predict.\n\nSome scientists argue that we should not respond to an alien signal at all. Stephen Hawking warned that advertising our existence to an unknown civilisation could be dangerous — comparing it to Native Americans encountering European explorers. Others argue that any civilisation capable of detecting us probably already knows we are here, and that the potential benefits of contact outweigh the risks.`,
    vocab: [
      { word: 'Protocol', definition: 'An official procedure or set of rules for how to handle a situation.' },
      { word: 'Narrowband', definition: 'A signal concentrated in a very specific frequency range — suggesting artificial rather than natural origin.' },
      { word: 'Reconcile', definition: 'To make two seemingly contradictory things compatible — finding a way for both to be true.' },
      { word: 'Cosmos', definition: 'The universe seen as an ordered, harmonious system.' },
    ],
    questions: [
      { n: 7, q: 'If alien life were confirmed, how do you think the world would react? Would it bring people together or create new conflicts?' },
      { n: 8, q: 'Hawking warned against responding to alien signals. Is he right to be cautious, or should we take the risk?' },
      { n: 9, q: 'How would the existence of alien intelligence affect religion? Can faith and extraterrestrial life coexist?' },
    ]
  },
  {
    number: 4, title: 'The Most Important Question', emoji: '🔭', color: '#7f1d1d',
    text: `Whether or not alien civilisations exist, the search for them is one of the most profoundly human activities imaginable.\n\nThink about what SETI represents. A species on a small planet orbiting an ordinary star in one of two trillion galaxies has built radio telescopes, pointed them at the sky, and asked: is anyone else out there? The question itself — regardless of the answer — says something extraordinary about what human beings are.\n\nWe are the only species on Earth that asks questions about the universe. We are the only species that wonders whether we are alone. We are the only species that builds instruments to listen for voices we have never heard, from places we have never been, in languages we cannot understand. This capacity for wonder — for reaching beyond what we know towards what we might discover — is perhaps the most remarkable thing about being human.\n\nThe new study suggests that our search has barely scratched the surface. We have listened on a fraction of the frequencies, examined a tiny number of stars, and assumed that alien civilisations think and communicate the way we do. The universe may be full of signals we have not yet learned to hear.\n\nOr it may be silent. We may be alone in the cosmos — the only minds contemplating the stars. If so, that makes us not less significant but more. In a universe of two trillion galaxies and countless stars, the fact that matter organised itself into beings capable of asking "is anyone there?" is itself the most extraordinary signal of all.\n\nThe search continues. And that, regardless of the outcome, is beautiful.`,
    vocab: [
      { word: 'Profoundly', definition: 'Very deeply — in a way that goes to the core of something.' },
      { word: 'Contemplating', definition: 'Thinking deeply about something — considering it with serious attention.' },
      { word: 'Capacity', definition: 'The ability to do something — the potential for a particular function.' },
      { word: 'Regardless', definition: 'No matter what — whatever happens or whatever the outcome.' },
    ],
    questions: [
      { n: 10, q: 'Humans are the only species that asks if anyone else is out there. What does this say about us?' },
      { n: 11, q: 'If we are alone in the universe, does that make humanity more or less significant?' },
      { n: 12, q: 'The passage says the search itself is beautiful, regardless of the outcome. Do you agree? Is the question more important than the answer?' },
    ]
  },
]
...
export default function AlienSignalsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Alien Signals Hiding in Unexplored Frequencies</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>We have searched less than 1% of the radio spectrum for alien signals. A new study says we may have been listening on the wrong channel all along.</p>
            </div>
          </div>
