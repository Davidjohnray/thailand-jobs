...
const PARTS = [
  {
    number: 1, title: 'When Mountains Collapse', emoji: '🏔️', color: '#dc2626',
    text: `The floods that struck Nepal\'s northern border region this week were not merely a natural disaster — they were a convergence of geological, climatic, and developmental vulnerabilities that scientists have been warning about for years.\n\nThe immediate trigger was extreme monsoon rainfall — approximately 300mm in 48 hours, far exceeding historical averages for the region. But the destructive power of the floods was amplified by factors that make the Himalayan region uniquely dangerous: steep terrain that channels water into narrow valleys, glacial meltwater that has swollen rivers beyond their historical capacity, deforestation that has removed the root systems that once stabilised hillsides, and infrastructure built in floodplains that were never safe for habitation.\n\nThe death toll — at least 200 confirmed dead with more than 4,000 missing — places this among the worst flood disasters in Nepal\'s recent history. But what distinguishes this event from previous disasters is the speed and scale of the destruction. Entire villages were obliterated in minutes. Roads that took decades to build were erased overnight. Communication infrastructure — mobile towers, fibre-optic cables, satellite uplinks — was destroyed across an area the size of a small European country.\n\nThe disaster has exposed a fundamental tension in Nepal\'s development strategy: the infrastructure that connects remote communities to the national economy — roads, bridges, power lines — is built through the same narrow valleys that serve as natural flood channels. Development and vulnerability are, quite literally, following the same path.`,
    vocab: [
      { word: 'Convergence', definition: 'Multiple factors coming together at the same time, each amplifying the others.' },
      { word: 'Floodplains', definition: 'Low-lying areas beside rivers that are naturally prone to flooding.' },
      { word: 'Obliterated', definition: 'Completely destroyed — wiped out with nothing remaining.' },
      { word: 'Vulnerability', definition: 'Exposure to harm — the state of being at risk from threats.' },
    ],
    questions: [
      { n: 1, q: 'Multiple factors made this disaster worse than any single one alone. How does the concept of convergence change how we should prepare for disasters?' },
      { n: 2, q: 'Development and vulnerability follow the same path through Himalayan valleys. How can countries develop infrastructure without increasing disaster risk?' },
      { n: 3, q: 'Communication infrastructure was destroyed across a huge area. Why is losing communications during a disaster almost as dangerous as the disaster itself?' },
    ]
  },
  {
    number: 2, title: 'The Glacier Time Bomb', emoji: '🧊', color: '#b91c1c',
    text: `Behind this week\'s floods lies a longer-term threat that scientists consider one of the most dangerous and least discussed consequences of climate change: glacial lake outburst floods, or GLOFs.\n\nAs Himalayan glaciers retreat — they have lost approximately 40% of their area since the Little Ice Age — they leave behind lakes of meltwater, often dammed behind moraines: walls of loose rock and debris deposited by the retreating glacier. These moraine dams are inherently unstable. When they fail — through erosion, earthquake, or the sheer pressure of accumulating water — the result is a sudden, catastrophic release of millions of cubic metres of water.\n\nThe International Centre for Integrated Mountain Development has identified more than 2,000 potentially dangerous glacial lakes across the Hindu Kush-Himalayan region. Of these, approximately 200 are considered at imminent risk of outburst. The lakes are growing — both in number and in volume — as glaciers continue to melt.\n\nMonitoring these lakes is extraordinarily challenging. Many are located above 4,000 metres, accessible only by helicopter or multi-day treks. Satellite monitoring can track surface area but cannot assess the stability of moraine dams. Ground-based sensors can provide early warning, but installing and maintaining them in one of the most remote and inhospitable environments on Earth is expensive and logistically complex.\n\nThe communities downstream from these lakes — millions of people in Nepal, Bhutan, India, Pakistan, and China — live under a threat they can neither see nor control. The glacier time bomb is ticking, and this week\'s floods may be a preview of what is coming.`,
    vocab: [
      { word: 'Moraines', definition: 'Walls of rock and debris left behind by retreating glaciers — natural but unstable dams.' },
      { word: 'Outburst', definition: 'A sudden, violent release — in this context, a massive rush of water from a burst glacial lake.' },
      { word: 'Imminent', definition: 'About to happen very soon — an immediate and approaching threat.' },
      { word: 'Inhospitable', definition: 'An environment that is extremely difficult or dangerous for humans to live or work in.' },
    ],
    questions: [
      { n: 4, q: '200 glacial lakes are at imminent risk of bursting. What should be done about a threat this widespread and remote?' },
      { n: 5, q: 'Monitoring these lakes requires expensive technology in extremely remote locations. Who should pay for it?' },
      { n: 6, q: 'Millions of people live downstream from unstable glacial lakes. Should they be relocated? Is that realistic?' },
    ]
  },
  {
    number: 3, title: 'Climate Injustice', emoji: '⚖️', color: '#991b1b',
    text: `Nepal\'s annual carbon emissions are approximately 0.04% of the global total — roughly equivalent to a single large American city. Yet the country bears a disproportionate burden of climate consequences. This asymmetry — between those who cause climate change and those who suffer from it — is the defining injustice of the climate crisis.\n\nThe concept of "loss and damage" — compensation from wealthy polluting nations to vulnerable countries suffering climate impacts — was formally recognised at the COP27 climate summit in 2022. A Loss and Damage Fund was established at COP28 in 2023. But the fund remains drastically underfunded — with pledges totalling approximately 700 million dollars against estimated needs of hundreds of billions.\n\nFor Nepal, the arithmetic is stark. The country needs billions of dollars to build climate-resilient infrastructure, establish comprehensive early warning systems, relocate communities from high-risk areas, and restore degraded watersheds. It cannot afford these investments on its own. And the countries that can afford them — the same countries whose emissions are melting Nepal\'s glaciers — have so far provided only a fraction of what is needed.\n\nThe Nepal floods will produce a familiar cycle: international sympathy, emergency donations, pledges of support, and then — within weeks — the world\'s attention will move on. The structural changes needed to protect Nepal and countries like it from the next disaster will not be made. And the next disaster will come.\n\nThis pattern — where vulnerable countries absorb the costs of climate change while wealthy countries absorb the benefits of the fossil fuel economy — is not just unfortunate. It is a policy choice made by the most powerful nations on Earth.`,
    vocab: [
      { word: 'Loss and damage', definition: 'Compensation from wealthy polluting countries to those suffering from climate change impacts.' },
      { word: 'Climate-resilient', definition: 'Designed to withstand the effects of climate change — built to survive extreme weather.' },
      { word: 'Watersheds', definition: 'Areas of land where all water drains into the same river system — affecting water flow and flooding.' },
      { word: 'Structural', definition: 'Relating to the underlying system — fundamental changes rather than temporary fixes.' },
    ],
    questions: [
      { n: 7, q: 'Nepal produces 0.04% of global emissions but suffers disproportionate consequences. Is this injustice? Who is responsible?' },
      { n: 8, q: 'The Loss and Damage Fund has 700 million against needs of hundreds of billions. Why is there such a gap?' },
      { n: 9, q: 'After every disaster, the world pledges support then moves on. How can this cycle be broken?' },
    ]
  },
  {
    number: 4, title: 'Building for the Inevitable', emoji: '🔧', color: '#7f1d1d',
    text: `Nepal will flood again. The question is not whether but when — and whether the country and the international community will be better prepared next time.\n\nTechnical solutions exist. Early warning systems using river sensors, satellite monitoring, and mobile phone alerts can give downstream communities hours of advance notice — enough time to evacuate. Nepal has deployed such systems in some river basins, with significant success. Expanding them to cover all high-risk areas would cost approximately 50 million dollars — a tiny fraction of the cost of disaster response.\n\nEngineering solutions can reduce damage. Building bridges higher above flood levels, routing roads along ridgelines rather than valley floors, and constructing settlements on elevated ground can all reduce vulnerability. These approaches are more expensive than conventional construction but dramatically cheaper than rebuilding after a disaster.\n\nEcological approaches work too. Reforestation stabilises hillsides and reduces landslide risk. Wetland restoration absorbs floodwater. Maintaining natural river channels — rather than constraining rivers with embankments that fail catastrophically — allows floods to dissipate naturally.\n\nBut the most important change is political. Climate adaptation in vulnerable countries must be treated not as charity but as obligation — an obligation that wealthy nations owe to the countries bearing the consequences of their emissions. Until this principle is accepted and funded at the scale required, countries like Nepal will continue to pay with their lives for a crisis they did not cause.\n\nThe floods of August 2026 killed hundreds of people and left thousands missing. The next flood will come. Whether fewer people die depends entirely on decisions made now — not in Kathmandu, but in Washington, Beijing, Brussels, and every capital that has contributed to the emissions warming the Himalayas.`,
    vocab: [
      { word: 'Ridgelines', definition: 'The highest points along a mountain ridge — elevated terrain above flood risk.' },
      { word: 'Dissipate', definition: 'To spread out and gradually weaken — losing force as energy is distributed.' },
      { word: 'Embankments', definition: 'Raised walls of earth or concrete built along rivers to prevent flooding.' },
      { word: 'Obligation', definition: 'A duty or responsibility — something that must be done, not optional.' },
    ],
    questions: [
      { n: 10, q: 'Early warning systems for all high-risk areas would cost 50 million dollars. Why has this not been done already?' },
      { n: 11, q: 'Should climate adaptation be treated as charity or obligation? What is the difference in practice?' },
      { n: 12, q: 'The passage says decisions in Washington and Beijing determine whether Nepalis die in the next flood. Do you agree? What would change the outcome?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Nepal Floods — The Glacier Time Bomb". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function NepalFloodsB2Page() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Nepal Floods — The Glacier Time Bomb</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Catastrophic floods killed hundreds in Nepal. Glacial lakes, climate injustice, and why the countries that cause climate change must pay for its consequences.</p>
            </div>
          </div>
