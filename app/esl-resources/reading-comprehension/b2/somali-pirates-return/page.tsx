...
const PARTS = [
  {
    number: 1, title: 'Pirates Are Back', emoji: '⚓', color: '#dc2626',
    text: `Off the coast of Somalia — the longest coastline in mainland Africa — pirates are back. After nearly a decade of relative calm, attacks on cargo ships, fishing vessels, and smaller craft have surged to levels not seen since the peak of Somali piracy in 2011-2012.\n\nThe numbers tell a dramatic story. In the first eight months of 2026, there have been more than 40 reported attacks on vessels in waters off the Horn of Africa — compared to fewer than 10 in all of 2024. Several ships have been hijacked, with crews held for ransom. Others have been boarded, looted, and released. The cost to the shipping industry — in ransoms, insurance, rerouting, and security — is already in the billions.\n\nThe resurgence is driven by a convergence of factors that illustrates how chaos in one part of the world creates crime in another. The US-Iran conflict has diverted the international naval forces that once patrolled these waters. Political instability in Somalia has weakened the coast guard and created ungoverned spaces where pirate networks can operate freely. And the economic desperation of coastal communities — where fishing has been decimated by illegal foreign trawlers — provides a ready supply of young men willing to take extraordinary risks for the chance of a ransom payday.\n\nThe pirate business model is grimly efficient: capture a ship, hold the crew hostage, negotiate a ransom, collect the money, and disappear. At its peak, Somali piracy generated more than 400 million dollars in ransom payments — transforming impoverished fishing villages into surprisingly wealthy communities.`,
    vocab: [
      { word: 'Piracy', definition: 'The crime of attacking and robbing ships at sea.' },
      { word: 'Ransom', definition: 'Money demanded in exchange for releasing someone who is being held captive.' },
      { word: 'Resurgence', definition: 'A return or revival after a period of decline — coming back strongly.' },
      { word: 'Decimated', definition: 'Severely damaged or destroyed — reduced to a fraction of its former level.' },
    ],
    questions: [
      { n: 1, q: 'Piracy off Somalia has surged because of the Iran war and political instability. How does one crisis cause another?' },
      { n: 2, q: 'Young Somali men turn to piracy because of economic desperation. Does understanding the cause change how you view the crime?' },
      { n: 3, q: 'Piracy generated 400 million dollars in ransoms. Where did all that money go? Who benefited?' },
    ]
  },
  {
    number: 2, title: 'The Root Causes', emoji: '🌊', color: '#b91c1c',
    text: `Somali piracy did not emerge from nowhere. It grew from a perfect storm of state collapse, environmental destruction, and economic desperation that has made the Horn of Africa one of the most troubled regions on Earth.\n\nSomalia has not had a fully functioning national government since 1991, when the central state collapsed into civil war and clan-based conflict. The resulting power vacuum created conditions in which armed groups — including pirates — could operate with impunity.\n\nThe collapse of governance had a devastating effect on fishing communities. Without a coast guard to enforce maritime boundaries, foreign fishing fleets — from China, South Korea, Spain, and other countries — moved into Somali waters and stripped them of fish. Local fishermen, who had sustained their families for generations, found their livelihoods destroyed by industrial-scale foreign vessels that took everything and left nothing.\n\nSome of the earliest Somali pirates were, in fact, fishermen who began attacking foreign fishing boats in what they described as self-defence — protecting their waters from illegal exploitation. Over time, this evolved into a organised criminal enterprise targeting any vessel that could generate ransom revenue.\n\nThe evolution from desperate fishermen to professional pirates mirrors patterns seen throughout history. When legitimate economic opportunities disappear and governance collapses, people turn to whatever means of survival are available. Piracy is not a career choice — it is what happens when every other option has been taken away.`,
    vocab: [
      { word: 'Power vacuum', definition: 'A situation where no authority is in control — an absence of government or leadership.' },
      { word: 'Impunity', definition: 'Freedom from punishment — being able to act without facing consequences.' },
      { word: 'Industrial-scale', definition: 'Massive in size and operation — far beyond what small local operators can match.' },
      { word: 'Enterprise', definition: 'A business or organised activity — in this case, a criminal operation run like a business.' },
    ],
    questions: [
      { n: 4, q: 'Early Somali pirates were fishermen defending their waters from foreign fleets. Does this change how you see piracy?' },
      { n: 5, q: 'Foreign fishing fleets stripped Somali waters while there was no government to stop them. Who is responsible for this?' },
      { n: 6, q: 'Piracy is what happens when every other option is taken away. Do you agree? Are there always alternatives?' },
    ]
  },
  {
    number: 3, title: 'The Global Connection', emoji: '🔗', color: '#991b1b',
    text: `The return of Somali piracy in 2026 is a textbook example of how interconnected the modern world is — and how instability anywhere can create problems everywhere.\n\nThe chain of causation runs like this: the US-Iran conflict disrupts shipping in the Persian Gulf. International navies that were patrolling the Horn of Africa are redeployed to protect Gulf shipping lanes. The reduced naval presence off Somalia creates an opportunity for pirates. Piracy attacks increase. Shipping companies reroute or add security costs. Insurance premiums rise. These costs are passed to consumers worldwide through higher prices for goods that travel by sea — which is roughly 80% of all international trade.\n\nA separate chain connects politics to piracy. Political instability in Somalia — worsened by a resurgence of the al-Shabaab militant group — weakens the national government ability to maintain coastal security. International attention and funding that might have supported Somali governance is instead focused on Iran, Ukraine, and other crises. Somalia, once again, becomes a forgotten country — and forgotten countries breed the conditions for piracy.\n\nThe lesson is systemic: you cannot solve piracy by arresting pirates. You solve piracy by addressing its causes — governance, economic opportunity, environmental protection, and international cooperation. Every attempt to suppress piracy through military force alone has failed. The pirates simply wait until the warships leave, then return. Only addressing the root causes produces lasting results.`,
    vocab: [
      { word: 'Causation', definition: 'The relationship between cause and effect — how one event leads to another.' },
      { word: 'Redeployed', definition: 'Moved from one location to another — reassigning resources to a different mission.' },
      { word: 'Systemic', definition: 'Relating to the whole system — a problem built into the structure, not just a surface issue.' },
      { word: 'Suppress', definition: 'To stop or prevent by force — pushing something down without addressing its cause.' },
    ],
    questions: [
      { n: 7, q: 'The Iran war reduced naval patrols off Somalia, enabling piracy. How many steps connect these two events?' },
      { n: 8, q: 'Military force alone cannot solve piracy. What would a real solution look like?' },
      { n: 9, q: 'Somalia is called a "forgotten country." What happens to countries the world stops paying attention to?' },
    ]
  },
  {
    number: 4, title: 'The Cost of Chaos', emoji: '💰', color: '#7f1d1d',
    text: `The return of Somali piracy is, ultimately, a story about the cost of chaos — and about how the failure to invest in stability in one place creates expensive problems in many others.\n\nThe international naval operation that suppressed Somali piracy from 2012 to 2020 cost approximately 2 billion dollars per year. This was funded by NATO, the European Union, and individual countries. When the operation was scaled back — partly because piracy had declined, partly because resources were needed elsewhere — the international community effectively bet that the improvement would be self-sustaining.\n\nThat bet has failed. Piracy has returned because the conditions that created it — state failure, illegal fishing, economic desperation — were never addressed. The naval patrols treated the symptom while ignoring the disease. And now the symptom is back, more expensive than ever.\n\nThe cost of renewed piracy — in ransoms, insurance, rerouting, and naval operations — will likely exceed what it would have cost to maintain the patrols and invest in Somali governance, fisheries protection, and economic development. This pattern — where prevention is cheaper than response but less politically attractive — repeats across virtually every area of international policy.\n\nFor the shipping industry, for consumers who pay higher prices, and for the Somali communities caught between pirates and poverty, the message is clear: chaos is expensive. Stability is an investment, not a luxury. And the world pays — one way or another — for every failed state it chooses to ignore.`,
    vocab: [
      { word: 'Self-sustaining', definition: 'Able to maintain itself without outside help — continuing on its own.' },
      { word: 'Symptom', definition: 'A visible sign of a deeper problem — what you can see, not the underlying cause.' },
      { word: 'Fisheries', definition: 'The industry and management of fishing — the systems that regulate how fish are caught.' },
      { word: 'Failed state', definition: 'A country where the government has collapsed and cannot provide basic services or security.' },
    ],
    questions: [
      { n: 10, q: 'Prevention is cheaper than response but less politically attractive. Why do governments prefer to react rather than prevent?' },
      { n: 11, q: 'The world pays for every failed state it ignores. Should wealthy countries be required to invest in stability in fragile nations?' },
      { n: 12, q: 'Chaos is expensive. Stability is an investment. What would it take to apply this principle consistently around the world?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Somali Pirates Return as Global Chaos Spreads". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function SomaliPiratesPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Somali Pirates Return as Global Chaos Spreads</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Piracy off Somalia has surged to levels not seen in a decade — driven by the Iran war and political collapse. How chaos in one region creates crime in another.</p>
            </div>
          </div>
