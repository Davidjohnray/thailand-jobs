...
const PARTS = [
  {
    number: 1, title: 'The Alternative Table', emoji: '🤝', color: '#dc2626',
    text: `Indian Prime Minister Narendra Modi this week hosted Russian President Vladimir Putin, Chinese President Xi Jinping, and leaders from more than 30 countries at the BRICS summit in New Delhi. The summit — the most significant gathering of non-Western leaders in years — was framed as a demonstration that the global order is no longer defined exclusively by Western institutions.\n\nBRICS originally referred to Brazil, Russia, India, China, and South Africa — five major emerging economies that formed a bloc in 2009 to coordinate on trade, investment, and development. In 2024, the group expanded to include Egypt, Ethiopia, Iran, Saudi Arabia, and the UAE, more than doubling its membership and its share of global GDP.\n\nThe expanded BRICS now represents approximately 46% of the world population and 36% of global GDP. Its members produce more than 40% of the world oil. By any measure, it is the most significant grouping of non-Western nations in modern history.\n\nThe New Delhi Declaration — adopted at the summit — called for "maximum restraint" in the Middle East, reform of the UN Security Council, greater representation of developing countries in global financial institutions, and the development of alternatives to the US dollar for international trade. Each of these positions directly challenges the current Western-dominated international order.`,
    vocab: [
      { word: 'BRICS', definition: 'An alliance of major emerging economies — Brazil, Russia, India, China, South Africa, and newer members.' },
      { word: 'Emerging economies', definition: 'Countries whose economies are growing rapidly and becoming more influential globally.' },
      { word: 'Global GDP', definition: 'The total value of everything produced by all countries — the size of the world economy.' },
      { word: 'International order', definition: 'The system of rules, institutions, and power relationships that govern how countries interact.' },
    ],
    questions: [
      { n: 1, q: 'BRICS represents 46% of the world population. Why has it taken so long for non-Western countries to organise at this scale?' },
      { n: 2, q: 'The summit called for alternatives to the US dollar. Why would countries want to trade in other currencies?' },
      { n: 3, q: 'India hosted both Putin and Xi despite Western pressure. What does this tell us about how India sees its role in the world?' },
    ]
  },
  {
    number: 2, title: 'What BRICS Wants', emoji: '📋', color: '#b91c1c',
    text: `BRICS members share one fundamental grievance: they believe the current international system was designed by and for Western countries — and that it no longer reflects the realities of a world in which economic and political power has shifted dramatically.\n\nThe institutions that govern the global economy — the International Monetary Fund, the World Bank, the World Trade Organization — were created after World War II by the United States and its European allies. Voting power in these institutions still reflects the world of 1945 rather than the world of 2026. The US has an effective veto at the IMF. Europe controls the World Bank presidency by tradition. And the UN Security Council permanent membership — US, UK, France, Russia, China — has not changed since 1945.\n\nBRICS countries argue this is unjust. India, with 1.4 billion people and the world fifth-largest economy, has no permanent seat on the Security Council. Africa, with 1.4 billion people across 54 countries, has no permanent seat either. Brazil, the largest economy in Latin America, is excluded. The institutions that claim to represent the world actually represent a small fraction of it.\n\nThe BRICS alternative is still taking shape. The New Development Bank — BRICS own development bank, headquartered in Shanghai — has lent approximately 33 billion dollars since its creation in 2015. The Contingent Reserve Arrangement provides emergency funding without IMF conditions. And discussions about a BRICS currency — or at least a system for trading in local currencies rather than dollars — are advancing.`,
    vocab: [
      { word: 'Grievance', definition: 'A feeling of being treated unfairly — a complaint about injustice.' },
      { word: 'Veto', definition: 'The power to block a decision — preventing something from being approved.' },
      { word: 'Permanent seat', definition: 'A fixed position on a council that does not rotate — always held by the same country.' },
      { word: 'Contingent', definition: 'Available for use if needed — a backup or emergency option.' },
    ],
    questions: [
      { n: 4, q: 'India has 1.4 billion people but no permanent Security Council seat. Is this fair?' },
      { n: 5, q: 'Global institutions still reflect 1945 power structures. Should they be reformed? How?' },
      { n: 6, q: 'BRICS is building alternative institutions. Will these replace Western ones, or exist alongside them?' },
    ]
  },
  {
    number: 3, title: 'The Contradictions', emoji: '⚡', color: '#991b1b',
    text: `For all its ambition, BRICS faces deep internal contradictions that limit its effectiveness.\n\nThe most obvious is the China-India rivalry. The world two most populous countries share a disputed border where soldiers have clashed as recently as 2020. They compete for influence across Asia and Africa. And their economic interests often conflict — India wants to protect its domestic industries while China champions free trade that benefits its manufacturing dominance. Asking China and India to coordinate within BRICS is like asking two rival companies to share a boardroom.\n\nThe Russia problem complicates matters further. Russia invasion of Ukraine has divided BRICS. India and China have maintained ties with Russia but have not endorsed the invasion. Brazil and South Africa have tried to remain neutral. The new members — including Saudi Arabia and the UAE — have their own complex relationships with both Russia and the West.\n\nIdeological diversity is both a strength and a weakness. BRICS includes democracies (India, Brazil, South Africa), authoritarian states (China, Russia), theocracies (Iran), and monarchies (Saudi Arabia, UAE). They agree on opposing Western dominance but agree on little else. There is no shared political philosophy, no common legal system, and no mutual security guarantee.\n\nThe Western response has been to dismiss BRICS as incoherent — a collection of countries with nothing in common except resentment. But this dismissal may be premature. Shared opposition to the status quo can be a powerful binding force, even among very different countries.`,
    vocab: [
      { word: 'Contradictions', definition: 'Internal conflicts — things within a group that work against each other.' },
      { word: 'Endorsed', definition: 'Officially supported or approved — publicly declared agreement with.' },
      { word: 'Theocracies', definition: 'Countries governed by religious leaders according to religious law.' },
      { word: 'Incoherent', definition: 'Lacking consistency or logic — not forming a clear, unified whole.' },
    ],
    questions: [
      { n: 7, q: 'China and India are rivals sitting at the same table. Can competitors cooperate effectively?' },
      { n: 8, q: 'BRICS includes democracies and dictatorships. Does this diversity strengthen or weaken the alliance?' },
      { n: 9, q: 'The West dismisses BRICS as incoherent. Is this fair, or is shared opposition enough to hold a bloc together?' },
    ]
  },
  {
    number: 4, title: 'What It Means for You', emoji: '🌍', color: '#7f1d1d',
    text: `The BRICS summit may seem distant from daily life. But the shifts it represents will affect everyone — including people in Thailand.\n\nIf BRICS succeeds in creating alternatives to the US dollar for international trade, it could reduce American economic influence worldwide. Countries that currently depend on dollars for oil purchases, debt payments, and trade settlements would have options. This could lower costs for oil-importing nations like Thailand — or it could create financial instability as the world adjusts to a new system.\n\nThailand is not a BRICS member but has close economic ties with several member states — particularly China (its largest trading partner), India (a growing market), and Saudi Arabia (a major oil supplier). Thailand also maintains strong relationships with Western nations, particularly the US and EU. As BRICS and the West compete for influence, countries like Thailand face a familiar dilemma: how to benefit from both sides without being forced to choose.\n\nThe most significant long-term impact may be on global governance. If BRICS succeeds in reforming international institutions to give developing countries a greater voice, countries like Thailand — which are not powerful enough individually to shape global rules — could benefit from a more equitable system.\n\nThe world is changing. The Western-dominated order that has existed since 1945 is being challenged by countries representing nearly half the world population. Whether this challenge produces a better, fairer world — or simply replaces one set of dominant powers with another — is the defining question of the decade.`,
    vocab: [
      { word: 'Trade settlements', definition: 'The process of completing international business transactions — paying for imports and exports.' },
      { word: 'Equitable', definition: 'Fair and just — treating everyone equally and giving everyone a fair share.' },
      { word: 'Governance', definition: 'The system of rules and institutions that manage how the world works.' },
      { word: 'Dominant', definition: 'Most powerful and influential — controlling or having the most authority.' },
    ],
    questions: [
      { n: 10, q: 'Thailand trades heavily with both BRICS countries and the West. How should it navigate between the two?' },
      { n: 11, q: 'BRICS wants to reduce the dominance of the US dollar. What would a world with multiple reserve currencies look like?' },
      { n: 12, q: 'Will BRICS create a fairer world, or just replace one set of powerful countries with another?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "BRICS Summit in New Delhi — A New World Order?". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>BRICS Summit in New Delhi — A New World Order?</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Modi hosted Putin and Xi at the BRICS summit as wars test the bloc. Trade, investment, and whether BRICS can genuinely challenge Western dominance.</p>
            </div>
          </div>
