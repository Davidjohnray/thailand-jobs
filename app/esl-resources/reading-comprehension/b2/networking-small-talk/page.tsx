...
const PARTS = [
  {
    number: 1, title: 'Why Networking Matters — and Why It Feels Difficult', emoji: '🤝', color: '#f59e0b',
    text: `Professional networking — building relationships with people who may be useful to your career, and being useful to theirs — is widely recognised as one of the most powerful drivers of career success. Research consistently shows that a significant proportion of job opportunities are filled through personal connections rather than formal applications. Promotions, partnerships, clients, and mentors are often found through conversations at events, conferences, and industry gatherings rather than through official channels.\n\nDespite knowing this, many professionals — including native English speakers — find networking uncomfortable. Approaching strangers, introducing yourself, and making conversation without an obvious purpose can feel awkward and unnatural. For non-native English speakers, this discomfort is often amplified by additional concerns: worrying about making grammatical errors, not understanding jokes or cultural references, or struggling to keep a fast-moving conversation going. The first step in overcoming this is recognising that these feelings are universal — and that the people you are approaching at a networking event are almost certainly feeling the same way.`,
    vocab: [
      { word: 'Networking', definition: 'Building professional relationships that may benefit your career or business in the future.' },
      { word: 'Mentor', definition: 'An experienced person who gives guidance and advice to someone less experienced in their field.' },
      { word: 'Amplified', definition: 'Made stronger or more intense — a feeling that is increased by additional factors.' },
      { word: 'Universal', definition: 'Applying to everyone — a feeling or experience that all people share regardless of background.' },
    ],
    questions: [
      { n: 1, q: 'Do you find networking in English uncomfortable? What makes it feel difficult?' },
      { n: 2, q: 'Do you think networking is genuinely important for career success, or is it overstated?' },
      { n: 3, q: 'Is networking viewed the same way in your culture as it is in Western business culture?' },
    ]
  },
  {
    number: 2, title: 'Starting Conversations and Making a Strong First Impression', emoji: '👋', color: '#22c55e',
    text: `The opening moments of a networking conversation set the tone for everything that follows. A warm, confident introduction — including your name, your role, and a brief, interesting statement about what you do — is far more memorable than a vague or apologetic opener. Instead of saying "I'm just an accountant at a small firm," try: "I work in financial compliance — I help companies avoid the regulatory risks that can really slow growth." The second version is specific, interesting, and invites a follow-up question.\n\nApproaching someone who is standing alone is generally easier than interrupting a group conversation. If you are joining a group, wait for a natural pause before introducing yourself, and make eye contact with each person as you do so. A simple, friendly opener such as "Hi, I don't think we've met — I'm [Name] from [Company]" works in almost any professional setting. Once the introduction is made, the quickest way to build rapport is to ask a genuine question and listen actively to the answer. People remember conversations where they felt heard — not conversations where they were talked at.`,
    vocab: [
      { word: 'Compliance', definition: 'Following rules and regulations — making sure actions meet required standards or laws.' },
      { word: 'Rapport', definition: 'A comfortable, friendly relationship — a sense of connection and mutual understanding between people.' },
      { word: 'Vague', definition: 'Unclear and imprecise — not giving enough specific detail to be interesting or convincing.' },
      { word: 'Actively', definition: 'With full attention and engagement — actively listening means giving your complete focus to the speaker.' },
    ],
    questions: [
      { n: 4, q: 'How do you introduce yourself in a way that is interesting and not just a job title?' },
      { n: 5, q: 'Is it easier to approach someone alone or join a group? What are the risks of each?' },
      { n: 6, q: 'What makes someone a good conversationalist at a networking event?' },
    ]
  },
  {
    number: 3, title: 'The Art of Small Talk', emoji: '💬', color: '#3b82f6',
    text: `Small talk — the brief, light conversation that precedes serious discussion — plays a critical role in professional relationship-building. In many English-speaking business cultures, jumping straight into business topics without any social conversation first can feel abrupt and cold. Small talk warms up the interaction, establishes common ground, and signals that you are interested in the person, not just in what they can do for you.\n\nSafe and effective small talk topics in most English-speaking contexts include the event itself ("What did you think of the keynote speaker?"), industry trends ("Have you noticed how quickly things are changing in this sector?"), travel or location ("Have you been to this venue before?"), and recent positive news. Topics to approach with care include politics, religion, salary, and personal relationships. The goal of small talk is not to impress — it is to create a comfortable atmosphere in which a genuine professional conversation can develop. The best small talkers are not the wittiest people in the room; they are the ones who make the other person feel relaxed and interesting.`,
    vocab: [
      { word: 'Abrupt', definition: 'Sudden and unexpected — moving too quickly without allowing time to settle into a conversation.' },
      { word: 'Common ground', definition: 'Shared interests, experiences or opinions — a topic that both people can connect over.' },
      { word: 'Keynote speaker', definition: 'The main speaker at a conference or event — typically delivering the opening or most important talk.' },
      { word: 'Witty', definition: 'Clever and amusing — able to say funny and intelligent things quickly and naturally.' },
    ],
    questions: [
      { n: 7, q: 'Is small talk natural for you, or does it feel forced? How do you get better at it?' },
      { n: 8, q: 'What topics work well for small talk in your culture? Are they different from English-speaking norms?' },
      { n: 9, q: 'Can you think of a time when small talk led to an important professional connection or opportunity?' },
    ]
  },
  {
    number: 4, title: 'Keeping in Touch and Building Lasting Connections', emoji: '📱', color: '#8b5cf6',
    text: `Meeting someone at a networking event is only the beginning. The real value of networking comes from the relationships that develop over time — and that requires follow-up. After a productive conversation, the standard professional practice is to connect on LinkedIn within 24 to 48 hours, while the conversation is still fresh. A personalised connection request — mentioning something specific from your conversation — is far more effective than the default LinkedIn message. For example: "It was great meeting you at the [Event] yesterday — your point about supply chain resilience really stayed with me. I'd love to stay in touch."\n\nOver time, maintaining a professional network means staying in contact even when you do not need anything. Sharing a relevant article, congratulating a connection on a promotion, or commenting thoughtfully on their posts keeps the relationship warm without requiring a major investment of time. When you do eventually need to ask for help — a referral, advice, or an introduction — a well-maintained relationship makes that request far more natural and likely to succeed. The most effective networkers think of their professional relationships not as a resource to be used, but as a community to be nurtured.`,
    vocab: [
      { word: 'Personalised', definition: 'Adapted specifically for one person — showing that you remember and value the individual.' },
      { word: 'Resilience', definition: 'The ability to recover quickly from difficulties — strength and flexibility in the face of challenges.' },
      { word: 'Referral', definition: 'A recommendation that directs someone to a person, service or opportunity — a professional introduction.' },
      { word: 'Nurtured', definition: 'Cared for and developed over time — relationships that are maintained with regular attention and effort.' },
    ],
    questions: [
      { n: 10, q: 'Do you use LinkedIn for professional networking? How effective do you find it?' },
      { n: 11, q: 'How do you maintain professional relationships without it feeling forced or transactional?' },
      { n: 12, q: 'What is the most valuable professional connection you have made — and how did it happen?' },
    ]
  },
]
...
export default function NetworkingSmallTalkPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #78350f 0%, #f59e0b 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(255,255,255,0.25)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Business English</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Networking and Small Talk at Events</h1>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Work the Room — master the art of professional small talk, confident introductions, and building lasting connections at business events.</p>
            </div>
          </div>
