...
const PARTS = [
  {
    number: 1, title: 'The Mystery of the Homing Pigeon', emoji: '🐦', color: '#7c3aed',
    text: `Pigeons have been navigating with extraordinary precision for thousands of years. Ancient civilisations used them to carry messages across vast distances — the Romans used pigeons during military campaigns, medieval merchants relied on them for business communications, and carrier pigeons played a significant role in both world wars, delivering messages across enemy lines when all other means of communication had failed. What made them so valuable was their remarkable ability to find their way home from places they had never been before, over distances of hundreds of kilometres, with a reliability that human technology struggled to match for centuries.\n\nHow they did this has remained one of biology's most stubborn and fascinating puzzles. Scientists have proposed various theories over the decades — that pigeons navigate using the position of the sun, the pattern of the stars, the Earth's magnetic field, infrasound (low-frequency sound waves below the range of human hearing), smell, or some combination of several of these. Each theory has attracted both supporting evidence and serious objections, and the scientific community has never reached a definitive consensus.\n\nIn May 2026, a team of researchers at the Max Planck Institute of Animal Behaviour in Germany published a study that appeared to offer a significant new piece of the puzzle. Their finding was unexpected enough to attract coverage far beyond the specialist ornithology journals where such research normally appears: iron-filled immune cells located in the liver of pigeons may function as tiny magnetic sensors, helping the birds to detect and interpret the Earth's magnetic field during navigation.\n\nThe liver — not the brain, not the inner ear, not the beak, which had previously been the focus of magnetic navigation research in birds — was the last organ most people would have nominated as the seat of a pigeon's navigational ability.`,
    vocab: [
      { word: 'Precision', definition: 'The quality of being exact and accurate, with very little room for error.' },
      { word: 'Infrasound', definition: 'Sound waves at frequencies too low for humans to hear, but detectable by some animals.' },
      { word: 'Consensus', definition: 'General agreement among a group of people, especially experts in a particular field.' },
      { word: 'Ornithology', definition: 'The scientific study of birds.' },
    ],
    questions: [
      { n: 1, q: 'The passage describes the homing pigeon\'s navigational ability as something "human technology struggled to match for centuries." Does this change how you think about pigeons as animals?' },
      { n: 2, q: 'Scientists had proposed multiple competing theories about pigeon navigation for decades without reaching consensus. What does this tell us about how difficult some scientific questions are to answer?' },
      { n: 3, q: 'The finding pointed to the liver as the unexpected location of the magnetic sense. Why do you think surprising findings like this capture public attention more than expected ones?' },
    ]
  },
  {
    number: 2, title: 'Iron in the Liver — The New Discovery', emoji: '🔬', color: '#6d28d9',
    text: `The research, published in the journal Nature, built on a decades-long search for the biological mechanism underlying avian magnetic navigation. Scientists have known for some time that pigeons and many other bird species are sensitive to the Earth's magnetic field — they use it as a kind of internal compass to maintain direction during long journeys. What they have not known is which cells or organs are responsible for detecting it.\n\nThe Max Planck team, led by Dr Henrik Mouritsen and colleagues, identified a population of immune cells in the pigeon's liver that contain unusually high concentrations of iron in a form called magnetite — the same iron mineral that functions as a magnetic sensor in bacteria, fish, and some other animals. These cells, called Kupffer cells, are found in the livers of many mammals including humans, but in pigeons they appear to contain iron deposits dense enough to be sensitive to the Earth's weak magnetic field.\n\nThe researchers tested their hypothesis by surgically altering the magnetic properties of these cells in some pigeons and observing the effect on navigational performance. Pigeons with disrupted iron deposits in their liver cells showed significantly impaired navigation compared to control birds — they were more likely to become lost, took longer to return home, and showed less consistent orientation in open-sky navigation tests.\n\nThe finding does not necessarily mean that the liver is the only magnetic sensor in pigeons, or that other proposed navigation mechanisms — sun position, star patterns, smell — are incorrect. Navigation in animals is almost certainly multi-sensory, with different cues used in different conditions and at different scales. But it does suggest that a crucial piece of the puzzle has been overlooked — hidden, in a sense, in plain sight inside an organ that nobody thought to look at.`,
    vocab: [
      { word: 'Avian', definition: 'Relating to birds.' },
      { word: 'Magnetite', definition: 'A naturally occurring magnetic mineral made of iron oxide, found in some living organisms.' },
      { word: 'Hypothesis', definition: 'A proposed scientific explanation that can be tested through experiment.' },
      { word: 'Multi-sensory', definition: 'Involving or using several different senses at the same time.' },
    ],
    questions: [
      { n: 4, q: 'The researchers tested the hypothesis by disrupting the iron deposits and observing the effect. Why is this experimental approach considered stronger evidence than simply finding the cells?' },
      { n: 5, q: 'The passage notes that the liver was "hidden in plain sight." Why do you think scientists sometimes overlook the obvious? Can you think of examples from other fields?' },
      { n: 6, q: 'The finding doesn\'t invalidate other navigation theories — it adds to them. How do you feel about scientific questions that don\'t have one clean answer but instead involve many contributing factors?' },
    ]
  },
  {
    number: 3, title: 'What This Means for Science', emoji: '🧬', color: '#5b21b6',
    text: `The pigeon liver study is significant for several reasons that extend well beyond the question of how one species of bird finds its way home. It represents a reminder — one that the history of biology keeps providing — that animal physiology contains systems and capabilities that we have not yet discovered, and that these discoveries can come from unexpected directions.\n\nThe search for the biological basis of magnetic navigation has been ongoing since the 1960s, when German biologist Wolfgang Wiltschko first demonstrated experimentally that European robins could use the Earth's magnetic field for orientation. In the decades since, researchers have found evidence for magnetic sensitivity in dozens of species — not just birds, but also fish, sea turtles, dolphins, bees, and even some bacteria. The mechanisms, however, have remained elusive. The cells responsible for detecting magnetic fields are tiny, they contain minuscule amounts of magnetic material, and finding them in a living organism is technically extremely challenging.\n\nThe pigeon liver finding may prompt researchers to look at the livers of other magnetically sensitive species with fresh eyes. If iron-rich immune cells in the liver can function as magnetic sensors in pigeons, the same mechanism might operate in other animals — potentially explaining magnetic sensitivity in species where the mechanism has also been mysterious.\n\nMore broadly, the discovery illustrates one of the most consistently surprising features of biological research: that evolution has found solutions to problems — in this case, the problem of long-distance navigation without landmarks or instruments — that are entirely different from the solutions that human engineers have developed. A liver cell functioning as a compass needle is not a design that any human engineer would have arrived at. It is a solution produced by hundreds of millions of years of natural selection, and it works.`,
    vocab: [
      { word: 'Physiology', definition: 'The branch of biology concerned with the normal functions of living organisms and their parts.' },
      { word: 'Elusive', definition: 'Difficult to find, catch, or achieve; tending to escape or avoid.' },
      { word: 'Minuscule', definition: 'Extremely small; tiny.' },
      { word: 'Natural selection', definition: 'The process by which organisms better adapted to their environment tend to survive and reproduce more successfully.' },
    ],
    questions: [
      { n: 7, q: 'The passage says evolution has found solutions that human engineers would never have designed. Can you think of other examples where nature has solved problems in unexpected ways?' },
      { n: 8, q: 'Magnetic sensitivity has been found in bacteria, fish, turtles, bees, and birds. Does the widespread presence of this ability across such different species surprise you? What does it suggest?' },
      { n: 9, q: 'The discovery took decades of research to make. How do you think scientists stay motivated when working on problems that may take their entire career to answer?' },
    ]
  },
  {
    number: 4, title: 'The Pigeon Reconsidered', emoji: '🌍', color: '#4c1d95',
    text: `There is a certain irony in the fact that the animal at the centre of this discovery is the pigeon — specifically the common city pigeon, Columba livia, which is simultaneously one of the most studied birds in the world and one of the most consistently underestimated. Pigeons are so familiar in urban environments across the globe that they have become almost invisible — taken for granted, frequently regarded as a nuisance, and rarely thought of as the remarkable navigational machines that research repeatedly reveals them to be.\n\nThe history of the pigeon's relationship with humans is long and largely forgotten. For most of recorded history, the pigeon was a highly valued animal — a source of food, a means of communication, and, in the form of carrier pigeons, a technology that saved thousands of lives in wartime. The transition from valued companion to urban pest happened relatively recently, driven by urbanisation and the widespread availability of cheaper, faster communication methods. The pigeon did not change. The human context around it did.\n\nThe liver navigation study adds to a growing body of research that has been quietly rehabilitating the pigeon's scientific reputation over the past two decades. Studies have demonstrated that pigeons can recognise individual human faces, categorise objects in photographs at speeds comparable to human visual processing, and — most remarkably — understand the statistical concept of probability, a cognitive feat previously thought to be uniquely human.\n\nThe pigeon that sits on your windowsill or waddles across a city square, pecking at discarded food, is carrying in its liver a magnetic compass refined by evolution over millions of years. It can find its way home from a place it has never been, across hundreds of kilometres, using a sense that humans do not possess and have only just managed to identify. It is, in short, considerably more interesting than it looks — which may be true of more things in the world than we typically notice.`,
    vocab: [
      { word: 'Irony', definition: 'A situation that is the opposite of what you expect, often with a touch of humour.' },
      { word: 'Nuisance', definition: 'A person, thing, or situation that causes inconvenience or annoyance.' },
      { word: 'Rehabilitating', definition: 'Restoring something or someone to a good reputation or useful condition after a period of decline.' },
      { word: 'Cognitive', definition: 'Relating to mental processes such as thinking, reasoning, and understanding.' },
    ],
    questions: [
      { n: 10, q: 'The passage describes the pigeon\'s fall from "valued companion to urban pest." Can you think of other animals whose relationship with humans has changed dramatically over time?' },
      { n: 11, q: 'Pigeons can recognise human faces and understand probability. Does knowing this change how you feel about the pigeons you encounter in cities? Why?' },
      { n: 12, q: 'The passage ends by saying things may be "considerably more interesting than they look." What else in your daily life do you think might be more remarkable than you have given it credit for?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Pigeons Navigate with Their Livers — A Hidden Discovery That Rewrites What We Know". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be genuinely curious and intellectually engaged.`
...
export default function PigeonsLiverPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1e0a3c 0%, #3b0764 50%, #4c1d95 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#7c3aed', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B2 Upper Intermediate</span>
                <span style={{ background: 'rgba(124,58,237,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Hidden Headlines</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Pigeons Navigate with Their Livers</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Scientists have spent decades trying to solve one of biology's most stubborn mysteries. The answer was hiding inside an organ nobody thought to look at.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#7c3aed' : '#e5e7eb', background: speed === s.value ? '#7c3aed' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#faf5ff', padding: '8px 28px', borderBottom: '1px solid #ede9fe' }}>
              <span style={{ color: '#4c1d95', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#7c3aed' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#faf5ff', border: '1px solid #ede9fe', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#4c1d95', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(124,58,237,0.15)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#c4b5fd', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#7c3aed', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #ede9fe', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#faf5ff', color: '#4c1d95', border: '2px solid #ede9fe', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #ede9fe' }}>
                  <div style={{ color: '#4c1d95', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>📖 English Definition</div>
                ...
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #c4b5fd' }}>
                    <div style={{ color: '#6d28d9', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>{currentLang?.label} Translation</div>
