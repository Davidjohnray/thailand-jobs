...
const PARTS = [
  {
    number: 1, title: 'Drilling at the Top of the World', emoji: '🧊', color: '#dc2626',
    text: `This week, a Trump-linked oil company confirmed it is preparing to begin exploratory drilling in Greenland — the vast, ice-covered island between the Atlantic and Arctic oceans. The move follows an executive order signed by President Trump earlier this year that fast-tracked energy exploration in Arctic territories, bypassing environmental reviews that would normally take years.\n\nGreenland is an autonomous territory of Denmark, and its government has the right to control its own natural resources. But the decision to allow drilling has divided the island's small population of 57,000 people. Some see oil exploration as an economic lifeline — a way to reduce Greenland's dependence on Danish financial subsidies and build a more self-sufficient economy. Others see it as an environmental catastrophe in waiting — a threat to the pristine Arctic ecosystem and a contradiction of global efforts to reduce fossil fuel consumption.\n\nThe geological surveys suggest that the waters around Greenland contain significant oil and gas reserves — potentially billions of barrels. For energy companies, this represents an enormous commercial opportunity. For environmentalists, it represents exactly the kind of development that must be prevented if the world is to meet its climate commitments.\n\nThe irony is painful: climate change is melting Greenland's ice sheet at an accelerating rate, making previously inaccessible areas available for the very fossil fuel extraction that is causing the melting in the first place. The ice retreats, the drills advance, the ice retreats further. It is a feedback loop that encapsulates the central contradiction of the global energy economy.`,
    vocab: [
      { word: 'Exploratory drilling', definition: 'Drilling to discover whether oil or gas exists in a location — testing before full-scale production.' },
      { word: 'Autonomous', definition: 'Having the right to govern itself in certain areas — self-ruling within a larger political structure.' },
      { word: 'Subsidies', definition: 'Financial support given by a government to help an industry, community, or activity.' },
      { word: 'Feedback loop', definition: 'A cycle where the output of a process feeds back to reinforce the process — making it stronger.' },
    ],
    questions: [
      { n: 1, q: 'Climate change melts ice, making oil drilling possible, which causes more climate change. How do you break this feedback loop?' },
      { n: 2, q: 'Greenland population is divided — some want oil money, others want environmental protection. How should small communities make decisions this consequential?' },
      { n: 3, q: 'Trump fast-tracked drilling by bypassing environmental reviews. Should environmental assessments be mandatory even when they slow development?' },
    ]
  },
  {
    number: 2, title: 'The Arctic Gold Rush', emoji: '🛢️', color: '#b91c1c',
    text: `Greenland is not the only Arctic territory attracting energy companies. As climate change melts sea ice and opens previously frozen waters, a new "Arctic gold rush" is underway — with Russia, the United States, Canada, Norway, and Denmark all staking claims to the vast natural resources beneath the Arctic Ocean.\n\nThe Arctic is estimated to contain approximately 13% of the world's undiscovered oil reserves and 30% of its undiscovered natural gas. These resources were inaccessible until recently because they lay beneath permanent ice. But as summer sea ice extent has declined by more than 40% since satellite monitoring began in 1979, shipping routes have opened, and drilling operations that were once technically impossible are becoming feasible.\n\nRussia has been the most aggressive in claiming Arctic territory. It has reopened Soviet-era military bases, built new icebreakers, and planted a Russian flag on the seabed beneath the North Pole — a symbolic gesture that other Arctic nations viewed with alarm. Russia currently operates several offshore oil platforms in the Arctic, despite the enormous environmental risks.\n\nThe environmental stakes could not be higher. The Arctic ecosystem is one of the most fragile on Earth. An oil spill in Arctic waters would be catastrophic — the cold temperatures slow the natural breakdown of oil, ice prevents the deployment of containment equipment, and the remote location makes cleanup operations extraordinarily difficult. The Deepwater Horizon spill in the Gulf of Mexico in 2010 was devastating enough in warm, accessible waters. A similar event in the Arctic could cause damage that lasts for decades.`,
    vocab: [
      { word: 'Staking claims', definition: 'Formally declaring ownership or rights over something — asserting territorial control.' },
      { word: 'Feasible', definition: 'Possible and practical — something that can realistically be done.' },
      { word: 'Fragile', definition: 'Easily damaged or destroyed — delicate and vulnerable to harm.' },
      { word: 'Containment', definition: 'The act of preventing something harmful from spreading — keeping it within limits.' },
    ],
    questions: [
      { n: 4, q: 'The Arctic has 13% of undiscovered oil and 30% of gas. Should these resources be extracted, or should they stay in the ground?' },
      { n: 5, q: 'Russia planted a flag on the seabed beneath the North Pole. Does planting a flag give you ownership? How should Arctic resources be shared?' },
      { n: 6, q: 'An Arctic oil spill would be far worse than Deepwater Horizon. Is any economic benefit worth this risk?' },
    ]
  },
  {
    number: 3, title: 'Greenland Caught in the Middle', emoji: '🇬🇱', color: '#991b1b',
    text: `For Greenland, the drilling controversy is about much more than oil — it is about sovereignty, identity, and the island's future as an independent nation.\n\nGreenland has been moving towards independence from Denmark for decades. It gained home rule in 1979 and self-governance in 2009, but remains financially dependent on an annual subsidy from Copenhagen of approximately 3.4 billion Danish kroner (roughly 500 million US dollars). This subsidy accounts for about half of Greenland's government budget. Full independence would require replacing this income — and oil revenues are the most obvious candidate.\n\nBut the path from exploration to production is long, expensive, and uncertain. Previous drilling campaigns in Greenland's waters found oil, but not in commercially viable quantities. The extreme conditions — icebergs, storms, months of darkness — make drilling far more expensive than in conventional locations. And the global energy transition towards renewables means that demand for oil may decline significantly over the coming decades, potentially making Arctic oil economically unviable before Greenland can benefit from it.\n\nTrump's interest in Greenland predates the current drilling controversy. In 2019, during his first term, Trump proposed purchasing Greenland from Denmark — an offer that was ridiculed by Danish and Greenlandic leaders alike. His renewed focus on the island's resources reflects a broader strategic interest in the Arctic, where the United States has been less active than Russia or China.\n\nFor Greenland's indigenous Inuit population — who make up approximately 88% of the island's residents — the stakes are deeply personal. Their culture, identity, and way of life are intimately connected to the Arctic environment. Oil development threatens the ecosystems they depend on for hunting and fishing, while offering economic opportunities that could fundamentally transform their society. It is a dilemma that mirrors the choices facing indigenous communities across the Arctic.`,
    vocab: [
      { word: 'Sovereignty', definition: 'The authority of a state to govern itself — supreme power and independence.' },
      { word: 'Commercially viable', definition: 'Profitable enough to justify the investment — worth doing from a business perspective.' },
      { word: 'Indigenous', definition: 'The original inhabitants of a place — people whose ancestors lived there before colonisation.' },
      { word: 'Dilemma', definition: 'A difficult situation where you must choose between two options, both with significant drawbacks.' },
    ],
    questions: [
      { n: 7, q: 'Greenland needs oil revenue to become independent from Denmark. Should environmental concerns override the desire for sovereignty?' },
      { n: 8, q: 'Trump tried to buy Greenland in 2019. Can countries buy other countries territory? What does this say about power dynamics?' },
      { n: 9, q: 'The Inuit population depends on the Arctic environment but also needs economic development. How would you resolve this dilemma?' },
    ]
  },
  {
    number: 4, title: 'The Last Frontier', emoji: '❄️', color: '#7f1d1d',
    text: `The Greenland drilling story crystallises one of the central questions of the 21st century: should there be places on Earth where resource extraction is simply not allowed — regardless of the economic benefits?\n\nThe argument for drilling is economic. Greenland needs revenue. The world still needs oil. The technology exists to extract it relatively safely. And the decision should belong to Greenland's people, not to environmental activists in distant cities who will not bear the economic consequences of saying no.\n\nThe argument against drilling is environmental and temporal. The Arctic is one of the last relatively untouched ecosystems on Earth. Oil extracted from Greenland will be burned, producing carbon emissions that will accelerate the very ice melt that made extraction possible. And the economic benefits will be temporary — oil is a finite resource that the world is committed to moving away from — while the environmental damage could be permanent.\n\nThere is also a philosophical dimension. The Arctic represents something that is increasingly rare in the modern world: wilderness. Untouched, unmanaged, unmonetised space. The drive to drill in Greenland is part of a larger pattern in which every resource, every landscape, every square metre of the planet must generate economic value or be considered wasted. The counterargument is that some things are valuable precisely because they are not exploited — that preserving wild places is not a waste but an investment in the planet's future.\n\nThe drills are being prepared. The environmental reviews have been bypassed. The ice continues to melt. And the question of whether the last frontier should be opened or protected remains the most consequential environmental decision of our time.`,
    vocab: [
      { word: 'Crystallises', definition: 'Makes something clear and focused — brings a complex issue into sharp definition.' },
      { word: 'Finite', definition: 'Limited in quantity — something that will eventually run out.' },
      { word: 'Wilderness', definition: 'Natural land that has not been developed or significantly altered by humans.' },
      { word: 'Consequential', definition: 'Having important and far-reaching results — significant enough to change outcomes.' },
    ],
    questions: [
      { n: 10, q: 'Should there be places on Earth where resource extraction is never allowed? Where would you draw those lines?' },
      { n: 11, q: 'The passage says some things are valuable because they are not exploited. Do you agree? Is wilderness worth preserving for its own sake?' },
      { n: 12, q: 'Oil from Greenland will accelerate the ice melt that made drilling possible. Is there a more perfect example of self-destructive behaviour?' },
    ]
  },
]
...
export default function GreenlandOilPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Oil Drilling in Greenland</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A Trump-linked company is preparing to drill for oil in Greenland. The Arctic gold rush, indigenous sovereignty, and whether some places should be off limits forever.</p>
            </div>
          </div>
