...
const PARTS = [
  {
    number: 1, title: 'Destroying the Evidence', emoji: '🔬', color: '#dc2626',
    text: `Syria new transitional government confirmed this week that it has begun destroying the remnants of the chemical weapons programme that the Assad regime used to kill thousands of civilians during the civil war. The announcement, made jointly with the United Nations, marks a significant step in Syria effort to break with its past and rebuild international trust.\n\nThe weapons being destroyed include precursor chemicals — the raw materials needed to produce nerve agents like sarin and VX — that were recovered from hidden stockpiles discovered after Assad government fell in late 2025. Some of these stockpiles had been hidden from international inspectors for years, contradicting Assad claims that all chemical weapons had been eliminated under a 2013 agreement brokered by Russia.\n\nThe destruction is being overseen by the Organisation for the Prohibition of Chemical Weapons, which has deployed inspectors and technical specialists to supervise the process. The chemicals are being neutralised using specialised equipment — a process that renders them harmless but takes months to complete safely.\n\nFor the families of the thousands of Syrians killed by chemical weapons — in attacks on Ghouta, Khan Shaykhun, Douma, and dozens of other locations — the destruction is bittersweet. It ensures that these weapons will never be used again. But it also destroys potential evidence that could have been used in future war crimes prosecutions.`,
    vocab: [
      { word: 'Precursor chemicals', definition: 'Raw materials that can be combined to produce chemical weapons — the ingredients.' },
      { word: 'Nerve agents', definition: 'Extremely toxic chemicals that attack the nervous system, causing paralysis and death.' },
      { word: 'Neutralised', definition: 'Made harmless — processed so that dangerous chemicals can no longer cause harm.' },
      { word: 'Bittersweet', definition: 'Producing both happiness and sadness — a mix of positive and negative feelings.' },
    ],
    questions: [
      { n: 1, q: 'Destroying chemical weapons ensures they cannot be used again but also destroys evidence. Which is more important — safety or justice?' },
      { n: 2, q: 'Assad hid weapons from inspectors for years. What does this tell us about the effectiveness of arms control agreements?' },
      { n: 3, q: 'Syria is trying to break with its past. Can a country that used chemical weapons on its own people truly start over?' },
    ]
  },
  {
    number: 2, title: 'The Red Line That Was Not', emoji: '🔴', color: '#b91c1c',
    text: `The history of chemical weapons in Syria is also a history of international failure.\n\nIn 2012, US President Barack Obama declared that the use of chemical weapons by the Assad regime would constitute a "red line" — an act that would trigger a US military response. In August 2013, Assad forces launched a sarin gas attack on the Damascus suburb of Ghouta, killing more than 1,400 people. The red line had been crossed.\n\nBut the US did not respond militarily. Instead, a diplomatic deal was struck — brokered by Russia — under which Syria agreed to declare and destroy its chemical weapons stockpile. The deal was celebrated as a diplomatic success. Syria joined the Chemical Weapons Convention. International inspectors arrived. Declared stockpiles were removed and destroyed.\n\nBut the deal had a fatal flaw: it relied on Assad honesty. And Assad lied. He did not declare all of his stockpiles. He continued developing and using chemical weapons — in smaller quantities, using methods that were harder to detect. Chlorine barrel bombs became a regular feature of the war. And in April 2017, another sarin attack — on the town of Khan Shaykhun — killed nearly 100 people.\n\nThe lesson is painful: diplomatic agreements are only as strong as the parties willingness to honour them. When a regime lies about its weapons, and the international community lacks the will to verify compliance, agreements become pieces of paper — and people continue to die.`,
    vocab: [
      { word: 'Red line', definition: 'A boundary that must not be crossed — a limit beyond which serious consequences will follow.' },
      { word: 'Compliance', definition: 'Following the rules of an agreement — doing what you promised to do.' },
      { word: 'Regime', definition: 'A government, especially one that is authoritarian or undemocratic.' },
      { word: 'Convention', definition: 'A formal international agreement — a treaty signed by multiple countries.' },
    ],
    questions: [
      { n: 4, q: 'Obama drew a red line but did not act when it was crossed. What message did this send to other authoritarian leaders?' },
      { n: 5, q: 'The diplomatic deal relied on Assad honesty and he lied. How can arms control agreements be made enforceable?' },
      { n: 6, q: 'Chemical weapons were banned in 1997 but have been used multiple times since. Are international bans effective?' },
    ]
  },
  {
    number: 3, title: 'Why Chemical Weapons Are Different', emoji: '☠️', color: '#991b1b',
    text: `All weapons kill. But chemical weapons occupy a special category in international law and public consciousness — and understanding why helps explain the global reaction to their use in Syria.\n\nChemical weapons were first used on a large scale during World War I, when both sides deployed chlorine, phosgene, and mustard gas against enemy trenches. The results were horrifying — soldiers drowning in their own lungs, suffering agonising burns, and dying slowly over days. The experience was so traumatic that nations agreed to ban chemical weapons in the 1925 Geneva Protocol — one of the first international arms control agreements.\n\nWhat makes chemical weapons uniquely horrifying is not their lethality — conventional explosives kill more people in most conflicts. It is their indiscriminate nature and the suffering they cause. A chemical weapon cannot be aimed at a specific soldier. It drifts with the wind, affecting everyone in the area — soldiers and civilians, adults and children, the intended target and the innocent bystander. And death by nerve agent is particularly cruel — victims experience convulsions, paralysis, and suffocation while remaining conscious.\n\nThe taboo against chemical weapons is one of the strongest norms in international relations. Even during World War II — the most destructive conflict in human history — neither side used chemical weapons on the battlefield, despite both possessing massive stockpiles. The taboo held because both sides feared retaliation and because the moral revulsion against chemical weapons had become deeply embedded in military culture.`,
    vocab: [
      { word: 'Taboo', definition: 'Something strongly prohibited by social custom or moral belief — an act considered unacceptable.' },
      { word: 'Indiscriminate', definition: 'Affecting everyone without distinction — not targeted at specific individuals.' },
      { word: 'Norms', definition: 'Accepted standards of behaviour — rules that most countries agree to follow.' },
      { word: 'Revulsion', definition: 'A strong feeling of disgust — intense moral rejection of something.' },
    ],
    questions: [
      { n: 7, q: 'Chemical weapons are banned partly because of how they make people suffer. Should the method of killing matter in war, or is all killing equally wrong?' },
      { n: 8, q: 'Even in WWII, chemical weapons were not used on the battlefield. Why did the taboo hold then but not in Syria?' },
      { n: 9, q: 'International norms against chemical weapons have been weakened by Syria. How can these norms be restored?' },
    ]
  },
  {
    number: 4, title: 'Can Syria Start Again?', emoji: '🌱', color: '#7f1d1d',
    text: `The destruction of Assad chemical weapons is more than a technical exercise in disarmament. It is a symbolic act — a new government declaring that it will not use the tools of terror that its predecessor wielded against its own people.\n\nBut symbols alone do not rebuild a country. Syria faces challenges that make the chemical weapons issue seem almost simple by comparison. More than half the population has been displaced. Cities lie in ruins. The economy has collapsed. Multiple armed groups control different parts of the country. And the ethnic, religious, and political divisions that fuelled the civil war have not been resolved.\n\nThe international community role is crucial — and its track record is mixed. Foreign countries intervened in the civil war on all sides, prolonging the conflict and increasing civilian suffering. Now those same countries are being asked to help rebuild. The question is whether they will provide the sustained support that rebuilding requires, or whether they will move on to the next crisis and leave Syria to manage alone.\n\nHistory offers both cautionary tales and models of hope. Germany and Japan were devastated by World War II but rebuilt into prosperous democracies with massive international support. Libya and Iraq were devastated by conflict and received inadequate post-war support — and remain unstable decades later. Which path Syria follows depends on choices being made right now.\n\nThe chemicals are being destroyed. The past is being dismantled. What remains to be built is a future — for 22 million Syrians who have already endured more than any population should have to.`,
    vocab: [
      { word: 'Disarmament', definition: 'The process of reducing or eliminating weapons — giving up military capabilities.' },
      { word: 'Predecessor', definition: 'The person or government that held the position before — the previous leader.' },
      { word: 'Track record', definition: 'A history of past performance — how well or badly someone has done before.' },
      { word: 'Prosperous', definition: 'Wealthy and successful — economically thriving.' },
    ],
    questions: [
      { n: 10, q: 'Germany rebuilt after WWII with massive help. Libya and Iraq did not. What makes the difference?' },
      { n: 11, q: 'Countries that fuelled the war are now asked to help rebuild. Should they be required to pay?' },
      { n: 12, q: 'Can Syria start again? What would a successful Syria look like in 20 years?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Syria Begins Destroying Assad Chemical Weapons". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function SyriaChemPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Syria Begins Destroying Assad Chemical Weapons</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Syria new government has begun dismantling the chemical weapons programme that Assad used against his own people. Justice, disarmament, and whether a country can truly start over.</p>
            </div>
          </div>
