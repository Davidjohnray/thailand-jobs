...
const PARTS = [
  {
    number: 1, title: 'Making History', emoji: '🗳️', color: '#dc2626',
    text: `This week, Aisha Wahab won a special election in California to become the first Afghan American member of the United States Congress. The victory was historic — not just for Afghan Americans, but for every immigrant community that has fought for representation in a country that has not always welcomed them.\n\nWahab's story is extraordinary. Her parents fled Afghanistan during the Soviet invasion in the 1980s, eventually settling in California. She grew up in a working-class family, the first in her family to attend university. Before entering politics, she worked as a community organiser, advocating for affordable housing and workers' rights.\n\nIn 2022, she was elected to the California State Senate — the first Afghan American state senator in US history. Her congressional victory extends that barrier-breaking journey to the national stage.\n\nHer election comes at a complex moment for Afghan Americans. Five years after the Taliban retook Afghanistan in 2021 — and the chaotic US withdrawal that left many Afghans feeling abandoned — the community is navigating a painful duality: building new lives in America while watching their homeland suffer under Taliban rule. Wahab's victory gives them a voice in the institution that decides US foreign policy — including policy toward Afghanistan.`,
    vocab: [
      { word: 'Representation', definition: 'Having someone who shares your background speak and act on your behalf in government.' },
      { word: 'Community organiser', definition: 'A person who helps communities work together to solve problems and improve their lives.' },
      { word: 'Barrier-breaking', definition: 'Being the first to achieve something that was previously closed to your group.' },
      { word: 'Duality', definition: 'The state of having two different aspects or identities at the same time.' },
    ],
    questions: [
      { n: 1, q: 'What does it mean for a community to see someone who looks like them in Congress for the first time?' },
      { n: 2, q: 'Wahab\'s parents fled war. She became a congresswoman. What does this journey tell us about immigration and opportunity?' },
      { n: 3, q: 'Afghan Americans watch their homeland suffer while building new lives. How do immigrants balance two identities?' },
    ]
  },
  {
    number: 2, title: 'Why Representation Matters', emoji: '🏛️', color: '#b91c1c',
    text: `The United States Congress has 535 members. For most of American history, the vast majority were white men. This has changed slowly — painfully slowly — over decades. The first woman was elected to Congress in 1916. The first Black senator took office in 1870 but it was another century before Black representation in Congress became consistent. The first Muslim member was elected in 2006. The first openly transgender member in 2024.\n\nEach of these firsts matters because representation affects policy. Research consistently shows that legislators who share a demographic background with their constituents are more likely to raise issues that affect those communities. Women in Congress are more likely to introduce legislation on childcare, reproductive rights, and domestic violence. Black legislators are more likely to address criminal justice reform and voting rights. And Afghan American representation in Congress could influence policy on refugee resettlement, foreign aid, and the US relationship with Afghanistan.\n\nRepresentation also has a symbolic power that extends beyond policy. When a young Afghan American girl sees someone who looks like her in Congress, it expands her sense of what is possible. The "role model effect" — extensively documented in research — shows that visible representation in leadership positions directly increases the aspirations and engagement of underrepresented groups.\n\nBut representation is not a substitute for policy. Having diverse faces in Congress matters, but what those faces do with their power matters more. The test for Wahab — as for any legislator — will be whether she can translate her historic election into meaningful change for the communities she represents.`,
    vocab: [
      { word: 'Legislators', definition: 'People who make laws — elected officials in a parliament or congress.' },
      { word: 'Constituents', definition: 'The people who live in the area that an elected official represents.' },
      { word: 'Demographic', definition: 'Relating to the characteristics of a population — age, race, gender, background.' },
      { word: 'Aspirations', definition: 'Hopes and ambitions for the future — what you want to achieve.' },
    ],
    questions: [
      { n: 4, q: 'Women in Congress raise more issues about childcare. Why does personal experience matter in making laws?' },
      { n: 5, q: 'When a young girl sees someone like her in Congress, it changes her aspirations. Can you think of a role model who changed what you thought was possible?' },
      { n: 6, q: 'Is representation enough, or does it matter what representatives actually do with their power?' },
    ]
  },
  {
    number: 3, title: 'The Afghan American Story', emoji: '🇦🇫', color: '#991b1b',
    text: `There are approximately 200,000 Afghan Americans living in the United States — a relatively small community, but one with a complex and often painful history.\n\nThe first wave of Afghan immigrants arrived in the 1980s, fleeing the Soviet invasion and the civil war that followed. Many were educated professionals — doctors, engineers, teachers — who had to start over in a new country, often working jobs far below their qualifications while learning English and navigating an unfamiliar culture.\n\nA second wave arrived after the Taliban first took power in 1996. And the largest and most traumatic wave came in 2021, when the US withdrew from Afghanistan after 20 years of war. The withdrawal was chaotic — desperate crowds at Kabul airport, people clinging to departing aircraft, families separated at checkpoints. More than 76,000 Afghans were evacuated to the US, but many more were left behind.\n\nThe Afghan Americans who arrived in 2021 faced unique challenges. Many had worked with the US military or government as translators, drivers, and advisors — putting their lives at risk in service to a country that was now struggling to resettle them. They arrived traumatised, often without documentation, and entered a resettlement system that was overwhelmed by the scale and speed of the evacuation.\n\nDespite these challenges, Afghan Americans have built successful lives across the US — in business, education, medicine, technology, and now politics. Wahab's election is a milestone in a community story that began with displacement and is now producing leaders.`,
    vocab: [
      { word: 'Qualifications', definition: 'The skills, education, and experience that make someone suitable for a job.' },
      { word: 'Evacuated', definition: 'Removed from a dangerous place to somewhere safe — transported to safety.' },
      { word: 'Resettlement', definition: 'The process of helping refugees establish new lives in a new country.' },
      { word: 'Milestone', definition: 'An important event that marks significant progress — a notable achievement.' },
    ],
    questions: [
      { n: 7, q: 'Many Afghan professionals had to start over in jobs below their qualifications. How does this experience affect immigrants and their families?' },
      { n: 8, q: 'People who helped the US military were left behind in the 2021 withdrawal. Does a country have an obligation to protect those who served it?' },
      { n: 9, q: 'The Afghan American community went from displacement to producing a congresswoman. What does this journey reveal about immigrant communities?' },
    ]
  },
  {
    number: 4, title: 'The Immigrant Question', emoji: '🌏', color: '#7f1d1d',
    text: `Wahab's election arrives at a moment when immigration is the most contentious political issue in the United States. President Trump has made immigration restriction a central policy priority, increasing deportations, reducing legal immigration pathways, and using rhetoric that critics describe as dehumanising toward immigrants.\n\nThe tension between America's identity as "a nation of immigrants" and its recurring waves of anti-immigrant sentiment is one of the defining contradictions of American history. Every wave of immigration — Irish in the 1840s, Chinese in the 1870s, Italians in the 1900s, Mexicans throughout the 20th century, and now Afghan, Syrian, and Central American refugees — has been met with resistance, discrimination, and claims that the newcomers will destroy American culture.\n\nAnd every wave has, eventually, been absorbed — enriching American culture, strengthening the economy, and producing leaders who shape the nation. The Irish Americans who were once despised became presidents. The Italian Americans who were once excluded became Supreme Court justices. And now, an Afghan American whose parents fled war sits in the United States Congress.\n\nThis pattern offers both hope and frustration. Hope because it shows that acceptance eventually comes. Frustration because each new wave of immigrants must fight the same battles — against prejudice, exclusion, and the persistent myth that there is a finite amount of "Americanness" that newcomers might dilute.\n\nWahab's story does not resolve these tensions. But it embodies the best version of the American promise: that where you come from matters less than what you do with the opportunity you are given.`,
    vocab: [
      { word: 'Contentious', definition: 'Causing disagreement and argument — a subject people feel strongly about.' },
      { word: 'Dehumanising', definition: 'Treating people as less than human — removing their dignity and individuality.' },
      { word: 'Sentiment', definition: 'A feeling or attitude, especially one shared by many people.' },
      { word: 'Embodies', definition: 'Represents or expresses something in a visible, concrete way — is a living example of.' },
    ],
    questions: [
      { n: 10, q: 'Every wave of immigrants to America was rejected then eventually accepted. Why does this pattern keep repeating?' },
      { n: 11, q: 'Is there a finite amount of national identity that immigrants dilute, or does immigration enrich a country? Defend your answer.' },
      { n: 12, q: 'Wahab embodies the American promise that where you come from matters less than what you do. Does this promise exist in your country too?' },
    ]
  },
]
...
export default function AfghanCongressPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>First Afghan American in Congress</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Aisha Wahab became the first Afghan American in Congress. Why representation matters, the Afghan American story, and the immigrant question in 2026.</p>
            </div>
          </div>
