...
const PARTS = [
  {
    number: 1, title: 'What Is Esports — and How Big Has It Become?', emoji: '🎮', color: '#8b5cf6',
    text: `Esports — competitive video gaming played at a professional level — has grown from a niche hobby into a global industry worth billions of dollars. Professional players compete in front of live audiences of tens of thousands, with millions more watching online via streaming platforms such as Twitch and YouTube. Games like League of Legends, Valorant, Counter-Strike, and FIFA have dedicated professional leagues, major tournaments with prize pools that rival traditional sports, and player contracts that include salaries, sponsorships, and performance bonuses.\n\nThe scale of esports is difficult to ignore. The League of Legends World Championship regularly attracts more online viewers than the Super Bowl or the NBA Finals. South Korea, China, and the United States have been the dominant forces in competitive gaming for years, but Southeast Asia — including Thailand, Indonesia, and the Philippines — has emerged as a rapidly growing market, both for players and for audiences. In 2022, esports was included as a medal event at the Asian Games for the first time, signalling a significant shift in how competitive gaming is being perceived by mainstream sporting organisations.`,
    vocab: [
      { word: 'Niche', definition: 'Appealing to a small, specific group — something that is not yet mainstream or widely known.' },
      { word: 'Prize pool', definition: 'The total amount of money available to be won in a competition — shared among the top finishers.' },
      { word: 'Streaming', definition: 'Watching or broadcasting video content live over the internet — platforms like Twitch or YouTube.' },
      { word: 'Mainstream', definition: 'Normal and accepted by most people — part of general culture rather than a specialist interest.' },
    ],
    questions: [
      { n: 1, q: 'Were you surprised by how large the esports industry has become? Why or why not?' },
      { n: 2, q: 'Do you watch esports? If yes, which games — if no, why not?' },
      { n: 3, q: 'Why do you think Southeast Asia has become such a major market for esports?' },
    ]
  },
  {
    number: 2, title: 'The Arguments For: Why Esports Deserves to Be Called a Sport', emoji: '🏆', color: '#3b82f6',
    text: `Supporters of esports argue that competitive gaming meets every meaningful definition of sport. Professional players train for eight to twelve hours a day, developing extraordinary levels of hand-eye coordination, reaction speed, strategic thinking, and mental endurance. Studies have found that elite esports players can execute more than four hundred precise actions per minute — a level of motor skill that rivals professional musicians or surgeons. The physical and mental demands of top-level competition are significant, and burnout is common at a young age.\n\nBeyond the physical argument, esports shares the structural characteristics of traditional sport. There are leagues, seasons, drafts, trades, coaching staff, analysts, and sports psychologists. Teams compete for championships, fans follow their favourite players with intense loyalty, and national teams represent their countries in international tournaments. Professional players are increasingly treated as athletes — subject to anti-doping rules, training regimes, and contracts. When the International Olympic Committee began formal discussions about including esports in future Olympic Games, it was a sign that the sporting world is taking competitive gaming seriously as a legitimate competitive discipline.`,
    vocab: [
      { word: 'Hand-eye coordination', definition: 'The ability to synchronise hand movements with what you see — a key skill in both sport and gaming.' },
      { word: 'Endurance', definition: 'The ability to keep going over a long period under difficult conditions — mental or physical stamina.' },
      { word: 'Motor skill', definition: 'The ability to perform precise physical movements — actions controlled by muscles and coordination.' },
      { word: 'Burnout', definition: 'Exhaustion caused by long periods of stress or overwork — common in high-pressure competitive environments.' },
    ],
    questions: [
      { n: 4, q: 'Does training for eight to twelve hours a day change your view of whether esports is a sport?' },
      { n: 5, q: 'What criteria do you think should define whether something is a "real" sport?' },
      { n: 6, q: 'Should esports be included in the Olympic Games? What are the arguments for and against?' },
    ]
  },
  {
    number: 3, title: 'The Arguments Against: Why Some People Disagree', emoji: '⚖️', color: '#f59e0b',
    text: `Critics of esports argue that no matter how skilled or competitive, video gaming lacks the physical athleticism that defines sport. Traditional sports — from football to swimming to athletics — demand physical exertion, fitness, and body conditioning. A professional gamer sitting at a computer, however fast their reactions, is not putting their body under the same kind of physical strain as a marathon runner or a rugby player. For many people, this physical dimension is not simply one feature of sport — it is the defining one.\n\nThere are also concerns about the health implications of the esports lifestyle. Professional players often sit for extremely long periods with poor posture, suffer from repetitive strain injuries in their wrists and hands, and report high levels of stress, anxiety, and depression. The average career of a professional esports player is remarkably short — many retire or decline significantly in their early to mid-twenties, raising questions about long-term wellbeing. Critics also point to the commercial nature of esports, noting that the games themselves are owned by corporations who can change the rules, discontinue titles, or shut down entire competitive ecosystems with little notice — something that could never happen to football or basketball.`,
    vocab: [
      { word: 'Athleticism', definition: 'Physical ability, fitness and skill — the qualities associated with trained athletes.' },
      { word: 'Physical exertion', definition: 'The effort and energy used by the body during physical activity — strain and exercise.' },
      { word: 'Repetitive strain injury', definition: 'Pain caused by repeatedly making the same movements — common in hands and wrists from gaming.' },
      { word: 'Ecosystem', definition: 'A connected network of organisations, games and communities — the whole competitive environment.' },
    ],
    questions: [
      { n: 7, q: 'Is physical exertion an essential part of sport, or can mental and strategic skill be enough?' },
      { n: 8, q: 'Does it matter that corporations control the games — could they shut down an esport overnight?' },
      { n: 9, q: 'What do you think about the short career length of professional esports players?' },
    ]
  },
  {
    number: 4, title: 'The Future of Esports — and What It Means for Sport', emoji: '🚀', color: '#22c55e',
    text: `Whether or not esports is classified as a sport in the traditional sense, its cultural and economic influence on the world of competitive entertainment is undeniable. Major sports organisations — including football clubs like PSG, Manchester City, and FC Barcelona — have established esports divisions, recognising the opportunity to connect with younger audiences who may never watch a football match but spend hours following competitive gaming. Universities now offer esports scholarships, and dedicated esports arenas are being built in cities around the world.\n\nPerhaps the most important question is not whether esports is a sport, but what its rise tells us about how younger generations engage with competition, identity, and entertainment. For many teenagers and young adults around the world, watching a League of Legends final is as exciting and emotionally meaningful as watching a World Cup match. The debate about labels may ultimately be less important than the broader shift it represents: a generation defining their own forms of competition, community, and achievement — on their own terms, on their own screens. Whether the sporting establishment chooses to embrace or resist that shift will shape the future of both worlds.`,
    vocab: [
      { word: 'Undeniable', definition: 'Impossible to deny or argue against — clearly true and obvious to everyone.' },
      { word: 'Scholarship', definition: 'Financial support given to a student based on their talent or achievement — paying for education.' },
      { word: 'Establishment', definition: 'The existing system of powerful institutions and organisations — the traditional authorities in any field.' },
      { word: 'Identity', definition: 'The sense of who you are — the values, communities and interests that define a person or group.' },
    ],
    questions: [
      { n: 10, q: 'Why do you think major football clubs are investing in esports divisions?' },
      { n: 11, q: 'Do you think esports can replace traditional sports for younger generations, or will both coexist?' },
      { n: 12, q: 'Overall — is esports a real sport? Give your final answer and your strongest reason.' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "Esports — Is Gaming a Real Sport?". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function EsportsPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #7c3aed 100%)', padding: '56px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Esports — Is Gaming a Real Sport?</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Controllers vs. Goalposts — explore the explosive rise of competitive gaming, the arguments for and against calling it a sport, and what it means for the future of competition.</p>
            </div>
          </div>
