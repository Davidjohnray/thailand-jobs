...
const PARTS = [
  { number: 1, title: 'How Facial Recognition Works', emoji: '👁️', color: '#6366f1',
    text: `Facial recognition technology uses artificial intelligence to identify people by analyzing their facial features. Cameras capture an image of a face, and software compares it to stored images in a database. This technology is now used in smartphones, airports, offices, and public security systems. Supporters say it increases speed, accuracy, and convenience in everyday activities.\n\nAs technology improves, facial recognition systems are becoming faster and more detailed. Many companies believe it can reduce fraud and improve safety. Because faces are unique, this method is often seen as more secure than passwords or ID cards.`,
    vocab: [
      { word: 'Artificial intelligence', definition: 'Computer systems that can perform tasks normally requiring human thinking — like recognizing faces.' },
      { word: 'Database', definition: 'A large organized collection of information stored and accessed by computers.' },
      { word: 'Accuracy', definition: 'How correct or precise something is — being free from errors or mistakes.' },
      { word: 'Fraud', definition: 'The crime of deceiving someone to gain money or an unfair advantage.' },
    ],
    questions: [
      { n: 1, q: 'Do you think facial recognition is more convenient than passwords? Why?' },
      { n: 2, q: 'Where do you think this technology is most useful?' },
      { n: 3, q: 'Should people be able to refuse facial recognition systems?' },
    ]
  },
  { number: 2, title: 'Privacy and Personal Freedom', emoji: '🔒', color: '#ec4899',
    text: `Despite its benefits, facial recognition raises strong privacy concerns. Many people worry that governments or companies could use it to track individuals without consent. Cameras in public spaces may collect facial data continuously, making some people feel they are always being watched.\n\nPrivacy experts argue that people should know when their data is being collected and how it is used. Without clear rules, facial recognition could reduce personal freedom and increase surveillance in everyday life.`,
    vocab: [
      { word: 'Consent', definition: 'Permission given by a person to allow something — especially collecting their personal data.' },
      { word: 'Surveillance', definition: 'The close monitoring or watching of a person or group, often by authorities.' },
      { word: 'Transparency', definition: 'Being open and honest about how something works — especially with data and privacy.' },
      { word: 'Personal freedom', definition: 'The right to live, move, and act without being constantly controlled or watched.' },
    ],
    questions: [
      { n: 4, q: 'How important is privacy in public spaces?' },
      { n: 5, q: 'Do you trust governments to use facial data responsibly?' },
      { n: 6, q: 'Should facial recognition be limited to certain situations?' },
    ]
  },
  { number: 3, title: 'Accuracy and Bias', emoji: '⚖️', color: '#f59e0b',
    text: `Another major concern is accuracy. Research shows that facial recognition systems can make more mistakes when identifying women, older people, or certain ethnic groups. These errors can have serious consequences, especially when the technology is used by police or security services.\n\nBias in technology often comes from biased data. If a system is trained on limited or unbalanced data, it may not work equally well for everyone. This has led to calls for better testing and stricter controls before the technology is widely used.`,
    vocab: [
      { word: 'Bias', definition: 'An unfair preference that causes unequal treatment of different groups or individuals.' },
      { word: 'Ethnic groups', definition: 'Communities of people who share a common culture, language, or background.' },
      { word: 'Consequences', definition: 'The results or effects that follow from an action or decision.' },
      { word: 'Unbalanced data', definition: 'A dataset that does not represent all groups equally — causing a system to work better for some than others.' },
    ],
    questions: [
      { n: 7, q: 'Why is accuracy especially important in security systems?' },
      { n: 8, q: 'Can technology ever be completely fair? Explain your view.' },
      { n: 9, q: 'Who should be responsible when technology makes mistakes?' },
    ]
  },
  { number: 4, title: 'Regulation and the Future', emoji: '🏛️', color: '#22c55e',
    text: `In response to growing concerns, some countries have started to regulate facial recognition technology. Certain cities have restricted its use by law enforcement, while others require transparency and public approval. Companies are also under pressure to explain how their systems work.\n\nIn the future, facial recognition will likely continue to develop, but its success will depend on trust. Clear laws, ethical design, and public discussion will be necessary to balance innovation with human rights.`,
    vocab: [
      { word: 'Regulation', definition: 'Official rules or laws that control how something is used or operated.' },
      { word: 'Law enforcement', definition: 'The police and other agencies responsible for upholding laws and public safety.' },
      { word: 'Ethical', definition: 'Related to moral principles about what is right, fair, and responsible.' },
      { word: 'Innovation', definition: 'The introduction of new ideas or technology that improves or changes things.' },
    ],
    questions: [
      { n: 10, q: 'Should governments control how facial recognition is used?' },
      { n: 11, q: 'How can companies build public trust in this technology?' },
      { n: 12, q: 'Do you think facial recognition will be accepted or resisted in the future?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "Facial Recognition Technology". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function FacialRecognitionPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(236,72,153,0.7)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Technology</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Facial Recognition Technology</h1>
              <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>How AI identifies faces — explore the technology, privacy risks, bias concerns, and the debate over regulation.</p>
            </div>
          </div>
          ...
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#eef2ff', padding: '8px 28px', borderBottom: '1px solid #e0e7ff' }}>
              <span style={{ color: '#4338ca', fontSize: '12px', fontWeight: '600' }}>
                ...
                {translationLang !== 'none' && <span style={{ color: '#3730a3' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
      ...
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #e0e7ff', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#eef2ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #e0e7ff', color: '#9ca3af', fontSize: '15px' }}>
