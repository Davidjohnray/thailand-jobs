...
const PARTS = [
  {
    number: 1, title: 'Why Reporting Skills Matter in the Workplace', emoji: '📊', color: '#0ea5e9',
    text: `In most professional environments, the ability to communicate data and results clearly is just as important as the ability to produce them. A manager who receives a well-researched report but cannot understand it has received very little value. This is why the skill of explaining data, findings, and recommendations to non-specialist colleagues or senior managers is one of the most valued competencies in modern business.\n\nMany professionals feel confident working with numbers and spreadsheets but struggle when asked to explain their findings verbally or in writing to people who are not specialists in their field. The challenge is not just language — it is the ability to translate complex information into clear, meaningful messages. A senior manager does not need to understand every technical detail; they need to know what the data means for the business, what action is required, and what risks exist if nothing is done. Developing this communication skill can have a direct impact on your career progression.`,
    vocab: [
      { word: 'Competency', definition: 'A skill or ability that is needed to do a job effectively — a measurable area of expertise.' },
      { word: 'Non-specialist', definition: 'A person who does not have expert knowledge in a particular technical field.' },
      { word: 'Findings', definition: 'The results or conclusions reached after research, analysis, or investigation.' },
      { word: 'Career progression', definition: 'The process of advancing to higher positions or greater responsibility in your professional life.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think communication skills are as important as technical skills in most jobs?' },
      { n: 2, q: 'Have you ever had to explain complex information to someone without specialist knowledge? How did it go?' },
      { n: 3, q: 'What is the difference between a good report and a useful report?' },
    ]
  },
  {
    number: 2, title: 'Structuring Your Report or Presentation', emoji: '🗂️', color: '#8b5cf6',
    text: `A well-structured report or presentation follows a logical flow that makes it easy for the audience to follow, even if the content is complex. The most effective business reports typically begin with an executive summary — a short overview of the key findings and recommendations that allows a busy senior manager to understand the main points without reading every detail. The body of the report then provides the supporting data, analysis, and context. A clear conclusion states what should happen next.\n\nWhen presenting data verbally, structure is equally important. Many experienced presenters use the BLUF principle — Bottom Line Up Front. This means stating the most important conclusion or recommendation at the start, before explaining how you arrived at it. This is the opposite of building up to a conclusion, which can lose the attention of a busy audience before you reach your key point. In business, time is limited and decisions need to be made quickly — a presenter who gets to the point immediately is far more effective than one who makes the audience wait.`,
    vocab: [
      { word: 'Executive summary', definition: 'A short overview at the beginning of a report — the key findings and recommendations in brief.' },
      { word: 'BLUF', definition: 'Bottom Line Up Front — a communication method that states the main conclusion before the supporting detail.' },
      { word: 'Analysis', definition: 'The careful examination of data or information to understand patterns, causes, or implications.' },
      { word: 'Context', definition: 'The background information that helps explain why something happened or what it means.' },
    ],
    questions: [
      { n: 4, q: 'Do you prefer to hear the conclusion first or build up to it? Does this differ by culture?' },
      { n: 5, q: 'Why is an executive summary so important for senior managers?' },
      { n: 6, q: 'How do you decide what to include and what to leave out of a business report?' },
    ]
  },
  {
    number: 3, title: 'Language for Describing Data and Trends', emoji: '📈', color: '#f59e0b',
    text: `Business English has a specific vocabulary for describing numbers, trends, and changes. Using this language accurately and naturally makes your reports and presentations sound more professional and credible. When describing an increase, you might say: "Sales rose sharply in Q3" or "There was a significant upturn in customer satisfaction." For a decrease: "Revenue fell slightly" or "We saw a marginal decline in market share." When a figure stays the same: "Costs remained stable" or "Numbers plateaued over the summer."\n\nBeyond individual figures, good business communicators explain what the data means — not just what it shows. Instead of simply saying "profits increased by 12%," a skilled communicator adds interpretation: "This 12% increase was driven primarily by strong performance in the Southeast Asian market and suggests that our pricing strategy is working effectively in that region." This kind of interpretive language — using phrases such as "this suggests," "this indicates," "this was largely due to," and "this points to" — is what separates a data reader from a true business communicator.`,
    vocab: [
      { word: 'Upturn', definition: 'An improvement or increase after a period of difficulty — a positive change in a trend.' },
      { word: 'Marginal', definition: 'Very small or slight — a marginal change is one that is barely noticeable.' },
      { word: 'Plateaued', definition: 'Reached a level and stopped changing — remaining flat after a period of growth or decline.' },
      { word: 'Interpretive language', definition: 'Words and phrases used to explain what data means, not just what it shows.' },
    ],
    questions: [
      { n: 7, q: 'What is the difference between describing data and interpreting data?' },
      { n: 8, q: 'Why might using precise language about trends make you seem more credible?' },
      { n: 9, q: 'Can you think of a time when data was misinterpreted or presented in a misleading way?' },
    ]
  },
  {
    number: 4, title: 'Handling Questions and Delivering Recommendations', emoji: '🎯', color: '#22c55e',
    text: `One of the most challenging parts of presenting data to senior management is handling questions — particularly when you do not know the answer, or when someone challenges your conclusions. Experienced presenters prepare for difficult questions in advance by anticipating what objections or concerns their audience is likely to raise. When you do not know the answer to a question, it is far better to say "That's a good question — I don't have that figure with me, but I'll find out and come back to you" than to guess or become flustered.\n\nFinally, every good report or presentation should end with clear, actionable recommendations. Senior managers do not just want to understand the situation — they want to know what to do about it. A recommendation should be specific, realistic, and linked directly to the data you have presented. For example: "Based on these results, I recommend we increase our marketing budget in the northern region by 15% over the next two quarters, with a review at the six-month mark." This kind of confident, evidence-based recommendation is what transforms a data analyst into a trusted business advisor.`,
    vocab: [
      { word: 'Anticipating', definition: 'Expecting something before it happens — preparing for likely questions or objections in advance.' },
      { word: 'Flustered', definition: 'Confused and anxious under pressure — losing composure in a difficult situation.' },
      { word: 'Actionable', definition: 'Something that can be acted upon — a concrete step that someone can take immediately.' },
      { word: 'Evidence-based', definition: 'Based on facts and data rather than opinion or assumption — supported by clear proof.' },
    ],
    questions: [
      { n: 10, q: 'How do you handle a situation when someone challenges your data or conclusions in a meeting?' },
      { n: 11, q: 'What makes a recommendation "actionable"? Can you give an example from your own work?' },
      { n: 12, q: 'How can improving your reporting and presentation skills change your career?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Explaining Data and Reports to Your Boss". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function ExplainingReportsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Explaining Data and Reports to Your Boss</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From Numbers to Decisions — learn how to present findings clearly, structure reports for senior audiences, and make recommendations with confidence.</p>
            </div>
          </div>
