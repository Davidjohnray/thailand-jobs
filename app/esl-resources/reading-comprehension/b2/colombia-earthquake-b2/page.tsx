...
const PARTS = [
  {
    number: 1, title: 'A Preventable Catastrophe', emoji: '🏚️', color: '#dc2626',
    text: `On 10 August 2026, a magnitude 7.4 earthquake struck western Colombia, killing at least 265 people, injuring more than 3,700, and leaving over 4,100 missing. Eighty-six buildings collapsed. A hospital in Cali — the country's third-largest city — was partially destroyed. The Colombian government declared a national emergency.\n\nThe earthquake was devastating. But here is the uncomfortable truth that earthquake engineers have been repeating for decades: most of those deaths were preventable. The earthquake itself was a natural event — the inevitable result of tectonic plates grinding against each other deep underground. But the deaths were not inevitable. They were the result of buildings that were not strong enough, codes that were not enforced, and a development model that consistently prioritises cost over safety.\n\nJapan experienced a magnitude 9.0 earthquake in 2011 — more than 100 times more powerful than the Colombia quake. The earthquake itself killed remarkably few people because Japanese buildings are designed to flex and absorb seismic energy rather than cracking and collapsing. Chile, another country on the Ring of Fire, experienced a magnitude 8.8 earthquake in 2010 that killed 525 people — a fraction of what a similar quake would have caused in a country with weaker building standards.\n\nThe comparison raises a fundamental question about development, inequality, and responsibility: if we know how to build structures that survive earthquakes, why do hundreds of people still die when the ground shakes?`,
    vocab: [
      { word: 'Preventable', definition: 'Something that could have been stopped or avoided if the right actions had been taken.' },
      { word: 'Seismic', definition: 'Relating to earthquakes — vibrations and energy released when the Earth shakes.' },
      { word: 'Building codes', definition: 'Official rules that set minimum safety standards for how buildings must be constructed.' },
      { word: 'Development model', definition: 'The approach a country takes to economic growth — what it prioritises and what it sacrifices.' },
    ],
    questions: [
      { n: 1, q: 'The passage says most earthquake deaths are preventable. If we know how to save lives, why do people still die in earthquakes?' },
      { n: 2, q: 'Japan survives earthquakes 100 times stronger with far fewer deaths. What can developing countries learn from Japan?' },
      { n: 3, q: 'Building earthquake-resistant structures costs 10-20% more. Who should bear this cost — homeowners, builders, or governments?' },
    ]
  },
  {
    number: 2, title: 'The Inequality of Disaster', emoji: '⚖️', color: '#b91c1c',
    text: `Natural disasters are not natural equalisers — they are inequality amplifiers. The same earthquake that causes minor inconvenience in a wealthy neighbourhood can destroy an entire community in a poor one. The Colombia earthquake demonstrated this with painful clarity.\n\nThe epicentre was in the department of Choco — one of Colombia's poorest regions, accessible in many areas only by boat or plane. Much of Choco's housing is built from wood and basic materials without engineering oversight. When the ground shook, these structures offered almost no protection. The death toll in Choco is expected to rise significantly as rescue teams reach remote communities.\n\nIn Cali and Pereira, the picture was more complex but equally revealing. Modern high-rise buildings generally survived with cosmetic damage. But older buildings, informal settlements, and structures built without proper permits collapsed. The pattern is consistent across every earthquake in every country: the poorest people, living in the weakest buildings, in the most vulnerable locations, suffer the most.\n\nThis pattern extends beyond individual earthquakes. Research shows that disasters consistently push people deeper into poverty. A family that loses its home in an earthquake may also lose its income, its savings, and its children's education. Without insurance — which most poor families cannot afford — there is no financial safety net. Recovery can take a generation. For the poorest communities, a single earthquake can reverse decades of development progress.\n\nThe term "natural disaster" is itself misleading. The earthquake is natural. The disaster — the death, destruction, and suffering — is almost entirely human-made, the product of decisions about where and how to build, who to protect, and whose safety is worth investing in.`,
    vocab: [
      { word: 'Amplifiers', definition: 'Things that make something bigger or more intense — increasing the effect.' },
      { word: 'Epicentre', definition: 'The point on the Earth surface directly above where an earthquake originates underground.' },
      { word: 'Informal settlements', definition: 'Housing built without official permission or planning — often in poor areas with no building standards.' },
      { word: 'Safety net', definition: 'A system of support that catches people when things go wrong — like insurance or government aid.' },
    ],
    questions: [
      { n: 4, q: 'Modern buildings survived but older ones collapsed. What does this tell us about the relationship between wealth and safety?' },
      { n: 5, q: 'The passage says "natural disaster" is misleading because the disaster part is human-made. Do you agree with this distinction?' },
      { n: 6, q: 'A single earthquake can reverse decades of development. How should the international community respond to prevent this?' },
    ]
  },
  {
    number: 3, title: 'Building for the Next One', emoji: '🏗️', color: '#991b1b',
    text: `Earthquake engineers have a saying: "Earthquakes do not kill people, buildings kill people." The Colombia earthquake is yet another confirmation of this principle — and yet another opportunity to ask why we keep building structures that we know will fail.\n\nThe technology for earthquake-resistant construction exists and is well understood. Base isolation systems allow buildings to move independently of the shaking ground. Reinforced concrete frames with proper steel reinforcement can withstand severe shaking. Cross-bracing and shear walls distribute seismic forces throughout a structure rather than concentrating them at weak points. These techniques are standard practice in Japan, Chile, New Zealand, and California.\n\nThe challenge in developing countries is implementation. Colombia has building codes — they were updated after a previous earthquake in 1999. But codes are only effective if they are enforced, and enforcement requires inspectors, funding, political will, and a willingness to reject substandard construction even when it means higher costs and slower development.\n\nRetrofitting existing buildings — strengthening them to meet modern earthquake standards — is even more challenging. Many of the buildings that collapsed in Colombia were built decades ago, before modern codes existed. Retrofitting them would cost billions of dollars. Demolishing and rebuilding them would cost even more. The question of who pays for this — when the people most at risk are those least able to afford it — has no easy answer.\n\nSome countries have found creative solutions. Turkey, after its devastating 1999 earthquake, introduced an earthquake insurance system funded by a small levy on all property owners. Chile mandates rigorous building standards and enforces them consistently. But these solutions require sustained political commitment — and earthquakes, unlike wars or economic crises, tend to fade from political attention until the next one strikes.`,
    vocab: [
      { word: 'Base isolation', definition: 'A technique where buildings sit on flexible supports that absorb earthquake energy.' },
      { word: 'Retrofitting', definition: 'Adding new features or strengthening an existing building to improve its safety or performance.' },
      { word: 'Levy', definition: 'A tax or fee imposed on people to fund a specific purpose.' },
      { word: 'Mandates', definition: 'Officially requires by law — makes something compulsory.' },
    ],
    questions: [
      { n: 7, q: 'We know how to build earthquake-resistant buildings but many countries do not. Is this a failure of knowledge, money, or political will?' },
      { n: 8, q: 'Turkey funds earthquake insurance through a levy on all property owners. Could this model work in other countries? What are the challenges?' },
      { n: 9, q: 'Earthquakes fade from political attention until the next one. How can countries maintain focus on earthquake preparedness between disasters?' },
    ]
  },
  {
    number: 4, title: 'The Global Earthquake Challenge', emoji: '🌐', color: '#7f1d1d',
    text: `The Colombia earthquake is not an isolated event — it is part of a global pattern that disproportionately affects developing countries and will become more dangerous as urbanisation accelerates.\n\nMore than half the world's population now lives in cities, and that proportion is growing rapidly. Many of the world's fastest-growing cities — Istanbul, Tehran, Manila, Jakarta, Lima, Mexico City — sit directly on or near major fault lines. As these cities expand, more people move into seismically vulnerable areas, often in informal housing that offers no earthquake protection.\n\nThe stakes are enormous. A major earthquake striking Istanbul — which seismologists consider overdue — could kill tens of thousands of people and cause hundreds of billions of dollars in damage. A repeat of the 1923 Tokyo earthquake could, despite Japan's excellent building standards, overwhelm even the most prepared city simply because of the density of population and infrastructure.\n\nClimate change adds another dimension. While earthquakes themselves are not caused by climate change, the ability of communities to recover from earthquakes is affected by it. Communities already stressed by drought, flooding, or extreme heat have fewer resources to devote to earthquake preparedness and recovery. The convergence of seismic risk and climate risk creates compound vulnerabilities that are only beginning to be understood.\n\nThe 265 people who died in Colombia this week are a reminder that the Earth is alive — that the ground beneath us is moving, and will continue to move. We cannot prevent earthquakes. But we can prevent the deaths they cause. The knowledge exists. The technology exists. What has been missing, earthquake after earthquake, is the will to act before the ground shakes rather than after.`,
    vocab: [
      { word: 'Urbanisation', definition: 'The process of cities growing as more people move from rural areas to urban centres.' },
      { word: 'Seismically', definition: 'Relating to earthquakes — in terms of earthquake activity and risk.' },
      { word: 'Compound vulnerabilities', definition: 'Multiple risks occurring together, each making the others worse.' },
      { word: 'Overdue', definition: 'Expected to happen based on historical patterns but has not yet occurred — late.' },
    ],
    questions: [
      { n: 10, q: 'Istanbul is overdue for a major earthquake and millions live in vulnerable buildings. What should be done now, before it happens?' },
      { n: 11, q: 'Climate change and earthquake risk are converging. How does being affected by one disaster make you more vulnerable to the next?' },
      { n: 12, q: 'The passage says the knowledge and technology to prevent earthquake deaths exist. Only the will is missing. Do you agree? What would create that will?' },
    ]
  },
]
...
export default function ColombiaEqB2Page() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Colombia Earthquake — A Preventable Catastrophe</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A 7.4 earthquake killed 265 people in Colombia. Japan survives far worse. The uncomfortable truth about why earthquakes kill, and why the victims are always the poorest.</p>
            </div>
          </div>
