...
const PARTS = [
  {
    number: 1, title: 'The Tweet That Shocked Silicon Valley', emoji: '📱', color: '#dc2626',
    text: `Days after the CEOs of Anthropic and OpenAI testified before Congress that AI development was moving too fast and needed regulation, President Trump responded with characteristic bluntness. Writing on Truth Social, he called warnings about superintelligent AI a "SICK Conspiracy" and a "HOAX," adding: "The only control or guardrails that AI needs is a STRONG AND SMART (High IQ!) PRESIDENT, and the U.S.A. has that, in spades!"\n\nThe statement effectively killed any prospect of AI regulation during this presidential term. Without White House support, legislation has no path to becoming law. The AI companies that had called for regulation — and their supporters in Congress — were left with testimony on the record and nothing else.\n\nTrump followed up by calling Nvidia CEO Jensen Huang to the White House, where they discussed expanding American AI chip production. The message was clear: the administration views AI as an economic asset to be accelerated, not a risk to be managed. Regulation, in this framing, is an obstacle to American competitiveness — particularly against China.\n\nFor the AI safety community — researchers, ethicists, and even some company executives who believe the technology poses genuine risks — the President response was devastating. They had finally succeeded in bringing their concerns to the highest levels of government. The government listened politely and said no.`,
    vocab: [
      { word: 'Guardrails', definition: 'Safety measures that prevent something dangerous from going off course — protective limits.' },
      { word: 'Characteristic', definition: 'Typical of a person — behaviour that is expected because it matches their known style.' },
      { word: 'Competitiveness', definition: 'The ability to compete effectively — staying ahead of rivals in business or technology.' },
      { word: 'Devastating', definition: 'Extremely damaging and disheartening — causing great distress or disappointment.' },
    ],
    questions: [
      { n: 1, q: 'AI CEOs warned about dangers. The President called it a hoax. Who should the public believe?' },
      { n: 2, q: 'Trump says AI needs a "strong president" not regulation. Is personal leadership a substitute for institutional oversight?' },
      { n: 3, q: 'Without White House support, AI regulation is dead. Should one person have this much power over technology policy?' },
    ]
  },
  {
    number: 2, title: 'The Pattern', emoji: '🔄', color: '#b91c1c',
    text: `Trump response to AI warnings follows a pattern that has defined his approach to every issue that requires regulation: reject the science, attack the messengers, and frame regulation as an attack on American greatness.\n\nThe pattern was established with climate change. Scientists warned for decades that greenhouse gas emissions were warming the planet. Trump called it a hoax, withdrew from the Paris Agreement, and expanded fossil fuel production. The scientific consensus did not change. The policy did.\n\nThe same pattern appeared with COVID-19. Public health experts recommended masks, social distancing, and vaccination. Trump questioned the experts, promoted unproven treatments, and framed pandemic restrictions as government overreach. The virus did not care about the politics. More than a million Americans died.\n\nNow the pattern is being applied to AI. Experts — including the people who build the technology — are warning about risks. The President dismisses the warnings, frames regulation as a conspiracy against innovation, and positions himself as the only safeguard needed.\n\nThe pattern raises a fundamental question about democratic governance: what happens when the leader of the world most powerful country systematically rejects expert consensus on the most important issues facing humanity? Climate change, pandemic preparedness, and now AI — in each case, the cost of delayed action grows with every year of inaction.`,
    vocab: [
      { word: 'Consensus', definition: 'Widespread agreement among experts — when most specialists reach the same conclusion.' },
      { word: 'Overreach', definition: 'Going too far — exceeding the appropriate limits of authority.' },
      { word: 'Systematically', definition: 'In a consistent, organised way — following a deliberate pattern.' },
      { word: 'Inaction', definition: 'Not doing anything — failing to act when action is needed.' },
    ],
    questions: [
      { n: 4, q: 'Climate, COVID, now AI — the same pattern of rejecting experts. Why does this approach resonate with voters?' },
      { n: 5, q: 'When the President rejects scientific consensus, what are the consequences?' },
      { n: 6, q: 'The cost of delayed action grows every year. How do you convince leaders to act on problems whose worst effects are in the future?' },
    ]
  },
  {
    number: 3, title: 'The China Factor', emoji: '🇨🇳', color: '#991b1b',
    text: `The strongest argument against AI regulation — and the one that resonates most in Washington — is China. If the United States slows down AI development, China will not. And whoever leads in AI will have enormous economic and military advantages for decades to come.\n\nThis argument is not without merit. China is investing heavily in AI — in research, in applications, in military uses. Chinese AI companies are competitive with their American counterparts in many areas. And the Chinese government has shown no inclination to slow down development for safety reasons — if anything, it is accelerating.\n\nBut the China argument has significant weaknesses. First, safety and speed are not necessarily opposed. A well-regulated AI industry could actually develop faster by avoiding costly mistakes, public backlash, and the kind of catastrophic failure that could set the entire field back by years. The nuclear industry provides a cautionary example: the Chernobyl and Fukushima disasters set nuclear energy back by decades. A comparable AI disaster could do the same.\n\nSecond, the US-China AI competition is not winner-take-all. Both countries will develop powerful AI systems. The question is not who gets there first but who gets there safely. A race that sacrifices safety for speed benefits nobody if the result is a technology that nobody can control.\n\nThird, using China as a reason to reject all regulation is a logical fallacy. The fact that China does not regulate does not mean the US should not. It means that international cooperation on AI safety is needed — which is harder to achieve, but far more important than either country acting alone.`,
    vocab: [
      { word: 'Inclination', definition: 'A tendency or willingness — being drawn toward a particular action or position.' },
      { word: 'Backlash', definition: 'A strong negative reaction — public anger or opposition to a policy or event.' },
      { word: 'Winner-take-all', definition: 'A competition where the winner gets everything and the loser gets nothing.' },
      { word: 'Logical fallacy', definition: 'A mistake in reasoning — an argument that sounds convincing but is actually flawed.' },
    ],
    questions: [
      { n: 7, q: 'If the US regulates AI and China does not, does China win? Or is this a false choice?' },
      { n: 8, q: 'Chernobyl set nuclear energy back decades. Could an AI disaster do the same? What would that look like?' },
      { n: 9, q: 'International cooperation on AI safety is needed but hard to achieve. How do you get rivals to cooperate on shared risks?' },
    ]
  },
  {
    number: 4, title: 'Who Governs the Ungoverned?', emoji: '🌐', color: '#7f1d1d',
    text: `Trump dismissal of AI regulation leaves a void — and voids in governance do not stay empty. If the US government will not regulate AI, someone else will fill the space.\n\nThe European Union has already passed the AI Act — the world most comprehensive AI regulation, which classifies AI systems by risk level and imposes requirements on high-risk applications. China has its own AI regulations, focused less on safety than on ensuring AI systems align with government ideology. And individual US states — particularly California, where most AI companies are headquartered — are passing their own laws.\n\nThe result is a patchwork of regulations that varies by jurisdiction — creating compliance nightmares for AI companies that operate globally and potential safe havens for those willing to shop for the most permissive rules.\n\nThe AI companies themselves are in an uncomfortable position. They called for regulation and were rejected. Now they must decide: do they self-regulate, knowing that self-regulation lacks enforcement power? Do they lobby states for laws that may conflict with federal policy? Or do they simply continue building, hoping that nothing goes catastrophically wrong before someone with the authority to act decides to do so?\n\nThe most powerful technology in human history is being developed in a regulatory vacuum — because the most powerful person in the world called the need for regulation a hoax. Whether this decision looks wise or catastrophic will depend on what the technology does next. And by the time we know, it may be too late to change course.`,
    vocab: [
      { word: 'Void', definition: 'An empty space — a gap where something should exist but does not.' },
      { word: 'Compliance', definition: 'Following rules and regulations — meeting the requirements set by authorities.' },
      { word: 'Permissive', definition: 'Allowing a lot of freedom — rules that are relaxed and easy to follow.' },
      { word: 'Regulatory vacuum', definition: 'A situation where no rules exist to govern an activity — an absence of oversight.' },
    ],
    questions: [
      { n: 10, q: 'The EU regulates AI. China regulates AI. The US does not. What does this patchwork mean for global AI governance?' },
      { n: 11, q: 'AI companies asked for regulation and were rejected. What should they do now?' },
      { n: 12, q: 'The most powerful technology in history is being developed without rules. Does this worry you? What would you want regulated?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Trump Calls AI Regulation a HOAX". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function TrumpAIPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Trump Calls AI Regulation a HOAX</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Days after AI CEOs warned about dangers, Trump rejected regulation as a conspiracy. The clash between Silicon Valley caution and presidential confidence in the most consequential tech debate of the century.</p>
            </div>
          </div>
