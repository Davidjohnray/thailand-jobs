...
const PARTS = [
  {
    number: 1, title: 'The Enemy of My Enemy', emoji: '🌐', color: '#dc2626',
    text: `Russian President Vladimir Putin this week made his most explicit statement yet about Russia\'s relationship with Iran: Moscow will continue to support Tehran militarily, economically, and diplomatically in its conflict with the United States. The statement came alongside a renewed pledge to "win" the war in Ukraine and a dismissal of Ukrainian leadership as "terrorists."\n\nThe Russia-Iran partnership is not new — the two countries have cooperated militarily in Syria since 2015 and have expanded their relationship significantly since Russia\'s invasion of Ukraine in 2022. Iran has supplied Russia with Shahed drones that have been used extensively against Ukrainian cities. In return, Russia has provided Iran with advanced air defence systems and, reportedly, technical assistance for its nuclear programme.\n\nBut the partnership has deepened dramatically since the US-Iran conflict began. Russia sees America\'s entanglement with Iran as strategically advantageous — every dollar and every military asset the US deploys against Iran is a dollar and an asset not available for supporting Ukraine. For Iran, Russia provides a powerful ally that can veto UN Security Council resolutions and supply weapons that Iran cannot manufacture domestically.\n\nThe partnership is one of convenience rather than ideology. Russia and Iran have different political systems, different cultures, and different long-term interests. But they share a common adversary — the United States — and that shared opposition is proving more powerful than their differences.`,
    vocab: [
      { word: 'Axis', definition: 'An alliance or partnership between countries, especially for military purposes.' },
      { word: 'Entanglement', definition: 'Being involved in a complicated situation that is difficult to escape from.' },
      { word: 'Veto', definition: 'The power to block a decision — preventing something from being approved.' },
      { word: 'Adversary', definition: 'An opponent or enemy — someone you are in conflict with.' },
    ],
    questions: [
      { n: 1, q: 'Russia supports Iran against the US while fighting its own war in Ukraine. How does fighting on multiple fronts affect each country?' },
      { n: 2, q: 'Iran supplies drones to Russia for Ukraine. Should countries that supply weapons to aggressors be held responsible for how they are used?' },
      { n: 3, q: 'The Russia-Iran alliance is based on a shared enemy, not shared values. How durable are alliances of convenience?' },
    ]
  },
  {
    number: 2, title: 'Reshaping the World Order', emoji: '🗺️', color: '#b91c1c',
    text: `The Russia-Iran axis is part of a broader realignment of global power that is challenging the US-led international order that has existed since the end of the Cold War.\n\nFor three decades after the Soviet Union collapsed in 1991, the United States was the undisputed global superpower. It maintained military alliances across Europe and Asia, set the rules for international trade, and used institutions like the UN, NATO, and the World Bank to project its values and interests worldwide.\n\nThat order is now being contested. Russia, China, Iran, and North Korea — despite their significant differences — are cooperating in ways that challenge American dominance. China provides economic lifelines to Russia and Iran through trade and investment. North Korea supplies ammunition to Russia. Iran supplies drones. Russia provides diplomatic cover for all of them at the UN Security Council.\n\nThis emerging bloc does not have a shared ideology or a formal alliance structure. What unites them is opposition to what they call American hegemony — the dominance of one country over the international system. Whether this opposition produces a genuine alternative order or simply creates chaos is one of the defining questions of the 2020s.\n\nFor countries like Thailand, which have historically maintained relationships with both the US and China, the emerging great-power competition creates difficult choices. Neutrality becomes harder when both sides demand loyalty.`,
    vocab: [
      { word: 'Realignment', definition: 'A fundamental shift in how countries relate to each other — changing partnerships and alliances.' },
      { word: 'Hegemony', definition: 'Dominance of one country or group over others — control of the international system.' },
      { word: 'Bloc', definition: 'A group of countries that work together for a common purpose — an alliance.' },
      { word: 'Neutrality', definition: 'Not taking sides in a conflict — remaining independent and impartial.' },
    ],
    questions: [
      { n: 4, q: 'Russia, China, Iran, and North Korea oppose American hegemony. Will this opposition create a better world order or more chaos?' },
      { n: 5, q: 'Thailand has relationships with both the US and China. How should smaller countries navigate great-power competition?' },
      { n: 6, q: 'The US-led order has lasted 30 years. Is it worth preserving, or does the world need something new?' },
    ]
  },
  {
    number: 3, title: 'The Ukraine Connection', emoji: '🇺🇦', color: '#991b1b',
    text: `Putin\'s statement this week explicitly connected Russia\'s war in Ukraine with its support for Iran — revealing what many analysts have long suspected: Moscow views both conflicts as part of a single struggle against American power.\n\nFor Russia, the US-Iran conflict is a strategic gift. American military resources deployed to the Middle East cannot simultaneously support Ukraine. American diplomatic attention focused on Iran is attention diverted from Russia\'s war. And rising oil prices — caused partly by the Hormuz crisis — benefit Russia\'s oil-dependent economy while straining America\'s.\n\nThis linkage has practical military consequences. Iranian Shahed drones, battle-tested in attacks on Saudi Arabia and Gulf shipping, have been adapted for use against Ukrainian cities. Russian air defence technology, refined through years of operation in Syria, has been shared with Iran. The two countries are learning from each other\'s conflicts and applying lessons in real time.\n\nFor Ukraine, the Russia-Iran partnership is deeply concerning. Every Iranian drone used against Kyiv represents a transfer of military technology between two of Ukraine\'s adversaries. And Putin\'s refusal to negotiate — characterising Ukrainian leaders as terrorists — suggests that the war will continue for as long as Russia has the resources to fight it.\n\nThe interconnection of these conflicts means that a resolution in one theatre could affect the other. A peace deal in the Middle East could free American resources for Ukraine. A Russian defeat in Ukraine could weaken Iran\'s most powerful ally. But escalation in either conflict could drag both into a wider war.`,
    vocab: [
      { word: 'Linkage', definition: 'The connection between two things — how events in one area affect another.' },
      { word: 'Theatre', definition: 'In military terms, a region where a war or conflict is taking place.' },
      { word: 'Battle-tested', definition: 'Proven effective through actual use in combat — not just theoretical.' },
      { word: 'Resolution', definition: 'A solution to a conflict — reaching an agreement that ends the dispute.' },
    ],
    questions: [
      { n: 7, q: 'Russia views Ukraine and Iran as one struggle against America. Does connecting conflicts this way make them harder to resolve?' },
      { n: 8, q: 'Iran supplies drones to Russia which are used against Ukrainian cities. Should Ukraine target Iran directly?' },
      { n: 9, q: 'Peace in the Middle East could free resources for Ukraine. Should conflicts be resolved together or separately?' },
    ]
  },
  {
    number: 4, title: 'What It Means for Everyone', emoji: '🌍', color: '#7f1d1d',
    text: `The deepening Russia-Iran alliance has consequences that extend far beyond the battlefields of Ukraine and the waters of the Persian Gulf.\n\nEnergy markets are affected directly. Russia and Iran together control approximately 20% of global oil production. Their coordination — whether through pricing, supply manipulation, or the weaponisation of energy infrastructure — gives them significant leverage over the global economy. Countries that depend on oil imports — including much of Europe, Japan, South Korea, India, and Thailand — are vulnerable to decisions made in Moscow and Tehran.\n\nThe nuclear dimension cannot be ignored. Russia\'s reported assistance to Iran\'s nuclear programme — if confirmed — would represent a dramatic escalation. A nuclear-armed Iran would fundamentally alter the security landscape of the Middle East and could trigger a regional nuclear arms race, with Saudi Arabia, Turkey, and Egypt all potentially seeking their own nuclear capabilities.\n\nThe broader lesson is about the fragility of international order. The system of rules, institutions, and norms that governed international relations for three decades is being tested simultaneously in Europe, the Middle East, and the Indo-Pacific. The outcome of these tests will determine whether the world moves toward a new, potentially unstable multipolar order — or whether the existing system adapts and survives.\n\nFor ordinary people around the world, the Russia-Iran axis means higher energy prices, greater geopolitical uncertainty, and the unsettling reality that decisions made by leaders in Moscow and Tehran affect the cost of living in Bangkok, the security of shipping lanes, and the stability of the world their children will inherit.`,
    vocab: [
      { word: 'Weaponisation', definition: 'Turning something into a weapon — using resources or systems to cause harm or exert pressure.' },
      { word: 'Arms race', definition: 'A competition between countries to build more and better weapons.' },
      { word: 'Multipolar', definition: 'A world order with several powerful countries rather than one dominant superpower.' },
      { word: 'Norms', definition: 'Accepted standards of behaviour — the unwritten rules that govern how countries interact.' },
    ],
    questions: [
      { n: 10, q: 'Russia and Iran control 20% of global oil. How does this energy leverage affect countries like Thailand?' },
      { n: 11, q: 'A nuclear-armed Iran could trigger an arms race. How can the world prevent nuclear proliferation?' },
      { n: 12, q: 'The international order built after the Cold War is being tested. Will it survive, adapt, or collapse? What comes next?' },
    ]
  },
]
...
export default function RussiaIranPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Russia and Iran Deepen Military Alliance</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Putin pledged continued support for Iran against the US while promising to win the war in Ukraine. What the Russia-Iran axis means for the world order.</p>
            </div>
          </div>
