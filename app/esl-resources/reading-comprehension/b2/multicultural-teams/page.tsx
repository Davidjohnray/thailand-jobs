...
const PARTS = [
  {
    number: 1, title: 'The Reality of Multicultural Teams', emoji: '🌏', color: '#3b82f6',
    text: `As businesses expand globally and workplaces become more diverse, the ability to work effectively with colleagues from different cultural backgrounds has become one of the most valued professional skills of the modern era. Multicultural teams — groups of people drawn from different countries, languages, and cultural traditions — are now standard in multinational companies, international schools, hotels, hospitals, and technology firms around the world. For many professionals in Thailand and Southeast Asia, working alongside colleagues from Europe, North America, East Asia, and the Middle East is simply a normal part of daily working life.\n\nThe potential advantages of multicultural teams are significant. Research consistently shows that diverse teams, when they function well, outperform homogeneous ones in creativity, problem-solving, and decision-making. Different cultural perspectives bring different ways of approaching challenges, different assumptions about how work should be organised, and different ideas about what counts as a good solution. However, those same differences can also create friction, misunderstanding, and conflict if they are not managed thoughtfully. The difference between a multicultural team that thrives and one that struggles often comes down not to the people involved, but to how well the team understands and navigates its own diversity.`,
    vocab: [
      { word: 'Diverse', definition: 'Including people from many different backgrounds, cultures, and perspectives.' },
      { word: 'Homogeneous', definition: 'Made up of people who are all very similar — the same background, culture, or way of thinking.' },
      { word: 'Friction', definition: 'Tension or conflict caused by differences between people — difficulty working smoothly together.' },
      { word: 'Navigates', definition: 'Finds a way through something complex or difficult — managing challenges skillfully.' },
    ],
    questions: [
      { n: 1, q: 'Have you worked in a multicultural team? What was the experience like?' },
      { n: 2, q: 'What do you think are the biggest advantages of working with people from different cultures?' },
      { n: 3, q: 'Is cultural diversity always an advantage in a team, or can it sometimes create more problems than it solves?' },
    ]
  },
  {
    number: 2, title: 'Communication Styles Across Cultures', emoji: '💬', color: '#f59e0b',
    text: `One of the most significant sources of misunderstanding in multicultural teams is differences in communication style. Researchers in cross-cultural communication distinguish between high-context and low-context cultures. In low-context cultures — typical of Germany, the Netherlands, the United States, and Australia — communication tends to be direct, explicit, and task-focused. People say what they mean, disagreement is expressed openly, and silence in a meeting is often interpreted as having nothing to contribute. In high-context cultures — more common across East Asia, Southeast Asia, the Middle East, and Latin America — meaning is often conveyed indirectly, through tone, silence, relationship, and context. Saying "no" directly may be considered rude; a polite non-answer or a change of subject may signal disagreement just as clearly to someone who understands the cultural code.\n\nThese differences can create serious misunderstandings in mixed teams. A German colleague who gives direct critical feedback may be perceived as aggressive or disrespectful by a Thai colleague for whom such directness is unexpected. A Japanese team member who remains silent during a meeting to show respect and careful consideration may be perceived as disengaged or lacking opinions by an American colleague who expects active verbal participation. Neither person is behaving badly — they are simply operating according to different but equally valid cultural norms. Recognising this is the first step toward communicating across difference effectively.`,
    vocab: [
      { word: 'High-context', definition: 'A communication style where much meaning is implied rather than stated directly — relying on shared understanding.' },
      { word: 'Low-context', definition: 'A communication style where meaning is stated explicitly and directly — little is left implied.' },
      { word: 'Explicit', definition: 'Stated clearly and directly — leaving nothing implied or open to interpretation.' },
      { word: 'Norms', definition: 'The unwritten rules about behaviour that are considered normal and acceptable in a particular culture.' },
    ],
    questions: [
      { n: 4, q: 'Would you describe your own communication style as more high-context or low-context? Give an example.' },
      { n: 5, q: 'Have you ever misunderstood someone from a different culture — or been misunderstood yourself? What happened?' },
      { n: 6, q: 'Should multicultural teams adopt one communication style, or should everyone adapt to each other?' },
    ]
  },
  {
    number: 3, title: 'Hierarchy, Decision-Making and Meetings', emoji: '🏛️', color: '#8b5cf6',
    text: `Attitudes toward hierarchy and authority vary enormously across cultures and can be a major source of confusion in multicultural workplaces. In cultures with high power distance — a term coined by researcher Geert Hofstede to describe the degree to which less powerful members of society accept unequal distribution of power — employees typically show significant deference to their managers and do not openly challenge or contradict a senior person's opinion, especially in public. In many parts of Southeast Asia, East Asia, and the Middle East, questioning a manager's decision in front of others would be considered deeply inappropriate. In low power distance cultures — common in Scandinavia, the Netherlands, and Australia — flat hierarchies and open debate between junior and senior staff are expected and valued.\n\nMeetings are a particularly revealing arena for these differences. In some cultures, meetings are decision-making forums where ideas are debated and conclusions reached in the room. In others — notably Japan and South Korea — meetings are primarily for presenting decisions that have already been agreed through careful behind-the-scenes consultation, a process known as nemawashi in Japanese. A Western manager who expects open debate in a meeting may be frustrated by what feels like passive agreement, while Asian colleagues may feel uncomfortable with what seems like a chaotic and disrespectful process. Understanding these different frameworks — rather than assuming one is right and the other is wrong — is essential for effective cross-cultural leadership.`,
    vocab: [
      { word: 'Power distance', definition: 'The degree to which people accept unequal distribution of power in a society or organisation.' },
      { word: 'Deference', definition: 'Respectful submission to the opinion or authority of someone more senior.' },
      { word: 'Nemawashi', definition: 'A Japanese practice of building consensus privately before a formal meeting — laying the groundwork.' },
      { word: 'Contradict', definition: 'To say the opposite of what someone has stated — to openly disagree with a statement or decision.' },
    ],
    questions: [
      { n: 7, q: 'In your culture, is it acceptable to openly disagree with a manager in a meeting? How is it usually handled?' },
      { n: 8, q: 'Which approach to meetings do you prefer — open debate or decisions prepared in advance? Why?' },
      { n: 9, q: 'How should a team leader manage a meeting when team members have very different expectations about hierarchy?' },
    ]
  },
  {
    number: 4, title: 'Building Trust and Making Multicultural Teams Work', emoji: '🤝', color: '#22c55e',
    text: `Trust is the foundation of any effective team, but the way trust is built varies significantly across cultures. In task-based cultures — common in Northern Europe and North America — trust is primarily built through professional reliability: doing what you say you will do, meeting deadlines, and delivering quality work. People trust colleagues they have worked with successfully, even if they do not know them personally. In relationship-based cultures — more typical of Southern Europe, Latin America, the Middle East, and much of Asia — trust is built through personal connection first. People need to know and like someone before they feel comfortable working closely with them, which means that time spent socialising, sharing meals, and building personal relationships is not a distraction from work — it is an essential part of the professional relationship.\n\nSuccessful multicultural teams are not teams where everyone pretends to be the same. They are teams where differences are acknowledged, discussed openly, and treated as assets rather than obstacles. Effective cross-cultural leaders invest time in helping their teams understand each other's backgrounds, creating shared norms that everyone has contributed to, and building psychological safety — an environment where people feel confident to speak, disagree, and make mistakes without fear of judgement. In a world where most significant work is done across borders, these skills are not a luxury — they are a professional necessity.`,
    vocab: [
      { word: 'Reliability', definition: 'Consistently doing what you promise — being dependable and trustworthy through your actions.' },
      { word: 'Psychological safety', definition: 'A team environment where people feel safe to speak, take risks, and be themselves without fear.' },
      { word: 'Assets', definition: 'Valuable qualities or resources — things that help rather than hinder.' },
      { word: 'Acknowledged', definition: 'Recognised and accepted as real or true — not ignored or denied.' },
    ],
    questions: [
      { n: 10, q: 'Do you build trust at work through results, or through personal relationships — or both?' },
      { n: 11, q: 'What specific things can a team leader do to create psychological safety in a multicultural team?' },
      { n: 12, q: 'Has working with people from different cultures changed the way you think or work? Give an example.' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Working in Multicultural Teams". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function MulticulturalTeamsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Working in Multicultural Teams</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Beyond Borders — understand how culture shapes communication, hierarchy and trust at work, and how to make diverse teams thrive.</p>
            </div>
          </div>
