...
const PARTS = [
  {
    number: 1, title: 'The Invisible Ecosystem Inside You', emoji: '🦠', color: '#dc2626',
    text: `A major new study published this week revealed something that will make you think differently about every pill you have ever taken: common medications reshape your gut microbiome — the community of trillions of microorganisms living inside your digestive system — and the changes can persist long after you stop taking the medication.\n\nThe study, which analysed data from more than 2,500 people, found lasting microbial changes linked not just to antibiotics — which are well known to affect gut bacteria — but also to antidepressants, diabetes medications, heartburn drugs, and several other commonly prescribed medicines. In some cases, the microbial changes were detectable years after the last dose.\n\nYour gut microbiome is not just a collection of bacteria — it is an ecosystem as complex and important as any rainforest. It contains approximately 38 trillion microorganisms — slightly more than the total number of human cells in your body. These organisms help digest food, produce vitamins, train your immune system, protect against harmful pathogens, and even influence your mood and mental health through what scientists call the "gut-brain axis."\n\nThe discovery that everyday medications alter this ecosystem has significant implications. If a course of antidepressants permanently changes your gut bacteria, and your gut bacteria influence your mood, does the medication work partly by changing your microbiome? And if so, what are the long-term consequences of those changes?`,
    vocab: [
      { word: 'Microbiome', definition: 'The community of trillions of microorganisms — bacteria, fungi, viruses — living in and on your body.' },
      { word: 'Persist', definition: 'To continue existing long after the original cause has stopped — to last.' },
      { word: 'Pathogens', definition: 'Microorganisms that cause disease — harmful bacteria, viruses, or parasites.' },
      { word: 'Gut-brain axis', definition: 'The communication network between your digestive system and your brain — they influence each other.' },
    ],
    questions: [
      { n: 1, q: 'You have 38 trillion microorganisms inside you. How does knowing this change how you think about your body?' },
      { n: 2, q: 'Medications change your gut bacteria years after you stop taking them. Should this concern us? Why or why not?' },
      { n: 3, q: 'Your gut bacteria influence your mood through the gut-brain axis. Does this surprise you? What are the implications?' },
    ]
  },
  {
    number: 2, title: 'What Medications Do to Your Gut', emoji: '💊', color: '#b91c1c',
    text: `The study identified several categories of medications that produce significant and lasting changes to the gut microbiome.\n\nAntibiotics have the most dramatic effect — and the most well-documented. A single course of broad-spectrum antibiotics can reduce gut bacterial diversity by 30-40%, killing beneficial bacteria alongside the harmful ones they are designed to target. While most bacterial populations recover within weeks, some species may be permanently eliminated. Repeated courses of antibiotics — common in childhood — can produce cumulative changes that persist into adulthood.\n\nAntidepressants, particularly SSRIs, were found to alter the composition of gut bacteria in ways that were detectable months or years after treatment ended. This finding is particularly intriguing because it may help explain why some antidepressants take weeks to start working — they may be gradually reshaping the gut microbiome, which in turn affects brain chemistry through the gut-brain axis.\n\nProton pump inhibitors — medications used to treat heartburn and acid reflux — reduce stomach acid, which changes the environment in which gut bacteria live. Lower acid levels allow certain bacterial species to proliferate while suppressing others, creating a different microbial balance that persists as long as the medication is taken and sometimes beyond.\n\nMetformin, a widely prescribed diabetes medication, has a particularly complex relationship with the microbiome. Research suggests that some of its beneficial effects on blood sugar may actually be mediated through changes to gut bacteria rather than through its direct chemical action — meaning the drug may work partly by feeding the right bacteria.`,
    vocab: [
      { word: 'Broad-spectrum', definition: 'Affecting a wide range of organisms — antibiotics that kill many types of bacteria, not just specific ones.' },
      { word: 'Diversity', definition: 'Variety — the number of different species present in an ecosystem.' },
      { word: 'Proliferate', definition: 'To multiply rapidly — to increase in number quickly.' },
      { word: 'Mediated', definition: 'Caused or influenced indirectly — working through an intermediate mechanism.' },
    ],
    questions: [
      { n: 4, q: 'Antibiotics kill beneficial bacteria alongside harmful ones. Should doctors prescribe them more carefully?' },
      { n: 5, q: 'Antidepressants may work partly by changing gut bacteria. Does this make them seem more or less like a natural treatment?' },
      { n: 6, q: 'A diabetes drug may work by feeding the right bacteria. What does this suggest about the future of medicine?' },
    ]
  },
  {
    number: 3, title: 'The Microbiome Revolution', emoji: '🔬', color: '#991b1b',
    text: `The study is part of a broader revolution in how medicine understands the role of the microbiome in human health. Over the past two decades, research has linked the gut microbiome to an astonishing range of conditions — obesity, diabetes, heart disease, cancer, autoimmune disorders, allergies, depression, anxiety, autism, and even Parkinson's disease.\n\nThe connections are complex and not fully understood. But the general principle is becoming clear: the composition of your gut microbiome — which species are present, in what proportions, and how active they are — has a profound influence on your overall health. A diverse, balanced microbiome is associated with better health outcomes. A disrupted or imbalanced microbiome — called dysbiosis — is associated with disease.\n\nThis understanding is changing medicine. Faecal microbiota transplantation — transferring gut bacteria from a healthy donor to a sick patient — has proven remarkably effective for treating Clostridioides difficile infections, a dangerous condition that kills approximately 30,000 Americans per year. Researchers are now exploring whether similar approaches could treat obesity, inflammatory bowel disease, and even mental health conditions.\n\nProbiotics — live beneficial bacteria taken as supplements — are a multibillion-dollar industry, though the scientific evidence for most commercial products is weak. The microbiome is so complex and individual that a generic probiotic supplement is unlikely to produce the specific changes needed for any particular health condition. Future probiotics may need to be personalised — tailored to each person's unique microbiome.`,
    vocab: [
      { word: 'Autoimmune', definition: 'A condition where the immune system attacks the body\'s own healthy cells by mistake.' },
      { word: 'Dysbiosis', definition: 'An imbalance in the gut microbiome — when the wrong bacteria dominate.' },
      { word: 'Faecal transplant', definition: 'Transferring gut bacteria from a healthy person to a sick one to restore a healthy microbiome.' },
      { word: 'Personalised', definition: 'Tailored specifically for one individual — not one-size-fits-all.' },
    ],
    questions: [
      { n: 7, q: 'The gut microbiome is linked to obesity, depression, heart disease, and more. Does this change how you think about health?' },
      { n: 8, q: 'Faecal transplants work for some conditions. How do you feel about this treatment? Would you accept one?' },
      { n: 9, q: 'Most commercial probiotics have weak evidence. Should they be regulated more strictly? How can consumers know what works?' },
    ]
  },
  {
    number: 4, title: 'You Are an Ecosystem', emoji: '🌿', color: '#7f1d1d',
    text: `The microbiome research reshapes one of the most fundamental questions in biology: what is a human being?\n\nTraditionally, we have thought of ourselves as individual organisms — single beings contained within the boundary of our skin. The microbiome research suggests something more complex: you are not one organism but a community. You are a superorganism — a collection of human cells, bacterial cells, fungal cells, and viral particles that function together as a single entity. Remove the microbiome, and the human body cannot survive.\n\nThis perspective has philosophical implications that extend beyond medicine. If your mood is influenced by bacteria in your gut, are your emotions entirely "yours"? If your food preferences are shaped by which bacteria are present, is your free will as free as you thought? If a medication changes your microbiome and your microbiome changes your personality, where does the drug end and you begin?\n\nThese questions may sound abstract, but they have practical consequences. As medicine moves toward personalised treatments based on individual microbiome profiles, the relationship between patient, microbiome, and medication becomes increasingly complex. Treating a person may mean treating their ecosystem.\n\nThe study published this week is a reminder that every pill we take has consequences we are only beginning to understand. The 38 trillion microorganisms inside you are not passive passengers — they are active participants in your health, your mood, and your life. Understanding them better is not just a scientific challenge — it is a fundamental part of understanding what it means to be human.`,
    vocab: [
      { word: 'Superorganism', definition: 'A collection of organisms that function together as a single entity — greater than its parts.' },
      { word: 'Entity', definition: 'A thing with distinct and independent existence — a being.' },
      { word: 'Free will', definition: 'The ability to make choices independently — the idea that your decisions are truly your own.' },
      { word: 'Profiles', definition: 'Detailed descriptions of characteristics — a map of what makes something unique.' },
    ],
    questions: [
      { n: 10, q: 'You are not one organism but a community. How does this idea change how you think about yourself?' },
      { n: 11, q: 'If gut bacteria influence your mood and preferences, is your free will as free as you thought?' },
      { n: 12, q: 'Every pill has consequences we are only beginning to understand. Should this make us more cautious about taking medications?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Your Medications Change Your Gut Forever</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Common medications reshape your gut microbiome permanently. 38 trillion organisms inside you, the gut-brain axis, and why you are not one organism but a community.</p>
            </div>
          </div>
