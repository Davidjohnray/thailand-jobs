...
const PARTS = [
  {
    number: 1, title: 'A Crisis Within a Crisis', emoji: '🌍', color: '#dc2626',
    text: `When 60,000 people crossed from Morocco into the tiny Spanish enclave of Ceuta in two days at the end of July 2026, the immediate crisis was humanitarian — people drowning, overcrowded streets, overwhelmed emergency services. But the response from European capitals revealed a deeper crisis: the European Union still has no coherent, unified policy on migration, and every new emergency exposes the same fault lines that have divided the continent for over a decade.\n\nWithin 48 hours of the Ceuta crossings, 22 EU member states had signed a joint letter calling for the "strengthening of external borders." Italy announced temporary border controls. France reinforced frontier checks. Hungary and Poland — which had refused to accept refugees during the 2015 migration crisis — used the event to demand even tougher measures. An emergency EU meeting was called.\n\nThe speed and uniformity of these responses contrasted sharply with the absence of any coordinated plan for what should actually happen to the people involved. Border reinforcement addresses the symptom — unauthorised crossings — but does nothing about the causes: poverty, conflict, climate change, and the enormous gap in living standards between Africa and Europe.\n\nThe Ceuta incident also exposed the transactional nature of EU-African relations on migration. Morocco has long acted as a de facto border guard for Europe, receiving billions of euros in exchange for preventing migrants from reaching European territory. When Morocco loosens controls — as it appeared to do this week — the arrangement collapses, and Europe discovers how dependent it has become on outsourcing its border security to countries whose interests do not always align with its own.`,
    vocab: [
      { word: 'Coherent', definition: 'Logical, consistent, and well-organised — making sense as a whole.' },
      { word: 'Fault lines', definition: 'Deep divisions or disagreements that become visible during a crisis.' },
      { word: 'Transactional', definition: 'Based on exchanges of favours or benefits rather than shared values or genuine partnership.' },
      { word: 'Outsourcing', definition: 'Paying someone else to do a job that you are responsible for — delegating to an external party.' },
    ],
    questions: [
      { n: 1, q: 'The EU responded quickly to reinforce borders but had no plan for the people involved. What does this reveal about EU priorities?' },
      { n: 2, q: 'Europe pays Morocco to prevent migration. Is outsourcing border security to another country ethical? What are the risks?' },
      { n: 3, q: 'The passage says the same fault lines appear every time there is a migration crisis. Why has the EU failed to resolve these divisions after more than a decade?' },
    ]
  },
  {
    number: 2, title: 'The Policy Vacuum', emoji: '📋', color: '#b91c1c',
    text: `The European Union has been trying to agree on a common migration policy since the 2015 refugee crisis, when more than a million people — many fleeing the Syrian civil war — arrived in Europe. More than a decade later, the fundamental disagreements remain unresolved.\n\nThe core dispute is about burden-sharing. Under the current system, the countries where migrants first arrive — primarily Italy, Greece, Spain, and Malta — bear a disproportionate share of the responsibility for processing asylum claims and providing accommodation. These countries have repeatedly demanded that other EU members accept their share of arrivals through a mandatory redistribution mechanism. Eastern European countries — particularly Hungary, Poland, and the Czech Republic — have consistently refused, arguing that each country should have the sovereign right to decide who enters its territory.\n\nThe EU Pact on Migration and Asylum, agreed in 2024 after years of negotiation, was supposed to resolve this impasse. It introduced faster border procedures, a solidarity mechanism requiring countries to either accept relocated migrants or pay financial contributions, and stricter rules for processing claims. But implementation has been slow, the solidarity mechanism remains disputed, and the Ceuta crisis demonstrated that the pact is inadequate for dealing with sudden, large-scale arrivals.\n\nCritics argue that the EU's approach is fundamentally reactive — it responds to crises rather than preventing them. A genuinely effective migration policy would address the root causes that drive people to leave their homes, create safe and legal routes for those who need protection, and build processing systems that are fast, fair, and humane. None of these elements exist at sufficient scale.`,
    vocab: [
      { word: 'Burden-sharing', definition: 'Distributing responsibilities fairly among all members of a group rather than leaving it to a few.' },
      { word: 'Redistribution', definition: 'Spreading something more equally — moving resources or people from where they are concentrated to where they are needed.' },
      { word: 'Sovereignty', definition: 'The supreme authority of a country to govern itself and make its own decisions.' },
      { word: 'Impasse', definition: 'A situation where no progress can be made because the sides cannot agree — a deadlock.' },
    ],
    questions: [
      { n: 4, q: 'Should all EU countries be forced to accept migrants, or should each country decide for itself? What are the arguments on both sides?' },
      { n: 5, q: 'The EU Pact on Migration took years to negotiate but is already proving inadequate. Why is migration so difficult to solve through legislation?' },
      { n: 6, q: 'The passage says EU migration policy is reactive rather than preventive. What would a preventive approach look like?' },
    ]
  },
  {
    number: 3, title: 'Migration as a Political Weapon', emoji: '⚔️', color: '#991b1b',
    text: `One of the most troubling aspects of the Ceuta crisis is the strong suspicion that it was not spontaneous but orchestrated — that Morocco deliberately relaxed border controls to send a political message to Spain and the EU.\n\nThis tactic — using migration as a geopolitical weapon — has become increasingly common. In 2021, Belarus deliberately funnelled thousands of migrants to its border with Poland in retaliation for EU sanctions, creating a humanitarian crisis that was designed to destabilise its neighbours. Turkey has repeatedly threatened to "open the gates" and allow millions of Syrian refugees to move towards Europe unless the EU provides more financial support. Libya's various armed factions have used control of migration routes as leverage in negotiations with European governments.\n\nThe weaponisation of migration puts the people involved in an impossible position. They are not just migrants seeking better lives — they become pawns in geopolitical games played by states that have no interest in their welfare. The 67 people who died at Ceuta did not die because of a natural disaster — they died because their desperation was exploited by governments pursuing their own strategic interests.\n\nFor the EU, the weaponisation of migration creates a painful dilemma. Responding to coercion by making concessions rewards the behaviour and encourages future blackmail. But refusing to make concessions means accepting that people will die at the borders — a morally untenable position for a bloc that defines itself by its commitment to human rights.\n\nThis dilemma has no easy resolution. As long as Europe depends on transit countries to control migration flows, those countries will have leverage — and some will use it.`,
    vocab: [
      { word: 'Orchestrated', definition: 'Carefully planned and coordinated — arranged to achieve a specific outcome.' },
      { word: 'Geopolitical', definition: 'Relating to politics on a global scale, especially the relationships between countries and regions.' },
      { word: 'Pawns', definition: 'People who are used and manipulated by others for their own purposes — tools in someone else\'s game.' },
      { word: 'Untenable', definition: 'A position that cannot be maintained or defended — impossible to justify.' },
    ],
    questions: [
      { n: 7, q: 'Countries like Morocco and Belarus have used migration as a political weapon. How should the EU respond without rewarding this behaviour?' },
      { n: 8, q: 'The 67 people who died were described as pawns in a geopolitical game. What responsibility do Morocco, Spain, and the EU each bear for their deaths?' },
      { n: 9, q: 'The passage says Europe depends on transit countries to control migration. How could the EU reduce this dependency?' },
    ]
  },
  {
    number: 4, title: 'Beyond Borders', emoji: '🔮', color: '#7f1d1d',
    text: `The Ceuta crisis, like every migration crisis before it, will eventually fade from the headlines. The emergency meeting will produce a statement. Politicians will promise action. And then, until the next crisis, migration will return to being a slow-burning issue that no one has the political courage to solve.\n\nBut the underlying dynamics are not going away. Africa's population is projected to double by 2050, reaching 2.5 billion people. Climate change is making large parts of the Sahel region uninhabitable. Economic opportunities in sub-Saharan Africa remain limited for hundreds of millions of young people. Meanwhile, Europe's population is ageing and shrinking — many European economies actually need immigrant workers to fill labour shortages and support pension systems.\n\nThis creates a fundamental paradox at the heart of the migration debate: Europe needs migration but does not want it. Its economies depend on immigrant labour, but its politics revolve around promises to reduce immigration. The gap between economic reality and political rhetoric is one of the most dangerous contradictions in contemporary European democracy.\n\nSome scholars argue that the solution lies in reframing the debate entirely — moving from a narrative of crisis and threat to one of managed opportunity. Countries like Canada and Australia have built immigration systems that are broadly popular because they are perceived as orderly, selective, and beneficial to the host country. Europe could, in theory, build something similar — but doing so would require political leaders willing to have an honest conversation with voters about what immigration actually does, rather than competing to promise the lowest numbers.\n\nThe people crossing borders this week are not a problem to be solved. They are human beings responding rationally to the conditions of their lives. Any policy that forgets this — that treats migration purely as a security issue rather than a human one — is not just morally wrong. It is also doomed to fail.`,
    vocab: [
      { word: 'Paradox', definition: 'A situation that seems contradictory — two things that are both true but appear to be opposite.' },
      { word: 'Rhetoric', definition: 'Language designed to persuade — often used to describe speech that sounds impressive but lacks substance.' },
      { word: 'Reframing', definition: 'Changing the way something is understood by presenting it from a different perspective.' },
      { word: 'Rationally', definition: 'In a logical, reasonable way — making decisions based on practical thinking.' },
    ],
    questions: [
      { n: 10, q: 'Europe needs immigrants but does not want them. How can this paradox be resolved? Can politics and economics ever be aligned on this issue?' },
      { n: 11, q: 'Canada and Australia have popular immigration systems. What makes them different from Europe\'s approach? Could the model be transferred?' },
      { n: 12, q: 'The passage ends by saying migrants are human beings responding rationally to their lives. Does this framing change how you think about migration?' },
    ]
  },
]
...
export default function EUMigrationPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The EU Migration Emergency</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>After 60,000 people crossed into Ceuta, the EU called an emergency meeting. But does Europe have any real answers to its migration crisis — or just more fences?</p>
            </div>
          </div>
