...
const PARTS = [
  {
    number: 1, title: 'The Fear of Public Speaking — and How to Overcome It', emoji: '🎤', color: '#8b5cf6',
    text: `Public speaking is consistently ranked among the most common fears in the world — in some surveys it even ranks above the fear of death. For professionals who must present in a second language, the anxiety can be even more intense. The worry of making grammatical errors, losing track of what you want to say, or being unable to answer questions can cause many talented people to underperform in situations where their ideas and expertise deserve to be heard.\n\nThe good news is that presentation skills can be learned and improved with practice. Research in communication science shows that the most important factor in a successful presentation is not perfect language or flawless delivery — it is the speaker's ability to connect with their audience and communicate their message clearly. In fact, a small number of natural errors can actually make a non-native speaker seem more authentic and relatable. What truly undermines a presentation is lack of structure, unclear purpose, and the speaker's own lack of confidence — all of which can be directly addressed through preparation.`,
    vocab: [
      { word: 'Anxiety', definition: 'A feeling of worry and nervousness — especially about something uncertain or difficult.' },
      { word: 'Underperform', definition: 'To do less well than expected — to not reach your potential in a situation.' },
      { word: 'Authentic', definition: 'Genuine and real — not pretending to be something you are not.' },
      { word: 'Delivery', definition: 'The way you speak when presenting — your tone, pace, body language and confidence.' },
    ],
    questions: [
      { n: 1, q: 'Do you find presenting in English more stressful than in your first language? Why?' },
      { n: 2, q: 'Is it better to memorise a presentation or speak from notes? What are the risks of each?' },
      { n: 3, q: 'Can presentation skills really be learned, or are some people naturally better at it?' },
    ]
  },
  {
    number: 2, title: 'Structure: The Foundation of Every Good Presentation', emoji: '🏗️', color: '#3b82f6',
    text: `Every effective presentation follows a clear structure. The classic formula — tell them what you're going to tell them, tell them, then tell them what you told them — may sound simple, but it reflects a deep truth about how people process information. Audiences need signposting: clear signals that indicate where you are in your presentation, what is coming next, and how each section connects to the overall message.\n\nA strong opening is critical. You have approximately thirty seconds to capture the audience's attention before their minds start to wander. Effective openers include a surprising statistic, a short story, a provocative question, or a bold statement about why this topic matters to the people in the room. The body of the presentation should focus on two or three key points only — trying to cover too much information is one of the most common mistakes presenters make. Each point should be supported by evidence, an example, or a brief story. The closing should be strong and memorable: restate your main message, give the audience a clear takeaway, and finish with a call to action or a thought-provoking final statement.`,
    vocab: [
      { word: 'Signposting', definition: 'Using language to guide your audience — phrases that show where you are and what comes next.' },
      { word: 'Provocative', definition: 'Designed to make people think or react — something that challenges or surprises the audience.' },
      { word: 'Takeaway', definition: 'The key message or idea an audience should remember after a presentation.' },
      { word: 'Call to action', definition: 'A clear request for the audience to do something specific after hearing your presentation.' },
    ],
    questions: [
      { n: 4, q: 'Why is the opening of a presentation so important? What makes a great opening?' },
      { n: 5, q: 'How do you decide which information to include and which to leave out?' },
      { n: 6, q: 'What is the most memorable presentation you have ever seen? What made it effective?' },
    ]
  },
  {
    number: 3, title: 'Delivery: Voice, Body Language and Slide Design', emoji: '🎭', color: '#f59e0b',
    text: `The words in your presentation are only part of the message. Research suggests that a significant proportion of how an audience perceives a speaker comes from non-verbal communication — voice tone, pace, eye contact, posture, and gesture. A presenter who speaks in a monotone, stares at their slides, or stands rigidly in one position will struggle to engage their audience regardless of how good their content is. Conversely, a speaker who varies their pace, uses deliberate pauses, makes eye contact with different parts of the room, and moves purposefully tends to hold attention far more effectively.\n\nSlide design is another area where many presenters make preventable mistakes. Slides filled with dense text, small fonts, or complex tables are difficult to read and force the audience to choose between listening to you and reading the screen. Effective slides use minimal text — often just a single headline and a supporting image or chart. The slide should illustrate and reinforce your spoken message, not replace it. A useful principle is the "six by six rule": no more than six bullet points per slide and no more than six words per bullet. Better still, many experienced presenters use slides with no text at all — only images and data — allowing their spoken words to carry the full message.`,
    vocab: [
      { word: 'Monotone', definition: 'Speaking in a flat, unchanging pitch — a voice with no variation in tone or energy.' },
      { word: 'Deliberate', definition: 'Done carefully and intentionally — a deliberate pause is one you choose for effect.' },
      { word: 'Posture', definition: 'The way you hold and position your body — standing tall and open projects confidence.' },
      { word: 'Reinforce', definition: 'To strengthen or support something — a good slide reinforces what you are saying aloud.' },
    ],
    questions: [
      { n: 7, q: 'How much do non-verbal signals like body language and eye contact affect your trust in a speaker?' },
      { n: 8, q: 'Have you ever sat through a presentation with too many slides or too much text? How did it feel?' },
      { n: 9, q: 'Is it better to use slides, no slides, or something else entirely when presenting?' },
    ]
  },
  {
    number: 4, title: 'Handling Questions and Presenting Across Cultures', emoji: '🌐', color: '#22c55e',
    text: `The question and answer session at the end of a presentation is where many speakers feel most vulnerable — especially in a second language. Preparation is the best defence. Before any important presentation, experienced speakers think through the questions they are most likely to be asked and prepare clear, concise answers. When a question is asked, it is important to listen carefully before responding. Paraphrasing the question — "So you're asking whether..." — gives you a moment to think and confirms that you have understood correctly.\n\nPresenting across cultures adds another layer of complexity. In some business cultures, audiences are expected to listen silently and ask questions only at the end; in others, interrupting to ask questions during the presentation is entirely normal. Some audiences respond warmly to humour and personal stories; others prefer a more formal, data-driven approach. Eye contact norms also vary significantly: maintaining strong eye contact signals confidence and honesty in many Western business cultures, but may be interpreted differently elsewhere. Understanding your audience's cultural expectations — and adapting your style accordingly — is what separates a good presenter from a truly skilled one.`,
    vocab: [
      { word: 'Vulnerable', definition: 'Exposed to the risk of being criticised or challenged — feeling unsure or unprotected.' },
      { word: 'Paraphrasing', definition: 'Restating something in different words — used to confirm understanding and buy thinking time.' },
      { word: 'Concise', definition: 'Short and clear — expressing ideas in as few words as necessary without losing meaning.' },
      { word: 'Adapting', definition: 'Changing your approach to suit a different situation, audience or cultural context.' },
    ],
    questions: [
      { n: 10, q: 'How do you handle a question in a presentation when you do not know the answer?' },
      { n: 11, q: 'Have you ever presented to an audience from a different culture? What did you have to adjust?' },
      { n: 12, q: 'What is one specific thing you will do differently in your next presentation based on what you have read?' },
    ]
  },
]
...
export default function GivingPresentationsPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #2e1065 0%, #8b5cf6 100%)', padding: '56px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Giving Presentations with Confidence</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Stand Up and Speak — learn how to structure, deliver and adapt professional presentations in English with clarity and confidence.</p>
            </div>
          </div>
