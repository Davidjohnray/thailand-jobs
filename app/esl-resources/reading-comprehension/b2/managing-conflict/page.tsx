...
const PARTS = [
  {
    number: 1, title: 'Understanding Workplace Conflict', emoji: '⚡', color: '#ef4444',
    text: `Conflict is an unavoidable feature of professional life. Wherever people work together — with different personalities, priorities, communication styles, and cultural backgrounds — disagreements will arise. This is not a sign of a failing organisation; in fact, research in organisational behaviour suggests that a complete absence of conflict can indicate a team that is avoiding difficult conversations rather than genuinely agreeing. The goal in professional environments is not to eliminate conflict but to manage it constructively — to ensure that disagreements lead to better decisions rather than damaged relationships and wasted energy.\n\nWorkplace conflicts take many forms. Task conflict — disagreements about how work should be done, which approach is best, or who should be responsible for what — can actually improve decision-making when handled well, by forcing teams to examine their assumptions and consider alternative perspectives. Relationship conflict — personal tension between individuals — is more damaging and almost always reduces team performance. Process conflict — disagreements about procedures, timelines, and how resources are allocated — falls somewhere between the two. Understanding which type of conflict you are facing is the first step toward resolving it effectively, since different types require different approaches.`,
    vocab: [
      { word: 'Unavoidable', definition: 'Impossible to prevent or escape — something that will happen regardless of your efforts.' },
      { word: 'Constructively', definition: 'In a way that produces positive results — dealing with something in a useful and helpful manner.' },
      { word: 'Task conflict', definition: 'Disagreement about what work should be done or how — can be productive if managed well.' },
      { word: 'Allocated', definition: 'Distributed or assigned — resources that are divided among different people or purposes.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever experienced conflict at work? What type was it — task, relationship, or process conflict?' },
      { n: 2, q: 'Do you think some conflict is healthy in a team, or should it always be avoided?' },
      { n: 3, q: 'Are you someone who addresses conflict directly, or do you tend to avoid it? Why?' },
    ]
  },
  {
    number: 2, title: 'Common Causes and How Conflict Escalates', emoji: '📈', color: '#f59e0b',
    text: `Most workplace conflicts do not begin as major confrontations. They typically start small — a misunderstood email, a missed deadline that affected someone else's work, a decision made without consulting the people it affected, or a comment that was interpreted differently from how it was intended. If these small tensions are not addressed early, they can escalate through a predictable pattern: minor irritation becomes frustration, frustration hardens into resentment, resentment begins to affect behaviour, and behaviour affects the wider team.\n\nAmong the most common triggers of workplace conflict are unclear roles and responsibilities — when people are not sure whose job something is, either nobody does it or two people do it and clash; poor communication — particularly in remote or multicultural teams where messages can be easily misread; competing priorities — when team members or departments have goals that are genuinely in tension with each other; and perceived unfairness — when people believe they are not being treated equitably compared to colleagues. Recognising these triggers early — before a small issue becomes a major one — is the most effective conflict prevention strategy available to any manager or team member.`,
    vocab: [
      { word: 'Escalates', definition: 'Increases in intensity or seriousness — a conflict that grows bigger and more difficult over time.' },
      { word: 'Resentment', definition: 'A feeling of bitterness toward someone because of something they did — anger that builds over time.' },
      { word: 'Perceived', definition: 'Understood or interpreted in a particular way — how something appears, whether or not it is objectively true.' },
      { word: 'Equitably', definition: 'Fairly and justly — treating everyone according to the same standards and principles.' },
    ],
    questions: [
      { n: 4, q: 'Can you think of a time when a small misunderstanding at work grew into a bigger problem? What could have prevented it?' },
      { n: 5, q: 'Which of the common conflict triggers do you think is most damaging in a workplace — and why?' },
      { n: 6, q: 'Is it better to address a small conflict immediately, or wait to see if it resolves itself naturally?' },
    ]
  },
  {
    number: 3, title: 'Language and Strategies for Resolving Conflict', emoji: '🕊️', color: '#3b82f6',
    text: `Resolving conflict professionally requires a specific set of communication skills and a willingness to approach difficult conversations with both honesty and sensitivity. One of the most effective frameworks for addressing conflict is the concept of separating people from problems — focusing on the issue at hand rather than making the conversation about personal character or motivation. "The deadline was missed, which has created a problem for the client" is more productive than "You are unreliable and don't take your responsibilities seriously."\n\nUseful language for initiating a difficult conversation includes: "I'd like to talk about something that's been affecting our working relationship — would now be a good time?" or "I want to make sure I've understood the situation correctly — can we discuss what happened?" During the conversation itself, active listening is essential: paraphrasing what the other person has said ("So if I understand correctly, you felt that..."), asking open questions rather than closed ones, and acknowledging the other person's perspective before stating your own. Phrases that signal openness — "I can see why you might have felt that way" or "I understand this has been frustrating for you too" — reduce defensiveness and make it easier for both parties to move toward a solution rather than remaining stuck in their respective positions.`,
    vocab: [
      { word: 'Framework', definition: 'A set of principles or rules that provide structure for approaching a problem or situation.' },
      { word: 'Paraphrasing', definition: 'Restating what someone has said in your own words — showing you have understood and are listening.' },
      { word: 'Defensiveness', definition: 'A reaction of self-protection when feeling criticised — becoming closed rather than open to dialogue.' },
      { word: 'Respective', definition: 'Belonging separately to each person — their own individual position or point of view.' },
    ],
    questions: [
      { n: 7, q: 'How do you start a difficult conversation at work? Do you find it easy or uncomfortable to initiate?' },
      { n: 8, q: 'What role does active listening play in resolving conflict — and are you good at it?' },
      { n: 9, q: 'Is it possible to resolve a conflict without both parties feeling heard? What happens if only one person feels understood?' },
    ]
  },
  {
    number: 4, title: 'When to Escalate and Building a Conflict-Resilient Team', emoji: '🏗️', color: '#22c55e',
    text: `Not all workplace conflicts can or should be resolved between the individuals involved. Some situations — persistent bullying or harassment, discrimination, ethical violations, or conflicts where a significant power imbalance makes direct resolution unsafe — require escalation to a manager, HR department, or formal grievance process. Knowing when to escalate is itself a professional skill. Many people either escalate too quickly, before attempting to resolve the issue directly, or too late, after the situation has become serious enough to cause lasting damage to relationships or wellbeing.\n\nBeyond resolving individual conflicts, truly high-performing teams develop what might be called conflict resilience — the ability to disagree productively, recover quickly from tension, and maintain trust even when navigating difficult conversations. This is built through several practices: creating explicit team agreements about how disagreements will be handled; normalising healthy debate — making it clear that challenging ideas is welcome, but personal attacks are not; building in regular opportunities for honest conversation about how the team is functioning; and modelling constructive behaviour from the top. Leaders who handle their own conflicts visibly and professionally give their teams a powerful example to follow. In the end, a team's ability to manage conflict is not a sign of dysfunction — it is one of the strongest indicators of maturity, trust, and long-term performance.`,
    vocab: [
      { word: 'Grievance', definition: 'A formal complaint made by an employee about unfair treatment — handled through official HR processes.' },
      { word: 'Power imbalance', definition: 'A situation where one person has significantly more authority or influence than another.' },
      { word: 'Normalising', definition: 'Making something seem normal and acceptable — treating it as a regular part of how things work.' },
      { word: 'Dysfunction', definition: 'The failure to work normally or effectively — a team or system that is not functioning as it should.' },
    ],
    questions: [
      { n: 10, q: 'Have you ever had to escalate a conflict to a manager or HR? How did you decide when it was the right time?' },
      { n: 11, q: 'What does a "conflict-resilient" team look like to you? Have you ever been part of one?' },
      { n: 12, q: 'What is the most important lesson you have learned — or want to learn — about managing conflict at work?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Managing Conflict at Work". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function ManagingConflictPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Managing Conflict at Work</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From Tension to Resolution — understand what causes workplace conflict, how to address it professionally, and how to build teams that handle disagreement well.</p>
            </div>
          </div>
