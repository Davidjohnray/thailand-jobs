...
const PARTS = [
  {
    number: 1, title: 'The Age of Misinformation', emoji: '📰', color: '#f59e0b',
    text: `In 2016, a man walked into a pizza restaurant in Washington, D.C. carrying an assault rifle. He had driven more than 500 kilometres from his home in North Carolina because he believed — based entirely on fabricated stories he had read on social media — that the restaurant was the centre of a child trafficking ring run by senior politicians. He fired several shots before being arrested. Nobody was hurt, but the incident shocked the world and became a symbol of something deeply troubling: people were making life-altering decisions based on information that was completely false.\n\nFake news is not new. Propaganda, rumours, and deliberate lies have been used to manipulate public opinion for centuries. What is new is the speed and scale at which false information can now spread. A fabricated story posted on social media can reach millions of people within hours — long before any fact-checker has time to respond. Research from MIT found that false stories spread six times faster than true stories on social media, and reach far more people.\n\nThe reasons for this are partly psychological and partly technological. Humans are naturally drawn to information that is surprising, emotional, or threatening — and false stories are often designed to trigger exactly these reactions. Social media algorithms amplify content that generates engagement, and outrage, fear, and disbelief are among the most engaging emotions. The platforms are not designed to spread truth — they are designed to hold attention. And false, sensational content holds attention more effectively than careful, nuanced reporting.\n\nThe consequences extend far beyond individual incidents. Misinformation has influenced elections, undermined public health responses, fuelled ethnic violence, and eroded trust in institutions that democracies depend on — the media, the judiciary, science, and government itself. Understanding how fake news works is no longer optional — it is an essential skill for living in the modern world.`,
    vocab: [
      { word: 'Fabricated', definition: 'Made up or invented — not based on facts or reality.' },
      { word: 'Propaganda', definition: 'Information, often misleading, used to promote a political cause or point of view.' },
      { word: 'Amplify', definition: 'To make something louder, bigger, or more widespread — to increase its reach and impact.' },
      { word: 'Eroded', definition: 'Gradually worn away or weakened over time.' },
    ],
    questions: [
      { n: 1, q: 'A man drove 500 kilometres and fired a gun because of fake news. What does this tell us about the power of misinformation?' },
      { n: 2, q: 'False stories spread six times faster than true stories. Why do you think lies travel faster than truth?' },
      { n: 3, q: 'Social media algorithms are designed to hold attention, not spread truth. Should platforms be required to change this? How?' },
    ]
  },
  {
    number: 2, title: 'Who Creates Fake News — and Why?', emoji: '🎭', color: '#d97706',
    text: `Fake news is not created randomly. Behind every piece of misinformation there is a motivation — and understanding those motivations is the first step to recognising false content when you encounter it.\n\nThe most straightforward motivation is money. During the 2016 US presidential election, journalists discovered that teenagers in the small town of Veles, North Macedonia, were running dozens of fake news websites. They did not care about American politics — they cared about advertising revenue. By creating sensational, emotionally charged stories that went viral on Facebook, they earned thousands of dollars per month from the ads displayed on their sites. For them, fake news was simply a business.\n\nPolitical motivation is equally powerful. Governments, political parties, and interest groups create and spread misinformation to damage opponents, promote their own narratives, and confuse public debate. Russia's Internet Research Agency, exposed in detail after 2016, employed hundreds of people to create fake social media accounts posing as ordinary citizens of other countries, posting divisive content designed to deepen social divisions and undermine trust in democratic institutions.\n\nIdeological motivation drives a different kind of misinformation. People who hold strong beliefs — about health, religion, politics, or conspiracy theories — often share false information not because they know it is false, but because it confirms what they already believe. This is one of the most difficult forms of misinformation to combat, because the people spreading it are acting in good faith — they genuinely believe they are sharing the truth.\n\nFinally, some misinformation is created purely for entertainment or social status. Satirical content is misunderstood as real news. Pranksters create hoaxes for attention. Influencers share unverified claims to boost engagement. The motivations are diverse, but the effect is the same: a polluted information environment in which truth becomes harder to find.`,
    vocab: [
      { word: 'Revenue', definition: 'Income or money earned, especially by a business or from advertising.' },
      { word: 'Divisive', definition: 'Causing disagreement and conflict between different groups of people.' },
      { word: 'Good faith', definition: 'With honest intentions — believing you are doing the right thing.' },
      { word: 'Satirical', definition: 'Using humour, irony, or exaggeration to criticise something — not meant to be taken literally.' },
    ],
    questions: [
      { n: 4, q: 'Teenagers in North Macedonia made thousands of dollars per month from fake news. Does the financial motivation surprise you? How could this be stopped?' },
      { n: 5, q: 'People share misinformation because it confirms what they already believe. Have you ever shared something online without checking if it was true? What happened?' },
      { n: 6, q: 'Of the four motivations — money, politics, ideology, entertainment — which do you think is most dangerous? Why?' },
    ]
  },
  {
    number: 3, title: 'How to Spot It', emoji: '🔍', color: '#b45309',
    text: `Critical thinking about information is a skill that can be learned and practised. Media literacy researchers have developed several practical techniques that anyone can use to evaluate whether a piece of content is reliable before sharing it.\n\nThe first and most important technique is simply to pause. Research shows that the single most effective intervention against misinformation is a brief delay between encountering a piece of content and deciding whether to share it. When people are asked to stop and think about accuracy before sharing, the spread of false information drops significantly. The instinct to share something immediately — before checking it — is the single biggest enabler of misinformation.\n\nThe second technique is lateral reading — a method used by professional fact-checkers. Instead of trying to evaluate a source by examining the source itself, open a new browser tab and search for information about the source. Who runs this website? What do other credible sources say about this claim? Is this story being reported by established news organisations? If a dramatic claim appears on only one website and no reputable news source has covered it, that is a strong signal that it may not be true.\n\nThe third technique is checking the evidence. Does the article cite specific sources? Can you find those sources independently? Are statistics presented with context — or are they cherry-picked to support a predetermined conclusion? A claim like "crime increased by 50%" sounds alarming, but without knowing the time period, the baseline, and the methodology, it is meaningless.\n\nThe fourth technique is emotional awareness. If a piece of content makes you feel strongly — angry, outraged, scared, triumphant — that emotional reaction is exactly what the creator intended. Strong emotions reduce critical thinking. The more strongly you react to a headline, the more carefully you should check it before sharing.`,
    vocab: [
      { word: 'Lateral reading', definition: 'Checking a source by searching for information about it elsewhere, rather than only reading the source itself.' },
      { word: 'Reputable', definition: 'Well-respected and trusted — known for being reliable and accurate.' },
      { word: 'Cherry-picked', definition: 'Selecting only the data or facts that support your argument while ignoring those that do not.' },
      { word: 'Predetermined', definition: 'Decided in advance — reaching a conclusion before examining the evidence.' },
    ],
    questions: [
      { n: 7, q: 'Simply pausing before sharing reduces misinformation significantly. Why is something so simple so effective? Do you pause before sharing?' },
      { n: 8, q: 'Lateral reading means checking what others say about a source. Try this right now — pick a news website you use and search for what others say about its reliability.' },
      { n: 9, q: 'If a headline makes you feel very angry or outraged, that is a signal to check it carefully. Why does emotion reduce critical thinking?' },
    ]
  },
  {
    number: 4, title: 'Can Truth Survive?', emoji: '🌐', color: '#92400e',
    text: `The fight against fake news is ultimately a fight for the survival of shared truth — the idea that there are facts about the world that can be established through evidence and agreed upon across political and cultural divides. Without shared truth, democratic debate becomes impossible, public health measures cannot function, and trust between citizens collapses.\n\nTechnology companies have begun to take some steps. Facebook, YouTube, and Twitter have introduced fact-checking labels, reduced the algorithmic promotion of content from unreliable sources, and removed some of the most dangerous misinformation — particularly around elections and public health. But these measures are inconsistent, often slow, and constantly outpaced by the volume of new false content being created.\n\nMedia literacy education is increasingly being introduced in schools. Finland, often cited as the world leader in this area, has integrated critical thinking about media into its national curriculum from primary school onwards. Finnish students are taught to question sources, identify manipulation techniques, and distinguish between fact, opinion, and misinformation. The results have been impressive — Finland consistently ranks as one of the most resilient countries in Europe against misinformation campaigns.\n\nBut education alone is not enough. Structural changes to the information environment are also necessary — changes to how algorithms work, how advertising revenue is distributed, and how platforms are regulated. The challenge is that these changes threaten the business models of some of the most powerful companies in the world, making reform politically difficult.\n\nIn the end, the responsibility is shared. Platforms must be designed to prioritise accuracy over engagement. Governments must invest in education and regulation. And individuals must develop the habits of critical thinking that allow them to navigate an information environment that is more complex, more manipulative, and more consequential than anything humanity has faced before.`,
    vocab: [
      { word: 'Shared truth', definition: 'Facts about the world that can be agreed upon through evidence, regardless of political beliefs.' },
      { word: 'Algorithmic', definition: 'Determined by computer algorithms — the automated rules that decide what content you see online.' },
      { word: 'Resilient', definition: 'Strong enough to recover quickly from difficulties — not easily damaged or manipulated.' },
      { word: 'Consequential', definition: 'Having important results or effects — significant in its impact.' },
    ],
    questions: [
      { n: 10, q: 'Finland teaches media literacy from primary school. Should every country do this? At what age should children start learning about fake news?' },
      { n: 11, q: 'Social media platforms profit from engagement, and false content is engaging. Can companies be trusted to fix this themselves, or is regulation needed?' },
      { n: 12, q: 'Who bears the most responsibility for fighting fake news — platforms, governments, or individuals? Can any one group solve it alone?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Fake News and How to Spot It</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Why misinformation spreads faster than truth, who creates it and why, and the practical skills you need to tell real news from fake.</p>
            </div>
          </div>
