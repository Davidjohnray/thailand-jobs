...
// ──────────────────────────────────────────────────────────────
// Content for AI in Everyday Life
// ──────────────────────────────────────────────────────────────
const PARTS = [
  {
    number: 1,
    ...
    emoji: '🧠',
    color: '#3b82f6', // blue
    text: `Artificial Intelligence (AI) refers to computer systems that can perform tasks normally requiring human intelligence. These tasks include understanding language, recognizing images, solving problems, and making decisions. AI is no longer just a concept from science fiction; it is now part of everyday life. Many people use AI without even realizing it, such as when they ask a voice assistant for the weather or unlock their phone using facial recognition.\n\nAI systems learn by analyzing large amounts of data. The more data they process, the better they become at predicting outcomes or recognizing patterns. This learning process allows AI to improve over time, making it more useful and accurate in daily applications.`,
    vocab: [
      { word: 'Artificial Intelligence', definition: 'Computer systems that can do tasks that normally need human thinking, like learning and problem-solving.' },
      { word: 'Recognizing', definition: 'Identifying something or someone you have seen before – here, images or faces.' },
      { word: 'Data', definition: 'Information collected and stored, often as numbers, text, or images.' },
      { word: 'Patterns', definition: 'Regular and repeated ways in which something happens or is arranged.' },
    ],
    questions: [
      { n: 1, q: 'Which AI tools do you think people use most often in daily life?' },
      { n: 2, q: 'Do you think AI makes life easier? Why or why not?' },
      { n: 3, q: 'Should people learn more about how AI works? Explain your opinion.' },
    ],
  },
  {
    number: 2,
    title: 'AI at Home and in Communication',
    emoji: '🏠',
    color: '#10b981', // green
    text: `In many homes, AI is used to control smart devices such as lights, speakers, and security systems. Voice assistants can play music, set reminders, or answer questions instantly. AI is also used in communication apps to suggest replies, correct grammar, or translate messages into other languages.\n\nThese tools help people save time and communicate more effectively. However, some people worry that relying too much on AI could reduce real human interaction. Others feel that AI actually helps them stay more connected, especially when communicating across different languages or time zones.`,
    vocab: [
      { word: 'Voice assistants', definition: 'Software that responds to spoken commands, like Siri or Alexa.' },
      { word: 'Instantly', definition: 'Immediately, without any delay.' },
      { word: 'Effectively', definition: 'Successfully achieving the desired result.' },
      { word: 'Relying', definition: 'Depending on something or someone for help or support.' },
    ],
    questions: [
      { n: 4, q: 'How has AI changed the way people communicate?' },
      { n: 5, q: 'Do smart home devices improve quality of life? Why or why not?' },
      { n: 6, q: 'Could AI reduce face-to-face communication in the future?' },
    ],
  },
  {
    number: 3,
    title: 'AI in Work and Education',
    emoji: '💼',
    color: '#f59e0b', // amber
    text: `AI is increasingly used in workplaces to analyze data, automate tasks, and support decision-making. In some jobs, AI handles repetitive work, allowing employees to focus on more creative or complex tasks. In education, AI can personalize learning by adapting lessons to a student's level and learning speed.\n\nDespite these benefits, there are concerns about job loss. Some workers fear that AI may replace human jobs, especially in industries that rely on routine tasks. As a result, many experts believe that learning new skills and adapting to technology will be essential in the future job market.`,
    vocab: [
      { word: 'Automate', definition: 'To use machines or computers to do work that people used to do.' },
      { word: 'Repetitive', definition: 'Happening many times in the same way – boring because it is always the same.' },
      { word: 'Personalize', definition: 'To change something so that it fits a particular person\'s needs.' },
      { word: 'Essential', definition: 'Completely necessary – you cannot do without it.' },
    ],
    questions: [
      { n: 7, q: 'Which jobs do you think AI will change the most?' },
      { n: 8, q: 'Should schools teach students how to work with AI? Why?' },
      { n: 9, q: 'Do you think AI will create more jobs or remove more jobs? Explain.' },
    ],
  },
  {
    number: 4,
    title: 'Ethical Concerns and the Future of AI',
    emoji: '⚖️',
    color: '#ef4444', // red
    text: `As AI becomes more powerful, ethical issues are becoming more important. These include data privacy, fairness, and responsibility. For example, AI systems may collect personal data, raising questions about how this information is stored and used. There is also concern that biased data could lead to unfair decisions.\n\nLooking ahead, AI is expected to play an even bigger role in society. Governments, companies, and individuals will need to work together to ensure that AI is used responsibly. If managed well, AI could greatly improve healthcare, education, and many other areas of life.`,
    vocab: [
      { word: 'Ethical', definition: 'Related to moral principles – what is right and wrong.' },
      { word: 'Privacy', definition: 'The right to keep personal information to yourself.' },
      { word: 'Biased', definition: 'Unfairly supporting one side or showing prejudice.' },
      { word: 'Responsibly', definition: 'In a way that shows good judgment and care for others.' },
    ],
    questions: [
      { n: 10, q: 'What are the biggest risks of using AI in society?' },
      { n: 11, q: 'Who should be responsible for controlling how AI is used?' },
      { n: 12, q: 'Are you optimistic or worried about the future of AI? Why?' },
    ],
  },
]

// ── Shared translate helper (copied from original) ─────────────────
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1/B2 level student practise speaking and discussion skills. The reading topic is "Artificial Intelligence in Everyday Life". The current discussion question is: "${question}". Keep every response to 2 sentences maximum — short and simple. Use easy vocabulary suitable for B2 level. Always end with one simple follow-up question. If the student makes a grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be warm, patient and encouraging.`
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.role === 'assistant' && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    {!m.translation && (
                      <TranslateBtn text={m.content} type="message" lang={translationLang} color={color}
                        onTranslated={(t) => setMessageTranslation(i, t)} />
                    )}
                    {translationLang === 'none' && !m.translation && (
                      <span style={{ color: '#9ca3af', fontSize: '11px' }}>Select a language to translate</span>
                    )}
                  </div>
                )}
                {m.translation && (
      ...
      {listening && (
        <div style={{ padding: '10px 16px 14px', borderTop: '1px solid #fee2e2', background: '#fef2f2' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
            ...
            <button onClick={stopVoice} style={{ background: '#ef4444', color: 'white', border: 'none', padding: '6px 16px', borderRadius: '10px', fontWeight: '800', fontSize: '13px', cursor: 'pointer', boxShadow: '0 2px 8px rgba(239,68,68,0.4)' }}>
              ⏹ Stop & Send
            </button>
          </div>
...
// ── Main Page ─────────────────────────────────────────────────
export default function AIEverydayLifePage() {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          ...
          body: JSON.stringify({
            system: isPhrase
              ? `You are an English dictionary for B1/B2 learners. Respond with ONLY one simple sentence (max 20 words) explaining what the phrase means. Easy vocabulary. No extra text.`
              : `You are an English dictionary for B1/B2 learners. Respond with ONLY one simple sentence (max 15 words) defining this word. Easy vocabulary. No extra text.`,
        ...
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: `You are a language learning assistant for B1/B2 English students. Respond ONLY with valid JSON (no markdown, no backticks): {"definition": "one simple English sentence max 15 words", "translation": "the word/phrase in ${translationLang} with a brief explanation in ${translationLang}, max 25 words"}`,
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(135deg, #0c4a6e 0%, #3b82f6 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(34,197,94,0.7)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Technology & Society</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Artificial Intelligence in Everyday Life</h1>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From voice assistants to smart homes, work, and ethics — explore how AI is reshaping daily life, communication, jobs, and the future of society.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#3b82f6' : '#e5e7eb', background: translationLang !== 'none' ? '#e0f2fe' : 'white', color: translationLang !== 'none' ? '#0369a1' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
          ...
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#e0f2fe', padding: '8px 28px', borderBottom: '1px solid #bae6fd' }}>
              <span style={{ color: '#0369a1', fontSize: '12px', fontWeight: '600' }}>
                ...
                {translationLang !== 'none' && <span style={{ color: '#0c4a6e' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '3px', flexWrap: 'wrap' }}>
                          ...
                          <TranslateBtn
                            ...
                            type="word" lang={translationLang} color={part.color}
