...
const PARTS = [
  {
    number: 1, title: 'A New Kind of Relationship', emoji: '🤝', color: '#6366f1',
    text: `For most of human history, the tools we created were passive — they did exactly what we told them to do and nothing more. A hammer does not decide how hard to strike. A calculator does not choose which numbers to process. A camera does not select what to photograph. The relationship between humans and their tools has always been one of complete and unambiguous control: we think, we decide, we act, and the tool simply executes.\n\nArtificial intelligence is changing this in ways that are both subtle and profound. AI systems today do not merely execute instructions — they generate responses, make recommendations, produce creative work, and in some domains make decisions that their creators cannot fully explain or predict. When a doctor uses an AI diagnostic system that identifies a pattern in a scan that no human radiologist noticed, the relationship between human and tool has fundamentally shifted. The tool is no longer passive. It is contributing something.\n\nThis shift is happening faster than most people anticipated, and it is touching almost every area of human life simultaneously. AI writes code, composes music, translates languages, drives cars, moderates social media, approves loan applications, filters job candidates, and converses with millions of lonely or curious people every day. Each of these applications represents a different kind of relationship between human intelligence and machine intelligence — a different configuration of who is in charge, who is responsible, and who benefits.\n\nUnderstanding the relationship between AI and humans requires us to think carefully about questions we have rarely needed to ask before: What is intelligence? What is creativity? What does it mean to trust a system that cannot explain itself? And what happens to human identity, work, and connection in a world where machines can do an increasing number of the things that once made us feel distinctively human?`,
    vocab: [
      { word: 'Passive', definition: 'Accepting or allowing what happens without taking action or making decisions.' },
      { word: 'Unambiguous', definition: 'Clear and certain — having only one possible meaning or interpretation.' },
      { word: 'Diagnostic', definition: 'Relating to the process of identifying the cause or nature of a problem, especially a medical one.' },
      { word: 'Configuration', definition: 'The arrangement or relationship of the parts of something.' },
    ],
    questions: [
      { n: 1, q: 'The passage says AI is changing our relationship with tools "in ways that are both subtle and profound." Can you give an example of a subtle change and a profound one?' },
      { n: 2, q: 'When a doctor uses an AI that finds something a human missed, who deserves the credit? How does this affect your view of the doctor\'s expertise?' },
      { n: 3, q: 'Of all the things AI does today — writing code, driving cars, approving loans — which do you find most interesting and which most concerning? Why?' },
    ]
  },
  {
    number: 2, title: 'Trust, Dependence, and the Black Box', emoji: '📦', color: '#4f46e5',
    text: `One of the most significant challenges in the human-AI relationship is trust — and specifically, the question of whether we can or should trust systems we do not fully understand. Many of the most powerful AI systems today are what engineers call "black boxes." They take in data, perform complex mathematical operations across billions of parameters, and produce an output. But the exact reasoning behind any particular output — why the system recommended this treatment, rejected this loan application, or flagged this piece of content — is often impossible to reconstruct, even for the engineers who built it.\n\nThis opacity creates a profound tension. We already trust many systems we do not fully understand — aeroplanes, financial markets, medical drugs. But these systems have been tested, regulated, and validated over long periods. AI is being deployed at extraordinary speed, in sensitive domains, with relatively limited testing and regulation. When a credit-scoring algorithm systematically disadvantages people from certain postcodes, or a hiring algorithm turns out to have learned to discriminate against women, the harm can be widespread before it is even detected.\n\nThe question of dependence is equally important. There is substantial evidence that human beings, when working alongside AI systems that perform well, begin to defer to those systems even in cases where their own judgement should take precedence. This is called automation bias — the tendency to over-trust automated recommendations and under-apply human critical thinking. Studies have found this effect even in highly trained professionals: pilots, radiologists, and judges have all been shown to accept AI outputs without adequate scrutiny in some circumstances.\n\nAt the same time, dependence can be beneficial. A surgeon who trusts a robotic system to make more precise incisions than human hands can manage is extending their capability, not abdicating their judgement. The challenge is to develop a relationship with AI that captures the benefits of its capabilities without surrendering the human oversight that remains essential — particularly in high-stakes decisions affecting real people's lives.`,
    vocab: [
      { word: 'Opacity', definition: 'The quality of being difficult to understand or see through; a lack of transparency or clarity.' },
      { word: 'Validated', definition: 'Proven to be accurate, effective, or reliable through careful testing and evidence.' },
      { word: 'Automation bias', definition: 'The tendency to over-trust automated systems and reduce one\'s own critical thinking as a result.' },
      { word: 'Abdicating', definition: 'Giving up a responsibility or duty that should be yours — failing to take responsibility.' },
    ],
    questions: [
      { n: 4, q: 'The passage distinguishes between trusting aeroplanes (tested over decades) and trusting new AI systems. Is this a fair comparison? What makes AI different?' },
      { n: 5, q: 'Have you ever accepted a recommendation from an app or system without questioning it? Looking back, was that the right decision?' },
      { n: 6, q: 'Where do you think the line should be between beneficial AI dependence and dangerous automation bias? Can you think of a concrete example of each?' },
    ]
  },
  {
    number: 3, title: 'Work, Identity, and What Remains Human', emoji: '🧠', color: '#4338ca',
    text: `Few questions generate more anxiety about AI than the question of work. For most of human history, the things machines replaced were physical tasks — lifting, carrying, repetitive assembly. The implicit assumption was that mental work — creativity, judgement, communication, emotional intelligence — was safe, because these were the things that only humans could do. AI is now challenging that assumption directly.\n\nLarge language models can write convincing essays, generate working code, compose music in almost any style, and produce images indistinguishable from professional photography. AI legal tools can review contracts faster and more thoroughly than junior lawyers. AI accounting tools can detect irregularities in financial data that human auditors routinely miss. The list of cognitive tasks where AI performs at or above human level is growing rapidly, and the pace of that growth shows no signs of slowing.\n\nEconomists and technologists are sharply divided on what this means for employment. Optimists argue that new technology always destroys some jobs and creates others — that AI will automate the dull and dangerous tasks while freeing humans to focus on more creative, meaningful, and interpersonal work. Pessimists point out that previous technological revolutions displaced workers gradually, giving societies time to adapt. The speed and breadth of AI's capabilities may not allow for the same gradual transition.\n\nBut the impact of AI on human identity goes beyond economics. Many people derive a significant part of their sense of self from what they are good at — their expertise, their craft, their professional judgement. When an AI system performs those tasks better, or as well, the psychological impact can be destabilising in ways that go beyond the practical question of employment. A radiologist who has spent fifteen years learning to read scans with extraordinary skill may feel something more than economic anxiety when an AI matches or exceeds their accuracy. They may feel, at some level, that something about their identity has been challenged.`,
    vocab: [
      { word: 'Implicit', definition: 'Suggested or understood without being directly stated; not explicitly expressed.' },
      { word: 'Irregularities', definition: 'Things that are unusual, unexpected, or do not follow the expected pattern — often suggesting a problem.' },
      { word: 'Breadth', definition: 'The wide range or extent of something; how many different areas something covers.' },
      { word: 'Destabilising', definition: 'Making something less secure, certain, or settled; disturbing something that was previously stable.' },
    ],
    questions: [
      { n: 7, q: 'The passage says the assumption that "mental work is safe" is being challenged. Which cognitive ability do you think AI will find hardest to replicate? Why?' },
      { n: 8, q: 'How do you think the relationship between humans and work will need to change as AI becomes more capable? What would a healthy adjustment look like?' },
      { n: 9, q: 'The passage says AI challenges not just employment but identity. Have you ever defined yourself by something you are good at? How would you feel if a machine could do it better?' },
    ]
  },
  {
    number: 4, title: 'Towards a Partnership', emoji: '🌐', color: '#3730a3',
    text: `Despite the anxieties that surround it, the relationship between AI and humans is not necessarily — or even primarily — one of competition or replacement. Many of the most thoughtful researchers working in this field argue that the most powerful and desirable outcome is not AI that surpasses human intelligence and operates independently, but AI that amplifies human intelligence and operates in genuine partnership.\n\nThe evidence for this view comes from domains where human-AI collaboration has already proven superior to either humans or AI working alone. In chess, human-AI teams have consistently outperformed both the strongest human grandmasters and the most powerful chess engines. In medical diagnosis, studies have found that AI paired with human doctors catches more errors than either makes independently. In scientific research, AI systems that can rapidly identify patterns across vast datasets are enabling human scientists to generate hypotheses and design experiments that would not have been conceivable without machine assistance.\n\nWhat these examples suggest is that the most productive framing of the human-AI relationship is one of complementarity rather than competition — each party contributing what the other lacks. AI brings speed, scale, consistency, and the ability to identify patterns in data too large for any human to process. Humans bring contextual judgement, ethical reasoning, emotional intelligence, the ability to navigate ambiguity, and — perhaps most importantly — accountability. A human being can be held responsible for a decision in a way that an algorithm cannot.\n\nThe relationship between AI and humans is still being negotiated. The norms, laws, and cultural understandings that will govern it are still being written. This makes the present moment genuinely important — not just for technologists and policymakers, but for everyone who will live and work in the world that AI is helping to create. The choices made now about how to develop, deploy, and constrain AI will shape the relationship between human and machine intelligence for generations. And unlike most historical transitions, this one is happening fast enough that many of the people making those choices — and most of the people affected by them — are alive today.`,
    vocab: [
      { word: 'Amplifies', definition: 'Makes something stronger, louder, or more powerful than it was before.' },
      { word: 'Complementarity', definition: 'The quality of two things that work well together because each has what the other lacks.' },
      { word: 'Accountability', definition: 'The fact of being responsible for decisions and actions, and expected to explain them if asked.' },
      { word: 'Constrain', definition: 'To limit or restrict something, keeping it within certain boundaries.' },
    ],
    questions: [
      { n: 10, q: 'The passage argues that human-AI collaboration is often better than either alone. Do you find this argument convincing? Can you think of a case where you would prefer only human decision-making?' },
      { n: 11, q: 'The passage says humans bring "accountability" that algorithms cannot. Do you think this is enough reason to keep humans in the loop on important decisions? What are the limits of this argument?' },
      { n: 12, q: 'The passage ends by saying the choices made now will "shape the relationship between human and machine intelligence for generations." What is the most important choice you think needs to be made — and who should make it?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Relationship Between AI and Humans</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Trust, dependence, identity, and partnership — how the rise of artificial intelligence is reshaping what it means to be human, to work, and to make decisions.</p>
            </div>
          </div>
