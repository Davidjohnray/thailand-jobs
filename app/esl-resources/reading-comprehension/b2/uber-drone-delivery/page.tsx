...
const PARTS = [
  {
    number: 1, title: 'Your Food Is Flying', emoji: '🛩️', color: '#dc2626',
    text: `Uber Eats announced this week that it will begin testing autonomous drone delivery in select US cities before the end of 2026. If successful, the service would allow customers to receive food deliveries by drone within 10 minutes of ordering — faster than any human driver could manage.\n\nThe drones, developed in partnership with an aviation technology company, are small electric aircraft about the size of a large suitcase. They can carry meals weighing up to 2.5 kilograms, fly at speeds of approximately 65 kilometres per hour, and navigate autonomously using GPS, cameras, and obstacle-avoidance sensors. Upon arrival, the drone descends to a safe height and lowers the package on a cable — the drone itself never touches the ground.\n\nThe technology is not entirely new. Wing, a subsidiary of Alphabet (Google\'s parent company), has been operating commercial drone delivery in parts of Australia, Finland, and the United States since 2019. Amazon has tested drone delivery in Texas. And in Rwanda, drones have been delivering medical supplies — blood, vaccines, and medications — to remote clinics since 2016.\n\nBut Uber\'s entry into drone delivery represents a significant escalation. Uber has more than 130 million active users worldwide and delivers more than 15 million meals per day. If even a fraction of those deliveries shift to drones, it would represent the largest deployment of autonomous aircraft in history — and a fundamental transformation of how cities function.`,
    vocab: [
      { word: 'Autonomous', definition: 'Operating independently without human control — making decisions on its own.' },
      { word: 'Obstacle-avoidance', definition: 'Technology that detects objects in the path and automatically changes course to avoid them.' },
      { word: 'Subsidiary', definition: 'A company owned or controlled by a larger parent company.' },
      { word: 'Escalation', definition: 'A significant increase in scale — making something much bigger or more intense.' },
    ],
    questions: [
      { n: 1, q: 'Food delivered by drone in 10 minutes. Is this a genuine improvement in people\'s lives, or unnecessary convenience?' },
      { n: 2, q: 'Rwanda uses drones to deliver blood and vaccines. Is this a better use of drone technology than food delivery?' },
      { n: 3, q: 'Uber delivers 15 million meals a day. What would it mean for cities if even a fraction of those were by drone?' },
    ]
  },
  {
    number: 2, title: 'The Last Mile Problem', emoji: '📦', color: '#b91c1c',
    text: `Drone delivery is not just about speed — it is about solving one of the most expensive and inefficient problems in modern logistics: the "last mile."\n\nThe last mile refers to the final leg of a delivery — from a distribution hub to your front door. It is, paradoxically, both the shortest and the most expensive part of the supply chain. While a container ship can transport goods across the Pacific Ocean for pennies per kilogram, getting those same goods from a local warehouse to your house costs several dollars — accounting for up to 53% of total shipping costs.\n\nThe reason is simple: the last mile requires a human driver, a vehicle, and navigation through residential streets with traffic, parking, and access challenges. A single delivery driver might complete only 20-30 deliveries per shift, spending much of their time stuck in traffic or searching for addresses.\n\nDrones solve many of these problems. They fly above traffic. They navigate directly to GPS coordinates. They require no driver, no vehicle, and no parking. A single drone can complete a delivery in minutes and return to base for the next one. The cost per delivery could eventually fall below one dollar — compared to five to ten dollars for a human driver.\n\nBut the last mile problem is not just logistical — it is also a labour problem. Millions of people worldwide work as delivery drivers. Uber alone has approximately 7 million drivers and couriers. If drones replace a significant portion of these deliveries, what happens to the people whose livelihoods depend on driving?`,
    vocab: [
      { word: 'Last mile', definition: 'The final leg of delivery from a local hub to the customer — the most expensive part.' },
      { word: 'Logistics', definition: 'The planning and organisation of complex operations — moving goods efficiently.' },
      { word: 'Paradoxically', definition: 'In a way that seems contradictory — the opposite of what you would expect.' },
      { word: 'Livelihoods', definition: 'How people earn money to support themselves — their source of income.' },
    ],
    questions: [
      { n: 4, q: 'The last mile accounts for 53% of shipping costs. Why is the shortest part of the journey the most expensive?' },
      { n: 5, q: 'Drone delivery could cost less than one dollar per trip. What would this mean for the delivery industry?' },
      { n: 6, q: 'Millions of people work as delivery drivers. Should companies be required to retrain workers they replace with drones?' },
    ]
  },
  {
    number: 3, title: 'Drones Over Your Head', emoji: '🏙️', color: '#991b1b',
    text: `The prospect of thousands of delivery drones buzzing over residential neighbourhoods raises concerns that go beyond economics.\n\nNoise is the most immediate issue. While individual drones are quieter than cars, the cumulative effect of hundreds of drones operating simultaneously in an urban area could create a persistent background buzz that residents find unacceptable. Studies in Australia — where Wing\'s drone delivery service has been operating for several years — have documented significant community complaints about noise, with some residents describing the sound as "like a swarm of angry bees."\n\nPrivacy is another concern. Delivery drones carry cameras for navigation and obstacle avoidance. These cameras can inadvertently capture images of private properties, people in their gardens, and activities that residents would prefer to keep private. While companies insist that camera data is not stored or shared, the mere presence of camera-equipped drones overhead creates a sense of surveillance.\n\nSafety must be addressed. What happens when a drone malfunctions over a busy street? What happens when two drones collide? What happens when a drone drops its payload? Aviation authorities are developing regulations, but the technology is advancing faster than the regulatory framework.\n\nAnd there is the question of equity. Drone delivery will initially serve wealthier neighbourhoods with open spaces for drone landing. Dense urban areas — apartment blocks, narrow streets, communities without gardens — may not benefit. If drone delivery becomes the fast, cheap option while human delivery becomes the slow, expensive one, the result could be a two-tier system that disadvantages communities that are already underserved.`,
    vocab: [
      { word: 'Cumulative', definition: 'Building up gradually — the total effect of many small things added together.' },
      { word: 'Inadvertently', definition: 'Without intending to — accidentally or unintentionally.' },
      { word: 'Regulatory framework', definition: 'The system of rules and laws that governs an industry or activity.' },
      { word: 'Two-tier', definition: 'A system with two levels of quality — better service for some and worse for others.' },
    ],
    questions: [
      { n: 7, q: 'Residents compare drone noise to angry bees. Would you accept drone noise for faster delivery?' },
      { n: 8, q: 'Drones with cameras fly over private properties. Is this an acceptable trade-off for convenience?' },
      { n: 9, q: 'Drone delivery may serve wealthy areas first. How can new technology be deployed equitably?' },
    ]
  },
  {
    number: 4, title: 'The Automated Future', emoji: '🤖', color: '#7f1d1d',
    text: `Drone delivery is not an isolated development — it is part of a broader trend toward automation that will reshape economies and societies in the coming decades.\n\nSelf-driving trucks are being tested on highways. Robotic warehouses can process orders without human workers. Automated checkout systems are replacing cashiers. And now, drones are coming for delivery drivers. Each of these technologies promises greater efficiency, lower costs, and faster service. Each also threatens the livelihoods of millions of workers.\n\nThe optimistic view is that automation will create as many jobs as it destroys — just different ones. New industries will emerge around drone maintenance, air traffic management, and logistics software. People freed from routine delivery work will find more creative, fulfilling employment.\n\nThe pessimistic view is that this time is different. Previous waves of automation replaced physical labour with machines but created new jobs requiring cognitive skills. This wave of automation — powered by AI — is replacing cognitive tasks too. If machines can drive, deliver, stock shelves, and process orders, what is left for the workers who used to do these things?\n\nThe honest answer is that nobody knows. The scale and speed of automation are unprecedented. Societies that manage the transition well — through education, retraining, social safety nets, and policies that share the benefits of automation broadly — will thrive. Those that allow the benefits to concentrate among technology owners while the costs fall on displaced workers will face social instability.\n\nA drone delivering your lunch in 10 minutes is convenient. The question is whether the society that builds these drones is also building the systems to ensure that everyone benefits — not just the people placing the orders.`,
    vocab: [
      { word: 'Automation', definition: 'Using machines and technology to perform tasks previously done by humans.' },
      { word: 'Cognitive', definition: 'Relating to thinking, reasoning, and mental processes.' },
      { word: 'Displaced', definition: 'Pushed out of a job or position — replaced by something else.' },
      { word: 'Social safety nets', definition: 'Government programmes that protect people who lose jobs or income — unemployment benefits, retraining.' },
    ],
    questions: [
      { n: 10, q: 'Previous automation created new jobs. Will AI-powered automation do the same, or is this time different?' },
      { n: 11, q: 'Who should benefit from automation — the companies that build it, the workers it replaces, or society as a whole?' },
      { n: 12, q: 'A drone delivers your lunch in 10 minutes. Is this progress? What does progress actually mean?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Uber Eats Drone Delivery Is Coming". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Uber Eats Drone Delivery Is Coming</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Uber will test autonomous drone delivery this year — food in 10 minutes. The last mile problem, drones over your head, and the automated future.</p>
            </div>
          </div>
