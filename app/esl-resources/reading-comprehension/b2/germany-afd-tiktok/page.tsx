...
const PARTS = [
  {
    number: 1, title: 'The Algorithm Governor', emoji: '📱', color: '#dc2626',
    text: `Germany is facing one of the most significant political moments since World War II. The Alternative for Germany party — known as the AfD — is poised to win a state election in Saxony-Anhalt that could produce the country\'s first far-right governor since the Nazi era.\n\nThe AfD\'s rise has been fuelled by an unlikely weapon: TikTok. While established parties campaign through traditional media, town halls, and newspaper interviews, the AfD has built a massive following on the platform, reaching young voters with short, emotionally charged videos that bypass traditional media gatekeepers entirely.\n\nThe party\'s TikTok strategy is sophisticated. Videos feature young, charismatic candidates speaking directly to camera about immigration, cost of living, and national identity — themes that resonate with voters who feel left behind by Germany\'s political establishment. The content is designed for maximum engagement: provocative, emotional, and shareable.\n\nGermany\'s other parties have been slow to respond. The Social Democrats, Greens, and Christian Democrats — all of whom have governed Germany in various combinations for decades — maintain a presence on social media but lack the AfD\'s understanding of how platforms like TikTok shape political opinion. By the time they recognised the threat, the AfD had already built an audience of millions.`,
    vocab: [
      { word: 'Far-right', definition: 'Political positions that are extremely conservative — often nationalist and anti-immigration.' },
      { word: 'Gatekeepers', definition: 'People or organisations that control access to information — editors, journalists, fact-checkers.' },
      { word: 'Charismatic', definition: 'Having a compelling charm that inspires devotion — naturally attractive and persuasive.' },
      { word: 'Establishment', definition: 'The existing power structure — the people and institutions that have traditionally held power.' },
    ],
    questions: [
      { n: 1, q: 'A far-right party is winning elections through TikTok. How does social media change who wins political power?' },
      { n: 2, q: 'Traditional parties were slow to respond to TikTok campaigning. Why do established institutions struggle with new technology?' },
      { n: 3, q: 'Germany could get its first far-right governor since WWII. Why is this historically significant?' },
    ]
  },
  {
    number: 2, title: 'Why Germany Is Different', emoji: '📜', color: '#b91c1c',
    text: `The rise of the far right in Germany carries a weight that it does not in most other countries. Germany\'s history — the Nazi regime, the Holocaust, and World War II — has created a political culture in which far-right movements are treated with extraordinary caution.\n\nAfter 1945, Germany undertook a process called Vergangenheitsbewaltigung — literally "coming to terms with the past." The country acknowledged its crimes, built memorials, taught the Holocaust in schools, and created legal and constitutional frameworks designed to prevent the return of fascism. Symbols of Nazism were banned. Hate speech laws were strengthened. And a political consensus emerged that the far right was beyond the boundaries of acceptable politics.\n\nThe AfD is testing those boundaries. The party — founded in 2013 originally as an anti-Euro economic party — has shifted increasingly rightward. Some of its leaders have been classified by Germany\'s domestic intelligence agency as suspected extremists. Party members have made statements minimising the Holocaust and calling for a "180-degree turn" in how Germany remembers its past.\n\nFor many Germans, the AfD\'s rise is not just politically concerning — it is existentially threatening. The country\'s post-war identity was built on the promise of "never again." If a far-right party governs a German state for the first time since 1945, what does that say about whether the promise has been kept?`,
    vocab: [
      { word: 'Holocaust', definition: 'The systematic murder of six million Jews by Nazi Germany during World War II.' },
      { word: 'Fascism', definition: 'A political system characterised by extreme nationalism, authoritarianism, and suppression of opposition.' },
      { word: 'Extremists', definition: 'People with political views far outside the mainstream — often willing to use radical methods.' },
      { word: 'Existentially', definition: 'Relating to fundamental existence — threatening the core identity of something.' },
    ],
    questions: [
      { n: 4, q: 'Germany built its post-war identity on "never again." Is this promise being broken?' },
      { n: 5, q: 'Some AfD leaders minimise the Holocaust. Why is this especially dangerous in Germany compared to other countries?' },
      { n: 6, q: 'Should intelligence agencies be allowed to classify political parties as extremist? What are the risks of doing so — and of not doing so?' },
    ]
  },
  {
    number: 3, title: 'TikTok and the Death of Gatekeepers', emoji: '🔓', color: '#991b1b',
    text: `The AfD\'s TikTok success is part of a global pattern: populist and far-right movements are consistently better at using social media than established parties and mainstream institutions.\n\nThe reasons are structural. Social media algorithms reward content that generates strong emotional reactions — and populist messaging is inherently more emotional than centrist policy discussion. A video about "invaders stealing your jobs" generates more engagement than a video about "evidence-based approaches to labour market integration." The algorithm does not care about truth — it cares about clicks.\n\nTraditional media acted as a filter — journalists fact-checked claims, editors decided which stories were important, and the public received information that had been vetted by professionals. Social media removes this filter entirely. Anyone can say anything to millions of people, and the platform\'s algorithm will amplify it if it generates engagement.\n\nThis is not inherently bad. Social media has given voice to movements that traditional media ignored — from the Arab Spring to climate activism to racial justice campaigns. But it has also given voice to misinformation, conspiracy theories, and political extremism — often amplified by algorithms that prioritise engagement over accuracy.\n\nThe AfD\'s TikTok strategy raises a fundamental question about democracy in the digital age: if the platform that shapes how millions of young people understand politics rewards emotional manipulation over factual debate, what kind of politics will result?`,
    vocab: [
      { word: 'Populist', definition: 'Appealing to ordinary people by claiming to represent their concerns against an out-of-touch elite.' },
      { word: 'Algorithms', definition: 'Mathematical rules that platforms use to decide which content to show users.' },
      { word: 'Vetted', definition: 'Carefully checked and verified — examined for accuracy before publication.' },
      { word: 'Manipulation', definition: 'Controlling or influencing someone unfairly — using tricks to shape their opinions.' },
    ],
    questions: [
      { n: 7, q: 'Algorithms reward emotional content over factual content. How does this advantage populist parties?' },
      { n: 8, q: 'Traditional media filtered information. Social media removes the filter. Which system is better for democracy?' },
      { n: 9, q: 'Should platforms be responsible for the political consequences of their algorithms?' },
    ]
  },
  {
    number: 4, title: 'The European Pattern', emoji: '🌍', color: '#7f1d1d',
    text: `Germany is not alone. Across Europe, far-right parties are gaining ground — winning elections, entering governments, and reshaping the political landscape in ways that would have been unthinkable a decade ago.\n\nIn France, Marine Le Pen\'s National Rally has become the largest party in parliament. In Italy, Giorgia Meloni governs as the country\'s first far-right prime minister since World War II. In the Netherlands, Geert Wilders\' PVV leads the government coalition. In Austria, Sweden, and Finland, far-right parties are in government or supporting governing coalitions.\n\nThe drivers are consistent across countries: anxiety about immigration, economic insecurity, cultural change, and a sense that mainstream parties have failed to address ordinary people\'s concerns. Far-right parties offer simple answers to complex problems — close the borders, protect national identity, put our people first. These messages resonate when people feel insecure.\n\nThe question is what happens when far-right parties gain power. Do they moderate their positions and govern pragmatically? Or do they implement the radical agendas they campaigned on? The evidence so far is mixed — some far-right leaders have moderated in office while others have pursued authoritarian policies that undermine democratic institutions.\n\nGermany\'s Saxony-Anhalt election will be watched across Europe as a test case. If the country that built its entire post-war identity on rejecting the far right elects a far-right governor, the symbolic impact will extend far beyond Germany\'s borders. It will signal that the political taboos established after World War II are eroding — and that the promise of "never again" may need to be fought for once more.`,
    vocab: [
      { word: 'Coalition', definition: 'An alliance of political parties that govern together — sharing power.' },
      { word: 'Moderate', definition: 'To become less extreme — moving toward the centre from a radical position.' },
      { word: 'Pragmatically', definition: 'In a practical, realistic way — focusing on what works rather than ideology.' },
      { word: 'Taboos', definition: 'Things that are socially forbidden — actions or ideas that society considers unacceptable.' },
    ],
    questions: [
      { n: 10, q: 'Far-right parties are gaining power across Europe. Is this a temporary trend or a permanent shift?' },
      { n: 11, q: 'Do far-right parties moderate when they gain power, or become more radical? What evidence exists?' },
      { n: 12, q: 'The promise of "never again" may need to be fought for. How do democracies protect themselves from authoritarian movements?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Germany Far-Right AfD Rises to Power on TikTok". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function GermanyAfdPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Germany Far-Right AfD Rises to Power on TikTok</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Germany could get its first far-right state governor since World War II, fuelled by TikTok. How social media is reshaping European politics and why history is watching.</p>
            </div>
          </div>
