...
const PARTS = [
  {
    number: 1, title: 'The Trees That Need to Burn', emoji: '🌲', color: '#dc2626',
    text: `Giant sequoias are the largest living things on Earth. Some stand more than 80 metres tall and have trunks wider than a bus. They can live for more than 3,000 years. They have survived ice ages, droughts, earthquakes, and countless ordinary fires. But recent extreme wildfires have killed thousands of sequoias that had survived for millennia — and this week, a new study revealed a counterintuitive solution: the best way to save these ancient trees may be to burn more of them.\n\nThe research, based on analysis of approximately 26,400 giant sequoias across their native range in California's Sierra Nevada mountains, found that trees in areas that had experienced regular, low-intensity fires were significantly more likely to survive extreme wildfires than trees in areas where fire had been suppressed.\n\nThe reason is ecological. Giant sequoias evolved with fire. Their bark — which can be more than 60 centimetres thick — is designed to withstand ordinary fires. Their cones actually require heat to open and release seeds. Fire clears the forest floor of dead wood and competing vegetation, creating the open, sunlit conditions that young sequoias need to grow. For sequoias, fire is not the enemy — it is an essential partner.\n\nThe problem is that for most of the 20th century, the United States followed a policy of total fire suppression — putting out every fire as quickly as possible. This seemed logical, but it had devastating unintended consequences: decades of dead wood and dry vegetation accumulated on the forest floor, creating fuel loads that turned ordinary fires into catastrophic infernos.`,
    vocab: [
      { word: 'Counterintuitive', definition: 'The opposite of what you would logically expect — surprising because it goes against common sense.' },
      { word: 'Suppressed', definition: 'Forcibly stopped or prevented — in this case, putting out all fires.' },
      { word: 'Ecological', definition: 'Relating to the relationships between living things and their environment.' },
      { word: 'Fuel loads', definition: 'The amount of flammable material available to burn — dead wood, dry leaves, and vegetation.' },
    ],
    questions: [
      { n: 1, q: 'The best way to save trees from fire is to burn them. Why is this so counterintuitive? Does it make sense when explained?' },
      { n: 2, q: 'Sequoias evolved with fire — their bark resists it and their cones need heat. What does this tell us about the relationship between species and their environment?' },
      { n: 3, q: 'Fire suppression for decades made fires worse. Can you think of other examples where preventing a natural process caused bigger problems?' },
    ]
  },
  {
    number: 2, title: 'When Good Intentions Go Wrong', emoji: '🔥', color: '#b91c1c',
    text: `The story of fire suppression in American forests is a cautionary tale about the unintended consequences of well-meaning human intervention in natural systems.\n\nBefore European colonisation, forests across North America were regularly burned — both by natural lightning strikes and by Indigenous peoples who used fire as a land management tool. These frequent, low-intensity fires kept the forest floor clear, prevented the buildup of dead wood, and maintained the open, park-like structure that characterised many pre-colonial forests.\n\nWhen the US Forest Service was established in 1905, it adopted a policy of suppressing all wildfires. The motivation was understandable: fires destroyed timber, threatened communities, and killed people. The "10 AM policy," adopted in 1935, required that every fire be controlled by 10 AM the morning after it was reported. For decades, this policy was considered a success — fire damage declined, and the forests appeared to thrive.\n\nBut the forests were not thriving. They were accumulating fuel. Without regular fire to clear the understory, dead wood piled up. Young trees grew densely, creating ladder fuels that could carry fire from the ground to the canopy. The forests became powder kegs — primed for the kind of catastrophic, high-intensity fires that sequoias, despite their thick bark, cannot survive.\n\nThe extreme wildfires of recent years — including the 2020 Castle Fire, which killed an estimated 10,000 large sequoias — are the direct result of a century of fire suppression combined with climate change. The trees that survived for 3,000 years could not survive the conditions that human policies created.`,
    vocab: [
      { word: 'Cautionary tale', definition: 'A story that serves as a warning — showing what happens when things go wrong.' },
      { word: 'Understory', definition: 'The layer of vegetation beneath the main canopy of a forest — smaller trees, shrubs, and dead wood.' },
      { word: 'Ladder fuels', definition: 'Vegetation that allows fire to climb from the ground to the treetops — connecting the forest floor to the canopy.' },
      { word: 'Powder keg', definition: 'A dangerous situation that could explode at any moment — ready to ignite.' },
    ],
    questions: [
      { n: 4, q: 'Indigenous peoples burned forests for thousands of years. Why did the US government stop this practice? What was lost?' },
      { n: 5, q: 'The forest looked healthy but was accumulating fuel. How can something appear successful while actually creating future disaster?' },
      { n: 6, q: '10,000 large sequoias died in one fire after surviving 3,000 years. What does this loss mean for the planet?' },
    ]
  },
  {
    number: 3, title: 'Prescribed Fire Returns', emoji: '🪵', color: '#991b1b',
    text: `The new study adds to growing scientific consensus that prescribed burning — deliberately setting controlled fires — is the most effective tool for protecting sequoia groves and fire-adapted forests in general.\n\nPrescribed burns are carefully planned operations. Fire managers select weather conditions — low wind, moderate humidity, appropriate temperature — that allow fire to burn at low intensity. They create firebreaks around the target area. They monitor the burn constantly and are prepared to suppress it if conditions change. The goal is to replicate the natural fire cycle that maintained forest health for millennia.\n\nThe results are dramatic. In sequoia groves that have received prescribed burns, the forest floor is clear of excessive fuel. Trees are more widely spaced. Young sequoias receive the sunlight they need. And when a wildfire does arrive — as it inevitably will — it burns at lower intensity and causes far less damage.\n\nBut prescribed burning faces significant obstacles. Smoke from controlled burns affects air quality in nearby communities, triggering complaints and sometimes legal challenges. The window of weather conditions suitable for prescribed burns is narrow and unpredictable. Liability concerns make land managers risk-averse — if a prescribed burn escapes control and damages property, the consequences can be severe. And the cultural assumption that all fire is bad remains deeply embedded in public attitudes.\n\nSome Indigenous communities are leading the return to traditional fire practices. In California, the Karuk and Yurok tribes have been advocating for — and conducting — cultural burns that maintain the landscapes their ancestors managed for centuries. Their knowledge, accumulated over generations, is proving more effective than modern fire science arrived at independently.`,
    vocab: [
      { word: 'Prescribed burns', definition: 'Controlled fires set deliberately by experts to reduce fuel and improve forest health.' },
      { word: 'Consensus', definition: 'General agreement among experts — a position that most scientists support.' },
      { word: 'Liability', definition: 'Legal responsibility for damage — being legally accountable if something goes wrong.' },
      { word: 'Risk-averse', definition: 'Unwilling to take risks — preferring safe options even if they are less effective.' },
    ],
    questions: [
      { n: 7, q: 'Prescribed burning works but faces opposition from communities worried about smoke. How do you balance forest health with air quality?' },
      { n: 8, q: 'Indigenous burning knowledge is proving more effective than modern fire science. What does this tell us about traditional knowledge?' },
      { n: 9, q: 'Land managers fear liability if a prescribed burn escapes. Does fear of lawsuits prevent good decisions? How can this be fixed?' },
    ]
  },
  {
    number: 4, title: 'Lessons from the Giants', emoji: '🌎', color: '#7f1d1d',
    text: `The giant sequoia story is about more than trees. It is about the relationship between humans and natural systems — and the consequences of assuming we know better than nature.\n\nFor millennia, forests managed themselves through fire. Ecosystems evolved with disturbance — fire, flood, drought, storm — as essential components. These disturbances were not disasters; they were maintenance. Fire cleared dead wood. Floods refreshed river ecosystems. Storms created gaps in the canopy that allowed new growth. The systems were dynamic, resilient, and self-regulating.\n\nHuman intervention disrupted this balance. Fire suppression, river damming, wetland drainage, and intensive agriculture all attempted to control natural processes that ecosystems depended on. In many cases, the short-term benefits — fewer fires, more farmland, controlled water — came at the cost of long-term resilience. The systems became more fragile, more dependent on continued human management, and more vulnerable to catastrophic failure.\n\nThe lesson applies far beyond forestry. In medicine, the overuse of antibiotics has created resistant bacteria. In agriculture, monoculture farming has depleted soils and increased vulnerability to pests. In economics, the suppression of small recessions may create conditions for larger financial crises. In each case, the pattern is the same: suppressing natural variability creates the conditions for catastrophic events.\n\nThe giant sequoias have survived for 3,000 years by being resilient, not by being protected. The best thing we can do for them — and for many of the natural systems we depend on — is not to shield them from disturbance but to restore the natural cycles of disturbance that made them strong.`,
    vocab: [
      { word: 'Dynamic', definition: 'Constantly changing and active — not static or fixed.' },
      { word: 'Self-regulating', definition: 'Able to maintain balance without outside control — adjusting naturally.' },
      { word: 'Monoculture', definition: 'Growing only one type of crop over a large area — lacking diversity.' },
      { word: 'Variability', definition: 'Natural fluctuations and changes — the normal ups and downs of a system.' },
    ],
    questions: [
      { n: 10, q: 'Suppressing fire, floods, and small recessions can create bigger disasters later. Can you think of other examples of this pattern?' },
      { n: 11, q: 'The passage says natural disturbances are maintenance, not disasters. Does this change how you think about fire, floods, or storms?' },
      { n: 12, q: 'The sequoias survived 3,000 years through resilience, not protection. What can human societies learn from this?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Giant Sequoias Need More Fire</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Trees that survived 3,000 years are dying because we stopped the fires they need. Prescribed burning, indigenous knowledge, and what nature teaches about resilience.</p>
            </div>
          </div>
