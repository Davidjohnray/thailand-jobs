...
const PARTS = [
  {
    number: 1, title: 'Blood for Oil', emoji: '🛢️', color: '#dc2626',
    text: `President Trump announced this week what he called "the greatest energy deal in American history" — an agreement giving the United States majority control over more than 65 billion barrels of Venezuelan oil reserves. The deal, signed with Venezuela\'s US-backed interim president, promises to lower American energy costs while bringing foreign investment to a country ravaged by decades of economic collapse.\n\nBut the deal is far more controversial than the White House suggests. Critics describe it as neo-colonialism — a powerful country extracting resources from a weaker one under terms that overwhelmingly favour the extractor. Venezuelan opposition groups have called it a "fire sale" of the nation\'s most valuable asset. And the US oil industry itself is sceptical, given its painful history in Venezuela.\n\nVenezuela has the largest proven oil reserves in the world — larger even than Saudi Arabia\'s. But the country\'s oil industry has been in decline for decades, devastated by mismanagement under Hugo Chavez and Nicolas Maduro, international sanctions, and chronic underinvestment. Production has fallen from more than 3 million barrels per day in the late 1990s to less than 800,000 today.\n\nThe deal promises to reverse this decline by bringing American technology, expertise, and capital to Venezuela\'s oil fields. In exchange, the US would receive preferential access to Venezuelan crude at below-market prices. For Trump, the deal supports his promise to lower petrol prices for American consumers. For Venezuela\'s interim government, it provides desperately needed revenue.`,
    vocab: [
      { word: 'Neo-colonialism', definition: 'When powerful countries control weaker ones economically rather than through direct military occupation.' },
      { word: 'Interim', definition: 'Temporary — holding a position until a permanent replacement is decided.' },
      { word: 'Preferential', definition: 'Giving special advantages or priority over others — favourable treatment.' },
      { word: 'Crude', definition: 'Unprocessed oil as it comes from the ground — before refining into petrol or other products.' },
    ],
    questions: [
      { n: 1, q: 'Is this deal economic partnership or neo-colonialism? What distinguishes a fair deal from exploitation?' },
      { n: 2, q: 'Venezuela has the largest oil reserves on Earth but is one of the poorest countries. How is this possible?' },
      { n: 3, q: 'Trump says the deal will lower US petrol prices. Should domestic energy costs justify foreign policy decisions?' },
    ]
  },
  {
    number: 2, title: 'Venezuela\'s Collapse', emoji: '📉', color: '#b91c1c',
    text: `To understand why Venezuela agreed to this deal, you need to understand the scale of the country\'s collapse.\n\nIn the 1970s and 1980s, Venezuela was the richest country in South America. Its oil wealth funded generous social programmes, modern infrastructure, and a middle class that was the envy of the continent. Caracas was called "the Paris of Latin America." Venezuelans travelled the world, studied at top universities, and enjoyed a standard of living comparable to parts of southern Europe.\n\nThen everything fell apart. Hugo Chavez, who came to power in 1999, nationalised the oil industry, expelled foreign companies, and used oil revenues to fund social programmes while neglecting the infrastructure needed to maintain production. When oil prices collapsed in 2014, the economy — which depended on oil for 95% of export revenue — collapsed with it.\n\nThe result was one of the worst humanitarian crises in modern Latin American history. Hyperinflation made the currency worthless. More than 7 million Venezuelans — roughly a quarter of the population — fled the country. Those who remained faced shortages of food, medicine, and basic goods. Hospitals ran without electricity. Children died of malnutrition in a country sitting on top of the world\'s largest oil reserves.\n\nIt is against this backdrop that the US oil deal must be understood. Venezuela is not negotiating from a position of strength — it is negotiating from desperation. And desperate negotiations rarely produce fair outcomes.`,
    vocab: [
      { word: 'Nationalised', definition: 'When a government takes control of private companies or industries — making them state-owned.' },
      { word: 'Hyperinflation', definition: 'Extremely rapid price increases that make a currency nearly worthless — prices doubling in days.' },
      { word: 'Humanitarian crisis', definition: 'A situation where large numbers of people suffer from lack of food, water, medicine, or safety.' },
      { word: 'Backdrop', definition: 'The context or situation against which something happens — the background circumstances.' },
    ],
    questions: [
      { n: 4, q: 'Venezuela went from the richest country in South America to a humanitarian crisis. What lessons does this teach about oil-dependent economies?' },
      { n: 5, q: '7 million people fled Venezuela. What happens to a country when a quarter of its population leaves?' },
      { n: 6, q: 'Venezuela is negotiating from desperation. Can a desperate country negotiate fairly? What protections should exist?' },
    ]
  },
  {
    number: 3, title: 'The Resource Curse', emoji: '💎', color: '#991b1b',
    text: `Venezuela\'s story illustrates one of the most paradoxical patterns in economics: the "resource curse" — the observation that countries rich in natural resources often perform worse economically, politically, and socially than countries with few resources.\n\nThe pattern is consistent across continents. Nigeria, Angola, the Democratic Republic of the Congo, and Iraq all have enormous natural resource wealth and widespread poverty. Meanwhile, resource-poor countries like Japan, South Korea, Singapore, and Switzerland are among the wealthiest and most stable on Earth.\n\nSeveral mechanisms explain why abundance can become a curse. Resource wealth tends to concentrate power — whoever controls the oil controls the money, and whoever controls the money controls the politics. This breeds corruption, authoritarianism, and conflict. It also discourages economic diversification — why invest in education, manufacturing, or technology when oil revenues flow easily?\n\nResource wealth can also create a phenomenon called "Dutch disease" — when a booming resource sector attracts so much investment that other industries wither. The currency strengthens, making non-resource exports uncompetitive. Agriculture, manufacturing, and services decline. When the resource price falls — as oil prices inevitably do — there is nothing else to fall back on.\n\nNorway is the most famous exception to the resource curse. When it discovered oil in the North Sea in the 1960s, it established a sovereign wealth fund that invested oil revenues abroad rather than spending them domestically. Today, the fund is worth more than 1.5 trillion dollars — making every Norwegian a theoretical millionaire. But Norway had strong institutions, low corruption, and a well-educated population before it found oil. Venezuela did not.`,
    vocab: [
      { word: 'Resource curse', definition: 'The paradox that countries rich in natural resources often have worse economic and political outcomes.' },
      { word: 'Diversification', definition: 'Developing multiple industries rather than depending on just one — spreading economic risk.' },
      { word: 'Dutch disease', definition: 'When a booming resource sector damages other industries by attracting all the investment.' },
      { word: 'Sovereign wealth fund', definition: 'A government-owned investment fund that saves resource revenues for future generations.' },
    ],
    questions: [
      { n: 7, q: 'Countries with abundant resources are often poorer than those without. Why does this paradox exist?' },
      { n: 8, q: 'Norway saved its oil money in a wealth fund. Venezuela spent it immediately. What made the difference?' },
      { n: 9, q: 'Thailand has some natural resources but is not oil-rich. Is this an advantage or disadvantage for long-term development?' },
    ]
  },
  {
    number: 4, title: 'Who Benefits?', emoji: '⚖️', color: '#7f1d1d',
    text: `The fundamental question about the US-Venezuela oil deal is deceptively simple: who benefits?\n\nThe US government benefits from access to cheap oil and reduced dependence on Middle Eastern supplies — particularly important given the ongoing Hormuz crisis. American oil companies benefit from access to vast reserves that they can develop using their superior technology.\n\nVenezuela\'s interim government benefits from revenue and international legitimacy. But this government was installed with US support and faces significant domestic opposition. Whether the deal benefits the Venezuelan people — or merely the political faction currently in power — is a very different question.\n\nThe precedent matters too. If the US can negotiate preferential access to a desperate country\'s resources during a crisis, what message does this send to other resource-rich developing nations? Does it encourage reform and good governance, or does it demonstrate that powerful countries will exploit weakness when they find it?\n\nThe history of foreign oil companies in developing countries is not encouraging. From Iran in the 1950s to Nigeria in the 1990s to Iraq in the 2000s, the pattern has been remarkably consistent: foreign companies extract resources, profits flow abroad, and local populations see minimal benefit while bearing the environmental costs.\n\nWhether the US-Venezuela deal breaks this pattern or repeats it will depend on implementation — specifically, on whether Venezuelan workers, communities, and institutions benefit meaningfully, or whether the deal enriches a few while the many continue to suffer. History suggests scepticism is warranted.`,
    vocab: [
      { word: 'Legitimacy', definition: 'The quality of being accepted as lawful and proper — the right to govern.' },
      { word: 'Precedent', definition: 'An action or decision that sets a pattern for the future — what happens next time.' },
      { word: 'Implementation', definition: 'How a plan or policy is carried out in practice — the execution of an agreement.' },
      { word: 'Warranted', definition: 'Justified and appropriate — there are good reasons for it.' },
    ],
    questions: [
      { n: 10, q: 'Foreign oil companies have a bad track record in developing countries. Will this deal be different? Why or why not?' },
      { n: 11, q: 'The deal benefits the US and Venezuela\'s interim government. But does it benefit ordinary Venezuelans?' },
      { n: 12, q: 'Should powerful countries be allowed to negotiate resource deals with desperate nations? What safeguards should exist?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "US-Venezuela Oil Deal — 65 Billion Barrels". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function VenezuelaOilPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US-Venezuela Oil Deal — 65 Billion Barrels</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Trump announced a deal for majority control of Venezuelan oil reserves. The resource curse, Venezuela collapse, and who really benefits from deals made in desperation.</p>
            </div>
          </div>
