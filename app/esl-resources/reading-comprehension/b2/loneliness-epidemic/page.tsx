...
const PARTS = [
  {
    number: 1, title: 'The Loneliest Generation', emoji: '📱', color: '#f59e0b',
    text: `In 2023, the United States Surgeon General issued a public health advisory about an epidemic that most people had never thought of as a medical issue: loneliness. The report described chronic loneliness as a health risk equivalent to smoking 15 cigarettes a day, associated with a 26% increase in early death. It was a striking claim — and it reflected a growing body of research suggesting that loneliness has become one of the defining challenges of modern life.\n\nLoneliness is not the same as being alone. A person can live alone and feel perfectly content. Another can be surrounded by hundreds of people every day and feel profoundly isolated. Loneliness is the gap between the social connection you want and the social connection you have. It is a subjective, emotional experience — and by almost every measure, it is getting worse.\n\nSurveys across the developed world show remarkably consistent patterns. In the UK, more than 3.8 million people over the age of 65 say television is their main form of company. In Japan, the phenomenon of "kodokushi" — dying alone and remaining undiscovered for weeks or months — has become so common that specialised cleaning companies have been created to deal with it. In South Korea, the government has created a Ministry of Loneliness. Young people are not immune — in fact, 18-to-24-year-olds consistently report higher rates of loneliness than any other age group.\n\nThis last finding surprises many people. How can the most digitally connected generation in history also be the loneliest? The answer lies in the difference between connection and genuine human contact — and in the way modern life has been quietly dismantling the social structures that once kept loneliness at bay.`,
    vocab: [
      { word: 'Chronic', definition: 'Lasting for a long time or constantly recurring — not temporary.' },
      { word: 'Subjective', definition: 'Based on personal feelings and experience rather than measurable facts.' },
      { word: 'Phenomenon', definition: 'A remarkable event, trend, or situation — something that is observed and discussed.' },
      { word: 'Dismantling', definition: 'Taking apart piece by piece — gradually destroying or removing something.' },
    ],
    questions: [
      { n: 1, q: 'Loneliness is as dangerous as smoking 15 cigarettes a day. Does this comparison surprise you? Why do you think loneliness affects physical health?' },
      { n: 2, q: 'Young people aged 18-24 report the highest loneliness. How can the most connected generation also be the loneliest?' },
      { n: 3, q: 'Japan has a word for dying alone undiscovered — kodokushi. What does this tell us about modern society?' },
    ]
  },
  {
    number: 2, title: 'What Changed?', emoji: '🏘️', color: '#d97706',
    text: `For most of human history, loneliness was not a widespread social problem. People lived in small, tight-knit communities where daily face-to-face interaction was unavoidable. Extended families shared homes. Neighbours depended on each other. Religious institutions provided weekly gathering points. Work was often communal. The social fabric of daily life was dense and inescapable — sometimes oppressively so.\n\nSeveral forces have combined to unravel that fabric over the past century. Urbanisation moved people from villages where everyone knew each other to cities where neighbours are strangers. The rise of car-dependent suburbs created communities built around private homes and private vehicles, with few public spaces for spontaneous interaction. Working hours have increased in many countries, leaving less time for socialising. And the decline of institutions that once brought people together regularly — churches, trade unions, clubs, local pubs — has removed the scaffolding that supported casual social connection.\n\nTechnology has played a complex role. Social media platforms promise connection but often deliver something closer to performance — curated versions of our lives presented for approval rather than genuine intimacy. Online communication lacks many of the elements that make face-to-face interaction satisfying: eye contact, touch, shared physical space, the warmth of simply being in the same room as another person. Video calls, while better than text, are still experienced by the brain as fundamentally different from in-person contact.\n\nThe COVID-19 pandemic accelerated many of these trends. Lockdowns forced people into isolation, remote work eliminated office socialising, and many of the habits of connection that people had maintained — gym classes, coffee with friends, casual chats with colleagues — were broken and never fully restored.`,
    vocab: [
      { word: 'Tight-knit', definition: 'A group of people who are closely connected and support each other.' },
      { word: 'Urbanisation', definition: 'The process of people moving from rural areas to cities.' },
      { word: 'Scaffolding', definition: 'A support structure — here meaning the systems that hold social life together.' },
      { word: 'Curated', definition: 'Carefully selected and arranged to present a particular image — not spontaneous or natural.' },
    ],
    questions: [
      { n: 4, q: 'The passage lists several forces that increased loneliness: urbanisation, cars, longer working hours, decline of community institutions. Which do you think has had the biggest impact?' },
      { n: 5, q: 'Social media promises connection but delivers performance. Do you agree? Does your own social media use make you feel more or less connected?' },
      { n: 6, q: 'The pandemic broke many social habits that were never restored. Has this been true in your own life? What changed?' },
    ]
  },
  {
    number: 3, title: 'The Health Crisis Nobody Talks About', emoji: '🧠', color: '#b45309',
    text: `The health consequences of chronic loneliness are severe and well documented. Loneliness triggers the same stress responses in the brain as physical pain — the brain literally interprets social isolation as a threat to survival, because for most of human evolution, being separated from the group meant death.\n\nThis stress response, when activated over long periods, causes measurable damage to the body. Chronic loneliness is associated with increased inflammation, weakened immune function, higher blood pressure, and elevated levels of the stress hormone cortisol. Lonely people are 29% more likely to develop coronary heart disease and 32% more likely to have a stroke. The cognitive effects are equally alarming — loneliness accelerates cognitive decline and is a significant risk factor for dementia.\n\nMental health is profoundly affected. Loneliness is both a cause and a consequence of depression and anxiety, creating a vicious cycle that can be extremely difficult to break. A lonely person may withdraw from social situations because they feel anxious, which increases their isolation, which deepens their loneliness, which worsens their anxiety. Breaking this cycle often requires external intervention — a friend who reaches out, a structured social activity, or professional support.\n\nThe economic costs are substantial. Lonely employees are less productive, take more sick days, and are more likely to leave their jobs. The UK government estimated that loneliness costs employers up to 2.5 billion pounds per year. Healthcare systems bear additional costs from the physical and mental health conditions that loneliness causes or worsens. Loneliness is not just a personal problem — it is an economic one.`,
    vocab: [
      { word: 'Inflammation', definition: 'A response by the body to injury or stress — swelling, redness, and pain that can cause long-term damage.' },
      { word: 'Cortisol', definition: 'A hormone released by the body during stress — too much over time can damage health.' },
      { word: 'Cognitive decline', definition: 'A gradual worsening of mental abilities like memory, thinking, and reasoning.' },
      { word: 'Vicious cycle', definition: 'A situation where one problem causes another, which makes the first problem worse, and so on.' },
    ],
    questions: [
      { n: 7, q: 'The brain treats loneliness like physical pain. Why do you think humans evolved to feel social isolation so intensely?' },
      { n: 8, q: 'Loneliness creates a vicious cycle with depression and anxiety. How could this cycle be broken? What kind of intervention would help most?' },
      { n: 9, q: 'Loneliness costs UK employers 2.5 billion pounds a year. Should businesses be responsible for their employees social wellbeing? How?' },
    ]
  },
  {
    number: 4, title: 'What Can Be Done?', emoji: '🤝', color: '#92400e',
    text: `Addressing loneliness requires action at every level — individual, community, and governmental. The good news is that effective interventions exist. The challenge is scaling them.\n\nAt the individual level, research suggests that the quality of social connections matters far more than the quantity. Having three or four close, trusted relationships is more protective against loneliness than having hundreds of acquaintances. Investing time in deepening existing relationships — through regular, unhurried, face-to-face contact — is more effective than trying to expand your social network. Small, consistent actions — a weekly phone call to a friend, a regular walk with a neighbour, joining a club that meets in person — build the kind of sustained connection that combats loneliness.\n\nAt the community level, urban design plays a surprisingly important role. Cities that prioritise walkable streets, public parks, community centres, and mixed-use neighbourhoods create more opportunities for the spontaneous interactions that build social bonds. Copenhagen, often cited as one of the world\\'s least lonely cities, has deliberately designed public spaces that encourage people to linger, sit, and talk. In contrast, car-dependent suburbs with no public gathering spaces actively work against social connection.\n\nAt the governmental level, several countries have begun treating loneliness as a public health priority. The UK appointed a Minister for Loneliness in 2018. Japan followed in 2021. Australia launched a national strategy to combat social isolation. These initiatives fund community programmes, support volunteering organisations, and raise public awareness that loneliness is not a personal failure but a structural problem that society has a responsibility to address.\n\nThe loneliness epidemic will not be solved by technology, by government policy, or by individual willpower alone. It requires all three — and above all, it requires a cultural shift in which we recognise that human connection is not a luxury but a fundamental need, as essential to health as food, water, and shelter.`,
    vocab: [
      { word: 'Intervention', definition: 'An action taken to improve a situation or prevent it from getting worse.' },
      { word: 'Acquaintances', definition: 'People you know slightly but who are not close friends.' },
      { word: 'Sustained', definition: 'Continuing steadily over a long period without stopping.' },
      { word: 'Structural', definition: 'Relating to the way something is built or organised — a problem caused by the system, not by individuals.' },
    ],
    questions: [
      { n: 10, q: 'Three close friendships protect against loneliness more than hundreds of acquaintances. Do you agree? How many close friends do you have?' },
      { n: 11, q: 'Copenhagen designed its city to reduce loneliness. How is the city or town where you live designed? Does it help or hinder social connection?' },
      { n: 12, q: 'The passage says loneliness is a structural problem, not a personal failure. Do you agree? Should governments be responsible for solving it?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Loneliness Epidemic</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Why more people feel alone than ever despite being more connected — the science, the causes, and what can be done about the modern loneliness crisis.</p>
            </div>
          </div>
