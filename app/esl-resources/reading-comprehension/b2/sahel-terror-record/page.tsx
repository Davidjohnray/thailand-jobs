...
const PARTS = [
  {
    number: 1, title: 'The War That Moved', emoji: '📍', color: '#dc2626',
    text: `Twenty-five years after the September 11 attacks launched the "War on Terror," new data reveals an uncomfortable truth: Islamist terrorism has not been defeated. It has moved.\n\nThe Sahel — a semi-arid belt stretching across Africa just south of the Sahara Desert, from Senegal to Sudan — has become the global epicentre of jihadist violence. Groups linked to al-Qaeda and Islamic State have carried out more attacks in the Sahel in 2026 than in any previous year. The conflict monitor Acled reports that violence in the region is on track to reach historic highs, with thousands of civilians killed and millions displaced.\n\nThe countries most affected — Mali, Burkina Faso, Niger, Nigeria, and Chad — are among the poorest on Earth. Their security forces are undermanned, undertrained, and outgunned by militant groups that control vast swathes of territory. In some areas, the state has effectively ceased to exist, replaced by armed groups that impose their own brutal version of governance.\n\nThe irony is cruel. The War on Terror, launched to prevent another 9/11, has cost more than 8 trillion dollars and involved military operations in dozens of countries. It has killed terrorist leaders, disrupted networks, and prevented many attacks. But the overall level of global terrorism is higher today than it was on September 10, 2001. The threat has not been eliminated — it has dispersed.`,
    vocab: [
      { word: 'Sahel', definition: 'A semi-arid region of Africa stretching from the Atlantic to the Red Sea, south of the Sahara Desert.' },
      { word: 'Jihadist', definition: 'A person who wages war in the name of a radical interpretation of Islam.' },
      { word: 'Dispersed', definition: 'Spread out over a wide area — scattered rather than concentrated in one place.' },
      { word: 'Swathes', definition: 'Large areas or sections — broad stretches of territory.' },
    ],
    questions: [
      { n: 1, q: 'The War on Terror cost 8 trillion dollars but terrorism has increased globally. Was it worth it?' },
      { n: 2, q: 'Terrorism has moved from the Middle East to Africa. Why does violence shift from region to region?' },
      { n: 3, q: 'Militant groups control territory where the state has collapsed. What happens to civilians in these areas?' },
    ]
  },
  {
    number: 2, title: 'Why the Sahel?', emoji: '🏜️', color: '#b91c1c',
    text: `Understanding why the Sahel has become the world terrorism epicentre requires understanding the forces — both local and global — that create fertile ground for extremism.\n\nPoverty is the foundation. The Sahel countries consistently rank among the lowest in the world on the Human Development Index. Life expectancy is short. Education is limited. Economic opportunities are scarce. Young men — the primary recruits for armed groups — face unemployment rates exceeding 50% in many areas. When a militant group offers a salary, a sense of purpose, and a gun, the alternative is often nothing at all.\n\nClimate change amplifies the crisis. The Sahel is warming 1.5 times faster than the global average. Rainfall patterns have become unpredictable, destroying the pastoralist and farming livelihoods that sustain most of the population. Competition for shrinking resources — water, grazing land, farmable soil — fuels ethnic tensions that militant groups exploit.\n\nGovernance failures complete the picture. Corrupt, ineffective governments have failed to deliver basic services — schools, clinics, justice, security — to rural populations. When the state provides nothing, people turn to whoever will. In some areas, militant groups have filled the void, providing crude but functional governance — courts, dispute resolution, and even healthcare — alongside their violence.\n\nForeign intervention has often made things worse. French military operations in the Sahel from 2013 to 2022 killed many militants but also alienated local populations. When France withdrew, Russian Wagner Group mercenaries moved in — bringing a different kind of foreign involvement but similar results.`,
    vocab: [
      { word: 'Pastoralist', definition: 'People who raise livestock and move with their herds — nomadic animal farmers.' },
      { word: 'Exploit', definition: 'To take advantage of something for your own benefit — using weaknesses or problems.' },
      { word: 'Alienated', definition: 'Made people feel hostile or unfriendly — turning potential allies into opponents.' },
      { word: 'Mercenaries', definition: 'Soldiers who fight for money rather than for their own country — hired fighters.' },
    ],
    questions: [
      { n: 4, q: 'Poverty, climate change, and bad governance create conditions for extremism. Which is the most important factor?' },
      { n: 5, q: 'Militant groups sometimes provide services the government does not — courts, healthcare. What does this tell us?' },
      { n: 6, q: 'French troops left. Russian mercenaries arrived. Does it matter which foreign force intervenes, or is all intervention counterproductive?' },
    ]
  },
  {
    number: 3, title: 'The Forgotten Front', emoji: '📰', color: '#991b1b',
    text: `The Sahel crisis receives a fraction of the media coverage given to terrorism in Europe, the Middle East, or the United States. This disparity has consequences.\n\nIn 2015, terrorist attacks in Paris killed 130 people and dominated global news for weeks. In the same year, Boko Haram in Nigeria killed more than 6,000 people. The Paris attacks produced an outpouring of international solidarity — profile pictures changed on Facebook, world leaders marched through the streets, and "Je suis Charlie" became a global slogan. The Nigerian massacres were barely reported outside Africa.\n\nThe attention gap reflects the same patterns visible in other crises: proximity, race, and perceived strategic importance determine how much coverage a story receives. European and American audiences — who consume most English-language news — relate more to attacks in cities they have visited than to violence in places they have never heard of.\n\nThe consequences are concrete. When a crisis receives attention, funding follows. When it does not, the crisis deepens. The Sahel receives a fraction of the per-capita aid directed to conflicts in the Middle East. Military assistance is limited. Diplomatic engagement is minimal. And the militant groups that thrive on neglect continue to expand.\n\nThe 9/11 anniversary this week prompted reflection on how the world has changed since 2001. One change that receives insufficient attention is this: the epicentre of global terrorism has shifted from the Middle East to Africa — and the world has barely noticed.`,
    vocab: [
      { word: 'Disparity', definition: 'A great difference — an unfair or unjustified inequality.' },
      { word: 'Solidarity', definition: 'Unity and support shown by people standing together — shared commitment to a cause.' },
      { word: 'Per-capita', definition: 'Per person — divided equally among all individuals in a population.' },
      { word: 'Thrive', definition: 'To grow strong and succeed — flourishing, especially in conditions others find difficult.' },
    ],
    questions: [
      { n: 7, q: '130 died in Paris and the world noticed. 6,000 died in Nigeria and few cared. Why this double standard?' },
      { n: 8, q: 'When crises receive attention, funding follows. How can the Sahel crisis become more visible?' },
      { n: 9, q: 'Terrorism has moved to Africa but the world barely noticed. What does this say about whose security matters?' },
    ]
  },
  {
    number: 4, title: 'What 25 Years Taught Us', emoji: '📚', color: '#7f1d1d',
    text: `Twenty-five years after 9/11, the War on Terror offers lessons that the world has been slow to learn.\n\nThe first lesson is that military force alone cannot defeat terrorism. The US deployed the most powerful military in history against terrorist groups — and terrorism increased. This does not mean military force is useless — it has disrupted networks, killed leaders, and prevented specific attacks. But it cannot address the conditions that create terrorists: poverty, injustice, lack of opportunity, and the appeal of radical ideology to people who feel they have nothing to lose.\n\nThe second lesson is that terrorism moves. Pressure in one region pushes militants to another. The destruction of ISIS in Syria and Iraq contributed to the expansion of ISIS-affiliated groups in Africa. The weakening of al-Qaeda in Afghanistan preceded its strengthening in the Sahel. Terrorism is like water — it finds the cracks.\n\nThe third lesson is that prevention is cheaper and more effective than response. Investing in education, governance, economic development, and community resilience in vulnerable regions costs a fraction of what military operations cost — and produces better results. But prevention is slow, unglamorous, and difficult to measure. Politicians prefer dramatic military action that produces visible results — even when those results are temporary.\n\nThe Sahel is where these lessons converge. A region devastated by poverty, climate change, and governance failure has become the new frontline of global terrorism. The world can respond with military force — and watch the problem move again — or it can finally apply the lessons that 25 years and 8 trillion dollars should have taught.`,
    vocab: [
      { word: 'Ideology', definition: 'A system of beliefs and ideas — especially political or religious doctrines.' },
      { word: 'Affiliated', definition: 'Officially connected or associated with a larger organisation.' },
      { word: 'Resilience', definition: 'The ability to recover from difficulties — strength and flexibility in the face of challenges.' },
      { word: 'Converge', definition: 'To come together at one point — multiple factors meeting in the same place.' },
    ],
    questions: [
      { n: 10, q: 'Military force cannot defeat terrorism alone. What else is needed?' },
      { n: 11, q: 'Terrorism is like water — it finds the cracks. How do you seal the cracks instead of just chasing the water?' },
      { n: 12, q: '8 trillion dollars spent on the War on Terror. If you could redirect that money, where would you spend it?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Sahel Terror Hits Record — 25 Years After 9/11". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function SahelPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Sahel Terror Hits Record — 25 Years After 9/11</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Islamist violence in Africa Sahel region is at historic highs. 25 years after 9/11 launched the War on Terror, terrorism has not been defeated — it has moved.</p>
            </div>
          </div>
