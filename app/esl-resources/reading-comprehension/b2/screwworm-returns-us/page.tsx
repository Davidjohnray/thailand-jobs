...
const PARTS = [
  {
    number: 1, title: 'The Parasite That Came Back', emoji: '🔬', color: '#dc2626',
    text: `One of the most celebrated achievements in American pest control is being undone. The New World screwworm — a flesh-eating fly larva that was eradicated from the United States in 1982 through one of the most ingenious biological control programmes in history — has returned.\n\nCases have been confirmed in livestock in southern Texas and Florida, with the parasite spreading northward at a rate that is alarming veterinarians and wildlife biologists. The screwworm lays its eggs in wounds on living animals — including livestock, wildlife, pets, and potentially humans. The larvae then feed on living tissue, literally eating the animal alive.\n\nThe original eradication was a triumph of biological engineering. Scientists bred billions of sterile male screwworm flies and released them into the wild. When sterile males mated with wild females, no offspring were produced. Over decades, this "sterile insect technique" reduced the population to zero across the entire United States, Mexico, and Central America — one of the most successful pest eradication campaigns in history.\n\nNow the parasite is back — likely crossing from South America through wildlife corridors in Central America and Mexico that were once maintained as barrier zones. The barrier programme, which required continuous releases of sterile flies, has been weakened by funding cuts and changing priorities. And climate change has expanded the range of conditions suitable for the screwworm, allowing it to survive in areas that were once too cold.`,
    vocab: [
      { word: 'Eradicated', definition: 'Completely destroyed — eliminated entirely so that none remain.' },
      { word: 'Larvae', definition: 'The early, worm-like stage of an insect life cycle — before it becomes an adult.' },
      { word: 'Sterile', definition: 'Unable to reproduce — incapable of producing offspring.' },
      { word: 'Wildlife corridors', definition: 'Connected strips of habitat that allow animals to move between larger natural areas.' },
    ],
    questions: [
      { n: 1, q: 'A parasite eradicated 40 years ago has returned. What does this tell us about the permanence of biological victories?' },
      { n: 2, q: 'Scientists bred billions of sterile flies to wipe out the species. Is this one of the most creative solutions in the history of science?' },
      { n: 3, q: 'Funding cuts weakened the barrier programme. Should eradication be maintained permanently, even when the threat seems gone?' },
    ]
  },
  {
    number: 2, title: 'The Sterile Insect Technique', emoji: '🧬', color: '#b91c1c',
    text: `The sterile insect technique — the method used to eradicate the screwworm — is one of the most elegant pest control strategies ever devised, and understanding it helps explain why the parasite return is so concerning.\n\nThe technique works by flooding a wild population with sterile males. In most insect species, females mate only once or a few times. If a female mates with a sterile male, she produces no offspring. If enough sterile males are released — overwhelming the fertile wild males by a ratio of ten to one or more — the population crashes within a few generations.\n\nThe beauty of the technique is that it targets only one species. Unlike pesticides, which kill indiscriminately and can harm beneficial insects, the sterile insect technique affects only the target species. It leaves the ecosystem intact while removing the pest.\n\nThe US screwworm programme released approximately 3.5 billion sterile flies per week at its peak — an industrial-scale biological operation. Factory facilities in Texas and later in Panama bred the flies, irradiated the males to render them sterile, and released them from aircraft across thousands of square kilometres. The programme cost approximately 750 million dollars over several decades — but saved the American livestock industry billions in losses.\n\nMaintaining the barrier zone — a continuous line of sterile fly releases across the narrow Isthmus of Panama — was supposed to prevent the screwworm from reinvading from South America. But this barrier requires permanent funding and attention. When both were reduced, the barrier weakened — and the parasite found its way through.`,
    vocab: [
      { word: 'Devised', definition: 'Invented or planned — created through careful thinking and design.' },
      { word: 'Indiscriminately', definition: 'Without distinction — affecting everything equally, including things that should not be harmed.' },
      { word: 'Irradiated', definition: 'Exposed to radiation — in this case, to make the flies unable to reproduce.' },
      { word: 'Isthmus', definition: 'A narrow strip of land connecting two larger landmasses — like Panama connecting North and South America.' },
    ],
    questions: [
      { n: 4, q: '3.5 billion sterile flies per week released from aircraft. Is this the most ambitious biological programme in history?' },
      { n: 5, q: 'The sterile insect technique only targets one species. Why is this better than pesticides?' },
      { n: 6, q: 'The Panama barrier needed permanent funding. Why do governments cut funding for programmes that are working?' },
    ]
  },
  {
    number: 3, title: 'Climate and Comeback', emoji: '🌡️', color: '#991b1b',
    text: `Climate change is a key factor in the screwworm return — and it illustrates a broader pattern that biologists are increasingly concerned about: warming temperatures are expanding the range of tropical parasites and diseases into regions that were once too cold to support them.\n\nThe screwworm is a tropical species that cannot survive freezing temperatures. Historically, winter cold in the southern United States killed any screwworm flies that crossed the border. The eradication programme eliminated the resident population, and winter cold prevented recolonisation from the south.\n\nBut winters in the southern US are getting warmer. Freeze events are less frequent and less severe. The number of days below freezing in southern Texas has declined by approximately 20% over the past 30 years. This means that screwworm flies arriving from Central America are more likely to survive — and reproduce — in areas that once would have killed them.\n\nThe screwworm is not an isolated case. Tropical diseases that were once confined to equatorial regions are moving poleward. Dengue fever, once limited to tropical areas, has appeared in southern Europe. Malaria is being found at higher altitudes in East Africa. And agricultural pests that were once contained by winter cold are surviving in regions where they previously could not — threatening crops, livestock, and ecosystems.\n\nThe pattern is clear: climate change is not just about rising temperatures. It is about redrawing the biological map of the world — moving diseases, parasites, and pests into new territories where populations have no immunity and ecosystems have no defences.`,
    vocab: [
      { word: 'Recolonisation', definition: 'When a species returns to an area it was previously eliminated from.' },
      { word: 'Poleward', definition: 'Moving toward the poles — northward in the Northern Hemisphere, southward in the Southern.' },
      { word: 'Immunity', definition: 'The ability to resist a disease — protection that comes from previous exposure or vaccination.' },
      { word: 'Biological map', definition: 'The distribution of species across the Earth — where different organisms can survive.' },
    ],
    questions: [
      { n: 7, q: 'Warmer winters allow tropical parasites to survive further north. What other species might expand their range?' },
      { n: 8, q: 'Dengue fever has appeared in southern Europe. Malaria at higher altitudes. How should countries prepare for diseases that did not exist in their region before?' },
      { n: 9, q: 'Climate change is redrawing the biological map. What does this mean for Thailand, which is already tropical?' },
    ]
  },
  {
    number: 4, title: 'The Price of Complacency', emoji: '⚠️', color: '#7f1d1d',
    text: `The return of the screwworm is a parable about complacency — the human tendency to assume that solved problems stay solved.\n\nThe eradication of the screwworm was one of the greatest achievements in the history of agriculture and public health. But it required continuous effort to maintain — the barrier zone, the sterile fly releases, the monitoring, the funding. When the threat seemed gone, attention and resources moved elsewhere. The barrier weakened. And the problem returned.\n\nThis pattern repeats across almost every domain. Diseases that were nearly eradicated — polio, measles, tuberculosis — are resurging because vaccination rates have declined. Infrastructure that was built and maintained is crumbling because maintenance budgets were cut. Environmental protections that were established are being rolled back because the problems they solved are no longer visible.\n\nThe fundamental error is confusing the absence of a problem with the absence of a threat. The screwworm was gone because the programme kept it gone — not because the underlying threat had disappeared. When the programme was weakened, the threat reasserted itself. The same is true for diseases, infrastructure, environmental protection, and virtually every other system that requires maintenance.\n\nThe lesson is uncomfortable but essential: winning is not the same as having won. Victories in biology, infrastructure, and public health require permanent vigilance. The moment you assume the battle is over is the moment you begin to lose it again.\n\nThe screwworm is back. The question is whether we will pay the price of re-eradicating it — or whether complacency will, once again, prove more expensive than prevention.`,
    vocab: [
      { word: 'Complacency', definition: 'A dangerous feeling of satisfaction with how things are — not worrying about threats because everything seems fine.' },
      { word: 'Parable', definition: 'A story that teaches a moral lesson — an example that illustrates a broader truth.' },
      { word: 'Resurging', definition: 'Coming back strongly after a period of decline — returning with force.' },
      { word: 'Vigilance', definition: 'Careful, constant attention — staying alert to potential threats.' },
    ],
    questions: [
      { n: 10, q: 'We stopped maintaining the barrier and the parasite returned. What other solved problems are we at risk of losing?' },
      { n: 11, q: 'Polio and measles are resurging because vaccination rates dropped. Why do people stop protecting themselves from threats they cannot see?' },
      { n: 12, q: 'Winning is not the same as having won. What does this mean for the challenges your generation faces — climate change, disease, AI?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "The Flesh-Eating Parasite the US Eradicated Is Back". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function ScrewwormPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Flesh-Eating Parasite the US Eradicated Is Back</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The New World screwworm — a flesh-eating parasite eradicated from the US decades ago — has returned. Climate change, wildlife corridors, and the fragility of biological victory.</p>
            </div>
          </div>
