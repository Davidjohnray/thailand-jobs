...
const PARTS = [
  {
    number: 1, title: 'The Revolving Door', emoji: '🚪', color: '#dc2626',
    text: `On 20 July 2026, Andy Burnham walked through the door of 10 Downing Street as the United Kingdom's new prime minister. He was the seventh person to hold the office in just ten years — a rate of turnover unprecedented in modern British history. The man he replaced, Keir Starmer, had lasted barely two years. His predecessor Rishi Sunak managed two. Before that, Liz Truss survived just 49 days — her premiership famously outlasted by a lettuce in a viral internet stunt.\n\nThe rapid succession of leaders reflects a deeper crisis in British politics that began with the 2016 Brexit referendum. The decision to leave the European Union fractured the country, shrank the economy, and created divisions within both major parties that no leader has been able to heal. Every prime minister since has struggled with the consequences of that vote — and every one has ultimately been destroyed by them.\n\nBurnham, 56, came to power through an unusual route. As the popular mayor of Greater Manchester — dubbed the "King of the North" — he had built a reputation for straight-talking, practical leadership that resonated with voters far beyond his northern English base. When Starmer announced his resignation in June after disastrous local election results, Burnham entered the Labour leadership contest and won the support of 379 out of 401 Labour MPs.\n\nIn his first speech outside Downing Street, Burnham struck a notably different tone from his predecessors. "I want to be honest with you: we have not been good enough, and we need to be better," he said. The question is whether honesty and good intentions will be enough to break the cycle of failure that has consumed British politics for a decade.`,
    vocab: [
      { word: 'Unprecedented', definition: 'Never having happened before — without any previous example in history.' },
      { word: 'Fractured', definition: 'Broken or divided — split into opposing groups.' },
      { word: 'Resonated', definition: 'Created a strong emotional connection — people felt it was meaningful and relevant to them.' },
      { word: 'Consumed', definition: 'Completely dominated or overwhelmed — taken over entirely.' },
    ],
    questions: [
      { n: 1, q: 'Seven prime ministers in ten years. What does this level of instability do to a country? How does it affect ordinary people?' },
      { n: 2, q: 'Burnham said "we have not been good enough." Is this kind of honesty from a politician refreshing, or is it a sign of weakness?' },
      { n: 3, q: 'In the UK, a party can change its leader — and the PM — without a general election. Is this democratic? Should the public have a say?' },
    ]
  },
  {
    number: 2, title: 'The Post-Brexit Hangover', emoji: '🇬🇧', color: '#b91c1c',
    text: `To understand why British politics has been so unstable, you need to understand Brexit — the United Kingdom's decision to leave the European Union in 2016.\n\nThe referendum divided the country almost exactly in half — 52% voted to leave, 48% voted to remain. But the divisions went deeper than the numbers suggest. Leave voters tended to be older, less educated, and living outside major cities. Remain voters tended to be younger, university-educated, and urban. The referendum exposed a cultural and economic divide that had been growing for decades but that politicians had largely ignored.\n\nThe economic consequences of Brexit have been significant. Trade with the EU — Britain's largest trading partner — has become more complicated and more expensive. Business investment has been lower than in comparable European economies. The UK economy has underperformed its peers since 2016, with the Office for Budget Responsibility estimating that Brexit has reduced UK GDP by approximately 4% compared to what it would have been had the country remained in the EU.\n\nBut the political consequences have been even more damaging. Brexit consumed the bandwidth of four successive prime ministers, leaving little room for other policy priorities. It destroyed two Conservative leaders (David Cameron and Theresa May), contributed to the downfall of two more (Boris Johnson and Liz Truss), and created impossible expectations that no Labour leader could meet. Voters who were promised that leaving the EU would make Britain richer, stronger, and more independent are still waiting for those promises to be fulfilled.\n\nBurnham has signalled a pragmatic approach to the EU — seeking closer cooperation without rejoining — but the underlying divisions that Brexit created remain unresolved. The hangover, it seems, is far from over.`,
    vocab: [
      { word: 'Referendum', definition: 'A vote in which all citizens can express their opinion on an important political question.' },
      { word: 'Bandwidth', definition: 'The time and energy available to deal with issues — capacity for attention.' },
      { word: 'Pragmatic', definition: 'Dealing with things in a practical, realistic way rather than following strict principles.' },
      { word: 'GDP', definition: 'Gross Domestic Product — the total value of everything a country produces, used to measure economic health.' },
    ],
    questions: [
      { n: 4, q: 'Brexit divided the UK by age, education, and geography. Why do these factors predict how people vote on issues like this?' },
      { n: 5, q: 'Brexit has reduced UK GDP by approximately 4%. Should the UK consider rejoining the EU? What would the barriers be?' },
      { n: 6, q: 'The passage says Brexit consumed the attention of four prime ministers. Can a single political decision really dominate a country for a decade?' },
    ]
  },
  {
    number: 3, title: 'The Rise of Reform UK', emoji: '📊', color: '#991b1b',
    text: `Perhaps the most significant factor in Burnham's rise — and Starmer's fall — was not Labour's failures but the explosive growth of Reform UK, a populist right-wing party led by Nigel Farage.\n\nReform UK emerged from the ashes of the Brexit Party, which itself grew out of UKIP — the movement that campaigned for Britain to leave the EU. Having achieved its primary goal with the Brexit referendum, the movement reinvented itself around a broader populist agenda: cutting immigration, reducing taxes, fighting what it calls the "liberal establishment," and challenging what its supporters see as a political class that is out of touch with ordinary people.\n\nIn the May 2026 local elections, Reform UK won hundreds of council seats across England, devastating Labour's support in its traditional heartlands — the working-class towns and cities of northern and central England that had been the backbone of the Labour movement for a century. The results were catastrophic for Starmer and triggered the pressure that led to his resignation.\n\nThe rise of Reform UK mirrors similar movements across Europe — Marine Le Pen's National Rally in France, the Alternative for Germany, Giorgia Meloni's Brothers of Italy. These movements share common themes: scepticism of immigration, hostility to supranational institutions like the EU, cultural conservatism, and a populist rhetorical style that positions the leader as the voice of ordinary people against a corrupt elite.\n\nBurnham has explicitly framed his premiership as a response to this challenge. "If we do not offer people real change, they will look for it elsewhere," he said in his first speech. "And the elsewhere they find may not be the elsewhere we want." The subtext was clear: if mainstream politics fails, populism fills the vacuum.`,
    vocab: [
      { word: 'Populist', definition: 'Claiming to represent ordinary people against a powerful, out-of-touch elite.' },
      { word: 'Heartlands', definition: 'The areas that are most strongly associated with a particular party or movement — traditional strongholds.' },
      { word: 'Supranational', definition: 'Having power or authority that goes beyond individual countries — like the EU or the UN.' },
      { word: 'Vacuum', definition: 'An empty space — when something is removed and nothing replaces it.' },
    ],
    questions: [
      { n: 7, q: 'Reform UK destroyed Labour support in working-class towns that voted Labour for a century. Why did these voters switch? What went wrong?' },
      { n: 8, q: 'Burnham said if mainstream politics fails, populism fills the vacuum. Do you agree? Is populism always the result of mainstream failure?' },
      { n: 9, q: 'Reform UK mirrors movements across Europe. Why is the same type of politics succeeding in so many different countries at the same time?' },
    ]
  },
  {
    number: 4, title: 'Can Burnham Break the Cycle?', emoji: '🔄', color: '#7f1d1d',
    text: `Andy Burnham faces a challenge that none of his predecessors managed to overcome: restoring public trust in a political system that has failed repeatedly for a decade.\n\nHis background gives him some advantages. Unlike most recent prime ministers, who were career politicians from the London establishment, Burnham built his reputation in the north of England, dealing with practical, local issues — transport, housing, homelessness, and policing. His response to the 2017 Manchester Arena bombing — in which he visibly held back tears while leading the city's response — earned him national respect and the "King of the North" nickname.\n\nBurnham has promised to address the cost of living crisis, reform public services, and tackle what he calls the "north-south divide" — the persistent economic gap between prosperous southern England and the more deprived north. He has also promised a different style of politics: less London-centric, more collaborative, and more willing to admit mistakes.\n\nBut the obstacles are enormous. The UK economy remains sluggish. Public services are under severe strain after years of austerity and underinvestment. The Reform UK challenge threatens to split the centre-left vote at the next election. And the structural problems created by Brexit continue to constrain economic growth and diplomatic flexibility.\n\nHistory is not on Burnham's side. Every British prime minister for a decade has entered Downing Street promising to fix what their predecessor broke, only to leave having created new problems of their own. Whether Burnham can break this cycle — or whether he will become the eighth departure in the revolving door — will depend not just on his abilities, but on whether a political system that has been failing for years still has the capacity to deliver the change that voters are desperately demanding.`,
    vocab: [
      { word: 'Establishment', definition: 'The group of powerful people who control politics, business, and society — the traditional ruling class.' },
      { word: 'Austerity', definition: 'Government policies that reduce spending and cut public services, usually to reduce debt.' },
      { word: 'Sluggish', definition: 'Moving slowly and lacking energy — used for an economy that is not growing well.' },
      { word: 'Constrain', definition: 'To limit or restrict — to prevent something from growing or developing freely.' },
    ],
    questions: [
      { n: 10, q: 'Burnham built his reputation in Manchester, not London. Does where a leader comes from matter? Why?' },
      { n: 11, q: 'Every UK PM for a decade has promised change and failed. Is it the leaders who are failing, or the system itself?' },
      { n: 12, q: 'What would success look like for Burnham? What single achievement would convince you that he has broken the cycle?' },
    ]
  },
]
...
export default function BurnhamPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Britain's 7th PM in a Decade</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Andy Burnham became the UK's seventh prime minister in ten years. Why can't Britain keep a leader, what went wrong after Brexit, and can Burnham break the cycle?</p>
            </div>
          </div>
