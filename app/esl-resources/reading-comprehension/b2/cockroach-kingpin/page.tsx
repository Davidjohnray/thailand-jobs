...
const PARTS = [
  {
    number: 1, title: 'The Bust', emoji: '🪳', color: '#16a34a',
    text: `In May 2026, officers from Australia's Department of Climate Change, Energy, the Environment and Water — not a department that typically makes international headlines — executed a raid on a commercial premises in Bathurst, a regional city in New South Wales. What they found inside set a new record in Australian law enforcement history: more than 100,000 live exotic insects, the vast majority of them cockroaches, kept in controlled conditions by a single commercial breeder.\n\nThe operation, described by authorities as the largest seizure of exotic invertebrates ever recorded in Australia, took several days to complete. The insects were housed in hundreds of containers at various stages of their life cycles. The breeder had been operating what amounted to a sophisticated insect farm, maintaining the temperature, humidity, and feeding conditions required to keep multiple species alive and breeding in captivity over what appeared to have been an extended period.\n\nAmong the seized animals were Madagascar hissing cockroaches — large, wingless cockroaches from Madagascar that produce a distinctive hissing sound by forcing air through respiratory pores in their abdomen. These insects, while genuinely striking in appearance and popular among exotic pet enthusiasts, are classified as a prohibited import in Australia due to the potential ecological damage they could cause if they were to establish a wild population on the continent.\n\nAustralia's strict biosecurity laws exist for well-documented reasons. The continent's isolation over tens of millions of years has produced a unique ecology — plants and animals found nowhere else on Earth. The introduction of non-native species, whether deliberate or accidental, has caused enormous ecological damage historically. Rabbits, cane toads, foxes, and feral cats are among the species whose introduction has had devastating consequences for native Australian wildlife.`,
    vocab: [
      { word: 'Invertebrates', definition: 'Animals without a backbone or spine, such as insects, worms, and molluscs.' },
      { word: 'Captivity', definition: 'The state of being kept confined, usually by humans, rather than living freely in the wild.' },
      { word: 'Biosecurity', definition: 'Measures taken to prevent the introduction or spread of harmful organisms into an environment.' },
      { word: 'Ecology', definition: 'The system of relationships between living things and their environment.' },
    ],
    questions: [
      { n: 1, q: 'Australia has some of the strictest biosecurity laws in the world. Do you think this level of restriction is justified? What are the trade-offs?' },
      { n: 2, q: 'The breeder had 100,000 insects. What does the scale of this operation suggest about the demand for exotic insects as pets? Why do you think people want them?' },
      { n: 3, q: 'The passage mentions that introduced species like rabbits and cane toads have devastated Australian wildlife. Can you think of similar examples from other countries?' },
    ]
  },
  {
    number: 2, title: 'The World of Exotic Insect Collecting', emoji: '🔍', color: '#15803d',
    text: `To understand why someone would maintain a secret collection of 100,000 cockroaches, it helps to understand the surprisingly large and passionate global community of exotic insect enthusiasts. Insect keeping — sometimes called entomophagy's quieter cousin, as opposed to the practice of eating insects — has grown significantly as a hobby over the past two decades, driven partly by the internet, which has allowed collectors to connect, share knowledge, and, crucially, trade specimens across international borders.\n\nMadagascar hissing cockroaches are among the most popular species in this community. They are large, slow-moving, and docile — unusual characteristics for cockroaches, which are more typically associated with speed and evasiveness. They do not fly, they do not bite, they live for two to five years in captivity, and the hissing sound they produce when disturbed has made them popular subjects for wildlife documentaries and science education programmes. In many countries, they are kept legally as pets and are available in pet shops.\n\nThe global trade in exotic insects exists in a complex legal landscape. In some countries, certain species can be bought and sold freely. In others, the same species are strictly prohibited. The disparity creates obvious opportunities for black market trade, particularly given the small size and relatively easy concealment of most insects. A consignment of cockroaches is considerably easier to smuggle than, say, a large reptile.\n\nLaw enforcement agencies around the world have noted an increase in the illegal trade in exotic invertebrates in recent years, partly driven by online marketplaces that have made it easier to find buyers and sellers across international borders. The challenge for customs officials is significant: insects are small, they can survive in sealed containers for extended periods, and distinguishing between legal and illegal species often requires specialist expertise that frontline border officials may not have.`,
    vocab: [
      { word: 'Specimens', definition: 'Individual examples of an animal or plant, collected or kept for study or display.' },
      { word: 'Docile', definition: 'Quiet, gentle, and easy to control — not aggressive or difficult to manage.' },
      { word: 'Disparity', definition: 'A noticeable difference or inequality between two or more things.' },
      { word: 'Consignment', definition: 'A batch of goods sent or delivered together, usually for commercial purposes.' },
    ],
    questions: [
      { n: 4, q: 'The passage describes a "surprisingly large and passionate global community" of exotic insect enthusiasts. Did this surprise you? What do you think draws people to keeping insects?' },
      { n: 5, q: 'The legal status of the same insect can vary dramatically between countries. Do you think international coordination on exotic animal trade is achievable? What are the obstacles?' },
      { n: 6, q: 'The passage notes that insects are easy to smuggle because they are small and can survive in sealed containers. How do you think customs authorities should respond to this challenge?' },
    ]
  },
  {
    number: 3, title: 'What Happens to 100,000 Cockroaches?', emoji: '❓', color: '#166534',
    text: `The practical question that immediately occurred to many people who read about the Bathurst bust was: what exactly do you do with 100,000 confiscated cockroaches? It is not a question that Australian wildlife authorities have had much practice answering, given that this was the largest such seizure ever recorded.\n\nThe answer, in most biosecurity cases of this type, is euthanasia. Animals seized at the border or as part of biosecurity operations cannot typically be released into the wild — that would defeat the entire purpose of the seizure. They cannot easily be returned to their country of origin. And in the case of invertebrates in particular, rehoming to licensed facilities is complicated by the sheer scale of the numbers involved and the specialist care requirements of different species.\n\nThis aspect of the story attracted some discomfort in public commentary. The cockroaches themselves had not chosen to be part of an illegal smuggling operation. They were, in the most literal sense, innocent bystanders in a human legal dispute. The utilitarian calculus of biosecurity — that the potential ecological harm of release outweighed the interests of individual animals — was widely accepted, but it sat uneasily alongside the scale of what it implied.\n\nThe case also prompted wider discussion about the adequacy of existing penalties for exotic animal trafficking in Australia. Current penalties for biosecurity breaches can include fines and imprisonment, but critics have argued that the penalties are not sufficiently severe to deter large-scale commercial operations of the kind uncovered in Bathurst. The breeder involved faced investigation under Australian biosecurity and wildlife protection legislation, but the outcome of that process had not been publicly reported at the time of writing.`,
    vocab: [
      { word: 'Euthanasia', definition: 'The act of humanely ending an animal\'s life, usually to prevent suffering or for safety reasons.' },
      { word: 'Utilitarian', definition: 'Based on the idea that the right action is whatever produces the greatest benefit for the greatest number.' },
      { word: 'Trafficking', definition: 'The illegal trade or transport of people, animals, or goods.' },
      { word: 'Deter', definition: 'To discourage someone from doing something, usually through fear of consequences.' },
    ],
    questions: [
      { n: 7, q: 'The cockroaches had to be euthanised because they couldn\'t safely be released or rehomed. Do you find the utilitarian argument for this convincing? Is there a better solution?' },
      { n: 8, q: 'The passage describes public "discomfort" at the fate of the cockroaches. Why do you think people felt sympathy for animals associated with being pests? What does this reveal about our relationship with animals?' },
      { n: 9, q: 'Critics argue that penalties for exotic animal trafficking are too lenient. What factors should be considered when setting penalties for crimes like this?' },
    ]
  },
  {
    number: 4, title: 'The Bigger Picture', emoji: '🌍', color: '#14532d',
    text: `The Bathurst cockroach bust was, by any measure, an unusual news story — strange enough to travel far beyond the Australian media outlets that initially covered it, reaching audiences in Europe, North America, and Asia who found the image of a "cockroach kingpin" irresistible. But beneath the inherently comic surface of the story lies a genuine and growing global problem.\n\nThe illegal wildlife trade is one of the most profitable criminal enterprises in the world, estimated by conservation organisations to be worth between fifteen and twenty billion US dollars annually. It encompasses everything from elephant ivory and rhinoceros horn to live birds, reptiles, and — as the Bathurst case demonstrated — exotic insects. The trade threatens biodiversity directly, by removing animals from wild populations, and indirectly, by funding organised criminal networks that often operate across multiple illegal markets simultaneously.\n\nInsects represent a growing segment of this trade precisely because they have, until relatively recently, been largely overlooked by law enforcement. The focus of international wildlife protection efforts has historically been on charismatic megafauna — elephants, tigers, rhinos — whose populations are visible, countable, and attract significant public sympathy. The illegal trade in invertebrates has operated in a lower-profile space, with less regulatory attention and, consequently, less enforcement.\n\nThe Bathurst case may represent a shift in this pattern. The scale of the seizure, and the public attention it attracted, has prompted discussion among Australian biosecurity officials about whether resources devoted to exotic invertebrate enforcement need to be increased. Whether that discussion translates into action — and whether other countries with similar biosecurity vulnerabilities take note — remains to be seen. In the meantime, somewhere, the world's most incongruous criminal enterprise continues.`,
    vocab: [
      { word: 'Encompasses', definition: 'Includes or contains a wide range of things within its scope.' },
      { word: 'Biodiversity', definition: 'The variety of plant and animal life in a particular habitat or on Earth as a whole.' },
      { word: 'Charismatic megafauna', definition: 'Large, appealing animal species — like lions and elephants — that attract public attention and conservation funding.' },
      { word: 'Incongruous', definition: 'Strange or out of place; not fitting with what you would expect in a particular situation.' },
    ],
    questions: [
      { n: 10, q: 'Conservation efforts tend to focus on charismatic megafauna like elephants and tigers. Do you think this is the right approach, or should resources be more evenly distributed?' },
      { n: 11, q: 'The illegal wildlife trade is worth $15-20 billion annually. What does this tell us about the relationship between demand, supply, and criminal opportunity?' },
      { n: 12, q: 'The passage ends by saying "somewhere, the world\'s most incongruous criminal enterprise continues." What effect does this ending have? What does it make you think or feel?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "The Cockroach Kingpin — Australia's Record Bug Bust". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be engaging and intellectually curious.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#f0fdf4', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #bbf7d0' }}>💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your full answer, then tap <strong>⏹ Stop & Send</strong>.</div>}
      {messages.length > 0 && (
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}><span style={{ color: color, fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>🌍 Translation</span>{m.translation}</div>}
              </div>
            </div>
          ))}
...
export default function CockroachKingpinPage() {
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(22,163,74,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Hidden Headlines</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Cockroach Kingpin</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Australian authorities raided a commercial breeder and seized over 100,000 illegal exotic insects — the largest invertebrate bust in the country's history. Behind the headlines lies a surprisingly serious story about wildlife crime.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#16a34a' : '#e5e7eb', background: speed === s.value ? '#16a34a' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
        ...
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#f0fdf4', padding: '8px 28px', borderBottom: '1px solid #bbf7d0' }}>
              <span style={{ color: '#14532d', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#16a34a' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#14532d', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(22,163,74,0.15)', border: '1px solid rgba(22,163,74,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#86efac', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
      ...
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #bbf7d0', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#f0fdf4', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bbf7d0', color: '#9ca3af', fontSize: '15px' }}>{translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}</div>
            ) : (
