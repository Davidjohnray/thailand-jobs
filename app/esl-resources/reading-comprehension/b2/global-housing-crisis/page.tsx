...
const PARTS = [
  {
    number: 1, title: 'A Generation Locked Out', emoji: '🔑', color: '#f59e0b',
    text: `In cities across the world — from London to Sydney, from San Francisco to Seoul — a generation of young adults is discovering something their parents took for granted is now beyond their reach: buying a home. House prices have risen so far and so fast that in many major cities, even professionals with good salaries cannot afford to buy a property without substantial family wealth or extraordinary luck.\n\nThe numbers are stark. In 1980, the average UK house cost roughly 3.5 times the average annual salary. By 2024, that figure had risen to more than 9 times — and in London, it was over 14 times. Similar ratios exist in Australia, Canada, New Zealand, and many parts of the United States. In Hong Kong, one of the most expensive housing markets in the world, the average home costs more than 20 times the average salary.\n\nThis is not just a problem for people who want to own property. Rising house prices push up rents too, as landlords pass on higher costs to tenants. In many cities, young workers spend 40-60% of their income on rent alone — leaving little for savings, pension contributions, or the kind of spending that keeps local economies healthy. The result is a generation that is not only poorer in housing terms than their parents, but poorer in almost every financial measure.\n\nThe housing crisis has profound social consequences beyond economics. People delay starting families because they cannot afford stable housing. Communities lose their character as long-term residents are priced out and replaced by wealthier newcomers or short-term rental tourists. Essential workers — teachers, nurses, firefighters, police officers — cannot afford to live in the cities where they work. The housing crisis is not just about buildings — it is about the kind of society we are building.`,
    vocab: [
      { word: 'Took for granted', definition: 'Assumed something would always be available without appreciating how fortunate it was.' },
      { word: 'Substantial', definition: 'Large in amount or importance — considerable and significant.' },
      { word: 'Ratios', definition: 'The relationship between two numbers showing how many times one contains the other.' },
      { word: 'Priced out', definition: 'Unable to afford something because the cost has risen too high.' },
    ],
    questions: [
      { n: 1, q: 'In 1980, a UK home cost 3.5 times the average salary. Now it costs 9 times. What has changed, and who benefits from rising prices?' },
      { n: 2, q: 'Young workers spend 40-60% of income on rent. How does this affect their lives beyond just having less money?' },
      { n: 3, q: 'Essential workers cannot afford to live where they work. What happens to a city when teachers and nurses are priced out?' },
    ]
  },
  {
    number: 2, title: 'Why Did This Happen?', emoji: '📈', color: '#d97706',
    text: `The global housing crisis has no single cause — it is the result of several forces acting together over decades.\n\nThe most fundamental factor is supply. In most expensive cities, the construction of new homes has not kept pace with population growth. Restrictive planning laws, opposition from existing homeowners who do not want new developments near their properties, and a shortage of construction workers have all contributed to a chronic undersupply of housing. In many cities, the number of homes built each year is less than half of what is needed.\n\nLow interest rates, which persisted from the 2008 financial crisis until 2022, played a major role. When borrowing is cheap, people can afford to take on larger mortgages, which pushes up the prices that sellers can charge. At the same time, low interest rates made property an attractive investment for wealthy individuals and institutional investors — pension funds, private equity firms, and corporations — who bought properties not to live in but to rent out or hold as appreciating assets.\n\nThe rise of short-term rental platforms like Airbnb has removed housing from local markets in tourist-heavy cities. In Barcelona, Lisbon, and many Thai resort towns, apartments that once housed local families have been converted into holiday rentals because the returns are higher. This reduces the supply of housing available to residents and drives up rents for everyone who remains.\n\nForeign investment has also been significant. In cities like Vancouver, London, and Auckland, wealthy overseas buyers have purchased properties as investments or safe havens for their capital, often leaving them empty. This pushes prices up while contributing nothing to the local community — creating the bizarre situation of housing shortages existing alongside thousands of unoccupied homes.`,
    vocab: [
      { word: 'Undersupply', definition: 'A situation where there is not enough of something to meet the demand.' },
      { word: 'Mortgage', definition: 'A large loan from a bank used to buy a property, paid back over many years with interest.' },
      { word: 'Appreciating assets', definition: 'Things that increase in value over time — investments that become worth more.' },
      { word: 'Safe haven', definition: 'A place or investment considered secure and protected from risk.' },
    ],
    questions: [
      { n: 4, q: 'The passage lists four main causes: undersupply, low interest rates, Airbnb, and foreign investment. Which do you think is most responsible?' },
      { n: 5, q: 'Airbnb has removed housing from local markets in tourist cities. Should governments restrict short-term rentals? What would happen in Thailand?' },
      { n: 6, q: 'Wealthy overseas buyers leave homes empty while locals cannot afford housing. Should foreign property ownership be restricted? What are the risks?' },
    ]
  },
  {
    number: 3, title: 'What Are Countries Trying?', emoji: '🔧', color: '#b45309',
    text: `Governments around the world have experimented with a wide range of policies to address the housing crisis, with varying degrees of success.\n\nSome countries have focused on increasing supply. Japan is often cited as a success story — Tokyo has some of the most relaxed planning laws of any major city, making it relatively easy to demolish old buildings and construct new ones. As a result, Tokyo has built far more housing than cities like London or New York, and its house prices have remained remarkably stable while prices in comparable cities have soared.\n\nOther countries have tried to reduce demand from investors and speculators. New Zealand banned most foreign buyers from purchasing existing homes in 2018. Canada introduced a two-year ban on foreign purchases in 2023. Singapore taxes foreign buyers at rates of up to 60%. Denmark requires buyers to prove they will live in the property before they can purchase it.\n\nRent controls — laws that limit how much landlords can charge — are another common approach. Berlin introduced a rent cap in 2020, which was later struck down by the courts. Scotland froze rents in 2022 during a cost-of-living crisis. Supporters argue that rent controls protect tenants from exploitation. Critics argue that they discourage construction of new rental housing and ultimately make the shortage worse.\n\nSocial housing — government-built housing rented at below-market rates — has been the most effective long-term solution in countries that have invested in it. Vienna, where roughly 60% of residents live in some form of subsidised housing, is consistently ranked as one of the most liveable cities in the world, with housing costs that are a fraction of those in London or Paris. The challenge is political will — social housing requires sustained public investment over decades, and many governments have been unwilling to commit.`,
    vocab: [
      { word: 'Speculators', definition: 'People who buy property not to live in but to sell later at a higher price for profit.' },
      { word: 'Rent controls', definition: 'Laws that limit how much landlords can increase rent, designed to keep housing affordable.' },
      { word: 'Subsidised', definition: 'Partly paid for by the government to make it more affordable for ordinary people.' },
      { word: 'Political will', definition: 'The determination of politicians to take action on a difficult issue, even when it is unpopular.' },
    ],
    questions: [
      { n: 7, q: 'Tokyo kept prices stable by making it easy to build. Why do you think other cities have not copied this approach?' },
      { n: 8, q: 'Several countries have banned foreign buyers. Is this fair? What message does it send, and are there unintended consequences?' },
      { n: 9, q: 'Vienna houses 60% of residents in subsidised housing. Could this model work in your country? What would it take?' },
    ]
  },
  {
    number: 4, title: 'Housing as a Human Right', emoji: '🏠', color: '#92400e',
    text: `At the heart of the housing crisis is a fundamental tension: is housing primarily a financial asset — something to be bought, sold, and profited from — or is it a basic human need that society has a responsibility to provide?\n\nFor most of the 20th century, housing policy in many countries treated shelter as a right. Governments built social housing, regulated rents, and ensured that adequate housing was available to people across the income spectrum. The post-war decades in the UK, for example, saw the construction of millions of council homes that provided affordable, secure housing for working-class families.\n\nFrom the 1980s onwards, this approach shifted dramatically. Governments sold off social housing, deregulated rental markets, and increasingly treated housing as a commodity — an investment vehicle rather than a social necessity. The financialisation of housing — treating homes as assets to be traded rather than places to live — has been identified by the United Nations as a primary driver of the global affordability crisis.\n\nThe consequences of this shift are now visible everywhere. Homelessness has increased in almost every wealthy country. Young adults live with their parents well into their thirties. Essential workers commute for hours because they cannot afford to live near their workplaces. And the gap between those who own property and those who do not has become one of the defining inequalities of the 21st century.\n\nThe housing crisis will not be solved by any single policy. It requires more construction, better regulation of investment and speculation, protection for tenants, and sustained investment in social housing. Above all, it requires a decision about what kind of society we want to live in — one in which housing is a right, or one in which it is a privilege available only to those who can afford it.`,
    vocab: [
      { word: 'Commodity', definition: 'Something that is bought and sold — treated as a product rather than a necessity.' },
      { word: 'Financialisation', definition: 'The process of turning something into a financial product to be traded for profit.' },
      { word: 'Deregulated', definition: 'Removed government rules and controls, allowing markets to operate more freely.' },
      { word: 'Inequality', definition: 'The unfair situation where some people have much more than others.' },
    ],
    questions: [
      { n: 10, q: 'Is housing a basic human right or a financial asset? Can it be both? What are the consequences of each view?' },
      { n: 11, q: 'The gap between property owners and renters is one of the defining inequalities of our time. How does this divide affect society?' },
      { n: 12, q: 'If you were in charge of housing policy in your country, what single change would you make first? Why?' },
    ]
  },
]
...
export default function HousingCrisisPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Global Housing Crisis</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Why young people everywhere cannot afford to buy a home — the causes, the consequences, and whether governments can fix the biggest financial crisis of a generation.</p>
            </div>
          </div>
