...
const PARTS = [
  {
    number: 1, title: 'What Is VAR and Why Was It Introduced?', emoji: '📺', color: '#3b82f6',
    text: `VAR — the Video Assistant Referee — is a technology system used in football to review decisions made by the on-field referee using video footage. Introduced into professional football from around 2016 and adopted in the English Premier League in 2019, VAR was designed to correct clear and obvious errors in four key decision categories: goals, penalty decisions, direct red card offences, and cases of mistaken identity. A team of officials based in a video review centre watches multiple camera angles in real time and can alert the on-field referee when a significant error appears to have been made.\n\nThe case for introducing VAR seemed compelling. Football had long suffered from high-profile errors — wrongly disallowed goals, penalties given for simulation, and red cards shown to the wrong player — that could decide the outcome of crucial matches, championships, and even relegation battles. Technology existed to address these mistakes, and most other major sports had already adopted some form of video review. Supporters argued that getting decisions right was simply more important than the speed of the game, and that VAR would remove the element of luck that had always allowed poor refereeing to influence results. The debate that followed its introduction, however, proved far more complicated than its supporters anticipated.`,
    vocab: [
      { word: 'Footage', definition: 'Recorded video — film captured by cameras that can be reviewed later.' },
      { word: 'Simulation', definition: 'Pretending to be fouled in order to win a penalty — also known as diving.' },
      { word: 'Relegation', definition: 'Being moved down to a lower division at the end of a season — the opposite of promotion.' },
      { word: 'Compelling', definition: 'Very convincing and difficult to argue against — a compelling case is one that seems obviously right.' },
    ],
    questions: [
      { n: 1, q: 'Before VAR, how much did refereeing errors affect the fairness of football in your opinion?' },
      { n: 2, q: 'Is getting every decision correct more important than keeping the game flowing quickly?' },
      { n: 3, q: 'Should football have adopted video review technology sooner — or not at all?' },
    ]
  },
  {
    number: 2, title: 'The Problems VAR Created', emoji: '⚠️', color: '#ef4444',
    text: `The introduction of VAR in the Premier League and other major competitions quickly exposed a series of problems that its designers had not fully anticipated. The most significant was time. VAR checks — particularly for offsides and penalty decisions — often took several minutes, leaving players standing still on the pitch and fans in the stadium unable to celebrate a goal that might be overturned. The spontaneous joy of a goal, one of the defining emotional experiences of football, was replaced by a period of anxious uncertainty that many fans found deeply unsatisfying.\n\nThe offside rule presented a particular challenge. VAR's ability to draw lines across freeze-frame images of players revealed that elite footballers were being flagged offside by millimetres — body parts invisible to the naked eye, caught in positions that neither the player nor any human official could have perceived in real time. Critics argued that this level of precision fundamentally misunderstood the purpose of the offside rule, which was designed to prevent players from gaining an unfair advantage — not to punish them for having an armpit fractionally ahead of a defender. The human element that had always been part of the game — imperfect but immediate — was being replaced by a technological precision that felt cold, legalistic, and often disconnected from the spirit of football.`,
    vocab: [
      { word: 'Spontaneous', definition: 'Happening naturally and immediately without planning — a spontaneous reaction is instinctive.' },
      { word: 'Freeze-frame', definition: 'A single still image taken from a video — used to examine a precise moment in time.' },
      { word: 'Fractionally', definition: 'By a very small amount — a fraction of a centimetre or second.' },
      { word: 'Legalistic', definition: 'Focused too narrowly on technical rules rather than common sense or the spirit of the law.' },
    ],
    questions: [
      { n: 4, q: 'Does waiting several minutes to celebrate a goal ruin the emotional experience of football for you?' },
      { n: 5, q: 'Should offside decisions be made with millimetre precision, or should there be a margin of error?' },
      { n: 6, q: 'Is there such a thing as "the spirit of the game" — or should rules simply be applied exactly as written?' },
    ]
  },
  {
    number: 3, title: 'Consistency, Controversy and Loss of Trust', emoji: '⚖️', color: '#f59e0b',
    text: `Perhaps the most damaging consequence of VAR has been its failure to deliver the consistency that justified its introduction. Football fans and pundits expected technology to remove subjectivity from decision-making — to replace human error with objective certainty. Instead, many VAR decisions have proved just as controversial as the ones they replaced. Penalty decisions in particular remain deeply divisive: whether a defender's arm was in a "natural" or "unnatural" position, whether contact inside the box constitutes a foul, and which goalkeeper movements are illegal during a penalty kick are all judgements that even trained officials watching multiple camera angles frequently disagree on.\n\nThe result has been a widespread sense that VAR has not made football fairer — it has simply moved the controversy from the pitch to the screen. Fans who once directed their frustration at the on-field referee now argue endlessly about what the VAR officials in the review centre should or should not have seen. The lack of transparency — officials in the review centre cannot be questioned and their reasoning is rarely explained in real time — has deepened distrust rather than reducing it. Several high-profile managers, including Jürgen Klopp and Pep Guardiola, have publicly expressed frustration with VAR's inconsistency, and fan protests against the technology have grown in scale and intensity across multiple leagues.`,
    vocab: [
      { word: 'Pundits', definition: 'Expert commentators who analyse and discuss sport on television or in the media.' },
      { word: 'Subjectivity', definition: 'Judgement based on personal opinion rather than objective fact — influenced by individual interpretation.' },
      { word: 'Divisive', definition: 'Causing strong disagreement and dividing people into opposing camps.' },
      { word: 'Transparency', definition: 'Openness about decisions and reasoning — making the process visible and understandable to everyone.' },
    ],
    questions: [
      { n: 7, q: 'Has VAR made football fairer, or has it simply moved the controversy to a different place?' },
      { n: 8, q: 'Should VAR officials explain their decisions publicly in real time, like cricket\'s DRS system?' },
      { n: 9, q: 'When technology creates more controversy rather than less, should it be abandoned?' },
    ]
  },
  {
    number: 4, title: 'The Future — Reform, Replace or Remove?', emoji: '🔮', color: '#22c55e',
    text: `The debate about VAR's future has intensified as fan dissatisfaction has grown. Several different proposals have emerged. Some advocate for scrapping VAR entirely and returning to the human referee as the sole authority — arguing that imperfect but immediate decisions are preferable to perfect but delayed ones. Others argue for a more limited use of VAR, restricting it to clear and obvious errors only and removing the detailed line-checking that has generated so much controversy. A third group supports technological reform — introducing semi-automated offside technology, clearer communication to fans in stadiums, and stricter time limits on reviews.\n\nBeyond football, the broader question raised by VAR is one that applies to many areas of modern life: does the pursuit of perfect accuracy always lead to better outcomes? Technology has an extraordinary ability to reveal truths that were previously invisible — but not every truth that can be revealed needs to be acted upon. A football match is a human contest, played and watched by human beings, in which the drama of uncertainty and the acceptance of imperfection have always been part of the experience. How football resolves its VAR dilemma may say something important about how society in general chooses to balance the promise of technology against the things we value that technology cannot measure.`,
    vocab: [
      { word: 'Scrapping', definition: 'Completely abandoning or getting rid of something — deciding to stop using it entirely.' },
      { word: 'Semi-automated', definition: 'Partly automated — using technology to assist human decision-making rather than replace it entirely.' },
      { word: 'Dilemma', definition: 'A situation requiring a difficult choice between two or more options, each with drawbacks.' },
      { word: 'Pursuit', definition: 'The act of trying to achieve or obtain something — the ongoing effort to reach a goal.' },
    ],
    questions: [
      { n: 10, q: 'If you could redesign VAR from scratch, what would you keep, change, or remove?' },
      { n: 11, q: 'Is the pursuit of perfect accuracy always a good thing — in sport or in life generally?' },
      { n: 12, q: 'Should VAR be kept, reformed, or removed from football entirely? Give your verdict and your strongest reason.' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "VAR and Technology in Football". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function VARFootballPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1e3a5f 0%, #3b82f6 100%)', padding: '56px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>VAR and Technology in Football</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Did Technology Fix the Beautiful Game — or Break It? Explore the controversy, the arguments, and the future of VAR in professional football.</p>
            </div>
          </div>
