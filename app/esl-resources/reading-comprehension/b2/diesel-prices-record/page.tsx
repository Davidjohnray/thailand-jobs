...
const PARTS = [
  {
    number: 1, title: 'The Fuel That Runs the World', emoji: '🚛', color: '#dc2626',
    text: `The price of diesel fuel hit an all-time record this week — and unlike petrol prices, which affect individual drivers, diesel prices affect absolutely everyone.\n\nDiesel is the fuel that moves the global economy. It powers the trucks that deliver food to supermarkets, the ships that carry goods across oceans, the trains that transport freight, the tractors that plough fields, the generators that provide backup electricity, and the construction equipment that builds cities. Without diesel, the modern world stops.\n\nThe price surge has two main causes. The ongoing US-Iran conflict has disrupted oil supplies through the Strait of Hormuz, reducing the amount of crude oil available for refining. And Ukrainian drone attacks on Russian oil refineries — which intensified this summer — have reduced Russia\'s capacity to produce refined diesel, removing millions of barrels from the global market.\n\nThe combination is creating a supply squeeze that is pushing prices to levels never seen before. In Europe, diesel has surpassed three euros per litre in several countries. In the United States, the national average has exceeded six dollars per gallon. And in countries that import most of their fuel — including many in Southeast Asia — the impact on household budgets is severe.`,
    vocab: [
      { word: 'Refined', definition: 'Processed from crude oil into usable fuels — turned from raw material into a finished product.' },
      { word: 'Supply squeeze', definition: 'When supply falls below demand, pushing prices up — not enough product to go around.' },
      { word: 'Crude oil', definition: 'Unprocessed oil as it comes from the ground — before being refined into petrol or diesel.' },
      { word: 'Freight', definition: 'Goods transported in bulk by truck, ship, train, or aircraft — commercial cargo.' },
    ],
    questions: [
      { n: 1, q: 'Diesel powers trucks, ships, trains, and tractors. Why does a diesel price increase affect everyone, not just truck drivers?' },
      { n: 2, q: 'Two separate conflicts — Iran and Ukraine — are both pushing diesel prices up. How do distant wars affect fuel prices in your country?' },
      { n: 3, q: 'Diesel has passed three euros per litre in Europe. How would you change your behaviour if fuel prices doubled?' },
    ]
  },
  {
    number: 2, title: 'The Price Chain', emoji: '📈', color: '#b91c1c',
    text: `When diesel prices rise, the effects cascade through every sector of the economy — a process economists call "cost pass-through."\n\nTransport is the first link in the chain. When diesel costs more, it costs more to drive a truck from a warehouse to a supermarket. Trucking companies pass this cost to retailers by charging higher delivery fees. Retailers pass it to consumers by raising prices on the shelf. A 20% increase in diesel can produce a 3-5% increase in food prices — which for families already struggling with the cost of living, can mean the difference between eating well and going without.\n\nManufacturing is the second link. Factories that use diesel-powered equipment face higher operating costs. Construction companies pay more for excavators, cranes, and generators. Farmers pay more for tractors, irrigation pumps, and harvest equipment. Each of these costs is ultimately passed to consumers in the form of higher prices for goods and services.\n\nAir travel is indirectly affected too. While planes run on jet fuel rather than diesel, jet fuel and diesel are both refined from crude oil. When crude oil prices rise, both fuels become more expensive. Airlines raise ticket prices, reducing demand for travel and affecting tourism-dependent economies.\n\nThe overall effect is inflationary — higher diesel prices push up the cost of virtually everything. Central banks then face a dilemma: raise interest rates to control inflation (which slows the economy and increases unemployment) or keep rates low and risk inflation spiralling further. There are no good options.`,
    vocab: [
      { word: 'Cost pass-through', definition: 'When businesses transfer increased costs to their customers through higher prices.' },
      { word: 'Inflationary', definition: 'Causing general price increases across the economy — reducing the buying power of money.' },
      { word: 'Central banks', definition: 'National institutions that manage a country money supply and interest rates.' },
      { word: 'Spiralling', definition: 'Getting worse in a continuous, accelerating cycle — out of control.' },
    ],
    questions: [
      { n: 4, q: 'A 20% diesel increase causes 3-5% food price increase. How does this chain reaction work for other products?' },
      { n: 5, q: 'Central banks must choose between fighting inflation and avoiding recession. Which is worse?' },
      { n: 6, q: 'Thailand depends heavily on imported fuel. How does the global diesel crisis affect the Thai economy?' },
    ]
  },
  {
    number: 3, title: 'Who Suffers Most?', emoji: '⚖️', color: '#991b1b',
    text: `Like most economic shocks, rising diesel prices hit the poorest people hardest.\n\nIn wealthy countries, higher fuel prices are an inconvenience. People may drive less, switch to public transport, or cut back on discretionary spending. The impact is real but manageable for most households.\n\nIn developing countries, the impact can be catastrophic. Families that already spend 60-80% of their income on food and transport have no margin for price increases. When food prices rise because of higher diesel costs, the choice is not between eating out and cooking at home — it is between eating and not eating. When transport costs rise, the choice is not between driving and walking — it is between getting to work and losing your job.\n\nThe geographic inequality is stark. Oil-producing countries — Saudi Arabia, the UAE, Russia, Norway — benefit from high prices. Their economies grow, their government revenues increase, and their citizens are insulated from the costs that others bear. Oil-importing countries — Thailand, Japan, India, most of Europe — suffer. They pay more for the energy they cannot produce domestically, and the wealth transfer from importers to exporters widens the global inequality gap.\n\nWithin countries, the same pattern applies. Rural communities, where diesel is essential for agriculture and transport distances are long, are hit harder than urban areas with public transport alternatives. And industries that cannot pass costs to consumers — small farms, independent truckers, local shops — face the possibility of bankruptcy.`,
    vocab: [
      { word: 'Discretionary', definition: 'Optional spending — things you choose to buy but do not need, like entertainment or eating out.' },
      { word: 'Margin', definition: 'The amount of extra money or room for manoeuvre — the gap between surviving and failing.' },
      { word: 'Insulated', definition: 'Protected from negative effects — shielded from harm.' },
      { word: 'Wealth transfer', definition: 'The movement of money from one group to another — resources shifting between countries or classes.' },
    ],
    questions: [
      { n: 7, q: 'Poor families spend 80% on food and transport. A diesel price rise can mean not eating. How should governments respond?' },
      { n: 8, q: 'Oil-producing countries benefit while importing countries suffer. Is this fair? What can be done about it?' },
      { n: 9, q: 'Rural communities are hit harder than cities. How can governments ensure that rural areas are not left behind?' },
    ]
  },
  {
    number: 4, title: 'Beyond Diesel', emoji: '🔋', color: '#7f1d1d',
    text: `The diesel price crisis strengthens an argument that has been building for years: the world needs to reduce its dependence on fossil fuels — not just for climate reasons, but for economic security.\n\nEvery diesel price shock delivers the same lesson. Dependence on a single energy source that is concentrated in a few countries, transported through vulnerable chokepoints, and subject to disruption by conflict creates permanent economic insecurity. As long as the global economy runs on diesel, it will be held hostage by whoever controls the supply.\n\nThe alternatives are developing rapidly. Electric trucks are entering commercial service in Europe and the United States. Hydrogen fuel cells are being tested for long-haul transport. Biofuels — diesel substitutes made from plant materials — are expanding production capacity. Solar-powered electric tractors are being piloted for agriculture.\n\nBut the transition is slow — far too slow for the crisis happening now. Electric trucks currently account for less than 1% of the global truck fleet. Hydrogen infrastructure barely exists. And biofuel production cannot scale quickly enough to replace diesel in the short term.\n\nFor countries like Thailand, the diesel crisis underscores the urgency of energy diversification. Every baht invested in solar panels, electric vehicles, and energy efficiency reduces the country\'s vulnerability to the next price shock — which, given the state of global politics, could come at any time.\n\nThe diesel price record set this week will eventually be broken by a new record. The question is whether the world will still be running on diesel when it happens.`,
    vocab: [
      { word: 'Chokepoints', definition: 'Narrow passages through which traffic must pass — blocking them disrupts supply.' },
      { word: 'Hostage', definition: 'Held captive — unable to act freely because someone else has control.' },
      { word: 'Biofuels', definition: 'Fuels made from plant materials or organic waste — renewable alternatives to fossil fuels.' },
      { word: 'Diversification', definition: 'Spreading across multiple sources — not depending on just one.' },
    ],
    questions: [
      { n: 10, q: 'Every diesel crisis teaches the same lesson: reduce dependence on fossil fuels. Why does the world keep failing to learn it?' },
      { n: 11, q: 'Electric trucks are coming but account for less than 1% of the fleet. How do you speed up the transition?' },
      { n: 12, q: 'Thailand depends on imported fuel. What energy investments would make the country most resilient to future price shocks?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Diesel Prices Hit an All-Time Record". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Diesel Prices Hit an All-Time Record</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Diesel prices reached an all-time high this week, driven by the Iran conflict and Ukrainian attacks on Russian refineries. Why diesel matters more than petrol and who pays the price.</p>
            </div>
          </div>
