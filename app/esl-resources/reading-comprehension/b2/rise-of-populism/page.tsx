...
const PARTS = [
  {
    number: 1, title: 'A Continent Shifts Right', emoji: '🗳️', color: '#dc2626',
    text: `On 1 August 2026, Colombia elected a far-right populist president in one of the most consequential elections in Latin American history. The winner, backed by US President Donald Trump, campaigned on promises of cracking down on crime, fighting corruption, and restoring traditional values. The result sent shockwaves across the region and added Colombia to a growing list of countries where populist, nationalist movements are gaining power.\n\nColombia has traditionally been one of the most stable democracies in Latin America, with a strong two-party system and close ties to the United States. The election of a far-right leader represents a dramatic departure from the country's political centre and reflects a pattern that is visible across the world — from Europe to the Americas to parts of Asia.\n\nThe rise of populist leaders is not a regional phenomenon — it is a global one. In the United States, Donald Trump won back the presidency in 2024. In Italy, Giorgia Meloni leads a right-wing coalition government. In Argentina, Javier Milei won the presidency on a radical libertarian platform. In India, Narendra Modi has consolidated power with a Hindu nationalist agenda. In Europe, parties like Reform UK, France's National Rally, and Germany's Alternative for Germany have surged in polls and elections.\n\nWhat connects these movements across different countries and cultures? Why are voters in such different places choosing similar types of leaders? And what does this trend mean for democracy, human rights, and international cooperation? These are among the most important questions in global politics today.`,
    vocab: [
      { word: 'Populist', definition: 'A political style that claims to represent ordinary people against a corrupt elite or establishment.' },
      { word: 'Consequential', definition: 'Having important results or effects — significant and far-reaching.' },
      { word: 'Departure', definition: 'A move away from the usual or expected course — a significant change from what came before.' },
      { word: 'Consolidated', definition: 'Strengthened and made more secure — brought different elements together under firm control.' },
    ],
    questions: [
      { n: 1, q: 'Far-right leaders are gaining power across the world. Why do you think this trend is happening in so many different countries at the same time?' },
      { n: 2, q: 'The passage lists populist leaders in the US, Italy, Argentina, and India. What do these leaders have in common? How are they different?' },
      { n: 3, q: 'Is the rise of populism a threat to democracy, or is it democracy working exactly as it should — giving people what they vote for?' },
    ]
  },
  {
    number: 2, title: 'Why Voters Are Angry', emoji: '😤', color: '#b91c1c',
    text: `The rise of populism is driven by genuine grievances that mainstream political parties have failed to address. Understanding these grievances is essential for understanding why so many people are choosing radical alternatives.\n\nEconomic frustration is the most commonly cited factor. In many countries, wages have stagnated while the cost of housing, healthcare, and education has risen sharply. The benefits of globalisation and technological progress have been unevenly distributed — with highly educated professionals in major cities doing well, while working-class communities in smaller towns and rural areas have seen their industries decline, their jobs disappear, and their living standards fall. For these voters, mainstream parties that promised prosperity but delivered precarity feel like part of the problem, not the solution.\n\nImmigration is another powerful driver. In Europe and the United States, large-scale immigration has become one of the most divisive political issues of the century. Populist leaders have been extraordinarily effective at connecting economic anxiety to immigration — arguing that immigrants take jobs, suppress wages, strain public services, and threaten national identity. Whether or not these claims are supported by evidence, they resonate powerfully with voters who feel that their concerns have been dismissed or ignored by mainstream politicians.\n\nCultural anxiety plays a role too. Rapid social change — around gender identity, racial equality, religious diversity, and traditional values — has left many voters feeling that the world they grew up in is disappearing. Populist leaders offer a simple, emotionally compelling message: we will protect your way of life against the forces that are trying to change it.\n\nFinally, there is a deep and widespread distrust of institutions — governments, media, experts, and international organisations. Populist leaders exploit this distrust, positioning themselves as outsiders who will fight the corrupt establishment on behalf of ordinary people.`,
    vocab: [
      { word: 'Grievances', definition: 'Feelings of unfairness or injustice — complaints about how you have been treated.' },
      { word: 'Stagnated', definition: 'Stopped growing or developing — remaining at the same level without improvement.' },
      { word: 'Precarity', definition: 'A state of insecurity and uncertainty about the future, especially regarding jobs and income.' },
      { word: 'Resonate', definition: 'To produce a strong emotional response — to feel meaningful and personally relevant.' },
    ],
    questions: [
      { n: 4, q: 'The passage lists four drivers of populism: economic frustration, immigration, cultural anxiety, and distrust of institutions. Which do you think is most powerful?' },
      { n: 5, q: 'Populist leaders connect economic anxiety to immigration. Is this connection fair? What does the evidence actually show?' },
      { n: 6, q: 'Many voters feel mainstream parties have failed them. Do you think this is true? What should mainstream parties do differently?' },
    ]
  },
  {
    number: 3, title: 'The Populist Playbook', emoji: '📖', color: '#991b1b',
    text: `Despite their differences, populist leaders around the world tend to use remarkably similar strategies. Understanding these strategies is important for anyone who wants to think critically about the political messages they encounter.\n\nThe first strategy is simplification. Complex problems are reduced to simple narratives with clear villains — immigrants, the elite, the media, the previous government, international institutions. The appeal of simplification is powerful: in a world that feels confusing and threatening, the promise that one person or one policy can fix everything is deeply attractive, even when it is unrealistic.\n\nThe second strategy is division. Populist leaders divide society into "the people" and "the enemy" — and define both in ways that serve their agenda. "The people" are the hardworking, honest majority. "The enemy" is whoever the leader needs to blame — journalists, judges, academics, minorities, or foreign governments. This us-versus-them framing creates intense loyalty among supporters and makes criticism of the leader feel like an attack on "the people" themselves.\n\nThe third strategy is the erosion of democratic norms. Once in power, populist leaders frequently attack the institutions that are designed to hold them accountable — the courts, the free press, independent regulators, and parliamentary oversight. They do this not by abolishing these institutions outright, but by undermining their credibility, replacing their leaders with loyalists, and portraying any opposition as illegitimate.\n\nThe fourth strategy is emotional communication. Populist leaders communicate through emotion rather than policy detail. They use rallies, social media, and direct language that bypasses traditional media and connects directly with supporters. The content is often less important than the feeling — anger, pride, fear, belonging.`,
    vocab: [
      { word: 'Simplification', definition: 'Making something appear simpler than it really is — reducing complexity to a basic narrative.' },
      { word: 'Us-versus-them', definition: 'A way of thinking that divides people into two opposing groups — insiders and outsiders.' },
      { word: 'Democratic norms', definition: 'The unwritten rules and traditions that make democracy work — fair elections, free press, independent courts.' },
      { word: 'Undermining', definition: 'Gradually weakening or damaging something from the inside — making it less effective or credible.' },
    ],
    questions: [
      { n: 7, q: 'The passage describes four populist strategies. Can you identify examples of any of these being used by political leaders you know about?' },
      { n: 8, q: 'Populist leaders attack courts, media, and regulators. Why are these institutions so important for democracy?' },
      { n: 9, q: 'Populism communicates through emotion rather than policy. Why is this effective? How can voters protect themselves from emotional manipulation?' },
    ]
  },
  {
    number: 4, title: 'What Comes Next?', emoji: '🔮', color: '#7f1d1d',
    text: `The global rise of populism raises urgent questions about the future of democracy. Some analysts argue that populism is a temporary reaction to specific economic and social conditions — and that once those conditions improve, voters will return to mainstream politics. Others argue that something more fundamental has changed, and that the era of centrist, consensus-based democracy that defined the late 20th century is over.\n\nThe optimistic view is that populism, for all its dangers, is also a corrective. It forces mainstream parties to listen to voters they have ignored, to address grievances they have dismissed, and to reconnect with communities they have abandoned. The anger that drives populism is not irrational — it is a response to real failures of governance. If mainstream parties learn from these failures, democracy can emerge stronger.\n\nThe pessimistic view is that populism, once it takes root, is difficult to reverse. Leaders who erode democratic institutions, normalise division, and concentrate power create conditions that make it harder for democracy to function — which in turn creates more frustration, which benefits more populists. This downward spiral, visible in countries from Hungary to Venezuela, is the greatest risk.\n\nWhat is clear is that the old assumption — that liberal democracy would spread inevitably across the world — has been decisively challenged. Democracy is not a destination that, once reached, is permanent. It is a system that must be actively maintained, defended, and adapted to changing circumstances.\n\nThe Colombian election is one more data point in a global trend. Whether that trend leads to the renewal of democracy or its erosion depends on choices that citizens, leaders, and institutions make in the years ahead. Understanding populism — its causes, its strategies, and its consequences — is essential preparation for making those choices wisely.`,
    vocab: [
      { word: 'Corrective', definition: 'Something that fixes or improves a problem — a necessary adjustment.' },
      { word: 'Normalise', definition: 'To make something seem normal and acceptable that was previously considered unacceptable.' },
      { word: 'Liberal democracy', definition: 'A political system with free elections, individual rights, rule of law, and separation of powers.' },
      { word: 'Decisively', definition: 'In a way that settles a question clearly and leaves no doubt.' },
    ],
    questions: [
      { n: 10, q: 'Is populism a temporary reaction or a permanent change in politics? Which view do you find more convincing, and why?' },
      { n: 11, q: 'The passage says democracy must be actively maintained. What does this mean in practice? What can ordinary citizens do to protect democracy?' },
      { n: 12, q: 'Is there a populist movement in your country? If so, what is driving it? If not, why do you think your country has been different?' },
    ]
  },
]
...
export default function PopulismPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Colombia and the Global Rise of Populism</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Colombia elected a far-right president this week, joining a global wave of populism. Why are voters choosing radical leaders, and what does it mean for democracy?</p>
            </div>
          </div>
