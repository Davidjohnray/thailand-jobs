...
const PARTS = [
  {
    number: 1, title: 'The Phenomenon and Its History', emoji: '🔥', color: '#ef4444',
    text: `Spontaneous human combustion — or SHC — refers to cases in which a human body appears to have caught fire and burned, often severely or completely, without any apparent external source of ignition. The term "spontaneous" implies that the fire originated from within the body itself, without being set by any outside flame, spark, or heat source. It is one of the most disputed and sensational topics in the history of paranormal investigation, and one that has generated fierce debate between believers in the genuinely inexplicable and scientists who insist that every recorded case has a rational explanation.\n\nReports of SHC stretch back centuries. One of the earliest well-documented accounts dates to 1663 and concerns a Danish physician named Thomas Bartholin, who described a woman in Paris whose body was said to have been found reduced to ash while her straw mattress remained entirely unburned. Cases proliferated throughout the eighteenth and nineteenth centuries, when SHC attracted considerable popular and even scientific attention. Charles Dickens famously used the phenomenon as a plot device in his 1852 novel Bleak House, in which a character named Krook dies by what Dickens explicitly described as spontaneous combustion — a decision that provoked public controversy at the time.\n\nThe defining features reported in classic SHC cases are both distinctive and deeply puzzling. The victim's body — or large portions of it — is reduced to ash or heavily charred, while surrounding objects, including highly flammable materials like furniture, curtains, or carpets, show little or no damage. The fire appears to have been extraordinarily intense where the body was located but entirely contained within a very small area. And in many cases, the victim's extremities — hands, feet, or legs — are left largely intact, even while the torso and head are consumed.`,
    vocab: [
      { word: 'Ignition', definition: 'The process of catching fire or causing something to start burning.' },
      { word: 'Proliferated', definition: 'Increased rapidly in number; spread and multiplied over a short period of time.' },
      { word: 'Charred', definition: 'Partially burned so that the surface has become black.' },
      { word: 'Extremities', definition: 'The hands and feet, or the outermost parts of the body.' },
    ],
    questions: [
      { n: 1, q: 'Before reading this, had you heard of spontaneous human combustion? What did you believe about it?' },
      { n: 2, q: 'Why do you think Charles Dickens chose SHC as a plot device, and why did it provoke public controversy?' },
      { n: 3, q: 'The defining feature is that the body burns intensely while surrounding objects remain undamaged. Why is this so puzzling from a scientific perspective?' },
    ]
  },
  {
    number: 2, title: 'Famous Cases', emoji: '🕵️', color: '#dc2626',
    text: `The most forensically scrutinised SHC case in modern history is that of Mary Reeser, a 67-year-old woman from St. Petersburg, Florida, whose remains were discovered on 2 July 1951. Her neighbour became concerned when she touched the door handle to Mrs. Reeser's apartment and found it unusually hot. When investigators entered, they found almost nothing remaining of Mrs. Reeser except a skull — which had shrunk to the size of a teacup — a vertebra, a foot still wearing a slipper, and a small pile of ash. The apartment itself showed only minor smoke damage, and a nearby stack of newspapers was undamaged. The FBI investigated the case and ultimately concluded that Mrs. Reeser, who had taken sleeping pills and was known to smoke, had likely fallen asleep with a lit cigarette. The case remains one of the most discussed in SHC literature.\n\nIn 2010, a case in County Tipperary, Ireland attracted international attention when coroner Ciaran McLoughlin made the remarkable decision to record the death of 76-year-old Michael Faherty as spontaneous human combustion — the first time an Irish coroner had used the term officially. Mr. Faherty's body was found severely burned near a fireplace in his home. Investigators found no accelerants and no evidence of foul play. The Irish coroner's conclusion was widely criticised by scientists, who argued that the fire in the fireplace provided a sufficient ignition source to explain the body's condition.\n\nIn 2012, a woman in Sspontin, Belgium was found with severe burns on her abdomen while the rest of her body and clothing were undamaged. No external fire source could be identified in the immediate area. The case was investigated by Belgian police and remains officially unexplained, though researchers have proposed several alternative explanations involving static electricity and methane gas produced by the digestive system.`,
    vocab: [
      { word: 'Scrutinised', definition: 'Examined very carefully and thoroughly, looking for details or problems.' },
      { word: 'Vertebra', definition: 'One of the small bones that form the spine or backbone.' },
      { word: 'Accelerants', definition: 'Substances used to help start or spread a fire, such as petrol or lighter fluid.' },
      { word: 'Foul play', definition: 'Criminal or violent activity that causes harm or death; used especially in investigations.' },
    ],
    questions: [
      { n: 4, q: 'The FBI concluded Mary Reeser likely fell asleep with a lit cigarette. Does this explanation satisfy you? What questions does it leave unanswered?' },
      { n: 5, q: 'Should a coroner ever officially record a death as "spontaneous human combustion"? What are the implications of doing so?' },
      { n: 6, q: 'Why do you think cases involving burns on the body with no identified fire source continue to attract so much attention?' },
    ]
  },
  {
    number: 3, title: 'The Science of Human Burning', emoji: '🔬', color: '#b91c1c',
    text: `The scientific community is unanimous in its scepticism about spontaneous human combustion as a genuine phenomenon. The central objection is thermodynamic: the human body is approximately 60 to 70 percent water, and for a body to burn spontaneously — without an external heat source of extraordinary intensity — would require a fundamental violation of the laws of thermodynamics. The body simply does not contain sufficient energy in a form that could produce the kind of combustion described in SHC cases.\n\nThe most widely accepted scientific explanation for cases that display SHC-like characteristics is the "wick effect." Proposed by forensic scientist John DeHaan in the 1990s, this theory holds that human body fat, once ignited by an external source such as a cigarette, a candle, or a flame, can behave like the wax in a candle. Clothing or hair acts as the wick; body fat melts and is drawn up through the wick, sustaining a slow-burning flame for many hours. This low-temperature, sustained burn can consume a body almost entirely while producing relatively little heat at a distance — which would explain why surrounding objects remain largely undamaged.\n\nExperimental evidence for the wick effect is robust. Forensic scientists have successfully replicated the conditions of SHC cases using pig carcasses — which have a fat composition similar to humans — ignited with a small external flame. The results closely match the patterns reported in SHC cases: extensive destruction of the body, intact extremities, localised damage to the immediate area.\n\nCritics of the wick effect theory point to cases in which no obvious external ignition source can be identified. However, sceptics of SHC note that in many of these cases, investigators cannot rule out an ignition source simply because the fire itself destroys the evidence of how it started.`,
    vocab: [
      { word: 'Thermodynamics', definition: 'The branch of physics that deals with the relationships between heat, energy, and work.' },
      { word: 'Combustion', definition: 'The process of burning — a chemical reaction between a substance and oxygen that produces heat and light.' },
      { word: 'Wick effect', definition: 'A theory in which human body fat acts like candle wax, sustained by a slow-burning external flame.' },
      { word: 'Replicated', definition: 'Repeated an experiment or process in order to confirm or test the original results.' },
    ],
    questions: [
      { n: 7, q: 'How convincing do you find the wick effect as an explanation for SHC? What are its strengths and weaknesses?' },
      { n: 8, q: 'The body is 60-70% water. Why does this make the idea of spontaneous combustion scientifically implausible?' },
      { n: 9, q: 'Scientists used pig carcasses to test the wick effect. Do you think experimental replication of this kind is sufficient to close the debate? Why or why not?' },
    ]
  },
  {
    number: 4, title: 'Why the Myth Persists', emoji: '🧠', color: '#991b1b',
    text: `If the scientific consensus is so firmly against spontaneous human combustion as a genuine phenomenon, why does it continue to captivate the public imagination? The answer involves a complex interplay of psychological, cultural, and epistemological factors that tell us as much about human nature as they do about fire.\n\nPart of the explanation lies in the visceral horror of the concept itself. The idea that the human body could suddenly and inexplicably burst into flames — without warning, without an identifiable cause, and apparently without any means of prevention — touches on some of the deepest anxieties of embodied existence. It transforms the body from a source of safety and continuity into a potential threat. This kind of existential horror is extraordinarily compelling in a way that prosaic explanations, however accurate, rarely match.\n\nThe media also plays a significant role. Reports of SHC cases have historically emphasised the most dramatic and inexplicable elements while downplaying or ignoring the mundane explanations that investigators eventually arrive at. The headline "Woman dies in mysterious fire" is far more arresting than "Woman falls asleep with cigarette and dies in slow-burning house fire," even when both describe the same event. The cumulative effect of decades of sensationalised reporting has created a cultural memory of SHC as an established, documented phenomenon.\n\nThere is also a genuine epistemological question here. Science explains SHC cases by reference to processes — the wick effect, cigarettes, candles — that themselves require an initial ignition source. In cases where that source cannot be identified, science cannot say with certainty what happened; it can only say that spontaneous combustion is not the answer. For some people, this gap between "we don\'t know" and "it definitely wasn\'t SHC" remains a space in which the mysterious is allowed to persist. And that, perhaps, is where all genuinely compelling mysteries ultimately live.`,
    vocab: [
      { word: 'Epistemological', definition: 'Relating to epistemology — the branch of philosophy concerned with the nature and limits of human knowledge.' },
      { word: 'Visceral', definition: 'Relating to deep, instinctive feelings rather than rational thought; intensely physical or emotional.' },
      { word: 'Prosaic', definition: 'Commonplace; lacking any special interest or originality; straightforwardly ordinary.' },
      { word: 'Sensationalised', definition: 'Presented in a way that is deliberately dramatic or shocking, often at the expense of accuracy.' },
    ],
    questions: [
      { n: 10, q: 'The passage argues that the concept of SHC "touches on deep anxieties of embodied existence." What does this mean, and do you agree?' },
      { n: 11, q: 'How responsible do you think media reporting is for the persistence of myths like SHC? Can you think of other examples where media has shaped public belief?' },
      { n: 12, q: 'The passage ends by saying that mysteries "live" in the gap between "we don\'t know" and "it definitely wasn\'t X." Is uncertainty itself a kind of knowledge? What do we do with things we cannot explain?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B2 upper-intermediate student practise discussion skills. The reading topic is "Spontaneous Human Combustion — Fact, Fiction, or Science?". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B2-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#fff7f7', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && (
        <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #fee2e2' }}>
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && (
                  <div style={{ background: '#fff7f7', border: '1px solid #fecaca', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}>
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid #fee2e2', display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
...
export default function SHCPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1c0505 0%, #7f1d1d 50%, #991b1b 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(239,68,68,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Mystery & the Unknown</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Spontaneous Human Combustion</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Bodies reduced to ash while surrounding furniture remains intact. A phenomenon that has baffled investigators for centuries — and what science says really happened.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab, questions & AI answers', '🤖 Practice with AI'].map((step, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#555', fontSize: '13px' }}>
                <span style={{ background: '#ef4444', color: 'white', width: '18px', height: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold', flexShrink: 0 }}>{i + 1}</span>
                {step}
              </div>
            ))}
          </div>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#ef4444' : '#e5e7eb', background: translationLang !== 'none' ? '#fff7f7' : 'white', color: translationLang !== 'none' ? '#991b1b' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#fff7f7', padding: '8px 28px', borderBottom: '1px solid #fecaca' }}>
                    ...
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && (
                          <div style={{ marginTop: '6px', background: '#fff7f7', border: '1px solid #fecaca', borderRadius: '8px', padding: '8px 12px' }}>
                            <span style={{ color: '#991b1b', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
            ...
            <div style={{ background: '#1a1a2e', padding: '20px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                ...
                <span style={{ color: '#fca5a5', fontWeight: 'bold', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>Discussion Questions</span>
              </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b2" style={{ color: '#ef4444', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B2 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fecaca', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#fff7f7', color: '#991b1b', border: '2px solid #fecaca', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fff7f7', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fecaca', color: '#9ca3af', fontSize: '15px' }}>
                {translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}
              </div>
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#fff7f7', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fecaca' }}>
                ...
                {translationLang !== 'none' && lookupTranslation && (
                  <div style={{ background: '#fff7f7', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fca5a5' }}>
                    <div style={{ color: '#dc2626', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>{currentLang?.label} Translation</div>
