...
const PARTS = [
  {
    number: 1, title: 'The People Building AI Say Stop', emoji: '🛑', color: '#dc2626',
    text: `In a remarkable joint appearance this week, the CEOs of Anthropic and OpenAI — the two companies at the forefront of artificial intelligence development — both called for AI development to slow down. Dario Amodei (Anthropic) and Sam Altman (OpenAI) told a Senate committee that the pace of AI advancement is outstripping society ability to manage its risks.\n\nThe testimony was striking for its candour. "We are building systems that we do not fully understand," Amodei said. "The capabilities of these models are increasing faster than our ability to test, evaluate, and control them." Altman echoed the sentiment: "The technology is moving incredibly fast. We need governance frameworks before the next generation of models, not after."\n\nSimultaneously, OpenAI announced it would delay its planned initial public offering (IPO) — reportedly because internal evaluations of GPT-6 revealed capabilities that the company itself found concerning. The cybersecurity risks alone were classified as "Critical" — meaning the model could potentially enable sophisticated attacks on computer systems.\n\nThe apparent contradiction — building the technology while warning about its dangers — drew sharp criticism. "This is like a tobacco company CEO testifying that smoking causes cancer while selling cigarettes in the lobby," said one technology ethicist. Others argued that the CEOs were being genuinely responsible — using their unique position to advocate for regulation that they cannot implement unilaterally.`,
    vocab: [
      { word: 'Outstripping', definition: 'Moving faster than — advancing beyond the ability to keep up.' },
      { word: 'Candour', definition: 'Honest and open speech — saying what you really think without hiding anything.' },
      { word: 'Governance frameworks', definition: 'Systems of rules and oversight designed to manage a technology or industry.' },
      { word: 'Unilaterally', definition: 'Done by one side alone — without agreement or cooperation from others.' },
    ],
    questions: [
      { n: 1, q: 'AI CEOs say development should slow down while their companies keep building. Is this hypocrisy or responsibility?' },
      { n: 2, q: 'OpenAI delayed its IPO because GPT-6 capabilities were concerning. Should companies release products they find worrying?' },
      { n: 3, q: 'One critic compared this to a tobacco CEO warning about cancer while selling cigarettes. Is this a fair comparison?' },
    ]
  },
  {
    number: 2, title: 'The Prisoner Dilemma', emoji: '🔄', color: '#b91c1c',
    text: `The AI CEOs face a genuine strategic dilemma — one that economists call the "prisoner dilemma."\n\nIf all AI companies slow down simultaneously, safety improves and nobody loses competitive advantage. But if one company slows down while others continue, the cautious company loses market share, talent, and potentially its existence — while the risk to society remains unchanged because other companies keep pushing forward.\n\nThis is why both CEOs called for regulation rather than voluntary restraint. Regulation creates a level playing field — all companies must follow the same rules, so no individual company is penalised for being cautious. Without regulation, the competitive pressure to build faster, bigger, and more powerful models is irresistible.\n\nThe international dimension makes this even harder. Even if US companies slow down, Chinese AI labs — which operate under different regulatory frameworks and different political pressures — may not. The fear of falling behind China is one of the most powerful arguments against any kind of AI slowdown in the United States.\n\nBut some researchers argue that the prisoner dilemma framing is itself the problem. "If you are building something that could be catastrophically dangerous, the correct response is not to negotiate a regulatory framework while continuing to build," said one AI safety researcher. "The correct response is to stop building until you know it is safe." The companies, unsurprisingly, disagree.`,
    vocab: [
      { word: 'Prisoner dilemma', definition: 'A situation where acting in your own interest produces a worse outcome for everyone.' },
      { word: 'Level playing field', definition: 'A situation where everyone follows the same rules — fair competition.' },
      { word: 'Irresistible', definition: 'Impossible to resist — too powerful to fight against.' },
      { word: 'Catastrophically', definition: 'In a way that causes extreme disaster — the worst possible outcome.' },
    ],
    questions: [
      { n: 4, q: 'If one company slows down and others do not, the cautious company loses. How do you solve this collective action problem?' },
      { n: 5, q: 'Both CEOs want regulation rather than voluntary restraint. Is this genuine, or are they asking for rules they know will be slow to arrive?' },
      { n: 6, q: 'Some say the correct response to danger is to stop building, not to regulate while continuing. Who is right?' },
    ]
  },
  {
    number: 3, title: 'What Are They Afraid Of?', emoji: '😰', color: '#991b1b',
    text: `When the people building the most powerful AI systems in history say they are worried, it is worth asking: what exactly are they afraid of?\n\nThe near-term concerns are concrete. AI systems can already generate convincing fake images, audio, and video — enabling disinformation campaigns, fraud, and identity theft at unprecedented scale. They can write malware that exploits software vulnerabilities. They can be used to plan and coordinate attacks. GPT-6 cybersecurity classification as "Critical" means that in the wrong hands, it could enable sophisticated cyberattacks that currently require teams of expert hackers.\n\nThe medium-term concerns are about autonomy. As AI systems become more capable, they are given more autonomy — the ability to take actions in the world without direct human oversight. An AI agent that can browse the internet, write and execute code, and make decisions independently is extraordinarily useful — and extraordinarily dangerous if its goals are misaligned with human welfare.\n\nThe long-term concern — the one that keeps AI safety researchers awake at night — is about superintelligence. If AI systems eventually exceed human intelligence across all domains, they could pursue objectives that humans cannot predict, control, or reverse. This is not science fiction — it is a genuine concern shared by many of the world leading AI researchers, including the people building the systems.\n\nThe CEOs testimony this week was, in essence, a warning: we are closer to these risks than the public realises, and the systems we need to manage them do not yet exist.`,
    vocab: [
      { word: 'Disinformation', definition: 'Deliberately false information spread to deceive people — fake news created on purpose.' },
      { word: 'Malware', definition: 'Software designed to damage, disrupt, or gain unauthorised access to computer systems.' },
      { word: 'Autonomy', definition: 'The ability to act independently — making decisions without human direction.' },
      { word: 'Misaligned', definition: 'Not matching — when AI goals do not correspond to what humans actually want.' },
    ],
    questions: [
      { n: 7, q: 'AI can generate convincing fakes and write malware. Are we prepared for these near-term risks?' },
      { n: 8, q: 'AI agents that browse the internet and make decisions independently — useful but dangerous. How do you control something that acts on its own?' },
      { n: 9, q: 'The people building AI are warning about superintelligence. Should we take this seriously, or is it hype?' },
    ]
  },
  {
    number: 4, title: 'Who Decides the Future?', emoji: '🗳️', color: '#7f1d1d',
    text: `The most important question raised by the AI CEOs testimony is not technical — it is democratic. Who gets to decide how the most transformative technology in human history is developed?\n\nCurrently, those decisions are made by a small number of companies, led by a small number of people, funded by a small number of investors. The public — which will be affected by AI more profoundly than by any technology since electricity — has almost no say in how it is built, what it is used for, or what risks are acceptable.\n\nThis is not how democracies are supposed to work. When nuclear energy was developed, governments created regulatory bodies, international treaties, and public oversight mechanisms. When the internet emerged, debates about governance — while imperfect — involved multiple stakeholders. AI development, by contrast, has been largely self-regulated by the companies building it.\n\nThe CEOs testimony is, at one level, an invitation for democratic governance of AI. "We need rules," they are saying. "Please give us rules." Whether this invitation is sincere or strategic, the underlying point is valid: decisions about AI should not be made by technology companies alone.\n\nThe Senate committee listened politely, asked questions, and adjourned. No legislation was introduced. The companies returned to their labs. And the models continued to get more powerful — faster than any regulatory framework can keep up. The future of AI is being decided right now. The question is whether anyone outside a handful of company boardrooms gets a vote.`,
    vocab: [
      { word: 'Transformative', definition: 'Causing major change — fundamentally altering how things work.' },
      { word: 'Stakeholders', definition: 'People who have an interest in or are affected by a decision — everyone with a stake.' },
      { word: 'Self-regulated', definition: 'When an industry sets and enforces its own rules without government oversight.' },
      { word: 'Adjourned', definition: 'Ended a meeting or session — stopped for the time being.' },
    ],
    questions: [
      { n: 10, q: 'AI decisions are made by a few companies with almost no public input. Is this acceptable for a technology that affects everyone?' },
      { n: 11, q: 'Nuclear energy got regulatory bodies and treaties. AI has mostly self-regulation. Why the difference?' },
      { n: 12, q: 'The future of AI is being decided now. Should the public have a vote? What would democratic AI governance look like?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "AI CEOs Call for Development to Slow Down". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function AISlowdownPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>AI CEOs Call for Development to Slow Down</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The CEOs of Anthropic and OpenAI both called for AI development to slow down — while their companies race to build more powerful models. Hypocrisy or genuine concern?</p>
            </div>
          </div>
