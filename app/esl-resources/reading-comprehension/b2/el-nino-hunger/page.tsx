...
const PARTS = [
  {
    number: 1, title: 'The Invisible Disaster', emoji: '🌾', color: '#dc2626',
    text: `This week, the United Nations World Food Programme warned that El Nino conditions developing in the Pacific Ocean could push approximately 50 million people into acute hunger by 2027. The forecast, described by aid agencies as "alarming," comes at a time when global hunger is already at its highest level in decades — with more than 280 million people currently facing food insecurity worldwide.\n\nEl Nino is a natural climate phenomenon that occurs every two to seven years, when sea surface temperatures in the central Pacific Ocean rise significantly above average. This warming disrupts weather patterns across the globe, causing droughts in some regions and floods in others. The effects can be devastating for agriculture — and for the hundreds of millions of people who depend on predictable weather to grow the food they eat.\n\nThe last major El Nino, in 2023-24, contributed to droughts across East Africa, Southeast Asia, and Central America that destroyed crops and left millions of people dependent on emergency food aid. The emerging El Nino is forecast to be even stronger — and it arrives at a time when the global food system is already under severe strain from the Ukraine war, the Hormuz oil crisis, climate change, and rising costs.\n\nHunger is often called an invisible disaster. Unlike earthquakes, floods, or wildfires, it does not produce dramatic images or sudden destruction. It is slow, silent, and disproportionately affects people in countries that receive little international media attention. But its consequences — malnutrition, disease, developmental damage in children, economic collapse, and mass displacement — are as devastating as any natural catastrophe.`,
    vocab: [
      { word: 'Acute hunger', definition: 'Severe food shortage that threatens lives — not just being hungry, but being dangerously close to starvation.' },
      { word: 'Food insecurity', definition: 'Not having reliable access to enough affordable, nutritious food.' },
      { word: 'Phenomenon', definition: 'A natural event or occurrence that can be observed and studied.' },
      { word: 'Malnutrition', definition: 'Poor health caused by not eating enough food, or not eating the right types of food.' },
    ],
    questions: [
      { n: 1, q: '50 million people could face acute hunger because of El Nino. Why does a weather pattern in the Pacific Ocean affect food supplies on the other side of the world?' },
      { n: 2, q: 'Hunger is called an invisible disaster. Why does it receive less attention than earthquakes or floods?' },
      { n: 3, q: '280 million people are already food insecure. Does this number surprise you? Why do you think global hunger is so high in 2026?' },
    ]
  },
  {
    number: 2, title: 'How El Nino Breaks the Food Chain', emoji: '🌊', color: '#b91c1c',
    text: `El Nino affects food production through a chain of interconnected effects that span continents.\n\nIn East Africa — including Ethiopia, Kenya, Somalia, and South Sudan — El Nino typically causes severe drought. Rainfall that farmers depend on to grow maize, sorghum, and other staple crops fails to arrive. Pastures dry up, killing livestock that pastoralist communities depend on for milk, meat, and income. Water sources shrink, forcing people and animals to compete for what remains. The 2023 drought in the Horn of Africa, intensified by El Nino, affected more than 36 million people.\n\nIn Southeast Asia, El Nino causes dry conditions that reduce rice yields — the staple food for more than half of the world's population. Thailand, Vietnam, Indonesia, and the Philippines are all affected. Thailand, one of the world's largest rice exporters, saw rice production decline significantly during the 2023-24 El Nino, contributing to higher rice prices globally.\n\nIn Central and South America, El Nino brings both drought to some areas and excessive rainfall to others. Coffee production in Colombia and Brazil — which together produce more than half of the world's coffee — can be severely affected, as coffee plants are particularly sensitive to temperature and rainfall changes.\n\nThe effects compound through the global food system. When production falls in one region, prices rise everywhere. When prices rise, the people who suffer most are the poorest — those who already spend 60-80% of their income on food. A 20% increase in the price of rice that is barely noticeable to a middle-class family in Bangkok can be catastrophic for a family in rural Cambodia or sub-Saharan Africa.`,
    vocab: [
      { word: 'Staple crops', definition: 'The main foods that people depend on for most of their calories — like rice, wheat, and maize.' },
      { word: 'Pastoralist', definition: 'People who raise livestock (cattle, goats, sheep) and move with their herds to find pasture and water.' },
      { word: 'Yields', definition: 'The amount of crop produced from a given area of land — harvest results.' },
      { word: 'Compound', definition: 'To make worse by adding additional problems — effects that multiply and intensify each other.' },
    ],
    questions: [
      { n: 4, q: 'El Nino affects Thailand\'s rice production, which affects rice prices worldwide. How does this connect what happens in the Pacific Ocean to what happens in your kitchen?' },
      { n: 5, q: 'Poor families spend 60-80% of income on food. A 20% price increase is catastrophic for them but barely noticed by wealthier families. How should this inequality be addressed?' },
      { n: 6, q: 'El Nino disrupts coffee, rice, maize, and livestock across multiple continents simultaneously. Is the global food system too fragile? How could it be made more resilient?' },
    ]
  },
  {
    number: 3, title: 'Climate Change Makes It Worse', emoji: '🌡️', color: '#991b1b',
    text: `El Nino is a natural phenomenon — it has occurred throughout recorded history and long before humans began burning fossil fuels. But climate change is making its effects significantly worse.\n\nWarmer baseline temperatures mean that the additional warming caused by El Nino pushes temperatures higher than they would have reached in the past. Droughts are more severe because higher temperatures increase evaporation, drying out soil and vegetation faster. Floods are more intense because a warmer atmosphere holds more moisture. The combination of natural variability (El Nino) and human-caused warming (climate change) creates conditions that are genuinely unprecedented.\n\nThe food system is also less resilient than it used to be. Industrial agriculture has increased yields enormously over the past century, but it has done so by creating systems that are highly optimised for specific climate conditions. When those conditions change — as they do during El Nino and increasingly due to climate change — the optimised systems fail more dramatically than the diverse, traditional farming systems they replaced.\n\nGroundwater reserves, which farmers in many regions rely on during droughts, are being depleted faster than they are replenished. The Ogallala Aquifer in the central United States, one of the world's largest underground water reserves, has been shrinking for decades. When the next severe drought hits the American grain belt — which El Nino makes more likely — the aquifer may not be able to compensate.\n\nThe convergence of El Nino, climate change, depleted water reserves, and a food system optimised for conditions that no longer exist creates what scientists call a "compound risk" — multiple threats arriving simultaneously, each amplifying the others.`,
    vocab: [
      { word: 'Baseline', definition: 'The starting point or normal level against which changes are measured.' },
      { word: 'Variability', definition: 'The degree to which something changes or differs over time — natural fluctuations.' },
      { word: 'Depleted', definition: 'Used up or exhausted — reduced to the point where not enough remains.' },
      { word: 'Compound risk', definition: 'Multiple threats occurring at the same time, each making the others worse.' },
    ],
    questions: [
      { n: 7, q: 'Climate change makes El Nino worse. What is the difference between natural climate variability and human-caused climate change?' },
      { n: 8, q: 'Modern farming is highly optimised but fragile. Traditional farming was less productive but more resilient. Which approach is better for the future?' },
      { n: 9, q: 'Underground water reserves are being depleted. What happens to farming when the water runs out?' },
    ]
  },
  {
    number: 4, title: 'What Can Be Done?', emoji: '💡', color: '#7f1d1d',
    text: `The 50-million-person hunger forecast is not a certainty — it is a warning. And warnings, if heeded, can lead to action that reduces the damage.\n\nEarly warning systems have improved dramatically. Meteorologists can now predict El Nino events months in advance, giving governments and aid agencies time to prepare. Pre-positioning food supplies, distributing drought-resistant seeds, providing cash transfers to vulnerable families before a crisis hits, and building emergency water infrastructure can all reduce the impact of predicted food shortages.\n\nLonger-term solutions focus on building resilience. Diversifying crops so that farmers are not dependent on a single harvest. Investing in irrigation systems that reduce dependence on rainfall. Developing drought-resistant and heat-resistant crop varieties through selective breeding and biotechnology. Building strategic grain reserves that can be released when prices spike. Each of these measures reduces vulnerability — but implementing them requires investment, coordination, and political will.\n\nThe international food system also needs reform. Currently, a handful of countries produce most of the world's staple crops, and disruption in any one of them — whether from El Nino, war, or policy decisions — can trigger a global crisis. Greater agricultural self-sufficiency in vulnerable regions, fairer trade rules, and reduced food waste (roughly one-third of all food produced globally is wasted) would all help build a more resilient system.\n\nThe El Nino forecast is a test — of our ability to anticipate, prepare, and act before a crisis becomes a catastrophe. We have the knowledge. We have the technology. The question, as always, is whether we have the will.`,
    vocab: [
      { word: 'Pre-positioning', definition: 'Placing supplies in strategic locations before a disaster, so they are ready when needed.' },
      { word: 'Resilience', definition: 'The ability to recover from difficulties — strength and flexibility in the face of challenges.' },
      { word: 'Self-sufficiency', definition: 'The ability to produce what you need without depending on others — independence in food production.' },
      { word: 'Catastrophe', definition: 'An event causing enormous damage and suffering — a disaster of the highest severity.' },
    ],
    questions: [
      { n: 10, q: 'Scientists can predict El Nino months in advance. If we know hunger is coming, why does it still happen? What prevents action?' },
      { n: 11, q: 'One-third of all food produced globally is wasted. If we solved food waste alone, would that be enough to prevent hunger crises?' },
      { n: 12, q: 'The passage says we have the knowledge and technology to prevent hunger. The question is whether we have the will. Do we? What would change your answer?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>El Nino Could Push 50 Million Into Hunger</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The UN warns that El Nino could drive 50 million people into acute hunger by 2027. How a weather pattern in the Pacific breaks the global food chain.</p>
            </div>
          </div>
