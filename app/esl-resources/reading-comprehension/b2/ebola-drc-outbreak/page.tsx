...
const PARTS = [
  {
    number: 1, title: 'The Virus Returns', emoji: '🦠', color: '#dc2626',
    text: `The Democratic Republic of the Congo has reported more than 4,000 confirmed cases of Ebola — the deadliest outbreak since the catastrophic West African epidemic of 2014-2016 that killed more than 11,000 people. The World Health Organisation declared the outbreak a Public Health Emergency of International Concern, triggering a global response that health experts say should have been activated weeks earlier.\n\nEbola is one of the most feared diseases on Earth. It kills between 25% and 90% of those it infects, depending on the strain and access to treatment. It spreads through direct contact with the blood, body fluids, or tissues of infected people or animals. Symptoms begin with fever and fatigue and can progress rapidly to severe bleeding, organ failure, and death.\n\nThe DRC — a vast, conflict-affected country in central Africa with a population of more than 100 million — has experienced multiple Ebola outbreaks over the past decade. But this one is different in scale. Previous outbreaks were contained in remote areas. This time, the virus has reached Goma, a city of more than two million people on the Rwandan border, and cases have been reported in several provinces simultaneously.\n\nThe international response has been complicated by the DRC's ongoing political instability, the presence of armed groups in the affected regions, and widespread community distrust of health workers — a legacy of previous outbreaks where misinformation and fear undermined vaccination campaigns. Containing Ebola requires not just medical intervention but trust — and trust, in the eastern DRC, is in desperately short supply.`,
    vocab: [
      { word: 'Outbreak', definition: 'A sudden increase in cases of a disease — when a disease spreads rapidly in a community.' },
      { word: 'Epidemic', definition: 'A widespread occurrence of a disease in a community or region at a particular time.' },
      { word: 'Containment', definition: 'The act of preventing something dangerous from spreading — keeping it under control.' },
      { word: 'Misinformation', definition: 'False or inaccurate information that is spread, sometimes deliberately, sometimes by mistake.' },
    ],
    questions: [
      { n: 1, q: 'Ebola kills up to 90% of those infected. Why do diseases like this still emerge despite modern medicine?' },
      { n: 2, q: 'The virus reached a city of 2 million people. Why is urban spread so much more dangerous than rural outbreaks?' },
      { n: 3, q: 'Community distrust of health workers is undermining the response. Why might people distrust doctors and vaccinators?' },
    ]
  },
  {
    number: 2, title: 'Why the DRC?', emoji: '🌍', color: '#b91c1c',
    text: `The Democratic Republic of the Congo has experienced more Ebola outbreaks than any other country — at least 15 since the virus was first identified near the Ebola River in 1976. Understanding why requires understanding the intersection of ecology, poverty, conflict, and governance that makes the DRC uniquely vulnerable.\n\nEcologically, the DRC's vast tropical forests are home to the animal species — particularly fruit bats — that are believed to be the natural reservoir of the Ebola virus. When humans encroach on forested areas through logging, mining, or agricultural expansion, they come into closer contact with these animals, increasing the chance of the virus jumping from animals to humans — what scientists call a "spillover event."\n\nPoverty amplifies the risk. The DRC is one of the poorest countries on Earth despite having enormous natural resources. Its healthcare system is severely underfunded — there are fewer than one doctor per 10,000 people in many provinces. When Ebola cases appear, the healthcare infrastructure is often too weak to detect them quickly, isolate patients, trace contacts, and contain the spread.\n\nConflict makes everything worse. Eastern DRC has been plagued by armed conflict for decades, with more than 100 militia groups operating in the region. These groups control territory, attack health facilities, and make it dangerous or impossible for medical teams to reach affected communities. During the 2018-2020 outbreak, several health workers were killed by armed groups, forcing temporary suspension of the response.\n\nThe result is a perfect storm: a virus that regularly spills over from nature, a healthcare system too weak to contain it, and a conflict that prevents effective response.`,
    vocab: [
      { word: 'Reservoir', definition: 'In disease biology, an animal species that carries a virus without becoming sick — a natural host.' },
      { word: 'Spillover event', definition: 'When a virus jumps from its animal host to humans for the first time.' },
      { word: 'Contact tracing', definition: 'Finding and monitoring everyone who has been in contact with an infected person.' },
      { word: 'Perfect storm', definition: 'A combination of factors that together create a particularly dangerous or catastrophic situation.' },
    ],
    questions: [
      { n: 4, q: 'Deforestation brings humans closer to the animals that carry Ebola. How does environmental destruction create health risks?' },
      { n: 5, q: 'The DRC has fewer than one doctor per 10,000 people. How does this compare to your country? What difference does it make?' },
      { n: 6, q: 'Armed groups attack health workers trying to fight Ebola. How can medical teams operate in conflict zones?' },
    ]
  },
  {
    number: 3, title: 'The Global Stakes', emoji: '✈️', color: '#991b1b',
    text: `Ebola in the DRC is not just an African problem — it is a global one. In an interconnected world where a person can fly from Goma to London, New York, or Bangkok in less than 24 hours, a virus that is circulating in a city of two million people is a virus that could appear anywhere.\n\nThe 2014-2016 West African epidemic demonstrated this risk. Cases appeared in the United States, Spain, the UK, and Italy — carried by healthcare workers returning from the affected region or by travellers who did not know they were infected. Each case triggered panic disproportionate to the actual risk, exposing how poorly prepared most countries were for even a small number of imported cases.\n\nThe COVID-19 pandemic, which began in late 2019, taught the world a brutal lesson about what happens when a new infectious disease is not contained at its source. The parallels with Ebola are imperfect — COVID spreads far more easily through the air, while Ebola requires direct contact with body fluids — but the underlying principle is the same: investing in disease surveillance and response in the countries where outbreaks originate is far cheaper and more effective than dealing with a pandemic after it has spread globally.\n\nThe global health community has tools that did not exist during previous outbreaks. An effective Ebola vaccine, developed during the 2014-2016 epidemic, has been deployed in the DRC. Experimental treatments have improved survival rates significantly. And the WHO's emergency response systems have been strengthened. But these tools are only effective if they are deployed quickly, at scale, and with the cooperation of affected communities — conditions that are not guaranteed in the chaotic environment of eastern DRC.`,
    vocab: [
      { word: 'Surveillance', definition: 'Systematic monitoring and observation — in health, watching for signs of disease outbreaks.' },
      { word: 'Pandemic', definition: 'A disease outbreak that spreads across multiple countries or continents, affecting large numbers of people.' },
      { word: 'Deployed', definition: 'Put into use in a specific area — sent and activated where needed.' },
      { word: 'At scale', definition: 'In large enough quantities to make a meaningful difference — not just in small amounts.' },
    ],
    questions: [
      { n: 7, q: 'A person can fly from Goma to any city in the world in 24 hours. How does global travel change the nature of disease outbreaks?' },
      { n: 8, q: 'COVID taught the world about pandemic unpreparedness. Have countries actually learned the lesson? Are we better prepared now?' },
      { n: 9, q: 'An Ebola vaccine exists but deployment is difficult. What barriers prevent effective vaccination in conflict zones?' },
    ]
  },
  {
    number: 4, title: 'Prevention vs Reaction', emoji: '💉', color: '#7f1d1d',
    text: `The DRC Ebola outbreak exposes a fundamental flaw in how the world approaches global health: we invest billions in reacting to crises but comparatively little in preventing them.\n\nThe cost of containing a major Ebola outbreak runs into hundreds of millions of dollars — for medical teams, protective equipment, vaccines, treatment centres, contact tracing, and community engagement. The 2014-2016 epidemic cost the global economy an estimated 53 billion dollars when economic disruption, lost tourism, and trade impacts were included.\n\nBy comparison, the cost of strengthening healthcare systems in the DRC and other high-risk countries — building laboratories, training health workers, establishing surveillance networks, and improving basic infrastructure — would be a fraction of what outbreak response costs. The Global Health Security Agenda estimated that an investment of approximately 4.5 billion dollars per year would give every country in the world basic capacity to detect, prevent, and respond to infectious disease outbreaks. The world currently spends about one-third of that amount.\n\nThe pattern is familiar from other domains. We spend more on fighting wildfires than preventing them. We spend more on disaster relief than disaster preparedness. We spend more on treating diseases than preventing them. In each case, the reactive approach costs more money, saves fewer lives, and creates more suffering than the preventive approach would have.\n\nThe Ebola virus does not respect borders, ideologies, or economic systems. It exploits weakness wherever it finds it — in healthcare systems, in governance, in community trust. The 4,000 cases in the DRC are a warning. Whether the world heeds that warning or waits for the next crisis depends on choices being made right now — in Geneva, Washington, Beijing, and every capital that has a stake in global health security.`,
    vocab: [
      { word: 'Preventive', definition: 'Designed to stop something from happening before it occurs — proactive rather than reactive.' },
      { word: 'Surveillance networks', definition: 'Systems of monitoring stations and communication designed to detect disease outbreaks early.' },
      { word: 'Exploits', definition: 'Takes advantage of a weakness for its own benefit.' },
      { word: 'Heeds', definition: 'Pays attention to and acts on a warning or advice.' },
    ],
    questions: [
      { n: 10, q: 'We spend more reacting to crises than preventing them. Why? What would need to change to shift this balance?' },
      { n: 11, q: '4.5 billion dollars per year could give every country basic disease detection capacity. Is this worth the investment? Who should pay?' },
      { n: 12, q: 'The passage says Ebola exploits weakness in healthcare, governance, and trust. Which of these three weaknesses is most dangerous?' },
    ]
  },
]
...
export default function EbolaPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Ebola Returns — 4,000 Cases in the DRC</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The DRC has 4,000 Ebola cases — the worst outbreak since 2014. Why the virus keeps returning, why the DRC is uniquely vulnerable, and what the world must learn.</p>
            </div>
          </div>
