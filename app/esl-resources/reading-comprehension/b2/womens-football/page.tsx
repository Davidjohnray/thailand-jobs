...
const PARTS = [
  {
    number: 1, title: 'How Women\'s Football Reached the Global Stage', emoji: '⚽', color: '#8b5cf6',
    text: `Women's football has existed for over a century, but for most of that time it operated in the shadow of the men's game — underfunded, under-broadcast, and largely ignored by mainstream sports media. The transformation of the past decade has been extraordinary. Attendances at women's matches have broken records, television deals have grown significantly, and the 2023 FIFA Women's World Cup in Australia and New Zealand attracted over two billion viewers globally — making it the most-watched women's sporting event in history.\n\nSeveral factors have driven this growth. The success of national teams like the United States, England, Spain, and Germany has inspired a generation of young girls to take up the sport. Major club competitions — including the UEFA Women's Champions League and the expansion of domestic leagues like the FA Women's Super League in England and the National Women's Soccer League in the United States — have given top players a high-profile platform that previously did not exist. Broadcasting investment has followed audience growth, and audience growth has followed broadcasting investment, creating a virtuous cycle that has accelerated the sport's rise. What was once a niche pursuit has become a genuinely global sporting movement.`,
    vocab: [
      { word: 'Mainstream', definition: 'Normal and accepted by most people — part of general culture rather than a specialist interest.' },
      { word: 'Virtuous cycle', definition: 'A situation where each positive development leads to another — a self-reinforcing pattern of growth.' },
      { word: 'Platform', definition: 'An opportunity to be heard or seen by a large audience — visibility and exposure.' },
      { word: 'Domestic league', definition: 'A professional competition within one country — as opposed to international or continental tournaments.' },
    ],
    questions: [
      { n: 1, q: 'Have you watched women\'s football? Has your view of it changed over recent years?' },
      { n: 2, q: 'Why do you think women\'s football took so long to gain mainstream recognition?' },
      { n: 3, q: 'Which other women\'s sports do you think deserve more attention and investment?' },
    ]
  },
  {
    number: 2, title: 'The Pay Gap — How Large Is It and Why Does It Exist?', emoji: '💰', color: '#ef4444',
    text: `One of the most debated topics in women's football is the pay gap between male and female players. At the very top of the men's game, elite players earn salaries that are simply incomparable — Kylian Mbappé's reported earnings run to hundreds of millions of euros per year, while even the best-paid women's players earn a tiny fraction of that figure. At most professional clubs around the world, the gap is enormous — women's team players may earn a comfortable living, but the contrast with their male counterparts is stark.\n\nThe reasons for this gap are complex. Revenue is the primary driver — men's football generates vastly more income through television rights, sponsorship, and ticket sales, and much of that revenue flows to players in the form of wages. Supporters of the current system argue that pay should reflect commercial value and that women's football will close the gap naturally as revenues grow. Critics argue that the gap reflects historic underinvestment, limited broadcasting opportunities, and cultural biases that have artificially suppressed the growth of the women's game for decades. They point to the fact that the US women's national team — the most successful women's team in history — fought a lengthy legal battle against their own federation for equal pay, eventually reaching a settlement in 2022.`,
    vocab: [
      { word: 'Incomparable', definition: 'So different that direct comparison is not meaningful — beyond the same scale.' },
      { word: 'Stark', definition: 'Very obvious and impossible to ignore — a stark contrast is one that is clearly visible.' },
      { word: 'Commercial value', definition: 'The amount of money a person or product can generate through business and sponsorship.' },
      { word: 'Settlement', definition: 'An agreement that ends a legal dispute — a negotiated resolution outside of a court ruling.' },
    ],
    questions: [
      { n: 4, q: 'Is it fair that male footballers earn so much more than female footballers? What are the arguments on both sides?' },
      { n: 5, q: 'Should pay in sport be based purely on revenue generated, or should other factors be considered?' },
      { n: 6, q: 'Do you think the pay gap in football will close significantly within the next twenty years?' },
    ]
  },
  {
    number: 3, title: 'The 2023 World Cup — A Turning Point?', emoji: '🏆', color: '#f59e0b',
    text: `The 2023 FIFA Women's World Cup was widely described as a watershed moment for the women's game. Held across Australia and New Zealand, the tournament produced moments of extraordinary drama — Spain's controversial triumph, England's emotional run to the final, Morocco becoming the first African nation to reach the quarter-finals, and co-host Australia's passionate run to the semi-finals, fuelled by superstar striker Sam Kerr. Attendances at matches across both countries were exceptional, and global media coverage reached levels that would have been unimaginable even five years earlier.\n\nYet the tournament also exposed tensions beneath the surface. Several top players — including members of the Spanish squad — had previously publicly protested against their national federation's management style, raising questions about governance and player welfare in women's football. Prize money for the tournament, while the highest ever for a women's World Cup, remained a fraction of the amount awarded at the men's equivalent. FIFA's television deal negotiations attracted criticism for undervaluing the broadcasting rights of women's football in certain markets. The 2023 World Cup demonstrated both how far the women's game had come and how far it still had to travel.`,
    vocab: [
      { word: 'Watershed moment', definition: 'A turning point — an event that marks a significant change in the direction of something.' },
      { word: 'Governance', definition: 'The system of rules and leadership that controls an organisation — how decisions are made.' },
      { word: 'Player welfare', definition: 'The physical and mental wellbeing of athletes — ensuring they are treated fairly and safely.' },
      { word: 'Broadcasting rights', definition: 'The legal permission to show a sporting event on television or online — sold to broadcasters.' },
    ],
    questions: [
      { n: 7, q: 'Do you think the 2023 World Cup was a genuine turning point for women\'s football, or just a temporary peak?' },
      { n: 8, q: 'Should players have the right to protest publicly against their national federation? What are the risks?' },
      { n: 9, q: 'Why do you think prize money in women\'s sport is still lower than in men\'s sport, even when audiences are similar?' },
    ]
  },
  {
    number: 4, title: 'The Future of Women\'s Football', emoji: '🚀', color: '#22c55e',
    text: `The trajectory of women's football points strongly upward, but several challenges remain. Investment in youth development — identifying and coaching talented girls from an early age — varies enormously between countries. In nations with strong grassroots programmes, the talent pipeline is healthy; in many others, girls still lack access to the same quality of coaching, facilities, and competitive opportunities as boys of the same age. Closing this gap at the grassroots level will be essential to producing the next generation of elite players and sustaining long-term growth.\n\nThe relationship between the men's and women's game is also evolving. Some of the world's biggest clubs — including Chelsea, Barcelona, and Lyon — have invested significantly in their women's teams, providing resources, facilities, and media exposure that were previously unavailable. Others treat the women's team as an afterthought. Fans, sponsors, and broadcasters are increasingly scrutinising how clubs balance their investment. The growth of dedicated women's football communities online — particularly on social media — has given fans a voice and created pressure for accountability that did not exist a generation ago. Whether women's football becomes fully equal to the men's game in commercial terms may take decades, but the direction of travel seems clear: it is a sport whose best days are still ahead of it.`,
    vocab: [
      { word: 'Trajectory', definition: 'The direction and speed of development — the path something is taking over time.' },
      { word: 'Grassroots', definition: 'The basic, local level of something — grassroots sport refers to amateur and youth participation.' },
      { word: 'Accountability', definition: 'Being answerable for decisions and actions — the obligation to explain and justify behaviour.' },
      { word: 'Scrutinising', definition: 'Examining something very closely and critically — looking carefully for problems or inconsistencies.' },
    ],
    questions: [
      { n: 10, q: 'What is the most important thing needed to ensure the continued growth of women\'s football?' },
      { n: 11, q: 'Should men\'s football clubs be required to invest equally in their women\'s teams?' },
      { n: 12, q: 'Overall, how optimistic are you about the future of women\'s football? Give your reasons.' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "The Rise of Women's Football". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function WomensFootballPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #4c1d95 0%, #8b5cf6 100%)', padding: '56px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Rise of Women's Football</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Equal Game — explore how women's football went from the margins to the global stage, and the ongoing debates about pay, investment, and the future of the sport.</p>
            </div>
          </div>
