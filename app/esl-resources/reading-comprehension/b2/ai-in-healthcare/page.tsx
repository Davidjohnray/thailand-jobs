...
const PARTS = [
  {
    number: 1, title: 'How AI is Entering the Medical World', emoji: '🏥', color: '#0ea5e9',
    text: `Artificial intelligence is rapidly changing the way doctors and hospitals work. For many years, medical decisions relied almost entirely on the knowledge and experience of trained professionals. Today, AI systems can analyse vast amounts of medical data — from patient records and test results to medical images — often faster and in some cases more accurately than a human expert alone. Hospitals in many countries are now using AI tools to assist with everything from booking appointments to detecting life-threatening conditions.\n\nWhat makes AI particularly valuable in healthcare is its ability to identify patterns. When trained on millions of patient records, an AI system can learn to recognise the early signs of diseases that might otherwise be missed. For example, AI has shown strong results in detecting certain cancers, diabetic eye disease, and heart conditions from scans and photographs. Supporters argue that this technology could save thousands of lives every year by catching illness at an earlier, more treatable stage.`,
    vocab: [
      { word: 'Analyse', definition: 'To examine something carefully and in detail in order to understand or explain it.' },
      { word: 'Vast', definition: 'Extremely large in amount, size, or degree — much more than usual.' },
      { word: 'Life-threatening', definition: 'Likely to cause death — describing a serious or dangerous medical condition.' },
      { word: 'Detect', definition: 'To discover or identify something, especially something that is not easy to notice.' },
    ],
    questions: [
      { n: 1, q: 'Do you think AI should be used to assist doctors, or should medical decisions always be made by humans?' },
      { n: 2, q: 'How might AI change the role of doctors and nurses over the next twenty years?' },
      { n: 3, q: 'Would you feel comfortable if an AI system helped diagnose your health condition?' },
    ]
  },
  {
    number: 2, title: 'Benefits for Patients and Medical Systems', emoji: '💊', color: '#8b5cf6',
    text: `One of the greatest potential benefits of AI in healthcare is improved access. In many parts of the world, there are not enough trained doctors to meet the needs of the population. Rural communities and developing countries often face particular challenges, where specialist care may be far away or unaffordable. AI-powered tools, accessed through smartphones or basic devices, could bring high-quality medical guidance to people who previously had very little support.\n\nFor patients in well-resourced hospitals, AI can also reduce waiting times and improve the consistency of care. An AI system does not get tired, does not make errors due to stress, and can process large amounts of information quickly. In drug discovery, AI has been used to identify potential treatments far faster than traditional laboratory research. During the COVID-19 pandemic, AI tools played a role in analysing patient data, predicting outbreaks, and accelerating vaccine development — demonstrating how rapidly this technology can respond to a global health crisis.`,
    vocab: [
      { word: 'Rural', definition: 'Relating to the countryside rather than the city — areas with few people and limited services.' },
      { word: 'Consistency', definition: 'The quality of always behaving or performing in the same way — reliability over time.' },
      { word: 'Drug discovery', definition: 'The process of finding new medicines — researching chemical compounds that could treat diseases.' },
      { word: 'Accelerating', definition: 'Making something happen faster — increasing the speed of a process or development.' },
    ],
    questions: [
      { n: 4, q: 'How could AI healthcare tools help people in rural or developing communities?' },
      { n: 5, q: 'Is it fair that wealthier countries benefit more from AI technology in healthcare?' },
      { n: 6, q: 'What other industries could benefit from AI in the same way healthcare has?' },
    ]
  },
  {
    number: 3, title: 'Risks, Errors and Ethical Questions', emoji: '⚠️', color: '#f59e0b',
    text: `Despite its promise, AI in healthcare comes with significant risks and ethical questions. One major concern is the issue of bias. AI systems learn from historical data, and if that data reflects existing inequalities in healthcare — for example, fewer studies on women or certain ethnic groups — then the AI may produce less accurate results for those populations. This could reinforce existing health inequalities rather than reducing them.\n\nThere is also the question of accountability. When a human doctor makes an error, there are clear legal and professional consequences. But when an AI system provides incorrect guidance, who is responsible — the hospital, the software company, or the doctor who trusted the recommendation? Privacy is another concern: AI systems require access to sensitive patient data to function effectively, raising questions about how that data is stored, shared, and protected. These challenges do not mean AI should be avoided, but they highlight the importance of careful regulation and transparent design.`,
    vocab: [
      { word: 'Bias', definition: 'An unfair preference or prejudice — when a system consistently favours one group over another.' },
      { word: 'Inequality', definition: 'A situation where people are treated differently or have different opportunities and outcomes.' },
      { word: 'Accountability', definition: 'The responsibility to explain your actions or decisions — being answerable for outcomes.' },
      { word: 'Regulation', definition: 'Rules or laws that control how something is done — especially in industry or technology.' },
    ],
    questions: [
      { n: 7, q: 'Who should be held responsible if an AI medical system makes a serious error?' },
      { n: 8, q: 'How can governments ensure that AI healthcare tools are fair for all groups of people?' },
      { n: 9, q: 'Is patient privacy more or less important than the benefits AI could provide?' },
    ]
  },
  {
    number: 4, title: 'The Future of AI-Assisted Medicine', emoji: '🔬', color: '#22c55e',
    text: `Looking ahead, many experts believe AI will not replace doctors but will fundamentally change how they work. The doctor of the future may spend less time on routine analysis and more time on complex decision-making, emotional support, and patient communication — areas where human judgment and empathy remain essential. AI could handle the data; humans could focus on care.\n\nSome researchers are already developing AI systems capable of personalised medicine — tailoring treatment plans to the individual genetics, lifestyle, and history of each patient rather than applying a general approach. Others are working on AI tools that can monitor patients continuously through wearable devices, alerting doctors before a condition becomes an emergency. Whether these advances lead to a healthier world will depend not just on the technology itself, but on how societies choose to develop, regulate, and share it. The most important question may not be what AI can do — but who gets to benefit from it.`,
    vocab: [
      { word: 'Fundamentally', definition: 'In a basic and important way — affecting the essential nature of something.' },
      { word: 'Empathy', definition: 'The ability to understand and share the feelings of another person.' },
      { word: 'Personalised medicine', definition: 'Medical treatment designed specifically for an individual based on their unique characteristics.' },
      { word: 'Wearable devices', definition: 'Electronic gadgets worn on the body — such as smartwatches that monitor health data continuously.' },
    ],
    questions: [
      { n: 10, q: 'Do you think human empathy can ever be replaced or replicated by AI in a medical setting?' },
      { n: 11, q: 'Should personalised medicine be available to everyone, or will it only be for those who can afford it?' },
      { n: 12, q: 'Overall, do you believe AI will make healthcare better or worse for most people in the world? Why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise discussion skills. The reading topic is "Artificial Intelligence in Healthcare". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Artificial Intelligence in Healthcare</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Can Machines Help Heal Us? — explore how AI is transforming diagnosis, treatment, and the future of medicine around the world.</p>
            </div>
          </div>
