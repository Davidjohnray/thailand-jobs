...
const PARTS = [
  {
    number: 1, title: 'Wall Street Goes South', emoji: '🤠', color: '#f59e0b',
    text: `For more than a century, Wall Street in New York City has been the undisputed centre of the global financial industry. The name itself has become synonymous with money, power, and capitalism. When people say "Wall Street," they do not just mean a street — they mean the entire American financial system.\n\nBut in 2026, something remarkable is happening. Goldman Sachs — one of the most powerful and prestigious investment banks in the world — is building a massive new campus in Dallas, Texas. The New York bank is "supersizing its presence" in the Texan city, part of a broader financial boom that has led local politicians and banking executives to coin a new nickname: "Y'all Street."\n\nGoldman Sachs is not alone. JPMorgan Chase, Charles Schwab, and dozens of other financial firms have expanded operations in Dallas, Austin, and other Texan cities. Hedge funds have relocated from New York and Connecticut to Miami, Nashville, and Palm Beach. The geography of American finance is shifting — and the reasons tell us something important about how business, politics, and lifestyle preferences are reshaping the economic map of the United States.\n\nThe trend has accelerated dramatically since the pandemic. When remote work proved that financial professionals could work from anywhere, many of them chose to work from places with lower taxes, cheaper housing, warmer weather, and a lower cost of living. Texas, Florida, and Tennessee — states with no personal income tax — have been the biggest beneficiaries.`,
    vocab: [
      { word: 'Undisputed', definition: 'Not questioned or challenged — universally accepted and recognised.' },
      { word: 'Synonymous', definition: 'So closely associated with something that the two are almost interchangeable.' },
      { word: 'Prestigious', definition: 'Having a very high reputation — respected and admired because of quality or importance.' },
      { word: 'Beneficiaries', definition: 'People, places, or organisations that receive an advantage or benefit from something.' },
    ],
    questions: [
      { n: 1, q: 'Goldman Sachs is building a huge new campus in Dallas, not New York. What does this tell us about how power centres can shift?' },
      { n: 2, q: '"Y\'all Street" is a playful name combining Southern culture with Wall Street finance. What does the nickname tell us about how Dallas wants to be seen?' },
      { n: 3, q: 'Texas has no personal income tax. How much do you think tax rates influence where companies and people choose to live?' },
    ]
  },
  {
    number: 2, title: 'Why Companies Are Leaving New York', emoji: '🏙️', color: '#d97706',
    text: `The migration of financial companies from New York to Texas and other Sun Belt states is driven by a combination of economic, political, and lifestyle factors.\n\nThe most obvious factor is cost. Office space in Manhattan costs roughly four times as much as equivalent space in Dallas. A financial analyst who earns 150,000 dollars in New York might take home only 90,000 after federal, state, and city taxes. The same analyst in Texas would take home roughly 115,000 — because Texas has no state income tax. Housing is dramatically cheaper too: the average home price in Dallas is less than half the New York equivalent.\n\nPolitics plays a role as well. Texas and Florida have Republican governors who have actively courted businesses with promises of lower regulation, fewer restrictions, and a more business-friendly environment. New York and California, by contrast, have increased taxes and regulations — particularly around climate disclosure, diversity requirements, and worker protections — that some businesses view as burdensome.\n\nLifestyle preferences matter more than many people expected. The pandemic revealed that many financial professionals — particularly those with families — preferred the larger houses, shorter commutes, and outdoor lifestyles available in Sun Belt cities. Dallas offers sunshine, space, and a cost of living that allows a comfortable upper-middle-class life on a salary that would feel stretched in Manhattan.\n\nCritics argue that the migration is not as straightforward as it appears. New York retains enormous advantages — proximity to clients, a deep talent pool, cultural vibrancy, and a networking ecosystem that has been built over generations. Several companies that relocated during the pandemic have quietly brought employees back to New York. The death of Wall Street, they argue, has been greatly exaggerated.`,
    vocab: [
      { word: 'Sun Belt', definition: 'The southern and southwestern states of the US, known for warm weather and rapid population growth.' },
      { word: 'Courted', definition: 'Actively tried to attract or win over — made efforts to persuade someone to come to you.' },
      { word: 'Burdensome', definition: 'Causing difficulty or extra work — something that feels like an unnecessary weight or obligation.' },
      { word: 'Talent pool', definition: 'The group of skilled workers available in a particular location or industry.' },
    ],
    questions: [
      { n: 4, q: 'A worker earning 150,000 takes home 90,000 in New York but 115,000 in Texas. Would this difference make you move? What other factors matter?' },
      { n: 5, q: 'Texas has lower taxes and fewer regulations. New York has more rules but also more worker protections. Which approach is better? For whom?' },
      { n: 6, q: 'Critics say New York still has advantages that Dallas cannot replicate. What makes a city a genuine financial centre beyond just having offices there?' },
    ]
  },
  {
    number: 3, title: 'Winners, Losers, and Unintended Consequences', emoji: '⚖️', color: '#b45309',
    text: `The financial migration to Texas and other Sun Belt states creates winners and losers — and some of the consequences are not what anyone expected.\n\nThe obvious winners are the receiving cities. Dallas, Austin, Miami, and Nashville gain high-paying jobs, tax revenue, and economic prestige. Local businesses benefit from the spending power of well-paid financial professionals. Property values rise. Restaurants, shops, and services multiply. The cities feel more dynamic, more cosmopolitan, and more important.\n\nBut there are downsides. The influx of wealthy newcomers drives up housing costs for existing residents. In Austin, which has attracted thousands of tech and finance workers, the average home price has more than doubled in a decade, pricing out many long-term residents. The very affordability that attracted companies to these cities is being destroyed by their arrival — a paradox that plays out in city after city.\n\nNew York, meanwhile, faces a genuine challenge. The city depends heavily on tax revenue from the financial sector — Wall Street firms and their employees pay a significant portion of New York State and City taxes. If enough of them leave, the tax base shrinks, public services deteriorate, and the city becomes less attractive — potentially triggering a further exodus. This negative feedback loop is what urban economists call a "doom loop," and while New York is far from that point, the risk is taken seriously.\n\nThere are also cultural consequences. When finance moves to Texas, the culture of finance changes. Wall Street has historically been a place where diverse perspectives — immigrants from around the world, people from every background — competed on relatively equal terms. Whether the more homogeneous culture of cities like Dallas can replicate this diversity is an open question.`,
    vocab: [
      { word: 'Cosmopolitan', definition: 'A place that includes people and influences from many different countries — worldly and diverse.' },
      { word: 'Influx', definition: 'A large number of people or things arriving at the same time — a sudden inflow.' },
      { word: 'Doom loop', definition: 'A negative cycle where each problem causes another problem, which makes the original problem worse.' },
      { word: 'Homogeneous', definition: 'Made up of similar people or things — lacking diversity or variety.' },
    ],
    questions: [
      { n: 7, q: 'Companies move to affordable cities, then their arrival makes those cities unaffordable. How can this paradox be solved?' },
      { n: 8, q: 'If enough companies leave New York, the tax base shrinks and services deteriorate. Should governments try to prevent companies from leaving? How?' },
      { n: 9, q: 'The passage says Wall Street is diverse but Dallas is more homogeneous. Why does diversity matter in the financial industry?' },
    ]
  },
  {
    number: 4, title: 'The Future of Work Geography', emoji: '🌐', color: '#92400e',
    text: `The shift from Wall Street to Y'all Street is part of a much bigger story: the decentralisation of knowledge work. For most of the 20th century, certain industries were concentrated in specific cities — finance in New York, technology in Silicon Valley, entertainment in Los Angeles, government in Washington. You had to be in the right city to work in the right industry.\n\nThe pandemic challenged this assumption fundamentally. When millions of knowledge workers proved they could work effectively from home — or from anywhere with a good internet connection — the link between job and location weakened. If you can do your job from a laptop, why pay Manhattan rent?\n\nThis trend has global implications. If American financial firms can move from New York to Dallas, they can also move from Dallas to Dublin, Singapore, or Bangkok. The same logic that makes Texas attractive compared to New York makes many Asian cities attractive compared to Texas — lower costs, growing talent pools, proximity to fast-growing markets. Several major banks have already expanded significantly in Singapore and Hong Kong.\n\nFor cities and countries competing to attract global business, the lesson is clear: location advantages are no longer permanent. A city that offers low costs today may become expensive tomorrow. A country that offers favourable regulations today may change them tomorrow. The competition for talent and investment is becoming truly global — and the winners will be places that offer not just low costs, but genuine quality of life, strong institutions, reliable infrastructure, and a welcoming culture.\n\nThe name on the street sign may change from "Wall" to "Y'all." But the fundamental dynamics of global capitalism — the restless search for efficiency, the constant movement of capital towards the highest returns — remain the same as they have always been. The only thing that changes is the address.`,
    vocab: [
      { word: 'Decentralisation', definition: 'The process of spreading activities or power away from one central location to multiple locations.' },
      { word: 'Knowledge work', definition: 'Work that primarily involves thinking, analysing, and creating — rather than physical labour.' },
      { word: 'Proximity', definition: 'Being near or close to something — physical closeness to a place or market.' },
      { word: 'Restless', definition: 'Never still or satisfied — always moving, changing, or looking for something better.' },
    ],
    questions: [
      { n: 10, q: 'If you can work from anywhere with a laptop, where would you choose to live? What factors would you consider?' },
      { n: 11, q: 'The passage says the same logic that attracts firms to Dallas could attract them to Bangkok or Singapore. Is this an opportunity or a threat for Southeast Asia?' },
      { n: 12, q: 'Location advantages are no longer permanent. What does your city or country need to do to remain competitive in the global economy?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Dallas Becomes "Y'all Street"</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Goldman Sachs is building a massive campus in Dallas as Wall Street moves south. Why companies are leaving New York and what it means for the future of work.</p>
            </div>
          </div>
