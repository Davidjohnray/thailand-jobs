...
const PARTS = [
  {
    number: 1, title: 'Why Meetings Matter — and Why They Often Fail', emoji: '🗓️', color: '#3b82f6',
    text: `Meetings are one of the most common activities in professional life, yet they are also one of the most frequently criticised. Research consistently shows that a large proportion of meetings are considered unproductive by the people attending them. Time is spent without clear decisions being made, discussions drift off topic, and participants leave uncertain about what was agreed or what they are expected to do next. For non-native English speakers, the challenge is even greater — not only must you follow a fast-moving discussion, but you must also find the right moment and the right language to contribute effectively.\n\nDespite their reputation, well-run meetings remain one of the most powerful tools in any organisation. They bring people together to share information, solve problems, align on strategy, and build working relationships that cannot easily be formed through email or messaging alone. The difference between a productive meeting and a wasted one usually comes down to preparation, structure, and the communication skills of the people involved. Understanding how to run a meeting well — and how to participate in one confidently — is therefore a high-value professional skill.`,
    vocab: [
      { word: 'Unproductive', definition: 'Not achieving useful results — wasting time without reaching decisions or making progress.' },
      { word: 'Contribute', definition: 'To give your ideas, opinions or effort to a shared discussion or project.' },
      { word: 'Align', definition: 'To bring people into agreement on a shared direction or goal — to get everyone on the same page.' },
      { word: 'Agenda', definition: 'A list of topics to be discussed at a meeting, usually shared in advance.' },
    ],
    questions: [
      { n: 1, q: 'What makes a meeting feel like a waste of time? Have you experienced this?' },
      { n: 2, q: 'Is it harder to participate in meetings in a second language? What are the main challenges?' },
      { n: 3, q: 'Do you think fewer meetings would make most organisations more productive?' },
    ]
  },
  {
    number: 2, title: 'Running a Meeting: The Chair\'s Role', emoji: '🪑', color: '#8b5cf6',
    text: `The person who runs a meeting is usually called the chair or facilitator. This role carries significant responsibility. A good chair opens the meeting clearly, states the purpose, and sets expectations for how long each item will take. They guide the discussion to ensure all agenda items are covered, keep the conversation focused when it drifts, and make sure that quieter participants have the opportunity to speak. At the end of the meeting, they summarise what was decided and confirm who is responsible for each action point.\n\nEffective chairs use specific language to manage discussions professionally. To open: "Thank you all for coming — let's get started. The purpose of today's meeting is..." To keep things on track: "That's an interesting point, but let's park that for now and come back to it later." To invite contributions: "We haven't heard from everyone yet — [Name], what's your view on this?" To close an item: "So we're agreed that... — let's move on to the next point." Learning and practising these phrases gives you control over the room and projects confidence, even when the discussion becomes difficult.`,
    vocab: [
      { word: 'Facilitator', definition: 'A person who guides a meeting or discussion — helping the group work together effectively.' },
      { word: 'Action point', definition: 'A specific task agreed in a meeting — something a named person must complete by a set deadline.' },
      { word: 'Park', definition: 'To set aside a topic temporarily — to note it and return to it later rather than discussing it now.' },
      { word: 'Summarise', definition: 'To give a brief statement of the main points — to recap what was said or decided.' },
    ],
    questions: [
      { n: 4, q: 'What qualities make someone an effective meeting chair?' },
      { n: 5, q: 'How do you politely bring a conversation back on topic without offending anyone?' },
      { n: 6, q: 'Should the most senior person always chair a meeting, or is it better to have a dedicated facilitator?' },
    ]
  },
  {
    number: 3, title: 'Participating Confidently as an Attendee', emoji: '🙋', color: '#f59e0b',
    text: `For many professionals, especially non-native speakers, the hardest part of a meeting is not understanding what is being said — it is finding the right moment to speak and expressing ideas clearly under time pressure. In many English-speaking business cultures, silence is often interpreted as lack of engagement or agreement rather than thoughtfulness. This means that waiting too long before contributing can create the wrong impression, even if your intentions are entirely professional.\n\nThere are several strategies that experienced meeting participants use. Signalling that you want to speak before jumping in — for example: "Can I just add something here?" or "I'd like to come back to an earlier point if I may" — is more effective than interrupting. When you want to disagree politely, phrases such as "I take your point, but..." or "I see it slightly differently — in my experience..." allow you to push back without creating conflict. If you miss something or need clarification: "Sorry, could you say that again?" or "Just to make sure I've understood — are you saying that...?" These phrases show active engagement and are entirely natural in professional English conversation.`,
    vocab: [
      { word: 'Engagement', definition: 'Active involvement and interest — showing that you are paying attention and contributing.' },
      { word: 'Interrupt', definition: 'To start speaking before someone else has finished — often considered rude in formal meetings.' },
      { word: 'Clarification', definition: 'An explanation that makes something clearer — asking for clarification means asking someone to explain further.' },
      { word: 'Push back', definition: 'To disagree with or challenge an idea — expressing a different view in a professional way.' },
    ],
    questions: [
      { n: 7, q: 'How do you signal that you want to speak in a meeting without interrupting?' },
      { n: 8, q: 'Is it ever appropriate to stay silent throughout a meeting? When?' },
      { n: 9, q: 'How do cultural differences affect the way people participate in meetings?' },
    ]
  },
  {
    number: 4, title: 'Virtual Meetings and Following Up', emoji: '💻', color: '#22c55e',
    text: `The rise of remote work has made virtual meetings — conducted via platforms such as Zoom, Microsoft Teams, or Google Meet — a standard part of professional life. While the core communication skills remain the same, virtual meetings bring additional challenges. Technical problems, background noise, and the absence of body language can all make communication more difficult. Experienced virtual meeting participants mute themselves when not speaking, use the raise hand function to signal they want to contribute, and follow up in the chat if they cannot get into the conversation verbally.\n\nRegardless of whether a meeting is in person or online, the follow-up is critical. A well-written meeting summary — sometimes called meeting minutes — should be sent to all participants within 24 hours. It should include the key decisions made, a list of action points with named owners and deadlines, and any items that were parked for future discussion. Without a clear follow-up, even a productive meeting can lose momentum as people return to their daily work and forget what was agreed. The follow-up is not just an administrative task — it is a communication tool that keeps teams accountable and projects moving forward.`,
    vocab: [
      { word: 'Mute', definition: 'To turn off your microphone in a virtual meeting so others cannot hear background noise.' },
      { word: 'Meeting minutes', definition: 'An official written record of what was discussed and decided in a meeting.' },
      { word: 'Accountable', definition: 'Responsible for your actions and required to explain or justify them to others.' },
      { word: 'Momentum', definition: 'The energy or progress that keeps something moving forward — the drive to continue.' },
    ],
    questions: [
      { n: 10, q: 'What are the biggest challenges of virtual meetings compared to in-person ones?' },
      { n: 11, q: 'Why do you think so many meetings end without a clear follow-up or action list?' },
      { n: 12, q: 'How has the rise of remote work changed meeting culture in your industry or country?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B2 level student practise Business English discussion skills. The reading topic is "Running and Participating in Meetings". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function RunningMeetingsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Running and Participating in Meetings</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Say What You Mean — learn how to chair meetings confidently, contribute effectively as a participant, and follow up professionally.</p>
            </div>
          </div>
