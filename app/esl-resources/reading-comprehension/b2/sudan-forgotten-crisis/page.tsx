...
const PARTS = [
  {
    number: 1, title: 'The Crisis Nobody Sees', emoji: '🇸🇩', color: '#dc2626',
    text: `While the world watches the US-Iran conflict and the war in Ukraine, another catastrophe is unfolding with almost no international attention. In Sudan, more than 200,000 people were displaced this week alone — by a combination of civil war and catastrophic flooding. The total number of displaced Sudanese has reached 14 million — making it the largest displacement crisis in the world, surpassing even Ukraine.\n\nSudan's civil war began in April 2023 when two rival military factions — the Sudanese Armed Forces and the Rapid Support Forces — turned their guns on each other. The fighting has killed tens of thousands of people, destroyed hospitals, schools, and infrastructure, and created famine conditions in several regions.\n\nThis week, the crisis deepened as heavy seasonal rains caused flooding that destroyed camps sheltering people already displaced by fighting. Families who had fled violence found their temporary shelters underwater. Aid workers described scenes of desperation — people standing on rooftops, surrounded by floodwater, with no food, no clean water, and no way out.\n\nThe international response has been woefully inadequate. The UN's humanitarian appeal for Sudan is less than 20% funded. News coverage is minimal. Political attention is focused elsewhere. Sudan has become what aid workers call a "forgotten crisis" — a catastrophe that is no less devastating for being invisible.`,
    vocab: [
      { word: 'Displaced', definition: 'Forced to leave your home because of war, disaster, or persecution.' },
      { word: 'Factions', definition: 'Groups within a larger organisation that disagree and compete for power.' },
      { word: 'Famine', definition: 'Extreme shortage of food affecting a large number of people — mass starvation.' },
      { word: 'Woefully', definition: 'Very badly — to a degree that is seriously inadequate or disappointing.' },
    ],
    questions: [
      { n: 1, q: '14 million displaced — more than Ukraine. Why does Sudan receive so much less attention?' },
      { n: 2, q: 'People displaced by war then had their shelters destroyed by floods. How do multiple crises compound suffering?' },
      { n: 3, q: 'The UN appeal is less than 20% funded. Why do some crises attract funding and others do not?' },
    ]
  },
  {
    number: 2, title: 'Why Sudan Broke', emoji: '⚔️', color: '#b91c1c',
    text: `Sudan's civil war is the result of a power struggle between two men: General Abdel Fattah al-Burhan, who leads the Sudanese Armed Forces, and General Mohamed Hamdan Dagalo — known as Hemedti — who leads the Rapid Support Forces.\n\nBoth men were allies during the military coup that overthrew Sudan's civilian transitional government in 2021. They shared power uneasily for two years before their rivalry erupted into open warfare in April 2023. The fighting quickly spread from the capital, Khartoum, across the country.\n\nThe conflict has been characterised by extraordinary brutality against civilians. Both sides have been accused of targeting civilian areas, using sexual violence as a weapon, blocking humanitarian aid, and committing ethnic violence. In the western region of Darfur — which experienced a genocide in the early 2000s — the RSF and allied militias have been accused of carrying out ethnically targeted killings that the UN has warned may constitute a new genocide.\n\nForeign powers have fuelled the conflict by supplying weapons and support to both sides. The UAE has been accused of supplying arms to the RSF. Egypt and Saudi Arabia have provided support to the SAF. Russia's Wagner Group — now rebranded — has operated in Sudan. The result is a proxy war in which foreign interests are pursued at the cost of Sudanese lives.\n\nThe civilian population — 48 million people — has no say in a war being fought by two generals over power and resources. They are caught between two armies, neither of which has shown any regard for their welfare.`,
    vocab: [
      { word: 'Coup', definition: 'A sudden, violent seizure of power from a government — often by the military.' },
      { word: 'Genocide', definition: 'The deliberate killing of a large group of people based on their ethnicity, religion, or nationality.' },
      { word: 'Proxy war', definition: 'A conflict where larger powers fight indirectly by supporting opposing sides.' },
      { word: 'Welfare', definition: 'The health, happiness, and safety of a person or group — their wellbeing.' },
    ],
    questions: [
      { n: 4, q: 'Two generals who were once allies are now destroying their country. What does this tell us about power and human nature?' },
      { n: 5, q: 'Foreign countries supply weapons to both sides. Should there be consequences for fuelling a war that kills civilians?' },
      { n: 6, q: '48 million civilians have no say in a war fought over power. What can ordinary people do when their leaders destroy their country?' },
    ]
  },
  {
    number: 3, title: 'Why Nobody Is Watching', emoji: '📺', color: '#991b1b',
    text: `The disparity between the scale of suffering in Sudan and the attention it receives is one of the most troubling features of the modern media landscape.\n\nSeveral factors explain why some crises attract attention and others do not. Geographic and cultural proximity matters — European audiences pay more attention to conflicts in Europe (Ukraine) and the Middle East (Gaza, Iran) than to conflicts in sub-Saharan Africa. Media infrastructure matters — there are very few international journalists in Sudan, making it difficult to produce the images and stories that drive coverage. And strategic relevance matters — the US-Iran conflict affects oil prices and global trade in ways that directly impact Western audiences, while Sudan's war, however devastating, has fewer direct economic consequences for wealthy countries.\n\nRace and racism play a role too, though this is rarely acknowledged openly. Studies consistently show that media coverage of crises is influenced by the race and nationality of the victims. A study by the Reuters Institute found that humanitarian emergencies affecting predominantly white populations received significantly more coverage than comparable emergencies affecting non-white populations.\n\nThe consequences of invisibility are concrete. When a crisis is not covered, the public does not demand action. When the public does not demand action, politicians do not act. When politicians do not act, funding does not flow. The result is a vicious cycle in which the most neglected crises become more neglected — and the people suffering in them become more invisible.\n\nSudan's 14 million displaced people are not less important than the displaced people in Ukraine or Gaza. Their suffering is not less real. Their children are not less deserving of food, shelter, and education. The only difference is that fewer people are watching.`,
    vocab: [
      { word: 'Disparity', definition: 'A great difference — an inequality that is unfair or unjustified.' },
      { word: 'Proximity', definition: 'Nearness — being close to something geographically or culturally.' },
      { word: 'Invisibility', definition: 'The state of not being seen or noticed — being ignored despite existing.' },
      { word: 'Vicious cycle', definition: 'A repeating pattern where each problem makes the next one worse.' },
    ],
    questions: [
      { n: 7, q: 'European crises get more coverage than African crises. Is this bias, or is it natural that people care more about what is close to them?' },
      { n: 8, q: 'Studies show race affects how much coverage a crisis receives. How should media organisations address this?' },
      { n: 9, q: 'When a crisis is invisible, funding does not flow. How can aid organisations make forgotten crises visible?' },
    ]
  },
  {
    number: 4, title: 'What Can Be Done?', emoji: '💚', color: '#7f1d1d',
    text: `The situation in Sudan is not hopeless — but it requires the international community to decide that Sudanese lives matter as much as any others.\n\nThe most immediate need is humanitarian funding. The UN estimates that 25 million Sudanese need humanitarian assistance. Providing food, clean water, shelter, and medical care to even a fraction of these people requires billions of dollars. The current funding gap means that aid agencies must make impossible choices — feeding one community means another goes hungry.\n\nDiplomatic pressure is essential. Both warring factions depend on foreign support. If the countries supplying weapons and money — particularly the UAE, Egypt, and Saudi Arabia — were pressured to stop, the combatants would have less capacity to fight. An arms embargo, enforced by the UN Security Council, could reduce the violence. But geopolitical rivalries among Security Council members have so far prevented any meaningful action.\n\nAccountability matters. The evidence of atrocities in Sudan — including potential genocide in Darfur — must be documented, preserved, and eventually prosecuted. The International Criminal Court and human rights organisations are collecting evidence. Whether this evidence ever leads to justice depends on political will that currently does not exist.\n\nFinally, attention matters. Every news story about Sudan, every social media post, every classroom discussion makes the crisis slightly less invisible. The people of Sudan cannot make the world watch. But those of us who do watch have a responsibility to speak — to insist that a crisis affecting 14 million people is not acceptable simply because it is happening far away.\n\nSudan deserves better. Its people deserve to be seen.`,
    vocab: [
      { word: 'Arms embargo', definition: 'An official ban on selling weapons to a particular country or group.' },
      { word: 'Combatants', definition: 'People or groups actively fighting in a war — the armed parties in a conflict.' },
      { word: 'Documented', definition: 'Recorded and preserved as evidence — creating an official record.' },
      { word: 'Insist', definition: 'To demand firmly that something must happen — to refuse to accept the status quo.' },
    ],
    questions: [
      { n: 10, q: 'An arms embargo could reduce violence but has been blocked. Why do powerful countries block action on humanitarian crises?' },
      { n: 11, q: 'The passage says attention matters. Can a classroom discussion about Sudan actually make a difference? How?' },
      { n: 12, q: 'Sudan deserves to be seen. After reading this, do you feel a responsibility to learn more? What will you do?' },
    ]
  },
]
...
export default function SudanCrisisPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Sudan — The Crisis Nobody Sees</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>14 million displaced, famine spreading, and the world is barely watching. Sudan's forgotten catastrophe, why some crises get attention and others do not.</p>
            </div>
          </div>
