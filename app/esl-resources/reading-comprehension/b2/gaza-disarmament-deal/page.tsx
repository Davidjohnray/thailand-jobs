...
const PARTS = [
  {
    number: 1, title: 'A Monumental Step — or an Illusion?', emoji: '🕊️', color: '#dc2626',
    text: `On 30 July 2026, US President Donald Trump declared that his "Board of Peace" had reached a "HISTORIC agreement for the COMPLETE DISARMAMENT of Hamas and all other armed groups in Gaza." The announcement, posted on Truth Social in characteristic capitals, described the deal as "a monumental step toward lasting PEACE and SECURITY" in a region that has known neither for decades.\n\nThe agreement, if implemented, would require Hamas to surrender its weapons over approximately eight months, allow the destruction of its vast tunnel network beneath Gaza, and accept the authority of a new Palestinian security force backed by an international stabilisation force. In return, Israeli forces would withdraw from Gaza as disarmament was completed, military operations would cease, and reconstruction of the devastated territory could begin.\n\nThe reaction was immediate — and deeply divided. Trump described the deal as a breakthrough comparable to the Camp David Accords. Critics called it a fantasy dressed up as diplomacy. Hamas official Ghazi Hamad confirmed that "difficult" negotiations had produced an agreement, but added a crucial caveat: "We will not take any steps regarding disarmament before Israel withdraws from the Gaza Strip." Israeli National Security Minister Itamar Ben-Gvir called the plan "unacceptable."\n\nThe gap between what was announced and what each side appears to have agreed to is significant — and it lies at the heart of the question that dominates the region: can a deal that requires mutual trust succeed between parties that have none?`,
    vocab: [
      { word: 'Disarmament', definition: 'The process of giving up weapons — reducing or eliminating a military force.' },
      { word: 'Stabilisation force', definition: 'An international military or police presence deployed to maintain peace and order in a conflict zone.' },
      { word: 'Caveat', definition: 'A warning or condition — an important limitation that changes the meaning of a statement.' },
      { word: 'Mutual trust', definition: 'When both sides believe the other will keep their promises and act in good faith.' },
    ],
    questions: [
      { n: 1, q: 'Trump called the deal "monumental." Hamas and Israel both expressed doubts. What does this gap between the announcement and reality tell us about modern diplomacy?' },
      { n: 2, q: 'Hamas says it will not disarm until Israel withdraws. Israel says it will not withdraw until Hamas disarms. How can this deadlock be broken?' },
      { n: 3, q: 'Can a peace deal work when neither side trusts the other? What would need to happen to build that trust?' },
    ]
  },
  {
    number: 2, title: 'The War That Preceded the Deal', emoji: '💔', color: '#b91c1c',
    text: `To understand the significance of the disarmament agreement, you need to understand the war that made it necessary.\n\nOn 7 October 2023, Hamas launched an unprecedented attack on southern Israel, killing approximately 1,200 people and taking more than 250 hostages. The attack was the deadliest day for Jewish people since the Holocaust and shocked the world with its scale and brutality.\n\nIsrael responded with a massive military operation in Gaza that has continued, in various forms, for nearly three years. The campaign has caused extraordinary destruction. More than 60,000 Palestinians have been killed, according to Gaza health authorities. Much of Gaza's infrastructure — hospitals, schools, residential buildings, water systems — has been destroyed or severely damaged. More than 1.9 million of Gaza's 2.2 million residents have been displaced, many multiple times.\n\nThe humanitarian crisis has been described by the United Nations as among the worst in the world. Food insecurity, disease, and lack of medical care have compounded the direct effects of military operations. International courts have opened investigations into potential war crimes committed by both sides.\n\nA ceasefire was eventually reached in October 2025, brokered by the United States, Egypt, and Qatar. Under the first phase, most hostages were released in exchange for Palestinian prisoners. But the ceasefire remained fragile, with sporadic violations by both sides, and the fundamental questions — the future governance of Gaza, the status of Hamas, and the conditions for lasting peace — remained unresolved until the disarmament announcement.`,
    vocab: [
      { word: 'Unprecedented', definition: 'Never having happened before — without any previous example in history.' },
      { word: 'Infrastructure', definition: 'The basic systems a place needs to function — buildings, water, electricity, roads, hospitals.' },
      { word: 'Humanitarian crisis', definition: 'A situation where large numbers of people face serious threats to their health, safety, or survival.' },
      { word: 'Sporadic', definition: 'Happening irregularly and unpredictably — not constant but occurring from time to time.' },
    ],
    questions: [
      { n: 4, q: 'More than 60,000 Palestinians have been killed. How should the international community respond to civilian casualties on this scale?' },
      { n: 5, q: 'Both sides have been accused of war crimes. Should there be accountability? What form should it take?' },
      { n: 6, q: 'The ceasefire was fragile for months before the disarmament deal. What makes ceasefires so difficult to maintain?' },
    ]
  },
  {
    number: 3, title: 'The Verification Problem', emoji: '🔍', color: '#991b1b',
    text: `Even if both sides genuinely want the disarmament deal to succeed — which is far from certain — the practical challenges of implementation are enormous.\n\nThe most fundamental challenge is verification. How do you confirm that an armed group has actually surrendered all of its weapons? Hamas has spent decades building a military infrastructure that includes thousands of rockets, small arms, anti-tank missiles, explosive devices, and an extensive tunnel network estimated to stretch for hundreds of kilometres beneath Gaza. Much of this infrastructure is hidden underground, in buildings, and in locations that even Israeli intelligence may not be aware of.\n\nThe agreement calls for an independent verification body and an international stabilisation force, but the details remain vague. Who would conduct the verification? What access would they have? What happens if hidden weapons are discovered after disarmament is declared complete? Historical precedents are not encouraging — disarmament agreements in Northern Ireland, Colombia, and Libya all faced significant verification challenges, and in several cases, armed groups retained hidden weapons.\n\nThe sequencing problem is equally difficult. The deal envisions a phased process: Hamas disarms, international forces deploy, Israeli forces withdraw. But each step depends on the previous one being completed satisfactorily — and the definition of "satisfactorily" is itself contested. Israel wants complete, verified disarmament before any withdrawal. Hamas wants withdrawal before any disarmament. The gap between these positions is the space in which the deal could collapse.\n\nPerhaps most importantly, disarmament addresses the military dimension of the conflict but not the political one. Even if every weapon in Gaza were surrendered tomorrow, the underlying grievances — occupation, self-determination, security, sovereignty — would remain. Without addressing these root causes, many analysts argue, any peace will be temporary.`,
    vocab: [
      { word: 'Verification', definition: 'The process of checking and confirming that something is true, accurate, or has been completed as promised.' },
      { word: 'Precedents', definition: 'Previous examples that can be used as guidance for similar situations in the future.' },
      { word: 'Sequencing', definition: 'The order in which steps must happen — which comes first, second, and third.' },
      { word: 'Self-determination', definition: 'The right of a people to decide their own political status and govern themselves.' },
    ],
    questions: [
      { n: 7, q: 'How do you verify that an armed group has surrendered ALL its weapons? Is complete verification even possible?' },
      { n: 8, q: 'Past disarmament deals in Northern Ireland and Colombia faced similar challenges. Should we learn from these examples? What worked and what did not?' },
      { n: 9, q: 'The passage says disarmament addresses military issues but not political ones. Can there be lasting peace without addressing root causes like occupation and self-determination?' },
    ]
  },
  {
    number: 4, title: 'What Peace Would Require', emoji: '🌍', color: '#7f1d1d',
    text: `The Gaza disarmament deal, whatever its ultimate fate, has forced a conversation about what genuine, lasting peace in the region would actually require. The answer, according to most scholars of the conflict, goes far beyond weapons.\n\nFirst, it would require a political settlement that addresses the fundamental question of Palestinian statehood. The international consensus — supported by the United Nations, the European Union, and most countries in the world — is that lasting peace requires the creation of an independent Palestinian state alongside Israel. Israel's current government rejects this, and successive US administrations have been unable or unwilling to push for it.\n\nSecond, it would require accountability and justice. The scale of destruction in Gaza — tens of thousands of civilians killed, an entire territory reduced to rubble — cannot simply be forgotten. For Palestinians, any peace that does not acknowledge what they have suffered will feel like defeat, not resolution. For Israelis, any peace that does not address the trauma of 7 October will feel equally hollow.\n\nThird, it would require sustained international commitment. The reconstruction of Gaza alone will cost tens of billions of dollars and take decades. International donors will need to fund this reconstruction, international forces will need to maintain security, and international mediators will need to remain engaged through the inevitable setbacks and crises that will occur along the way.\n\nThe disarmament agreement is, at best, the first step on a very long road. Whether it leads to genuine peace or becomes another failed promise in a conflict that has consumed generations depends on decisions that have not yet been made — by leaders in Jerusalem, Ramallah, Washington, and capitals around the world. The people of Gaza, who have endured more suffering than almost any population on Earth in recent years, are watching and waiting.`,
    vocab: [
      { word: 'Political settlement', definition: 'An agreement that resolves the fundamental political disagreements at the root of a conflict.' },
      { word: 'Consensus', definition: 'General agreement among a group — a position that most people or countries support.' },
      { word: 'Accountability', definition: 'Being held responsible for actions — facing consequences and acknowledging what happened.' },
      { word: 'Reconstruction', definition: 'The process of rebuilding something that has been destroyed — restoring infrastructure and communities.' },
    ],
    questions: [
      { n: 10, q: 'Most of the world supports a two-state solution. Israel rejects it. Can peace be achieved without Palestinian statehood?' },
      { n: 11, q: 'Rebuilding Gaza will cost tens of billions and take decades. Who should pay for this? What obligation does the international community have?' },
      { n: 12, q: 'The passage says the people of Gaza are watching and waiting. If you could send them one message, what would it be?' },
    ]
  },
]
...
export default function GazaDealPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Gaza Disarmament Deal</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Trump announced a historic deal for Hamas to disarm. But Israel and Hamas disagree on the terms. Can a deal built on distrust actually deliver peace?</p>
            </div>
          </div>
