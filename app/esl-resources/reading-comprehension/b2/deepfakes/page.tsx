...
const PARTS = [
  {
    number: 1, title: 'A New Kind of Lie', emoji: '📹', color: '#6366f1',
    text: `In 2024, a finance worker at a multinational company in Hong Kong received a video call from his chief financial officer. The CFO, appearing live on screen alongside several other senior colleagues, instructed the worker to transfer 25 million US dollars to a series of bank accounts. The worker complied. Every person on that video call — every face, every voice, every gesture — was a deepfake. None of them were real. The money was gone.\n\nA deepfake is a piece of media — usually a video or audio recording — that has been created or manipulated using artificial intelligence to make it appear that someone is saying or doing something they never actually said or did. The technology uses a type of AI called deep learning to analyse thousands of images and audio samples of a real person, learn the patterns of their face, voice, and movements, and then generate convincing synthetic versions.\n\nThe technology has improved with extraordinary speed. Early deepfakes, which first appeared around 2017, were often easy to spot — the faces looked slightly wrong, the mouth movements did not quite match the audio, the eyes behaved strangely. Today, the best deepfakes are virtually indistinguishable from genuine footage, even to trained experts using forensic analysis tools. What once required expensive equipment and specialist skills can now be produced using free software on an ordinary laptop.\n\nThis combination of increasing quality and decreasing cost has made deepfakes one of the most significant technological threats of the decade — not because the technology itself is inherently evil, but because it attacks something fundamental to how human societies function: the ability to trust what we see and hear.`,
    vocab: [
      { word: 'Manipulated', definition: 'Changed or altered in a clever way, often to deceive or mislead someone.' },
      { word: 'Synthetic', definition: 'Artificially created rather than natural — made by technology rather than occurring naturally.' },
      { word: 'Forensic', definition: 'Using scientific methods to investigate and analyse evidence, especially for legal purposes.' },
      { word: 'Indistinguishable', definition: 'Impossible to tell apart from something else — so similar that no difference can be detected.' },
    ],
    questions: [
      { n: 1, q: 'The Hong Kong worker lost 25 million dollars to a deepfake video call. What safeguards should companies put in place to prevent this?' },
      { n: 2, q: 'The passage says deepfakes attack the ability to trust what we see and hear. How important is this ability to society?' },
      { n: 3, q: 'Deepfake technology is now available for free on ordinary laptops. Should access to this technology be restricted? How?' },
    ]
  },
  {
    number: 2, title: 'The Weaponisation of Fakery', emoji: '⚔️', color: '#4f46e5',
    text: `The most immediate and widespread harm caused by deepfakes has been in two areas: non-consensual intimate imagery and political disinformation.\n\nThe overwhelming majority of deepfakes currently circulating online — estimated at over 90% — are non-consensual intimate content, in which the faces of real people, almost always women, are placed onto explicit material without their knowledge or consent. The victims include both public figures and ordinary individuals, and the psychological harm can be devastating.\n\nPolitical deepfakes represent a different but equally serious threat. During election campaigns in multiple countries, deepfake videos have been used to make candidates appear to say things they never said, to fabricate endorsements, and to create false impressions of events that never occurred. In 2023, a deepfake audio clip of a political leader appeared to show him making inflammatory statements — it was shared millions of times before it was identified as fake.\n\nThe danger of political deepfakes is not only that people will believe false content. It is also what researchers call the "liar's dividend" — the idea that in a world where any video or audio could be fake, real evidence of genuine misconduct can be dismissed as a deepfake. A politician caught on camera doing something wrong can now claim the footage is AI-generated. The existence of deepfake technology does not just make lies more convincing — it makes truth less powerful.`,
    vocab: [
      { word: 'Disinformation', definition: 'False information that is deliberately created and spread to mislead people.' },
      { word: 'Fabricate', definition: 'To invent or create something false — to make up a lie or a fake piece of evidence.' },
      { word: 'Inflammatory', definition: 'Likely to cause anger, violence, or strong negative emotions.' },
      { word: 'Misconduct', definition: 'Unacceptable or improper behaviour, especially by a professional or public figure.' },
    ],
    questions: [
      { n: 4, q: 'The liar\'s dividend means real evidence can be dismissed as fake. Is this more dangerous than deepfakes themselves?' },
      { n: 5, q: '90% of deepfakes are non-consensual intimate content targeting women. What does this tell us about how technology is used?' },
      { n: 6, q: 'How should social media platforms respond when a deepfake goes viral? What responsibility do they have?' },
    ]
  },
  {
    number: 3, title: 'Detection and Defence', emoji: '🛡️', color: '#4338ca',
    text: `The fight against deepfakes mirrors the fight against doping in sport — it is an arms race between those who create fakes and those who try to detect them.\n\nEarly deepfake detection relied on visible flaws — unnatural blinking patterns, inconsistent lighting, distorted edges around the face. As deepfake technology improved, these flaws disappeared. Modern detection tools use AI to analyse subtle features that the human eye cannot perceive — micro-expressions, blood flow patterns beneath the skin, the way light reflects off the surface of an eye.\n\nSome organisations are taking a different approach: rather than trying to detect fakes after they are created, they are working to verify authentic content at the point of creation. The Content Authenticity Initiative, backed by Adobe and Microsoft, is developing a system that embeds a digital signature into photos and videos at the moment they are captured. Any subsequent manipulation would break the signature.\n\nGovernments are also responding with legislation. The European Union's AI Act requires that AI-generated content be clearly labelled. China has introduced laws requiring deepfake creators to obtain consent and to watermark synthetic content. Several US states have passed laws specifically criminalising malicious deepfakes.\n\nBut enforcement remains the central challenge. Deepfakes can be created anywhere and distributed instantly across borders. A video created in one country can cause harm in another before any legal system has time to respond. Technology, once again, is moving faster than the law.`,
    vocab: [
      { word: 'Sophisticated', definition: 'Complex, advanced, and highly developed — using the latest knowledge or technology.' },
      { word: 'Authentic', definition: 'Genuine and real — not a copy, fake, or imitation.' },
      { word: 'Digital signature', definition: 'A coded stamp embedded in a digital file that proves who created it and whether it has been changed.' },
      { word: 'Criminalising', definition: 'Making something illegal — turning an activity into a criminal offence punishable by law.' },
    ],
    questions: [
      { n: 7, q: 'The passage compares deepfake detection to the fight against doping in sport. Who is currently winning?' },
      { n: 8, q: 'Verifying real content vs detecting fake content — which approach do you think is more promising? Why?' },
      { n: 9, q: 'Technology moves faster than the law. Is it possible for legislation to keep up with AI? What alternatives might work?' },
    ]
  },
  {
    number: 4, title: 'Living in a Post-Truth World', emoji: '🌐', color: '#3730a3',
    text: `The deepest challenge posed by deepfakes is not technical — it is philosophical. If any piece of media can be faked, how do we decide what is real?\n\nSome researchers argue that we are entering a "post-truth" era in which objective, verifiable reality is being eroded — not just by deepfakes, but by a broader information environment in which social media algorithms prioritise engagement over accuracy, and people increasingly consume information that confirms their existing beliefs.\n\nOthers are more optimistic. They point out that every major communication technology — the printing press, photography, radio, television — was initially accompanied by fears that it would be used to deceive and manipulate. Each time, societies eventually developed the tools, institutions, and cultural norms needed to distinguish reliable information from unreliable. Deepfakes, they argue, will follow the same pattern.\n\nWhat most experts agree on is that media literacy — the ability to critically evaluate the information we consume — has become an essential life skill. Understanding how deepfakes work, knowing where to check the authenticity of content, and developing the habit of pausing before sharing something online are no longer optional skills. They are as fundamental as reading and writing.\n\nThe technology behind deepfakes is not going away. It will continue to improve. The question is not whether we can stop it — we cannot — but whether we can build a society that is resilient enough to function in a world where seeing is no longer believing.`,
    vocab: [
      { word: 'Post-truth', definition: 'A situation where emotions and personal beliefs are more influential than objective facts.' },
      { word: 'Eroded', definition: 'Gradually worn away or weakened over time.' },
      { word: 'Media literacy', definition: 'The ability to critically analyse and evaluate media content — to tell reliable from unreliable.' },
      { word: 'Resilient', definition: 'Able to recover from difficulties and adapt to challenges — tough and flexible.' },
    ],
    questions: [
      { n: 10, q: 'The passage says seeing is no longer believing. How do you personally decide whether something you see online is real?' },
      { n: 11, q: 'Should media literacy be taught in schools as a core subject alongside reading and maths? At what age should it start?' },
      { n: 12, q: 'Are you optimistic or pessimistic about our ability to adapt to deepfakes? What gives you hope or concern?' },
    ]
  },
]
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(99,102,241,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Technology</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Deepfakes — When You Cannot Believe What You See</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>AI can now create fake videos so realistic that even experts struggle to tell them from the real thing. What does this mean for truth, trust, and democracy?</p>
            </div>
          </div>
