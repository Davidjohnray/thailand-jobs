...
const PARTS = [
  {
    number: 1, title: 'Two Countries, One Archipelago', emoji: '🗺️', color: '#dc2626',
    text: `This week, Argentine President Javier Milei escalated his country\'s long-running dispute with the United Kingdom over a group of small, wind-swept islands in the South Atlantic Ocean. Argentina imposed new sanctions on companies involved in an offshore oil project near the islands and demanded that Britain negotiate their sovereignty.\n\nThe Falkland Islands — or Islas Malvinas, as Argentina calls them — are a remote archipelago of about 780 islands, roughly 480 kilometres east of the Argentine coast. They have a total population of approximately 3,500 people, most of whom are of British descent and overwhelmingly want to remain British. The islands have been under British control since 1833.\n\nArgentina has claimed the islands since it became independent from Spain in the early 19th century, arguing that it inherited Spain\'s colonial claim to the territory. In 1982, Argentina invaded the Falklands, triggering a 74-day war with Britain that killed 649 Argentine soldiers, 255 British soldiers, and 3 civilian islanders. Britain won and re-established control.\n\nMore than 40 years later, the dispute continues. Argentina\'s constitution includes a clause asserting sovereignty over the Malvinas. Every Argentine president reaffirms the claim. And for many Argentines, the islands represent an unhealed wound — a piece of their country that was taken by a colonial power and never returned.`,
    vocab: [
      { word: 'Archipelago', definition: 'A group or chain of islands — scattered islands in the same area of sea.' },
      { word: 'Sovereignty', definition: 'The authority to govern a territory — the right to control and rule a place.' },
      { word: 'Colonial', definition: 'Relating to colonialism — when one country takes control of another territory.' },
      { word: 'Sanctions', definition: 'Penalties or restrictions imposed on a country or companies to pressure them.' },
    ],
    questions: [
      { n: 1, q: 'Argentina says the Falklands are theirs. Britain says they are British. The islanders want to stay British. Whose opinion should matter most?' },
      { n: 2, q: '649 Argentine and 255 British soldiers died fighting over these islands in 1982. Was this war worth it?' },
      { n: 3, q: 'Can you think of other territorial disputes in the world? Why do countries fight over land — even small, remote pieces of it?' },
    ]
  },
  {
    number: 2, title: 'Why Fight Over Rocks?', emoji: '🛢️', color: '#b91c1c',
    text: `The Falkland Islands might seem like an unlikely thing to fight over. They are cold, windy, and home to more penguins than people. But beneath the surface — both literally and figuratively — there are reasons why both countries care so much.\n\nOil is the most obvious reason. Surveys have estimated that the waters around the Falklands contain significant oil and gas reserves — potentially billions of barrels. A major offshore oil project is currently underway, and Argentina\'s new sanctions target the companies involved. For Argentina, a country that has lurched from one economic crisis to another, control of these oil reserves would be transformative.\n\nFishing rights are also valuable. The waters around the Falklands are among the richest fishing grounds in the South Atlantic. Squid, in particular, is a major industry — the Falkland Islands government earns millions of dollars annually from selling fishing licences.\n\nBut the dispute is about more than resources. For Argentina, the Malvinas are a matter of national identity. The islands represent a colonial injustice — a piece of Argentine territory taken by a European power nearly 200 years ago. For Britain, the islands represent self-determination — the right of the islanders to choose their own nationality. In a 2013 referendum, 99.8% of Falkland Islanders voted to remain British.\n\nBoth arguments have merit. And that is what makes territorial disputes so difficult to resolve — both sides genuinely believe they are right.`,
    vocab: [
      { word: 'Figuratively', definition: 'In a symbolic rather than literal way — used to describe a deeper meaning.' },
      { word: 'Transformative', definition: 'Causing a major change — dramatically altering the situation.' },
      { word: 'Self-determination', definition: 'The right of people to decide their own political status — choosing their own government.' },
      { word: 'Referendum', definition: 'A direct vote by all citizens on an important political question.' },
    ],
    questions: [
      { n: 4, q: 'Oil, fish, and national pride. Which of these do you think is the real reason for the dispute?' },
      { n: 5, q: '99.8% of islanders voted to stay British. Should this settle the question? Why or why not?' },
      { n: 6, q: 'Both sides believe they are right. How do you solve a dispute when both arguments have merit?' },
    ]
  },
  {
    number: 3, title: 'Territorial Disputes Around the World', emoji: '🌍', color: '#991b1b',
    text: `The Falklands dispute is just one of dozens of territorial conflicts around the world. Humans have been fighting over land for as long as civilisation has existed — and many of these disputes remain unresolved.\n\nIn Asia, China, Vietnam, the Philippines, Malaysia, Brunei, and Taiwan all claim parts of the South China Sea — a waterway through which roughly one-third of global shipping passes. China has built artificial islands with military bases on them. The Philippines has taken the dispute to an international tribunal. Tensions remain high.\n\nJapan and Russia dispute ownership of the Kuril Islands — a chain of islands between Japan and Russia that the Soviet Union seized at the end of World War II. Despite decades of negotiations, no peace treaty has been signed between the two countries.\n\nIndia and Pakistan have fought three wars over Kashmir — a mountainous region that both countries claim in full but control only in part. The dispute has lasted since 1947 and shows no sign of resolution.\n\nEven in Europe, territorial disputes persist. Spain claims Gibraltar, a small British territory at the southern tip of the Iberian Peninsula. Morocco claims Ceuta and Melilla, two Spanish cities on the North African coast. And Cyprus remains divided between a Greek south and a Turkish-occupied north.\n\nWhat all these disputes share is a clash between different principles — historical claims, ethnic identity, self-determination, and strategic interest — with no universally accepted rule for deciding which principle should win.`,
    vocab: [
      { word: 'Tribunal', definition: 'An official court or panel set up to settle a specific dispute.' },
      { word: 'Seized', definition: 'Took control of something by force — grabbed quickly and without permission.' },
      { word: 'Resolution', definition: 'A solution to a dispute — an agreement that settles the question.' },
      { word: 'Strategic', definition: 'Important for military or political advantage — valuable for control and security.' },
    ],
    questions: [
      { n: 7, q: 'China has built military bases on artificial islands. How does this change the nature of territorial disputes?' },
      { n: 8, q: 'Thailand has its own border issues with neighbouring countries. How does Thailand handle territorial questions?' },
      { n: 9, q: 'There is no universal rule for who owns disputed territory. Should there be one? What would it look like?' },
    ]
  },
  {
    number: 4, title: 'Penguins, Oil, and Pride', emoji: '🐧', color: '#7f1d1d',
    text: `The Falkland Islands dispute will probably never be fully resolved. Argentina will never abandon its claim. Britain will never hand over a territory whose residents overwhelmingly want to remain British. And the islanders — 3,500 people who raise sheep, catch squid, and share their home with half a million penguins — will continue living their quiet lives while two countries argue about who owns the ground they stand on.\n\nThere is something absurd about the dispute — and also something very human. Two countries, separated by thousands of kilometres, both passionately attached to a group of cold, windy islands in one of the remotest parts of the world. The absurdity is the point: humans will fight over almost anything if it becomes a matter of national pride.\n\nBut there are also real consequences. The 1982 war killed nearly 1,000 people. The ongoing dispute prevents normal economic relations between Argentina and the Falklands. And the escalation of sanctions this week — timed to coincide with comments by US President Trump appearing to support Argentina\'s position — could increase tensions further.\n\nFor the penguins, of course, none of this matters. The king penguins, gentoo penguins, and rockhopper penguins of the Falkland Islands do not recognise borders, do not vote in referendums, and do not care which flag flies over their breeding grounds. Perhaps they have the right idea.`,
    vocab: [
      { word: 'Absurd', definition: 'Ridiculous and unreasonable — so silly that it should not be taken seriously.' },
      { word: 'Remotest', definition: 'Most distant and far away — the most isolated and hard to reach.' },
      { word: 'Coincide', definition: 'To happen at the same time — events occurring together.' },
      { word: 'Breeding grounds', definition: 'Places where animals go to mate and raise their young.' },
    ],
    questions: [
      { n: 10, q: 'Humans fight over cold, windy islands in the middle of nowhere. What does this tell us about national pride?' },
      { n: 11, q: 'The 1982 war killed nearly 1,000 people over these islands. Is any piece of land worth dying for?' },
      { n: 12, q: 'The penguins do not care which flag flies over their home. What can we learn from this perspective?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Argentina Fights UK Over the Falkland Islands — Again". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function FalklandsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Argentina Fights UK Over the Falkland Islands — Again</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Argentina is escalating its dispute with Britain over tiny islands in the South Atlantic. Who owns the Falklands, why do they matter, and can two countries fight over rocks in the ocean?</p>
            </div>
          </div>
