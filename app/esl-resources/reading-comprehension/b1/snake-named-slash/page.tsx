...
const PARTS = [
  {
    number: 1, title: 'Rock and Roll Reptile', emoji: '🎸', color: '#dc2626',
    text: `Scientists this week announced the discovery of a new species of snake in New Guinea — and named it after one of the most famous rock guitarists in history. The snake, officially called Tropidophis slashii, is named after Slash — the legendary lead guitarist of Guns N\' Roses, known for his top hat, curly hair, and iconic guitar solos.\n\nThe naming was not random. Slash has been a lifelong reptile enthusiast who has owned dozens of snakes, lizards, and other reptiles throughout his career. He has supported wildlife conservation organisations and has spoken publicly about his love of herpetology — the study of reptiles and amphibians. When the research team discovered the new species, naming it after Slash felt natural.\n\n"Slash has done more to make people interested in snakes than almost any public figure," said the lead researcher. "Most people are afraid of snakes. But when a rock legend says snakes are fascinating, people listen."\n\nThe snake itself is a small, non-venomous species found in the rainforests of Papua New Guinea. It is approximately 50 centimetres long, brown with darker markings, and lives in the forest canopy. Like many newly discovered species, it was identified not by its appearance but through genetic testing — its DNA showed it was distinct from all previously known species.`,
    vocab: [
      { word: 'Species', definition: 'A group of living things that are the same type and can reproduce together.' },
      { word: 'Herpetology', definition: 'The scientific study of reptiles and amphibians — snakes, lizards, frogs, and turtles.' },
      { word: 'Conservation', definition: 'Protecting animals, plants, and natural habitats from destruction.' },
      { word: 'Canopy', definition: 'The top layer of a forest — the branches and leaves that form a roof over the trees below.' },
    ],
    questions: [
      { n: 1, q: 'A snake named after a rock star. What was your first reaction? Would this make you more interested in snakes?' },
      { n: 2, q: 'Slash has made people interested in reptiles just by talking about his love of snakes. Can celebrities change how we feel about animals?' },
      { n: 3, q: 'The snake was identified through DNA, not appearance. Why is genetic testing important for discovering new species?' },
    ]
  },
  {
    number: 2, title: 'What Is in a Name?', emoji: '📝', color: '#b91c1c',
    text: `Naming a species after a celebrity might sound like a publicity stunt, but it is actually part of a long scientific tradition — and there are good reasons for it.\n\nWhen scientists discover a new species, they get to choose its official scientific name. This name follows strict rules set by the International Code of Zoological Nomenclature — it must be in Latin or Greek, it must be unique, and once published, it cannot be changed. The person who discovers the species gets to decide what to call it.\n\nMany scientists use the naming opportunity to honour people they admire. There is a spider named after David Bowie (Heteropoda davidbowie). A fly named after Beyonce (Scaptia beyonceae — because of its golden rear end). A moth named after Donald Trump (Neopalpa donaldtrumpi — because of its yellow head scales). And now a snake named after Slash.\n\nBut celebrity names serve a practical purpose too: they attract attention. When a new species is announced with a forgettable Latin name, nobody outside the scientific community notices. When it is named after a rock star, the story goes viral — and suddenly millions of people are learning about biodiversity, rainforest conservation, and the ongoing discovery of new species. In a world where attention is the most valuable currency, a famous name can be a powerful tool for science.\n\nThere are approximately 8.7 million species on Earth. Scientists have formally described only about 1.5 million of them. That means roughly 7 million species are waiting to be discovered, named, and studied — many of them in places like the rainforests of New Guinea that are rapidly being destroyed.`,
    vocab: [
      { word: 'Nomenclature', definition: 'The system of names and naming rules used in a particular field — scientific naming conventions.' },
      { word: 'Biodiversity', definition: 'The variety of life in a particular area — the number of different species living together.' },
      { word: 'Viral', definition: 'Spreading rapidly across the internet — shared by millions of people.' },
      { word: 'Formally described', definition: 'Officially identified and named by scientists — documented in scientific literature.' },
    ],
    questions: [
      { n: 4, q: 'A spider named after Bowie, a fly after Beyonce, a moth after Trump. Which is your favourite? Why do scientists do this?' },
      { n: 5, q: 'Celebrity names make people care about new species. Is using fame for conservation a good strategy?' },
      { n: 6, q: '7 million species have not been discovered yet. Why should we care about species we have never seen?' },
    ]
  },
  {
    number: 3, title: 'The Race to Discover', emoji: '🔍', color: '#991b1b',
    text: `The discovery of Slash snake highlights an urgent problem: scientists are in a race against time to discover and catalogue Earth species before they disappear.\n\nThe rate of species extinction is currently 100 to 1,000 times higher than the natural background rate. Habitat destruction — particularly deforestation in tropical regions — is the primary driver. Every time a hectare of rainforest is cleared for farming, logging, or mining, dozens of species that lived there may be lost forever — many of them never known to science.\n\nNew Guinea, where the Slash snake was found, is one of the most biodiverse places on Earth. Its rainforests contain thousands of species found nowhere else — unique birds, mammals, reptiles, insects, and plants that evolved in isolation on the island over millions of years. But these forests are shrinking rapidly as logging companies and palm oil plantations expand.\n\nThe situation creates a painful irony: we are destroying species faster than we can discover them. Scientists estimate that dozens of species go extinct every day — most of them insects, fungi, and small organisms that nobody has ever studied. We will never know what we lost.\n\nFor the Slash snake, discovery is the first step toward protection. Once a species is formally described, it can be included in conservation assessments, habitat protection plans, and environmental laws. A species without a name has no legal protection — it does not officially exist. Naming it is not just science. It is an act of recognition that says: you are here, you matter, and you deserve to survive.`,
    vocab: [
      { word: 'Extinction', definition: 'When a species dies out completely — no living members remain anywhere on Earth.' },
      { word: 'Habitat destruction', definition: 'The removal or damage of the natural environment where species live.' },
      { word: 'Biodiverse', definition: 'Having a large variety of different species — rich in biological life.' },
      { word: 'Isolation', definition: 'Being separated from everything else — evolving alone without contact with other populations.' },
    ],
    questions: [
      { n: 7, q: 'We are destroying species faster than we can discover them. How does this make you feel?' },
      { n: 8, q: 'A species without a name has no legal protection. Why is naming something the first step to saving it?' },
      { n: 9, q: 'New Guinea rainforests are being cleared for palm oil. Do you check whether products you buy contain palm oil?' },
    ]
  },
  {
    number: 4, title: 'Why Snakes Deserve Better', emoji: '💚', color: '#7f1d1d',
    text: `Let us be honest: most people do not like snakes. Surveys consistently show that snakes are among the most feared animals in the world — more feared than spiders, sharks, or even bears. The fear of snakes — called ophidiophobia — is so common that some researchers believe it may be partly innate, hardwired into our brains by millions of years of evolution.\n\nBut snakes are extraordinary animals that deserve our respect, not our fear. They are found on every continent except Antarctica. They range in size from the tiny Barbados threadsnake (10 centimetres) to the reticulated python (more than 7 metres). They have evolved an incredible variety of hunting strategies — from the heat-sensing pits of vipers to the constricting coils of boas to the lightning-fast strikes of cobras.\n\nSnakes play vital roles in ecosystems. They control rodent populations — a single snake can eat hundreds of mice per year. They are prey for birds, mammals, and other reptiles. And they are indicators of environmental health — when snake populations decline, it often signals broader ecological problems.\n\nIn Thailand, snakes are a common part of daily life. King cobras, pit vipers, and pythons are found across the country. Thai people have a complex relationship with snakes — respecting them, fearing them, and sometimes worshipping them in Buddhist and Hindu traditions.\n\nSlash the guitarist understood something that most people miss: snakes are not monsters. They are fascinating, beautiful, and essential parts of the natural world. Naming a snake after a rock legend is a small act — but if it makes one person reconsider their fear and see snakes differently, it is worth celebrating.`,
    vocab: [
      { word: 'Ophidiophobia', definition: 'An extreme fear of snakes — one of the most common phobias in the world.' },
      { word: 'Innate', definition: 'Born with — a quality or instinct you have naturally, not something you learn.' },
      { word: 'Constricting', definition: 'Squeezing tightly — snakes that kill by wrapping around prey and tightening.' },
      { word: 'Ecological', definition: 'Relating to the relationships between living things and their environment.' },
    ],
    questions: [
      { n: 10, q: 'Are you afraid of snakes? After reading this, has your view changed at all?' },
      { n: 11, q: 'Thailand has king cobras, pit vipers, and pythons. What is the relationship between Thai people and snakes?' },
      { n: 12, q: 'If naming a snake after a rock star makes one person see snakes differently, is it worth it? Can small acts change big attitudes?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Scientists Name New Snake After Guns N' Roses Legend Slash". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function SnakeSlashPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Scientists Name New Snake After Guns N' Roses Legend Slash</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A newly discovered snake from New Guinea has been named after rock guitarist Slash. Why scientists name species after celebrities, how new species are found, and why it matters.</p>
            </div>
          </div>
