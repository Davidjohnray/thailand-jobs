...
const PARTS = [
  {
    number: 1, title: 'Coming Home', emoji: '👑', color: '#dc2626',
    text: `On 20 August 2026, Buckingham Palace confirmed one of the most talked-about stories of the year: Prince Harry and his wife Meghan, the Duke and Duchess of Sussex, will return to the United Kingdom for an extended stay starting this autumn. The couple, who have been living in California since 2020, will bring their two children — Prince Archie, aged seven, and Princess Lilibet, aged five — back to the country where Harry grew up.\n\nThe announcement surprised many people. Harry and Meghan's departure from the royal family in 2020 — dubbed "Megxit" by the British press — was one of the most dramatic royal events in modern history. The couple gave up their roles as working members of the royal family, moved to the United States, and publicly criticised the institution they had left behind. Harry's memoir, "Spare," revealed private family conflicts in extraordinary detail. Meghan's interview with Oprah Winfrey included allegations of racism within the royal family.\n\nThe palace statement was careful and measured: "The Duke and Duchess of Sussex will spend an extended period in the United Kingdom beginning in the autumn. They will not resume roles as working members of the Royal Family." In other words, they are coming home — but not coming back to work.\n\nThe British public is divided. Some welcome the return and hope for reconciliation. Others feel that Harry and Meghan's public criticisms of the royal family were disloyal and unforgivable. The tabloid press — which played a central role in the couple's decision to leave — is predictably excited about the prospect of having them back on British soil.`,
    vocab: [
      { word: 'Extended stay', definition: 'A visit that lasts for a long time — not just a short trip but a significant period.' },
      { word: 'Memoir', definition: 'A book written about your own life experiences — a personal autobiography.' },
      { word: 'Reconciliation', definition: 'Restoring a friendly relationship after a disagreement — making peace.' },
      { word: 'Tabloid press', definition: 'Newspapers that focus on celebrity news, scandals, and sensational stories.' },
    ],
    questions: [
      { n: 1, q: 'Harry and Meghan left the UK in 2020 and criticised the royal family publicly. Would you welcome them back? Why or why not?' },
      { n: 2, q: 'They are returning but will not resume royal duties. What do you think their role will be? Can you be royal without working?' },
      { n: 3, q: 'The tabloid press is excited about their return. How does media attention affect people decisions about where to live?' },
    ]
  },
  {
    number: 2, title: 'Why They Left', emoji: '✈️', color: '#b91c1c',
    text: `To understand why Harry and Meghan's return is so significant, you need to understand why they left.\n\nMeghan Markle, an American actress, married Prince Harry in 2018 in a wedding watched by an estimated 1.9 billion people worldwide. The marriage was initially celebrated as a modernising moment for the British monarchy — Meghan was biracial, American, divorced, and outspoken, representing a break from the traditional image of the royal family.\n\nBut the relationship between Meghan and the British press quickly became toxic. Tabloid newspapers published stories that Meghan and her supporters described as racist and invasive. Headlines compared her unfavourably to other members of the royal family. Her family background was scrutinised in ways that supporters called discriminatory.\n\nHarry, who had grown up watching his mother Princess Diana be hounded by photographers — and who blamed media intrusion for her death in a car crash in 1997 — became increasingly protective and angry. In 2020, the couple announced they would "step back" from royal duties and seek financial independence. They moved to Montecito, California, signed multimillion-dollar deals with Netflix and Spotify, and began telling their side of the story.\n\nThe response in Britain was sharply divided. Many people sympathised with the couple, particularly regarding the treatment Meghan received from the press. Others felt that Harry had betrayed his family and his duty by leaving, and that the couple had exploited their royal connections for commercial gain while complaining about the institution that gave them their platform.`,
    vocab: [
      { word: 'Biracial', definition: 'Having parents from two different racial backgrounds.' },
      { word: 'Invasive', definition: 'Intruding into someone private life without permission — crossing personal boundaries.' },
      { word: 'Scrutinised', definition: 'Examined very closely and critically — every detail inspected and judged.' },
      { word: 'Exploited', definition: 'Used something for personal benefit in a way that others consider unfair.' },
    ],
    questions: [
      { n: 4, q: 'Meghan faced treatment from the press that many called racist. How does race affect how people are treated by the media?' },
      { n: 5, q: 'Harry blamed the media for his mother death. How does this explain his decision to leave the UK?' },
      { n: 6, q: 'Some say Harry exploited his royal status for money. Others say he earned his own way. What do you think?' },
    ]
  },
  {
    number: 3, title: 'What Is the Point of a Royal Family?', emoji: '🏰', color: '#991b1b',
    text: `Harry and Meghan's story has reignited a debate that has simmered in Britain for decades: what is the point of having a royal family in a modern democracy?\n\nSupporters of the monarchy argue that it provides national unity, cultural identity, and soft power diplomacy that elected politicians cannot match. The royal family attracts tourists, generates media attention, and represents continuity — a living link to centuries of British history. State visits by the King or Queen carry a symbolic weight that no prime minister can replicate. And the monarchy costs each British taxpayer only about one pound per year — a bargain, supporters say, for what it delivers.\n\nCritics argue that the monarchy is an outdated institution that represents inherited privilege, class hierarchy, and a refusal to embrace genuine equality. Why should one family live in palaces, wear crowns, and receive public money simply because of who their ancestors were? In a democracy, they argue, every citizen should have an equal chance to reach the highest positions in society — and a hereditary head of state contradicts this principle.\n\nThe Harry and Meghan saga has highlighted another criticism: that the royal family is an institution that demands conformity and punishes those who do not fit in. Meghan — outspoken, independent, and unwilling to follow unwritten rules she considered outdated — did not conform, and paid a price for it. Whether you see her as a victim of an inflexible institution or as someone who refused to respect the role she married into depends largely on your view of the monarchy itself.\n\nThailand also has a monarchy that plays an important role in national life. The relationship between monarchy and democracy is a question that many countries continue to navigate.`,
    vocab: [
      { word: 'Soft power', definition: 'Influence achieved through culture, reputation, and diplomacy rather than military force.' },
      { word: 'Hereditary', definition: 'Passed from parent to child — a position you are born into rather than elected to.' },
      { word: 'Conformity', definition: 'Behaving according to established rules and expectations — fitting in with the group.' },
      { word: 'Navigate', definition: 'To find your way through a complex situation — dealing with difficulties carefully.' },
    ],
    questions: [
      { n: 7, q: 'What is the point of a royal family in a democracy? Can you think of arguments for and against?' },
      { n: 8, q: 'The monarchy costs each British taxpayer about one pound per year. Is this good value? How do you measure the value of a monarchy?' },
      { n: 9, q: 'Thailand also has a monarchy. How does the role of the monarchy differ between Thailand and the UK?' },
    ]
  },
  {
    number: 4, title: 'Family, Fame, and Forgiveness', emoji: '💚', color: '#7f1d1d',
    text: `Beyond the politics and the press coverage, the Harry and Meghan story is also a deeply human story about family conflict — something that millions of people around the world can relate to.\n\nFamily disagreements are universal. Arguments about loyalty, respect, tradition, and independence happen in every family, in every culture. The difference is that most family arguments happen in private. Harry and Meghan's played out in front of the entire world — in books, interviews, documentaries, and thousands of newspaper articles. The pressure of that public scrutiny made reconciliation harder, not easier.\n\nThe return to the UK suggests that some form of healing may be underway — even if the palace statement made clear that the relationship has changed permanently. Harry will not return to his old role. The family dynamics will not go back to what they were. But being in the same country, allowing the children to know their grandfather King Charles and their cousins, and simply being present — these are steps that many families would recognise as the beginning of repair.\n\nForgiving someone who has hurt you — or who you believe has hurt you — is one of the hardest things a human being can do. It requires letting go of anger that may be entirely justified. It requires accepting that the relationship will be different from what it was. And it requires vulnerability — the willingness to be hurt again.\n\nWhether the royal family can find their way to genuine reconciliation remains to be seen. But the attempt — however imperfect, however public, however complicated — is something that everyone who has ever had a difficult family relationship can understand.`,
    vocab: [
      { word: 'Reconciliation', definition: 'The process of rebuilding a relationship after a serious disagreement or conflict.' },
      { word: 'Dynamics', definition: 'The way people in a group interact and relate to each other — the patterns of a relationship.' },
      { word: 'Vulnerability', definition: 'Being open to the possibility of being hurt — emotional openness and risk.' },
      { word: 'Scrutiny', definition: 'Very close and critical examination — being watched and judged by others.' },
    ],
    questions: [
      { n: 10, q: 'Most family arguments happen in private. How does having your family conflict in public make it harder to fix?' },
      { n: 11, q: 'The passage says forgiving requires letting go of justified anger. Is this possible? Have you ever had to forgive someone who hurt you?' },
      { n: 12, q: 'Do you think Harry and Meghan return will lead to genuine reconciliation? What would need to happen for the family to heal?' },
    ]
  },
]
...
export default function HarryMeghanPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Harry and Meghan Return to the UK</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Prince Harry and Meghan will return to the UK this autumn with their children. Why they left, what the monarchy means today, and whether families can heal after public conflict.</p>
            </div>
          </div>
