...
const PARTS = [
  {
    number: 1, title: 'The Most Studied Object in History', emoji: '🔬', color: '#dc2626',
    text: `This week, scientists published extraordinary new findings about one of the most mysterious objects in the world: the Shroud of Turin. By analysing tiny traces of DNA found on the ancient cloth, researchers have uncovered centuries of hidden history — a remarkable mixture of human lineages, microbes, plants, animals, and even coral accumulated through hundreds of years of handling and travel.\n\nThe Shroud of Turin is a 4.4-metre-long piece of linen cloth that bears the faint image of a man who appears to have been crucified. For centuries, many Christians have believed it to be the burial cloth of Jesus Christ. Sceptics argue it is a medieval forgery. The debate has raged for more than 600 years — and the new DNA evidence, while fascinating, does not settle it.\n\nWhat the DNA does reveal is the shroud's remarkable journey. Traces of DNA from people of European, Middle Eastern, East Asian, and sub-Saharan African origin were found on the cloth. Plant DNA from species native to the Mediterranean, the Middle East, and even the Americas was detected. Coral DNA suggests the shroud may have travelled by sea. Each trace tells a story of someone who touched, carried, or prayed over the cloth at some point in its long existence.\n\nThe Shroud of Turin is the most studied archaeological object in history. It has been examined by physicists, chemists, biologists, historians, and theologians. And yet, after decades of research, its origins remain one of the great unsolved mysteries of the ancient world.`,
    vocab: [
      { word: 'Shroud', definition: 'A cloth used to wrap a dead body for burial.' },
      { word: 'Lineages', definition: 'Lines of descent — the different ancestral backgrounds of people.' },
      { word: 'Forgery', definition: 'Something fake that is made to look real — a deliberate deception.' },
      { word: 'Theologians', definition: 'Scholars who study religion, God, and religious beliefs.' },
    ],
    questions: [
      { n: 1, q: 'DNA from people on every continent was found on the shroud. What does this tell us about how far this object has travelled?' },
      { n: 2, q: 'Some believe the shroud wrapped Jesus. Others say it is a forgery. Does it matter which is true? Why?' },
      { n: 3, q: 'The shroud is the most studied object in history but remains a mystery. Why are some questions so hard to answer?' },
    ]
  },
  {
    number: 2, title: 'What the DNA Tells Us', emoji: '🧬', color: '#b91c1c',
    text: `The DNA analysis used a technique called environmental DNA sequencing — a method that can identify every organism that has left traces on an object, no matter how tiny or how old.\n\nThe human DNA found on the shroud tells a story of contact with people from many different parts of the world. European DNA dominates, which makes sense given that the shroud has been kept in Italy since at least the 1350s. But Middle Eastern DNA is also present — consistent with the shroud having originated in the region where Jesus lived, though also consistent with contact during the Crusades, when European soldiers travelled extensively in the Middle East.\n\nThe plant DNA is equally revealing. Species native to the eastern Mediterranean were found — olive, oak, and plants common in what is now Israel and Turkey. But there were also traces of plants from the Americas — species that could only have reached the shroud after 1492, when Columbus crossed the Atlantic. This helps establish that the shroud was being handled and displayed well into the modern era.\n\nPerhaps the most surprising finding was coral DNA — suggesting the shroud travelled by sea at some point. Coral fragments could have been transferred during a sea voyage, possibly when the shroud was transported between locations. This detail adds a physical dimension to the shroud's journey that written records alone could not provide.\n\nThe researchers emphasised that their findings do not prove or disprove the shroud's authenticity as a religious relic. DNA can tell us who touched the cloth, but not who was wrapped in it.`,
    vocab: [
      { word: 'Environmental DNA', definition: 'Genetic material left behind by organisms on surfaces — traces that can be detected and identified.' },
      { word: 'Crusades', definition: 'Military campaigns by European Christians to the Middle East during the medieval period.' },
      { word: 'Authenticity', definition: 'Whether something is genuine and real — not a copy or forgery.' },
      { word: 'Relic', definition: 'An object of religious significance, often connected to a holy person.' },
    ],
    questions: [
      { n: 4, q: 'DNA from the Americas was found on the shroud. What does this tell us about when people were handling it?' },
      { n: 5, q: 'The researchers say DNA cannot prove who was wrapped in the shroud. Why not? What are the limits of DNA evidence?' },
      { n: 6, q: 'Coral DNA suggests a sea voyage. How does physical evidence like this complement written historical records?' },
    ]
  },
  {
    number: 3, title: 'Faith vs Science', emoji: '⚖️', color: '#991b1b',
    text: `The Shroud of Turin sits at the intersection of two of humanity's most powerful ways of understanding the world: faith and science. And the relationship between them is more complicated than most people think.\n\nIn 1988, radiocarbon dating — a technique that measures the age of organic materials — tested samples from the shroud and concluded it was made between 1260 and 1390 AD. For many scientists, this settled the question: the shroud was a medieval creation, not a 2,000-year-old burial cloth. Case closed.\n\nBut believers challenged the results. They argued that the samples were taken from a repaired corner of the cloth, not the original material. They pointed to other evidence — the weave pattern, the pollen found on the cloth, the anatomical accuracy of the crucifixion wounds — that seemed inconsistent with a medieval forgery. The debate continued.\n\nThe new DNA study does not resolve this dispute. It adds fascinating detail about the shroud's history but cannot determine its age or origin with certainty. And this is perhaps the most important lesson: science is extraordinarily powerful, but it has limits. Some questions — particularly those that involve unique, irreplaceable objects from the distant past — may never be answered with absolute certainty.\n\nFor believers, the shroud's mystery is part of its power. For scientists, the mystery is an invitation to keep asking questions. Both responses are valid — and the fact that they can coexist is a reminder that faith and science, despite their differences, are both expressions of the same human desire to understand the world.`,
    vocab: [
      { word: 'Radiocarbon dating', definition: 'A scientific method that measures the age of organic materials by analysing carbon isotopes.' },
      { word: 'Anatomical', definition: 'Relating to the structure of the human body — the physical details of how the body is built.' },
      { word: 'Irreplaceable', definition: 'So unique that it cannot be replaced if lost — one of a kind.' },
      { word: 'Coexist', definition: 'To exist together at the same time — living alongside each other peacefully.' },
    ],
    questions: [
      { n: 7, q: 'Radiocarbon dating said the shroud is medieval. Believers challenged the results. Who do you find more convincing?' },
      { n: 8, q: 'Can faith and science coexist? Are there questions that science cannot answer but faith can?' },
      { n: 9, q: 'The passage says some questions may never be answered. Is this frustrating or beautiful? Why?' },
    ]
  },
  {
    number: 4, title: 'Why Mysteries Matter', emoji: '✨', color: '#7f1d1d',
    text: `In a world where Google can answer almost any question in seconds, the Shroud of Turin is a refreshing reminder that some mysteries resist easy answers — and that this resistance is part of what makes them valuable.\n\nHumans are drawn to mysteries. We watch detective shows, read thriller novels, and follow true crime podcasts. We are fascinated by unsolved cases, unexplained phenomena, and questions that experts cannot agree on. The Shroud of Turin has captivated people for six centuries precisely because it has never been definitively explained.\n\nBut mysteries do more than entertain us. They teach us intellectual humility — the recognition that our knowledge has limits and that certainty is rarer than we pretend. In an era of confident opinions and instant answers, the shroud reminds us that the most honest response to some questions is "we do not know."\n\nThe new DNA findings add another layer to the story without resolving it. They tell us that the shroud has been touched by people from every continent, carried across seas, and preserved through centuries of war, plague, and political upheaval. Whatever it is — relic or forgery, miracle or masterpiece — the cloth itself has lived an extraordinary life.\n\nThe Shroud of Turin will continue to be studied, debated, and wondered about for centuries to come. And that, perhaps, is exactly the point. The best mysteries are not the ones we solve — they are the ones that keep us asking questions.`,
    vocab: [
      { word: 'Intellectual humility', definition: 'Recognising the limits of your own knowledge — being honest about what you do not know.' },
      { word: 'Phenomena', definition: 'Remarkable events or things that can be observed — unusual occurrences.' },
      { word: 'Upheaval', definition: 'A major change or disruption — a period of disorder and instability.' },
      { word: 'Masterpiece', definition: 'A work of outstanding skill — the finest example of an art or craft.' },
    ],
    questions: [
      { n: 10, q: 'The passage says intellectual humility means saying "we do not know." How often do you hear people say this? Is it a strength or weakness?' },
      { n: 11, q: 'Why are humans so drawn to mysteries? What is it about unanswered questions that fascinates us?' },
      { n: 12, q: 'The best mysteries keep us asking questions. Do you agree? Can you think of other great unsolved mysteries?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Shroud of Turin DNA Mystery</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>DNA on the Shroud of Turin reveals traces from every continent — coral, ancient plants, and centuries of human contact. Science meets faith in history's greatest mystery.</p>
            </div>
          </div>
