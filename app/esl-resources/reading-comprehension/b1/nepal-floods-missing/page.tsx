...
const PARTS = [
  {
    number: 1, title: 'Villages Washed Away', emoji: '🌊', color: '#dc2626',
    text: `On 26 August 2026, catastrophic floods struck the border region between Nepal and China, wiping out entire villages and leaving thousands of people missing. Four days later, rescue teams are still searching — but hopes of finding survivors are fading.\n\nThe floods were caused by torrential monsoon rains that overwhelmed rivers and triggered massive landslides in the mountainous terrain of northern Nepal. Entire hillsides collapsed, burying homes and blocking roads. The force of the water carried away bridges, vehicles, and buildings as if they were toys.\n\nMore than 200 people have been confirmed dead, but officials warn the true death toll could be much higher. At least 4,000 people remain uncontactable. Communication networks were destroyed by the floods, making it impossible to reach remote villages. Rescue helicopters have been grounded by continuing bad weather.\n\nThe disaster has hit Nepal's tourism industry at one of its busiest times. Dozens of foreign pilgrims and trekkers are among the missing. Malaysia, India, China, and several other countries have sent search teams to help find their citizens. The human stories emerging — families waiting desperately for news, children separated from parents, entire communities simply gone — are heartbreaking.`,
    vocab: [
      { word: 'Catastrophic', definition: 'Causing sudden and extreme damage or destruction — a disaster of the worst kind.' },
      { word: 'Landslides', definition: 'When a mass of earth and rock slides down a hillside, often triggered by heavy rain.' },
      { word: 'Uncontactable', definition: 'Impossible to reach or communicate with — no phone, no signal, no response.' },
      { word: 'Pilgrims', definition: 'People who travel to a holy or sacred place for religious reasons.' },
    ],
    questions: [
      { n: 1, q: '4,000 people are uncontactable. What does it feel like to wait for news when you cannot reach someone you love?' },
      { n: 2, q: 'Entire villages were washed away in minutes. How do you prepare for a disaster that can happen so fast?' },
      { n: 3, q: 'Foreign tourists are among the missing. How does this change the international response compared to when only local people are affected?' },
    ]
  },
  {
    number: 2, title: 'Why Nepal Is So Vulnerable', emoji: '🏔️', color: '#b91c1c',
    text: `Nepal is one of the most disaster-prone countries on Earth. Its geography — squeezed between the Tibetan Plateau and the Indian plains, with the Himalayas running through it — makes it vulnerable to earthquakes, floods, landslides, and glacial lake outbursts.\n\nThe monsoon season, which runs from June to September, brings the rain that Nepal depends on for agriculture. But the same rain that grows crops also triggers the floods and landslides that kill people every year. In a typical monsoon season, hundreds of Nepalis die in flood-related disasters.\n\nClimate change is making the situation worse. Glaciers in the Himalayas are melting at an accelerating rate, creating lakes of meltwater dammed behind walls of loose rock and ice. These glacial lakes can burst without warning, sending walls of water cascading down valleys. Scientists have identified more than 2,000 potentially dangerous glacial lakes in the Himalayan region.\n\nNepal is also one of the poorest countries in Asia. Its infrastructure — roads, bridges, communication networks, hospitals — is underfunded and often poorly maintained. Buildings in rural areas are constructed from local materials with little earthquake or flood resistance. When disaster strikes, the infrastructure that should protect people and enable rescue is often the first thing destroyed.`,
    vocab: [
      { word: 'Disaster-prone', definition: 'Likely to experience natural disasters frequently — at high risk.' },
      { word: 'Glacial lake', definition: 'A lake formed by melting glacier ice, often dammed behind unstable rock or ice.' },
      { word: 'Cascading', definition: 'Flowing downward rapidly in stages — like a waterfall, each stage triggering the next.' },
      { word: 'Infrastructure', definition: 'The basic systems a country needs — roads, bridges, hospitals, communication networks.' },
    ],
    questions: [
      { n: 4, q: 'Nepal needs monsoon rain for farming but the same rain causes deadly floods. How do countries manage something that is both essential and dangerous?' },
      { n: 5, q: '2,000 glacial lakes in the Himalayas could burst at any time. How do you protect communities from a threat that is invisible until it happens?' },
      { n: 6, q: 'Nepal is poor and its infrastructure is weak. How does poverty make natural disasters more deadly?' },
    ]
  },
  {
    number: 3, title: 'The Rescue Challenge', emoji: '🚁', color: '#991b1b',
    text: `Rescuing people in the Himalayas after a flood is one of the most difficult operations in disaster response. The terrain is extreme — steep valleys, narrow gorges, and mountain passes above 4,000 metres. Roads are few and easily blocked by landslides. Helicopters — the fastest way to reach remote villages — are grounded by the same bad weather that caused the disaster.\n\nNepal's military has deployed thousands of soldiers to the affected areas. International rescue teams from India, China, Malaysia, and Japan have arrived. But reaching the most remote villages can take days on foot — and in some cases, the villages no longer exist. The floods have literally changed the landscape, redirecting rivers and burying settlements under metres of mud and rock.\n\nTechnology is helping where it can. Satellite imagery is being used to map the extent of the destruction and identify areas where survivors might be trapped. Drones are flying into valleys too dangerous for helicopters. Mobile phone data — from the last known locations of missing people — is being used to focus search efforts.\n\nBut the window for finding survivors is closing. The golden hours — the first 72 hours after a disaster when trapped people are most likely to be alive — have already passed. As each day goes by, the operation shifts from rescue to recovery — from looking for the living to recovering the dead.`,
    vocab: [
      { word: 'Terrain', definition: 'The physical features of an area of land — mountains, valleys, flat ground.' },
      { word: 'Gorges', definition: 'Narrow, deep valleys with steep rocky sides, often with a river at the bottom.' },
      { word: 'Settlement', definition: 'A place where people live — a village, town, or community.' },
      { word: 'Recovery', definition: 'In disaster terms, the process of finding and retrieving bodies rather than living survivors.' },
    ],
    questions: [
      { n: 7, q: 'The golden 72 hours have passed. Should rescue teams keep looking, or is there a point when they should stop?' },
      { n: 8, q: 'Drones and satellites are helping the rescue. How has technology changed how we respond to natural disasters?' },
      { n: 9, q: 'International teams from many countries are helping. Why do countries send help to disasters in other nations?' },
    ]
  },
  {
    number: 4, title: 'Learning from Disaster', emoji: '💚', color: '#7f1d1d',
    text: `Nepal has experienced devastating floods before — and it will experience them again. The question is whether each disaster leads to better preparation for the next one.\n\nThe 2015 earthquake that killed nearly 9,000 people in Nepal led to significant improvements in earthquake preparedness — better building codes, improved early warning systems, and international agreements for rapid response. Some of these systems helped during this week's floods. But flood preparedness has lagged behind.\n\nEarly warning systems for floods exist but are unevenly deployed. In some river valleys, sensors measure water levels and send alerts to downstream communities. In others, the first warning people receive is the sound of water coming. Expanding these systems to cover all at-risk areas is essential — and relatively inexpensive compared to the cost of disaster response.\n\nThe most important lesson from Nepal's floods is one that applies globally: climate change is making natural disasters more frequent and more severe, and the poorest countries are least equipped to cope. Nepal contributes almost nothing to global greenhouse gas emissions, yet it bears a disproportionate share of climate consequences. This inequality — between those who cause climate change and those who suffer from it — is one of the defining injustices of our time.\n\nThe people waiting for news from Nepal this week deserve more than sympathy. They deserve action — from their own government, from the international community, and from the countries whose emissions are melting the glaciers above their homes.`,
    vocab: [
      { word: 'Preparedness', definition: 'Being ready for something before it happens — having plans and systems in place.' },
      { word: 'Downstream', definition: 'Further along a river in the direction the water flows — below the source of danger.' },
      { word: 'Disproportionate', definition: 'Too large or too small compared to what is fair — an unfair share.' },
      { word: 'Emissions', definition: 'Gases released into the atmosphere, especially carbon dioxide from burning fossil fuels.' },
    ],
    questions: [
      { n: 10, q: 'Nepal contributes almost nothing to climate change but suffers the most. Is this fair? What should be done?' },
      { n: 11, q: 'Early warning systems save lives but are expensive to install everywhere. How should poor countries pay for them?' },
      { n: 12, q: 'The passage says the people of Nepal deserve action, not just sympathy. What kind of action would make the biggest difference?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Nepal Floods — Thousands Still Missing". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function NepalFloodsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Nepal Floods — Thousands Still Missing</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Catastrophic floods wiped out villages along the Nepal-China border. Thousands are missing, rescue teams are racing against time, and climate change is making it worse.</p>
            </div>
          </div>
