...
const PARTS = [
  {
    number: 1, title: 'Holy Smoke', emoji: '🔥', color: '#dc2626',
    text: `In Texas, barbecue is not just food — it is religion. Texans will drive hours to reach their favourite pitmaster. They will wait in line for three hours in the scorching sun. They will argue passionately about whether brisket should be wrapped in butcher paper or aluminium foil. Barbecue in Texas is identity.\n\nNow a new generation of Muslim pitmasters is bringing something different to the smoker: halal barbecue. Across Texas, restaurants and food trucks are serving brisket, ribs, and sausages made from halal-certified meat — slaughtered according to Islamic law — and cooked using the same low-and-slow techniques that have defined Texas BBQ for over a century.\n\nThe results are winning over even the most sceptical traditionalists. At Loro BBQ in Houston, pitmaster Amir Hassan serves halal brisket that has been smoked for 14 hours over post oak wood — the same wood used by the most famous non-halal joints in the state. At a recent barbecue festival, his booth had the longest line.\n\n"People ask me if halal brisket tastes different," Hassan told NPR. "I tell them: come taste it and decide for yourself. The wood does not care what prayers were said over the meat. The smoke does not know if the cow faced Mecca. Good barbecue is good barbecue."`,
    vocab: [
      { word: 'Pitmaster', definition: 'A person who specialises in cooking barbecue — the expert who manages the smoker.' },
      { word: 'Halal', definition: 'Food prepared according to Islamic law — including specific rules about how animals are slaughtered.' },
      { word: 'Brisket', definition: 'A cut of beef from the chest of the cow — the most important meat in Texas barbecue.' },
      { word: 'Low-and-slow', definition: 'Cooking at low temperature for many hours — the technique that makes barbecue tender and smoky.' },
    ],
    questions: [
      { n: 1, q: 'Barbecue in Texas is described as religion. Is there a food in your culture that people feel this strongly about?' },
      { n: 2, q: 'The pitmaster says "good barbecue is good barbecue" regardless of how the meat was prepared. Do you agree?' },
      { n: 3, q: 'Would you try halal barbecue? Does knowing how food is prepared change how it tastes to you?' },
    ]
  },
  {
    number: 2, title: 'Food and Identity', emoji: '🕌', color: '#b91c1c',
    text: `The halal BBQ movement is about much more than meat. It is about identity — about being both fully American and fully Muslim at the same time.\n\nFor many Muslim Americans, food has always been a point of tension. Traditional American foods — burgers, hot dogs, barbecue — often use pork or non-halal beef, making them off-limits for observant Muslims. At school cafeterias, at work barbecues, at neighbourhood block parties, Muslim Americans have frequently found themselves unable to eat what everyone else is eating. This exclusion, while unintentional, reinforces a feeling of being different — of not quite belonging.\n\nHalal barbecue solves this problem elegantly. It says: we do not have to choose between our faith and our culture. We can honour Islamic dietary laws and participate fully in one of America most beloved food traditions. We can be at the barbecue, not watching from the sidelines.\n\nThe response from the broader Texas BBQ community has been largely positive. Several non-Muslim pitmasters have expressed admiration for the quality of halal barbecue and have collaborated with Muslim pitmasters on joint events. "Barbecue has always been about community," said one legendary Texas pitmaster. "The more people at the table, the better the party."\n\nThis spirit of inclusion through food is not unique to Texas. Across the world, immigrant communities adapt the cuisine of their new home to fit their own traditions — creating fusion foods that belong to both cultures and neither.`,
    vocab: [
      { word: 'Observant', definition: 'Strictly following the rules of a religion — carefully practising your faith.' },
      { word: 'Off-limits', definition: 'Not allowed — forbidden or restricted.' },
      { word: 'Sidelines', definition: 'The edge of an activity — watching rather than participating.' },
      { word: 'Fusion', definition: 'A blend of two different styles or traditions — combining elements from both.' },
    ],
    questions: [
      { n: 4, q: 'Muslim Americans could not eat at many BBQ events. How does food exclusion affect belonging?' },
      { n: 5, q: 'Halal BBQ lets people honour their faith while joining American culture. Can you think of similar examples from other cultures?' },
      { n: 6, q: 'A pitmaster said the more people at the table, the better the party. Do you agree? Is food the best way to bring people together?' },
    ]
  },
  {
    number: 3, title: 'The History of BBQ', emoji: '📜', color: '#991b1b',
    text: `The story of halal BBQ fits into a much larger story: the history of barbecue itself, which is a history of cultural fusion, immigration, and adaptation.\n\nBarbecue did not originate in Texas. The word "barbecue" comes from the Caribbean Taino people, who used the word "barbacoa" to describe their method of slow-cooking meat over a wooden frame. Spanish colonisers brought the technique to the American mainland, where it was adopted and transformed by enslaved African Americans in the Southern states.\n\nAfrican Americans are the true originators of American barbecue as we know it. Enslaved people were given the toughest, least desirable cuts of meat — and through patience, skill, and the slow application of smoke and heat, they transformed those cheap cuts into something extraordinary. The techniques they developed — low-and-slow cooking, dry rubs, vinegar-based sauces — became the foundation of every regional barbecue style in America.\n\nGerman and Czech immigrants brought sausage-making traditions to Texas in the 19th century, adding another layer. Mexican influences contributed spices and techniques. Each wave of immigration added something new while preserving the core principle: take humble ingredients, apply time and care, and create something greater than the sum of its parts.\n\nHalal barbecue is simply the latest chapter in this ongoing story. A food tradition that began with Caribbean indigenous people, was perfected by enslaved Africans, and was enriched by European and Mexican immigrants is now being adapted by Muslim Americans. The tradition grows. The table expands. The story continues.`,
    vocab: [
      { word: 'Barbacoa', definition: 'The original Caribbean word for slow-cooking meat over a wooden frame — the origin of "barbecue."' },
      { word: 'Dry rubs', definition: 'A mixture of spices rubbed onto meat before cooking — adding flavour without liquid sauces.' },
      { word: 'Humble', definition: 'Simple and ordinary — not expensive or glamorous.' },
      { word: 'Sum of its parts', definition: 'The total is greater than the individual pieces — something more emerges when elements combine.' },
    ],
    questions: [
      { n: 7, q: 'Barbecue was created by enslaved Africans from the worst cuts of meat. What does this tell us about creativity born from hardship?' },
      { n: 8, q: 'Each immigrant group added something to BBQ. Can you trace a similar history for a food in your own culture?' },
      { n: 9, q: 'Food traditions evolve as new cultures contribute. Is this a positive thing, or does something get lost when traditions change?' },
    ]
  },
  {
    number: 4, title: 'Everyone Eats', emoji: '🌍', color: '#7f1d1d',
    text: `In a world that often emphasises what divides us — religion, politics, nationality, race — food has a remarkable ability to bring people together. You do not need to speak the same language to share a meal. You do not need to agree on politics to enjoy the same brisket. Food operates below the level of argument, at the level of pleasure and connection.\n\nThe halal BBQ story is, at its heart, a story about what happens when people stop focusing on differences and start focusing on what they have in common. A Muslim pitmaster and a Christian rancher may disagree about theology. But they both understand what 14 hours of smoke does to a brisket. And standing around a smoker at five in the morning, waiting for the meat to be ready, creates a bond that transcends whatever else separates them.\n\nThis is not naive optimism. Real differences exist between cultures, religions, and communities — and pretending they do not is dishonest. But the halal BBQ movement shows that difference and belonging are not opposites. You can be different and still belong. You can honour your own traditions while participating in someone else traditions. You can be yourself and still be welcome at the table.\n\nThe next time you eat something from a culture that is not your own — pad thai, sushi, pizza, tacos, or halal brisket — remember that you are participating in one of humanity oldest traditions: sharing food across boundaries. It is a small act. But small acts, repeated millions of times, are how cultures change — slowly, deliciously, one meal at a time.`,
    vocab: [
      { word: 'Transcends', definition: 'Goes beyond or rises above — overcoming barriers that normally separate people.' },
      { word: 'Theology', definition: 'The study of religion and God — beliefs about the divine.' },
      { word: 'Naive optimism', definition: 'Being unrealistically positive — believing things are better than they really are.' },
      { word: 'Boundaries', definition: 'Lines that separate groups — cultural, religious, or social divisions.' },
    ],
    questions: [
      { n: 10, q: 'Food brings people together below the level of argument. Has sharing a meal ever changed how you felt about someone?' },
      { n: 11, q: 'You can be different and still belong. Do you believe this? What makes it possible — or difficult?' },
      { n: 12, q: 'The passage says cultures change one meal at a time. What food from another culture has become part of your life?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "American Muslims Give Texas BBQ a Halal Makeover". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function HalalBBQPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>American Muslims Give Texas BBQ a Halal Makeover</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Muslim pitmasters across Texas are reinventing America most sacred food tradition. Brisket, identity, and what happens when cultures collide over a smoker.</p>
            </div>
          </div>
