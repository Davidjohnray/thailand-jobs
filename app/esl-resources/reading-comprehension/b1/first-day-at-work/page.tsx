...
const PARTS = [
  {
    number: 1, title: 'Before You Arrive', emoji: '📋', color: '#f59e0b',
    text: `Starting a new job is one of the most exciting and nerve-wracking experiences in working life. Whether it is your very first job or your tenth, the first day always brings a mixture of anticipation and anxiety. What will the people be like? Will I understand what to do? What if I make a mistake? These feelings are completely normal — and almost everyone around you felt exactly the same way on their first day.\n\nThe good news is that preparation can make a huge difference. Before your first day, there are several things you can do to feel more confident. First, make sure you know the practical details: what time to arrive, where to go, who to ask for, and what to wear. If you are unsure about any of these, it is perfectly professional to email or call your new employer and ask. They will appreciate that you are taking the job seriously.\n\nSecond, research the company. Read their website, look at their social media, and try to understand what they do, who their customers are, and what their values are. You do not need to memorise everything, but showing basic knowledge of the company during your first conversations will make a strong impression.\n\nThird, prepare some simple introductions. You will meet many new people on your first day, and having a few ready phrases makes the process much smoother. "Hi, I\'m [name], I\'m starting today in the [department] team" is simple but effective. Prepare a few questions too — asking colleagues about their role or how long they have worked there shows genuine interest and opens up natural conversation.\n\nFinally, prepare what you need physically. Lay out your clothes the night before, charge your phone, pack any documents your employer has asked for, and plan your route so you arrive 10-15 minutes early. Arriving late on your first day is one of the worst impressions you can make.`,
    vocab: [
      { word: 'Nerve-wracking', definition: 'Making you feel very worried, anxious, or stressed.' },
      { word: 'Anticipation', definition: 'The excited feeling of looking forward to something that is about to happen.' },
      { word: 'Impression', definition: 'The opinion or feeling that other people form about you based on how you behave.' },
      { word: 'Professional', definition: 'Behaving in a way that is appropriate, respectful, and competent in a work environment.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever started a new job or a new school? How did you feel on the first day? What helped you feel more comfortable?' },
      { n: 2, q: 'The passage says you should research the company before your first day. Why do you think this makes a good impression?' },
      { n: 3, q: 'What do you think is the single most important thing to do on your first day at work?' },
    ]
  },
  {
    number: 2, title: 'The First Few Hours', emoji: '🤝', color: '#d97706',
    text: `The first morning of a new job usually follows a similar pattern, regardless of the company or industry. You will typically be met by someone from the human resources department or by your direct manager. They will show you around the office, introduce you to your colleagues, and explain where things are — the toilets, the kitchen, the printer, the fire exits.\n\nDuring these introductions, you will hear many names that you will immediately forget. This is completely normal. Do not worry about remembering everyone on the first day — focus on learning the names of the people you will work with most closely. A useful technique is to repeat a person\'s name when you are introduced: "Nice to meet you, Sarah" helps fix the name in your memory.\n\nYou will probably be given some administrative tasks to complete — filling in forms, setting up your computer login, reading company policies, and possibly completing online training modules about health and safety or data protection. These tasks can feel tedious, but they are important, and completing them promptly and carefully shows that you are organised and reliable.\n\nLunchtime on your first day can feel awkward. Should you eat alone? Should you ask someone to join you? The best approach is usually to accept any invitation that is offered — if a colleague says "do you want to come to lunch with us?", say yes, even if you feel shy. If nobody offers, it is perfectly fine to ask: "Is there somewhere good to eat nearby?" This is a natural, low-pressure way to start a conversation. First-day lunches are where many lasting workplace friendships begin.\n\nAbove all, remember that nobody expects you to know everything on day one. Asking questions is not a sign of weakness — it is a sign of someone who wants to learn and do the job well.`,
    vocab: [
      { word: 'Human resources', definition: 'The department in a company that deals with hiring, training, and looking after employees.' },
      { word: 'Administrative', definition: 'Relating to the organisation and management of an office — paperwork and systems.' },
      { word: 'Tedious', definition: 'Boring and too long — something that takes a lot of time and is not interesting.' },
      { word: 'Promptly', definition: 'Quickly and without delay — doing something as soon as it needs to be done.' },
    ],
    questions: [
      { n: 4, q: 'The passage says you will forget most names on your first day. Do you have any tricks for remembering new names?' },
      { n: 5, q: 'Lunchtime on the first day can feel awkward. Would you ask colleagues to eat with you, or wait to be invited? Why?' },
      { n: 6, q: 'The passage says asking questions is a sign of strength, not weakness. Do you agree? Why do some people find it hard to ask questions at work?' },
    ]
  },
  {
    number: 3, title: 'Making a Good First Impression', emoji: '⭐', color: '#b45309',
    text: `Research in psychology suggests that people form first impressions within the first seven seconds of meeting someone — and those impressions can be remarkably persistent. While this might sound intimidating, it also means that a few simple behaviours can have a disproportionately positive impact on how your new colleagues perceive you.\n\nBody language matters more than most people realise. Making eye contact, smiling, offering a firm handshake (in cultures where this is appropriate), standing up straight, and facing the person you are talking to all communicate confidence, openness, and respect. Conversely, looking at your phone, avoiding eye contact, or crossing your arms can make you seem disinterested or unfriendly — even if you are simply nervous.\n\nListening is one of the most underrated skills on a first day. When colleagues explain how things work, give your full attention. Nod to show understanding. Take notes if appropriate. Ask clarifying questions. People notice when someone genuinely listens to them, and they remember it positively. In contrast, someone who spends the first day talking about themselves or their previous job often makes a poor impression, however impressive their experience.\n\nOne of the most effective things you can do in your first week is to learn and remember the small details that matter to the people around you. How do they take their coffee? What do they call the regular team meeting? What topics do they enjoy talking about? These details might seem trivial, but they demonstrate something important: that you are paying attention to the people around you, not just the work.\n\nFinally, be yourself. Trying to project a personality that is not your own is exhausting and unsustainable. Authenticity — being genuine, honest, and real — is ultimately the quality that builds the strongest and most lasting professional relationships.`,
    vocab: [
      { word: 'Persistent', definition: 'Lasting for a long time — difficult to change once established.' },
      { word: 'Disproportionately', definition: 'To a degree that seems too large or too small compared to something else.' },
      { word: 'Underrated', definition: 'Not appreciated or valued as much as it deserves to be.' },
      { word: 'Authenticity', definition: 'Being genuine and true to who you really are — not pretending to be someone else.' },
    ],
    questions: [
      { n: 7, q: 'People form first impressions in seven seconds. Is this fair? Have you ever changed your mind about someone after a bad first impression?' },
      { n: 8, q: 'The passage says listening is more important than talking on your first day. Why do you think this is? Is it true in all cultures?' },
      { n: 9, q: 'The passage says "be yourself" is the best advice. Is this always possible at work? Are there situations where you need to adjust your personality?' },
    ]
  },
  {
    number: 4, title: 'The First Week and Beyond', emoji: '📅', color: '#92400e',
    text: `Your first day is important, but it is really just the beginning. The first week, the first month, and the first three months are when you truly establish yourself in a new workplace — building relationships, learning systems, and proving that you are someone the team can rely on.\n\nDuring your first week, focus on understanding rather than impressing. Learn how things are done before trying to change them. Every workplace has its own way of doing things — its own systems, habits, shortcuts, and unwritten rules. Some of these will seem inefficient or strange to you, especially if you have experience from a previous job. Resist the temptation to say "at my old company, we did it differently." Understanding why things are done a certain way before suggesting changes shows respect for your new colleagues and their experience.\n\nBuild relationships gradually and genuinely. Have conversations with people from different teams, not just your immediate colleagues. Ask people about their work, their interests, and their experience at the company. Show appreciation when someone helps you — a simple "thank you, that was really helpful" goes a long way. Remember that every person you meet is a potential ally, mentor, or friend.\n\nSet realistic expectations for yourself. You will make mistakes — everyone does. What matters is how you respond to them. Acknowledge the mistake honestly, apologise if necessary, learn from it, and move on. People respect someone who takes responsibility far more than someone who makes excuses or tries to blame others.\n\nThe first few months at a new job can be tiring. You are processing enormous amounts of new information while simultaneously trying to perform well and build relationships. Be patient with yourself. Give yourself permission to not know everything. And remember that the discomfort of being new is temporary — within a few months, the strange will become familiar, the unknown will become routine, and the new workplace will start to feel like home.`,
    vocab: [
      { word: 'Establish', definition: 'To set up or create something that will last — to build a position or reputation.' },
      { word: 'Unwritten rules', definition: 'Rules that everyone follows but that are not officially written down anywhere.' },
      { word: 'Ally', definition: 'Someone who supports you and is on your side — a helpful colleague or friend.' },
      { word: 'Simultaneously', definition: 'At the same time — doing two or more things at once.' },
    ],
    questions: [
      { n: 10, q: 'The passage says learn how things are done before trying to change them. Do you agree? How long should you wait before suggesting improvements?' },
      { n: 11, q: 'Everyone makes mistakes at a new job. What is the best way to handle a mistake — how should you respond?' },
      { n: 12, q: 'What advice would you give to someone starting their very first job tomorrow? What do you wish someone had told you?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Your First Day at Work</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>What to expect, how to introduce yourself, and the simple things that make the difference between a great first impression and a forgettable one.</p>
            </div>
          </div>
