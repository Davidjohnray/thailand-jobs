...
const PARTS = [
  {
    number: 1, title: 'A Historic Offer', emoji: '🕊️', color: '#dc2626',
    text: `On 11 August 2026, the Turkish parliament voted to approve a remarkable piece of legislation: a conditional pardon for thousands of Kurdish militants who have been fighting against the Turkish state for more than 40 years. The law offers fighters from the PKK — the Kurdistan Workers Party — the chance to lay down their weapons and return to normal life without facing prosecution, as long as they meet certain conditions.\n\nThe PKK has been fighting for Kurdish rights and autonomy in southeastern Turkey since 1984. The conflict has killed more than 40,000 people and displaced millions. It is one of the longest-running armed conflicts in the Middle East, and it has caused enormous suffering for Kurdish and Turkish communities alike.\n\nThe pardon is part of a broader peace initiative launched by the Turkish government to end the conflict permanently. President Recep Tayyip Erdogan — who has spent much of his political career taking a hard line against the PKK — surprised many observers by describing the law as "a hand extended in peace" and calling on PKK fighters to "choose life over the mountains."\n\nThe Kurds are the largest ethnic group in the world without their own country. An estimated 30-40 million Kurds live across Turkey, Iraq, Syria, and Iran. In each of these countries, Kurds have faced varying degrees of discrimination, repression, and denial of cultural and political rights. The Turkish peace initiative is the most significant attempt in years to address these grievances.`,
    vocab: [
      { word: 'Pardon', definition: 'Official forgiveness for a crime — allowing someone to go free without punishment.' },
      { word: 'Militants', definition: 'People who use force or violence to fight for a political or social cause.' },
      { word: 'Autonomy', definition: 'The right to govern yourself — having control over your own affairs and decisions.' },
      { word: 'Grievances', definition: 'Feelings of unfairness — complaints about how you have been treated.' },
    ],
    questions: [
      { n: 1, q: 'Turkey is offering to pardon fighters who have been at war for 40 years. Do you think this is brave, risky, or both?' },
      { n: 2, q: 'The Kurds are the largest ethnic group without their own country. Why do you think some groups have countries and others do not?' },
      { n: 3, q: 'Erdogan called the pardon "a hand extended in peace." Can enemies become partners? What does it take?' },
    ]
  },
  {
    number: 2, title: 'Who Are the Kurds?', emoji: '🌍', color: '#b91c1c',
    text: `The Kurds are an ancient people with their own language, culture, and identity. They have lived in the mountainous region where Turkey, Iraq, Syria, and Iran meet for thousands of years — long before any of these modern countries existed. This region is often called Kurdistan, though it has never been a recognised independent state.\n\nAfter the First World War, when the Ottoman Empire collapsed and the modern borders of the Middle East were drawn by European powers, the Kurds were promised their own country. That promise was never kept. Instead, Kurdistan was divided between Turkey, Iraq, Syria, and Iran, and the Kurds became minorities in each country.\n\nIn Turkey, which has the largest Kurdish population (approximately 15-20 million people), Kurds have historically faced significant discrimination. For decades, the Kurdish language was banned in schools and public life. Kurdish culture was suppressed. Kurdish political parties were shut down. Many Kurds felt they were being erased — that Turkey wanted them to stop being Kurdish and become Turkish instead.\n\nThe PKK was founded in 1978 by Abdullah Ocalan, who remains in prison in Turkey after being captured in 1999. The organisation launched an armed struggle in 1984, fighting for Kurdish independence — later modified to a demand for autonomy within Turkey. The conflict has been marked by violence on both sides, including PKK attacks on Turkish military and civilian targets, and Turkish military operations that have destroyed thousands of Kurdish villages.`,
    vocab: [
      { word: 'Ottoman Empire', definition: 'A large empire based in Turkey that ruled much of the Middle East for 600 years until after World War I.' },
      { word: 'Minorities', definition: 'Groups of people who are smaller in number than the main population of a country.' },
      { word: 'Suppressed', definition: 'Forcibly stopped or prevented — pushed down and not allowed to exist freely.' },
      { word: 'Armed struggle', definition: 'Using weapons and military force to fight for a political goal.' },
    ],
    questions: [
      { n: 4, q: 'The Kurds were promised their own country after World War I but never got it. How do you think this broken promise has affected them?' },
      { n: 5, q: 'Turkey banned the Kurdish language for decades. Why do governments sometimes try to suppress minority languages? What is the effect?' },
      { n: 6, q: 'The PKK started fighting for independence but later changed to asking for autonomy. What is the difference? Why might they have changed?' },
    ]
  },
  {
    number: 3, title: 'Can Peace Work?', emoji: '🤝', color: '#991b1b',
    text: `This is not the first time Turkey has tried to make peace with the PKK. In 2013, a ceasefire was declared and peace talks began. For two years, the guns fell silent and there was genuine hope that the conflict might end. But in 2015, the ceasefire collapsed, violence resumed, and the peace process was abandoned.\n\nMany people are sceptical about whether this new initiative will succeed where the previous one failed. The conditions for the pardon require PKK fighters to surrender their weapons, provide information about the organisation, and commit to non-violence. Many within the PKK view these conditions as a demand for surrender rather than a genuine offer of peace.\n\nTrust is the fundamental problem. After decades of war, neither side trusts the other. Turkish Kurds point to broken promises, destroyed villages, and political leaders who were imprisoned for speaking Kurdish. The Turkish government points to PKK bombings that killed civilians, including children. Both sides have legitimate grievances — and both sides have committed acts that the other cannot forgive.\n\nPeace processes around the world show that ending long-running conflicts requires more than just stopping the fighting. Northern Ireland, Colombia, South Africa, and other countries that have successfully ended internal conflicts all found that lasting peace requires three things: justice for victims, political representation for the marginalised group, and economic development for the affected communities. Without all three, a ceasefire is temporary — a pause, not an ending.`,
    vocab: [
      { word: 'Ceasefire', definition: 'An agreement to stop fighting temporarily — a pause in a war or conflict.' },
      { word: 'Sceptical', definition: 'Having doubts about whether something will really happen or work.' },
      { word: 'Legitimate', definition: 'Reasonable and justified — having a fair basis or good reason.' },
      { word: 'Marginalised', definition: 'Pushed to the edges of society — treated as less important than the majority.' },
    ],
    questions: [
      { n: 7, q: 'The last peace process collapsed in 2015. What can Turkey learn from that failure to make this attempt more successful?' },
      { n: 8, q: 'The passage says peace requires justice, representation, and economic development. Which of these three do you think is most important?' },
      { n: 9, q: 'After 40 years of war, can enemies ever truly forgive each other? What would forgiveness look like between Turkey and the PKK?' },
    ]
  },
  {
    number: 4, title: 'What Peace Means', emoji: '💚', color: '#7f1d1d',
    text: `For millions of Kurdish people in Turkey, the peace initiative is not an abstract political event — it is deeply personal. Many Kurdish families have members who joined the PKK, who are in prison, who disappeared during military operations, or who fled to other countries. The possibility of peace means the possibility of seeing their loved ones again.\n\nFor Turkish families who lost relatives to PKK attacks, the offer of pardons for fighters who killed their loved ones is deeply painful. Many feel that justice is being sacrificed for political convenience. The tension between the desire for peace and the need for justice is one of the most difficult challenges in any peace process.\n\nThe Turkish peace initiative also has international significance. If Turkey can resolve its Kurdish conflict, it would remove one of the most destabilising factors in Middle Eastern politics. Kurdish fighters have been involved in conflicts in Syria and Iraq as well as Turkey, and a peace deal in Turkey could have positive effects across the region.\n\nPeace is never easy. It requires people to accept things they find unacceptable — to sit across a table from people they consider enemies and find common ground. It requires leaders to take political risks and ordinary people to let go of anger that may be entirely justified. It is messy, imperfect, and incomplete. But the alternative — another 40 years of war — is worse.\n\nWhether this latest attempt succeeds or fails, the fact that it is being attempted at all is significant. After 40 years and 40,000 deaths, Turkey is choosing to try peace over war. That choice, however imperfect, deserves attention and respect.`,
    vocab: [
      { word: 'Abstract', definition: 'Existing as an idea rather than something you can touch or see — theoretical.' },
      { word: 'Destabilising', definition: 'Making a situation less stable or secure — causing disorder and uncertainty.' },
      { word: 'Common ground', definition: 'Things that both sides agree on — shared beliefs or interests that can be the basis for agreement.' },
      { word: 'Significant', definition: 'Important and meaningful — having a noticeable effect or consequence.' },
    ],
    questions: [
      { n: 10, q: 'For Kurdish families, peace means seeing loved ones again. For Turkish families, pardons feel unjust. Can both be right? How do you balance peace and justice?' },
      { n: 11, q: 'The passage says peace requires accepting things you find unacceptable. Is this true? Can you think of examples from history or your own life?' },
      { n: 12, q: 'After 40 years and 40,000 deaths, is peace still possible? What gives you hope — or doubt?' },
    ]
  },
]
...
export default function TurkeyKurdsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Turkey Offers Peace to Kurdish Fighters</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Turkey voted to pardon thousands of Kurdish fighters after 40 years of war. Who are the Kurds, why have they been fighting, and can peace finally work?</p>
            </div>
          </div>
