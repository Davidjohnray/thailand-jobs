...
const PARTS = [
  {
    number: 1, title: 'Justice After the War', emoji: '⚖️', color: '#dc2626',
    text: `This week, a Syrian court sentenced former President Bashar al-Assad to death in absentia — meaning he was tried and convicted without being present in the courtroom. Assad, who ruled Syria for 24 years and presided over a civil war that killed more than half a million people and displaced more than 12 million, fled the country when his government fell in December 2025.\n\nThe sentence is largely symbolic. Assad is believed to be living in Russia, where President Vladimir Putin has given him protection. Russia does not have an extradition treaty with Syria, and it is extremely unlikely that Assad will ever be handed over to face justice. He will almost certainly live out his life in exile, beyond the reach of the courts that convicted him.\n\nBut for millions of Syrians, the sentence matters — not because it will result in punishment, but because it represents an official acknowledgement that what happened during the war was wrong. For years, Assad's government carried out barrel bomb attacks on civilian areas, used chemical weapons against its own people, operated a network of prisons where detainees were tortured and killed, and destroyed entire cities in its effort to crush the opposition.\n\nThe trial, conducted under Syria's new transitional government, heard testimony from survivors, reviewed evidence of mass atrocities, and produced a verdict that many Syrians had waited years to hear. Whether or not Assad ever faces physical punishment, the court's decision puts his crimes on the official record — a record that cannot be erased.`,
    vocab: [
      { word: 'In absentia', definition: 'A legal term meaning the accused person was not present during the trial.' },
      { word: 'Extradition', definition: 'The legal process of sending a person from one country to another to face trial.' },
      { word: 'Exile', definition: 'Being forced to live in another country, away from your homeland.' },
      { word: 'Atrocities', definition: 'Extremely cruel and violent acts, especially against civilians or prisoners.' },
    ],
    questions: [
      { n: 1, q: 'Assad was sentenced to death but will probably never be punished. Does a symbolic sentence still have value?' },
      { n: 2, q: 'Russia is protecting Assad from justice. Should countries be allowed to shelter leaders accused of war crimes?' },
      { n: 3, q: 'The passage says putting crimes on the official record matters even without punishment. Do you agree? Why?' },
    ]
  },
  {
    number: 2, title: 'What Happened in Syria', emoji: '🏚️', color: '#b91c1c',
    text: `The Syrian Civil War began in 2011 as part of the Arab Spring — a wave of protests that swept across the Middle East demanding democratic reforms. When Syrian citizens took to the streets to demand change, Assad's government responded with extreme violence, firing on protesters and arresting thousands.\n\nWhat began as peaceful protests quickly escalated into a full-scale civil war. Opposition groups took up arms against the government. The conflict attracted foreign involvement from all sides — Russia and Iran supported Assad, while the United States, Turkey, and Gulf states supported various opposition groups. The extremist group ISIS took advantage of the chaos to seize large parts of the country.\n\nThe human cost was catastrophic. More than 500,000 people were killed. More than 12 million Syrians — roughly half the country's pre-war population — were displaced. More than 6 million fled abroad as refugees, creating the largest refugee crisis since World War II. Cities like Aleppo and Homs were reduced to rubble.\n\nAssad's forces were responsible for the majority of civilian casualties, according to the United Nations. The government used barrel bombs — crude explosive devices dropped from helicopters onto residential areas — that killed indiscriminately. In 2013 and 2017, chemical weapons were used against civilian areas, killing hundreds, including many children. These attacks shocked the world and were widely condemned, but Assad remained in power — protected by Russian military support — until his government finally collapsed in late 2025.`,
    vocab: [
      { word: 'Arab Spring', definition: 'A series of protests and uprisings across the Middle East in 2011 demanding democracy and reform.' },
      { word: 'Escalated', definition: 'Became more serious, intense, or violent over time.' },
      { word: 'Indiscriminately', definition: 'Without distinction — affecting everyone equally, without choosing targets carefully.' },
      { word: 'Condemned', definition: 'Publicly expressed very strong disapproval — officially declared something as wrong.' },
    ],
    questions: [
      { n: 4, q: 'The Syrian War began with peaceful protests. How does a protest movement become a civil war? What went wrong?' },
      { n: 5, q: '12 million Syrians were displaced — half the population. Can you imagine half your country population losing their homes?' },
      { n: 6, q: 'Chemical weapons were used against civilians including children. Why do these weapons shock the world differently from other forms of violence?' },
    ]
  },
  {
    number: 3, title: 'Can Syria Rebuild?', emoji: '🏗️', color: '#991b1b',
    text: `With Assad gone and a new transitional government in place, Syria faces the enormous challenge of rebuilding a country that has been almost completely destroyed.\n\nThe physical destruction is staggering. The World Bank estimated in 2023 that the cost of rebuilding Syria's infrastructure — roads, bridges, hospitals, schools, water systems, electricity networks, and housing — would exceed 400 billion dollars. Many of Syria's most historic cities — places that had been continuously inhabited for thousands of years — have been reduced to ruins.\n\nBut the human reconstruction is even harder. A generation of Syrian children has grown up knowing nothing but war. Many have received little or no education. Many have experienced trauma that will affect their mental health for decades. Reintegrating these young people into a peaceful society — giving them education, employment, and hope — is one of the most important challenges the new government faces.\n\nThe political challenges are equally daunting. Syria's population is divided along ethnic, religious, and political lines. Sunni Muslims, Alawites, Kurds, Christians, and Druze all have different visions for the country's future. The opposition groups that fought Assad often fought each other as well. Building a government that represents all of these groups and commands their loyalty will require negotiation, compromise, and trust — all of which are in extremely short supply after a decade of war.\n\nThe international community has promised support, but delivering it is complicated. Many countries are reluctant to invest billions in a country whose political future remains uncertain. The question of whether Syrian refugees will return — and whether they will be welcomed — adds another layer of complexity.`,
    vocab: [
      { word: 'Transitional government', definition: 'A temporary government that manages a country while a permanent system is being established.' },
      { word: 'Reintegrating', definition: 'Bringing people back into normal life and society after a period of separation or conflict.' },
      { word: 'Daunting', definition: 'So difficult or challenging that it feels intimidating or overwhelming.' },
      { word: 'Reluctant', definition: 'Unwilling or hesitant to do something — not wanting to commit.' },
    ],
    questions: [
      { n: 7, q: 'Rebuilding Syria will cost 400 billion dollars. Who should pay for it? What responsibility does the international community have?' },
      { n: 8, q: 'A generation of children grew up in war with no education. How do you give these young people a future?' },
      { n: 9, q: 'Syria has many different ethnic and religious groups. How do you build a government that represents everyone after a civil war?' },
    ]
  },
  {
    number: 4, title: 'Lessons from the Ashes', emoji: '🕊️', color: '#7f1d1d',
    text: `The Syrian Civil War is one of the defining tragedies of the 21st century. As the country begins the long process of recovery, the war offers lessons that the world must learn — even if history suggests it will not.\n\nThe first lesson is about the cost of inaction. The international community watched as peaceful protests were crushed, as civilians were bombed, as chemical weapons were used — and did not intervene effectively. Each time the world said "never again," it happened again. The gap between rhetoric and action cost hundreds of thousands of lives.\n\nThe second lesson is about refugees. Syria's 6 million refugees were welcomed by some countries and rejected by others. The countries that accepted refugees — particularly Lebanon, Jordan, and Turkey — bore an enormous burden. The countries that refused them — citing security concerns or cultural fears — avoided the cost but also missed the contributions that refugees make to their host societies. The debate about Syrian refugees reshaped politics across Europe and contributed to the rise of populist movements.\n\nThe third lesson is about justice. Assad's death sentence, even in absentia, sends a message that leaders who commit atrocities will be judged — if not by international courts, then by the courts of their own people. Whether this message prevents future atrocities is uncertain, but the alternative — allowing mass murder to go unrecorded and unjudged — is worse.\n\nSyria's story is not over. The country that emerges from the ashes of war will be different from the one that existed before it. Whether it will be better depends on the choices made by Syrians and by the international community in the years ahead.`,
    vocab: [
      { word: 'Inaction', definition: 'Not doing anything when action is needed — failing to act.' },
      { word: 'Rhetoric', definition: 'Words designed to persuade but that may not lead to action — impressive speech without substance.' },
      { word: 'Host societies', definition: 'Countries and communities that receive and accommodate refugees or immigrants.' },
      { word: 'From the ashes', definition: 'Rising after complete destruction — rebuilding from nothing, like a phoenix.' },
    ],
    questions: [
      { n: 10, q: 'The world said "never again" but did not act effectively. Why is it so hard for countries to intervene in other countries conflicts?' },
      { n: 11, q: 'Some countries welcomed Syrian refugees and others rejected them. What is the right approach? What are the arguments on each side?' },
      { n: 12, q: 'The passage asks whether Syria that emerges from war will be better. What would a better Syria look like? What would it need?' },
    ]
  },
]
...
export default function AssadPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Syria Sentences Assad to Death</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A Syrian court sentenced former President Assad to death for crimes during the civil war. What happened in Syria, can the country rebuild, and what can the world learn?</p>
            </div>
          </div>
