...
const PARTS = [
  { number: 1, title: 'Understanding Climate Change', emoji: '🌡️', color: '#16a34a',
    text: `Climate change refers to long-term shifts in global temperatures and weather patterns. While some natural changes have always occurred, scientists agree that human activity has been the main cause of climate change since the 1900s. Burning fossil fuels like coal, oil, and gas releases carbon dioxide and other gases into the atmosphere. These gases trap heat from the sun and cause the planet to warm — a process known as the greenhouse effect.\n\nThe effects of climate change are already visible around the world. Temperatures are rising, glaciers are melting, and sea levels are increasing. Extreme weather events such as floods, droughts, and wildfires are becoming more frequent and more severe. Understanding what is happening and why is the first step towards finding solutions.`,
    vocab: [
      { word: 'Fossil fuels', definition: 'Natural energy sources like coal, oil and gas formed from ancient living things underground.' },
      { word: 'Atmosphere', definition: 'The layer of gases surrounding the Earth that protects it and makes life possible.' },
      { word: 'Greenhouse effect', definition: 'The process where gases trap the sun\'s heat, causing the Earth\'s surface to warm.' },
      { word: 'Glacier', definition: 'A large slow-moving mass of ice found in mountains or polar regions.' },
    ],
    questions: [
      { n: 1, q: 'When did you first learn about climate change?' },
      { n: 2, q: 'Do you think climate change is the most serious problem in the world today?' },
      { n: 3, q: 'Are people in your country worried about climate change? Why or why not?' },
    ]
  },
  { number: 2, title: 'How Climate Change Affects Daily Life', emoji: '🌊', color: '#0ea5e9',
    text: `Climate change is already affecting people in their daily lives. In many parts of the world, hotter summers are making it harder to work outdoors or grow food. Farmers are struggling with unpredictable rainfall and longer droughts. Coastal communities face a higher risk of flooding as sea levels continue to rise.\n\nIn cities, extreme heat creates health risks, especially for older people and young children. Air quality is also getting worse in some areas, leading to more respiratory problems. These changes are not just environmental — they affect food prices, water supplies, and even where people can safely live.`,
    vocab: [
      { word: 'Drought', definition: 'A long period of very little or no rainfall, causing water shortages.' },
      { word: 'Unpredictable', definition: 'Impossible to know in advance — changing without warning or pattern.' },
      { word: 'Coastal', definition: 'Relating to the land along the edge of a sea or ocean.' },
      { word: 'Respiratory', definition: 'Relating to breathing and the lungs — respiratory problems affect how we breathe.' },
    ],
    questions: [
      { n: 4, q: 'Have you noticed any changes in the weather where you live?' },
      { n: 5, q: 'How does climate change affect your daily life personally?' },
      { n: 6, q: 'Which group of people do you think is most affected by climate change?' },
    ]
  },
  { number: 3, title: 'What Individuals Can Do', emoji: '♻️', color: '#f59e0b',
    text: `Many people feel that climate change is too big a problem for one person to make a difference. However, individual choices do add up. Reducing energy use at home, eating less meat, using public transport, and buying fewer new products can all help reduce carbon emissions.\n\nSmall habits like turning off lights, reducing food waste, and choosing products with less packaging also contribute. More importantly, talking about climate change and encouraging others to act can create a wider impact. Every action, no matter how small, is part of a larger movement towards a more sustainable future.`,
    vocab: [
      { word: 'Carbon emissions', definition: 'Gases like carbon dioxide released into the air mainly from burning fossil fuels.' },
      { word: 'Sustainable', definition: 'Using resources in a way that does not damage the environment for future generations.' },
      { word: 'Food waste', definition: 'Food that is thrown away or not eaten when it could have been used.' },
      { word: 'Contribute', definition: 'To help produce a result — to add to something or make it larger over time.' },
    ],
    questions: [
      { n: 7, q: 'What changes have you made in your life to help the environment?' },
      { n: 8, q: 'Is it the responsibility of individuals or governments to solve climate change?' },
      { n: 9, q: 'Do you think reducing meat consumption is an effective way to help the planet?' },
    ]
  },
  { number: 4, title: 'Government and Global Action', emoji: '🏛️', color: '#6366f1',
    text: `While individual action is important, large-scale change requires governments and international cooperation. Many countries have signed agreements like the Paris Agreement, which aims to limit global temperature increases. Governments are investing in renewable energy, electric transport, and green building projects.\n\nHowever, progress is slow and opinions are divided. Some argue that economic growth should be the priority, while others believe protecting the environment is more urgent. Finding a balance between development and sustainability is one of the greatest challenges of our time. Without strong global leadership, meeting climate targets will remain difficult.`,
    vocab: [
      { word: 'International cooperation', definition: 'Countries working together to solve a shared problem or reach a common goal.' },
      { word: 'Renewable energy', definition: 'Power from natural sources like sunlight or wind that will not run out.' },
      { word: 'Priority', definition: 'Something considered more important than other things — the first focus of attention.' },
      { word: 'Sustainability', definition: 'The ability to continue without harming the environment or using up resources.' },
    ],
    questions: [
      { n: 10, q: 'Do you think governments are doing enough to fight climate change?' },
      { n: 11, q: 'Should richer countries do more to help poorer countries deal with climate change?' },
      { n: 12, q: 'Are you hopeful or worried about the future of our planet? Why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise discussion skills. The reading topic is "Climate Change and Everyday Life". The current discussion question is: "${question}". Keep every response to 2 sentences maximum. Always end with one simple follow-up question. If the student makes a grammar error, gently correct it using "💡 Tip: ..." — only the most important error. Use clear, simple English suitable for B1 level. Be encouraging.`
...
export default function ClimateChangePage() {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: isPhrase ? `You are an English dictionary for B1 learners. Respond with ONLY one sentence (max 20 words) explaining what the phrase means simply. No extra text.`
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #052e16 0%, #14532d 60%, #166534 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#16a34a', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(34,197,94,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Environment</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Climate Change and Everyday Life</h1>
              <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>What is climate change, how does it affect us, and what can we do — explore the causes, the impact, and the solutions.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#16a34a' : '#e5e7eb', background: translationLang !== 'none' ? '#f0fdf4' : 'white', color: translationLang !== 'none' ? '#15803d' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
