...
const PARTS = [
  {
    number: 1, title: 'Best Friends at War', emoji: '🇨🇦', color: '#dc2626',
    text: `This week, the United States imposed 50% tariffs on 20 billion dollars worth of Canadian products. Canada's Prime Minister Mark Carney immediately promised to match those tariffs "dollar for dollar." Two countries that share the longest peaceful border in the world are now in a full-blown trade war.\n\nA tariff is a tax on imported goods. When the US puts a 50% tariff on Canadian lumber, it means Canadian lumber costs 50% more for American buyers. The idea is to protect domestic industries — but the reality is more complicated.\n\nThe US and Canada trade more than 700 billion dollars worth of goods every year. American cars contain Canadian parts. Canadian homes are heated by American gas. Supply chains cross the border multiple times. When tariffs disrupt these chains, both sides suffer.\n\nPresident Trump justified the tariffs by claiming Canada has taken advantage of the United States. Canada argues the relationship is balanced and mutually beneficial. Economists on both sides acknowledge that trade wars rarely have winners — only different degrees of losing.`,
    vocab: [
      { word: 'Tariff', definition: 'A tax placed on goods imported from another country, making them more expensive.' },
      { word: 'Trade war', definition: 'When countries impose tariffs on each other in retaliation, escalating the conflict.' },
      { word: 'Supply chains', definition: 'The network of companies and processes involved in making and delivering a product.' },
      { word: 'Mutually beneficial', definition: 'Good for both sides — an arrangement where everyone gains.' },
    ],
    questions: [
      { n: 1, q: 'The US and Canada are close allies but now in a trade war. Can friends fight over money and still remain friends?' },
      { n: 2, q: 'Tariffs make imported goods more expensive. Who actually pays — the foreign company or the domestic consumer?' },
      { n: 3, q: 'Car parts cross the US-Canada border multiple times during manufacturing. What happens when tariffs are imposed?' },
    ]
  },
  {
    number: 2, title: 'What Happens When Prices Rise', emoji: '🛒', color: '#b91c1c',
    text: `The most immediate effect of tariffs is higher prices — paid by ordinary people, not governments.\n\nWhen the US puts a 50% tariff on Canadian lumber, building a house in America costs thousands more. When Canada retaliates on American food, Canadian supermarket prices go up. The consumer pays the higher price.\n\nThis is widely misunderstood. Politicians describe tariffs as punishment for the other country. In reality, tariffs are a tax on your own citizens. The foreign exporter may lose sales, but the domestic consumer pays more. Economists across the political spectrum agree.\n\nThe effects extend beyond directly affected products. When lumber costs rise, construction companies raise prices. When construction costs rise, house prices rise. When house prices rise, rents rise. One tariff triggers a chain reaction across the entire economy.\n\nFor countries that trade with the US or Canada — including Thailand, which exports more than 40 billion dollars to the US annually — the trade war creates uncertainty about whether tariffs might spread further.`,
    vocab: [
      { word: 'Retaliates', definition: 'Fights back — responds to an attack with a similar action.' },
      { word: 'Consumer', definition: 'A person who buys and uses products or services.' },
      { word: 'Chain reaction', definition: 'A series of events where each one causes the next.' },
      { word: 'Uncertainty', definition: 'Not knowing what will happen — a state of doubt about the future.' },
    ],
    questions: [
      { n: 4, q: 'Politicians say tariffs punish other countries. Economists say they punish your own consumers. Who is right?' },
      { n: 5, q: 'A tariff on lumber can raise house prices and rents. Can you think of other chain reactions tariffs might cause?' },
      { n: 6, q: 'Thailand exports 40 billion dollars to the US. Should Thailand be worried about tariffs?' },
    ]
  },
  {
    number: 3, title: 'Why Countries Trade', emoji: '🌍', color: '#991b1b',
    text: `Different countries are good at producing different things. Thailand grows excellent rice. Japan makes excellent cars. Brazil produces excellent coffee. Instead of every country trying to produce everything — which would be inefficient — countries specialise and trade.\n\nThis principle, called "comparative advantage," was first described by economist David Ricardo in 1817. Countries that trade freely tend to be wealthier and more innovative than those that try to produce everything domestically.\n\nFree trade has lifted billions out of poverty. China transformed from one of the poorest countries to the second-largest economy largely through trade. The same is true for South Korea, Taiwan, Singapore, and Thailand.\n\nBut free trade has losers too. When a factory closes because the same product is made more cheaply abroad, workers lose their jobs and communities suffer. The benefits of trade are spread widely (lower prices for everyone) but the costs are concentrated on specific people and places. This tension is at the heart of every trade debate.`,
    vocab: [
      { word: 'Comparative advantage', definition: 'Countries benefit by specialising in what they produce most efficiently and trading for the rest.' },
      { word: 'Specialise', definition: 'To focus on doing one thing very well rather than trying to do everything.' },
      { word: 'Domestically', definition: 'Within your own country — produced at home, not internationally.' },
      { word: 'Concentrated', definition: 'Focused in one place — not spread out evenly.' },
    ],
    questions: [
      { n: 7, q: 'Thailand grows rice, Japan makes cars. Why is specialisation better than every country doing everything?' },
      { n: 8, q: 'Free trade makes countries richer but some workers lose jobs. Is free trade fair? How should the losers be helped?' },
      { n: 9, q: 'Thailand grew partly because of trade. What does Thailand export, and what would happen if trade was disrupted?' },
    ]
  },
  {
    number: 4, title: 'Who Wins a Trade War?', emoji: '🤔', color: '#7f1d1d',
    text: `Nobody wins a trade war. But some lose more than others.\n\nIn 1930, during the Great Depression, the US raised tariffs on 20,000 imported goods. Other countries retaliated. Global trade fell by 65%. Most economists believe this made the Depression significantly worse.\n\nThe US-China trade war from 2018 provides a recent example. Studies found American consumers paid most of the cost through higher prices. American farmers lost export markets. The overall effect on the US economy was negative. China also suffered.\n\nThe US-Canada trade war will likely follow a similar pattern. Both economies will be damaged. Consumers will pay higher prices. Supply chains will be disrupted. And the relationship between close allies will be strained.\n\nFor students of English and citizens of the world, the trade war is a reminder that the global economy is deeply interconnected. What happens between the US and Canada affects lumber prices in Japan, car prices in Europe, and export opportunities in Thailand. A fight between two countries is never just between two countries.`,
    vocab: [
      { word: 'Great Depression', definition: 'A severe worldwide economic downturn in the 1930s — the worst in modern history.' },
      { word: 'Retaliated', definition: 'Responded to an attack with a similar action — fought back.' },
      { word: 'Strained', definition: 'Put under pressure — damaged but not completely broken.' },
      { word: 'Interconnected', definition: 'Connected to each other — what happens to one affects the others.' },
    ],
    questions: [
      { n: 10, q: 'The 1930 tariffs made the Great Depression worse. Do you think leaders today know this history?' },
      { n: 11, q: 'Nobody wins a trade war, but some lose more. Between the US and Canada, who will lose more?' },
      { n: 12, q: 'A fight between two countries is never just between them. How does this trade war affect the rest of the world?' },
    ]
  },
]
...
export default function CanadaTariffsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US-Canada Trade War</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The US imposed 50% tariffs on Canadian goods and Canada is fighting back. What tariffs really are, why trade matters, and why nobody wins a trade war.</p>
            </div>
          </div>
