...
const PARTS = [
  {
    number: 1, title: 'A Bomb at a Wedding', emoji: '💔', color: '#dc2626',
    text: `On 2 September 2026, a US airstrike hit a house in the southern Iranian county of Sirik during a wedding celebration. At least five people were killed, including a child. Footage from the Iranian Red Crescent showed children being treated for injuries. The US military denied targeting civilians, saying the strikes were aimed at Revolutionary Guard military sites.\n\nHours later, Iran retaliated. Missiles struck a US military base in Jordan. Drones hit equipment warehouses in Iraq. Kuwait reported that an Iranian drone caused a fire in a residential complex in the capital. The cycle of violence that began months ago is intensifying.\n\nPresident Trump said the strikes were in response to Iran laying sea mines near the Strait of Hormuz. He claimed the strait was now clear. But oil prices rose again, suggesting markets do not believe the situation is under control.\n\nFor the families at that wedding in Sirik, the geopolitical justifications are meaningless. They were celebrating. Then a bomb fell. A child died. No military objective, no matter how legitimate, can undo that moment. And it is moments like these — not strategic calculations or political speeches — that define how wars are remembered.`,
    vocab: [
      { word: 'Airstrike', definition: 'An attack carried out by military aircraft dropping bombs on a target.' },
      { word: 'Retaliated', definition: 'Fought back — responded to an attack with a similar action.' },
      { word: 'Intensifying', definition: 'Becoming stronger and more severe — escalating in force.' },
      { word: 'Geopolitical', definition: 'Relating to politics between countries and regions on a global scale.' },
    ],
    questions: [
      { n: 1, q: 'A bomb hit a wedding and killed civilians including a child. How should the world respond when military strikes kill innocent people?' },
      { n: 2, q: 'The US says it targeted military sites. Iran says civilians were hit. In war, how do we know what really happened?' },
      { n: 3, q: 'Each side retaliates after being attacked. How does this cycle of violence end?' },
    ]
  },
  {
    number: 2, title: 'When Bombs Miss', emoji: '🎯', color: '#b91c1c',
    text: `Military forces around the world use the term "collateral damage" to describe civilian deaths caused by attacks on military targets. The phrase is clinical and impersonal — designed to make the killing of innocent people sound like a technical problem rather than a human tragedy.\n\nThe reality is that no military technology, however advanced, can guarantee that only combatants are killed. Bombs go astray. Intelligence is wrong. Targets are misidentified. Buildings that are believed to be military facilities turn out to be homes, schools, or wedding venues. In every war in modern history, civilians have been killed in far greater numbers than soldiers.\n\nThe US military uses what it calls "precision-guided munitions" — bombs that use GPS or laser guidance to hit specific targets. These weapons are far more accurate than the unguided bombs of previous generations. But "precision" is relative. A GPS-guided bomb can land within 10 metres of its target — but 10 metres is the difference between a military building and the house next door.\n\nThe question of civilian casualties is not just military — it is moral. International law requires that military attacks must distinguish between combatants and civilians, and that civilian harm must not be excessive relative to the military advantage gained. When a bomb kills wedding guests, these legal and moral standards have failed — regardless of who fired it and what they were aiming at.`,
    vocab: [
      { word: 'Collateral damage', definition: 'Civilian deaths or destruction caused unintentionally during a military attack.' },
      { word: 'Combatants', definition: 'People who are actively fighting in a war — soldiers and fighters.' },
      { word: 'Precision-guided', definition: 'Weapons that use technology to aim accurately at specific targets.' },
      { word: 'Excessive', definition: 'More than is reasonable or necessary — going too far.' },
    ],
    questions: [
      { n: 4, q: 'The term collateral damage makes civilian deaths sound technical. Why do militaries use language like this?' },
      { n: 5, q: 'Precision bombs can miss by 10 metres. Is precision good enough when the difference is life and death?' },
      { n: 6, q: 'Should military attacks be allowed if they risk killing civilians? Where do you draw the line?' },
    ]
  },
  {
    number: 3, title: 'Escalation', emoji: '📈', color: '#991b1b',
    text: `The exchange of strikes between the US and Iran this week follows a pattern that military historians call "escalation" — a step-by-step process in which each side responds to the other with slightly more force, gradually increasing the risk of full-scale war.\n\nEscalation is dangerous because each side believes its response is proportional — a fair reaction to what the other side did. But the other side sees it differently. What feels defensive to one side looks offensive to the other. Each retaliation becomes the justification for the next attack.\n\nThe US struck Iranian military sites. Iran struck US bases in Jordan and Iraq. If US soldiers were killed in the Jordan attack, the pressure on Trump to respond with even greater force would be enormous. And Iran, having already crossed the threshold of attacking US forces directly, may feel it has nothing left to lose.\n\nHistory shows that wars rarely start with a single dramatic event. They start with small provocations that grow larger, with red lines that are crossed one at a time, with leaders who believe they can control a situation that is slowly slipping beyond control. World War I began with an assassination. The current US-Iran conflict began with sanctions, moved to naval confrontations, then airstrikes, and now direct attacks on each other military bases.\n\nThe question is not whether the situation is dangerous — it clearly is. The question is whether anyone has the courage to stop the escalation before it becomes something that nobody can stop.`,
    vocab: [
      { word: 'Escalation', definition: 'A gradual increase in the severity of a conflict — each step more dangerous than the last.' },
      { word: 'Proportional', definition: 'In proportion to what happened — a response that matches the scale of the original action.' },
      { word: 'Threshold', definition: 'A point of no return — a line that, once crossed, changes the situation fundamentally.' },
      { word: 'Provocations', definition: 'Actions designed to cause a reaction — deliberately making the other side angry.' },
    ],
    questions: [
      { n: 7, q: 'Each side thinks its response is fair. The other side disagrees. How do you break this cycle?' },
      { n: 8, q: 'World War I started with small events that grew larger. Do you see the same pattern in the US-Iran conflict?' },
      { n: 9, q: 'Who has the power to stop the escalation? What would stopping look like?' },
    ]
  },
  {
    number: 4, title: 'The People in Between', emoji: '🕊️', color: '#7f1d1d',
    text: `In every war, the people who suffer most are those who have the least power to stop it.\n\nThe wedding guests in Sirik did not choose this conflict. The US soldiers at the base in Jordan did not choose it either. The Kuwaiti residents whose building was hit by an Iranian drone certainly did not choose it. They are all casualties of decisions made by leaders in distant capitals — leaders who will never see the damage their orders cause.\n\nFor the people living in the conflict zone — in Iran, Iraq, Jordan, Kuwait, and the Gulf states — the escalation means constant anxiety. Will tonight be the night a missile hits my city? Will my children be safe at school tomorrow? Should I stockpile food and water? These are questions that millions of people are asking right now.\n\nThe psychological toll of living under the threat of attack is enormous. Studies of populations that have experienced prolonged conflict show elevated rates of anxiety, depression, post-traumatic stress disorder, and substance abuse. Children are particularly affected — growing up in a conflict zone can permanently alter brain development and emotional regulation.\n\nWars end eventually. But the damage they cause — to bodies, to minds, to families, to communities — lasts for generations. The child who survived the wedding bombing in Sirik will carry that experience for life. The question we should be asking is not who started this conflict, but who is going to end it — and how many more wedding guests and children will be harmed before they do.`,
    vocab: [
      { word: 'Casualties', definition: 'People killed or injured in a war or disaster — victims of conflict.' },
      { word: 'Stockpile', definition: 'To collect and store large amounts of supplies in preparation for a crisis.' },
      { word: 'Psychological toll', definition: 'The mental and emotional damage caused by a stressful experience.' },
      { word: 'Post-traumatic stress', definition: 'A mental health condition caused by experiencing or witnessing a terrifying event.' },
    ],
    questions: [
      { n: 10, q: 'The people who suffer most in wars have the least power to stop them. Is this inevitable, or can it be changed?' },
      { n: 11, q: 'Children growing up in conflict zones suffer lasting psychological damage. What responsibility does the world have to protect them?' },
      { n: 12, q: 'The passage asks who will end this conflict. Who do you think can? What would peace require?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "US Strikes Hit a Wedding in Iran". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function IranWeddingPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US Strikes Hit a Wedding in Iran</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A US bomb killed civilians at a wedding in Iran, including a child. Iran fired back at US bases. The human cost of war, escalation, and what happens when bombs hit the wrong target.</p>
            </div>
          </div>
