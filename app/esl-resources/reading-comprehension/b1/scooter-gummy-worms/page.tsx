...
const PARTS = [
  {
    number: 1, title: 'Scooter Has No Regrets', emoji: '🐕', color: '#dc2626',
    text: `On 31 July 2026, a three-year-old beagle named Scooter was rushed to an emergency veterinary clinic in Brisbane, Australia. The reason? She had eaten an entire bag of gummy worms — known in Australia as "jelly snakes" — weighing 1.1 kilograms. That is more than a kilogram of pure sugar and gelatin, consumed by a dog that weighs about 10 kilograms herself.\n\nScooter's panicked owners brought her to the Animal Emergency Service in Jindalee, where veterinarians decided to make her vomit. The result was spectacular: Scooter produced 1.1 kilograms of brightly coloured, barely chewed gummy worms. The clinic posted the story on Instagram, where it immediately went viral — the image of a small, guilty-looking beagle surrounded by a mountain of regurgitated candy was shared millions of times.\n\nAs a precaution, the vets also made Scooter's sibling Jada vomit. Jada produced exactly one gummy worm. The clinic's veterinary nurse manager, Kate Wesche, told reporters that Scooter had "clearly no regrets in her decision."\n\nThe story was funny, the photos were unforgettable, and Scooter became an instant internet celebrity. But behind the humour, the incident raises a serious point that every pet owner should know: many common human foods can be extremely dangerous for dogs. Scooter was lucky — the gummy worms she ate did not contain xylitol, an artificial sweetener that is toxic to dogs and can cause liver failure or death even in small amounts. If they had contained xylitol, the story could have ended very differently.`,
    vocab: [
      { word: 'Veterinary', definition: 'Relating to the medical treatment of animals — a vet is an animal doctor.' },
      { word: 'Regurgitated', definition: 'Brought food back up from the stomach through the mouth — vomited.' },
      { word: 'Precaution', definition: 'An action taken to prevent something dangerous from happening — being careful just in case.' },
      { word: 'Toxic', definition: 'Poisonous — something that can cause serious harm or death if eaten or touched.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think Scooter story went viral? What makes animal stories so popular on social media?' },
      { n: 2, q: 'The vet said Scooter had "no regrets." Do you think dogs understand that they have done something wrong? How can you tell?' },
      { n: 3, q: 'Have you ever had a pet that ate something it should not have? What happened?' },
    ]
  },
  {
    number: 2, title: 'Why Dogs Eat Everything', emoji: '🦴', color: '#b91c1c',
    text: `If you have ever owned a dog, you know that they will eat almost anything. Shoes, socks, remote controls, entire birthday cakes left on the kitchen counter, the contents of the rubbish bin, cat food, other dogs food, and — as Scooter demonstrated — an entire bag of gummy worms. But why? What makes dogs such enthusiastic and indiscriminate eaters?\n\nThe answer lies in evolution. Dogs are descended from wolves, and wolves are opportunistic feeders — they eat whenever food is available because they never know when their next meal will come. This "eat everything now" instinct served wolves well in the wild, where food was unpredictable. But in a modern home, where food is always available and gummy worms are left within reach, the same instinct can lead to problems.\n\nDogs also have far fewer taste buds than humans — about 1,700 compared to our 9,000. This means they are less able to distinguish between delicious and disgusting, which explains why they seem equally enthusiastic about steak and rubbish. Their sense of smell, however, is 10,000 to 100,000 times more sensitive than ours, which means they can detect food from extraordinary distances — and once they smell it, the ancient wolf instinct kicks in: eat first, ask questions later.\n\nBeagles, like Scooter, are particularly notorious for their eating habits. Originally bred as hunting dogs, beagles are driven by their noses more than almost any other breed. Studies have shown that beagles are more motivated by food than other breeds and are less likely to stop eating when full. In scientific research, beagles are often used in food-related studies precisely because they will eat almost anything — a quality that makes them excellent research subjects but challenging pets.`,
    vocab: [
      { word: 'Indiscriminate', definition: 'Not making careful choices — accepting or consuming everything without being selective.' },
      { word: 'Opportunistic', definition: 'Taking advantage of every opportunity — eating whatever is available whenever it is available.' },
      { word: 'Notorious', definition: 'Famous for something bad — well-known for a negative quality or behaviour.' },
      { word: 'Breed', definition: 'A particular type of dog that has been developed by humans for specific characteristics.' },
    ],
    questions: [
      { n: 4, q: 'Dogs eat everything because of their wolf instincts. Can you think of other ways that pets behaviour is explained by their wild ancestors?' },
      { n: 5, q: 'Dogs have 1,700 taste buds and humans have 9,000. How do you think this changes their experience of eating?' },
      { n: 6, q: 'Beagles are more food-motivated than other breeds. Does your pet (or a pet you know) have a personality trait that is typical of its breed?' },
    ]
  },
  {
    number: 3, title: 'The Hidden Dangers in Your Kitchen', emoji: '⚠️', color: '#991b1b',
    text: `Scooter was lucky that her gummy worms did not contain xylitol. But many common foods that are perfectly safe for humans can be genuinely dangerous — even fatal — for dogs. Every pet owner should know what these foods are.\n\nChocolate is probably the most well-known danger. It contains a chemical called theobromine that dogs cannot process effectively. Dark chocolate is the most dangerous — even a small amount can cause vomiting, seizures, and heart problems in a medium-sized dog. Grapes and raisins are another surprising danger — even a few grapes can cause sudden kidney failure in some dogs, though scientists still do not fully understand why.\n\nOnions and garlic, in all forms — raw, cooked, powdered — can damage a dog's red blood cells, leading to a condition called anaemia. Macadamia nuts can cause weakness, vomiting, and tremors. Avocado contains a substance called persin that can cause digestive problems. And sugar-free products containing xylitol — including some peanut butters, chewing gums, and sweets — can cause a dangerous drop in blood sugar and liver failure.\n\nIn Thailand and across Southeast Asia, where dogs often roam freely and eat scraps from the street, awareness of these dangers is particularly important. Street food scraps may contain garlic, onions, or other ingredients that are harmless to humans but dangerous to dogs. Even well-meaning people who feed street dogs may not realise that some foods could be doing more harm than good.\n\nThe good news is that most food-related emergencies in dogs can be treated successfully if caught early. Knowing the signs — vomiting, lethargy, tremors, loss of appetite — and getting to a vet quickly can make the difference between a funny Instagram post and a tragedy.`,
    vocab: [
      { word: 'Theobromine', definition: 'A chemical found in chocolate that is harmless to humans but poisonous to dogs.' },
      { word: 'Seizures', definition: 'Sudden, uncontrolled movements of the body caused by abnormal brain activity.' },
      { word: 'Anaemia', definition: 'A condition where the blood does not have enough healthy red blood cells to carry oxygen.' },
      { word: 'Lethargy', definition: 'A state of being very tired and having no energy — unusual sleepiness or weakness.' },
    ],
    questions: [
      { n: 7, q: 'Did you know that chocolate and grapes are dangerous for dogs? Which of these hidden dangers surprised you the most?' },
      { n: 8, q: 'In Thailand, dogs often eat street food scraps. How could awareness of food dangers be improved for people who feed street dogs?' },
      { n: 9, q: 'The passage says knowing the signs of food poisoning in dogs can save their lives. Do you think pet first aid should be taught in schools?' },
    ]
  },
  {
    number: 4, title: 'Why We Love Pet Stories', emoji: '❤️', color: '#7f1d1d',
    text: `Scooter's gummy worm adventure was one of the most-shared news stories of the week. In a week that also included wildfires, wars, political crises, and migration emergencies, a small beagle in Brisbane who ate too many sweets captured the world's attention. Why?\n\nPsychologists have a simple answer: humans are hardwired to respond to animals. Studies show that looking at pictures of cute animals activates the same brain regions that respond to human babies — triggering feelings of warmth, protectiveness, and joy. In a news environment dominated by stress and anxiety, animal stories provide a psychological break — a moment of lightness that allows our brains to reset.\n\nSocial media has amplified this effect enormously. Animal content consistently outperforms almost every other type of content online. The most-followed accounts on Instagram and TikTok include dozens of animals — dogs, cats, ducks, capybaras, and even a famous seal named Neil. Pet owners share more than 60 million photos of their animals on social media every day. The internet, it turns out, was built for cat videos and dog stories.\n\nBut there is something deeper going on too. Animal stories remind us of the bond between humans and their pets — a relationship that has existed for at least 15,000 years, since wolves first began living alongside human communities and gradually evolved into the dogs we know today. That bond is one of the oldest and most enduring relationships in human history, and in a world that often feels divided and uncertain, the simple, unconditional love of a pet is something that almost everyone can relate to.\n\nScooter did not know she was making international news. She saw gummy worms, she ate gummy worms, and she had no regrets. Sometimes, the simplest stories are the ones we need most.`,
    vocab: [
      { word: 'Hardwired', definition: 'Built into our brains from birth — a natural response that we do not have to learn.' },
      { word: 'Amplified', definition: 'Made stronger, louder, or more widespread — increased in power or effect.' },
      { word: 'Unconditional', definition: 'Given freely without any conditions or requirements — love that does not depend on anything.' },
      { word: 'Enduring', definition: 'Lasting for a very long time — surviving through many changes and challenges.' },
    ],
    questions: [
      { n: 10, q: 'In a week full of serious news, a dog eating gummy worms was one of the most-shared stories. Is this a problem, or do we need light stories alongside serious ones?' },
      { n: 11, q: 'The internet was built for cat videos and dog stories. Why do you think animal content is so much more popular than almost everything else online?' },
      { n: 12, q: 'Do you have a pet? What does your pet mean to you? If you do not have one, would you like one? Why?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Scooter the Beagle Eats 1kg of Gummy Worms</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A beagle in Australia ate an entire bag of gummy worms and became an internet celebrity. Why dogs eat everything, the hidden dangers in your kitchen, and why we love pet stories.</p>
            </div>
          </div>
