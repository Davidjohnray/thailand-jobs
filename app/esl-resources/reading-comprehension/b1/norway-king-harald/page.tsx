...
const PARTS = [
  {
    number: 1, title: 'A King Who Chose Love', emoji: '👑', color: '#dc2626',
    text: `King Harald V of Norway died peacefully on 28 August 2026 at the age of 89. He had been king for 35 years — the longest-reigning monarch in Norwegian history. His son, Crown Prince Haakon, will succeed him as King Haakon VII.\n\nHarald was born in 1937, during a time of great upheaval in Europe. When Nazi Germany invaded Norway in 1940, three-year-old Harald and his mother fled to Sweden, then to the United States, where they lived in exile for five years. He returned to Norway after the war ended in 1945 — an experience that shaped his lifelong commitment to peace, democracy, and international cooperation.\n\nBut Harald is perhaps best remembered for a love story. As a young man, he fell in love with Sonja Haraldsen — a commoner, the daughter of a clothing shop owner. At the time, Norwegian law required the heir to the throne to marry someone of royal blood. Harald reportedly told his father that if he could not marry Sonja, he would never marry at all — meaning the royal line would end. After years of resistance, King Olav V finally gave his permission, and Harald and Sonja married in 1968.\n\nThe marriage was one of the most popular decisions in modern Norwegian history. Sonja became one of the most beloved queens in Europe, and their relationship — which lasted more than 55 years — became a symbol of love triumphing over tradition.`,
    vocab: [
      { word: 'Reigning', definition: 'Ruling as king or queen — holding the position of monarch.' },
      { word: 'Exile', definition: 'Being forced to live in another country, away from your homeland.' },
      { word: 'Commoner', definition: 'An ordinary person who is not from a royal or noble family.' },
      { word: 'Heir', definition: 'The person who will inherit a position or title — next in line to be king or queen.' },
    ],
    questions: [
      { n: 1, q: 'Harald said he would never marry anyone except Sonja. Would you give up everything for love?' },
      { n: 2, q: 'He fled Norway as a three-year-old during World War II. How do you think this experience shaped him as a king?' },
      { n: 3, q: 'Do you know the story of your own country royal family or head of state? What defines a good leader?' },
    ]
  },
  {
    number: 2, title: 'A Different Kind of King', emoji: '🇳🇴', color: '#b91c1c',
    text: `Harald was not a typical European monarch. Norway is one of the most egalitarian societies on Earth, and Harald reflected this — living modestly by royal standards, travelling on public transport, and famously insisting that he was "the king of all Norwegians" regardless of their background.\n\nIn 2016, Harald gave a speech at a garden party that went viral around the world. "Norwegians are girls who love girls, boys who love boys, and girls and boys who love each other," he said. "Norwegians believe in God, Allah, everything and nothing." The speech was a powerful statement of inclusivity from a head of state — and it resonated far beyond Norway's borders.\n\nHarald was also known for his sense of humour and his love of sailing. He competed in three Olympic Games as a sailor — in 1964, 1968, and 1972 — and won a World Championship in 1987. Even as king, he continued to race competitively, earning the nickname "the Sailor King."\n\nHis health declined in his later years. He was hospitalised several times and had a pacemaker fitted. But he continued his royal duties as long as he could, telling reporters in 2024: "A king does not retire. He serves until he can serve no more." He died with his family at his bedside.`,
    vocab: [
      { word: 'Egalitarian', definition: 'Believing in equal rights for all people — a society where everyone is treated equally.' },
      { word: 'Inclusivity', definition: 'Including everyone regardless of differences — making all people feel welcome and valued.' },
      { word: 'Pacemaker', definition: 'A small electronic device placed in the chest to help the heart beat regularly.' },
      { word: 'Retire', definition: 'To stop working — to leave your job or role permanently.' },
    ],
    questions: [
      { n: 4, q: 'Harald said he was king of all Norwegians — girls who love girls, boys who love boys. Why was this speech so powerful?' },
      { n: 5, q: 'He competed in the Olympics and won a World Championship as a sailor. Should royals live ordinary lives or be set apart?' },
      { n: 6, q: 'He said a king does not retire. Do you agree? Should there be an age limit for leaders?' },
    ]
  },
  {
    number: 3, title: 'Monarchy in the Modern World', emoji: '🏛️', color: '#991b1b',
    text: `Harald's death comes at a time when monarchies around the world are facing questions about their relevance. There are currently 43 countries with monarchs — ranging from absolute monarchies like Saudi Arabia, where the king holds real political power, to constitutional monarchies like Norway, the UK, and Thailand, where the monarch's role is largely ceremonial and symbolic.\n\nSupporters of constitutional monarchy argue that it provides national unity, continuity, and a head of state who is above politics. A king or queen can represent all citizens equally because they are not elected by one side or the other. Harald's popularity in Norway — where support for the monarchy consistently exceeds 80% — demonstrates that a well-loved monarch can be a powerful force for social cohesion.\n\nCritics argue that hereditary privilege has no place in a democracy. Why should one family hold a special position simply because of who their ancestors were? In an age of equality, the idea that someone is born to be head of state seems fundamentally unfair.\n\nThe answer may depend on the individual monarch. Harald was popular because he was authentic, humble, and genuinely committed to the values of equality and inclusivity. A monarch who is arrogant, out of touch, or controversial can damage the institution. The Norwegian monarchy thrived under Harald because he earned the respect that his title alone could not guarantee.`,
    vocab: [
      { word: 'Constitutional monarchy', definition: 'A system where the monarch is head of state but real power belongs to an elected government.' },
      { word: 'Ceremonial', definition: 'Related to formal events and traditions rather than real power or decision-making.' },
      { word: 'Cohesion', definition: 'Unity — the quality of people sticking together and feeling connected.' },
      { word: 'Authentic', definition: 'Genuine and real — true to who you are, not pretending.' },
    ],
    questions: [
      { n: 7, q: '43 countries still have monarchs. Is monarchy outdated, or does it still serve a purpose?' },
      { n: 8, q: 'Support for Norway monarchy exceeds 80%. What makes some monarchies popular and others controversial?' },
      { n: 9, q: 'Thailand also has a monarchy. What role does the monarchy play in Thai society?' },
    ]
  },
  {
    number: 4, title: 'What He Leaves Behind', emoji: '🕊️', color: '#7f1d1d',
    text: `Norway's new king, Haakon VII, faces the challenge of following one of the most popular monarchs in modern European history. Like his father, Haakon married a commoner — Mette-Marit Tjessem Hoiby, a single mother with a past that included the Norwegian party scene. Like his father's marriage, the relationship was initially controversial — and like his father, Haakon insisted on marrying the woman he loved.\n\nHarald's legacy extends beyond Norway. His 2016 inclusivity speech is studied in schools around the world. His example — of a monarch who was humble, authentic, and genuinely committed to equality — has influenced how other European royals approach their roles. In an era when many institutions are losing public trust, Harald maintained the trust of his people through the simplest possible method: being himself.\n\nThe response to his death has been remarkable. Flags fly at half-mast across Scandinavia. World leaders have sent condolences. Ordinary Norwegians have left flowers, candles, and handwritten notes outside the Royal Palace in Oslo. Many of the notes say the same thing: "Thank you for being our king."\n\nHarald's life spanned one of the most turbulent centuries in human history — from World War II through the Cold War, the digital revolution, and the climate crisis. Through all of it, he represented something increasingly rare in public life: decency, consistency, and the quiet conviction that every person matters equally. Norway has lost its king. The world has lost a reminder of what leadership can look like at its best.`,
    vocab: [
      { word: 'Legacy', definition: 'What someone leaves behind — the lasting impact of their life and work.' },
      { word: 'Half-mast', definition: 'A flag flown halfway up a flagpole as a sign of respect for someone who has died.' },
      { word: 'Condolences', definition: 'Expressions of sympathy — messages of comfort sent to someone who is grieving.' },
      { word: 'Conviction', definition: 'A strong, firmly held belief — confidence in what you think is right.' },
    ],
    questions: [
      { n: 10, q: 'Norwegians left notes saying "thank you for being our king." What would you want people to say about your leader?' },
      { n: 11, q: 'Both Harald and his son married commoners despite controversy. What does this tell us about how royal families are changing?' },
      { n: 12, q: 'The passage says Harald represented decency and consistency. Are these qualities enough for leadership, or do leaders need something more?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Norway King Harald Dies at 89". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function NorwayKingPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Norway King Harald Dies at 89</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>King Harald V of Norway died peacefully at 89 after 35 years on the throne. The sailor king who chose love, the inclusivity speech that went viral, and what monarchy means today.</p>
            </div>
          </div>
