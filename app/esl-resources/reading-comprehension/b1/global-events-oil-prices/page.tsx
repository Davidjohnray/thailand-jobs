...
const PARTS = [
  { number: 1, title: 'Why Oil Prices Matter', emoji: '🛢️', color: '#0ea5e9',
    text: `Oil is one of the most important resources in the world. It is used to make fuel for cars, planes, and ships, and it also helps produce electricity, plastic, and many everyday products. Because oil is so widely used, changes in oil prices can affect almost everyone. When oil prices rise, transport and production costs usually increase, which can make food, goods, and services more expensive. When prices fall, costs may go down, but oil-producing countries can lose money.\n\nOil prices are decided by supply and demand. If there is plenty of oil available and demand is low, prices usually fall. However, if oil becomes harder to get or demand increases, prices often rise. Many global events can influence this balance.`,
    vocab: [
      { word: 'Resource', definition: 'Something natural or useful that people need — like oil, water, or land.' },
      { word: 'Supply and demand', definition: 'The amount available (supply) compared to how much people want (demand) — this balance sets prices.' },
      { word: 'Production costs', definition: 'The money needed to make goods and services — what it costs to produce something.' },
      { word: 'Influence', definition: 'To have an effect on something — to change or shape a result.' },
    ],
    questions: [
      { n: 1, q: 'Why is oil considered an important resource?' },
      { n: 2, q: 'How can high oil prices affect everyday life?' },
      { n: 3, q: 'Do you think people notice oil price changes quickly? Why or why not?' },
    ]
  },
  { number: 2, title: 'Political Events and Conflicts', emoji: '🌍', color: '#8b5cf6',
    text: `Political events play a major role in oil prices. Many of the world's largest oil-producing countries are located in regions where political tensions or conflicts can happen. When a war, conflict, or political crisis occurs, oil production or transport can be reduced. This makes oil harder to access, causing prices to increase.\n\nEven the fear of conflict can affect oil prices. Traders and companies may worry that oil supplies will be interrupted, so prices rise before any real shortage happens. Sanctions placed on oil-producing countries can also limit exports, which reduces supply on the global market.`,
    vocab: [
      { word: 'Political tensions', definition: 'Disagreements or conflict between countries or groups in government.' },
      { word: 'Sanctions', definition: 'Official penalties placed on a country to limit its trade or economic activity.' },
      { word: 'Shortage', definition: 'When there is not enough of something that people need or want.' },
      { word: 'Exports', definition: 'Goods or resources that are sold and sent to other countries.' },
    ],
    questions: [
      { n: 4, q: 'How can political conflicts affect oil supply?' },
      { n: 5, q: 'Why do oil prices sometimes rise even before a real shortage?' },
      { n: 6, q: 'Should countries depend less on oil from unstable regions? Why?' },
    ]
  },
  { number: 3, title: 'The Global Economy and Demand', emoji: '📈', color: '#f59e0b',
    text: `The global economy strongly influences oil prices. When the world economy is growing, factories produce more goods, people travel more, and businesses use more energy. This increases demand for oil and often pushes prices higher. On the other hand, during economic slowdowns or recessions, demand for oil usually falls.\n\nEvents such as pandemics or financial crises can suddenly reduce travel and industrial activity. When this happens, oil prices may drop sharply because there is too much supply and not enough demand. These changes can be difficult for oil-producing countries that rely heavily on oil income.`,
    vocab: [
      { word: 'Economy', definition: 'The system of money, trade, and production in a country or the world.' },
      { word: 'Recession', definition: 'A period when the economy slows down and people have less money to spend.' },
      { word: 'Industrial activity', definition: 'Work done by factories and businesses to produce goods and energy.' },
      { word: 'Pandemic', definition: 'A disease that spreads quickly across many countries at the same time.' },
    ],
    questions: [
      { n: 7, q: 'How does economic growth increase oil demand?' },
      { n: 8, q: 'Why do oil prices fall during global crises?' },
      { n: 9, q: 'Which countries are most affected by falling oil prices? Why?' },
    ]
  },
  { number: 4, title: 'Energy Transition and the Future', emoji: '☀️', color: '#22c55e',
    text: `In recent years, the world has started to focus more on renewable energy, such as solar and wind power. Many governments are encouraging cleaner energy to reduce pollution and fight climate change. As a result, long-term demand for oil may decrease in the future.\n\nHowever, oil is still very important today, and the transition to renewable energy will take time. During this period, oil prices may continue to change often, depending on global events, economic growth, and energy policies. Understanding these factors helps people and governments prepare for future challenges.`,
    vocab: [
      { word: 'Renewable energy', definition: 'Power from natural sources like sunlight or wind that will not run out.' },
      { word: 'Transition', definition: 'A period of change from one situation or system to another.' },
      { word: 'Climate change', definition: 'Long-term changes in global weather caused by human activity and pollution.' },
      { word: 'Energy policy', definition: 'Government plans and rules about how energy is produced and used.' },
    ],
    questions: [
      { n: 10, q: 'How could renewable energy affect oil prices in the future?' },
      { n: 11, q: 'Why will oil still be important for many years?' },
      { n: 12, q: 'Do you think the world should move away from oil faster? Why or why not?' },
    ]
  },
]
...
async function fetchTranslation(text: string, lang: string, type: 'word' | 'question' | 'message'): Promise<string> {
  const systems: Record<string, string> = {
    word: `You are a language learning assistant. Translate this English vocabulary entry to ${lang}. Return ONLY the translated word and a brief explanation in ${lang} (max 20 words). No extra text, no English.`,
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise discussion skills. The reading topic is "Global Events and Oil Prices". The current discussion question is: "${question}". Keep every response to 2 sentences maximum. Always end with one simple follow-up question. If the student makes a grammar error, gently correct it using "💡 Tip: ..." — only the most important error. Use simple, clear English suitable for B1 level. Be encouraging.`
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: isPhrase ? `You are an English dictionary for B1 learners. Respond with ONLY one sentence (max 20 words) explaining what the phrase means in simple English. No extra text.`
              : `You are an English dictionary for B1 learners. Respond with ONLY one sentence (max 15 words) defining this word simply. No extra text.`,
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(245,158,11,0.8)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Society & Economy</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Global Events and Oil Prices</h1>
              <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Understand why oil prices change and how wars, economies, and clean energy affect the cost of fuel around the world.</p>
            </div>
          </div>
          <div style={{ display: 'flex', gap: '20px', marginTop: '28px', flexWrap: 'wrap' }}>
            {[{ icon: '📄', label: '4 reading parts' }, { icon: '💬', label: '12 discussion questions' }, { icon: '📚', label: '16 vocabulary words' }, { icon: '✍️', label: 'Highlight any text' }, { icon: '🌍', label: 'Multi-language lookup' }, { icon: '🤖', label: 'AI conversation partner' }].map(s => (
              <div key={s.label} style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'rgba(255,255,255,0.8)', fontSize: '13px' }}><span>{s.icon}</span> {s.label}</div>
            ))}
          </div>
        </div>
      </section>
