...
const PARTS = [
  {
    number: 1, title: 'A Record-Breaking Weekend', emoji: '🎬', color: '#dc2626',
    text: `On the weekend of 1-3 August 2026, the latest Spider-Man movie opened in cinemas across the world and immediately broke records. The film earned more than 400 million dollars globally in its first three days — making it one of the biggest opening weekends in cinema history and the largest opening of 2026 by a huge margin.\n\nThe success was not entirely surprising. Spider-Man has become one of the most popular and profitable characters in entertainment history. The previous Spider-Man film earned more than 1.9 billion dollars worldwide. The character has appeared in dozens of films, television shows, video games, and comic books since his creation in 1962, and his popularity shows no signs of slowing down.\n\nWhat makes Spider-Man so popular? Part of the answer is the character himself. Unlike many superheroes, Spider-Man is an ordinary person — a teenager named Peter Parker who struggles with homework, friendships, money, and self-doubt. He did not choose to become a hero — he was bitten by a radioactive spider and had to figure out what to do with his new powers. His famous motto — "with great power comes great responsibility" — has become one of the most quoted phrases in popular culture.\n\nBut the business side of Spider-Man is just as interesting as the character. The film industry has changed dramatically in the last decade, with streaming services, shorter cinema windows, and changing audience habits all threatening the traditional movie business. Yet superhero films — and Spider-Man in particular — continue to draw enormous audiences to cinemas. Understanding why tells us a lot about how entertainment, technology, and business intersect in the modern world.`,
    vocab: [
      { word: 'Box office', definition: 'The total amount of money a film earns from ticket sales at cinemas.' },
      { word: 'Franchise', definition: 'A series of related films, books, or products based on the same characters or brand.' },
      { word: 'Profitable', definition: 'Making a lot of money — earning more than the cost of production.' },
      { word: 'Intersect', definition: 'To meet, cross, or overlap — where two or more things come together.' },
    ],
    questions: [
      { n: 1, q: 'Have you seen a Spider-Man film? Which superhero films do you enjoy? Why are they so popular?' },
      { n: 2, q: 'Spider-Man is popular because he is an ordinary person with ordinary problems. Do you agree that this makes him more interesting than other superheroes?' },
      { n: 3, q: '400 million dollars in one weekend. Does it surprise you that people still go to cinemas when they can watch films at home on streaming services?' },
    ]
  },
  {
    number: 2, title: 'The Business of Superheroes', emoji: '💰', color: '#b91c1c',
    text: `The Spider-Man films are produced by Sony Pictures in partnership with Marvel Studios, which is owned by Disney — one of the largest entertainment companies in the world. This partnership is itself an interesting story about how the modern film industry works.\n\nMarvel sold the film rights to Spider-Man to Sony in 1999 for just 7 million dollars — a decision that looks extraordinary today, given that the character has since generated more than 10 billion dollars in film revenue alone. When Marvel launched its own film studio and created the hugely successful Marvel Cinematic Universe, Spider-Man was the one major character they could not use because Sony owned the rights.\n\nIn 2015, the two companies reached a deal to share the character — Sony would continue to make Spider-Man films, but the character could also appear in Marvel Cinematic Universe films alongside Iron Man, Captain America, and the Avengers. This partnership has been enormously profitable for both companies and is widely credited with revitalising the Spider-Man franchise.\n\nThe economics of modern blockbuster films are staggering. A major superhero film typically costs between 200 and 350 million dollars to produce, with an additional 150-200 million spent on marketing and advertising. To break even, a film usually needs to earn roughly 2.5 times its production budget at the global box office. This means a film that cost 300 million to make needs to earn about 750 million just to avoid losing money. The financial risks are enormous — but so are the potential rewards.`,
    vocab: [
      { word: 'Film rights', definition: 'The legal permission to make a film based on a character, book, or story.' },
      { word: 'Revenue', definition: 'The total income generated from selling something — money earned.' },
      { word: 'Revitalising', definition: 'Giving new life and energy to something that was becoming weak or unpopular.' },
      { word: 'Break even', definition: 'To earn exactly enough money to cover all costs — neither making a profit nor a loss.' },
    ],
    questions: [
      { n: 4, q: 'Marvel sold Spider-Man film rights for 7 million dollars. The character has since earned 10 billion. What lesson does this teach about business decisions?' },
      { n: 5, q: 'A superhero film can cost 500 million dollars including marketing. Is this too much money to spend on entertainment? What else could it be used for?' },
      { n: 6, q: 'Sony and Marvel share Spider-Man in a partnership. Can you think of other examples where rival companies work together because it benefits both?' },
    ]
  },
  {
    number: 3, title: 'Why We Love Stories About Heroes', emoji: '🦸', color: '#991b1b',
    text: `Superhero films dominate modern cinema in a way that no other genre has done before. Of the 20 highest-grossing films of all time, more than half are superhero or fantasy films. This raises an interesting question: why are humans so drawn to stories about people with extraordinary powers?\n\nPsychologists suggest several reasons. First, superhero stories follow a pattern that humans find deeply satisfying — the "hero journey." An ordinary person faces a challenge, discovers hidden strength, overcomes obstacles, and triumphs over evil. This story structure appears in myths, legends, and fairy tales from every culture in history. Spider-Man is simply the modern version of a story that humans have been telling for thousands of years.\n\nSecond, superheroes represent wish fulfilment. Most people feel powerless at some point in their lives — unable to fix problems, protect the people they love, or change things that are unfair. Superhero stories allow us to imagine what it would be like to have the power to make a difference. For young viewers especially, seeing someone like Peter Parker — awkward, uncertain, and struggling — transform into someone powerful and important is deeply appealing.\n\nThird, superhero films provide a simple moral framework in a complex world. In real life, it can be difficult to know what is right and what is wrong. In a superhero film, the distinction is usually clear. The hero is good. The villain is bad. Justice prevails. In a world full of ambiguity and uncertainty, the clarity of a superhero story can be genuinely comforting.\n\nCritics of superhero films argue that this simplicity is also their weakness — that they reduce complex human experiences to battles between good and evil, and that their dominance of cinema crowds out more thoughtful, challenging filmmaking. Both arguments have merit.`,
    vocab: [
      { word: 'Genre', definition: 'A category or type of film, book, or music — like comedy, horror, or action.' },
      { word: 'Wish fulfilment', definition: 'The satisfaction of a desire through imagination — imagining something you want coming true.' },
      { word: 'Moral framework', definition: 'A system of beliefs about what is right and wrong that helps people make decisions.' },
      { word: 'Ambiguity', definition: 'A situation where something can be understood in more than one way — uncertainty about meaning.' },
    ],
    questions: [
      { n: 7, q: 'The passage says superhero stories follow the same pattern as ancient myths. Can you think of a traditional story from your culture that follows the same hero journey?' },
      { n: 8, q: 'Superhero films offer simple good-vs-evil stories. Is this comforting or does it oversimplify the world? Can entertainment be too simple?' },
      { n: 9, q: 'Critics say superhero films crowd out more thoughtful filmmaking. Do you agree? What other types of films do you wish were more popular?' },
    ]
  },
  {
    number: 4, title: 'The Future of Cinema', emoji: '🍿', color: '#7f1d1d',
    text: `The success of Spider-Man at the box office comes at a time when the future of cinema is uncertain. The film industry has changed more in the last decade than in the previous fifty years, and the changes are still accelerating.\n\nStreaming services like Netflix, Disney+, and Amazon Prime have transformed how people watch films. Instead of going to a cinema, millions of people now watch new releases on their televisions, tablets, and phones — often within weeks of the theatrical release. During the pandemic, many studios released films simultaneously in cinemas and on streaming platforms, and some viewers never returned to the cinema habit.\n\nDespite this, certain films still draw enormous cinema audiences. Superhero blockbusters, animated family films, and event movies — films that feel like they need to be seen on the biggest possible screen — continue to perform well. The cinema experience offers something that streaming cannot replicate: a giant screen, powerful sound, a shared audience reaction, and the sense of an event. Laughing with 200 strangers, gasping at a plot twist together, or feeling the bass of an explosion through your seat — these are experiences that a phone screen cannot provide.\n\nIn many parts of Asia, including Thailand, cinema culture remains strong. Shopping mall cinemas are social gathering places, especially for young people. Premium formats — IMAX, 4DX, and luxury seating — have given cinemas a way to charge more and offer experiences that justify the higher cost compared to watching at home.\n\nThe film industry is not dying — but it is changing. The films that succeed in cinemas are increasingly the big, spectacular event films that demand a big screen. Smaller, quieter films are migrating to streaming. And Spider-Man, swinging between buildings on a screen the size of a house, is exactly the kind of experience that keeps people buying tickets.`,
    vocab: [
      { word: 'Streaming', definition: 'Watching video content over the internet without downloading it — services like Netflix and Disney+.' },
      { word: 'Theatrical release', definition: 'When a film is first shown in cinemas, before it becomes available on streaming or DVD.' },
      { word: 'Replicate', definition: 'To copy or reproduce something exactly — to create the same experience.' },
      { word: 'Migrating', definition: 'Moving from one place to another — shifting to a different platform or format.' },
    ],
    questions: [
      { n: 10, q: 'Do you prefer watching films at the cinema or at home on a streaming service? What is different about each experience?' },
      { n: 11, q: 'In Thailand, cinema culture is still strong, especially in shopping malls. Is this true where you live? Why do you think cinemas remain popular in Asia?' },
      { n: 12, q: 'The passage says big blockbusters go to cinema while smaller films go to streaming. Is this a good thing or are we losing something important?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Spider-Man Breaks Box Office Records</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The latest Spider-Man movie earned 400 million dollars in one weekend. Why are superhero films so popular, and what does their success tell us about cinema and entertainment?</p>
            </div>
          </div>
