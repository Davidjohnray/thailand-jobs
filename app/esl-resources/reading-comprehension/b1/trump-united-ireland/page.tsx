...
const PARTS = [
  {
    number: 1, title: 'A Presidential Bombshell', emoji: '💣', color: '#dc2626',
    text: `During a visit to Ireland this week, President Trump made a statement that sent shockwaves through British and Irish politics: "I would love to see a united Ireland. I think it would be a beautiful thing."\n\nThe comment — made casually during a press conference at his golf resort in Doonbeg, County Clare — may have been spontaneous rather than planned. But in the complex world of Irish and British politics, the words of a US president carry enormous weight. No sitting American president has ever publicly supported Irish unification.\n\nThe reaction was immediate. In Ireland, the statement was celebrated. Sinn Fein, the party that has long campaigned for a united Ireland, called it "historic." The Irish government — which officially supports unification but has been careful not to push the issue — welcomed the sentiment while urging caution.\n\nIn Northern Ireland and Britain, the reaction was very different. Unionists — the community that wants Northern Ireland to remain part of the United Kingdom — described Trump comment as "reckless" and "ignorant." The British government said it was "disappointed" by the remarks. And in Northern Ireland itself — where the question of unification is deeply personal and emotionally charged — the statement reopened wounds that many had hoped were healing.`,
    vocab: [
      { word: 'Unification', definition: 'Joining two separate parts into one — making divided Ireland a single country.' },
      { word: 'Spontaneous', definition: 'Not planned — said or done on impulse, without thinking in advance.' },
      { word: 'Unionists', definition: 'People who want Northern Ireland to remain part of the United Kingdom.' },
      { word: 'Emotionally charged', definition: 'A topic that makes people feel very strong emotions — sensitive and personal.' },
    ],
    questions: [
      { n: 1, q: 'Trump casually said he would love a united Ireland. Should presidents make statements this big without planning them?' },
      { n: 2, q: 'Ireland celebrated the comment. Britain was angry. Why does the same statement produce opposite reactions?' },
      { n: 3, q: 'No US president has ever supported Irish unification publicly. Why does the opinion of an American leader matter in Ireland?' },
    ]
  },
  {
    number: 2, title: 'Why Ireland Is Divided', emoji: '🗺️', color: '#b91c1c',
    text: `To understand why Trump comment was so explosive, you need to understand why Ireland is divided in the first place.\n\nIreland was ruled by Britain for more than 800 years. In 1921, after a war of independence, most of the island became the Irish Free State (later the Republic of Ireland). But six counties in the northeast — where a majority of the population was Protestant and loyal to Britain — remained part of the United Kingdom as "Northern Ireland."\n\nThis partition created a divided island. The Republic of Ireland in the south is an independent country with its own government, laws, and identity. Northern Ireland is part of the United Kingdom, governed from London, but with its own regional assembly.\n\nThe division was never accepted by everyone. For decades, the Catholic and nationalist community in Northern Ireland — who wanted to join the Republic — felt discriminated against in housing, employment, and political representation. In the late 1960s, this grievance erupted into a violent conflict known as "the Troubles" — 30 years of bombings, shootings, and political violence that killed more than 3,500 people.\n\nThe Good Friday Agreement of 1998 largely ended the Troubles by creating a power-sharing government in Northern Ireland and establishing that unification could only happen through a democratic vote — a "border poll" — in which a majority in both Northern Ireland and the Republic agreed. Since then, Northern Ireland has been at peace — fragile, imperfect, but holding.`,
    vocab: [
      { word: 'Partition', definition: 'Dividing a country into two or more parts — splitting a territory along political or religious lines.' },
      { word: 'Nationalist', definition: 'Someone who wants their region to be part of a particular nation — in Ireland, wanting a united Ireland.' },
      { word: 'The Troubles', definition: 'The 30-year conflict in Northern Ireland between those who wanted to stay British and those who wanted a united Ireland.' },
      { word: 'Power-sharing', definition: 'A system where two opposing groups share government — both sides have a role in making decisions.' },
    ],
    questions: [
      { n: 4, q: 'Britain ruled Ireland for 800 years. How does this long history of colonisation affect the relationship today?' },
      { n: 5, q: 'The Troubles killed 3,500 people over 30 years. What does this level of violence do to a community? How do you recover?' },
      { n: 6, q: 'The Good Friday Agreement says unification can only happen through a vote. Is this the right approach?' },
    ]
  },
  {
    number: 3, title: 'Is Unification Coming?', emoji: '📊', color: '#991b1b',
    text: `Trump comment arrives at a time when the question of Irish unification is more alive than it has been in decades.\n\nDemographic changes in Northern Ireland are shifting the balance. For the first time in history, people who identify as Catholic or Irish nationalist outnumber those who identify as Protestant or British unionist. The 2021 census showed that Catholics made up 45.7% of the population compared to 43.5% for Protestants — a historic reversal.\n\nBrexit accelerated the debate. When the UK left the European Union in 2020, Northern Ireland was given a special status — remaining in the EU single market for goods while being part of the UK. This created a trade border in the Irish Sea rather than on the island of Ireland. Many unionists see this as a step toward separating Northern Ireland from Britain. Many nationalists see it as proof that Northern Ireland future lies with the Republic.\n\nPolls on unification remain closely divided. Depending on how the question is asked, support for a united Ireland in Northern Ireland ranges from 30% to 50%. In the Republic, support is high — but drops significantly when people consider the economic costs of absorbing Northern Ireland, which receives substantial subsidies from the British government.\n\nA border poll is not imminent. But it is no longer unthinkable. And when the President of the United States — the most powerful political figure in the world — says he would "love" to see it happen, the question moves from abstract to real.`,
    vocab: [
      { word: 'Demographic', definition: 'Relating to the population — changes in who lives in a place and their characteristics.' },
      { word: 'Brexit', definition: 'Britain decision to leave the European Union in 2020.' },
      { word: 'Subsidies', definition: 'Money given by a government to support an area or industry — financial aid.' },
      { word: 'Imminent', definition: 'About to happen very soon — approaching in the near future.' },
    ],
    questions: [
      { n: 7, q: 'Catholics now outnumber Protestants in Northern Ireland for the first time. How does demographic change affect political outcomes?' },
      { n: 8, q: 'Brexit put a trade border in the Irish Sea. How did leaving the EU change the unification debate?' },
      { n: 9, q: 'Support for unification drops when people consider the cost. Should money decide a question this important?' },
    ]
  },
  {
    number: 4, title: 'Words Have Consequences', emoji: '🎤', color: '#7f1d1d',
    text: `Trump may have said "I would love a united Ireland" without thinking deeply about the consequences. But in Northern Ireland — where peace was hard-won and remains fragile — words from powerful people can shift the ground beneath entire communities.\n\nFor nationalists, the statement validates their goal. The world most powerful leader agrees with them. This strengthens their position in any future negotiation and makes a border poll more likely.\n\nFor unionists, the statement is a betrayal. America has been seen as an honest broker in Irish politics — supporting peace without taking sides. By expressing support for unification, Trump has, in their view, abandoned neutrality and sided against them.\n\nThe lesson extends beyond Ireland. What leaders say matters — not just in formal speeches and signed agreements, but in casual comments, throwaway lines, and spontaneous remarks. A sentence spoken at a press conference in Doonbeg can destabilise politics in Belfast, anger a government in London, and change the calculations of political parties on both sides of the Irish border.\n\nTrump may forget what he said by next week. Ireland will not. Northern Ireland will not. And the delicate balance that has kept peace on the island for 28 years has been shifted — by a man who may not have understood what he was shifting.`,
    vocab: [
      { word: 'Validates', definition: 'Confirms or supports — making something seem more legitimate or justified.' },
      { word: 'Honest broker', definition: 'A neutral mediator — someone trusted by both sides to be fair.' },
      { word: 'Throwaway lines', definition: 'Casual comments that are not carefully thought through — remarks made without considering the impact.' },
      { word: 'Delicate balance', definition: 'A fragile situation where small changes can cause big problems — easily disrupted.' },
    ],
    questions: [
      { n: 10, q: 'A casual comment by a president can destabilise peace in another country. Should leaders always think before they speak?' },
      { n: 11, q: 'America was seen as neutral in Irish politics. Has Trump destroyed that neutrality?' },
      { n: 12, q: 'Trump may forget what he said. Ireland will not. Why do some communities remember words that the speaker forgets?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Trump Says He Would Love a United Ireland". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function TrumpIrelandPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Trump Says He Would Love a United Ireland</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>President Trump stunned Britain and delighted Ireland by saying he would love to see a united Ireland. What this means, why Ireland is divided, and why words from a US president matter.</p>
            </div>
          </div>
