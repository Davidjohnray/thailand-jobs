...
const PARTS = [
  {
    number: 1, title: 'The Great Beer Heist', emoji: '🍺', color: '#dc2626',
    text: `California police are searching for what they are calling "beer bandits" — thieves who stole an entire truck carrying 50,000 cans of Pabst Blue Ribbon beer. The truck, which was parked at a distribution centre near Sacramento, disappeared overnight. When workers arrived the next morning, the truck and its cargo — worth approximately 75,000 dollars — were gone.\n\nPabst Blue Ribbon, known as PBR, posted on social media: "We are asking for the safe return of our beer. No questions asked." The post went viral, with thousands of people sharing jokes about the theft and offering to "help search" for the missing beer.\n\nThe story captured the internet's imagination for several reasons. First, the scale — 50,000 cans is enough beer to fill a swimming pool. Second, the audacity — stealing an entire truck requires planning, nerve, and a very specific set of skills. And third, the humour — there is something inherently funny about a beer heist that is absent from, say, a bank robbery.\n\nPolice believe the theft was carried out by organised criminals who target cargo trucks — a growing problem in the United States. Cargo theft costs American businesses more than 15 billion dollars per year. Most stolen goods are electronics, clothing, and pharmaceuticals. Beer is less common — but apparently not off the menu.`,
    vocab: [
      { word: 'Heist', definition: 'A robbery or theft, especially one that is carefully planned and dramatic.' },
      { word: 'Distribution centre', definition: 'A warehouse where goods are stored before being sent to shops and customers.' },
      { word: 'Audacity', definition: 'Boldness or daring — the confidence to do something surprising or risky.' },
      { word: 'Cargo', definition: 'Goods carried by a truck, ship, or aircraft — the load being transported.' },
    ],
    questions: [
      { n: 1, q: '50,000 cans of beer stolen in one night. What was your first reaction to this story?' },
      { n: 2, q: 'The beer company posted "no questions asked" on social media. Is this a smart response? Why might humour work better than anger?' },
      { n: 3, q: 'Cargo theft costs 15 billion dollars a year in the US. Why do you think this crime is so common?' },
    ]
  },
  {
    number: 2, title: 'The Business of Stealing Stuff', emoji: '🚛', color: '#b91c1c',
    text: `The beer truck theft might be funny, but cargo theft is a serious and growing crime. Every year, thousands of trucks carrying goods are stolen from parking lots, rest stops, and distribution centres across the United States and Europe.\n\nThe criminals who carry out these thefts are not amateurs. Many are part of organised networks that identify high-value loads, track truck movements, and have buyers ready for the stolen goods before they are even taken. Some groups use fake identification to impersonate legitimate drivers, picking up loads from warehouses using forged paperwork.\n\nThe COVID-19 pandemic made the problem worse. With more goods being shipped than ever — thanks to the explosion of online shopping — there are more trucks on the road and more opportunities for theft. Meanwhile, driver shortages mean that trucks are often parked overnight in unsecured locations while drivers rest, creating easy targets.\n\nFor the companies whose goods are stolen, the cost goes beyond the value of the cargo. Insurance premiums rise. Delivery schedules are disrupted. Customers receive their orders late or not at all. And in some cases — particularly with pharmaceuticals or food products — stolen goods that re-enter the market through unofficial channels can pose safety risks to consumers.`,
    vocab: [
      { word: 'Organised networks', definition: 'Groups of criminals who work together systematically — planned and coordinated crime.' },
      { word: 'Impersonate', definition: 'To pretend to be someone else — using fake identity to deceive people.' },
      { word: 'Forged', definition: 'Fake — documents or papers that have been illegally created to look real.' },
      { word: 'Insurance premiums', definition: 'Regular payments made to an insurance company — the cost of being insured against loss.' },
    ],
    questions: [
      { n: 4, q: 'Criminals use fake IDs to steal entire truckloads. How can companies protect themselves from this kind of theft?' },
      { n: 5, q: 'Online shopping means more trucks and more targets. Is the convenience of delivery worth the increased crime risk?' },
      { n: 6, q: 'Stolen medicines re-entering the market can be dangerous. Why is cargo theft more serious than just losing money?' },
    ]
  },
  {
    number: 3, title: 'Why We Love Crime Stories', emoji: '📺', color: '#991b1b',
    text: `The beer heist went viral — not because of the financial loss, but because people found it entertaining. This raises an interesting question: why are humans so fascinated by crime?\n\nCrime stories have been popular throughout human history. From the tales of Robin Hood to modern true crime podcasts, we are drawn to stories about people who break the rules. The reasons are partly psychological — crime stories create tension, suspense, and resolution that our brains find deeply satisfying. They also allow us to safely explore dangerous scenarios from the comfort of our homes.\n\nThe beer heist is a specific type of crime story that people find especially appealing: the victimless (or nearly victimless) caper. Nobody was hurt. The "victim" is a large corporation that can absorb the loss. The criminals showed creativity and daring. And the stolen item — beer — is inherently amusing. We root for the thieves in a way we never would if they had stolen medicine from a hospital.\n\nThis selective sympathy reveals something interesting about our moral intuitions. We judge crimes not just by what was done, but by who did it, who suffered, and whether the crime feels clever or cruel. A heist is more entertaining than a mugging. A con artist is more fascinating than a pickpocket. Our moral judgements are far less consistent than we like to believe.`,
    vocab: [
      { word: 'Suspense', definition: 'A feeling of excitement and uncertainty about what will happen next.' },
      { word: 'Caper', definition: 'A playful or daring theft — a crime that feels more like an adventure than a serious offence.' },
      { word: 'Moral intuitions', definition: 'Our instinctive feelings about what is right and wrong — gut reactions to ethical situations.' },
      { word: 'Con artist', definition: 'A person who tricks others for money — someone who deceives people through clever schemes.' },
    ],
    questions: [
      { n: 7, q: 'We find the beer heist funny but would not laugh at a hospital robbery. Why do we judge crimes so differently?' },
      { n: 8, q: 'True crime podcasts are hugely popular. Why are people so fascinated by crime stories?' },
      { n: 9, q: 'We sometimes root for clever thieves in films. Does this mean our sense of right and wrong is inconsistent?' },
    ]
  },
  {
    number: 4, title: 'What Happened to the Beer?', emoji: '🔍', color: '#7f1d1d',
    text: `As of this week, the beer has not been recovered. Police have released security camera footage showing the truck leaving the distribution centre at approximately 3 AM, driven by someone who clearly knew the facility's layout and security routines.\n\nThe practical challenge of selling 50,000 stolen cans of beer is significant. Unlike electronics or jewellery, beer is bulky, heavy, and has a limited shelf life. Selling it through legitimate channels is impossible — every can has a batch number that can be traced. The thieves would need to sell it through unofficial channels — bars, parties, private buyers — at a fraction of the retail price.\n\nSome investigators speculate that the theft may not have been about the beer at all. The truck itself — a refrigerated trailer worth more than 100,000 dollars — may have been the real target. Stolen trucks can be repainted, given new registration numbers, and sold or used for other criminal purposes. The beer may have simply been dumped.\n\nWhatever happened to the 50,000 cans, the story has given the world a brief moment of lightness in a news cycle dominated by floods, wars, and political crises. Sometimes, in a week full of serious headlines, the story we need most is the one about someone stealing a swimming pool's worth of beer and driving off into the California night.`,
    vocab: [
      { word: 'Batch number', definition: 'A code that identifies when and where a product was made — used for tracking.' },
      { word: 'Shelf life', definition: 'The length of time a product remains good to use or consume before it expires.' },
      { word: 'Speculate', definition: 'To guess or form a theory without having all the facts — to consider possibilities.' },
      { word: 'News cycle', definition: 'The ongoing flow of news stories — what the media is currently focused on.' },
    ],
    questions: [
      { n: 10, q: 'How would you sell 50,000 cans of stolen beer? What makes this crime harder than stealing electronics?' },
      { n: 11, q: 'The truck might have been the real target, not the beer. Why would a truck be more valuable than its cargo?' },
      { n: 12, q: 'In a serious news week, a beer heist gave people something to smile about. Do we need funny news stories? Why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "50,000 Cans of Beer Stolen in California". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function BeerHeistPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>50,000 Cans of Beer Stolen in California</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Thieves stole an entire truck carrying 50,000 cans of beer. The great beer heist, the business of cargo theft, and why we love crime stories.</p>
            </div>
          </div>
