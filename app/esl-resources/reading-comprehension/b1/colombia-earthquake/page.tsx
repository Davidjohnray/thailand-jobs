...
const PARTS = [
  {
    number: 1, title: 'The Ground Shook', emoji: '🏚️', color: '#dc2626',
    text: `On 10 August 2026, a powerful earthquake struck western Colombia. The earthquake measured 7.4 on the Richter scale — making it the strongest to hit the country this century. At least 265 people were killed, more than 3,700 were injured, and over 4,100 remain missing. Entire buildings collapsed in the cities of Cali, Pereira, and Quibdo, trapping people under tonnes of concrete and steel.\n\nThe earthquake struck at mid-morning, when most people were at work, school, or out on the streets. The shaking lasted for more than 30 seconds — long enough for buildings to crack, walls to fall, and roads to split open. Witnesses described the ground moving like waves on the ocean. People ran screaming from buildings, many still in their work clothes or school uniforms.\n\nThe images from Colombia were heartbreaking. Rescue workers and ordinary citizens formed human chains to pass rubble from collapsed buildings, searching desperately for survivors. An elderly woman was carried to safety on a piece of furniture. A child was pulled alive from the ruins of a school. A hospital in Cali partly collapsed, forcing patients to be evacuated while doctors continued treating the injured in the car park outside.\n\nThe Colombian government declared a national emergency and deployed the army to help with rescue operations. Seven airports were closed. Five major cities were placed on red alert. Countries across Latin America immediately offered assistance, and international aid organisations began mobilising resources.`,
    vocab: [
      { word: 'Richter scale', definition: 'A system for measuring the strength of an earthquake — higher numbers mean stronger quakes.' },
      { word: 'Collapsed', definition: 'Fell down suddenly and completely — a building that broke apart and fell to the ground.' },
      { word: 'Evacuated', definition: 'Moved people out of a dangerous place to somewhere safe.' },
      { word: 'Mobilising', definition: 'Organising and preparing resources or people to take action quickly.' },
    ],
    questions: [
      { n: 1, q: 'The earthquake lasted 30 seconds but killed 265 people. How much damage can happen in such a short time?' },
      { n: 2, q: 'Ordinary citizens formed human chains to search for survivors. Would you help in a situation like this? What would you do?' },
      { n: 3, q: 'Has your country ever experienced a serious earthquake? What happened and how did people respond?' },
    ]
  },
  {
    number: 2, title: 'Why Earthquakes Happen', emoji: '🌍', color: '#b91c1c',
    text: `The Earth might feel solid and stable beneath your feet, but the ground you are standing on is actually moving — very slowly, all the time. The surface of the Earth is made up of enormous pieces called tectonic plates, which float on a layer of hot, semi-liquid rock deep underground. These plates are constantly moving — usually just a few centimetres per year — and where they meet, push against each other, or slide past each other, earthquakes happen.\n\nColombia sits on the "Ring of Fire" — a horseshoe-shaped zone around the Pacific Ocean where about 90% of the world's earthquakes occur. The Ring of Fire stretches from New Zealand through Southeast Asia, Japan, Alaska, and down the western coast of the Americas. Countries on the Ring of Fire — including Japan, Indonesia, Chile, Mexico, and the Philippines — experience earthquakes regularly.\n\nThe Colombia earthquake was caused by the Malpelo plate — a small piece of ocean floor — pushing underneath the South American plate at a rate of about 58 millimetres per year. When the pressure between the plates becomes too great, the rock suddenly breaks and shifts, releasing enormous energy in the form of seismic waves that travel through the ground — and that is what we feel as an earthquake.\n\nEarthquake strength is measured on a logarithmic scale, which means each whole number represents roughly 32 times more energy than the number below it. A magnitude 7.4 earthquake like the one in Colombia releases about 32 times more energy than a magnitude 6.4, and about 1,000 times more energy than a magnitude 5.4. This is why the difference between a "moderate" and a "major" earthquake can be the difference between rattling windows and destroying cities.`,
    vocab: [
      { word: 'Tectonic plates', definition: 'Enormous pieces of the Earth surface that float on hot rock underneath and move very slowly.' },
      { word: 'Ring of Fire', definition: 'A zone around the Pacific Ocean where most earthquakes and volcanic eruptions happen.' },
      { word: 'Seismic waves', definition: 'Waves of energy that travel through the ground during an earthquake, causing shaking.' },
      { word: 'Logarithmic', definition: 'A scale where each step is many times larger than the previous one — not evenly spaced.' },
    ],
    questions: [
      { n: 4, q: 'The ground beneath you is always moving. Does knowing this change how you feel about the Earth? Is it comforting or unsettling?' },
      { n: 5, q: 'Thailand is not on the Ring of Fire but felt the 2004 tsunami. How can earthquakes far away affect countries that are not on fault lines?' },
      { n: 6, q: 'A 7.4 earthquake releases 1,000 times more energy than a 5.4. Why do you think scientists use this unusual scale?' },
    ]
  },
  {
    number: 3, title: 'Why Buildings Fall', emoji: '🏗️', color: '#991b1b',
    text: `Earthquakes do not kill people — buildings do. This is a phrase that earthquake engineers repeat constantly, because it captures an important truth: in almost every earthquake, the vast majority of deaths are caused by buildings collapsing on the people inside them. If every building in Colombia had been built to withstand a magnitude 7.4 earthquake, the death toll would have been dramatically lower.\n\nJapan experiences more earthquakes than almost any country on Earth, but its death tolls are remarkably low compared to countries at similar risk. The 2011 earthquake that struck Japan was magnitude 9.0 — more than 100 times stronger than the Colombia earthquake — yet the earthquake itself killed relatively few people. Most of the 18,000 deaths were caused by the tsunami that followed, not by collapsed buildings. Japanese buildings are designed to flex and sway during an earthquake rather than cracking and falling.\n\nThe difference is money. Building earthquake-resistant structures costs more — sometimes 10-20% more than standard construction. For wealthy countries like Japan, this cost is manageable. For developing countries like Colombia, where many people live in buildings constructed without proper engineering, without reinforced concrete, and sometimes without any building permits at all, the cost of earthquake-proofing is beyond what most people can afford.\n\nThis means that earthquakes are, in a very real sense, a poverty problem. The same earthquake that causes minor damage in Tokyo can destroy entire neighbourhoods in a poorer country. The people who die in earthquakes are almost always the poorest — living in the weakest buildings, in the most vulnerable locations, with the least access to emergency services.`,
    vocab: [
      { word: 'Earthquake-resistant', definition: 'Built to survive an earthquake without collapsing — designed to be flexible and strong.' },
      { word: 'Reinforced concrete', definition: 'Concrete strengthened with steel bars inside it, making it much stronger.' },
      { word: 'Building permits', definition: 'Official permission from the government to construct a building, ensuring it meets safety standards.' },
      { word: 'Earthquake-proofing', definition: 'Making a building strong enough to survive an earthquake without major damage.' },
    ],
    questions: [
      { n: 7, q: 'Earthquakes do not kill people — buildings do. What does this phrase mean, and why is it important?' },
      { n: 8, q: 'Japan survives huge earthquakes with few deaths because of building standards. Should all countries be required to build this way? Who should pay?' },
      { n: 9, q: 'Poor people die in earthquakes because they live in weak buildings. How can this inequality be addressed?' },
    ]
  },
  {
    number: 4, title: 'After the Shaking Stops', emoji: '💚', color: '#7f1d1d',
    text: `The earthquake in Colombia lasted less than a minute. But the recovery will take years — possibly decades.\n\nIn the immediate aftermath, the priority is search and rescue. The first 72 hours after an earthquake are called the "golden hours" — the period when trapped survivors are most likely to still be alive. After 72 hours, the chances of finding someone alive under rubble drop dramatically. Rescue teams use dogs, cameras, listening devices, and thermal sensors to locate survivors, and heavy equipment to carefully remove debris without causing further collapse.\n\nOnce the immediate rescue phase ends, the focus shifts to emergency relief — providing food, water, shelter, and medical care to the hundreds of thousands of people whose homes have been destroyed or damaged. This phase can last for months. People live in temporary shelters — tents, sports halls, school buildings — while the slow work of clearing rubble and assessing damage begins.\n\nThe longest and hardest phase is reconstruction. Rebuilding a city after an earthquake is enormously expensive and logistically complex. Damaged buildings must be inspected, demolished if unsafe, and rebuilt to higher standards. Infrastructure — roads, bridges, water pipes, electrical networks — must be repaired. And the psychological damage — the fear, grief, and trauma experienced by survivors — must be addressed through counselling and community support.\n\nColombia will rebuild. The international community will help. But for the families who lost loved ones this week — and for the thousands of people still waiting to hear whether their missing relatives are alive — the earthquake of 10 August 2026 will be a date they never forget.`,
    vocab: [
      { word: 'Golden hours', definition: 'The critical first 72 hours after a disaster when trapped survivors are most likely to be found alive.' },
      { word: 'Thermal sensors', definition: 'Devices that detect heat — used to find warm bodies under cold rubble.' },
      { word: 'Reconstruction', definition: 'The long process of rebuilding a place after it has been destroyed.' },
      { word: 'Trauma', definition: 'Deep emotional distress caused by a terrible experience — psychological damage.' },
    ],
    questions: [
      { n: 10, q: 'The first 72 hours are called the golden hours. Why is time so important in earthquake rescue?' },
      { n: 11, q: 'Thousands of people are living in tents after losing their homes. What do you think the hardest part of this experience would be?' },
      { n: 12, q: 'How can the international community help Colombia recover? What kind of support is most important — money, people, or equipment?' },
    ]
  },
]
...
export default function ColombiaEarthquakePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Earthquake Kills Hundreds in Colombia</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A 7.4 magnitude earthquake struck Colombia on Monday, killing at least 265 people and leaving thousands missing. Why earthquakes kill, and why poverty makes them worse.</p>
            </div>
          </div>
