...
const PARTS = [
  {
    number: 1, title: 'The King of Cycling', emoji: '🚴', color: '#dc2626',
    text: `On 26 July 2026, Tadej Pogacar of Slovenia rode into Paris wearing the famous yellow jersey and raised his arms in triumph. He had just won the Tour de France for the fifth time — tying the all-time record held by legendary riders Jacques Anquetil, Eddy Merckx, Bernard Hinault, and Miguel Indurain. At just 27 years old, Pogacar is already being called the greatest cyclist of his generation and one of the best in the history of the sport.\n\nThe Tour de France is the most famous cycling race in the world. It takes place every July and covers approximately 3,500 kilometres across France over 21 stages, lasting three weeks. Riders climb mountains, race across flat plains, and battle exhaustion, heat, rain, and crashes. It is considered one of the most physically demanding sporting events on Earth.\n\nPogacar dominated the 2026 Tour from start to finish. He won five individual stages, took the yellow jersey early in the race, and never looked in danger of losing it. His nearest rival finished more than six minutes behind — in a sport where races are often decided by seconds, this margin was enormous.\n\nWhat makes Pogacar remarkable is not just his physical ability but his style. Unlike many champions who ride defensively — protecting their lead and avoiding risks — Pogacar attacks constantly. He races with a joy and aggression that has made him hugely popular with fans. His smile on the podium, his willingness to try things that other riders would consider reckless, and his ability to win even when things go wrong have earned him comparisons with the greatest athletes in any sport.`,
    vocab: [
      { word: 'Jersey', definition: 'In cycling, a special shirt worn by the race leader — the yellow jersey is the most famous in the Tour de France.' },
      { word: 'Stages', definition: 'The individual sections of a multi-day race — each stage is a separate race within the bigger competition.' },
      { word: 'Margin', definition: 'The gap or difference between the winner and the next competitor.' },
      { word: 'Defensively', definition: 'In a careful, protective way — trying to avoid losing rather than trying to win aggressively.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever watched the Tour de France or any cycling race? What do you know about it?' },
      { n: 2, q: 'Pogacar won by more than six minutes. In a sport decided by seconds, what does this tell you about how good he is?' },
      { n: 3, q: 'The passage says Pogacar attacks constantly rather than riding defensively. Do you prefer athletes who take risks or athletes who play it safe?' },
    ]
  },
  {
    number: 2, title: 'The Hardest Race in the World', emoji: '🏔️', color: '#b91c1c',
    text: `The Tour de France is not just a bike race — it is one of the ultimate tests of human endurance. To understand what Pogacar achieved, you need to understand what the race demands from the human body.\n\nOver three weeks, riders cover approximately 3,500 kilometres — roughly the distance from London to Istanbul. They ride for five to seven hours per day, burning between 5,000 and 8,000 calories — more than three times what an average person burns in an entire day. On mountain stages, riders climb the equivalent of several kilometres vertically, pedalling at extreme effort for hours at a time.\n\nThe physical toll is extraordinary. Riders lose an average of 2-3 kilograms of body weight during the race, despite eating enormous amounts of food. Their resting heart rates drop to levels that would be considered dangerously low in a normal person — sometimes below 30 beats per minute. Some riders sleep for as little as five hours per night. Crashes are common and can end a rider's race — or career — in an instant.\n\nThe psychological demands are equally intense. Riders must maintain concentration for hours in a group of 150 cyclists moving at speeds of up to 70 kilometres per hour, where a momentary lapse in attention can cause a catastrophic crash. They must manage pain, fatigue, and self-doubt over three weeks while making tactical decisions that affect their entire team. And they must do all of this on live television, watched by millions of fans around the world.\n\nDespite all of this, the Tour de France attracts the best cyclists on Earth every year, and millions of fans line the roads to watch them pass. There is something deeply compelling about watching human beings push themselves to the absolute limits of what the body can endure.`,
    vocab: [
      { word: 'Endurance', definition: 'The ability to continue doing something difficult or painful for a long time without giving up.' },
      { word: 'Calories', definition: 'A unit of energy — the fuel your body gets from food. More active people burn more calories.' },
      { word: 'Concentration', definition: 'The ability to focus your attention on something for a long time without being distracted.' },
      { word: 'Compelling', definition: 'So interesting or exciting that it holds your attention completely — impossible to ignore.' },
    ],
    questions: [
      { n: 4, q: 'Riders burn 8,000 calories per day — three times what a normal person burns. What do you think they eat to fuel this?' },
      { n: 5, q: 'Would you ever want to try cycling 3,500 kilometres over three weeks? What do you think would be the hardest part — physical or mental?' },
      { n: 6, q: 'Millions of fans stand by the road to watch cyclists pass for a few seconds. Why do you think people do this?' },
    ]
  },
  {
    number: 3, title: 'A Tiny Country, A Giant Champion', emoji: '🇸🇮', color: '#991b1b',
    text: `Tadej Pogacar comes from Slovenia — a country of just two million people, roughly the same population as the city of Bangkok. Slovenia is one of the smallest countries in Europe, squeezed between Italy, Austria, Hungary, and Croatia. Most people outside Europe would struggle to find it on a map. Yet this tiny nation has produced the dominant cyclist of his era.\n\nSlovenia has a strong cycling culture, partly because of its geography. The country is mountainous, with beautiful Alpine roads that are perfect for training. Cycling is one of the most popular sports in the country, and the success of Pogacar and his compatriot Primoz Roglic — who has also won major races — has turned cycling into a national obsession.\n\nPogacar grew up in the small town of Komenda, population 6,000. He started cycling at the age of eight, riding with his father on the roads around their home. By 15, he was winning junior races. By 21, he had won the Tour de France for the first time — one of the youngest winners in the race's history. His rise was so rapid that many people in the cycling world simply could not believe what they were seeing.\n\nSmall countries producing world-class athletes is not unusual — Jamaica dominates sprinting, New Zealand excels at rugby, and Iceland has produced world-class footballers despite having fewer people than most cities. But there is something particularly inspiring about a champion who comes from nowhere — who grows up in a town that most people have never heard of and becomes the best in the world at what he does. It is a reminder that talent does not care about geography, population, or wealth.`,
    vocab: [
      { word: 'Compatriot', definition: 'A person from the same country as you.' },
      { word: 'Obsession', definition: 'Something that you think about all the time — an intense, overwhelming interest.' },
      { word: 'Dominates', definition: 'Is clearly the best or most powerful — controls a sport or competition.' },
      { word: 'Geography', definition: 'The physical features of a place — mountains, rivers, climate — or the study of these features.' },
    ],
    questions: [
      { n: 7, q: 'Slovenia has two million people but produced the best cyclist in the world. What advantages might small countries have in developing elite athletes?' },
      { n: 8, q: 'Pogacar started cycling at 8 and won the Tour de France at 21. At what age should children start specialising in a sport? Is there a danger in starting too young?' },
      { n: 9, q: 'Jamaica dominates sprinting, New Zealand dominates rugby. Does your country dominate any sport? Why do you think certain sports become popular in certain countries?' },
    ]
  },
  {
    number: 4, title: 'Why We Watch Sport', emoji: '🏆', color: '#7f1d1d',
    text: `Pogacar's fifth Tour de France victory was watched by millions of people around the world. Cycling fans lined the roads across France, filled cafes to watch on television, and flooded social media with celebrations. But why? Why do millions of people care so much about watching someone ride a bicycle very fast?\n\nThe answer lies in what sport represents. At its best, sport is a story — a narrative of struggle, sacrifice, talent, and triumph that plays out in real time with no guaranteed outcome. Unlike a film or a book, where the ending has already been written, sport is unpredictable. Anything can happen. The favourite can crash. The underdog can win. A moment of brilliance can change everything. This uncertainty is what makes sport so exciting — and so emotionally powerful.\n\nSport also provides something that modern life often lacks: clarity. In the real world, success and failure are complicated. Hard work does not always lead to reward. The best person does not always win. But in sport, the rules are clear, the competition is fair (ideally), and the result is definitive. First place is first place. There is no ambiguity. In a world full of complexity, the simplicity of sport is deeply satisfying.\n\nFinally, sport connects people. When Pogacar crossed the finish line in Paris, two million Slovenians celebrated together. Strangers hugged in cafes. Children who had never ridden a bicycle asked their parents for one. Sport creates shared experiences and shared emotions that cut across age, class, language, and culture. In a world that often feels divided, those moments of connection are precious.\n\nPogacar will try to break the record next year — a sixth Tour de France victory that nobody has ever achieved. Whether he succeeds or fails, millions of people will be watching. And that, in the end, is why sport matters.`,
    vocab: [
      { word: 'Narrative', definition: 'A story — the way events are told, with a beginning, middle, and end.' },
      { word: 'Underdog', definition: 'A person or team that is not expected to win — the weaker competitor.' },
      { word: 'Definitive', definition: 'Final and certain — leaving no doubt or room for argument.' },
      { word: 'Precious', definition: 'Extremely valuable — something that is rare and should be treasured.' },
    ],
    questions: [
      { n: 10, q: 'The passage says sport provides clarity in a complex world. Do you agree? Is the simplicity of sport part of its appeal?' },
      { n: 11, q: 'When Pogacar won, two million Slovenians celebrated together. Can you think of a sporting moment that united your country? What happened?' },
      { n: 12, q: 'Pogacar will try for a record 6th Tour de France next year. Do you think he will do it? What makes a truly great athlete?' },
    ]
  },
]
...
export default function PogacarPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Pogacar Wins Record 5th Tour de France</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Tadej Pogacar from tiny Slovenia won cycling's biggest race for the 5th time, tying the all-time record. The hardest race in the world and why we love watching sport.</p>
            </div>
          </div>
