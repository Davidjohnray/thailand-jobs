...
const PARTS = [
  {
    number: 1, title: 'What Is a Volcano?', emoji: '🌋', color: '#ef4444',
    text: `A volcano is an opening in the Earth's surface through which hot melted rock, ash, and gas can escape from deep underground. Volcanoes can look like mountains — and many of the world's most famous mountains are actually volcanoes. Mount Fuji in Japan, Mount Kilimanjaro in Africa, and Mount Rainier in the United States are all volcanoes.\n\nDeep beneath the Earth's surface, the rock is so incredibly hot that it melts and becomes liquid. This liquid rock underground is called magma. When magma pushes up through cracks in the Earth's surface and comes out, it is called lava. Lava can be as hot as 1,200 degrees Celsius — that is hot enough to melt metal!\n\nThe Earth's outer shell is made up of huge pieces called tectonic plates, which fit together like a giant jigsaw puzzle. These plates are constantly moving — very slowly, just a few centimetres every year. Most volcanoes are found where two tectonic plates meet. When plates pull apart or push into each other, magma can find a way to the surface and a volcano is born.\n\nThere is a famous region called the "Ring of Fire" — a huge circle around the Pacific Ocean where most of the world's volcanoes are found. Countries like Japan, the Philippines, Indonesia, and parts of the United States all sit on the Ring of Fire. Indonesia alone has more than 130 active volcanoes — more than any other country in the world. Thailand is fortunate — it sits just outside the Ring of Fire and has no active volcanoes.`,
    vocab: [
      { word: 'Magma', definition: 'Hot melted rock that is found deep underground inside the Earth.' },
      { word: 'Lava', definition: 'Hot melted rock that comes out of a volcano onto the Earth\'s surface.' },
      { word: 'Tectonic plates', definition: 'The huge pieces that make up the Earth\'s outer shell, which slowly move over time.' },
      { word: 'Active', definition: 'A volcano that has erupted recently or could erupt again in the future.' },
    ],
    questions: [
      { n: 1, q: 'Did you know that many famous mountains are actually volcanoes? Does this surprise you?' },
      { n: 2, q: 'Lava can reach 1,200 degrees Celsius. Can you think of anything that happens at very high temperatures in everyday life?' },
      { n: 3, q: 'Indonesia has more than 130 active volcanoes. Would you want to live in a country with so many volcanoes? Why or why not?' },
    ]
  },
  {
    number: 2, title: 'How Does a Volcano Erupt?', emoji: '💥', color: '#dc2626',
    text: `A volcanic eruption happens when pressure builds up inside a volcano and magma is forced up to the surface. Think of it like shaking a bottle of fizzy drink — if you open the lid suddenly, the pressure inside makes everything explode upwards.\n\nDeep underground, magma collects in a large underground space called a magma chamber. As more and more magma collects, the pressure increases. When the pressure becomes too great, the magma forces its way up through a long tube called a volcanic vent and bursts out of the top of the volcano. The opening at the top is called the crater.\n\nNot all volcanic eruptions look the same. Some volcanoes erupt explosively — shooting ash, gas, and rocks high into the sky. The ash can travel thousands of kilometres and block out sunlight. Other volcanoes have calmer eruptions — the lava flows slowly down the sides of the mountain like a very thick, glowing river. Hawaii is famous for these lava flow eruptions, which are much less dangerous than explosive ones.\n\nVolcanic eruptions also produce pyroclastic flows — fast-moving clouds of very hot gas, ash, and rock that rush down the side of the volcano at speeds of up to 700 kilometres per hour. Pyroclastic flows are the most dangerous part of a volcanic eruption. They can destroy everything in their path and travel so fast that it is almost impossible to escape them.\n\nScientists who study volcanoes are called volcanologists. They use special equipment to monitor volcanoes and try to predict when they might erupt, which helps to save lives by warning people to evacuate.`,
    vocab: [
      { word: 'Pressure', definition: 'The force that pushes against something from inside — like the pressure inside a balloon.' },
      { word: 'Crater', definition: 'The opening at the top of a volcano where lava and ash come out.' },
      { word: 'Pyroclastic flow', definition: 'A fast-moving, extremely hot cloud of gas, ash and rock that rushes down a volcano.' },
      { word: 'Evacuate', definition: 'To leave a dangerous area quickly and move to a safer place.' },
    ],
    questions: [
      { n: 4, q: 'The passage compares a volcano to a shaken fizzy drink. Can you think of another good comparison that explains how pressure builds up?' },
      { n: 5, q: 'Pyroclastic flows travel at 700 kilometres per hour. To understand how fast that is — a car on a motorway travels at about 110 km/h. Does this change how you think about volcanic eruptions?' },
      { n: 6, q: 'Would you like to be a volcanologist? What do you think would be exciting — and scary — about the job?' },
    ]
  },
  {
    number: 3, title: 'Famous Eruptions in History', emoji: '📜', color: '#b91c1c',
    text: `Some volcanic eruptions have been so powerful that they changed history. One of the most famous is the eruption of Mount Vesuvius in Italy in 79 CE. The Roman city of Pompeii was buried under nearly six metres of ash and rock in just a few hours. Around 2,000 people died. The ash preserved everything so perfectly that when archaeologists began excavating the site in the 1700s, they found buildings, furniture, paintings, and even the shapes of people and animals exactly as they were on the day of the eruption.\n\nIn 1815, a volcano called Tambora on the island of Sumbawa in Indonesia had one of the most powerful eruptions in recorded history. It was so enormous that it threw so much ash and gas into the atmosphere that it blocked sunlight around the entire world. The following year — 1816 — became known as the "Year Without a Summer." Crops failed across Europe and North America because temperatures were too cold. Thousands of people died from famine.\n\nIn 1883, the island of Krakatoa in Indonesia was almost completely destroyed by a massive eruption. The explosion was so loud that it was heard nearly 5,000 kilometres away — that would be like hearing an explosion in Bangkok and the sound reaching all the way to Australia. The eruption caused a tsunami that killed more than 36,000 people.\n\nMore recently, in 1980, Mount St. Helens in the United States erupted and blew off the entire top of the mountain in seconds. The eruption was caught on camera and the footage showed the incredible power of nature. Today, Mount St. Helens is a popular tourist destination — nature has slowly begun to recover, and it is a fascinating example of how landscapes can be destroyed and then rebuilt by volcanic activity.`,
    vocab: [
      { word: 'Archaeologists', definition: 'Scientists who study history by digging up and examining objects left behind by people who lived long ago.' },
      { word: 'Excavating', definition: 'Carefully digging up objects buried in the ground to study them.' },
      { word: 'Famine', definition: 'A period when there is not enough food for people to eat, causing many to go hungry or die.' },
      { word: 'Tsunami', definition: 'A very large and powerful wave caused by an earthquake or volcanic eruption under the ocean.' },
    ],
    questions: [
      { n: 7, q: 'The eruption of Tambora caused a "Year Without a Summer" around the world. What do you think life was like for ordinary people in 1816?' },
      { n: 8, q: 'The city of Pompeii was preserved perfectly under ash. Do you think this is lucky or unlucky? What can we learn from it?' },
      { n: 9, q: 'Which of these four eruptions do you find most fascinating — Vesuvius, Tambora, Krakatoa, or Mount St. Helens? Why?' },
    ]
  },
  {
    number: 4, title: 'Volcanoes and Life', emoji: '🌱', color: '#991b1b',
    text: `Volcanoes might seem like only destructive forces, but they also play a very important role in creating and supporting life on Earth. Without volcanoes, our planet might look very different — and life as we know it might not exist at all.\n\nMillions of years ago, when Earth was young, volcanic eruptions released enormous amounts of gas into the atmosphere. Scientists believe that these gases helped to form Earth's early atmosphere and oceans. Some researchers even think that volcanic activity may have helped to create the first chemical building blocks of life.\n\nVolcanic soil is some of the most fertile in the world. When lava cools and breaks down over many years, it becomes rich in minerals that plants love. This is why many people choose to live near volcanoes even though they know the danger. The slopes of Mount Etna in Sicily, Italy, and the slopes of volcanoes in Java, Indonesia, are covered in farms and vineyards producing delicious food. Farmers know that the volcanic soil gives their crops extra nutrition.\n\nVolcanic activity also creates some of the most beautiful landscapes on Earth. The Hawaiian islands were formed entirely by underwater volcanic eruptions over millions of years. The dramatic black rock coastlines, the spectacular waterfalls, and the unique wildlife of Iceland are all the result of volcanic activity.\n\nToday, scientists are studying how to use geothermal energy — heat from inside the Earth — as a clean source of power. Iceland already produces most of its electricity from geothermal energy. As the world looks for cleaner ways to produce power, the heat from inside the Earth — the same heat that powers volcanoes — could become increasingly important.\n\nVolcanoes remind us that the Earth is a living, powerful, and constantly changing planet. They are terrifying and beautiful at the same time — one of nature's most spectacular and important forces.`,
    vocab: [
      { word: 'Fertile', definition: 'Soil that is fertile is very good for growing plants and crops.' },
      { word: 'Minerals', definition: 'Natural substances found in the Earth that plants and animals need to be healthy.' },
      { word: 'Geothermal', definition: 'Using heat from inside the Earth to create energy or warmth.' },
      { word: 'Spectacular', definition: 'Very impressive and exciting to look at.' },
    ],
    questions: [
      { n: 10, q: 'Many farmers choose to live near dangerous volcanoes because the soil is so good. Would you make the same choice? Why or why not?' },
      { n: 11, q: 'Iceland uses geothermal energy from volcanoes to produce electricity. Do you think more countries should develop this kind of clean energy?' },
      { n: 12, q: 'The passage says volcanoes are "terrifying and beautiful at the same time." Can you think of other things in nature that feel both dangerous and beautiful?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly and enthusiastic English conversation partner helping a B1 level student aged 10-12 practise English discussion skills. The reading topic is "Volcanoes — Mountains That Explode". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear, exciting language for a young learner. Be enthusiastic and show genuine interest in volcanoes and science! Always end with one fun follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#fff7f7', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #fecaca' }}>💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your full answer, then tap <strong>⏹ Stop & Send</strong>.</div>}
      {messages.length > 0 && (
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && <div style={{ background: '#fff7f7', border: '1px solid #fecaca', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}><span style={{ color: color, fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>🌍 Translation</span>{m.translation}</div>}
              </div>
            </div>
          ))}
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid #fecaca', display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
...
export default function VolcanoesPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1c0505 0%, #7f1d1d 50%, #b91c1c 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#ef4444', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(239,68,68,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Science & Space</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Volcanoes — Mountains That Explode</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>How do volcanoes work? What caused the eruptions that buried cities and changed the climate of the whole world? And why do people choose to live next to them?</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#ef4444' : '#e5e7eb', background: speed === s.value ? '#ef4444' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#fff7f7', padding: '8px 28px', borderBottom: '1px solid #fecaca' }}>
              <span style={{ color: '#991b1b', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#ef4444' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#fff7f7', border: '1px solid #fecaca', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#991b1b', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(239,68,68,0.15)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#fca5a5', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b1" style={{ color: '#ef4444', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B1 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fecaca', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fff7f7', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fecaca', color: '#9ca3af', fontSize: '15px' }}>{translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}</div>
            ) : (
