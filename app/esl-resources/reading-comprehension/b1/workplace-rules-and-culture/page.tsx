...
const PARTS = [
  {
    number: 1, title: 'The Rules Nobody Tells You', emoji: '🏢', color: '#f59e0b',
    text: `Every workplace has two sets of rules. The first set is written down — in your contract, in the employee handbook, on signs on the wall. Do not smoke inside. Lunch is from 12 to 1. Report all accidents to your manager. These rules are clear, official, and easy to follow.\n\nThe second set of rules is unwritten — and these are often far more important. Nobody tells you these rules directly. You learn them by watching, listening, and sometimes by making mistakes. They include things like: which chair in the meeting room belongs to the boss. Whether it is acceptable to eat at your desk. Whether people actually leave on time or stay late to show dedication. Whether the dress code that says "smart casual" really means smart casual, or whether everyone actually wears formal clothes.\n\nThese unwritten rules make up what is often called "workplace culture" — the shared habits, values, expectations, and behaviours that define how things are really done in a particular company. Two companies in the same industry, in the same city, can have completely different workplace cultures. One might be relaxed, informal, and flexible. The other might be formal, hierarchical, and strict. Neither is necessarily better — but understanding the culture you are working in is essential for fitting in and being effective.\n\nWorkplace culture is particularly challenging for people who are new to a country or working in a foreign language. The unwritten rules of a Thai workplace may be very different from the unwritten rules of a British, Japanese, or American workplace. What is considered polite in one culture may be considered rude in another. What is seen as showing initiative in one workplace may be seen as overstepping your role in another.`,
    vocab: [
      { word: 'Employee handbook', definition: 'A document given to new employees that explains company rules, policies, and procedures.' },
      { word: 'Dedication', definition: 'The quality of working hard and giving a lot of time and energy to something.' },
      { word: 'Smart casual', definition: 'A dress code that is neat and professional but not as formal as a suit and tie.' },
      { word: 'Initiative', definition: 'The ability to decide what to do and take action without being told — showing independence.' },
    ],
    questions: [
      { n: 1, q: 'Can you think of an unwritten rule at a workplace or school you have been in? How did you learn it?' },
      { n: 2, q: 'The passage says two companies in the same city can have completely different cultures. Why do you think this happens?' },
      { n: 3, q: 'What unwritten rules might be different between a Thai workplace and a Western workplace? Can you give examples?' },
    ]
  },
  {
    number: 2, title: 'Time, Punctuality and Presence', emoji: '⏰', color: '#d97706',
    text: `Attitudes to time vary enormously between workplaces and cultures, and getting this wrong can cause serious problems. In some workplaces, arriving five minutes late is barely noticed. In others, it is considered disrespectful and unprofessional. Understanding how your workplace treats time is one of the first things you should learn.\n\nIn many Western workplaces, punctuality is taken very seriously. Arriving on time means arriving a few minutes early. Being late to a meeting — even by two or three minutes — is noticed and remembered. Deadlines are treated as firm commitments, and missing one without advance warning is a serious issue. The underlying message is: your time is valuable, and so is mine.\n\nIn some Asian workplaces, including many in Thailand, the relationship with time can be different. While punctuality is still important, there may be more flexibility around exact start times, and meetings may start a few minutes after the scheduled time. However, this does not mean time does not matter — it means the culture expresses respect differently, often through other behaviours like staying late or being available outside normal hours.\n\nThe concept of "presenteeism" — being physically present at work even when there is nothing productive to do — is common in many countries. In Japan and South Korea, employees often stay at their desks long after their work is finished because leaving before the boss is seen as a sign of disloyalty. In contrast, many Northern European workplaces actively encourage employees to leave on time, viewing long hours as a sign of inefficiency rather than dedication.\n\nThe key is to observe what the people around you actually do — not what the official policy says. If the handbook says working hours are 9 to 5 but everyone arrives at 8:30 and leaves at 6, the real expectation is 8:30 to 6. Adapting to the real culture, not the written one, is how you succeed.`,
    vocab: [
      { word: 'Punctuality', definition: 'The quality of always being on time — arriving when you are expected to arrive.' },
      { word: 'Presenteeism', definition: 'Being at work even when you have nothing to do or are too ill to be productive.' },
      { word: 'Disloyalty', definition: 'Not being faithful or committed to a person, company, or group.' },
      { word: 'Inefficiency', definition: 'Wasting time, energy, or resources — not working in the best possible way.' },
    ],
    questions: [
      { n: 4, q: 'In some cultures, leaving before the boss is seen as disloyal. In others, staying late means you are inefficient. Which view do you agree with?' },
      { n: 5, q: 'The passage says to observe what people actually do, not what the policy says. Can you think of examples where the real rules differ from the written rules?' },
      { n: 6, q: 'How important is punctuality in your culture? Is being five minutes late acceptable, or is it a problem?' },
    ]
  },
  {
    number: 3, title: 'Communication and Hierarchy', emoji: '💬', color: '#b45309',
    text: `How people communicate at work — who speaks to whom, how directly, and through which channels — is one of the strongest markers of workplace culture.\n\nIn flat, informal workplaces — common in Scandinavian countries, many tech companies, and some start-ups — everyone is on first-name terms, including the CEO. Junior employees are expected to speak up in meetings, challenge ideas, and communicate directly with senior leaders. Email tone is casual and friendly. The underlying philosophy is that good ideas can come from anyone, regardless of their position.\n\nIn more hierarchical workplaces — common in many Asian countries, traditional corporations, and government organisations — communication follows a clear chain of command. You report to your direct manager, who reports to their manager, and so on. Speaking directly to a senior leader without going through the proper channels may be seen as disrespectful or inappropriate. Formality in language and behaviour is expected, particularly when addressing people who are senior to you.\n\nIn Thailand, workplace hierarchy is strongly influenced by concepts of seniority and respect. The use of "P" before the name of an older colleague, the wai greeting, and the practice of avoiding direct confrontation or public disagreement with a superior are all expressions of a hierarchical culture that values harmony, respect, and social order.\n\nNeither flat nor hierarchical cultures are inherently better — they simply work differently. Problems arise when people from one culture try to work in another without understanding the expectations. A Western employee who speaks bluntly to a Thai manager may cause offence without realising it. A Thai employee in a Swedish company may wait to be asked for their opinion rather than volunteering it, and be perceived as lacking initiative. Cultural awareness — understanding that your way is not the only way — is the foundation of effective cross-cultural communication.`,
    vocab: [
      { word: 'Hierarchy', definition: 'A system where people are ranked by authority or importance — with clear levels of seniority.' },
      { word: 'Chain of command', definition: 'The official order of authority in an organisation — who reports to whom.' },
      { word: 'Confrontation', definition: 'A direct, often aggressive disagreement or argument between people.' },
      { word: 'Cross-cultural', definition: 'Involving or relating to two or more different cultures and how they interact.' },
    ],
    questions: [
      { n: 7, q: 'Would you prefer to work in a flat culture where everyone is equal, or a hierarchical culture with clear levels? Why?' },
      { n: 8, q: 'In Thailand, directly disagreeing with your boss is often avoided. What are the advantages and disadvantages of this approach?' },
      { n: 9, q: 'A Western employee speaks bluntly to a Thai manager. How could this situation be handled better by both sides?' },
    ]
  },
  {
    number: 4, title: 'Fitting In Without Losing Yourself', emoji: '🧭', color: '#92400e',
    text: `Understanding workplace culture and adapting to it is important — but there is a difference between adapting and losing yourself. Every employee faces the challenge of fitting in while remaining true to their own values, personality, and working style.\n\nSome workplace cultures are healthy and supportive. They value diversity, encourage open communication, respect work-life balance, and treat employees fairly. Adapting to a healthy culture usually feels natural and positive — you are adjusting your style to work better with others, not compromising who you are.\n\nOther workplace cultures are toxic. They may involve bullying, unreasonable expectations, discrimination, or pressure to behave in ways that conflict with your values. In these environments, "fitting in" means accepting behaviour that is harmful — and that is not adaptation, it is self-harm. Recognising the difference between a culture that is simply different from what you are used to and a culture that is genuinely harmful is an important skill.\n\nSigns of a toxic workplace culture include: managers who shout at employees, colleagues who take credit for your work, expectations to work unpaid overtime regularly, punishment for taking sick leave, gossip and backstabbing, and discrimination based on gender, age, nationality, or appearance. If you experience these behaviours consistently, the problem is the culture — not you.\n\nThe healthiest approach to workplace culture is what psychologists call "adaptive authenticity" — adjusting your behaviour to work effectively within the culture while maintaining your core values and identity. You can be polite without being submissive. You can be respectful without accepting disrespect. You can adapt your communication style without silencing your voice. The goal is not to become someone else — it is to become the best version of yourself within the context you are working in.`,
    vocab: [
      { word: 'Toxic', definition: 'Harmful, unpleasant, and damaging — a workplace that makes people feel bad.' },
      { word: 'Discrimination', definition: 'Treating people unfairly because of their gender, race, age, religion, or other characteristics.' },
      { word: 'Backstabbing', definition: 'Saying harmful things about someone behind their back while pretending to be friendly to their face.' },
      { word: 'Adaptive authenticity', definition: 'Adjusting your behaviour to fit a situation while staying true to your real values and personality.' },
    ],
    questions: [
      { n: 10, q: 'What is the difference between adapting to a culture and losing yourself? Can you give an example?' },
      { n: 11, q: 'The passage lists signs of a toxic workplace. Have you ever experienced or heard about any of these? What should someone do in that situation?' },
      { n: 12, q: 'Adaptive authenticity means adjusting your style while keeping your values. Is this easy or difficult? How do you know when you have crossed the line?' },
    ]
  },
]
...
export default function WorkplaceRulesPage() {
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(99,102,241,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Business English</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Workplace Rules and Culture</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Dress codes, punctuality, hierarchy, and the unwritten rules that nobody tells you about — how to understand workplace culture and fit in without losing yourself.</p>
            </div>
          </div>
