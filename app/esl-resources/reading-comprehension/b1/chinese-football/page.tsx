...
const PARTS = [
  {
    number: 1, title: 'The Big Spending Era', emoji: '💰', color: '#ef4444',
    text: `For most of its history, Chinese football was not well known outside Asia. The Chinese Super League — the top division of professional football in China — had existed since 2004, but it struggled to attract attention on the world stage. All of this changed dramatically in the mid-2010s when Chinese club owners, many of them backed by large state-owned companies or wealthy private investors, began spending enormous amounts of money on foreign players and coaches.\n\nBetween 2015 and 2018, Chinese clubs broke transfer records that shocked the football world. In January 2017, the club Shanghai SIPG paid around £60 million for Brazilian attacking midfielder Oscar from Chelsea — one of the most expensive transfers in history at the time. Just weeks earlier, the same club had signed Hulk, another Brazilian international, for a similarly huge fee. Clubs such as Jiangsu Suning, Guangzhou Evergrande, and Beijing Guoan also brought in big names from European leagues, offering wages that even the richest clubs in England, Spain, and Italy found difficult to match. At its peak, the Chinese Super League was spending more money on transfers than any other league in the world — more than the Premier League, more than La Liga, more than the Bundesliga.`,
    vocab: [
      { word: 'Transfer', definition: 'When a football player moves from one club to another, usually for a fee paid between the clubs.' },
      { word: 'Investor', definition: 'A person or organisation that puts money into a business or project in order to make a profit.' },
      { word: 'Division', definition: 'A level or group within a football league system — the top division contains the best clubs.' },
      { word: 'Wages', definition: 'The money paid regularly to an employee for their work — in football, this is a player\'s weekly salary.' },
    ],
    questions: [
      { n: 1, q: 'Why do you think Chinese clubs were willing to pay such enormous fees and wages to attract foreign players? What were they hoping to achieve?' },
      { n: 2, q: 'Is it surprising that Chinese clubs were spending more on transfers than European leagues at their peak? What does this tell us about money in modern football?' },
      { n: 3, q: 'If you were the owner of a football club with unlimited money, what kind of players would you sign and why?' },
    ]
  },
  {
    number: 2, title: 'The Dream and the Reality', emoji: '⚽', color: '#f59e0b',
    text: `The spending boom was not just about entertainment. Behind it was a much bigger ambition — China's president Xi Jinping was known to be a football fan, and he had stated publicly that he wanted China to qualify for, host, and one day win the FIFA World Cup. Football was seen as a symbol of national pride and international prestige, and developing the sport was made an official government priority. Hundreds of new football schools were built across the country. Foreign coaches were brought in to train young Chinese players. The government set a target of building 70,000 football pitches across China by 2025.\n\nHowever, the reality on the pitch did not match the ambition off it. While Chinese clubs were buying the world's best players, the Chinese national team continued to struggle badly. The national team has only ever qualified for one FIFA World Cup — in 2002 — and they were knocked out in the group stage without scoring a single goal. Despite all the investment in the domestic league, the quality of Chinese players did not improve fast enough. Critics argued that filling the league with expensive foreign stars actually made things worse — Chinese players had fewer opportunities to play, develop their skills, and gain experience.`,
    vocab: [
      { word: 'Prestige', definition: 'Widespread respect and admiration that comes from being successful, important, or famous.' },
      { word: 'Domestic', definition: 'Relating to your own country — a domestic league is one played within that country, not internationally.' },
      { word: 'Group stage', definition: 'The first round of a tournament where teams play in small groups — only the top teams move forward.' },
      { word: 'Critics', definition: 'People who express disapproval or point out problems with something — those who criticise a plan or idea.' },
    ],
    questions: [
      { n: 4, q: 'Do you think it is possible for a country to improve its national football team simply by spending money? What else might be needed?' },
      { n: 5, q: 'Some people say that having too many foreign players in a league is bad for the national team. Do you agree? Can you think of any examples from other countries?' },
      { n: 6, q: 'Why do you think governments sometimes invest in sport? What benefits can a strong national football team bring to a country?' },
    ]
  },
  {
    number: 3, title: 'The Collapse of the Spending Era', emoji: '📉', color: '#8b5cf6',
    text: `By the early 2020s, the era of big spending in Chinese football had come to a sudden and dramatic end. Several of the clubs that had led the spending boom ran into serious financial difficulties. Jiangsu Suning — who had just won the Chinese Super League title in 2020 — announced in February 2021 that they were disbanding the club entirely due to financial problems at their parent company. Guangzhou FC (formerly Guangzhou Evergrande) fell into deep debt and were eventually relegated from the top division. Players and staff went unpaid for months at several clubs across the league.\n\nThe Chinese football authorities introduced new rules to try to control spending. Salary caps were introduced to limit how much clubs could pay their players. Foreign player quotas were tightened, reducing the number of overseas players allowed in each team. The transfer window became much quieter as clubs lost their financial backing. Several high-profile foreign players quietly left the league as their contracts ended, returning to Europe or moving elsewhere. The Chinese Super League, which had briefly been the richest league in the world, became a much smaller and more cautious competition almost overnight. It was a sharp and painful lesson in the dangers of building a football league on borrowed money and unsustainable investment.`,
    vocab: [
      { word: 'Disbanding', definition: 'Officially closing or breaking up an organisation or team so that it no longer exists.' },
      { word: 'Relegated', definition: 'Moved down to a lower division of a football league because of poor results — the opposite of promoted.' },
      { word: 'Salary cap', definition: 'A rule that limits the maximum amount of money a club is allowed to pay its players.' },
      { word: 'Unsustainable', definition: 'Something that cannot continue at the same level for a long time — too extreme or expensive to keep going.' },
    ],
    questions: [
      { n: 7, q: 'Why do you think clubs continued to spend so much money even when it was clear this might not be financially safe? What pressures might they have been under?' },
      { n: 8, q: 'Do you think salary caps are a good idea in football? What are the advantages and disadvantages of limiting how much clubs can spend?' },
      { n: 9, q: 'The Chinese Super League went from the richest league in the world to a much smaller competition in just a few years. What lessons can other countries learn from this?' },
    ]
  },
  {
    number: 4, title: 'The Chinese National Team Today', emoji: '🇨🇳', color: '#0ea5e9',
    text: `Today, China's national football team remains one of the most underperforming teams in the world relative to the size of the country. With a population of over 1.4 billion people, China is the most populous nation on earth, yet the national team regularly struggles to qualify for major tournaments. In the 2026 World Cup qualification campaign, China found themselves in a difficult group alongside Japan, Australia, Saudi Arabia, and Bahrain — and qualification looked extremely unlikely for most of the campaign.\n\nThe gap between China and the leading Asian football nations — Japan, South Korea, and increasingly Australia — remains large. Japan in particular has developed a very different model, focusing on youth development, technical coaching, and sending players to compete in top European leagues. Many Japanese players now play regularly in the Premier League, the Bundesliga, and Serie A. Chinese players, by contrast, rarely make the move to top European football. The future of Chinese football now depends less on spending money on foreign stars and more on the difficult, slow work of building a proper grassroots system — good coaches, good facilities, and a culture where football is played and loved from a young age. That transformation, if it happens at all, will take a generation.`,
    vocab: [
      { word: 'Underperforming', definition: 'Doing worse than expected given your resources, size, or potential — not reaching the level you should.' },
      { word: 'Qualification campaign', definition: 'A series of matches that a national team must play in order to earn a place at a major tournament.' },
      { word: 'Grassroots', definition: 'The most basic, local level of something — grassroots football means the game played by ordinary people and young children, not professionals.' },
      { word: 'Generation', definition: 'All the people born and living at around the same time — roughly a period of 20 to 30 years.' },
    ],
    questions: [
      { n: 10, q: 'Why do you think Japan has been so much more successful than China in developing its national football team, despite being a much smaller country?' },
      { n: 11, q: 'What do you think is more important for developing a strong national team — spending money on foreign players in the domestic league, or sending young players abroad to improve? Give reasons.' },
      { n: 12, q: 'Overall, do you think Chinese football has a bright future? What would need to change for China to become a genuine football power in the next 20 or 30 years?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise discussion skills. The reading topic is "Chinese Football — The Big Spending Era and the National Team Today". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear English suitable for B1 level. Always end with one natural follow-up question. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
    ...
    <div style={{ marginTop: '10px', background: '#f8faff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && (
        <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #eee' }}>
          💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your answer, then tap <strong>⏹ Stop & Send</strong>.
        </div>
      )}
      {messages.length > 0 && (
        ...
        <div style={{ padding: '10px 16px 14px', borderTop: '1px solid #fee2e2', background: '#fef2f2' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{ color: '#ef4444', fontSize: '12px', fontWeight: '700' }}>Recording...</span>
            </div>
...
export default function ChineseFootballPage() {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          ...
          body: JSON.stringify({
            system: isPhrase
              ? `You are an English dictionary for B1 learners. Respond with ONLY one simple sentence (max 20 words) explaining what the phrase means. No extra text.`
              : `You are an English dictionary for B1 learners. Respond with ONLY one simple sentence (max 15 words) defining this word. No extra text.`,
        ...
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: `You are a language learning assistant for B1 English students. Respond ONLY with valid JSON (no markdown, no backticks): {"definition": "one simple English sentence max 15 words", "translation": "the word/phrase in ${translationLang} with a brief explanation in ${translationLang}, max 25 words"}`,
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #991b1b 0%, #ef4444 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#991b1b', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(255,255,255,0.25)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Sport & Society</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Chinese Football — Big Spending, Big Dreams, Big Problems</h1>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From the most expensive league in the world to financial collapse — explore the rise and fall of Chinese football spending and the challenges facing the national team today.</p>
            </div>
          </div>
      ...
      <section style={{ background: 'white', borderBottom: '1px solid #eee', padding: '14px 24px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '10px' }}>
            ...
            {['🔊 Play passage aloud', '✍️ Highlight any text for lookup', '🌍 Translate vocab & questions', '🤖 Practice with AI'].map((step, i) => (
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)}
                  style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#ef4444' : '#e5e7eb', background: speed === s.value ? '#ef4444' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer' }}>
                  {s.label}
                </button>
              ))}
            </div>
        ...
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#fef2f2', padding: '8px 28px', borderBottom: '1px solid #fecaca' }}>
              <span style={{ color: '#991b1b', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to look it up{translationLang !== 'none' && <span style={{ color: '#ef4444' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                          ...
                          {translationLang === 'none' && <span style={{ color: '#4b5563', fontSize: '11px' }}>← select a language</span>}
                        </div>
      ...
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fecaca', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fef2f2', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fecaca', color: '#9ca3af', fontSize: '15px' }}>Looking up...</div>
            ) : (
