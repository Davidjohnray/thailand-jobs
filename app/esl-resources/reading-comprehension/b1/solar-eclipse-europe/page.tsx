...
const PARTS = [
  {
    number: 1, title: 'The Sun Will Disappear', emoji: '🌑', color: '#dc2626',
    text: `On 12 August 2026 — just one week from now — something spectacular will happen in the skies over Europe. The Moon will pass directly in front of the Sun, blocking out its light and turning day into night for a few extraordinary minutes. It will be the first total solar eclipse visible from mainland Europe since 1999, and millions of people are already planning where and how to watch it.\n\nThe path of totality — the narrow strip of land where the Sun will be completely blocked — will cross Greenland, Iceland, and northern Spain, including cities like Bilbao, Zaragoza, and Palma de Mallorca. In these places, the sky will go dark in the middle of the day, the temperature will drop, stars will become visible, and the Sun's glowing atmosphere — called the corona — will appear as a ring of white fire around the dark circle of the Moon. The experience lasts only a few minutes, but people who have seen a total eclipse describe it as one of the most awe-inspiring experiences of their lives.\n\nOutside the path of totality, people across most of Europe will see a partial eclipse — where part of the Sun is covered but not all of it. In the UK and Ireland, up to 96% of the Sun will be hidden. In France, Belgium, and Switzerland, around 90% will be covered. Even a partial eclipse is impressive — the light becomes strangely dim, shadows look different, and the air feels cooler.\n\nThe eclipse will happen in the evening, with the Sun low on the horizon — making it even more dramatic. And as if that were not enough, the Perseid meteor shower will light up the night sky on the same night. It is going to be an extraordinary day for anyone who loves looking up.`,
    vocab: [
      { word: 'Eclipse', definition: 'When one object in space moves in front of another and blocks its light — the Moon blocking the Sun.' },
      { word: 'Path of totality', definition: 'The narrow strip on Earth where the Sun is completely blocked during a total solar eclipse.' },
      { word: 'Corona', definition: 'The outer atmosphere of the Sun, visible as a glowing ring during a total eclipse.' },
      { word: 'Awe-inspiring', definition: 'Something that fills you with wonder and amazement — so impressive it takes your breath away.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever seen a solar eclipse — even a partial one? What was it like? If not, would you like to?' },
      { n: 2, q: 'People describe total eclipses as one of the most amazing experiences of their lives. Why do you think watching something in the sky affects people so deeply?' },
      { n: 3, q: 'The eclipse will be visible across most of Europe. If you could travel anywhere to watch it, where would you go?' },
    ]
  },
  {
    number: 2, title: 'How Eclipses Work', emoji: '🌍', color: '#b91c1c',
    text: `A solar eclipse happens when the Moon passes between the Earth and the Sun, casting a shadow on the Earth's surface. This sounds simple, but it requires an extraordinary coincidence of size and distance that is unique in our solar system.\n\nThe Sun is about 400 times wider than the Moon. But by a remarkable coincidence, the Sun is also about 400 times farther away from Earth than the Moon is. This means that from our perspective on Earth, the Sun and the Moon appear to be almost exactly the same size in the sky. When the Moon passes in front of the Sun, it can cover it almost perfectly — creating the dramatic effect of a total eclipse.\n\nThis coincidence will not last forever. The Moon is slowly moving away from the Earth — about 3.8 centimetres per year. In about 600 million years, the Moon will be too far away to completely cover the Sun, and total solar eclipses will no longer be possible. We are living in the only period of Earth's history when total eclipses happen. Future generations — if they exist — will never see what we can see.\n\nTotal eclipses do not happen very often in any one place. Although there are usually two solar eclipses somewhere on Earth each year, the path of totality is very narrow — typically only about 100 to 250 kilometres wide. Any particular spot on Earth experiences a total eclipse only about once every 375 years on average. This rarity is part of what makes eclipses so special — for most people, seeing one requires travelling to the right place at the right time.`,
    vocab: [
      { word: 'Coincidence', definition: 'When two things happen together by chance in a way that seems surprising or unlikely.' },
      { word: 'Perspective', definition: 'The way things appear from a particular position — how something looks from where you are standing.' },
      { word: 'Rarity', definition: 'The quality of being very uncommon or unusual — something that does not happen often.' },
      { word: 'Centimetres', definition: 'A unit of measurement — one hundredth of a metre, about the width of a fingernail.' },
    ],
    questions: [
      { n: 4, q: 'The Sun is 400 times wider than the Moon but also 400 times farther away. Is this a coincidence, or could there be a reason?' },
      { n: 5, q: 'In 600 million years, total eclipses will no longer be possible. How does it feel to know we are living in a special time in Earth history?' },
      { n: 6, q: 'A total eclipse happens at any one place only once every 375 years. Would you travel to another country just to see one? Why or why not?' },
    ]
  },
  {
    number: 3, title: 'Eclipses in History', emoji: '📜', color: '#991b1b',
    text: `Throughout human history, solar eclipses have terrified, fascinated, and inspired people in equal measure. Before science could explain what was happening, an eclipse — the Sun suddenly disappearing in the middle of the day — was one of the most frightening things a person could witness.\n\nMany ancient cultures believed that eclipses were caused by creatures eating the Sun. In ancient China, people believed a dragon was devouring it. In Norse mythology, wolves chased the Sun across the sky and occasionally caught it. In Vietnam, a giant frog was thought to be swallowing the Sun. In many cultures, people would bang drums, shout, and make as much noise as possible to scare the creature away — and when the Sun returned, as it always did, they believed their noise had worked.\n\nBut eclipses have also been turning points in history. In 585 BC, a total eclipse occurred during a battle between the Lydians and the Medes in what is now Turkey. Both armies were so frightened by the sudden darkness that they immediately stopped fighting and agreed to peace. It is one of the earliest events in history that can be dated to a specific day using astronomical calculations.\n\nEclipses have also been important for science. In 1919, a total eclipse allowed the astronomer Arthur Eddington to test Albert Einstein's theory of general relativity. Einstein predicted that the gravity of the Sun would bend light from distant stars. During the eclipse, when the Sun's glare was blocked by the Moon, Eddington photographed the stars near the Sun and confirmed that their light had indeed been bent — exactly as Einstein had predicted. The result made Einstein world-famous overnight.`,
    vocab: [
      { word: 'Devouring', definition: 'Eating something quickly and completely — consuming hungrily.' },
      { word: 'Mythology', definition: 'A collection of traditional stories and legends from a particular culture, often about gods and heroes.' },
      { word: 'Astronomical', definition: 'Relating to astronomy — the scientific study of stars, planets, and space.' },
      { word: 'General relativity', definition: 'Albert Einstein s theory about how gravity works — showing that massive objects bend space and time.' },
    ],
    questions: [
      { n: 7, q: 'Ancient people thought creatures were eating the Sun during eclipses. What does this tell us about how humans try to explain things they do not understand?' },
      { n: 8, q: 'Two armies stopped fighting because of an eclipse in 585 BC. Why do you think the sudden darkness scared them so much?' },
      { n: 9, q: 'The 1919 eclipse helped prove Einstein was right. Can you think of other scientific discoveries that changed how we understand the world?' },
    ]
  },
  {
    number: 4, title: 'Eclipse Tourism', emoji: '✈️', color: '#7f1d1d',
    text: `The August 2026 eclipse has created a new phenomenon: eclipse tourism. Hundreds of thousands of people are expected to travel to the path of totality — particularly to Spain, where the weather is most likely to be clear and the infrastructure can handle large numbers of visitors.\n\nHotels in cities along the eclipse path have been fully booked for months. Bilbao, Zaragoza, and Palma de Mallorca — cities that are already popular tourist destinations — are expecting record visitor numbers. Special eclipse-viewing events have been organised in fields, on beaches, and at observatories. Airlines have added extra flights. Some companies are even offering "eclipse cruises" — ships positioned in the Atlantic Ocean directly in the path of totality.\n\nEclipse tourism has become a global industry. A dedicated community of "eclipse chasers" travels the world to see every total eclipse, wherever it occurs. Some have seen ten, twenty, or even thirty total eclipses. They describe the experience as addictive — once you have seen the Sun disappear and the corona appear, you want to see it again and again.\n\nBut eclipse tourism also raises questions about over-tourism and its impact on local communities. When hundreds of thousands of visitors descend on small towns for a single event, the strain on local services, roads, and accommodation can be enormous. Prices for hotels and restaurants increase dramatically, benefiting business owners but making life temporarily more expensive for residents.\n\nWhether you travel to see it or watch a live stream from your phone, the August 2026 eclipse is a reminder of something we easily forget in our busy, screen-dominated lives: the universe is still capable of putting on a show that no technology can match. Sometimes, the most extraordinary thing you can do is simply look up.`,
    vocab: [
      { word: 'Infrastructure', definition: 'The basic systems a place needs — roads, hotels, transport, water, electricity.' },
      { word: 'Observatories', definition: 'Buildings designed and equipped for watching stars, planets, and other objects in space.' },
      { word: 'Over-tourism', definition: 'When too many tourists visit a place, causing problems for the environment and local residents.' },
      { word: 'Live stream', definition: 'Video that is broadcast on the internet in real time as it happens.' },
    ],
    questions: [
      { n: 10, q: 'Some people have seen 30 total eclipses and call it addictive. What makes natural events like this so powerful that people travel the world to see them?' },
      { n: 11, q: 'Eclipse tourism can overwhelm small towns. How can communities benefit from big events without being damaged by them?' },
      { n: 12, q: 'The passage says the universe can put on a show that no technology can match. Do you agree? What natural event has impressed you the most?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Solar Eclipse Coming Next Week</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>On 12 August, the Moon will block the Sun over Europe for the first time since 1999. How eclipses work, their place in history, and why millions are planning to watch.</p>
            </div>
          </div>
