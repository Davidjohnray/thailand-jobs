...
const PARTS = [
  {
    number: 1, title: 'Wall of Water', emoji: '🌊', color: '#dc2626',
    text: `This week, flash floods tore through parts of Arizona\'s Grand Canyon, killing at least two people and leaving dozens of hikers stranded. The floods washed out footbridges, destroyed campgrounds, and turned peaceful streams into raging torrents of brown water carrying rocks, trees, and debris.\n\nThe hikers who died were caught in a narrow side canyon — one of the most dangerous places to be during a flash flood. In narrow canyons, water has nowhere to spread. Instead, it rises rapidly, sometimes going from ankle-deep to chest-deep in minutes. By the time you hear the roar of approaching water, it may already be too late to escape.\n\nRescue helicopters pulled more than 30 people from the canyon over two days. Some had spent the night clinging to rocks above the waterline. Others had climbed to high ground and waited, wet and cold, for rescue teams to find them. The National Park Service temporarily closed several popular hiking trails while crews assessed the damage.\n\nThe Grand Canyon is one of the most visited natural sites in the world, attracting more than six million visitors per year. Most people see it from the rim — the edge at the top. But thousands of hikers descend into the canyon each year, camping beside the Colorado River at the bottom. It is a stunning experience — but this week\'s floods are a reminder that the canyon is not a theme park. It is one of the most powerful landscapes on Earth.`,
    vocab: [
      { word: 'Flash flood', definition: 'A sudden, unexpected flood caused by heavy rain, often in canyons or valleys.' },
      { word: 'Torrents', definition: 'Fast-flowing, powerful streams of water — a rushing flood.' },
      { word: 'Stranded', definition: 'Left in a place with no way to leave — stuck and unable to move.' },
      { word: 'Assessed', definition: 'Evaluated and judged — looked at carefully to understand the situation.' },
    ],
    questions: [
      { n: 1, q: 'Hikers were caught in a narrow canyon with rising water. What would you do in that situation?' },
      { n: 2, q: 'Six million people visit the Grand Canyon every year. Should dangerous areas be closed to protect visitors?' },
      { n: 3, q: 'The passage says the canyon is not a theme park. Why do people sometimes forget that nature is dangerous?' },
    ]
  },
  {
    number: 2, title: 'How Flash Floods Work', emoji: '⛈️', color: '#b91c1c',
    text: `Flash floods are among the most dangerous natural hazards in the world — and among the hardest to predict. They can occur with little or no warning, often striking areas that were dry and sunny just minutes earlier.\n\nThe mechanism is deceptively simple. Heavy rain falls on hard ground that cannot absorb it. The water runs downhill, gathering speed and volume as it flows into channels, gullies, and canyons. In a narrow canyon, the water concentrates — transforming a gentle stream into a powerful flood capable of moving boulders weighing several tonnes.\n\nThe Grand Canyon is particularly vulnerable to flash floods because of its geology. The rock walls are largely impermeable — water cannot soak in. The canyon is shaped like a funnel — wide at the top and narrow at the bottom. And the desert climate means that when rain does fall, it often comes in intense, concentrated bursts rather than gentle showers.\n\nThe most deceptive aspect of flash floods is that the rain may fall miles away from where the flood occurs. A hiker at the bottom of a dry canyon under clear blue sky can be hit by a wall of water caused by a thunderstorm they never saw, 30 kilometres upstream. This is why flash floods kill more people in the American Southwest than any other weather-related hazard — because the danger is invisible until it arrives.`,
    vocab: [
      { word: 'Hazard', definition: 'A danger or risk — something that could cause harm.' },
      { word: 'Impermeable', definition: 'Not allowing water to pass through — a surface that blocks absorption.' },
      { word: 'Upstream', definition: 'Higher up along a river or stream — closer to where the water comes from.' },
      { word: 'Deceptive', definition: 'Giving a false impression — making something seem safe when it is not.' },
    ],
    questions: [
      { n: 4, q: 'Rain 30 kilometres away can cause a flood where the sky is clear. Why does this make flash floods so deadly?' },
      { n: 5, q: 'The canyon is shaped like a funnel. How does this shape make floods more dangerous?' },
      { n: 6, q: 'Flash floods kill more people than any other weather hazard in the American Southwest. Does this surprise you?' },
    ]
  },
  {
    number: 3, title: 'Climate Change and Extreme Rain', emoji: '🌡️', color: '#991b1b',
    text: `Flash floods have always occurred in the Grand Canyon. But climate change is making them more frequent and more intense.\n\nThe basic physics is straightforward. A warmer atmosphere holds more moisture — about 7% more for every degree Celsius of warming. When storms form, they have more water to release. The result is heavier rainfall in shorter periods — exactly the conditions that produce flash floods.\n\nData from the American Southwest confirms this trend. The frequency of extreme rainfall events — storms that drop unusually large amounts of rain in a short time — has increased significantly over the past 30 years. Meanwhile, overall annual rainfall has decreased in many parts of the region. The climate is becoming drier on average but more extreme when rain does come — a combination that maximises flash flood risk.\n\nThis pattern is not unique to Arizona. Across the world, climate change is making extreme rainfall events more common while droughts become longer and more severe. Thailand experienced devastating floods in 2011 partly because of unusually intense monsoon rainfall. The European floods of 2021 were caused by rainfall that climate models predicted would become more frequent with warming.\n\nFor tourists visiting places like the Grand Canyon, the message is clear: the risks of outdoor recreation in canyon environments are increasing. Check weather forecasts before hiking. Know the signs of flash flood danger. And remember that a clear sky above you does not mean safety — the storm that kills you may be behind the next ridge.`,
    vocab: [
      { word: 'Moisture', definition: 'Water in the form of tiny droplets in the air — humidity.' },
      { word: 'Extreme rainfall', definition: 'Unusually heavy rain that falls in a short period — far more than normal.' },
      { word: 'Maximises', definition: 'Makes something as large or as likely as possible — increases to the greatest extent.' },
      { word: 'Recreation', definition: 'Activities done for enjoyment in your free time — hobbies and outdoor pursuits.' },
    ],
    questions: [
      { n: 7, q: 'Less rain overall but more extreme when it comes. Why is this combination especially dangerous?' },
      { n: 8, q: 'Thailand 2011 and Europe 2021 both had extreme rainfall linked to climate change. Is this a global problem or a local one?' },
      { n: 9, q: 'Should national parks do more to warn visitors about flash flood risks? What would effective warnings look like?' },
    ]
  },
  {
    number: 4, title: 'Respect the Canyon', emoji: '🏔️', color: '#7f1d1d',
    text: `The Grand Canyon is 1.6 kilometres deep, up to 29 kilometres wide, and 446 kilometres long. The Colorado River has been carving it for approximately six million years. The oldest rocks at the bottom are nearly two billion years old — almost half the age of the Earth itself.\n\nHumans have been visiting the canyon for thousands of years. Native American peoples — including the Havasupai, Hualapai, Navajo, and Hopi — have lived in and around the canyon for centuries. For them, the canyon is not a tourist destination — it is home, a sacred landscape with deep spiritual significance.\n\nFor the millions of tourists who visit each year, the canyon offers something that is increasingly rare in modern life: a genuine encounter with the power of nature. Standing on the rim and looking down into a chasm carved over millions of years puts human life into perspective. Our cities, our politics, our conflicts — all of it is temporary. The canyon was here before us and will be here long after.\n\nBut the canyon demands respect. Every year, an average of 12 people die in the Grand Canyon — from falls, heat exhaustion, drowning, and medical emergencies. The beauty of the place can make people forget its dangers. The distance from the rim to the river is deceptive — what looks like a pleasant walk down is an exhausting, dangerous climb back up in desert heat.\n\nThis week\'s flash floods are a reminder. Nature is beautiful, powerful, and utterly indifferent to human plans. The Grand Canyon does not care about your hiking schedule, your Instagram photos, or your fitness level. It is what it has always been: a force of nature that deserves our wonder and our respect.`,
    vocab: [
      { word: 'Sacred', definition: 'Considered holy or deeply important — connected to spiritual beliefs.' },
      { word: 'Chasm', definition: 'A deep crack or opening in the Earth surface — a dramatic gap.' },
      { word: 'Perspective', definition: 'A way of seeing things in proper relation — understanding size and importance.' },
      { word: 'Indifferent', definition: 'Not caring — having no concern for human plans or feelings.' },
    ],
    questions: [
      { n: 10, q: 'The oldest rocks in the Grand Canyon are two billion years old. How does knowing this change how you see human history?' },
      { n: 11, q: 'An average of 12 people die in the Grand Canyon every year. Should access be restricted to reduce deaths?' },
      { n: 12, q: 'Nature is indifferent to human plans. Is this frightening or liberating? Why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Flash Floods Kill Two at the Grand Canyon". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Flash Floods Kill Two at the Grand Canyon</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Flash floods swept through the Grand Canyon this week, killing two hikers and destroying footbridges. Why flash floods are so dangerous and how climate change is making them worse.</p>
            </div>
          </div>
