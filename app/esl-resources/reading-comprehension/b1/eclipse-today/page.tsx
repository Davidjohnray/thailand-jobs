...
const PARTS = [
  {
    number: 1, title: 'The Sun Disappeared Today', emoji: '🌑', color: '#dc2626',
    text: `Today — 12 August 2026 — the Moon passed directly in front of the Sun, creating a total solar eclipse visible across parts of the northern hemisphere. For a few extraordinary minutes, day turned to night. The temperature dropped. Stars appeared in the middle of the afternoon. And millions of people across Greenland, Iceland, Spain, and North Africa looked up at one of the most spectacular sights in nature.\n\nThe path of totality — the narrow strip where the Sun was completely blocked — crossed Greenland, Iceland, and northern Spain, including cities like Bilbao and Zaragoza. In these places, the sky went completely dark, and the Sun's glowing outer atmosphere — called the corona — appeared as a ring of white fire around the dark circle of the Moon.\n\nAcross the rest of Europe, people saw a partial eclipse — where part of the Sun was covered but not all of it. In the UK and Ireland, up to 96% of the Sun was hidden. In France and Germany, around 90% was covered. Even in places with only a partial view, the light became strangely dim and shadows looked different.\n\nIn the United States, parts of the eastern seaboard caught the eclipse just before sunset, creating dramatic images of a partially eclipsed Sun sinking below the horizon. The timing was perfect — the Perseid meteor shower also peaked on the same night, giving stargazers a double treat.`,
    vocab: [
      { word: 'Solar eclipse', definition: 'When the Moon passes between the Earth and Sun, blocking the Sun light.' },
      { word: 'Path of totality', definition: 'The narrow strip on Earth where the Sun is completely blocked during a total eclipse.' },
      { word: 'Corona', definition: 'The Sun outer atmosphere, visible as a glowing ring during a total eclipse.' },
      { word: 'Meteor shower', definition: 'When many shooting stars are visible as the Earth passes through space debris.' },
    ],
    questions: [
      { n: 1, q: 'Did you see the eclipse today? If so, what was it like? If not, did you see photos or videos?' },
      { n: 2, q: 'People describe total eclipses as life-changing experiences. Why do you think watching something in the sky affects people so deeply?' },
      { n: 3, q: 'The eclipse and the Perseid meteor shower happened on the same day. If you could watch one, which would you choose?' },
    ]
  },
  {
    number: 2, title: 'How Eclipses Work', emoji: '🌍', color: '#b91c1c',
    text: `A solar eclipse happens when the Moon passes between the Earth and the Sun, casting a shadow on the Earth. This requires an extraordinary coincidence of size and distance.\n\nThe Sun is about 400 times wider than the Moon. But it is also about 400 times farther away. This means that from Earth, the Sun and Moon appear to be almost exactly the same size in the sky. When the Moon passes in front of the Sun, it can cover it almost perfectly.\n\nThis coincidence will not last forever. The Moon is slowly moving away from the Earth — about 3.8 centimetres per year. In about 600 million years, the Moon will be too far away to completely cover the Sun. Total solar eclipses will no longer be possible. We are living in the only period of Earth history when this phenomenon can occur.\n\nTotal eclipses are rare in any one place. Although there are usually two solar eclipses somewhere on Earth each year, the path of totality is very narrow — typically only 100 to 250 kilometres wide. Any particular spot on Earth experiences a total eclipse only about once every 375 years on average. This rarity is part of what makes eclipses so special — and why hundreds of thousands of people travelled to Spain and Iceland this week to see one.`,
    vocab: [
      { word: 'Coincidence', definition: 'When two things happen together by chance in a surprising way.' },
      { word: 'Phenomenon', definition: 'A natural event that can be observed — something remarkable that happens.' },
      { word: 'Rarity', definition: 'The quality of being very uncommon — something that does not happen often.' },
      { word: 'Shadow', definition: 'A dark area created when something blocks light.' },
    ],
    questions: [
      { n: 4, q: 'The Sun is 400 times bigger than the Moon but also 400 times further away. Is this just luck, or could there be a reason?' },
      { n: 5, q: 'In 600 million years, total eclipses will no longer be possible. How does it feel to know we live in a special time?' },
      { n: 6, q: 'A total eclipse only happens at each place once every 375 years. Would you travel to another country to see one?' },
    ]
  },
  {
    number: 3, title: 'Eclipses in History', emoji: '📜', color: '#991b1b',
    text: `For most of human history, solar eclipses were terrifying. Without science to explain what was happening, the Sun suddenly disappearing in the middle of the day was one of the most frightening things a person could experience.\n\nMany cultures believed creatures were eating the Sun. In ancient China, people thought a dragon was devouring it. In Norse mythology, wolves chased the Sun across the sky. In Vietnam, a giant frog was swallowing it. People banged drums and shouted to scare the creature away — and when the Sun returned, they believed their noise had worked.\n\nBut eclipses have also been turning points in history. In 585 BC, a total eclipse occurred during a battle between two armies in what is now Turkey. Both sides were so frightened by the sudden darkness that they stopped fighting and agreed to peace.\n\nEclipses have been vital for science too. In 1919, a total eclipse allowed the astronomer Arthur Eddington to test Einstein theory of general relativity. Einstein predicted that the Sun gravity would bend light from distant stars. During the eclipse, when the Sun glare was blocked, Eddington photographed stars near the Sun and confirmed their light had been bent — exactly as Einstein predicted. The result made Einstein famous overnight.`,
    vocab: [
      { word: 'Devouring', definition: 'Eating something quickly and completely — consuming hungrily.' },
      { word: 'Mythology', definition: 'Traditional stories from a particular culture, often about gods and supernatural events.' },
      { word: 'General relativity', definition: 'Einstein theory about how gravity works — massive objects bend space and time.' },
      { word: 'Confirmed', definition: 'Proved that something was true or correct by finding evidence.' },
    ],
    questions: [
      { n: 7, q: 'Ancient people thought creatures were eating the Sun. What does this tell us about how humans explain things they do not understand?' },
      { n: 8, q: 'Two armies stopped fighting because of an eclipse. What other natural events have changed the course of history?' },
      { n: 9, q: 'The 1919 eclipse proved Einstein was right. Can you think of other scientific discoveries that changed how we see the world?' },
    ]
  },
  {
    number: 4, title: 'Looking Up', emoji: '✨', color: '#7f1d1d',
    text: `Today eclipse reminded millions of people of something we easily forget: the universe is still capable of putting on a show that no technology can match.\n\nIn our daily lives, we spend most of our time looking at screens — phones, laptops, tablets, televisions. We consume entertainment that is designed, edited, and polished by professionals. We watch videos with millions of views and scroll through images enhanced by filters. Everything is curated, controlled, and artificial.\n\nAn eclipse is none of these things. It is raw, unfiltered reality — the Moon, the Sun, and the Earth lining up in a way that has nothing to do with human plans or human technology. You cannot fast-forward it, pause it, or watch it again tomorrow. It happens once, in real time, and then it is gone. The only way to experience it is to be in the right place at the right moment and look up.\n\nPeople who saw today eclipse — whether in Spain, Iceland, or through a live stream — will remember it for the rest of their lives. Not because it was the most important event of the week. The Colombia earthquake killed hundreds. Wars continue. Political crises unfold. But the eclipse offered something that the news rarely does: wonder. Pure, simple, unfiltered wonder at the extraordinary universe we live in.\n\nThe next total solar eclipse visible from Europe will not happen until 2027. But the next opportunity to look up, to notice the sky, to feel small and amazed — that is available every single night. All you have to do is stop scrolling and look up.`,
    vocab: [
      { word: 'Curated', definition: 'Carefully selected and arranged to present a particular image — not natural or spontaneous.' },
      { word: 'Unfiltered', definition: 'Not changed, edited, or adjusted — real and raw.' },
      { word: 'Wonder', definition: 'A feeling of amazement and admiration caused by something beautiful or extraordinary.' },
      { word: 'Extraordinary', definition: 'Very unusual and remarkable — far beyond what is normal or expected.' },
    ],
    questions: [
      { n: 10, q: 'The passage says we spend too much time looking at screens. Do you agree? When was the last time you looked at the sky?' },
      { n: 11, q: 'An eclipse cannot be paused, rewound, or watched again. Does this make it more special than entertainment we can replay?' },
      { n: 12, q: 'The passage ends by saying "stop scrolling and look up." Will you? What do you think you might notice?' },
    ]
  },
]
...
export default function EclipseTodayPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Sun Disappeared Today</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Today the Moon blocked the Sun over Europe and North Africa. How eclipses work, why ancient people feared them, and why looking up still matters.</p>
            </div>
          </div>
