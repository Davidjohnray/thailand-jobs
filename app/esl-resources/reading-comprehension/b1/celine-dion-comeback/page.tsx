...
const PARTS = [
  {
    number: 1, title: 'The Voice Returns', emoji: '🎵', color: '#dc2626',
    text: `On Saturday night in Montreal, Canada, something extraordinary happened. Celine Dion — one of the greatest singers in the history of popular music — walked onto a stage and sang for the first time in six years. The audience of 25,000 people rose to their feet before she sang a single note. Many were already crying.\n\nDion, now 58, was diagnosed in 2022 with Stiff Person Syndrome — a rare neurological disorder that causes the muscles to become rigid and spasm uncontrollably. For a singer, it was the cruelest possible diagnosis. The disease affected the muscles she used to breathe, to support her voice, and to move on stage. At its worst, it left her unable to walk, unable to cook for her children, and unable to do the one thing that had defined her life since childhood: sing.\n\nHer return to the stage was not announced in advance. The concert was billed as a "special guest" appearance at a charity event. When she walked out, the roar of the crowd was so loud that she stood silently for nearly two minutes, visibly overwhelmed.\n\nThen she sang. Her voice was different — slightly thinner, more careful, less powerful than the voice that once filled stadiums effortlessly. But it was unmistakably hers. And for the audience — many of whom had feared they would never hear her sing again — it was perfect.`,
    vocab: [
      { word: 'Neurological', definition: 'Relating to the brain and nervous system — affecting how nerves and muscles work.' },
      { word: 'Spasm', definition: 'A sudden, uncontrollable tightening of muscles — painful and involuntary.' },
      { word: 'Diagnosis', definition: 'The identification of a disease or condition by a doctor.' },
      { word: 'Overwhelmed', definition: 'Feeling such strong emotion that it is hard to control — overcome by feelings.' },
    ],
    questions: [
      { n: 1, q: '25,000 people stood and cried before she sang a note. Why do some artists inspire this kind of devotion?' },
      { n: 2, q: 'A singer diagnosed with a disease that attacks muscles used for singing. Can you imagine a crueler twist for someone whose life is music?' },
      { n: 3, q: 'Her voice was different but unmistakably hers. Is imperfection sometimes more moving than perfection?' },
    ]
  },
  {
    number: 2, title: 'Fighting Back', emoji: '💪', color: '#b91c1c',
    text: `Dion documentary, released in 2024, showed the world what Stiff Person Syndrome does to a human body. In one devastating scene, she has a spasm so severe that she cannot move or speak — her body locks rigid while her eyes show terror and pain. The footage was difficult to watch. Dion chose to include it because she wanted people to understand.\n\n"I did not want sympathy," she said in an interview. "I wanted people to see the truth. This is what I fight every single day."\n\nHer fight involved years of intensive physical therapy, experimental treatments, and a determination that medical professionals described as extraordinary. She worked with vocal coaches to retrain her singing voice using different muscle groups. She underwent painful rehabilitation sessions to maintain mobility. She adapted her entire approach to singing — learning to produce sound in ways that worked around the damaged muscles.\n\nThe comeback was never guaranteed. Many doctors told her that performing again was unlikely. Stiff Person Syndrome is progressive — it typically gets worse over time, not better. But Dion refused to accept that assessment. "My voice is my life," she said. "If I cannot sing, I will learn a new way to sing. But I will not be silent."\n\nHer return to the stage — while limited to a shorter set than her famous multi-hour performances — represents a victory of willpower over disease that has inspired millions of people facing their own health challenges.`,
    vocab: [
      { word: 'Documentary', definition: 'A film or programme that shows real events and real people — not fiction.' },
      { word: 'Rehabilitation', definition: 'The process of recovering abilities after injury or illness — therapy to restore function.' },
      { word: 'Progressive', definition: 'Getting worse over time — a disease that gradually becomes more severe.' },
      { word: 'Willpower', definition: 'The mental strength to keep going despite difficulty — determination and self-control.' },
    ],
    questions: [
      { n: 4, q: 'Dion showed footage of her worst moments because she wanted people to understand. Was this brave or too personal?' },
      { n: 5, q: 'Doctors said performing again was unlikely. She did it anyway. What drives someone to refuse to accept limitations?' },
      { n: 6, q: 'She said "I will not be silent." What does music mean to someone whose entire identity is built around singing?' },
    ]
  },
  {
    number: 3, title: 'Why Music Moves Us', emoji: '🎶', color: '#991b1b',
    text: `Dion comeback raises a question that scientists and philosophers have debated for centuries: why does music affect us so deeply?\n\nMusic is the only art form that directly stimulates the brain reward system — the same neural pathways activated by food, love, and other survival-essential experiences. When you hear a song that moves you, your brain releases dopamine — the same chemical that makes you feel pleasure when you eat your favourite food or spend time with someone you love.\n\nThis explains why music can make us cry, dance, feel brave, or remember things we thought we had forgotten. A song you heard during a happy period of your life can transport you back to that moment instantly. Music played at funerals can express grief that words cannot reach. And a beloved singer returning to the stage after years of silence can generate an emotional response that surprises even the people feeling it.\n\nMusic is also universal. Every culture in human history has created music. There is no society, no matter how isolated, that does not sing, drum, or play instruments. Music appears to be built into what we are — not a luxury but a fundamental part of being human.\n\nFor Dion fans, her return is not just about entertainment. It is about a voice that was part of the soundtrack of their lives — weddings, road trips, breakups, celebrations — coming back from the silence. When she sings, they hear not just her voice but their own memories.`,
    vocab: [
      { word: 'Neural pathways', definition: 'Routes in the brain through which signals travel — connections between brain cells.' },
      { word: 'Dopamine', definition: 'A chemical in the brain associated with pleasure and reward — it makes you feel good.' },
      { word: 'Soundtrack', definition: 'The music that accompanies an experience — the songs that define a period of your life.' },
      { word: 'Universal', definition: 'Found everywhere — present in all cultures and societies throughout history.' },
    ],
    questions: [
      { n: 7, q: 'Music activates the same brain pathways as food and love. Why do you think humans evolved to respond to music this way?' },
      { n: 8, q: 'A song can transport you back to a specific moment. What song takes you back to a particular memory?' },
      { n: 9, q: 'Every culture in history has created music. Why is music universal when other art forms are not?' },
    ]
  },
  {
    number: 4, title: 'Coming Back', emoji: '🌅', color: '#7f1d1d',
    text: `Celine Dion comeback is one of those rare stories that makes the entire world smile. In a news week that included wars, disasters, and political crises, a woman standing on a stage and singing is the story that touched people most deeply.\n\nWhy? Perhaps because comebacks speak to something fundamental in the human experience. We all face setbacks — illness, failure, loss, disappointment. Most of them are not as dramatic as losing your ability to sing. But the feeling of being knocked down and wondering whether you can get back up is universal.\n\nDion story says: you can get back up. Not perfectly. Not the way you were before. But you can find a new way. You can adapt. You can refuse to accept that the worst moment defines you. And sometimes — if you fight hard enough and long enough — you can stand on a stage and do the thing you love, even when the world told you it was impossible.\n\nThis is not a fairy tale. Dion disease has not been cured. She may not be able to perform regularly. Future spasms could take her voice again. The road ahead is uncertain. But on Saturday night in Montreal, none of that mattered. What mattered was the music — imperfect, emotional, real — and the 25,000 people who stood in the darkness and remembered why they fell in love with that voice in the first place.\n\nSometimes the most powerful thing a person can do is simply refuse to give up. Celine Dion refused. And the world is better for it.`,
    vocab: [
      { word: 'Setbacks', definition: 'Problems that slow your progress — obstacles that knock you back.' },
      { word: 'Adapt', definition: 'To change in order to deal with new circumstances — finding a different way.' },
      { word: 'Fairy tale', definition: 'A story with a perfect, unrealistic happy ending — not how real life works.' },
      { word: 'Imperfect', definition: 'Not perfect — flawed but real and genuine.' },
    ],
    questions: [
      { n: 10, q: 'In a week of wars and crises, a woman singing was the most moving story. Why does human resilience affect us more than politics?' },
      { n: 11, q: 'Her comeback was not perfect. She may not perform again. Does this make the moment more or less meaningful?' },
      { n: 12, q: 'The most powerful thing a person can do is refuse to give up. Do you agree? Who in your life has shown this kind of determination?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Celine Dion Performs Her First Concert in 6 Years". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function CelineDionPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Celine Dion Performs Her First Concert in 6 Years</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>After a devastating diagnosis that took away her ability to sing, Celine Dion returned to the stage this weekend. Music, resilience, and the power of never giving up.</p>
            </div>
          </div>
