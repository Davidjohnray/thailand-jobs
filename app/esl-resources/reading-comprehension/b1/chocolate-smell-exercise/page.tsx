...
const PARTS = [
  {
    number: 1, title: 'The Sweetest Workout', emoji: '💪', color: '#dc2626',
    text: `Here is a sentence you probably never expected to read: smelling chocolate can make you stronger.\n\nA study published this week found that men who smelled dark chocolate while doing leg exercises completed significantly more repetitions than men who did not — without feeling like the workout was any harder. The effect was strongest with dark chocolate, moderate with milk chocolate, and absent with white chocolate (which has almost no cocoa aroma).\n\nThe researchers asked 30 men to perform leg extension exercises — lifting a weighted bar with their legs — under three conditions: while smelling dark chocolate, while smelling a neutral scent, and with no scent at all. The men who smelled dark chocolate completed an average of 11% more repetitions before stopping. When asked how hard the exercise felt, they reported the same level of effort as the other groups.\n\nIn other words, they did more work without realising it. The chocolate smell somehow increased their physical performance without increasing their perception of effort. The researchers believe this has to do with how familiar, pleasant aromas affect motivation and reward pathways in the brain — essentially, the smell of chocolate puts the brain in a happier state, which makes physical effort feel more manageable.`,
    vocab: [
      { word: 'Repetitions', definition: 'The number of times you repeat an exercise movement — doing the same action again and again.' },
      { word: 'Perception', definition: 'How you experience or interpret something — what you feel or believe about a sensation.' },
      { word: 'Aroma', definition: 'A pleasant smell — a distinctive, appealing scent.' },
      { word: 'Reward pathways', definition: 'Brain circuits that produce feelings of pleasure and motivation — making you feel good.' },
    ],
    questions: [
      { n: 1, q: 'Smelling chocolate made people exercise more without feeling more tired. Does this surprise you?' },
      { n: 2, q: 'Would you try smelling chocolate during exercise? What other smells might have a similar effect?' },
      { n: 3, q: 'Dark chocolate worked best, milk chocolate was weaker, white chocolate did nothing. Why might the intensity of the cocoa smell matter?' },
    ]
  },
  {
    number: 2, title: 'The Power of Smell', emoji: '👃', color: '#b91c1c',
    text: `The chocolate study is part of a growing body of research showing that smell — often considered the least important of our five senses — has a surprisingly powerful influence on our behaviour, emotions, and physical performance.\n\nSmell is the only sense that connects directly to the limbic system — the part of the brain that processes emotions and memory. This is why a particular smell can instantly transport you back to a childhood memory, make you feel hungry, or change your mood. The other senses — sight, hearing, touch, taste — are processed through other brain regions first.\n\nThis direct connection explains why smell affects us in ways we are often not aware of. Studies have shown that the smell of lavender reduces anxiety. The smell of peppermint improves concentration and alertness. The smell of fresh-baked bread makes people more helpful to strangers. And now, the smell of dark chocolate improves exercise performance.\n\nBusinesses have been exploiting the power of smell for years. Real estate agents bake cookies before house viewings because the smell of baking makes houses feel like homes. Luxury hotels use signature scents in their lobbies to create memorable experiences. And supermarkets position their bakeries near the entrance so the smell of fresh bread draws customers inside.\n\nThe chocolate exercise study adds a new dimension: smell does not just affect our emotions — it affects our physical performance. Your nose is doing more than you think.`,
    vocab: [
      { word: 'Limbic system', definition: 'The part of the brain that processes emotions, memory, and motivation.' },
      { word: 'Anxiety', definition: 'A feeling of worry, nervousness, or unease about something.' },
      { word: 'Alertness', definition: 'The state of being awake, focused, and ready to respond — mental sharpness.' },
      { word: 'Signature scent', definition: 'A unique, distinctive smell that is associated with a particular brand or place.' },
    ],
    questions: [
      { n: 4, q: 'Smell connects directly to emotions and memory. What smell instantly takes you back to a specific memory?' },
      { n: 5, q: 'Shops use smell to make you buy more. Is this clever marketing or manipulation?' },
      { n: 6, q: 'Lavender reduces anxiety, peppermint improves focus. Do you use any scents to change how you feel?' },
    ]
  },
  {
    number: 3, title: 'Why Chocolate Is Special', emoji: '🫘', color: '#991b1b',
    text: `Of all the foods in the world, chocolate has a unique place in human culture — and there are scientific reasons why it affects us so powerfully.\n\nChocolate contains more than 600 chemical compounds that contribute to its flavour and aroma. Many of these compounds are also found in other pleasant things — fruits, flowers, vanilla, caramel, and even red wine. The complexity of chocolate aroma is one reason why it is so universally appealing — it contains something for almost every nose.\n\nChocolate also contains small amounts of chemicals that directly affect the brain. Theobromine — a mild stimulant related to caffeine — provides a gentle energy boost. Phenylethylamine — sometimes called the "love chemical" — is the same substance the brain produces when you fall in love. And anandamide — named after the Sanskrit word for bliss — activates the same brain receptors as cannabis, producing a mild feeling of happiness.\n\nThe amounts of these chemicals in chocolate are too small to produce significant effects when eaten. But the aroma — which contains many of the same volatile compounds — reaches the brain through the olfactory system, which has a more direct route to the emotional centres. This may explain why smelling chocolate affects mood and performance even more directly than eating it.\n\nChocolate was first consumed by the ancient Maya and Aztec civilisations in Central America more than 3,000 years ago — as a bitter drink, not a sweet bar. They considered it sacred — a gift from the gods. Modern science is beginning to understand why they were not entirely wrong.`,
    vocab: [
      { word: 'Compounds', definition: 'Chemical substances made of two or more elements combined together.' },
      { word: 'Stimulant', definition: 'A substance that increases alertness and energy — like caffeine.' },
      { word: 'Olfactory', definition: 'Relating to the sense of smell — the system that detects and processes scents.' },
      { word: 'Volatile', definition: 'Evaporating easily — substances that turn to gas quickly, producing smells.' },
    ],
    questions: [
      { n: 7, q: 'Chocolate contains the same chemical your brain produces when you fall in love. Does this change how you think about chocolate?' },
      { n: 8, q: 'The Maya considered chocolate a gift from the gods. What foods does your culture consider special or sacred?' },
      { n: 9, q: 'Smelling chocolate may affect you more than eating it. Is this good news or frustrating news for chocolate lovers?' },
    ]
  },
  {
    number: 4, title: 'The Gym of the Future', emoji: '🏋️', color: '#7f1d1d',
    text: `If smelling chocolate can improve exercise performance by 11%, what else might be hiding in our senses that could help us perform better?\n\nThe study opens up fascinating possibilities. Could gyms of the future use scent systems — like the signature scents in luxury hotels — to improve their members workouts? Could runners wear scented wristbands during marathons? Could physiotherapists use aromas to help patients recover from injuries faster?\n\nThe research is still in its early stages, and there are many questions to answer. Does the effect work for all types of exercise, or just leg extensions? Does it work for women as well as men? (The study only tested men.) Does it work for people who do not like chocolate? And does the effect diminish over time — or does the brain eventually stop responding to the same smell?\n\nBut even if the practical applications are limited, the study teaches us something important about the human body: our senses do not work in isolation. What you see affects what you hear. What you hear affects what you taste. And what you smell affects how strong you are. The human body is not a collection of separate systems — it is an integrated whole, where everything is connected to everything else.\n\nSo the next time you are struggling at the gym, try this: close your eyes, imagine the smell of dark chocolate, and push through one more rep. Your nose might just give your muscles the permission they need.`,
    vocab: [
      { word: 'Physiotherapists', definition: 'Health professionals who help people recover from injuries through exercise and movement.' },
      { word: 'Diminish', definition: 'To become weaker or smaller over time — losing its effect.' },
      { word: 'Integrated', definition: 'Combined into a single working system — all parts connected and influencing each other.' },
      { word: 'In isolation', definition: 'Separately, without connection to other things — on their own.' },
    ],
    questions: [
      { n: 10, q: 'Should gyms use chocolate scent to improve workouts? Would you want this in your gym?' },
      { n: 11, q: 'The study only tested men. Why is it important to test women too? Might the results be different?' },
      { n: 12, q: 'Our senses are all connected — smell affects strength, sight affects taste. What other surprising connections can you think of?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Smelling Chocolate Helps You Exercise More". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function ChocolateExercisePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Smelling Chocolate Helps You Exercise More</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Scientists found that smelling dark chocolate helped men do more exercise without feeling more tired. The strange science of smell, motivation, and how your nose tricks your brain.</p>
            </div>
          </div>
