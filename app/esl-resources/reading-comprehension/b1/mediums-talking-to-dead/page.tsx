...
const PARTS = [
  {
    number: 1, title: 'What Is a Medium — and How Long Have They Existed?', emoji: '🔮', color: '#8b5cf6',
    text: `A medium is a person who claims to be able to communicate with the spirits of people who have died. They say they can receive messages from the dead and pass these messages on to living people. The word "medium" comes from the idea that this person is in the middle — between the living world and the world of the dead. Many people visit mediums hoping to receive a message from a family member or friend who has passed away.\n\nBelief in communication with the dead is not new. It has existed in almost every culture in human history. Ancient Egyptians believed that priests could speak with the spirits of dead pharaohs. The ancient Greeks visited special places called oracles where they believed the gods and spirits could send messages. Native American and Aboriginal Australian cultures have long traditions of shamans — spiritual leaders who travel between the world of the living and the world of the spirits. In many Asian cultures, including in Thailand, it is very common to believe that the spirits of ancestors stay close to their family after death and can be communicated with through prayer and ritual. The desire to speak with the dead seems to be something deeply human — found in every part of the world and throughout all of history.`,
    vocab: [
      { word: 'Medium', definition: 'A person who says they can communicate with the spirits of dead people.' },
      { word: 'Spirits', definition: 'The non-physical part of a person that some people believe continues to exist after death.' },
      { word: 'Oracle', definition: 'In ancient times, a place or person believed to receive messages from gods or spirits.' },
      { word: 'Ancestors', definition: 'Family members from the past, such as grandparents and great-grandparents who have died.' },
    ],
    questions: [
      { n: 1, q: 'In your culture or religion, do people believe it is possible to communicate with the dead? How?' },
      { n: 2, q: 'Have you ever visited a medium or fortune teller? What was the experience like?' },
      { n: 3, q: 'Why do you think the desire to communicate with the dead exists in almost every culture in the world?' },
    ]
  },
  {
    number: 2, title: 'The Spiritualist Movement and Famous Mediums', emoji: '👻', color: '#a855f7',
    text: `The modern idea of mediums became very popular in the nineteenth century. In 1848, two young sisters in the United States — Kate and Maggie Fox — claimed that they could communicate with a spirit in their house by listening to knocking sounds. People came from all over America to witness this, and the girls became famous. This started a movement called Spiritualism — a belief that the dead can communicate with the living, and that mediums are the people who can help make this connection.\n\nSpiritualism spread quickly across America and Europe. Many famous and intelligent people became believers, including the writer Arthur Conan Doyle, who created the character Sherlock Holmes. Queen Victoria of England is also reported to have consulted mediums after the death of her husband, Prince Albert. In the early twentieth century, the famous escape artist Harry Houdini spent many years trying to expose fake mediums. He believed that most mediums were simply very clever performers who used tricks to make people think they were communicating with spirits. Before he died in 1926, Houdini made a secret agreement with his wife — if communication with the dead was truly possible, he would send her a coded message from the afterlife. She never received it.`,
    vocab: [
      { word: 'Spiritualism', definition: 'A religious movement that believes the spirits of the dead can communicate with living people.' },
      { word: 'Witness', definition: 'To see something happen with your own eyes — to be present when something occurs.' },
      { word: 'Expose', definition: 'To reveal the truth about someone who is lying or cheating — to show that something is fake.' },
      { word: 'Afterlife', definition: 'The idea that a person\'s spirit continues to exist in another place after their physical death.' },
    ],
    questions: [
      { n: 4, q: 'Does it surprise you that intelligent and famous people like Arthur Conan Doyle believed in mediums? Why?' },
      { n: 5, q: 'Do you think Houdini was right that most mediums are just clever performers using tricks? Why or why not?' },
      { n: 6, q: 'If you had made the same agreement as Houdini with someone you loved, and they never received a message, what would that tell you?' },
    ]
  },
  {
    number: 3, title: 'How Do Mediums Work — Science and Scepticism', emoji: '🔬', color: '#06b6d4',
    text: `Most scientists are very sceptical about mediums. They say there is no scientific evidence that communication with the dead is possible, and that the techniques mediums use can be explained by psychology rather than supernatural ability. One of the most well-known techniques is called "cold reading." This is when a medium asks a lot of general questions and uses the answers to make it seem like they have special knowledge. For example, a medium might say "I'm sensing someone whose name begins with a J..." — a very common letter in many names. When the person responds with excitement, the medium uses their reaction to find more specific details, slowly building a picture that feels very accurate.\n\nAnother technique is called "hot reading" — where a medium researches a person before meeting them, perhaps by looking at social media or speaking to people who know them. Psychologists have also identified a tendency called the "Barnum effect" — people tend to accept vague, general statements as personally meaningful when they are told those statements are specifically about them. Studies have shown that when people read horoscopes or medium readings, they often rate them as highly accurate — even when the same reading has been given to many different people. Despite all of this scientific criticism, belief in mediums remains widespread. Surveys suggest that a significant percentage of people in many countries believe that communication with the dead is genuinely possible.`,
    vocab: [
      { word: 'Sceptical', definition: 'Doubting whether something is true — not easily believing claims without evidence.' },
      { word: 'Cold reading', definition: 'A technique where someone appears to know personal information by asking clever questions and reading reactions.' },
      { word: 'Barnum effect', definition: 'The tendency to accept vague, general statements as personally accurate descriptions of yourself.' },
      { word: 'Supernatural', definition: 'Beyond the natural world — things that cannot be explained by science or the laws of nature.' },
    ],
    questions: [
      { n: 7, q: 'Have you heard of cold reading before? Does knowing about this technique change how you think about mediums?' },
      { n: 8, q: 'Why do you think people continue to believe in mediums even after they learn about these techniques?' },
      { n: 9, q: 'Is it harmful for people to visit mediums, or can it be a positive experience even if the medium is not real? Explain.' },
    ]
  },
  {
    number: 4, title: 'Why People Believe — Grief, Comfort and the Unknown', emoji: '💙', color: '#22c55e',
    text: `Even if mediums cannot truly communicate with the dead, it is important to understand why so many people visit them and find the experience meaningful. Grief — the deep sadness we feel when someone we love dies — can be one of the most painful human experiences. When someone loses a parent, a child, or a close friend, they often feel that there are things they did not say, questions they did not ask, or simply that they want to feel the presence of that person one more time. A medium who seems to bring a message from a loved one — even if that message is produced through clever techniques — can bring real comfort and peace to a grieving person.\n\nSome psychologists argue that this comfort is not worthless simply because the medium is not genuinely supernatural. Others strongly disagree, saying that mediums make money from people who are vulnerable and in pain, and that they prevent people from processing their grief in healthy ways. The question of whether mediums are helpful or harmful depends very much on the individual situation and the honesty of the medium involved. What almost everyone agrees on is this: the wish to believe that the people we love do not simply disappear when they die is completely understandable — and it is one of the most powerful and universal feelings that human beings share.`,
    vocab: [
      { word: 'Grief', definition: 'The deep sadness and pain felt when someone you love dies.' },
      { word: 'Vulnerable', definition: 'In a weak position — more easily hurt, cheated, or influenced than usual.' },
      { word: 'Processing', definition: 'Working through something emotionally — thinking and feeling your way through a difficult experience.' },
      { word: 'Universal', definition: 'True for everyone, everywhere — something that all people share regardless of culture or background.' },
    ],
    questions: [
      { n: 10, q: 'Do you think it is acceptable for a medium to charge money for their services even if they are not genuinely supernatural? Why?' },
      { n: 11, q: 'Have you ever known someone who visited a medium after losing a loved one? Did it help them?' },
      { n: 12, q: 'Do you believe that our personalities and consciousness survive death in some form? What do you think happens after we die?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise English discussion skills. The reading topic is "Mediums and Talking to the Dead". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use clear, simple language suitable for B1 level. Always end with one natural follow-up question. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function MediumsTalkingToDeadPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #1a0a2e 0%, #4a1272 50%, #7c3aed 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#8b5cf6', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(139,92,246,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Belief & Mystery</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Mediums — Can People Really Talk to the Dead?</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Between Worlds — explore the history of mediums, how they claim to work, what scientists say, and why so many people find comfort in the idea of speaking with the dead.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#8b5cf6' : '#e5e7eb', background: translationLang !== 'none' ? '#f5f3ff' : 'white', color: translationLang !== 'none' ? '#6d28d9' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
