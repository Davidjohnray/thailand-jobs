...
const PARTS = [
  {
    number: 1, title: 'How the Moon Was Born', emoji: '💥', color: '#8b5cf6',
    text: `Look up at the night sky on a clear evening and you will see the Moon — Earth's closest neighbour in space and our only natural satellite. It is the fifth largest moon in our entire solar system, and it is the only place beyond Earth where human beings have ever stood. But how did the Moon get there in the first place?\n\nScientists believe the Moon was born about 4.5 billion years ago — not long after Earth itself formed. Back then, our solar system was a chaotic, violent place, full of enormous rocks and chunks of material flying through space. One of these objects, a planet roughly the size of Mars, crashed into the young Earth with enormous force. Scientists have given this mysterious planet a name — Theia.\n\nThe collision was one of the most powerful events in the history of our solar system. Theia was completely destroyed, and a huge amount of material from both Theia and the young Earth was thrown out into space. This material formed a ring of debris around Earth, a bit like the rings around Saturn. Over millions of years, this debris slowly clumped together under the force of gravity, and the Moon was formed.\n\nThis explanation is called the Giant Impact Hypothesis, and most scientists today believe it is correct. We have strong evidence for it because the rocks brought back from the Moon by astronauts are made of almost exactly the same materials as rocks on Earth — which is exactly what we would expect if the Moon was partly made from Earth itself.\n\nIt is a remarkable story — our beautiful, peaceful Moon was born from one of the most violent events imaginable.`,
    vocab: [
      { word: 'Satellite', definition: 'An object that travels around a planet in space. The Moon is Earth\'s natural satellite.' },
      { word: 'Chaotic', definition: 'Very messy and with no order — completely out of control.' },
      { word: 'Debris', definition: 'Pieces of broken material left behind after something is destroyed.' },
      { word: 'Hypothesis', definition: 'A scientific idea that tries to explain something, which scientists then test to see if it is correct.' },
    ],
    questions: [
      { n: 1, q: 'Does it surprise you that the Moon was formed from a massive collision? What did you think before reading this?' },
      { n: 2, q: 'Scientists named the planet that hit Earth "Theia." Why do you think scientists give names to things that no longer exist?' },
      { n: 3, q: 'The Moon rocks brought back by astronauts match Earth rocks. Why is this such important evidence for the Giant Impact Hypothesis?' },
    ]
  },
  {
    number: 2, title: 'Why Does the Moon Glow?', emoji: '🌕', color: '#7c3aed',
    text: `Have you ever wondered why the Moon looks so bright in the night sky? It seems to shine like a lamp — but the Moon does not actually produce any light of its own. It has no fires burning on it, and it is not a star. So where does the light come from?\n\nThe answer is the Sun. The Moon reflects sunlight — just like a mirror. When sunlight hits the surface of the Moon, some of it bounces back towards Earth, and that reflected light is what we see as the bright white glow of the Moon in the sky. The Moon is actually quite dark — its surface is a dull grey colour, and it reflects only about 12% of the light that hits it. But because space is so dark, even this small amount of reflected light is enough to make the Moon look very bright to us.\n\nThis also explains why the Moon appears to change shape throughout the month. The Moon does not actually change shape — it is always a sphere. What changes is how much of the sunlit side we can see from Earth, depending on where the Moon is in its journey around our planet. When the Moon is between Earth and the Sun, the sunlit side faces away from us and we cannot see it — this is called a new moon. When Earth is between the Moon and the Sun, we can see the entire sunlit side — this is called a full moon.\n\nThe Moon takes about 27 days to complete one orbit around Earth. Interestingly, the Moon also rotates at almost exactly the same speed as it orbits — which means the same side of the Moon always faces Earth. The other side — sometimes called the "dark side of the Moon" — was completely invisible to humans until the first spacecraft flew around it in 1959.`,
    vocab: [
      { word: 'Reflects', definition: 'Bounces light back from a surface, the way a mirror does.' },
      { word: 'Sphere', definition: 'A perfectly round shape, like a ball.' },
      { word: 'Orbit', definition: 'The path that one object in space takes as it travels around another object.' },
      { word: 'Rotates', definition: 'Spins around on its own centre, the way a spinning top does.' },
    ],
    questions: [
      { n: 4, q: 'Before reading this, did you know the Moon does not produce its own light? Does this change how you think about it?' },
      { n: 5, q: 'Can you explain in your own words why the Moon appears to change shape during the month?' },
      { n: 6, q: 'The same side of the Moon always faces Earth, so humans never saw the other side until 1959. How do you think people felt when they finally saw it?' },
    ]
  },
  {
    number: 3, title: 'Walking on the Moon', emoji: '👨‍🚀', color: '#6d28d9',
    text: `On 20 July 1969, astronaut Neil Armstrong climbed down the ladder of a spacecraft called the Eagle and stepped onto the surface of the Moon. He became the first human being ever to walk on another world. His first words were famous around the world: "That's one small step for man, one giant leap for mankind."\n\nThe Apollo 11 mission, as it was called, was the result of years of hard work by hundreds of thousands of scientists, engineers, and astronauts. In 1961, US President John F. Kennedy had challenged the American space agency NASA to land a human on the Moon before the end of the decade — and they succeeded, with just five months to spare.\n\nWhat was it actually like to walk on the Moon? The astronauts who went there — twelve in total, between 1969 and 1972 — described a completely alien experience. The Moon has no atmosphere, which means there is no air, no wind, no weather, and no sound. If two astronauts stood next to each other on the Moon and tried to talk, they would hear nothing — sound cannot travel without air. They communicated through radios inside their spacesuits.\n\nThe Moon's gravity is about six times weaker than Earth's gravity. This means that on the Moon, you would weigh only one sixth of what you weigh on Earth. The astronauts found that they could jump much higher than on Earth. But moving around was still difficult — their spacesuits were very heavy and stiff, and the surface of the Moon is covered in a thick layer of fine grey dust called regolith, which stuck to everything.\n\nThe astronauts described the view as breathtaking. The sky was completely black even during the day — because there is no atmosphere to scatter sunlight and make the sky look blue. Earth hung in the sky like a beautiful blue and white marble, slowly rotating.`,
    vocab: [
      { word: 'Atmosphere', definition: 'The layer of gases surrounding a planet. Earth\'s atmosphere gives us air to breathe and makes our sky blue.' },
      { word: 'Gravity', definition: 'The invisible force that pulls objects towards each other. Earth\'s gravity keeps us on the ground.' },
      { word: 'Regolith', definition: 'The layer of loose dust and broken rock that covers the surface of the Moon.' },
      { word: 'Scatter', definition: 'To spread something in many different directions at once.' },
    ],
    questions: [
      { n: 7, q: 'Imagine you are Neil Armstrong stepping onto the Moon for the first time. What do you think you would feel in that moment?' },
      { n: 8, q: 'The Moon has no sound because there is no air. How do you think this would make you feel — peaceful, frightening, or something else?' },
      { n: 9, q: 'The astronauts saw Earth from the Moon as a "beautiful blue and white marble." Why do you think this experience changed the way many of them thought about our planet?' },
    ]
  },
  {
    number: 4, title: 'The Moon and Our Future', emoji: '🚀', color: '#5b21b6',
    text: `No human has walked on the Moon since 1972. For fifty years, our closest neighbour in space has gone unvisited. But that is about to change. Space agencies from the United States, Europe, China, and other countries are all planning to return to the Moon — and this time, they want to stay.\n\nNASA's Artemis programme aims to send astronauts back to the Moon, including the first woman ever to walk on its surface. Scientists want to build a permanent base on the Moon — a station where astronauts could live and work for months at a time, similar to how scientists live at research stations in Antarctica today.\n\nWhy go back? There are several exciting reasons. The Moon contains a mineral called helium-3 in its soil, which could one day be used as fuel for nuclear fusion reactors — a clean and powerful source of energy. There is also water ice hidden in deep craters near the Moon's south pole, where sunlight never reaches. This water could be split into hydrogen and oxygen — providing both drinking water and rocket fuel for future space missions.\n\nBut perhaps the most exciting reason is that the Moon could be a stepping stone for further exploration of space. Mars is the most likely next destination for human explorers. A base on the Moon would allow astronauts to practice living in space for long periods, test new equipment, and even launch missions to Mars from the Moon's surface — where the weaker gravity makes it much easier and cheaper to launch rockets.\n\nThe Moon has fascinated human beings since the beginning of history. People have written poems, told stories, and sung songs about it for thousands of years. Now, as we prepare to return, the Moon is no longer just a beautiful light in the night sky — it is a destination, a resource, and a doorway to the rest of the solar system.`,
    vocab: [
      { word: 'Permanent', definition: 'Lasting for a very long time or forever — not temporary.' },
      { word: 'Nuclear fusion', definition: 'A process that produces enormous amounts of energy by joining atoms together — the same process that powers the Sun.' },
      { word: 'Craters', definition: 'Large circular holes on the surface of the Moon or a planet, made by rocks crashing into it from space.' },
      { word: 'Stepping stone', definition: 'Something that helps you get to a further goal, one step at a time.' },
    ],
    questions: [
      { n: 10, q: 'Would you like to visit the Moon one day if it were possible? What would you most want to see or do there?' },
      { n: 11, q: 'Scientists want to build a permanent base on the Moon. What do you think would be the hardest challenge about living there?' },
      { n: 12, q: 'The passage says the Moon is "a doorway to the rest of the solar system." If humans could travel anywhere in the solar system, where do you think they should go next and why?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly and enthusiastic English conversation partner helping a B1 level student aged 10-12 practise English discussion skills. The reading topic is "The Moon — how it formed, why it glows, and what it's like to walk on it". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear, exciting language for a young learner. Be enthusiastic about space! Always end with one fun follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#faf5ff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #ede9fe' }}>💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your full answer, then tap <strong>⏹ Stop & Send</strong>.</div>}
      {messages.length > 0 && (
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && <div style={{ background: '#faf5ff', border: '1px solid #ede9fe', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}><span style={{ color: color, fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>🌍 Translation</span>{m.translation}</div>}
              </div>
            </div>
          ))}
...
export default function MoonPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0d0520 0%, #2e1065 50%, #4c1d95 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(139,92,246,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Science & Space</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>The Moon</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>How was it born from a giant collision? Why does it glow? And what was it really like for astronauts to walk on its surface?</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#8b5cf6' : '#e5e7eb', background: speed === s.value ? '#8b5cf6' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#faf5ff', padding: '8px 28px', borderBottom: '1px solid #ede9fe' }}>
              <span style={{ color: '#6d28d9', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#8b5cf6' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#faf5ff', border: '1px solid #ede9fe', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#6d28d9', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(139,92,246,0.15)', border: '1px solid rgba(139,92,246,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#c4b5fd', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b1" style={{ color: '#8b5cf6', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B1 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #ede9fe', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#faf5ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #ede9fe', color: '#9ca3af', fontSize: '15px' }}>{translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}</div>
            ) : (
