...
const PARTS = [
  {
    number: 1, title: 'The Character Nobody Created', emoji: '🤖', color: '#dc2626',
    text: `It looks like a cartoon stick with googly eyes. Its name is Tung Tung Sahur and it is one of the most recognised characters on the internet. This week, a legal battle began over a question nobody has answered before: who owns an AI-generated character?\n\nTung Tung is part of "Italian brainrot" — absurdist internet content featuring bizarre characters with Italian-sounding names, created using AI image generators. The legal problem: the person who typed the prompt did not draw the character and could not predict what the AI would produce. So who is the creator?\n\nCurrent copyright law requires a "human author" who made creative decisions. But typing "weird Italian stick character with eyes" into an AI involves very few decisions. The AI made most of the choices. This means Tung Tung — one of the most popular characters online — may not be owned by anyone.\n\nMerchandise is already being sold worldwide. Unofficial products appeared on Amazon and Alibaba before anyone established ownership rights. The speed of internet culture has outpaced the speed of the law.`,
    vocab: [
      { word: 'Copyright', definition: 'The legal right to control how a creative work is used — who can copy, sell, or share it.' },
      { word: 'Absurdist', definition: 'Deliberately strange and meaningless — humour based on things that make no sense.' },
      { word: 'Prompt', definition: 'A text instruction given to an AI system telling it what to create.' },
      { word: 'Merchandise', definition: 'Products like t-shirts, toys, and mugs featuring a character or brand.' },
    ],
    questions: [
      { n: 1, q: 'Who should own Tung Tung — the person who typed the prompt, the AI company, or nobody?' },
      { n: 2, q: 'Why do bizarre, meaningless characters become so popular on the internet?' },
      { n: 3, q: 'If nobody owns the character, can anyone sell products with its image?' },
    ]
  },
  {
    number: 2, title: 'Who Is an Author?', emoji: '✍️', color: '#b91c1c',
    text: `When an artist paints, they make thousands of decisions — colours, brushstrokes, composition. Copyright protects those decisions. When a photographer takes a photo, they choose the angle, timing, and framing. Courts protect those choices too.\n\nBut when someone types a prompt into an AI generator, the machine makes most decisions. The AI chooses colours, shapes, proportions, and style. The human contribution is a few words. Is that enough to be an "author"?\n\nThe US Copyright Office says no — AI-generated images cannot be copyrighted because they lack human authorship. But China has granted copyright to some AI works. The EU is still debating. Different countries may reach different conclusions.\n\nThe question matters beyond Tung Tung. AI can now generate images, music, text, and video. If these creations cannot be owned, the entire business model of creative industries could change. If they can be owned, we need new rules about what counts as human creativity.`,
    vocab: [
      { word: 'Authorship', definition: 'Being the person who created a work — making the creative decisions that shaped it.' },
      { word: 'Composition', definition: 'How elements are arranged in a work of art — the layout and structure.' },
      { word: 'Legal landscape', definition: 'The current state of laws on a topic — how the rules stand.' },
      { word: 'Creative industries', definition: 'Businesses based on creating content — art, music, film, design, writing.' },
    ],
    questions: [
      { n: 4, q: 'A painter makes thousands of decisions. An AI prompter makes a few. Where is the line between creating and requesting?' },
      { n: 5, q: 'The US says AI art cannot be copyrighted. China says it can. Which is correct?' },
      { n: 6, q: 'If AI characters cannot be owned, what happens to the business of creating characters for films and games?' },
    ]
  },
  {
    number: 3, title: 'The Meme Economy', emoji: '💰', color: '#991b1b',
    text: `Within weeks of going viral, Tung Tung appeared on t-shirts, phone cases, stickers, and plush toys. Content creators earned thousands from advertising revenue. The character appeared in video games as unofficial mods.\n\nThis pattern — internet culture becoming commerce overnight — is increasingly common. Memes, viral dances, and AI-generated characters generate significant value before anyone figures out who owns them.\n\nFor young content creators, this raises practical questions. If you create a character using AI and it goes viral, can you profit from it? Can someone else profit without your permission? Can you sue them? Right now, the answers are unclear.\n\nThe Tung Tung case highlights a fundamental tension in the digital age: the internet moves at the speed of culture, but the law moves at the speed of courts. By the time a judge rules on who owns Tung Tung, the character may already have been replaced by the next viral sensation.`,
    vocab: [
      { word: 'Viral', definition: 'Spreading rapidly across the internet, shared by millions of people.' },
      { word: 'Revenue', definition: 'Income earned — money generated from a business activity.' },
      { word: 'Mods', definition: 'Modifications to a video game — adding new characters or features.' },
      { word: 'Sensation', definition: 'Something that causes great excitement and widespread interest.' },
    ],
    questions: [
      { n: 7, q: 'Tung Tung went from joke to million-dollar merchandise in weeks. How does the internet turn worthless things into valuable ones?' },
      { n: 8, q: 'Unofficial merchandise appeared before anyone knew who owned the character. Is this fair?' },
      { n: 9, q: 'The internet moves faster than the law. Is this always a problem?' },
    ]
  },
  {
    number: 4, title: 'Creativity in the Age of AI', emoji: '🎨', color: '#7f1d1d',
    text: `AI can now produce beautiful paintings in seconds, write songs millions enjoy, and generate characters that go viral. This raises fundamental questions about creativity.\n\nFor professional artists and designers, AI is both tool and threat. It helps them work faster and explore new ideas. But it can also replace them — if a company can generate images using AI for free, why pay a designer?\n\nThe deeper question is philosophical. If an AI can create something beautiful, does that diminish human art? If a machine writes a song people love, does it matter that no human felt the emotions it expresses?\n\nA cartoon stick with googly eyes might seem like an unlikely place for these questions to be decided. But the law often works this way — the most important precedents are set by the strangest cases. The Tung Tung copyright battle is funny. The questions it raises will affect every creative person on the planet.`,
    vocab: [
      { word: 'Diminish', definition: 'To make something seem less valuable or impressive.' },
      { word: 'Philosophical', definition: 'Relating to deep questions about existence, knowledge, and meaning.' },
      { word: 'Precedents', definition: 'Previous legal decisions that guide how future cases will be decided.' },
      { word: 'Prevalent', definition: 'Widespread and common — found everywhere.' },
    ],
    questions: [
      { n: 10, q: 'If AI can paint beautifully in seconds, does that make human art less valuable?' },
      { n: 11, q: 'Should AI be allowed to learn from human art without paying artists?' },
      { n: 12, q: 'A cartoon stick might set legal precedents for all AI creativity. Why do small cases sometimes have big consequences?' },
    ]
  },
]
...
export default function TungTungPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Who Owns Tung Tung?</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A legal battle over a viral AI-generated meme character could set the rules for who owns AI creativity. Memes, copyright, and the age of AI.</p>
            </div>
          </div>
