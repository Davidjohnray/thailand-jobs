...
const PARTS = [
  {
    number: 1, title: 'The Skies Over Rwanda', emoji: '🚁', color: '#dc2626',
    text: `Look up at the sky in Rwanda, and you might see something unusual. Small, unmanned aircraft — drones — constantly fly overhead, carrying blood, vaccines, medicines, and other medical supplies to hospitals and health clinics across the country. Rwanda has become the world leader in medical drone delivery, and the technology is saving lives every single day.\n\nThe story began in 2016, when the Rwandan government partnered with an American company called Zipline to launch the world's first national drone delivery service for medical supplies. The idea was simple but revolutionary: instead of sending a truck along bumpy, unpaved roads for hours to deliver urgent blood supplies to a remote hospital, send a drone that can make the same journey in minutes.\n\nThe results have been remarkable. Zipline's drones now make more than 500 deliveries per day across Rwanda, serving more than 12 million people. They can deliver blood, vaccines, and medicines to any hospital in the country within 30 minutes of receiving an order. For patients who need emergency blood transfusions — particularly mothers experiencing dangerous bleeding during childbirth — those 30 minutes can mean the difference between life and death.\n\nThe drones are small, autonomous aircraft with a wingspan of about two metres. They are launched from distribution centres using a catapult system, fly to the destination at speeds of up to 100 kilometres per hour, and drop their cargo using a small parachute before returning to base. The entire process — from order to delivery — is faster than calling a taxi in most cities.`,
    vocab: [
      { word: 'Unmanned', definition: 'Without a human pilot or operator on board — controlled remotely or by a computer.' },
      { word: 'Autonomous', definition: 'Able to operate independently without human control — making its own decisions.' },
      { word: 'Transfusion', definition: 'The process of transferring blood from one person into the body of another person who needs it.' },
      { word: 'Catapult', definition: 'A device that launches something into the air with great force and speed.' },
    ],
    questions: [
      { n: 1, q: 'Drones can deliver blood in 30 minutes instead of hours by truck. How many lives do you think this saves?' },
      { n: 2, q: 'Rwanda is a small African country but leads the world in drone delivery. Does this surprise you? What does it tell us about innovation?' },
      { n: 3, q: 'Would you trust a drone to deliver medicine to you? What are the advantages and disadvantages compared to a human driver?' },
    ]
  },
  {
    number: 2, title: 'Why Rwanda?', emoji: '🇷🇼', color: '#b91c1c',
    text: `Rwanda might seem like an unlikely place to lead a technology revolution. It is a small, landlocked country in East Africa with a population of about 14 million people. Just 32 years ago, it suffered one of the worst tragedies in modern history — the 1994 genocide, in which approximately 800,000 people were killed in just 100 days.\n\nBut Rwanda's recovery from the genocide has been extraordinary. Under President Paul Kagame, the country has invested heavily in technology, infrastructure, and innovation. Rwanda consistently ranks as one of the best places in Africa to do business. Its capital, Kigali, is famously clean and well-organised. Internet coverage reaches most of the population. And the government has been willing to take risks on new technologies — like drone delivery — that more cautious countries have avoided.\n\nRwanda's geography actually makes it an ideal testing ground for drone technology. The country is hilly and rural, with many communities accessible only by unpaved roads that become impassable during the rainy season. A journey that takes a drone 15 minutes might take a truck four hours — if the truck can get through at all. In these conditions, drones are not a luxury or a novelty — they are a practical necessity.\n\nThe success of the drone programme has attracted global attention. Countries including Ghana, Nigeria, Japan, and the United States have launched similar programmes, many using the same Zipline technology that was first tested in Rwanda. A small African country, still recovering from tragedy, has shown the rest of the world how technology can save lives.`,
    vocab: [
      { word: 'Landlocked', definition: 'A country that is completely surrounded by land — it has no coastline or access to the sea.' },
      { word: 'Genocide', definition: 'The deliberate killing of a very large number of people from a particular ethnic group.' },
      { word: 'Impassable', definition: 'Impossible to travel through — a road that is blocked, flooded, or too damaged to use.' },
      { word: 'Novelty', definition: 'Something new and unusual that is interesting because it is different — not a serious solution.' },
    ],
    questions: [
      { n: 4, q: 'Rwanda suffered a terrible genocide in 1994 but has rebuilt remarkably. What do you think drives a country to recover from such a tragedy?' },
      { n: 5, q: 'Rwanda took a risk on drone technology that other countries avoided. Why do you think some countries are more willing to try new ideas than others?' },
      { n: 6, q: 'The passage says a small African country showed the world how technology can save lives. How does this challenge stereotypes about Africa and technology?' },
    ]
  },
  {
    number: 3, title: 'Drones Around the World', emoji: '🌍', color: '#991b1b',
    text: `Rwanda pioneered medical drone delivery, but the technology is now spreading rapidly around the world — and the applications go far beyond medicine.\n\nIn Ghana, drones deliver vaccines to remote villages, helping the country achieve some of the highest vaccination rates in West Africa. In the Philippines, drones are used to deliver food and supplies to communities cut off by typhoons and flooding. In Scotland, drones carry medical supplies between hospitals on remote islands. In the United States, companies like Amazon and Walmart are testing drone delivery for everyday items — groceries, prescriptions, and household goods.\n\nBut medical delivery remains the most impactful application. In many developing countries, the biggest challenge in healthcare is not a lack of medicine — it is getting medicine to the people who need it. Roads are poor, distances are long, and the supply chain between warehouses and rural clinics is unreliable. Drones bypass all of these problems. They do not need roads. They are not affected by traffic or flooding. They can operate 24 hours a day, seven days a week.\n\nThe technology is not without challenges. Drones have limited range and carrying capacity — they work well for lightweight, urgent deliveries but cannot replace trucks for large shipments. Weather can ground them in extreme conditions. There are concerns about noise, privacy, and the safety of flying objects over populated areas. And in some countries, regulations have not kept pace with the technology, creating legal uncertainty about where and how drones can operate.\n\nDespite these challenges, the growth of drone delivery has been explosive. The global drone delivery market is expected to be worth more than 30 billion dollars by 2030. What started as an experiment in a small African country is becoming a global industry.`,
    vocab: [
      { word: 'Pioneered', definition: 'Was the first to develop or use something new — led the way for others.' },
      { word: 'Supply chain', definition: 'The network of steps involved in getting a product from where it is made to where it is needed.' },
      { word: 'Bypass', definition: 'To go around something — to avoid a problem or obstacle entirely.' },
      { word: 'Regulations', definition: 'Official rules made by a government that control how something is done.' },
    ],
    questions: [
      { n: 7, q: 'Drones are used for medicine in Africa and groceries in America. Which use do you think is more important? Why?' },
      { n: 8, q: 'Would you like drone delivery in your area? What would you want delivered — and what concerns would you have?' },
      { n: 9, q: 'The global drone delivery market will be worth 30 billion dollars by 2030. Is this a good thing or should we be cautious about filling the sky with drones?' },
    ]
  },
  {
    number: 4, title: 'Technology That Helps People', emoji: '💚', color: '#7f1d1d',
    text: `In a week dominated by news about AI hacking computers, wildfires, and political crises, the story of drones delivering medicine in Rwanda offers something different: a reminder that technology can be used to make the world genuinely better.\n\nThe tech industry often talks about changing the world, but the changes it delivers are frequently trivial — a slightly better camera on a smartphone, a faster way to order food, a more addictive social media algorithm. Rwanda's drone programme is different because it solves a problem that genuinely matters: people dying because medicine cannot reach them in time. It is technology with a clear, measurable, life-saving purpose.\n\nThe programme also challenges the assumption that innovation flows from rich countries to poor countries. In this case, the innovation flowed the other way — Rwanda adopted drone delivery years before the United States, Europe, or Japan. A country that many people could not find on a map is leading the world in a technology that will define the future of logistics and healthcare.\n\nFor students learning English and thinking about the world, Rwanda's drone programme raises important questions about where ideas come from, who benefits from technology, and what kind of innovation we should be investing in. Should technology serve convenience or necessity? Should it make comfortable lives slightly more comfortable, or should it make difficult lives significantly better?\n\nScooter the beagle ate a kilogram of gummy worms and the internet loved it. In Rwanda, a drone delivered blood to a mother who would have died without it, and almost nobody noticed. Both stories tell us something important about the world we live in — and about the stories we choose to pay attention to.`,
    vocab: [
      { word: 'Trivial', definition: 'Not important or serious — small and insignificant.' },
      { word: 'Algorithm', definition: 'A set of rules that a computer follows to solve problems or make decisions.' },
      { word: 'Logistics', definition: 'The planning and organisation of moving things from one place to another efficiently.' },
      { word: 'Necessity', definition: 'Something that is absolutely needed — essential for survival or basic wellbeing.' },
    ],
    questions: [
      { n: 10, q: 'The passage says most tech innovation is trivial — better cameras, faster food ordering. Do you agree? What technology has genuinely improved your life?' },
      { n: 11, q: 'Rwanda adopted drone delivery before the US or Europe. What does this tell us about where innovation can come from?' },
      { n: 12, q: 'A drone saved a life in Rwanda and nobody noticed. A dog ate gummy worms and went viral. What does this say about the stories we pay attention to?' },
    ]
  },
]
...
export default function RwandaDronesPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Drones Deliver Medicine in Rwanda</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Drones in Rwanda make 500 medical deliveries per day, saving lives that would be lost waiting for trucks on unpaved roads. How a small African country leads the world.</p>
            </div>
          </div>
