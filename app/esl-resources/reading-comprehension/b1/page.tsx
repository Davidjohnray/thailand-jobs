...
const CATEGORIES = [
  {
    ...
    lessons: [
      ...
      { id: 'typhoon-dolphin', title: 'Typhoon Dolphin Forces One Million to Evacuate', emoji: '🌀', description: 'China Hit by Massive Storm', detail: 'Typhoon Dolphin hit China with 180km/h winds, forcing one million people to flee. Are storms getting worse, and how do you live on the front line?', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-08-13' },
      { id: 'italy-art-thieves', title: 'Art Thieves Strike Twice in Italy', emoji: '🖼️', description: 'Stolen Twice in One Weekend', detail: 'Police recovered three stolen paintings on Friday. By Saturday, four more were stolen. Italy art crime problem and why protecting the past matters.', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-08-13' },
      { id: 'syria-assad-sentence', title: 'Syria Sentences Assad to Death', emoji: '⚖️', description: 'Justice After the War', detail: 'A Syrian court sentenced former President Assad to death for crimes during the civil war. What happened, can Syria rebuild, and what can the world learn?', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-08-13' },
      { id: 'colombia-earthquake', title: 'Earthquake Kills Hundreds in Colombia', emoji: '🏚️', description: 'A 7.4 Magnitude Disaster', detail: 'A powerful earthquake struck Colombia, killing 265 people and leaving thousands missing. Why earthquakes kill, and why poverty makes them worse.', badges: ['4 parts', '12 questions'], color: '#dc2626', publishedDate: '2026-08-13' },
      { id: 'eclipse-today', title: 'The Sun Disappeared Today', emoji: '🌑', description: 'Total Solar Eclipse Crosses Europe', detail: 'Today the Moon blocked the Sun over Europe and North Africa. How eclipses work, why ancient people feared them, and why looking up still matters.', badges: ['4 parts', '12 questions'], color: '#991b1b', publishedDate: '2026-08-13' },
      { id: 'turkey-kurdish-peace', title: 'Turkey Offers Peace to Kurdish Fighters', emoji: '🕊️', description: '40 Years of War — Can It Finally End?', detail: 'Turkey voted to pardon thousands of Kurdish fighters after 40 years of conflict. Who are the Kurds, why have they been fighting, and can peace work?', badges: ['4 parts', '12 questions'], color: '#b91c1c', publishedDate: '2026-08-13' },
