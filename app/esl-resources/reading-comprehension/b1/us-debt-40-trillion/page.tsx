...
const PARTS = [
  {
    number: 1, title: 'The 40 Trillion Dollar Number', emoji: '💵', color: '#dc2626',
    text: `This week, the United States national debt passed 40 trillion dollars for the first time in history. That number is so large that it is almost impossible to understand. If you counted one dollar per second, it would take you more than 1.2 million years to reach 40 trillion. If you stacked 40 trillion one-dollar bills on top of each other, the pile would reach from Earth to the Moon and back — more than 20 times.\n\nThe national debt is the total amount of money that the US government owes. Every year, the government spends more than it collects in taxes. The difference — called the deficit — is borrowed by selling government bonds to investors, banks, foreign governments, and ordinary people. Over time, these annual deficits add up to form the national debt.\n\nThe United States has been in debt for almost its entire history — it borrowed money to fight the Revolutionary War in the 1770s. But the speed at which the debt has grown in recent decades is unprecedented. In 2000, the national debt was about 5.7 trillion dollars. By 2010, it had doubled to 13.5 trillion. By 2020, it had nearly doubled again to 27 trillion. And now, just six years later, it has passed 40 trillion.\n\nThe milestone received surprisingly little attention in the news — perhaps because the number is so large that people have stopped being shocked by it. But economists warn that ignoring the growing debt is dangerous, and that the consequences of borrowing at this scale will eventually affect every person in the country — and many people beyond it.`,
    vocab: [
      { word: 'National debt', definition: 'The total amount of money a government owes — accumulated over many years of borrowing.' },
      { word: 'Deficit', definition: 'The gap between what a government spends and what it earns — spending more than income.' },
      { word: 'Bonds', definition: 'A type of loan — investors give money to the government and receive it back later with interest.' },
      { word: 'Unprecedented', definition: 'Never having happened before — without any previous example.' },
    ],
    questions: [
      { n: 1, q: '40 trillion dollars is impossible to imagine. Why do you think governments allow debt to grow this large?' },
      { n: 2, q: 'The debt doubled three times in 20 years. What is causing this acceleration?' },
      { n: 3, q: 'This milestone received little attention. Why do you think people have stopped being shocked by big numbers?' },
    ]
  },
  {
    number: 2, title: 'Where Does the Money Go?', emoji: '📊', color: '#b91c1c',
    text: `To understand why the US debt is so large, you need to understand where the government spends its money.\n\nThe biggest category is social programmes. Social Security — the system that provides income to retired Americans — and Medicare — the programme that provides healthcare to people over 65 — together account for roughly 40% of all government spending. These programmes are popular and politically untouchable — no politician who wants to be re-elected would vote to cut them.\n\nMilitary spending is the next largest category. The United States spends more on its military than the next ten countries combined — approximately 900 billion dollars per year. This funds the world's most powerful armed forces, more than 750 military bases around the world, and ongoing operations in multiple regions.\n\nInterest on the existing debt is now one of the fastest-growing expenses. As the debt grows, the amount of interest the government must pay on that debt grows too. In 2026, the US government will spend approximately 1 trillion dollars just on interest payments — more than it spends on the military. This is money that produces nothing — no schools, no roads, no healthcare — it simply services the cost of past borrowing.\n\nTax cuts have also contributed to the debt. Over the past 25 years, multiple rounds of tax reductions — particularly for corporations and high-income individuals — have reduced the amount of money the government collects, widening the gap between spending and revenue.\n\nThe result is a government that spends far more than it earns, borrows the difference, and pays an ever-growing amount of interest on what it has already borrowed.`,
    vocab: [
      { word: 'Social Security', definition: 'A US government programme that provides income to retired people and people with disabilities.' },
      { word: 'Medicare', definition: 'A US government programme that provides healthcare to people aged 65 and older.' },
      { word: 'Interest payments', definition: 'Money paid to lenders as the cost of borrowing — the price of using someone else money.' },
      { word: 'Revenue', definition: 'Income — the money a government collects through taxes and other sources.' },
    ],
    questions: [
      { n: 4, q: 'The US spends 1 trillion dollars a year just on interest. What else could that money be used for?' },
      { n: 5, q: 'Social Security and Medicare are popular but expensive. Should they be cut to reduce debt, or is there another solution?' },
      { n: 6, q: 'The US spends more on military than the next ten countries combined. Is this necessary? What would happen if it spent less?' },
    ]
  },
  {
    number: 3, title: 'Does Debt Matter?', emoji: '🤔', color: '#991b1b',
    text: `Economists disagree about how dangerous the national debt actually is — and the debate is one of the most important in modern economics.\n\nSome economists argue that the debt is a serious problem that will eventually lead to a crisis. Their reasoning is straightforward: the more a government borrows, the more interest it must pay. As interest payments consume a larger share of the budget, there is less money available for everything else — education, healthcare, infrastructure, defence. Eventually, lenders may lose confidence that the government can repay its debts, and they will demand higher interest rates — making the problem even worse. This is what happened to Greece in 2010, when investors lost faith in the Greek government's ability to repay, triggering a financial crisis that devastated the country for years.\n\nOther economists argue that the US debt is manageable — and that worrying about it too much could actually cause harm. Their reasoning is that the United States is in a unique position: the US dollar is the world's primary reserve currency, meaning that most international trade and financial transactions are conducted in dollars. This creates constant global demand for US government bonds, keeping interest rates low. As long as this demand continues, the US can borrow at lower rates than almost any other country.\n\nBoth sides agree on one thing: the current trajectory — where debt grows faster than the economy — is unsustainable in the long run. The disagreement is about how urgent the problem is and what should be done about it.`,
    vocab: [
      { word: 'Reserve currency', definition: 'A currency held by governments worldwide for international trade — the US dollar is the main one.' },
      { word: 'Unsustainable', definition: 'Cannot continue at the current rate — will eventually fail or collapse.' },
      { word: 'Trajectory', definition: 'The path something is following — the direction and speed of change over time.' },
      { word: 'Confidence', definition: 'Trust or belief that something will work or succeed — faith in a system.' },
    ],
    questions: [
      { n: 7, q: 'Greece had a debt crisis in 2010. Could the same happen to the United States? Why or why not?' },
      { n: 8, q: 'The US dollar is the world reserve currency, which helps America borrow cheaply. What would happen if this changed?' },
      { n: 9, q: 'Both sides agree the current path is unsustainable. What should be done — raise taxes, cut spending, or something else?' },
    ]
  },
  {
    number: 4, title: 'Why Should You Care?', emoji: '🌏', color: '#7f1d1d',
    text: `You might be wondering why an ESL student in Thailand should care about the US national debt. The answer is simple: the American economy is so large and so interconnected with the rest of the world that what happens to US finances affects everyone.\n\nIf the US government has to pay more interest on its debt, it may cut spending on programmes that affect global stability — military alliances, foreign aid, development assistance. Countries that rely on American support would feel the impact directly.\n\nIf confidence in US government bonds falls, global financial markets would be disrupted. Interest rates would rise worldwide. Borrowing would become more expensive for governments, businesses, and individuals everywhere — including in Thailand. The 2008 financial crisis, which began in the American housing market, caused a global recession that affected virtually every country on Earth. A US debt crisis could be even worse.\n\nThe US debt also raises questions that every country must answer. How much should a government borrow? How should it balance spending on things people need now — healthcare, education, infrastructure — with the cost of paying for them later? What obligations does one generation have to the next?\n\nThailand's public debt is approximately 62% of GDP — lower than the US but rising steadily. Every country faces the same fundamental challenge: how to invest in the present without bankrupting the future. The 40 trillion dollar milestone in America is a warning — not just for Americans, but for everyone — about what happens when that balance is lost.`,
    vocab: [
      { word: 'Financial markets', definition: 'The systems where stocks, bonds, currencies, and other financial products are bought and sold.' },
      { word: 'Recession', definition: 'A period when the economy shrinks — businesses close, people lose jobs, spending falls.' },
      { word: 'GDP', definition: 'Gross Domestic Product — the total value of everything a country produces, measuring economic size.' },
      { word: 'Bankrupting', definition: 'Using up all money and resources — being unable to pay debts.' },
    ],
    questions: [
      { n: 10, q: 'The 2008 US financial crisis affected every country. Could a US debt crisis be even worse? How would it affect Thailand?' },
      { n: 11, q: 'Thailand debt is 62% of GDP and rising. Should you be worried? What should the Thai government prioritise?' },
      { n: 12, q: 'What obligations does one generation have to the next? Is it fair to borrow money that future generations will have to repay?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US Debt Hits $40 Trillion</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The US national debt passed 40 trillion dollars this week. Where does the money go, does debt matter, and why should people outside America care?</p>
            </div>
          </div>
