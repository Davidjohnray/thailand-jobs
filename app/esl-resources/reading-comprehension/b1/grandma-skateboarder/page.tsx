...
const PARTS = [
  {
    number: 1, title: 'Age Is Just a Number', emoji: '🛹', color: '#dc2626',
    text: `This week, a 66-year-old grandmother from California extended her record as the world's oldest female competitive skateboarder. While most people her age are settling into retirement, she strapped on a helmet, stepped onto a board, and competed against skaters less than half her age. She did not win — but winning was never the point.\n\nSkateboarding is a sport dominated by teenagers and young adults. The average age of competitors at the Olympic Games skateboarding events is around 20. The youngest Olympic skateboarding medallist was just 13 years old. In this context, a 66-year-old competitor is not just unusual — she is extraordinary.\n\nShe started skateboarding in her late 50s, after watching her grandchildren at a skate park. "They made it look so fun," she told reporters. "I thought, why not me?" Her first attempts were painful and embarrassing — she fell constantly, bruised herself regularly, and was stared at by teenagers who could not believe what they were seeing. But she kept going.\n\nOver the years, she has built a following on social media, where her videos — showing a silver-haired woman dropping into half-pipes and attempting tricks — have been viewed millions of times. Her message is simple and powerful: it is never too late to try something new, and the only person who decides what you are too old for is you.`,
    vocab: [
      { word: 'Competitive', definition: 'Taking part in contests or competitions — not just doing something for fun.' },
      { word: 'Retirement', definition: 'The period of life after you stop working — usually from your 60s onwards.' },
      { word: 'Half-pipe', definition: 'A U-shaped ramp used in skateboarding and snowboarding for performing tricks.' },
      { word: 'Following', definition: 'A group of people who regularly watch and support someone — fans and admirers.' },
    ],
    questions: [
      { n: 1, q: 'A 66-year-old competing against teenagers. What was your first reaction to this story?' },
      { n: 2, q: 'She started skateboarding in her late 50s after watching her grandchildren. What activity would you like to try even though people might say you are too old?' },
      { n: 3, q: 'She says the only person who decides what you are too old for is you. Do you agree?' },
    ]
  },
  {
    number: 2, title: 'Breaking the Age Barrier', emoji: '💪', color: '#b91c1c',
    text: `Our grandma skateboarder is part of a growing trend: older adults refusing to accept society's expectations about what they can and cannot do.\n\nAround the world, people over 60 are running marathons, learning to surf, starting businesses, going back to university, and taking up sports they have never tried before. A 102-year-old Japanese woman holds the world record for the oldest person to complete a 1,500-metre swim. An 80-year-old Italian woman recently earned her university degree. A 73-year-old British man completed an Ironman triathlon — a race that combines 3.8km of swimming, 180km of cycling, and a full marathon.\n\nThese individuals challenge one of the most persistent stereotypes in society: that ageing means decline. The assumption that older people should slow down, take fewer risks, and accept their limitations is deeply embedded in most cultures. Phrases like "act your age" and "you're too old for that" reinforce the idea that certain activities belong to certain age groups.\n\nBut science tells a different story. Research shows that regular physical activity, mental stimulation, and social engagement can dramatically slow the physical and cognitive effects of ageing. People who remain active in later life have stronger bones, better cardiovascular health, sharper minds, and lower rates of depression. The science is clear: the worst thing you can do as you age is stop moving.\n\nOur skateboarder is not defying age — she is redefining what age means.`,
    vocab: [
      { word: 'Stereotypes', definition: 'Fixed, oversimplified ideas about what a group of people are like.' },
      { word: 'Persistent', definition: 'Continuing for a long time and difficult to change — stubbornly lasting.' },
      { word: 'Cognitive', definition: 'Relating to thinking, memory, and mental abilities.' },
      { word: 'Cardiovascular', definition: 'Relating to the heart and blood vessels — the system that pumps blood around the body.' },
    ],
    questions: [
      { n: 4, q: 'A 102-year-old woman swam 1,500 metres. A 73-year-old completed an Ironman. How do these stories change how you think about ageing?' },
      { n: 5, q: 'The phrase "act your age" implies certain activities are inappropriate for older people. Is this fair? Who decides?' },
      { n: 6, q: 'Science says the worst thing you can do as you age is stop moving. Do older people in your culture stay active or slow down?' },
    ]
  },
  {
    number: 3, title: 'Learning at Any Age', emoji: '🧠', color: '#991b1b',
    text: `One of the most inspiring aspects of the skateboarding grandmother's story is not her physical achievement — it is the fact that she started learning something completely new in her late 50s. This challenges another powerful myth: that there is an age limit for learning.\n\nThe concept of a "critical period" for learning — the idea that the brain can only acquire new skills during childhood and adolescence — has been significantly revised by modern neuroscience. While it is true that children's brains are more flexible and absorb new information faster, adult brains retain a remarkable capacity for learning throughout life. This capacity is called neuroplasticity — the brain's ability to form new connections and reorganise itself in response to new experiences.\n\nResearch shows that older adults who learn new skills — whether it is a language, a musical instrument, or a sport like skateboarding — show measurable improvements in brain function. Learning something difficult and unfamiliar is particularly beneficial because it forces the brain to build entirely new pathways rather than relying on existing ones.\n\nThe barriers to learning in later life are usually psychological rather than physical. Fear of looking foolish, fear of failure, and the assumption that "I'm too old to learn" stop far more people than any biological limitation. Our skateboarding grandmother faced all of these fears — and decided to fall off the board anyway.\n\nFor ESL students of any age, this is encouraging news. Learning English as an adult is harder than learning it as a child — but it is absolutely possible, and the brain benefits from the effort regardless of how old you are.`,
    vocab: [
      { word: 'Neuroplasticity', definition: 'The brain\'s ability to change, grow, and form new connections throughout life.' },
      { word: 'Critical period', definition: 'A time in childhood when the brain is thought to learn certain skills most easily.' },
      { word: 'Pathways', definition: 'Connections in the brain that allow information to travel — neural routes.' },
      { word: 'Psychological', definition: 'Relating to the mind and emotions — mental rather than physical.' },
    ],
    questions: [
      { n: 7, q: 'The brain can learn new things at any age. Does this surprise you? What would you like to learn?' },
      { n: 8, q: 'Fear of looking foolish stops more people than biology. Is this true in your experience?' },
      { n: 9, q: 'Learning English as an adult is harder but possible. How does knowing about neuroplasticity change how you feel about learning?' },
    ]
  },
  {
    number: 4, title: 'The World Needs More Grandma Skaters', emoji: '🌟', color: '#7f1d1d',
    text: `In a news week that included trade wars, collapsing ceasefires, and military deployments, a 66-year-old woman on a skateboard might seem trivial. But stories like hers matter more than their size suggests.\n\nThey matter because they challenge assumptions. Every time someone does something they were "too old" or "too young" or "too female" or "too anything" to do, they expand the boundaries of what everyone else considers possible. Our grandma skateboarder will never win an Olympic medal. But she may inspire a 55-year-old watching her video to try something they have always wanted to try. And that person may inspire someone else.\n\nThey matter because they celebrate joy. Serious news is important, but a diet of nothing but serious news is unhealthy. Humans need lightness, play, and moments of pure, uncomplicated happiness. Watching a grandmother attempt a kickflip and laugh when she falls is medicine for the soul.\n\nAnd they matter because they remind us of a truth we easily forget: life does not have an expiry date for fun. Society tells us that adventure belongs to the young, that risk belongs to the bold, and that new experiences belong to those with their whole lives ahead of them. Our skateboarder says no. Fun belongs to everyone. Learning belongs to everyone. Falling down and getting back up belongs to everyone.\n\nShe is 66 years old. She cannot do a 900-degree spin. She falls off her board regularly. And she is, without question, one of the most inspiring athletes in the world.`,
    vocab: [
      { word: 'Trivial', definition: 'Not important or serious — too small to matter.' },
      { word: 'Boundaries', definition: 'Limits or edges — the lines that define what is considered possible or acceptable.' },
      { word: 'Kickflip', definition: 'A skateboarding trick where the board flips in the air while the skater jumps.' },
      { word: 'Inspiring', definition: 'Making you feel motivated and enthusiastic — encouraging you to try something.' },
    ],
    questions: [
      { n: 10, q: 'In a week of serious news, does a story about a grandma on a skateboard matter? Why or why not?' },
      { n: 11, q: 'She may inspire a 55-year-old to try something new. Has a story like this ever inspired you? What happened?' },
      { n: 12, q: 'Life does not have an expiry date for fun. What would you do differently if you truly believed this?' },
    ]
  },
]
...
export default function SkaterGrandmaPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>66-Year-Old Grandma Breaks Skateboarding Record</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A 66-year-old grandmother extended her record as the oldest competitive skateboarder. Age stereotypes, neuroplasticity, and why life has no expiry date for fun.</p>
            </div>
          </div>
