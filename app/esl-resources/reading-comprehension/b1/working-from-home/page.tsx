...
const PARTS = [
  {
    number: 1, title: 'What is Working from Home?', emoji: '🏡', color: '#0ea5e9',
    text: `Working from home — also called remote work or telecommuting — means doing your job from a place outside the office, usually your house. For most of history, this was only possible for a small number of workers, such as writers, artists, or people who ran their own small businesses. Most jobs required people to be physically present at a workplace.\n\nAll of this changed very quickly in 2020, when the COVID-19 pandemic forced companies around the world to close their offices. Millions of workers suddenly had to set up home offices and learn how to do their jobs online. Many people had never done this before and found it difficult at first. However, after a while, a large number of workers discovered that they actually enjoyed working from home. When offices reopened, many employees did not want to return full-time. This created a new situation where companies had to decide how much flexibility to offer their staff — and the debate about working from home has continued ever since.`,
    vocab: [
      { word: 'Remote work', definition: 'Working from a location away from the office — usually from home, using a computer and internet connection.' },
      { word: 'Pandemic', definition: 'A disease that spreads across a very large area, affecting many people in many countries at the same time.' },
      { word: 'Flexibility', definition: 'The ability to change or adapt easily — having freedom to choose when, where, or how you do something.' },
      { word: 'Full-time', definition: 'Working the normal number of hours every week — usually around 40 hours, five days a week.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever worked or studied from home? What was it like?' },
      { n: 2, q: 'Why do you think so many people wanted to continue working from home after the pandemic ended?' },
      { n: 3, q: 'Do you think all jobs can be done from home, or are some jobs impossible to do remotely? Give some examples.' },
    ]
  },
  {
    number: 2, title: 'The Advantages of Working from Home', emoji: '✅', color: '#22c55e',
    text: `There are many reasons why people enjoy working from home. One of the biggest advantages is saving time. When you work from home, you do not need to commute — travel to and from the office. For many workers, this daily journey can take one, two, or even three hours. By staying at home, people can use this time for other things, such as exercise, cooking, spending time with family, or simply sleeping more.\n\nAnother advantage is flexibility. Many people who work from home can choose their own schedule more freely. They can start earlier, take breaks when they need to, and finish when their work is done. This is especially helpful for parents with young children, or people who have health conditions that make it difficult to follow a strict routine. Studies also show that many remote workers are more productive — they get more work done — because there are fewer interruptions and distractions compared to a busy office. Finally, working from home can save money. Workers spend less on transport, work clothes, and eating out at lunchtime.`,
    vocab: [
      { word: 'Commute', definition: 'To travel regularly between your home and your place of work — usually by car, train, or bus.' },
      { word: 'Schedule', definition: 'A plan that shows what you need to do and when — a timetable for your day or week.' },
      { word: 'Productive', definition: 'Getting a lot of useful work done in a period of time — achieving good results efficiently.' },
      { word: 'Distraction', definition: 'Something that takes your attention away from what you are trying to do — making it harder to focus.' },
    ],
    questions: [
      { n: 4, q: 'Which advantage of working from home do you think is most important — saving time, flexibility, or saving money? Why?' },
      { n: 5, q: 'Do you think you would be more or less productive if you worked from home? What might help or distract you?' },
      { n: 6, q: 'Are there any other advantages of working from home that are not mentioned in the passage?' },
    ]
  },
  {
    number: 3, title: 'The Disadvantages of Working from Home', emoji: '⚠️', color: '#f59e0b',
    text: `Although working from home has many benefits, there are also some serious disadvantages. One of the most common problems is feeling lonely or isolated. When you work in an office, you see your colleagues every day, chat over lunch, and feel part of a team. At home, you may go for hours — or even days — without speaking to another person. This can have a negative effect on mental health, and some remote workers say they feel disconnected from their company and their workmates.\n\nAnother problem is that it can be difficult to separate work from home life. When your office is in your bedroom or living room, it is easy to keep working late into the evening, or to feel that you are never really "off work." Some workers also struggle with interruptions at home — from children, family members, or neighbours — that make it hard to concentrate. Not everyone has a quiet, comfortable space to work in. People in small apartments, or those who share their home with many others, may find it very difficult to work effectively at home. Finally, some managers find it harder to supervise their teams remotely, and worry that workers are less accountable when they cannot be seen.`,
    vocab: [
      { word: 'Isolated', definition: 'Feeling alone and separated from other people — without regular contact or social connection.' },
      { word: 'Colleagues', definition: 'People who work in the same organisation or do the same type of job as you — workmates.' },
      { word: 'Disconnected', definition: 'Feeling separate from something or someone — not involved or in contact with a group or community.' },
      { word: 'Accountable', definition: 'Responsible for your actions and expected to explain them — having to answer for the results of your work.' },
    ],
    questions: [
      { n: 7, q: 'Do you think loneliness is a serious problem for remote workers? What could companies do to help?' },
      { n: 8, q: 'How easy do you think it would be for you personally to separate work time from home time? What strategies might help?' },
      { n: 9, q: 'Do you think managers should trust their employees to work well from home, or is it reasonable to check on them regularly?' },
    ]
  },
  {
    number: 4, title: 'Finding the Right Balance', emoji: '⚖️', color: '#8b5cf6',
    ...
    vocab: [
      { word: 'Hybrid model', definition: 'A work arrangement that combines both remote work and office work — employees split their time between the two.' },
      { word: 'Quality of life', definition: 'How comfortable, enjoyable, and satisfying your everyday life is — your general level of happiness and wellbeing.' },
      { word: 'Structure', definition: 'A clear, organised system or routine — a regular pattern that helps you know what to expect each day.' },
      { word: 'Permanently', definition: 'In a way that lasts forever or for a very long time — not temporary or likely to change back.' },
    ],
    questions: [
      { n: 10, q: 'Do you think the hybrid model is a good solution? What might be its advantages and disadvantages compared to working fully at home or fully in the office?' },
      { n: 11, q: 'Why might younger or newer employees find remote work more difficult than experienced workers?' },
      { n: 12, q: 'Overall, would you prefer to work fully from home, fully in an office, or use a hybrid model? Give reasons for your answer.' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise discussion skills. The reading topic is "Working from Home". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear English suitable for B1 level. Always end with one natural follow-up question. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function WorkingFromHomePage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0369a1 0%, #0ea5e9 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#0369a1', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(34,197,94,0.7)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Work & Life</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Working from Home — Advantages and Disadvantages</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Office or Home? — Explore how remote work has changed our lives, and whether working from home is really better than going to the office.</p>
            </div>
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)}
                  style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#0ea5e9' : '#e5e7eb', background: speed === s.value ? '#0ea5e9' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer' }}>
                  {s.label}
                </button>
              ))}
            </div>
        ...
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#e0f2fe', padding: '8px 28px', borderBottom: '1px solid #bae6fd' }}>
              <span style={{ color: '#0369a1', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to look it up{translationLang !== 'none' && <span style={{ color: '#0ea5e9' }}> + {currentLang?.label} translation</span>}</span>
            </div>
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #bae6fd', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#e0f2fe', color: '#0369a1', border: '2px solid #bae6fd', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer' }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#e0f2fe', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bae6fd', color: '#9ca3af', fontSize: '15px' }}>Looking up...</div>
            ) : (
