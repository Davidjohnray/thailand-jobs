...
const PARTS = [
  {
    number: 1, title: 'Too Close to Sacred Ground', emoji: '🛡️', color: '#dc2626',
    text: `Saudi Arabia announced this week that it intercepted and destroyed a Houthi drone south of Mecca — the holiest city in Islam. The drone was shot down before it entered the prohibited airspace that surrounds the city, home to the Kaaba and the Grand Mosque, where millions of Muslims pray and perform pilgrimage every year.\n\nThe Houthis — the Iran-backed rebel group that controls much of Yemen — denied targeting Mecca, saying their strikes were aimed at a Saudi military airbase in the region. But the proximity of the drone to the holiest site in Islam sent shockwaves across the Muslim world.\n\nMecca is sacred to 1.9 billion Muslims worldwide. The idea of a weapon — even one that missed its target — flying near the Grand Mosque is deeply disturbing to believers of every nationality and sect. Saudi Arabia, which considers itself the guardian of the two holy mosques (Mecca and Medina), described the drone as "an attack on all Muslims everywhere."\n\nThe incident came on the same day that Houthi forces launched dozens of ballistic missiles and drones at a Saudi airbase in the south of the country. Air raid sirens were activated in six Saudi provinces, including Jeddah — the major city closest to Mecca. The war between Saudi Arabia and Yemen Houthi movement, which began in 2015, is escalating to levels that threaten the entire region.`,
    vocab: [
      { word: 'Intercepted', definition: 'Caught or stopped something before it reached its target.' },
      { word: 'Pilgrimage', definition: 'A journey to a holy place for religious reasons — an act of devotion.' },
      { word: 'Sect', definition: 'A division within a religion — different groups with slightly different beliefs or practices.' },
      { word: 'Guardian', definition: 'A protector — someone responsible for keeping something safe.' },
    ],
    questions: [
      { n: 1, q: 'A drone was shot down near Mecca. Why does this feel different from a drone near any other city?' },
      { n: 2, q: 'The Houthis say they were not targeting Mecca. Does intention matter when the result threatens a sacred place?' },
      { n: 3, q: 'Saudi Arabia calls itself guardian of the holy mosques. What responsibilities come with that role?' },
    ]
  },
  {
    number: 2, title: 'Sacred Places in a World of Weapons', emoji: '🏛️', color: '#b91c1c',
    text: `Throughout history, sacred places have been considered off-limits during conflict. Temples, churches, mosques, and shrines have been treated as sanctuaries — places where even enemies would not attack. This tradition crosses cultures and religions.\n\nIn ancient Greece, the sanctuary of Delphi was considered neutral territory — warring armies would not fight there. In medieval Europe, churches offered sanctuary — people fleeing violence could shelter inside and be protected by religious law. In Islam, the Haram — the sacred precinct around the Kaaba in Mecca — has been considered inviolable for more than 1,400 years.\n\nBut modern warfare has repeatedly violated these traditions. During World War II, historic churches, temples, and mosques were destroyed across Europe and Asia. In 2001, the Taliban dynamited the Bamiyan Buddhas in Afghanistan — giant statues carved into a cliff 1,500 years ago. ISIS destroyed ancient temples in Palmyra, Syria, and mosques in Mosul, Iraq. And in the current conflicts, religious sites have been damaged in Ukraine, Gaza, and Yemen.\n\nThe drone near Mecca did not hit its target. But the fact that a weapon flew close to Islam holiest site raises a question that every religion and every culture must face: in an age of long-range missiles, drones, and autonomous weapons, can any place truly be sacred — or has technology made the concept of sanctuary obsolete?`,
    vocab: [
      { word: 'Sanctuary', definition: 'A safe place — a sacred space where people are protected from violence.' },
      { word: 'Inviolable', definition: 'Must never be broken or violated — absolutely sacred and untouchable.' },
      { word: 'Precinct', definition: 'A defined area or zone — a space with specific boundaries and rules.' },
      { word: 'Obsolete', definition: 'No longer useful or relevant — made outdated by new developments.' },
    ],
    questions: [
      { n: 4, q: 'Sacred places were once considered off-limits in war. Has modern technology made sanctuary impossible?' },
      { n: 5, q: 'ISIS destroyed ancient temples. The Taliban destroyed the Bamiyan Buddhas. Why do some groups deliberately attack sacred sites?' },
      { n: 6, q: 'Are there places in Thailand that you would consider sacred and untouchable? What would happen if they were threatened?' },
    ]
  },
  {
    number: 3, title: 'The War Nobody Talks About', emoji: '🇾🇪', color: '#991b1b',
    text: `The Houthi drone near Mecca is a symptom of a war that has been devastating Yemen for more than a decade — a war that receives far less attention than the conflicts in Ukraine or the Middle East.\n\nThe Yemen war began in 2014 when Houthi forces — a Shia Muslim group from northern Yemen — captured the capital Sanaa and overthrew the internationally recognised government. In 2015, Saudi Arabia led a military coalition to restore the government, launching thousands of airstrikes on Houthi-held territory.\n\nThe humanitarian consequences have been catastrophic. More than 150,000 people have been killed. More than 21 million people — roughly 70% of the population — need humanitarian assistance. Cholera outbreaks have affected more than 2 million people. And millions of children face malnutrition so severe that their physical and cognitive development has been permanently affected.\n\nBoth sides have committed violations of international humanitarian law. Saudi-led coalition airstrikes have hit hospitals, schools, weddings, and funerals. Houthi forces have used child soldiers, laid mines in civilian areas, and blocked humanitarian aid. The United States and United Kingdom have supplied weapons to Saudi Arabia throughout the conflict — weapons that have been used to kill Yemeni civilians.\n\nThe escalation this week — with Houthi drones reaching toward Mecca and missiles striking Saudi cities — shows that the conflict is not winding down but intensifying. And the people who suffer most, as always, are ordinary Yemenis who want nothing more than the war to end.`,
    vocab: [
      { word: 'Coalition', definition: 'A group of countries working together for a shared military purpose.' },
      { word: 'Malnutrition', definition: 'Poor health caused by not eating enough food or the right types of food.' },
      { word: 'Child soldiers', definition: 'Children forced to fight in armed conflicts — a violation of international law.' },
      { word: 'Intensifying', definition: 'Becoming stronger and more severe — getting worse.' },
    ],
    questions: [
      { n: 7, q: '70% of Yemen population needs humanitarian aid. Why does this crisis receive so little media attention?' },
      { n: 8, q: 'The US and UK supply weapons to Saudi Arabia that are used against Yemeni civilians. Should weapon-selling countries be responsible for how weapons are used?' },
      { n: 9, q: 'Both sides have committed violations. In a war where everyone is guilty, how do you achieve justice?' },
    ]
  },
  {
    number: 4, title: 'When War Reaches Holy Ground', emoji: '🕊️', color: '#7f1d1d',
    text: `The Houthi drone near Mecca is more than a military incident — it is a moment that forces the Muslim world to confront an uncomfortable reality: a war between Muslim-majority countries is threatening Islam most sacred place.\n\nThe Sunni-Shia divide — the theological and political split that dates back to the earliest years of Islam — is at the heart of the Saudi-Yemen conflict. Saudi Arabia is a Sunni monarchy. The Houthis are a Shia movement supported by Shia-majority Iran. The war is, at one level, a proxy conflict between Saudi Arabia and Iran for regional dominance — fought on Yemeni soil.\n\nFor ordinary Muslims worldwide — most of whom do not identify strongly with either sect — the sight of a drone flying toward Mecca is heartbreaking. The city that is supposed to unite all Muslims in prayer is at risk because of divisions within Islam itself.\n\nThe Quran explicitly prohibits fighting near the Kaaba. The sanctity of Mecca is one of the few principles that virtually all Muslims agree on, regardless of sect or interpretation. That a weapon came close to violating this sanctity — even accidentally — has prompted soul-searching across the Muslim world.\n\nSacred places matter because they remind us of what we share rather than what divides us. When those places are threatened, the divisions become harder to ignore — and the need for peace becomes more urgent. The drone was destroyed. The Kaaba is safe. But the war that sent the drone continues — and until it ends, no place is truly beyond its reach.`,
    vocab: [
      { word: 'Theological', definition: 'Relating to the study of God and religious beliefs — concerning religious ideas.' },
      { word: 'Proxy conflict', definition: 'A war where larger powers fight indirectly through smaller allies.' },
      { word: 'Sanctity', definition: 'The quality of being sacred and holy — deserving absolute respect and protection.' },
      { word: 'Soul-searching', definition: 'Deep, honest reflection about your values and beliefs — questioning yourself seriously.' },
    ],
    questions: [
      { n: 10, q: 'A war between Muslim countries threatens Islam holiest site. What does this tell us about the gap between religious values and political conflict?' },
      { n: 11, q: 'The Quran prohibits fighting near the Kaaba. Does this religious rule carry weight in modern warfare?' },
      { n: 12, q: 'Sacred places remind us what we share. When they are threatened, divisions become harder to ignore. Do you agree?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Houthi Drone Intercepted Near Mecca". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function MeccaDronePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Houthi Drone Intercepted Near Mecca</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Saudi Arabia shot down a Houthi drone near Islam holiest city. The Houthis deny targeting Mecca. The war in Yemen is spreading and sacred places are no longer safe.</p>
            </div>
          </div>
