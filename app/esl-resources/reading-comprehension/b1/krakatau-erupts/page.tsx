...
const PARTS = [
  {
    number: 1, title: 'The Child of Krakatoa', emoji: '💨', color: '#dc2626',
    text: `Anak Krakatau — which means "Child of Krakatoa" in Indonesian — erupted this weekend in a dramatic 25-hour explosion that sent ash high into the atmosphere and rained volcanic debris on the Indonesian capital Jakarta, more than 150 kilometres away.\n\nThe volcano, located in the Sunda Strait between Java and Sumatra, is one of the most closely watched volcanoes on Earth — and for good reason. Its parent volcano, Krakatoa, produced one of the most catastrophic eruptions in recorded history in 1883, killing more than 36,000 people and causing a global temperature drop that lasted for years.\n\nAnak Krakatau emerged from the sea in 1927, growing from the remains of the original Krakatoa. It has been active ever since, gradually building itself higher through repeated eruptions. In 2018, a major eruption caused a landslide that triggered a tsunami, killing more than 400 people on the coasts of Java and Sumatra.\n\nThis weekend eruption, while spectacular, has not caused casualties. But Indonesian authorities warned that the volcano remains highly active and could erupt again at any time. Flights were rerouted to avoid the ash cloud, and residents across western Java were advised to wear masks and stay indoors. The ash fall in Jakarta — a city of more than 10 million people — turned cars, rooftops, and streets grey.`,
    vocab: [
      { word: 'Erupted', definition: 'When a volcano explosively releases lava, ash, and gas from underground.' },
      { word: 'Volcanic debris', definition: 'Rocks, ash, and other material thrown out by a volcanic eruption.' },
      { word: 'Tsunami', definition: 'A massive ocean wave caused by an earthquake, volcanic eruption, or underwater landslide.' },
      { word: 'Ash cloud', definition: 'A large cloud of tiny volcanic particles that rises into the atmosphere and can spread for hundreds of kilometres.' },
    ],
    questions: [
      { n: 1, q: 'Anak Krakatau means "Child of Krakatoa" — it grew from its destroyed parent. Is there something poetic about a volcano being reborn from destruction?' },
      { n: 2, q: 'Ash rained on Jakarta, 150km away. How does a volcanic eruption affect a city that far from the volcano?' },
      { n: 3, q: 'The 2018 eruption killed 400 people. Should people live near active volcanoes? Why do they?' },
    ]
  },
  {
    number: 2, title: 'Living on the Ring of Fire', emoji: '🔥', color: '#b91c1c',
    text: `Indonesia has more active volcanoes than any other country on Earth — approximately 130. This is because Indonesia sits on the "Ring of Fire" — the same zone of tectonic activity that produces earthquakes in Japan, eruptions in the Philippines, and tsunamis across the Pacific.\n\nThe Ring of Fire is a horseshoe-shaped band around the Pacific Ocean where tectonic plates collide, creating conditions for both earthquakes and volcanic eruptions. About 75% of the world active volcanoes are located on the Ring of Fire, and approximately 90% of the world earthquakes occur there.\n\nFor the 275 million people of Indonesia, living with volcanoes is simply a fact of life. Many of the most densely populated areas — including Java, Bali, and Sumatra — are located near active volcanoes. People farm on volcanic soil because it is extraordinarily fertile — the minerals deposited by eruptions make volcanic land some of the most productive farmland on Earth.\n\nThis creates a paradox that affects volcanic communities worldwide: the same force that threatens to destroy them also sustains them. The soil that feeds their families exists because of eruptions. The hot springs that attract tourists are heated by magma. The mountains that define their landscape were built by the same processes that could one day flatten them.\n\nThailand is not on the Ring of Fire but has experienced indirect effects — the 2004 tsunami, triggered by an earthquake off Sumatra, killed more than 5,000 people on Thailand coast. Living in Southeast Asia means living with the consequences of a planet that is very much alive.`,
    vocab: [
      { word: 'Tectonic plates', definition: 'Enormous pieces of Earth surface that move slowly, causing earthquakes and volcanic eruptions where they meet.' },
      { word: 'Fertile', definition: 'Land that is rich in nutrients and good for growing crops — productive soil.' },
      { word: 'Paradox', definition: 'A situation that seems contradictory — two things that should not be true together but are.' },
      { word: 'Magma', definition: 'Hot, melted rock beneath the Earth surface — when it reaches the surface it becomes lava.' },
    ],
    questions: [
      { n: 4, q: 'Indonesia has 130 active volcanoes and 275 million people. How do you build a country on such dangerous ground?' },
      { n: 5, q: 'Volcanic soil is incredibly fertile. People farm on volcanoes because it feeds their families. Would you take this risk?' },
      { n: 6, q: 'Thailand felt the 2004 tsunami from an earthquake in Indonesia. How do disasters in one country affect their neighbours?' },
    ]
  },
  {
    number: 3, title: 'Can We Predict Eruptions?', emoji: '📊', color: '#991b1b',
    text: `One of the most important questions in volcanology is: can we predict when a volcano will erupt? The answer is: sometimes — but not reliably enough to prevent all deaths.\n\nModern monitoring uses a range of technologies. Seismographs detect the small earthquakes that occur as magma moves underground. GPS stations measure tiny changes in the shape of the volcano — swelling that indicates magma is rising. Gas sensors monitor the types and quantities of gases escaping from vents. Satellite images track temperature changes on the surface.\n\nThese tools can often detect that a volcano is becoming more active — giving warnings that range from hours to weeks. The successful evacuation of more than 20,000 people before the 1991 eruption of Mount Pinatubo in the Philippines — one of the largest eruptions of the 20th century — saved thousands of lives and is considered one of the greatest achievements in disaster prediction.\n\nBut prediction remains imperfect. Volcanoes can show signs of activity and then quiet down without erupting. They can also erupt with very little warning. The 2014 eruption of Mount Ontake in Japan killed 63 hikers — the volcano had shown minimal warning signs. And the 2022 eruption of Hunga Tonga in the Pacific — which produced the most powerful explosion recorded in the satellite era — was largely unexpected.\n\nFor communities living near Anak Krakatau, the uncertainty is constant. The volcano could sleep for years or erupt tomorrow. All they can do is monitor, prepare, and live with the knowledge that the mountain beneath their feet has its own schedule.`,
    vocab: [
      { word: 'Volcanology', definition: 'The scientific study of volcanoes — understanding how and why they erupt.' },
      { word: 'Seismographs', definition: 'Instruments that detect and record earthquakes and underground vibrations.' },
      { word: 'Vents', definition: 'Openings in a volcano through which gas, ash, and lava escape.' },
      { word: 'Evacuation', definition: 'Moving people from a dangerous area to safety before a disaster.' },
    ],
    questions: [
      { n: 7, q: 'The Pinatubo evacuation saved thousands of lives. Why can we predict some eruptions but not others?' },
      { n: 8, q: '63 hikers died on Mount Ontake with minimal warning. Should people be allowed to hike on active volcanoes?' },
      { n: 9, q: 'Communities near Krakatau know it could erupt at any time. How do you live normally with this kind of uncertainty?' },
    ]
  },
  {
    number: 4, title: 'The Power Beneath Our Feet', emoji: '🌏', color: '#7f1d1d',
    text: `Anak Krakatau eruption is a reminder of something we easily forget in our air-conditioned, Wi-Fi-connected, delivery-app lives: the planet we live on is alive.\n\nBeneath the thin crust of rock we walk on, the Earth interior is a churning mass of molten rock at temperatures exceeding 5,000 degrees Celsius. This heat drives the tectonic plates that shape continents, build mountains, trigger earthquakes, and feed volcanoes. The same forces that created the Himalayas, the Andes, and the islands of Indonesia are still active — right now, as you read this.\n\nWe tend to think of the Earth as solid and stable — a platform on which human civilisation is built. But the Earth is more like a thin-shelled egg floating on a sea of hot liquid. The crust that supports our cities, farms, and highways is, on average, only about 30 kilometres thick — compared to the Earth total radius of 6,371 kilometres. If the Earth were an apple, the crust would be thinner than the skin.\n\nVolcanic eruptions, earthquakes, and tsunamis are not aberrations — they are the normal behaviour of a living planet. They are how the Earth releases energy, recycles its surface, and maintains the conditions that make life possible. Without volcanic activity, there would be no atmosphere. Without tectonic movement, there would be no mountains, no ocean basins, and no continents.\n\nAnak Krakatau will erupt again. The Ring of Fire will continue to shake and burn. And the thin crust of rock we call home will continue doing what it has always done: reminding us that we are guests on a planet that was here long before us and will be here long after we are gone.`,
    vocab: [
      { word: 'Crust', definition: 'The thin outer layer of the Earth — the solid rock we live on.' },
      { word: 'Molten', definition: 'Melted by extreme heat — rock that has become liquid.' },
      { word: 'Aberrations', definition: 'Something unusual or different from what is normal — a departure from the expected.' },
      { word: 'Recycles', definition: 'Processes and reuses — in geology, how the Earth breaks down and reforms rock over millions of years.' },
    ],
    questions: [
      { n: 10, q: 'If the Earth were an apple, the crust would be thinner than the skin. How does this image change how you think about the ground beneath you?' },
      { n: 11, q: 'Without volcanic activity, there would be no atmosphere. The same forces that threaten us also made life possible. How do you feel about this?' },
      { n: 12, q: 'We are guests on a planet that was here before us. Does this perspective change how you think about human problems?' },
    ]
  },
]
...
export default function KrakatauPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Anak Krakatau Erupts — Ash Rains on Jakarta</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Indonesia most dangerous volcano erupted for 25 hours, raining ash on Jakarta and millions of people. The child of Krakatoa, the Ring of Fire, and living next to a volcano.</p>
            </div>
          </div>
