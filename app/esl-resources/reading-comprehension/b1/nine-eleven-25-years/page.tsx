...
const PARTS = [
  {
    number: 1, title: 'The Day the World Changed', emoji: '✈️', color: '#dc2626',
    text: `Tomorrow — 11 September 2026 — marks exactly 25 years since the deadliest terrorist attack in modern history. On that morning in 2001, 19 hijackers took control of four commercial aircraft in the United States. Two planes were flown into the Twin Towers of the World Trade Center in New York City. One was flown into the Pentagon — the headquarters of the US military — near Washington, D.C. The fourth plane, United Flight 93, crashed in a field in Pennsylvania after passengers fought the hijackers.\n\nAlmost 3,000 people were killed — office workers, firefighters, police officers, passengers, and flight crews. People from more than 90 countries died. It was the single deadliest day on American soil since the Civil War.\n\nIf you are a student reading this in 2026, you were probably born after 9/11. You have never known a world before airport security scanners, before the "War on Terror," before the words "homeland security" became part of everyday language. But for everyone alive that morning, 9/11 is a dividing line — a before and after. People remember exactly where they were when they heard the news, the way previous generations remembered the assassination of JFK or the fall of the Berlin Wall.\n\nThe 25th anniversary is being commemorated with ceremonies in New York, Washington, and Shanksville, Pennsylvania. But the true commemoration is understanding — knowing what happened, why it happened, and how it changed the world you live in today.`,
    vocab: [
      { word: 'Hijackers', definition: 'People who illegally take control of an aircraft, ship, or vehicle by force.' },
      { word: 'Commemorated', definition: 'Remembered and honoured with a special event or ceremony.' },
      { word: 'Dividing line', definition: 'A point that separates two very different periods — before and after.' },
      { word: 'Homeland security', definition: 'Government efforts to protect a country from terrorism and other threats within its borders.' },
    ],
    questions: [
      { n: 1, q: 'Almost 3,000 people from 90 countries died in one morning. How do you react to numbers this large? Can you imagine the scale?' },
      { n: 2, q: 'People alive that day remember exactly where they were. Do you have a moment like this — an event so big it divided time into before and after?' },
      { n: 3, q: 'Most students today were born after 9/11. Why is it important for your generation to understand what happened?' },
    ]
  },
  {
    number: 2, title: 'How the World Changed', emoji: '🌍', color: '#b91c1c',
    text: `The 9/11 attacks did not just kill 3,000 people. They reshaped the entire world — in ways that affect your daily life even now, 25 years later.\n\nAir travel was transformed overnight. Before 9/11, airport security was minimal. You could walk to the gate without a ticket. You could carry liquids, scissors, and pocket knives onto a plane. After 9/11, governments created security systems that scan every passenger, X-ray every bag, and restrict what you can bring on board. These systems cost billions of dollars per year and add hours to every journey. If you have ever taken off your shoes at an airport, you are living in the post-9/11 world.\n\nThe "War on Terror" followed. The United States invaded Afghanistan in October 2001 to destroy al-Qaeda — the group that planned the attacks — and remove the Taliban government that had sheltered them. In 2003, the US invaded Iraq, claiming that Iraq possessed weapons of mass destruction (a claim that later proved false). The two wars lasted more than 20 years, killed hundreds of thousands of people, cost trillions of dollars, and destabilised the entire Middle East.\n\nSurveillance expanded dramatically. Governments around the world used the threat of terrorism to justify monitoring phone calls, emails, internet activity, and financial transactions. Edward Snowden revealed in 2013 that the US government was collecting data on millions of its own citizens. The debate between security and privacy that 9/11 triggered continues today.\n\nMuslim communities worldwide faced a backlash. Hate crimes against Muslims in the US increased by more than 1,600% in the year after 9/11. Suspicion, discrimination, and profiling became daily realities for millions of people who had nothing to do with the attacks.`,
    vocab: [
      { word: 'Surveillance', definition: 'Monitoring and watching people, usually by governments for security purposes.' },
      { word: 'Destabilised', definition: 'Made a region less stable and secure — causing disorder and conflict.' },
      { word: 'Backlash', definition: 'A strong negative reaction against something — anger directed at a group after an event.' },
      { word: 'Profiling', definition: 'Targeting people for suspicion based on their appearance, religion, or background.' },
    ],
    questions: [
      { n: 4, q: 'Before 9/11, you could walk to an airport gate without a ticket. How would air travel be different without these security changes?' },
      { n: 5, q: 'The Iraq War was based on false claims about weapons of mass destruction. What does this tell us about how governments justify wars?' },
      { n: 6, q: 'Muslim communities faced hatred after 9/11 for attacks they had nothing to do with. Why does this happen, and how can it be prevented?' },
    ]
  },
  {
    number: 3, title: 'The Heroes', emoji: '🚒', color: '#991b1b',
    text: `Amid the horror of 9/11, there were extraordinary acts of courage that deserve to be remembered alongside the tragedy.\n\nThe firefighters of New York ran into the burning towers while everyone else was running out. They climbed staircases carrying heavy equipment, knowing the buildings could collapse at any moment. 343 firefighters died that day — the largest loss of rescue workers in a single event in American history. Their sacrifice is honoured every year at fire stations across the country.\n\nThe passengers of United Flight 93 learned through phone calls that other hijacked planes had already hit the World Trade Center. They understood that their plane was being used as a weapon. Rather than let the hijackers reach their target — believed to be the US Capitol building — the passengers voted to fight back. They stormed the cockpit. The plane crashed into a field in Pennsylvania. All 40 passengers and crew died. But their actions may have saved hundreds more.\n\nOrdinary New Yorkers became heroes too. Office workers carried injured colleagues down dozens of flights of stairs. Strangers helped each other through dust clouds so thick they could not see. Boat captains evacuated half a million people from lower Manhattan by water — the largest maritime evacuation in history, larger than the evacuation of Dunkirk in World War II.\n\nThe phrase most associated with 9/11 is "Never Forget." But what we should never forget is not just the horror — it is the humanity. On the worst day, people were at their best.`,
    vocab: [
      { word: 'Sacrifice', definition: 'Giving up something precious — including your life — for others.' },
      { word: 'Capitol', definition: 'The building where the US Congress meets — a symbol of American democracy.' },
      { word: 'Maritime evacuation', definition: 'Rescuing people by boat — moving them across water to safety.' },
      { word: 'Humanity', definition: 'The quality of being compassionate and caring — the best of human nature.' },
    ],
    questions: [
      { n: 7, q: '343 firefighters ran into burning buildings knowing they might not come out. What drives people to risk their lives for strangers?' },
      { n: 8, q: 'Passengers on Flight 93 voted to fight back, knowing they would probably die. Could you make that choice?' },
      { n: 9, q: 'Boat captains evacuated 500,000 people in hours. Why do ordinary people do extraordinary things in a crisis?' },
    ]
  },
  {
    number: 4, title: 'What 9/11 Means Now', emoji: '🕊️', color: '#7f1d1d',
    text: `Twenty-five years later, 9/11 is becoming history rather than memory. For people who lived through it, the day still feels raw and personal. For younger generations, it is something that happened before they were born — important but distant, like Pearl Harbor or the Kennedy assassination.\n\nThis transition from memory to history is natural and necessary. But it carries risks. When people remember 9/11 personally, they remember the fear, the grief, the unity, and the humanity. When it becomes abstract history, there is a danger of remembering only the politics — the wars, the surveillance, the division — without the human stories that give those events meaning.\n\nThe 25th anniversary is an opportunity to ensure that the human dimension is preserved. The stories of the firefighters who climbed the stairs. The phone calls from passengers on Flight 93. The volunteers who worked for months at Ground Zero, many of whom later developed cancer from the toxic dust. The families who lost someone and had to rebuild their lives from nothing.\n\nThe world you live in today — the security checks, the surveillance technology, the conflicts in the Middle East, the debates about immigration and identity — was shaped by what happened on one morning in September 2001. Understanding that morning is not just an exercise in history. It is essential for understanding the world you are inheriting.\n\nTomorrow, take a moment. Read the names. Watch the footage. Listen to the phone calls. And remember that behind the politics and the history, there were people — 2,977 of them — who woke up that morning expecting an ordinary day.`,
    vocab: [
      { word: 'Raw', definition: 'Still emotionally painful — a wound that has not fully healed.' },
      { word: 'Abstract', definition: 'Theoretical rather than real — disconnected from personal experience.' },
      { word: 'Ground Zero', definition: 'The site where the Twin Towers stood — now a memorial and museum in New York.' },
      { word: 'Inheriting', definition: 'Receiving something passed down from a previous generation — what is left to you.' },
    ],
    questions: [
      { n: 10, q: '9/11 is becoming history instead of memory. Why is this transition important, and what are the risks?' },
      { n: 11, q: 'The security, surveillance, and conflicts of today were shaped by one morning 25 years ago. Does this surprise you?' },
      { n: 12, q: '2,977 people woke up expecting an ordinary day. How does knowing this change how you think about your own ordinary days?' },
    ]
  },
]
...
export default function NineElevenPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>September 11 — 25 Years Later</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Tomorrow marks 25 years since the September 11 attacks. What happened that day, how the world changed, and what a generation born after 9/11 needs to understand.</p>
            </div>
          </div>
