...
const PARTS = [
  {
    number: 1, title: 'The Party Nobody Paid For', emoji: '🎆', color: '#dc2626',
    text: `When Donald Trump Jr married his wife in the Bahamas earlier this year, the three-day wedding celebration was spectacular by any standard. Guests arrived by helicopter and seaplane on two ultra-exclusive private islands. Dancers in costumes performed on the beach. A five-tier funfetti cake was airlifted from Florida. Fireworks launched from a barge over the sea. And the couple later described it as "everything we dreamed of and more."\n\nThis week, an investigation revealed who paid for much of it: Umar Kremlev, a Russian oligarch with close ties to President Vladimir Putin.\n\nKremlev is the president of the International Boxing Association and a wealthy businessman with connections to the Russian government. According to the report, he provided significant financial support for the wedding — covering costs for venues, entertainment, and logistics that would have totalled millions of dollars.\n\nNeither Trump Jr nor the Trump organisation has commented on the report. But the revelation raises serious questions. The President of the United States is the son of the groom. Russia is engaged in a war in Ukraine that the US is indirectly involved in. And a Russian oligarch close to Putin secretly funded a celebration for the presidential family. In most democracies, this would be considered a scandal.`,
    vocab: [
      { word: 'Oligarch', definition: 'An extremely wealthy person who has significant political influence — especially in Russia.' },
      { word: 'Airlifted', definition: 'Transported by aircraft — flown in from another location.' },
      { word: 'Logistics', definition: 'The organisation and coordination of complex operations — planning the details.' },
      { word: 'Revelation', definition: 'New information that surprises people — something previously hidden that is now known.' },
    ],
    questions: [
      { n: 1, q: 'A Russian oligarch secretly paid for the president son wedding. Why is this a problem?' },
      { n: 2, q: 'The wedding involved private islands, helicopters, and fireworks from barges. Does the luxury matter, or is it just the funding source that is the issue?' },
      { n: 3, q: 'Neither Trump Jr nor the Trump organisation have commented. If you were them, what would you say?' },
    ]
  },
  {
    number: 2, title: 'What Is an Oligarch?', emoji: '💰', color: '#b91c1c',
    text: `The word "oligarch" has become common in news coverage of Russia — but what exactly does it mean, and why does it matter?\n\nAn oligarch is an extremely wealthy individual who wields significant political influence — often behind the scenes. The term comes from the Greek word "oligarchia," meaning "rule by the few." In modern usage, it specifically refers to the Russian businessmen who accumulated enormous wealth during the chaotic privatisation of state assets in the 1990s, when the Soviet Union collapsed.\n\nDuring the 1990s, well-connected individuals bought state-owned companies — oil firms, metal producers, banks — at a fraction of their real value. Within a few years, a small group of men had become billionaires while ordinary Russians struggled with poverty and unemployment.\n\nWhen Vladimir Putin came to power in 2000, he made a deal with the oligarchs: they could keep their wealth as long as they supported his political agenda. Those who cooperated thrived. Those who challenged Putin — like Mikhail Khodorkovsky, once the richest man in Russia — were arrested, their assets seized, and their empires dismantled.\n\nToday, Russian oligarchs function as an extension of the state. Their wealth, their businesses, and their international relationships serve Putin interests. When an oligarch funds a wedding for the son of an American president, the question is not whether Putin approved — it is why Putin wanted it to happen.`,
    vocab: [
      { word: 'Privatisation', definition: 'Selling government-owned businesses to private individuals — transferring state assets to private hands.' },
      { word: 'Assets', definition: 'Valuable things owned — property, companies, money, and investments.' },
      { word: 'Dismantled', definition: 'Taken apart and destroyed — broken down into pieces.' },
      { word: 'Extension', definition: 'An addition or continuation — something that serves as part of a larger system.' },
    ],
    questions: [
      { n: 4, q: 'Russian oligarchs got rich by buying state companies for almost nothing. Is this fair? Who lost out?' },
      { n: 5, q: 'Putin made a deal: keep your wealth if you support me. What kind of system does this create?' },
      { n: 6, q: 'Do other countries have oligarchs? What is the difference between an oligarch and a regular billionaire?' },
    ]
  },
  {
    number: 3, title: 'When Money Buys Access', emoji: '🚪', color: '#991b1b',
    text: `The Trump Jr wedding story is ultimately about something that affects every democracy: the relationship between money and political access.\n\nIn theory, democratic governments serve all citizens equally. In practice, wealthy individuals and organisations have significantly more access to politicians than ordinary people. They attend fundraising dinners, they make campaign donations, they hire lobbyists, and — as this story suggests — they fund personal celebrations for political families. This access translates into influence. Politicians are more likely to listen to people they know, socialise with, and depend on for support.\n\nThe problem is not unique to the United States. In virtually every democracy, there is a tension between the principle that every citizen vote counts equally and the reality that money amplifies political voice. A billionaire who donates millions to a campaign has more influence than a factory worker who can barely afford to vote.\n\nWhen the money comes from a foreign source — particularly from a country that is a geopolitical rival — the concern is even more serious. Foreign funding of political activities is illegal in most democracies precisely because it creates the possibility that foreign governments are buying influence over domestic politics.\n\nThe Trump Jr wedding funding may or may not be illegal — that depends on whether it counts as a political contribution or a personal gift. But the question it raises is universal: in a world where money equals access, how do ordinary citizens ensure their voices are heard?`,
    vocab: [
      { word: 'Lobbyists', definition: 'People hired to influence politicians on behalf of companies or interest groups.' },
      { word: 'Campaign donations', definition: 'Money given to support a politician election campaign.' },
      { word: 'Geopolitical rival', definition: 'A country that competes with yours for power and influence on the world stage.' },
      { word: 'Contribution', definition: 'Money or support given to help someone — in politics, funding for campaigns or events.' },
    ],
    questions: [
      { n: 7, q: 'Wealthy people have more access to politicians. Is this inevitable, or can it be prevented?' },
      { n: 8, q: 'Foreign funding of political activities is illegal in most countries. Why is this rule so important?' },
      { n: 9, q: 'Money equals access in most democracies. How can ordinary citizens compete with billionaires for their leaders attention?' },
    ]
  },
  {
    number: 4, title: 'Why It Matters to Everyone', emoji: '🌍', color: '#7f1d1d',
    text: `You might think a story about an American wedding funded by a Russian billionaire has nothing to do with you. But the issues it raises — corruption, foreign influence, and the power of money in politics — affect every country on Earth.\n\nThailand has experienced its own challenges with money in politics. Political donations, business connections to political parties, and the influence of wealthy individuals on government policy are recurring themes in Thai politics. The details are different from the American story, but the underlying dynamic is the same: those with money have more power than those without.\n\nThe Trump Jr wedding story is also a reminder that in the modern world, political relationships cross borders. Russian money flowing to American politicians, Chinese investment in African politics, Gulf state funding of European institutions — these international connections create webs of influence that ordinary citizens can barely see, let alone control.\n\nTransparency is the best available defence. When political funding is public, voters can judge for themselves whether their leaders are serving the people or serving their donors. When it is secret — as the wedding funding was until this week investigation — voters are left in the dark.\n\nA wedding is a private event. But when the groom father is the President of the United States and the person paying is a Russian oligarch with ties to Vladimir Putin, it stops being private. It becomes a question about the integrity of the most powerful government in the world — and that is everyone business.`,
    vocab: [
      { word: 'Corruption', definition: 'Dishonest behaviour by people in power — using public position for private gain.' },
      { word: 'Transparency', definition: 'Openness — making information available to the public so they can see what is happening.' },
      { word: 'Integrity', definition: 'Honesty and strong moral principles — being trustworthy and uncorrupt.' },
      { word: 'Donors', definition: 'People who give money to support a cause, campaign, or organisation.' },
    ],
    questions: [
      { n: 10, q: 'Thailand has its own challenges with money in politics. What similarities and differences do you see with the American story?' },
      { n: 11, q: 'Transparency is described as the best defence against corruption. Is it enough? What else is needed?' },
      { n: 12, q: 'A private wedding becomes everyone business when power and foreign money are involved. Where is the line between private and public?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Trump Jr Wedding Secretly Funded by Russian Oligarch". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function TrumpWeddingPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Trump Jr Wedding Secretly Funded by Russian Oligarch</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Donald Trump Jr lavish Bahamas wedding was secretly paid for by a Russian oligarch close to Putin. Private islands, fireworks from barges, and the questions nobody is asking.</p>
            </div>
          </div>
