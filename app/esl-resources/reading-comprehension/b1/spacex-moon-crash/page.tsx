...
const PARTS = [
  {
    number: 1, title: 'A Crash Nobody Expected', emoji: '🌕', color: '#dc2626',
    text: `On 5 August 2026, a piece of a SpaceX Falcon 9 rocket crashed into the Moon at approximately 8,700 kilometres per hour. The impact created a new crater roughly 18 metres wide near a lunar feature called Einstein Crater. Nobody was hurt — the Moon is uninhabited — but the event raised eyebrows for a simple reason: nobody had planned for this to happen.\n\nThe rocket stage had been drifting through space for more than 18 months. It was originally launched in January 2025 as part of a mission to deliver lunar landers. After completing its job, the upper stage was left in space — standard practice for stages that are too high to fall back to Earth and burn up.\n\nOver the following months, the pull of the Sun, the Earth, and the Moon gradually altered its path. Solar radiation pushed it off course. Gravitational forces tugged it in different directions. Eventually, its trajectory intersected with the Moon — and the roughly four-tonne chunk of metal slammed into the lunar surface.\n\nScientists had hoped to observe the impact flash — the bright burst of light created by a high-speed collision. But no ground-based telescopes confirmed a visual sighting. NASA said its lunar orbiters would photograph the impact site in the coming weeks, adding a new human-made crater to the Moon's ancient, battered surface.`,
    vocab: [
      { word: 'Trajectory', definition: 'The path that a moving object follows through space.' },
      { word: 'Payload', definition: 'The cargo carried by a rocket — the equipment or satellites it delivers.' },
      { word: 'Solar radiation', definition: 'Energy from the Sun that travels through space as light and heat.' },
      { word: 'Debris', definition: 'Scattered pieces of something that has been broken or destroyed.' },
    ],
    questions: [
      { n: 1, q: 'A rocket crashed into the Moon by accident. Should we be worried about things we leave floating in space?' },
      { n: 2, q: 'The rocket drifted for 18 months before hitting the Moon. What does this tell us about how objects move through space?' },
      { n: 3, q: 'If you could watch a rocket hit the Moon from a telescope, would you want to? Why?' },
    ]
  },
  {
    number: 2, title: 'Space Junk — A Growing Problem', emoji: '🛰️', color: '#b91c1c',
    text: `The SpaceX rocket is just one piece of a much larger problem: space junk. Since the Space Age began in 1957, humans have launched thousands of rockets and satellites — and most of the debris is still up there.\n\nThere are currently more than 36,000 objects larger than 10 centimetres being tracked in Earth orbit. These include dead satellites, spent rocket stages, tools dropped by astronauts, and fragments from collisions. Below the tracking threshold, there are an estimated 130 million pieces smaller than one centimetre — too small to track but large enough to damage a satellite.\n\nThe speeds involved make even small pieces extremely dangerous. Objects in low Earth orbit travel at approximately 28,000 kilometres per hour. At that speed, a paint chip can crack a spacecraft window. A bolt can punch through a satellite. A piece the size of a marble can destroy a space station.\n\nThe International Space Station regularly adjusts its orbit to avoid collisions with tracked debris. In 2021, Russia deliberately destroyed one of its own old satellites in a weapons test, creating more than 1,500 new pieces of tracked debris. Some scientists warn of a future scenario called "Kessler syndrome" — a chain reaction of collisions that could make parts of Earth orbit unusable for decades.`,
    vocab: [
      { word: 'Space junk', definition: 'Human-made objects left in space that no longer serve any purpose.' },
      { word: 'Orbit', definition: 'The curved path that an object follows as it travels around a planet or star.' },
      { word: 'Manoeuvre', definition: 'A planned movement or change of direction to avoid danger.' },
      { word: 'Chain reaction', definition: 'A series of events where each one causes the next — like dominoes falling.' },
    ],
    questions: [
      { n: 4, q: 'There are 36,000 large objects and 130 million small pieces of junk in orbit. Did you know space was this cluttered?' },
      { n: 5, q: 'A paint chip at 28,000 km/h can crack a spacecraft window. Why does speed make small objects so dangerous?' },
      { n: 6, q: 'Russia destroyed its own satellite and created 1,500 pieces of debris. Should weapons tests in space be banned?' },
    ]
  },
  {
    number: 3, title: 'Who Cleans Up Space?', emoji: '🧹', color: '#991b1b',
    text: `On Earth, when someone dumps rubbish illegally, there are laws and fines. In space, there is almost nothing. The question of who cleans up space junk is one of the most complicated challenges of the modern space age.\n\nThe 1967 Outer Space Treaty says that objects launched into space remain the property of the country that launched them, even after they stop working. This means a dead satellite belongs to the country that put it there, and nobody else can touch it without permission. This creates a bizarre situation: thousands of dangerous objects float through space, and removing them could technically be interference with another country's property.\n\nSeveral companies are developing technologies to clean up debris. The European Space Agency is planning ClearSpace-1, which will use a robot with four mechanical arms to grab debris and drag it into the atmosphere to burn up. Japan's Astroscale has tested a magnetic capture system. Other proposals include using lasers to slow debris down or giant nets to catch it.\n\nBut all of these solutions face the same problem: cleaning up space is extremely expensive, and nobody wants to pay. The companies that create the debris have no legal obligation to clean up after themselves. Until that changes, the amount of junk in space will continue to grow.`,
    vocab: [
      { word: 'Treaty', definition: 'A formal agreement between countries — official rules that nations agree to follow.' },
      { word: 'Interference', definition: 'Getting involved in something without permission — meddling or disrupting.' },
      { word: 'Obligation', definition: 'Something you are required to do — a duty or responsibility.' },
      { word: 'Capture', definition: 'To catch and hold something — to take control of an object.' },
    ],
    questions: [
      { n: 7, q: 'A dead satellite is still the property of the country that launched it. Is this a good law? What would you change?' },
      { n: 8, q: 'Robots, magnets, lasers, and nets have been proposed for cleaning up space. Which idea sounds best to you?' },
      { n: 9, q: 'Companies that create space junk have no obligation to clean it up. Should they be forced to? How?' },
    ]
  },
  {
    number: 4, title: 'Our Messy Relationship with Space', emoji: '🚀', color: '#7f1d1d',
    text: `The SpaceX rocket crashing into the Moon is a small event with a big message: humans are very good at going places and very bad at cleaning up after themselves.\n\nThis pattern is not unique to space. We have polluted the oceans with plastic, filled the atmosphere with carbon dioxide, and left rubbish on the summit of Mount Everest. Now we are doing the same thing in space — the one environment we had the chance to keep clean from the very beginning.\n\nThe Moon itself is already littered with human objects. The Apollo missions left behind six American flags, several lunar rovers, scientific instruments, and about 100 bags of human waste. Other countries have left crashed probes on the surface. The SpaceX rocket stage is simply the latest addition.\n\nDoes this matter? Some argue that debris on the Moon is insignificant — the Moon has no life, no atmosphere, and no environment to protect. Others argue it matters because of what it says about us. If we cannot keep space clean when we are just beginning to explore it, what will happen when space travel becomes routine?\n\nA piece of a rocket hit the Moon this week. It was an accident. But the mess we are making in space is not accidental — it is the predictable result of exploration without responsibility. And that is a problem we will need to solve before we go any further.`,
    vocab: [
      { word: 'Pristine', definition: 'In its original, untouched condition — perfectly clean and undamaged.' },
      { word: 'Insignificant', definition: 'Too small or unimportant to matter — not worth worrying about.' },
      { word: 'Routine', definition: 'A regular, normal activity — something that happens often and is not special.' },
      { word: 'Predictable', definition: 'Expected and unsurprising — something that could have been foreseen.' },
    ],
    questions: [
      { n: 10, q: 'We polluted the oceans, the air, and Mount Everest. Now we are polluting space. Why do humans keep making this mistake?' },
      { n: 11, q: 'The Apollo missions left bags of waste on the Moon. Does this bother you? Should we clean it up or is it history?' },
      { n: 12, q: 'Can we explore space responsibly? What would that look like?' },
    ]
  },
]
...
export default function MoonCrashPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>SpaceX Rocket Crashes Into the Moon</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A SpaceX rocket drifted through space for 18 months then crashed into the Moon. The growing problem of space junk and why cleaning up space is so difficult.</p>
            </div>
          </div>
