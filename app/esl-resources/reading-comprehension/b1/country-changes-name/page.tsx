...
const PARTS = [
  {
    number: 1, title: 'What Is in a Name?', emoji: '🏝️', color: '#dc2626',
    text: `This week, one of the smallest countries in the world did something that made headlines everywhere: it changed its name. The tiny Pacific island nation formerly known as Nauru officially became the Republic of Naoero. The new name matches the traditional spelling used by the island's indigenous people for centuries before European colonisers arrived and renamed it.\n\nNaoero is a coral island in the central Pacific Ocean, about 4,000 kilometres northeast of Australia. It has a population of just 12,000 people and a land area of only 21 square kilometres — making it one of the three smallest countries on Earth by both population and size. If you walked around the entire island, it would take about four hours.\n\nThe country adopted the name "Nauru" when it became independent in 1968, because it was thought to be easier for foreigners to pronounce. But many Naoero citizens felt that the foreign name erased an important part of their identity. The traditional pronunciation — "now-ero" rather than "now-roo" — carries cultural and historical significance that the anglicised version does not.\n\nThe change might seem small — just a few letters — but for the people of Naoero, it represents something much bigger: the right to be called what you call yourself, in your own language, rather than what others decided to call you. It is a story about identity, language, colonialism, and the power of names.`,
    vocab: [
      { word: 'Indigenous', definition: 'The original inhabitants of a place — people who lived there before colonisers arrived.' },
      { word: 'Colonisers', definition: 'People from one country who take control of another country or territory.' },
      { word: 'Anglicised', definition: 'Changed to make it sound more English — adapted for English speakers.' },
      { word: 'Identity', definition: 'Who you are — the qualities, beliefs, and history that make a person or group unique.' },
    ],
    questions: [
      { n: 1, q: 'Naoero changed its name back to the traditional spelling. Why do you think names are so important to people and countries?' },
      { n: 2, q: 'The name "Nauru" was adopted because it was easier for foreigners. Should countries change their names to suit outsiders, or keep their original names?' },
      { n: 3, q: 'Can you think of other places that have changed their names? Why did they do it?' },
    ]
  },
  {
    number: 2, title: 'Why Countries Change Their Names', emoji: '🗺️', color: '#b91c1c',
    text: `Naoero is not the first country to reclaim its original name, and it will not be the last. Across the world, dozens of countries, cities, and geographical features have changed their names — often to shake off colonial histories and reassert their own identities.\n\nIn 2018, Swaziland in southern Africa became Eswatini — the name the Swazi people had always used for their country. King Mswati III made the change on the 50th anniversary of independence from Britain, saying it was absurd that the country was still using a name given by its colonisers.\n\nTurkey officially changed its international name from "Turkey" to "Turkiye" in 2022. The government argued that the English word "Turkey" had unwanted associations — particularly with the bird — and did not reflect how Turkish people referred to their own country.\n\nIn Asia, Myanmar was formerly known as Burma, and its largest city Yangon was formerly Rangoon. India has renamed several cities: Bombay became Mumbai, Madras became Chennai, and Calcutta became Kolkata. In each case, the new names reflected local languages rather than British colonial pronunciations.\n\nThese changes are never just about spelling. They are about power — specifically, the power to define yourself rather than being defined by others. When a European country colonised a place, one of the first things it did was rename it. Mountains, rivers, cities, and entire nations were given European names, erasing the names that indigenous peoples had used for thousands of years. Reclaiming those original names is a way of reversing that erasure.`,
    vocab: [
      { word: 'Reclaim', definition: 'To take back something that was yours — to recover what was lost or taken away.' },
      { word: 'Reassert', definition: 'To state or claim something again with confidence — to insist on it firmly.' },
      { word: 'Absurd', definition: 'Completely unreasonable or ridiculous — so silly that it should not be taken seriously.' },
      { word: 'Erasure', definition: 'The act of removing or eliminating something — making it disappear as if it never existed.' },
    ],
    questions: [
      { n: 4, q: 'Swaziland, Turkey, and India have all changed names. Do you know any other examples? Why do you think more countries are doing this now?' },
      { n: 5, q: 'Turkey changed its name partly because of the association with the bird. Should countries care about how their name sounds in other languages?' },
      { n: 6, q: 'Colonisers renamed places to erase local identity. How does giving something a new name change how people think about it?' },
    ]
  },
  {
    number: 3, title: 'The Power of Language', emoji: '💬', color: '#991b1b',
    text: `The story of Naoero is also a story about language — and why languages matter far more than most people realise.\n\nThere are approximately 7,000 languages spoken in the world today. But linguists estimate that by the end of this century, between 50% and 90% of them will have disappeared. Languages die when their last speakers die — and in a globalised world where English, Mandarin, Spanish, and a handful of other major languages dominate business, education, and the internet, smaller languages are being squeezed out at an alarming rate.\n\nWhen a language dies, it is not just words that are lost. Every language contains a unique way of seeing the world — concepts, distinctions, and ideas that do not exist in other languages. The Inuit people of the Arctic have dozens of words for different types of snow. The Pirah people of the Amazon have no words for specific numbers. The Australian Aboriginal language Guugu Yimithirr uses compass directions instead of left and right — speakers say "the cup is to the northeast of the plate" rather than "the cup is to the left." Each of these linguistic features reveals a different way of understanding and interacting with the world.\n\nNaoero's decision to restore its traditional name is a small but symbolic act of linguistic preservation. It says: our language matters. Our way of saying our own name matters. In a world where small languages are disappearing every month, every act of preservation — no matter how small — counts.\n\nFor ESL students, this story has a personal dimension too. Learning English opens enormous opportunities — but it should not come at the cost of losing your own language and identity. The goal is not to replace your first language with English, but to add English to the languages you already have.`,
    vocab: [
      { word: 'Linguists', definition: 'Scientists who study languages — how they work, how they change, and how they are connected.' },
      { word: 'Globalised', definition: 'Connected across the whole world — where countries, cultures, and economies are increasingly linked.' },
      { word: 'Preservation', definition: 'The act of keeping something alive and protecting it from being lost or destroyed.' },
      { word: 'Symbolic', definition: 'Representing something bigger than itself — an action that carries deeper meaning.' },
    ],
    questions: [
      { n: 7, q: 'Up to 90% of languages could disappear this century. Does this matter? What is lost when a language dies?' },
      { n: 8, q: 'Some languages have concepts that do not exist in other languages. Can you think of a word in your language that has no English equivalent?' },
      { n: 9, q: 'The passage says learning English should not replace your first language. Do you agree? How do you balance learning English with keeping your own language strong?' },
    ]
  },
  {
    number: 4, title: 'What Should We Call Things?', emoji: '🤔', color: '#7f1d1d',
    text: `The Naoero story raises a surprisingly tricky question: what should we call places, people, and things — and who gets to decide?\n\nIn English, we call the country next to France "Germany." But Germans call it "Deutschland." The French call it "Allemagne." Italians call it "Germania." Polish people call it "Niemcy." None of these names sound anything alike, and none of them is what the country calls itself. This is true for many countries — Japan calls itself "Nihon," Greece calls itself "Hellas," and Egypt calls itself "Misr."\n\nShould English speakers start using these original names? The argument for doing so is clear: it shows respect for other cultures and their right to name themselves. The argument against is practical: changing established names causes confusion, and many people would struggle to recognise familiar countries by unfamiliar names.\n\nThe same debate applies to personal names. Many people from Asian, African, and Middle Eastern cultures adopt English names when they move to English-speaking countries or work in international businesses — not because they want to, but because their real names are difficult for English speakers to pronounce. This practice, while practical, involves a real loss of identity. Your name is one of the most personal things about you, and having to change it because other people find it inconvenient sends a powerful message about whose comfort matters more.\n\nNaoero's decision to reclaim its name challenges all of us to think about these questions. What do we call things? Why? And are we willing to make the small effort of learning to pronounce someone's actual name — whether it belongs to a person or a country — rather than replacing it with something easier for us?`,
    vocab: [
      { word: 'Established', definition: 'Accepted and used for a long time — well-known and traditional.' },
      { word: 'Adopt', definition: 'To take on or start using something new — like choosing a new name.' },
      { word: 'Inconvenient', definition: 'Causing difficulty or extra effort — not easy or comfortable.' },
      { word: 'Pronounce', definition: 'To say a word correctly — to speak a name or word the right way.' },
    ],
    questions: [
      { n: 10, q: 'Should English speakers call Germany "Deutschland" and Japan "Nihon"? What are the arguments for and against?' },
      { n: 11, q: 'Many people from Asian cultures adopt English names at work. Have you ever done this? How does it feel to use a different name?' },
      { n: 12, q: 'Is learning to pronounce someone\'s real name a matter of respect? What would you say to someone who said your name was too difficult?' },
    ]
  },
]
...
export default function NaoeroPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>A Country Changes Its Name</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Nauru became Naoero this week, reclaiming its traditional name. Why countries change their names, why languages matter, and who gets to decide what we call things.</p>
            </div>
          </div>
