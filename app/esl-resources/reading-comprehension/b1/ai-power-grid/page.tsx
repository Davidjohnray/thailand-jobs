...
const PARTS = [
  {
    number: 1, title: 'The Machines Are Thirsty', emoji: '⚡', color: '#dc2626',
    text: `On 4 August 2026, the Governor of Texas did something unusual: he ordered a pause on all approvals for new data centres in the state. The reason? The enormous amount of electricity that data centres consume was threatening the reliability of the entire Texas power grid. There simply was not enough electricity to keep the lights on for ordinary Texans and power the hundreds of new data centres that technology companies wanted to build.\n\nA data centre is a large building filled with thousands of powerful computers that store, process, and transmit the data that powers the internet. Every time you search Google, watch a YouTube video, send a message on social media, or ask an AI chatbot a question, your request travels to a data centre somewhere in the world, is processed by computers, and the answer is sent back to you — usually in less than a second.\n\nData centres have existed for decades, but the explosion of artificial intelligence has dramatically increased their power consumption. Training a large AI model like GPT or Claude requires enormous amounts of computing power running continuously for weeks or months. A single AI training run can consume as much electricity as a small town uses in an entire year.\n\nThe numbers are staggering. Data centres in the United States are expected to consume more than 12% of the country total electricity by 2028 — up from about 4% in 2023. Globally, data centre electricity consumption is growing faster than any other sector. The International Energy Agency has warned that the AI boom could add the electricity demand of an entire country — roughly equivalent to Japan — to the global grid by 2030.`,
    vocab: [
      { word: 'Data centre', definition: 'A large building filled with powerful computers that store and process information for the internet.' },
      { word: 'Power grid', definition: 'The network of cables, power stations, and systems that delivers electricity to homes and businesses.' },
      { word: 'Transmit', definition: 'To send or pass something from one place to another — especially data or signals.' },
      { word: 'Sector', definition: 'A particular area or part of something larger — a section of the economy or industry.' },
    ],
    questions: [
      { n: 1, q: 'Every Google search and AI question uses electricity in a data centre. Did you know this? Does it change how you think about using the internet?' },
      { n: 2, q: 'A single AI training run uses as much electricity as a small town in a year. Is AI worth this cost? Where should the line be drawn?' },
      { n: 3, q: 'Texas paused new data centres because the grid could not handle the demand. What would happen if the electricity ran out?' },
    ]
  },
  {
    number: 2, title: 'Where Does the Power Come From?', emoji: '🔌', color: '#b91c1c',
    text: `The growing electricity demand from data centres creates a serious problem: where does all that extra power come from?\n\nIn many countries, electricity is still generated primarily by burning fossil fuels — coal, natural gas, and oil. Building new data centres powered by fossil fuels would dramatically increase carbon emissions at exactly the time when the world is trying to reduce them. This creates a painful contradiction: artificial intelligence could help solve climate change (by optimising energy use, improving weather forecasting, and designing better materials) — but the energy required to run AI is itself contributing to the problem.\n\nTech companies are aware of this contradiction. Microsoft, Google, Amazon, and Meta have all pledged to power their data centres with 100% renewable energy. But the reality is more complicated than the pledges suggest. Building new solar farms and wind turbines takes time — often five to ten years from planning to operation. In the meantime, the demand for data centre electricity is growing now, and much of it is being met by extending the life of existing fossil fuel power plants or building new natural gas facilities.\n\nSome companies are exploring more radical solutions. Microsoft has signed a deal to use nuclear power. Google has invested in geothermal energy — heat from deep inside the Earth. Amazon is building massive solar farms in the desert. Some researchers are even exploring the possibility of placing data centres in cold climates — like Iceland or northern Scandinavia — where the natural cold air can be used to cool the computers, reducing the energy needed for air conditioning, which accounts for roughly 40% of a data centre total electricity consumption.\n\nThe race to find clean energy for AI is one of the most important and least discussed challenges in the climate debate.`,
    vocab: [
      { word: 'Fossil fuels', definition: 'Energy sources like coal, oil, and gas that were formed from ancient plants and animals millions of years ago.' },
      { word: 'Carbon emissions', definition: 'Carbon dioxide and other greenhouse gases released into the atmosphere, mainly from burning fossil fuels.' },
      { word: 'Renewable energy', definition: 'Energy from sources that never run out — like sunlight, wind, and water.' },
      { word: 'Geothermal', definition: 'Energy generated from the natural heat inside the Earth.' },
    ],
    questions: [
      { n: 4, q: 'AI could help solve climate change, but running AI makes climate change worse. How do we solve this contradiction?' },
      { n: 5, q: 'Tech companies promise 100% renewable energy, but many still use fossil fuels. Should companies be held accountable for their promises?' },
      { n: 6, q: 'Some data centres could be built in cold places like Iceland to save energy on cooling. What other creative solutions can you think of?' },
    ]
  },
  {
    number: 3, title: 'Water, Heat, and the Neighbours', emoji: '🌡️', color: '#991b1b',
    text: `Electricity is not the only resource that data centres consume in enormous quantities. They also use vast amounts of water.\n\nComputers generate heat when they work, and thousands of computers working together in a data centre generate an enormous amount of heat. Without cooling, the computers would overheat and fail within minutes. The most common cooling method uses water — either directly, by running cold water through pipes near the computers, or indirectly, through cooling towers that evaporate water to remove heat from the air.\n\nA single large data centre can use more than 5 million litres of water per day — roughly the same amount that a town of 50,000 people uses. In places where water is already scarce — like parts of Texas, Arizona, and the Middle East — this consumption creates direct competition between data centres and local communities for a limited resource.\n\nData centres also affect the communities around them in other ways. They generate constant low-frequency noise from cooling fans and backup generators. They produce heat that can raise the temperature of surrounding areas. They require massive amounts of land — some data centre campuses cover more than 100 hectares. And while they create some jobs, data centres are highly automated and employ far fewer people per square metre than traditional businesses.\n\nLocal communities increasingly push back against new data centre construction. In parts of Ireland, the Netherlands, and Virginia — all major data centre hubs — residents have organised against new facilities, arguing that the costs to local infrastructure, water, and quality of life outweigh the economic benefits. The Texas pause reflects this growing tension between the technology industry's appetite for computing power and communities' need for reliable, affordable basic services.`,
    vocab: [
      { word: 'Evaporate', definition: 'To change from liquid to gas — water turning into vapour, usually because of heat.' },
      { word: 'Scarce', definition: 'Not enough to meet demand — in short supply and hard to find.' },
      { word: 'Automated', definition: 'Run by machines or computers with little or no human involvement.' },
      { word: 'Push back', definition: 'To resist or oppose something — to fight against a decision or plan.' },
    ],
    questions: [
      { n: 7, q: 'A single data centre uses as much water as a town of 50,000 people. Should data centres be built in places where water is scarce?' },
      { n: 8, q: 'Data centres bring few jobs but use lots of resources. Would you want one built near your home? Why or why not?' },
      { n: 9, q: 'Communities are pushing back against data centres. Should local people have the power to block them, even if the technology benefits the whole country?' },
    ]
  },
  {
    number: 4, title: 'The Hidden Cost of the Internet', emoji: '💭', color: '#7f1d1d',
    text: `Most people use the internet every day without thinking about the physical infrastructure that makes it possible. We stream videos, search for information, post on social media, and talk to AI chatbots as if these things happen by magic — as if the internet exists in some invisible, weightless cloud.\n\nThe reality is very different. The internet is physical. It runs on cables buried under the ocean, satellites orbiting the Earth, mobile phone towers on hilltops, and data centres the size of shopping malls humming with electricity 24 hours a day. Every click, every search, every streamed song has a physical cost — in electricity, in water, in land, in carbon emissions.\n\nThe term "the cloud" is itself misleading. There is no cloud. There are just other people's computers — millions of them, housed in data centres, consuming resources and producing waste. When a company says your photos are "stored in the cloud," what they mean is that your photos are on a hard drive in a building somewhere, kept running by electricity generated at a power station, cooled by water pumped from a river or an underground source.\n\nNone of this means we should stop using the internet or AI. These technologies have transformed our lives in overwhelmingly positive ways. But it does mean we should be honest about their costs — and make informed decisions about how to manage those costs sustainably. The Texas data centre pause is a small but important step towards that honesty.\n\nThe next time you ask an AI a question, remember: somewhere in the world, a computer is using electricity to think about your answer. The question is whether we are willing to pay the true cost of that thought — not just in money, but in energy, water, and the health of the planet.`,
    vocab: [
      { word: 'Infrastructure', definition: 'The basic systems and structures needed for something to work — cables, buildings, power systems.' },
      { word: 'Misleading', definition: 'Giving a wrong or false impression — making people believe something that is not quite true.' },
      { word: 'Sustainably', definition: 'In a way that can continue without damaging the environment or using up resources.' },
      { word: 'Informed decisions', definition: 'Choices made after understanding the facts and consequences — not guessing or assuming.' },
    ],
    questions: [
      { n: 10, q: 'The passage says "there is no cloud — just other people s computers." Does this change how you think about where your photos and data are stored?' },
      { n: 11, q: 'Every internet search has an environmental cost. Should websites show users how much energy their activity uses, like food labels show calories?' },
      { n: 12, q: 'AI is transforming our lives but uses enormous amounts of energy and water. How do we balance the benefits of technology with its environmental costs?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>AI Data Centres Are Eating the Power Grid</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Texas paused all new data centres because AI is consuming too much electricity. The hidden cost of every Google search, every AI question, and every streamed video.</p>
            </div>
          </div>
