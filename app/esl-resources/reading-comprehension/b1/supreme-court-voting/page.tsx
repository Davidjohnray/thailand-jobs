...
const PARTS = [
  {
    number: 1, title: 'The Court Says No', emoji: '⚖️', color: '#dc2626',
    text: `The United States Supreme Court blocked President Trump this week from restricting mail-in voting ahead of November midterm elections. The court upheld a lower court ruling that prevented the US Postal Service from refusing to deliver mail-in ballots to voters not on a new federal list.\n\nThe decision is significant because millions of Americans vote by mail — sending their ballot through the postal system instead of going to a polling station in person. Trump has repeatedly claimed, without evidence, that mail-in voting leads to widespread fraud. His executive order attempted to create a federal list of eligible voters and block ballots sent by anyone not on that list.\n\nCritics said the plan would disenfranchise millions of legitimate voters — particularly elderly people, disabled people, rural residents, and members of the military serving overseas, all of whom depend heavily on mail-in voting. They described it as voter suppression disguised as fraud prevention.\n\nThe Supreme Court ruling was brief and unsigned — meaning the justices did not explain their reasoning in detail. But the result is clear: mail-in voting will continue as normal for the November 2026 midterm elections, and the government cannot create barriers to receiving or sending ballots by post.`,
    vocab: [
      { word: 'Mail-in voting', definition: 'Voting by sending your ballot through the postal system instead of going to a polling station.' },
      { word: 'Disenfranchise', definition: 'To take away someone right to vote — preventing them from participating in elections.' },
      { word: 'Ballot', definition: 'The paper or electronic form on which a voter records their choice in an election.' },
      { word: 'Voter suppression', definition: 'Deliberate actions to prevent certain groups of people from voting.' },
    ],
    questions: [
      { n: 1, q: 'Trump claims mail-in voting causes fraud. Courts say there is no evidence. Who should people believe?' },
      { n: 2, q: 'Elderly, disabled, rural, and military voters depend on mail-in voting. Why would restricting it affect these groups most?' },
      { n: 3, q: 'How do people vote in your country? Is it easy to vote, or are there barriers?' },
    ]
  },
  {
    number: 2, title: 'How Voting Works in America', emoji: '🇺🇸', color: '#b91c1c',
    text: `Voting in the United States is more complicated than in most democracies — and understanding why helps explain the current controversy.\n\nUnlike many countries, the United States does not have a national voter registration system. Each of the 50 states manages its own voter rolls, with different rules about who can vote, how to register, and what identification is required. Some states allow same-day registration at polling stations. Others require registration weeks in advance. Some accept any photo ID. Others require specific government-issued documents.\n\nMail-in voting rules also vary by state. Five states conduct their elections almost entirely by mail — every registered voter receives a ballot automatically. Others require voters to request a mail-in ballot in advance and provide a reason why they cannot vote in person. The patchwork of rules means that your right to vote depends partly on where you live.\n\nVoter turnout in the United States is lower than in most other developed democracies — typically around 50-60% in midterm elections and 60-70% in presidential elections. Many Americans do not vote because the process is too complicated, because they cannot take time off work, or because they feel their vote does not matter.\n\nThe debate over mail-in voting is really a debate about who gets to vote and how easy it should be. Those who support expanded mail-in voting argue it makes democracy more accessible. Those who oppose it argue it creates opportunities for fraud — though study after study has found that mail-in voting fraud is extremely rare.`,
    vocab: [
      { word: 'Voter rolls', definition: 'The official lists of people registered and eligible to vote in an election.' },
      { word: 'Patchwork', definition: 'A collection of different pieces — inconsistent rules that vary from place to place.' },
      { word: 'Turnout', definition: 'The percentage of eligible voters who actually vote in an election.' },
      { word: 'Accessible', definition: 'Easy to reach and use — available to everyone without unnecessary barriers.' },
    ],
    questions: [
      { n: 4, q: 'Voting rules change depending on which state you live in. Is this fair? Should rules be the same everywhere?' },
      { n: 5, q: 'Only 50-60% of Americans vote in midterm elections. Why is turnout so low in the world oldest democracy?' },
      { n: 6, q: 'Studies show mail-in fraud is extremely rare. Why does the myth persist? Who benefits from it?' },
    ]
  },
  {
    number: 3, title: 'Democracy Under Pressure', emoji: '🏛️', color: '#991b1b',
    text: `The voting controversy is part of a broader pattern: democracy in the United States — and in many other countries — is under increasing pressure.\n\nIn the US, efforts to restrict voting have intensified in recent years. Since 2020, state legislatures have passed hundreds of laws making it harder to vote — reducing early voting hours, closing polling stations in minority neighbourhoods, requiring specific forms of identification, and limiting the use of drop boxes for mail-in ballots. Critics describe these laws as targeted at minority communities that tend to vote for the Democratic Party.\n\nThe US is not alone. Around the world, democratic institutions are being weakened. Freedom House — an organisation that tracks democracy globally — reports that more countries have been moving away from democracy than toward it for 18 consecutive years. Authoritarian leaders use elections to legitimise their power while undermining the conditions that make elections meaningful — free press, independent courts, and equal access to the ballot.\n\nFor ESL students, understanding how democracy works — and how it can be weakened — is not just an academic exercise. Thailand has experienced its own democratic struggles, including multiple coups and constitutional changes. The principles at stake in the US voting debate — who gets to vote, how votes are counted, and whether the result is respected — are universal.`,
    vocab: [
      { word: 'Legislatures', definition: 'The elected bodies that make laws — parliaments and congresses.' },
      { word: 'Drop boxes', definition: 'Secure containers where voters can deposit their mail-in ballots.' },
      { word: 'Authoritarian', definition: 'A system where power is concentrated in a single leader or small group with limited freedoms.' },
      { word: 'Legitimise', definition: 'To make something appear lawful and proper — giving the appearance of being democratic.' },
    ],
    questions: [
      { n: 7, q: 'Hundreds of laws have made it harder to vote in the US. Why would elected officials want fewer people to vote?' },
      { n: 8, q: 'More countries are moving away from democracy than toward it. Why is this happening?' },
      { n: 9, q: 'Thailand has experienced coups and constitutional changes. How does your own country democratic history shape how you think about voting?' },
    ]
  },
  {
    number: 4, title: 'Your Vote, Your Voice', emoji: '✊', color: '#7f1d1d',
    text: `The Supreme Court decision to protect mail-in voting is a reminder that democracy is not automatic — it requires constant defence.\n\nDemocracy is sometimes described as the worst form of government except for all the others. It is slow, messy, and often produces results that large numbers of people disagree with. But it has one advantage that no other system offers: the ability to change your government without violence. The ballot box replaces the battlefield. Disagreements are settled by counting votes, not by counting bodies.\n\nThis system only works if everyone who is eligible can vote, and if every vote is counted fairly. When barriers are placed between citizens and the ballot box — whether through restrictive laws, complicated registration processes, or intimidation — democracy is weakened. And when people lose faith that their vote matters, they stop participating — creating a downward spiral in which fewer voters produce less representative governments, which in turn make more people feel that voting is pointless.\n\nThe US midterm elections are in November 2026. The issues on the ballot — healthcare, immigration, the economy, the Iran war — will affect not just Americans but people around the world. The Supreme Court ruling ensures that millions of Americans who would otherwise have been prevented from voting will be able to make their voices heard.\n\nDemocracy is not a spectator sport. It works only when people participate — by voting, by paying attention, by demanding accountability from their leaders. Whether you live in the United States, Thailand, or anywhere else, the principle is the same: your vote is your voice. And your voice matters.`,
    vocab: [
      { word: 'Ballot box', definition: 'The container where votes are placed — symbolically, the democratic process itself.' },
      { word: 'Intimidation', definition: 'Using fear to influence behaviour — threatening people to prevent them from acting.' },
      { word: 'Representative', definition: 'Accurately reflecting the views of the people — a government that represents its citizens.' },
      { word: 'Accountability', definition: 'Being held responsible for actions — leaders answering to the people they serve.' },
    ],
    questions: [
      { n: 10, q: 'Democracy is described as the worst system except for all the others. Do you agree?' },
      { n: 11, q: 'When people stop believing their vote matters, they stop voting. How do you break this cycle?' },
      { n: 12, q: 'Your vote is your voice. Do you plan to vote in your country next election? Why or why not?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Supreme Court Blocks Trump on Mail-In Voting". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Supreme Court Blocks Trump on Mail-In Voting</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The Supreme Court blocked Trump attempt to restrict mail-in voting before the midterm elections. What mail-in voting is, why it matters, and who gets to decide how you vote.</p>
            </div>
          </div>
