...
const PARTS = [
  {
    number: 1, title: 'Alone in the Ice', emoji: '⛵', color: '#dc2626',
    text: `Matt Rutherford is alone in the Arctic Ocean, sailing a small boat through ice floes, storms, and some of the most dangerous waters on Earth. His goal: to complete a 10,000-nautical-mile solo voyage that nobody has ever accomplished — sailing around the entire Arctic Ocean in a single, unassisted journey.\n\nRutherford, an American sailor known for extreme voyages, set out from Maryland in the spring of 2026. His route takes him through the Northwest Passage — the treacherous waterway above Canada — across the top of Russia along the Northern Sea Route, and back down through the North Atlantic. The entire journey is expected to take five to six months.\n\nThis week, Rutherford spoke to NPR from the cabin of his 27-foot sailboat while navigating through ice floes north of Canada. He described conditions that would terrify most people: ice chunks larger than his boat scraping along the hull, temperatures below freezing, fog so thick he cannot see the bow of his own vessel, and winds that can shift from calm to violent in minutes.\n\nRutherford is not just sailing for the record. He is collecting ocean temperature data, water samples, and wildlife observations for scientific organisations. His route passes through areas rarely visited by humans, making his observations scientifically valuable. He is also raising awareness about climate change — the fact that his route is even possible is itself evidence that Arctic ice is retreating at an unprecedented rate.`,
    vocab: [
      { word: 'Ice floes', definition: 'Large sheets of floating ice on the surface of the ocean.' },
      { word: 'Solo', definition: 'Done alone, without any help or companions.' },
      { word: 'Treacherous', definition: 'Very dangerous and unpredictable — likely to cause harm.' },
      { word: 'Hull', definition: 'The main body of a ship — the part that sits in the water.' },
    ],
    questions: [
      { n: 1, q: 'Would you want to sail alone through the Arctic Ocean? What would be the scariest part?' },
      { n: 2, q: 'Rutherford route is only possible because Arctic ice is melting. Is this an adventure story or a climate change story?' },
      { n: 3, q: 'He is collecting scientific data while sailing. How can adventures also contribute to science?' },
    ]
  },
  {
    number: 2, title: 'Why People Seek the Impossible', emoji: '🏔️', color: '#b91c1c',
    text: `Matt Rutherford is part of a long tradition of human beings who deliberately seek out extreme challenges — not because they need to, but because something inside them demands it.\n\nThe history of exploration is full of people who risked everything to go where nobody had gone before. Ernest Shackleton sailed to Antarctica in 1914 and spent two years fighting for survival. Edmund Hillary climbed Mount Everest in 1953 because, as he famously said, "it was there." Amelia Earhart flew solo across the Atlantic Ocean in 1932, knowing that the journey could kill her.\n\nPsychologists have studied what drives people to seek extreme challenges. The motivation is rarely fame or money. Most extreme adventurers describe a need to test their limits — to discover what they are truly capable of when everything is stripped away. In the Arctic, alone on a small boat, there is no boss, no schedule, no social media, no comfort. There is only you, the ocean, and the question: can you survive?\n\nThere is also a philosophical dimension. Modern life is extraordinarily comfortable compared to any previous era. We have heating, air conditioning, supermarkets, hospitals, and entertainment available at the touch of a button. But this comfort comes at a cost — many people feel disconnected from the physical world, from their own bodies, and from the sense of purpose that comes from genuine struggle. Extreme adventure offers a return to something more fundamental.`,
    vocab: [
      { word: 'Deliberately', definition: 'Done on purpose — a conscious choice rather than an accident.' },
      { word: 'Stripped away', definition: 'Removed completely — everything unnecessary taken away.' },
      { word: 'Disconnected', definition: 'Feeling separated from something — not feeling connected to the world around you.' },
      { word: 'Fundamental', definition: 'Basic and essential — relating to the most important core of something.' },
    ],
    questions: [
      { n: 4, q: 'Why do people deliberately choose dangerous challenges? What drives someone to sail alone through the Arctic?' },
      { n: 5, q: 'Modern life is very comfortable but many people feel disconnected. Do you agree? Does comfort make us weaker?' },
      { n: 6, q: 'Hillary climbed Everest because "it was there." Is this a good enough reason to risk your life?' },
    ]
  },
  {
    number: 3, title: 'The Changing Arctic', emoji: '🧊', color: '#991b1b',
    text: `Rutherford's route around the Arctic Ocean would have been impossible just 30 years ago. The Northwest Passage — the waterway above Canada that connects the Atlantic and Pacific oceans — was blocked by ice for most of the year. Ships that attempted it risked being trapped and crushed. Entire expeditions were lost.\n\nToday, the Northwest Passage is open for several months each summer. Arctic sea ice has declined by more than 40% since satellite monitoring began in 1979. The ice that remains is thinner and weaker than it once was. What was once one of the most impenetrable environments on Earth is becoming navigable.\n\nThis transformation has enormous implications. As Arctic shipping routes open, they offer shorter paths between Asia and Europe — potentially reducing shipping times by weeks compared to routes through the Suez Canal. Russia is investing heavily in its Northern Sea Route, building icebreakers and port infrastructure to attract commercial shipping.\n\nBut the opening of the Arctic also means the loss of an ecosystem. Polar bears, walruses, seals, and countless other species depend on sea ice for hunting, breeding, and resting. As the ice disappears, these animals are losing their habitat. Indigenous communities that have lived on and around the ice for thousands of years are watching their world literally melt beneath them.\n\nRutherford sails through these changes every day. The water samples he collects, the temperatures he records, and the wildlife he observes all contribute to our understanding of how fast the Arctic is changing — and what we are losing.`,
    vocab: [
      { word: 'Impenetrable', definition: 'Impossible to get through — completely blocked or inaccessible.' },
      { word: 'Navigable', definition: 'Able to be sailed through — open enough for ships to pass.' },
      { word: 'Ecosystem', definition: 'A community of living things and their environment, all connected and depending on each other.' },
      { word: 'Habitat', definition: 'The natural home or environment of an animal or plant.' },
    ],
    questions: [
      { n: 7, q: 'The Northwest Passage was impossible 30 years ago. Now it is open. What does this speed of change tell us?' },
      { n: 8, q: 'Shorter shipping routes through the Arctic would save time and money. But at what environmental cost?' },
      { n: 9, q: 'Indigenous communities are watching their world melt. How should the world respond to people losing their homeland to climate change?' },
    ]
  },
  {
    number: 4, title: 'What We Can Learn from Sailors', emoji: '🌊', color: '#7f1d1d',
    text: `Matt Rutherford is sailing through one of the last wild places on Earth, and his journey offers lessons that go far beyond navigation.\n\nThe first lesson is about self-reliance. On a small boat in the Arctic, there is nobody to call for help. If something breaks, you fix it. If a storm comes, you endure it. If you make a mistake, you live with the consequences. In a world where most of us depend on systems, services, and other people for everything, the idea of being entirely responsible for your own survival is both terrifying and liberating.\n\nThe second lesson is about patience. Sailing is slow. Progress is measured in miles per day, not miles per hour. There are days when the wind dies and the boat barely moves. There are days when storms push you backwards. The ability to accept what you cannot control and keep going anyway is a skill that applies far beyond sailing.\n\nThe third lesson is about perspective. When you are alone on the ocean, surrounded by ice and water and sky, the concerns of daily life — work deadlines, social media notifications, traffic — seem absurdly small. The ocean does not care about your problems. This indifference is not depressing — it is freeing. It reminds you what actually matters.\n\nRutherford will return to Maryland in a few months, having sailed 10,000 miles through the top of the world. He will be thinner, weathered, and exhausted. But he will have answered the question he set out to answer: what happens when you test yourself against the most demanding environment on Earth? The answer, for those brave enough to ask, is always the same: you discover who you really are.`,
    vocab: [
      { word: 'Self-reliance', definition: 'The ability to depend on yourself — solving problems without help from others.' },
      { word: 'Liberating', definition: 'Making you feel free — releasing you from constraints or fears.' },
      { word: 'Indifference', definition: 'Not caring — having no interest or concern about something.' },
      { word: 'Weathered', definition: 'Showing the effects of exposure to harsh conditions — aged by wind, sun, and cold.' },
    ],
    questions: [
      { n: 10, q: 'Self-reliance means fixing everything yourself. Do you think modern life makes us too dependent on others?' },
      { n: 11, q: 'The ocean does not care about your problems. Is this thought depressing or freeing? Why?' },
      { n: 12, q: 'The passage says extreme challenges show you who you really are. Do you agree? What challenge has taught you the most about yourself?' },
    ]
  },
]
...
export default function ArcticSailorPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Solo Sailor in Arctic Ice</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Matt Rutherford is sailing 10,000 miles alone through the Arctic Ocean — a route that was impossible 30 years ago. Adventure, climate change, and what the ocean teaches us.</p>
            </div>
          </div>
