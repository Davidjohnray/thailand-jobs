...
const PARTS = [
  {
    number: 1, title: 'What Is a Near-Death Experience?', emoji: '✨', color: '#7c3aed',
    ...
    vocab: [
      { word: 'Unconscious', definition: 'Not awake and unable to feel or respond to the world around you.' },
      { word: 'Remarkable', definition: 'Very unusual or surprising in a way that deserves attention.' },
      { word: 'Tunnel', definition: 'A long passage through something, like a mountain or underground.' },
      { word: 'Ancient', definition: 'Belonging to a period of history very long ago.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever heard of a near-death experience before? What did you think of it?' },
      { n: 2, q: 'Why do you think so many people from different countries describe such similar experiences?' },
      { n: 3, q: 'Would you be frightened or comforted to hear someone describe their NDE? Why?' },
    ]
  },
  {
    number: 2, title: 'Famous Stories of NDEs', emoji: '🌟', color: '#6d28d9',
    ...
    vocab: [
      { word: 'Coma', definition: 'A state of deep unconsciousness that lasts for a long period of time.' },
      { word: 'Infection', definition: 'An illness caused by bacteria or a virus entering the body.' },
      { word: 'Operating theatre', definition: 'The room in a hospital where doctors perform surgery on patients.' },
      { word: 'Influence', definition: 'To have an effect on how someone thinks, feels, or behaves.' },
    ],
    questions: [
      { n: 4, q: 'Do you think Pam Reynolds really watched her operation from outside her body? Why or why not?' },
      { n: 5, q: 'Why might people from different cultures see different things during an NDE?' },
      { n: 6, q: 'Would you want to read a book written by someone who had an NDE? Why or why not?' },
    ]
  },
  {
    ...
    vocab: [
      { word: 'Oxygen', definition: 'A gas in the air that all living things need to breathe and survive.' },
      { word: 'Vivid', definition: 'Very clear, bright, and detailed — easy to remember and imagine.' },
      { word: 'Stimulating', definition: 'Causing activity or a reaction in a part of the body or brain.' },
      { word: 'Theory', definition: 'A carefully thought-out idea that tries to explain why something happens.' },
    ],
    questions: [
      { n: 7, q: 'Which scientific explanation for NDEs do you find most convincing? Why?' },
      { n: 8, q: 'Do you think science will ever fully explain near-death experiences?' },
      { n: 9, q: 'Is it possible that both science and spiritual beliefs are partly correct about what NDEs are?' },
    ]
  },
  {
    number: 4, title: 'How NDEs Change People\'s Lives', emoji: '🦋', color: '#4c1d95',
    ...
    vocab: [
      { word: 'Significantly', definition: 'In a way that is large or important enough to be clearly noticed.' },
      { word: 'Consciousness', definition: 'The state of being awake and aware of your own thoughts and feelings.' },
      { word: 'Purpose', definition: 'The reason why you do something, or why something exists.' },
      { word: 'Material', definition: 'Relating to physical objects and money, rather than feelings or spiritual things.' },
    ],
    questions: [
      { n: 10, q: 'If you had an NDE, how do you think it would change your life?' },
      { n: 11, q: 'Why do you think NDEs make so many people less afraid of death?' },
      { n: 12, q: 'What do you think consciousness is? Is it just the brain, or could it be something more?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise English discussion skills. The reading topic is "Near-Death Experiences". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use clear, simple language suitable for B1 level. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Tunnels of light, meetings with the dead, and out-of-body journeys — what really happens when we come close to death?</p>
            </div>
          </div>
