...
const PARTS = [
  {
    number: 1, title: 'Meet the Shark', emoji: '🦈', color: '#0ea5e9',
    text: `Sharks are some of the most amazing animals on Earth. They have lived in our oceans for more than 450 million years — that is longer than trees have existed on land! Scientists have discovered more than 500 different species of shark. Some are tiny, like the dwarf lanternshark, which is small enough to fit in your hand. Others are enormous, like the whale shark, which can grow up to 12 metres long — about the same length as two school buses.\n\nSharks live in every ocean in the world. Some prefer warm, shallow water near beaches. Others live in the deep, cold parts of the ocean where it is completely dark. Some sharks, like the bull shark, can even swim into rivers and live in fresh water for a time.\n\nSharks are fish, but they are very different from most other fish. Most fish have skeletons made of bone. Sharks have skeletons made of cartilage — the same flexible material that makes your ears and the tip of your nose bendy. This makes sharks lighter and helps them swim more efficiently.\n\nOne of the most impressive things about sharks is their teeth. Sharks do not just have one row of teeth — they have several rows, one behind the other. When a tooth at the front falls out, a new one from the next row moves forward to replace it. During their lifetime, a shark may grow and lose more than 30,000 teeth. If only human teeth worked the same way!`,
    vocab: [
      { word: 'Species', definition: 'A group of animals or plants that are very similar and can have babies together.' },
      { word: 'Cartilage', definition: 'A strong but bendy material in the body — you have it in your ears and nose.' },
      { word: 'Efficiently', definition: 'Doing something well without wasting energy or effort.' },
      { word: 'Impressive', definition: 'Something that makes you feel surprised and admiring because it is so good.' },
    ],
    questions: [
      { n: 1, q: 'Sharks have lived on Earth for 450 million years. What do you think made them so successful at surviving for so long?' },
      { n: 2, q: 'Which fact about sharks surprised you the most in this part? Why?' },
      { n: 3, q: 'If you could choose to study any species of shark, which would you choose — the tiny dwarf lanternshark or the enormous whale shark? Why?' },
    ]
  },
  {
    number: 2, title: 'Sharks and Humans — The Truth About Attacks', emoji: '🏖️', color: '#0284c7',
    text: `Many people are very afraid of sharks. Films like "Jaws" — made in 1975 — showed a great white shark attacking and killing people, and it made millions of people scared to swim in the sea. But is this fear based on the truth?\n\nThe reality is that shark attacks on humans are extremely rare. According to researchers, about 70 to 80 unprovoked shark attacks happen worldwide every year. On average, fewer than 10 of these are fatal. To put this in perspective, falling coconuts kill more people every year than sharks do. You are also more likely to be struck by lightning than to be killed by a shark.\n\nMost shark attacks are cases of mistaken identity. A shark in the water cannot see very well from below. A person lying on a surfboard with their arms paddling looks very similar to a sea turtle or a seal — which are animals that sharks do eat. When a shark bites a person, it usually lets go quickly when it realises its mistake. This is why most shark attack survivors have one bite wound rather than many.\n\nGreat white sharks, tiger sharks, and bull sharks are responsible for most attacks. But even these sharks do not actively hunt humans. Humans are not part of a shark's natural diet. We do not have enough fat on our bodies to be a good meal for a shark — sharks much prefer seals and fish.\n\nInterestingly, humans are far more dangerous to sharks than sharks are to humans. People kill an estimated 100 million sharks every year, mainly for their fins, which are used in shark fin soup.`,
    vocab: [
      { word: 'Unprovoked', definition: 'Something that happens without being caused or started by the other person or animal.' },
      { word: 'Fatal', definition: 'Causing death.' },
      { word: 'Perspective', definition: 'A way of thinking about something that helps you understand how important it really is.' },
      { word: 'Estimated', definition: 'A number that is approximately correct, not exact.' },
    ],
    questions: [
      { n: 4, q: 'Were you surprised to learn how few people are killed by sharks each year? Has this changed how you feel about them?' },
      { n: 5, q: 'Do you think it is fair that films like "Jaws" made people so afraid of sharks? What effect does this have on sharks?' },
      { n: 6, q: 'Humans kill 100 million sharks every year. Do you think this is a serious problem? What could be done about it?' },
    ]
  },
  {
    number: 3, title: 'Amazing Shark Abilities', emoji: '⚡', color: '#0369a1',
    text: `Sharks have some extraordinary abilities that make them incredible hunters and survivors. Understanding these abilities helps us appreciate just how perfectly designed for ocean life they are.\n\nThe most famous ability is the shark's sense of smell. Sharks can detect blood in the water from up to one kilometre away. They can smell one drop of blood in an Olympic-sized swimming pool. This incredible sense of smell helps them find food over huge distances in the ocean.\n\nSharks also have a special sense that humans do not have at all. They can detect tiny electrical signals produced by the muscles and heart of other animals. These electrical sensors, called the ampullae of Lorenzini, are found in small holes around a shark's nose and mouth. This means a shark can find a fish hiding under the sand on the ocean floor, because the fish's heartbeat produces a tiny electrical signal that the shark can feel.\n\nAnother amazing ability is a shark's lateral line — a row of sensors running along each side of its body. This system detects tiny movements and vibrations in the water. It is a little like a sixth sense that tells the shark about everything moving around it.\n\nGreat white sharks can also maintain a body temperature slightly warmer than the water around them. This helps their muscles work faster and makes them more powerful hunters in cold water. Most fish are cold-blooded, meaning their body temperature matches the water — so this gives the great white shark a real advantage.\n\nSharks also heal incredibly quickly. Scientists have observed that some shark species can recover from serious injuries in just a few weeks.`,
    vocab: [
      { word: 'Extraordinary', definition: 'Very unusual and surprising; much better or more impressive than normal.' },
      { word: 'Detect', definition: 'To notice or discover something, especially something that is not easy to see or find.' },
      { word: 'Vibrations', definition: 'Small, fast movements backwards and forwards that travel through water, air, or solid objects.' },
      { word: 'Advantage', definition: 'Something that helps you do better than others or makes a situation easier for you.' },
    ],
    questions: [
      { n: 7, q: 'Which of the shark\'s special abilities do you think is the most impressive? Why?' },
      { n: 8, q: 'If you could have one of the shark\'s abilities — incredible smell, electrical sensing, or the lateral line — which would you choose and why?' },
      { n: 9, q: 'Knowing that sharks have so many incredible adaptations, why do you think some people still think they are not intelligent animals?' },
    ]
  },
  {
    number: 4, title: 'Why We Must Protect Sharks', emoji: '🌊', color: '#075985',
    text: `Sharks have been swimming in our oceans for hundreds of millions of years, but today many species of shark are in serious danger. Scientists believe that around one third of all shark species are now threatened with extinction. This means they could disappear from our planet forever — and that would be a disaster for the entire ocean.\n\nSharks are what scientists call apex predators. This means they are at the very top of the ocean food chain. They eat sick, weak, and old fish and sea animals, which keeps populations healthy. Without sharks, some fish species would grow too numerous and eat too many smaller creatures, which would then upset the entire ecosystem. Healthy oceans need sharks in the same way that healthy forests need wolves and lions.\n\nThe biggest threat to sharks is overfishing. Millions of sharks are caught every year, often just for their fins. Shark fin soup is considered a luxury dish in some countries, particularly in parts of Asia. The fins are cut off the shark while it is still alive, and then the shark is thrown back into the water to die. This practice — called shark finning — is now illegal in many countries, but it still continues in parts of the world.\n\nSharks are also caught accidentally in fishing nets set for other fish. This is called bycatch. Climate change is another growing threat, as warming oceans affect the fish that sharks depend on for food.\n\nThe good news is that many people around the world are working to protect sharks. Some countries have made it illegal to fish for sharks in their waters. Scientists are tagging sharks with electronic trackers to learn more about where they travel and what they need to survive. And slowly, public attitudes are changing — as people learn the truth about sharks, more and more people want to protect them.`,
    vocab: [
      { word: 'Extinction', definition: 'When every single animal or plant of a species dies and it no longer exists anywhere on Earth.' },
      { word: 'Apex predator', definition: 'An animal at the top of the food chain that is not hunted by any other animal.' },
      { word: 'Ecosystem', definition: 'All the plants, animals, and living things in one area and how they depend on each other.' },
      { word: 'Bycatch', definition: 'Fish or other sea animals that are caught accidentally when fishing for a different species.' },
    ],
    questions: [
      { n: 10, q: 'Why do you think sharks are so important for keeping oceans healthy? What would happen if they all disappeared?' },
      { n: 11, q: 'Shark fin soup is a traditional dish in some cultures. Do you think tradition is a good enough reason to continue a practice that harms animals? Why?' },
      { n: 12, q: 'What is one thing you could personally do to help protect sharks and ocean life?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly and encouraging English conversation partner helping a B1 level student aged 10-12 practise English discussion skills. The reading topic is "Sharks — Misunderstood Predators". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear language appropriate for a young learner. Be enthusiastic and positive about the topic. Always end with one fun follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end.`
  ...
  return (
    <div style={{ marginTop: '10px', background: '#f0f9ff', borderRadius: '14px', border: `2px solid ${color}30`, overflow: 'hidden' }}>
      ...
      {messages.length === 0 && <div style={{ padding: '14px 16px', color: '#6b7280', fontSize: '13px', lineHeight: '1.6', borderBottom: '1px solid #e0f2fe' }}>💡 Type your answer or tap <strong>🎤 Start Recording</strong> — speak your full answer, then tap <strong>⏹ Stop & Send</strong>.</div>}
      {messages.length > 0 && (
          ...
          {messages.map((m, i) => (
            <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', flexDirection: m.role === 'user' ? 'row-reverse' : 'row' }}>
              ...
              <div style={{ maxWidth: '80%', display: 'flex', flexDirection: 'column', gap: '4px', alignItems: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
                ...
                {m.translation && <div style={{ background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: '10px', padding: '8px 12px', fontSize: '13px', color: '#374151', lineHeight: '1.5' }}><span style={{ color: color, fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>🌍 Translation</span>{m.translation}</div>}
              </div>
            </div>
          ))}
...
export default function SharksPage() {
  ...
  const handleLookup = async (text: string) => {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ system: isPhrase ? `You are an English dictionary for B1 young learners aged 10-12. Respond with ONLY one simple sentence (max 20 words) explaining what the phrase means. No extra text.` : `You are an English dictionary for B1 young learners aged 10-12. Respond with ONLY one simple sentence (max 15 words) defining this word. No extra text.`, messages: [{ role: 'user', content: isPhrase ? `What does "${text}" mean?` : `Define: "${text}"` }] }) })
        const data = await res.json(); setLookupDef(data.content || 'No definition found.')
      } else {
        const res = await fetch('/api/chat', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ system: `You are a language learning assistant for young B1 English students. Respond ONLY with valid JSON (no markdown, no backticks): {"definition": "one simple English sentence max 15 words", "translation": "the word/phrase in ${translationLang} with a brief explanation in ${translationLang}, max 25 words"}`, messages: [{ role: 'user', content: `Word or phrase: "${text}"` }] }) })
        const data = await res.json()
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0c2340 0%, #0c4a6e 50%, #075985 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(14,165,233,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Nature & Animals</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Sharks — Misunderstood Predators</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>The truth about the ocean's most feared fish — their incredible abilities, the real facts about attacks, and why we must protect them.</p>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)} style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#0ea5e9' : '#e5e7eb', background: speed === s.value ? '#0ea5e9' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>{s.label}</button>
              ))}
            </div>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#f0f9ff', padding: '8px 28px', borderBottom: '1px solid #bae6fd' }}>
              <span style={{ color: '#0369a1', fontSize: '12px', fontWeight: '600' }}>✍️ Highlight any word or phrase to hear it and see its meaning{translationLang !== 'none' && <span style={{ color: '#0ea5e9' }}> + {currentLang?.label} translation</span>}</span>
            </div>
                  ...
                  return (
                    <div key={v.word} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', paddingBottom: i < part.vocab.length - 1 ? '10px' : '0', borderBottom: i < part.vocab.length - 1 ? `1px solid ${part.color}15` : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {vocabTranslations[vKey] && <div style={{ marginTop: '6px', background: '#f0f9ff', border: '1px solid #bae6fd', borderRadius: '8px', padding: '8px 12px' }}><span style={{ color: '#0369a1', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: '#374151', fontSize: '14px', lineHeight: '1.5' }}>{vocabTranslations[vKey]}</span></div>}
                      </div>
                    </div>
                  )
                })}
                  ...
                  <div key={q.n}>
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && <div style={{ marginTop: '8px', background: 'rgba(14,165,233,0.15)', border: '1px solid rgba(14,165,233,0.3)', borderRadius: '10px', padding: '10px 14px' }}><span style={{ color: '#7dd3fc', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span><span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '14px', lineHeight: '1.6' }}>{questionTranslations[q.n]}</span></div>}
                      </div>
                    </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: selectedText ? '140px' : '16px' }}>
          <Link href="/esl-resources/reading-comprehension/b1" style={{ color: '#0ea5e9', textDecoration: 'none', fontWeight: 'bold', fontSize: '14px' }}>← Back to B1 Reading Comprehension</Link>
        </div>
      </div>
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #bae6fd', borderBottom: 'none' }}>
            ...
            {lookupLoading ? (
              <div style={{ background: '#f0f9ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #bae6fd', color: '#9ca3af', fontSize: '15px' }}>{translationLang !== 'none' ? `Looking up definition and ${currentLang?.label} translation...` : 'Looking up...'}</div>
            ) : (
