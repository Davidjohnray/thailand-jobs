...
const PARTS = [
  {
    number: 1, title: 'Calling Mars', emoji: '📡', color: '#dc2626',
    text: `NASA announced this week that it has selected Blue Origin — the space company founded by Amazon billionaire Jeff Bezos — to build the Mars Telecommunications Network. The 700-million-dollar project will create a system of spacecraft that relay communications between Earth and Mars, allowing rovers, landers, and eventually human explorers to stay connected with mission control.\n\nRight now, communicating with Mars is slow and unreliable. Radio signals between Earth and Mars travel at the speed of light, but the distance is so great that messages take between 4 and 24 minutes each way, depending on where the planets are in their orbits. A simple question-and-answer exchange can take nearly an hour.\n\nThe current system relies on a handful of ageing spacecraft orbiting Mars that relay signals between surface rovers and Earth. These spacecraft were designed for previous missions and are well past their intended lifetimes. If they fail — which becomes more likely every year — NASA could lose contact with Perseverance, Curiosity, and other assets on the Martian surface.\n\nThe new network will solve these problems by placing a constellation of dedicated communication satellites around Mars. Think of it as building a mobile phone network — but on another planet. The spacecraft are scheduled for launch in late 2028 and should be operational by 2030.`,
    vocab: [
      { word: 'Telecommunications', definition: 'Communication over long distances using technology — phone calls, internet, radio signals.' },
      { word: 'Relay', definition: 'To pass information from one point to another — acting as a middle station.' },
      { word: 'Constellation', definition: 'A group of satellites working together as a system — like a network in space.' },
      { word: 'Operational', definition: 'Working and ready for use — fully functioning.' },
    ],
    questions: [
      { n: 1, q: 'Messages to Mars take up to 24 minutes each way. How would you solve a problem on Mars if you had to wait an hour for each answer?' },
      { n: 2, q: 'NASA is building a phone network on another planet. Does this excite you or seem like a waste of money?' },
      { n: 3, q: 'The old Mars satellites are past their lifetime. What happens if we lose contact with our rovers on Mars?' },
    ]
  },
  {
    number: 2, title: 'The New Space Race', emoji: '🏁', color: '#b91c1c',
    text: `The choice of Blue Origin over its competitor Rocket Lab highlights a new reality in space exploration: the space race is no longer between countries — it is between billionaires.\n\nJeff Bezos founded Blue Origin in 2000 with a vision of millions of people living and working in space. Elon Musk founded SpaceX in 2002 with the goal of making humanity a multi-planetary species. Both men have invested billions of their personal fortunes into their space companies. Both compete fiercely for NASA contracts. And both believe that the future of humanity depends on expanding beyond Earth.\n\nThe competition has produced remarkable results. SpaceX has dramatically reduced the cost of launching rockets by developing reusable boosters. Blue Origin is developing its own reusable rocket system and has won contracts for lunar landers. Together, they have pushed the boundaries of what private companies can achieve in space.\n\nBut the billionaire space race also raises uncomfortable questions. Should the exploration of space — which affects all of humanity — be controlled by a handful of extremely wealthy individuals? What happens when commercial interests conflict with scientific priorities? And is it appropriate for taxpayer-funded NASA contracts to enrich men who are already among the richest people in history?\n\nThe 700-million-dollar Mars contract is a drop in the bucket for Bezos, whose net worth exceeds 200 billion dollars. But for NASA, it represents a significant investment — and a bet that private companies can deliver on promises that government agencies have struggled to keep.`,
    vocab: [
      { word: 'Reusable', definition: 'Designed to be used more than once — rockets that land and fly again.' },
      { word: 'Lunar', definition: 'Relating to the Moon.' },
      { word: 'Commercial interests', definition: 'Business goals focused on making profit — the financial motivations of companies.' },
      { word: 'Taxpayer-funded', definition: 'Paid for with money collected from citizens through taxes.' },
    ],
    questions: [
      { n: 4, q: 'The space race is now between billionaires, not countries. Is this progress or a problem?' },
      { n: 5, q: 'Should space exploration be controlled by private companies or governments? What are the arguments for each?' },
      { n: 6, q: '700 million dollars for Mars communications. Is this a good use of money when there are problems on Earth?' },
    ]
  },
  {
    number: 3, title: 'Why Mars Matters', emoji: '🔴', color: '#991b1b',
    text: `Building a communications network for Mars might seem like an expensive luxury. But the technology developed for Mars has a history of transforming life on Earth.\n\nNASA missions have produced technologies that we use every day without realising where they came from. Water purification systems used in developing countries were originally designed for space stations. Memory foam was invented for spacecraft seats. Scratch-resistant lenses were developed for helmet visors. The camera in your smartphone uses sensors originally designed for space telescopes.\n\nThe Mars communications network will require advances in areas that have direct Earth applications: long-range communication, autonomous systems, power management, and radiation-resistant electronics. Each of these technologies has uses far beyond Mars — from remote internet access in rural areas to more resilient communication systems for disaster response.\n\nMars also matters as a destination for human exploration. If humanity is to become a multi-planetary species — which many scientists argue is essential for long-term survival — Mars is the most realistic candidate. It has a thin atmosphere, water ice at its poles, a day length similar to Earth, and raw materials that could support a settlement. But none of this is possible without reliable communication.\n\nA human astronaut on Mars who cannot talk to Earth is not an explorer — they are lost. The telecommunications network that Blue Origin will build is not just infrastructure for robots. It is the foundation for the next great chapter of human exploration.`,
    vocab: [
      { word: 'Purification', definition: 'The process of removing dirt and harmful substances — making something clean and safe.' },
      { word: 'Autonomous', definition: 'Operating independently without human control.' },
      { word: 'Resilient', definition: 'Able to recover quickly from problems — strong and adaptable.' },
      { word: 'Foundation', definition: 'The base on which something is built — the essential starting point.' },
    ],
    questions: [
      { n: 7, q: 'Space technology gave us water purification and smartphone cameras. What might Mars technology give us?' },
      { n: 8, q: 'An astronaut on Mars who cannot communicate is lost. Why is communication the most important technology for exploration?' },
      { n: 9, q: 'Should humanity try to become multi-planetary? Is Mars realistic, or is it science fiction?' },
    ]
  },
  {
    number: 4, title: 'Looking Up from Earth', emoji: '✨', color: '#7f1d1d',
    text: `In a week dominated by war, conflict, and political crises, the story of a 700-million-dollar Mars mission might seem out of place. But perhaps it is exactly the kind of story we need.\n\nSpace exploration represents the best version of what humans can do — the curiosity, ingenuity, and cooperation that built civilisations, crossed oceans, and now reaches for other worlds. While politicians argue about borders and bombs, engineers and scientists quietly work on problems that will benefit all of humanity — regardless of nationality, religion, or politics.\n\nThe Mars communications network will be built by Americans, but the science it enables will belong to the world. The data from Perseverance and future Mars missions is shared freely with researchers from every country. The technologies developed will find applications in places their creators never imagined. And the knowledge gained — about Mars, about our solar system, about the universe — will expand our understanding in ways that benefit everyone.\n\nThere is something deeply hopeful about a species that is simultaneously fighting wars and building communications networks on other planets. We are capable of terrible destruction and remarkable creation — often at the same time. The question of which impulse defines us is not yet settled.\n\nSomewhere in late 2028, a spacecraft built by Blue Origin will leave Earth and head for Mars. It will carry no weapons, threaten no one, and serve no political agenda. It will simply extend the reach of human communication a little further into the universe. And that, in a week like this one, is worth celebrating.`,
    vocab: [
      { word: 'Ingenuity', definition: 'Cleverness and creativity — the ability to solve problems in new ways.' },
      { word: 'Impulse', definition: 'A strong urge or drive — a basic human tendency.' },
      { word: 'Agenda', definition: 'A hidden plan or purpose — the real reason behind an action.' },
      { word: 'Simultaneously', definition: 'At the same time — happening together.' },
    ],
    questions: [
      { n: 10, q: 'Humans fight wars and explore Mars at the same time. Which impulse do you think defines us more?' },
      { n: 11, q: 'Mars science is shared freely with all countries. Should more things in the world work this way?' },
      { n: 12, q: 'The passage says this story is worth celebrating in a difficult week. Do you agree? Why do we need hopeful stories?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "NASA Picks Blue Origin for Mars Mission". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function BlueOriginMarsPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>NASA Picks Blue Origin for Mars Mission</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>NASA chose Jeff Bezos company to build a 700-million-dollar communications network for Mars. How we talk to robots on other planets and the new space race.</p>
            </div>
          </div>
