...
const PARTS = [
  {
    number: 1, title: 'Operation Homecoming', emoji: '🏠', color: '#dc2626',
    text: `Law enforcement agencies across the United States announced this week that a coordinated operation had rescued nearly 80 missing children — some of whom had been missing for months or even years. The operation, which involved the FBI, state police, and local law enforcement in more than 20 states, is one of the largest child rescue efforts in recent American history.\n\nThe children ranged in age from infants to teenagers. Some had been kidnapped by non-custodial parents during custody disputes. Some had run away from home or from foster care and been exploited by adults. Some had been trafficked — moved across state lines and forced into labour or other forms of exploitation. Each case was different, but all shared one thing: a child who was missing and a family desperate to find them.\n\nThe operation used a combination of traditional detective work and modern technology. Facial recognition software matched photos of missing children with images found on social media. Phone tracking data helped locate children who had been moved across the country. And tips from the public — often from teachers, doctors, or neighbours who noticed something wrong — provided crucial leads.\n\nFor the families reunited with their children, the relief is overwhelming. Videos of parents seeing their children for the first time in months — crying, embracing, unable to speak — have been shared widely. But behind each joyful reunion is a story of fear, uncertainty, and trauma that will take years to heal.`,
    vocab: [
      { word: 'Coordinated', definition: 'Organised together — multiple groups working in partnership toward the same goal.' },
      { word: 'Custody disputes', definition: 'Legal arguments between parents about who should care for a child after separation.' },
      { word: 'Foster care', definition: 'A system where children live with temporary families when their own families cannot care for them.' },
      { word: 'Trafficked', definition: 'Illegally moved and exploited — transported against your will for someone else profit.' },
    ],
    questions: [
      { n: 1, q: '80 children rescued in one operation. What was your first reaction to this story?' },
      { n: 2, q: 'Some children had been missing for years. Can you imagine what the families went through during that time?' },
      { n: 3, q: 'Tips from teachers and neighbours helped find some children. How can ordinary people help protect children in their community?' },
    ]
  },
  {
    number: 2, title: 'How Children Go Missing', emoji: '❓', color: '#b91c1c',
    text: `In the United States, approximately 365,000 reports of missing children are filed every year. That number is staggering — roughly 1,000 children per day. But the reality behind the number is more complex than it first appears.\n\nThe vast majority of missing children — more than 90% — are runaways. These are typically teenagers who leave home because of family conflict, abuse, or difficult living situations. Most return or are found within a few days. But during the time they are missing, they are extremely vulnerable — to exploitation by adults, to human trafficking, and to violence.\n\nFamily abductions account for most of the remaining cases. These typically involve a parent who does not have legal custody taking a child — often during or after a divorce or separation. The child is usually not in physical danger, but the separation from the other parent causes enormous emotional harm.\n\nThe rarest but most frightening category is stranger abductions — children taken by people they do not know. These cases, while making up less than 1% of all missing children reports, receive the most media attention because they represent every parent worst nightmare.\n\nWhat all these situations share is vulnerability. Children are missing because something in their support system failed — a family broke apart, a home became unsafe, a community did not notice, or a predator found an opportunity. Protecting children means strengthening all of these systems.`,
    vocab: [
      { word: 'Runaways', definition: 'Children or teenagers who leave home without permission — often escaping a difficult situation.' },
      { word: 'Vulnerable', definition: 'At risk of being harmed — in a weak position where exploitation is likely.' },
      { word: 'Abduction', definition: 'Taking someone away by force or deception — kidnapping.' },
      { word: 'Predator', definition: 'A person who exploits others, especially children — someone who targets vulnerable people.' },
    ],
    questions: [
      { n: 4, q: '365,000 children reported missing per year in the US. Does this number shock you? How does it compare to your country?' },
      { n: 5, q: 'Most missing children are runaways escaping difficult homes. What does this tell us about what children need?' },
      { n: 6, q: 'Stranger abductions are the rarest but get the most attention. Why does media focus on the least common type?' },
    ]
  },
  {
    number: 3, title: 'Finding Them', emoji: '🔍', color: '#991b1b',
    text: `Finding missing children requires a combination of technology, detective work, and community awareness that has improved dramatically over the past 25 years.\n\nThe AMBER Alert system — named after Amber Hagerman, a nine-year-old girl who was abducted and murdered in Texas in 1996 — sends emergency notifications to millions of phones, televisions, and highway signs when a child is believed to be in danger. Since its creation, the system has helped recover more than 1,100 children.\n\nSocial media has transformed the search for missing children. A photo posted on Facebook or TikTok can reach millions of people within hours. The National Center for Missing & Exploited Children uses age-progression technology — software that predicts what a child might look like years after they went missing — to create updated images that help people recognise children who have grown older.\n\nInternational cooperation has improved too. INTERPOL maintains a database of missing children that is accessible to police in 194 countries. Cross-border coordination — essential when children are trafficked across national boundaries — has become faster and more effective.\n\nBut technology alone is not enough. The most important tool in finding missing children is people — neighbours who notice something unusual, teachers who recognise signs of abuse, doctors who ask the right questions, and ordinary citizens who pay attention. Technology can amplify these human observations, but it cannot replace them.`,
    vocab: [
      { word: 'AMBER Alert', definition: 'An emergency notification system that broadcasts information about missing children to the public.' },
      { word: 'Age-progression', definition: 'Technology that predicts how a person appearance will change as they grow older.' },
      { word: 'INTERPOL', definition: 'The International Criminal Police Organization — helping police from different countries work together.' },
      { word: 'Amplify', definition: 'To make stronger or louder — increasing the reach and impact of something.' },
    ],
    questions: [
      { n: 7, q: 'AMBER Alerts have helped rescue 1,100 children. Should more countries adopt this system?' },
      { n: 8, q: 'Age-progression software shows what missing children might look like years later. How does this technology help?' },
      { n: 9, q: 'The most important tool is people paying attention. How can you help protect children in your community?' },
    ]
  },
  {
    number: 4, title: 'Every Child Matters', emoji: '💚', color: '#7f1d1d',
    text: `Behind every statistic about missing children is a name, a face, and a family waiting for news.\n\nThe children rescued this week will need more than a ride home. Many have experienced trauma — fear, exploitation, separation from everything familiar. They will need counselling, medical care, educational support, and patience. The physical rescue is the beginning, not the end.\n\nSome of the rescued children were found in situations so disturbing that law enforcement officials declined to describe them publicly. This is a reminder that child exploitation — in all its forms — remains one of the most serious and under-reported crimes in the world. It happens in every country, in every community, and across all social classes. It is not a problem that belongs to somewhere else.\n\nThe story also highlights the people who dedicate their careers to finding and protecting children — detectives, social workers, counsellors, and advocates who deal daily with cases that would break most people. Their work is essential, often underfunded, and rarely recognised.\n\nNearly 80 children are home this week because people cared enough to look for them. But thousands more remain missing — in the United States and around the world. Each one is someone child, someone sibling, someone friend. Each one matters. And each one deserves someone who refuses to stop looking.`,
    vocab: [
      { word: 'Counselling', definition: 'Professional support to help someone deal with emotional or psychological problems.' },
      { word: 'Exploitation', definition: 'Taking unfair advantage of someone — using them for your own benefit.' },
      { word: 'Advocates', definition: 'People who speak up and fight for the rights of others — supporters and defenders.' },
      { word: 'Under-reported', definition: 'Not reported as often as it actually happens — hidden from public awareness.' },
    ],
    questions: [
      { n: 10, q: 'Rescued children need counselling, medical care, and patience. Why is the rescue just the beginning of recovery?' },
      { n: 11, q: 'Child exploitation happens in every country and every social class. Why is it so widespread and so hidden?' },
      { n: 12, q: 'Thousands of children remain missing worldwide. What can the international community do to protect all children?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Nearly 80 Missing Children Rescued in Massive Operation". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function ChildrenRescuePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Nearly 80 Missing Children Rescued in Massive Operation</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>A huge law enforcement operation across the United States rescued nearly 80 missing children in a single week. How children go missing, who finds them, and why every child matters.</p>
            </div>
          </div>
