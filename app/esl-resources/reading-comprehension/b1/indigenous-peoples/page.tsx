...
const PARTS = [
  {
    number: 1, title: 'Who Are Indigenous Peoples?', emoji: '🌍', color: '#f97316',
    text: `There are around 476 million indigenous people living in the world today. They belong to more than 5,000 different groups and live in almost every country on Earth. Indigenous peoples are the original inhabitants of a land — the people who lived there before others came and took control. Some well-known examples are the Aboriginal Australians, the Maori people of New Zealand, the Native Americans of the United States and Canada, and the Karen hill tribes of Thailand and Myanmar.\n\nIndigenous communities are incredibly diverse. They speak thousands of different languages, follow different traditions, eat different foods, and live in very different environments — from the Amazon rainforest to the Arctic tundra to the mountains of Southeast Asia. Despite this diversity, many indigenous groups share something important: a very deep connection to the land where their ancestors lived.\n\nFor many centuries, the world did not treat indigenous peoples fairly. Governments and powerful nations took their land, banned their languages, and tried to change their way of life. Today, many people around the world are starting to understand and appreciate indigenous cultures more — but the road to real equality is still long. Understanding who indigenous peoples are is the first step towards treating them with the respect they deserve.`,
    vocab: [
      { word: 'Indigenous', definition: 'Originally from a particular place — the first people to live in a land or region.' },
      { word: 'Inhabitants', definition: 'The people who live in a particular place — the residents of an area.' },
      { word: 'Diverse', definition: 'Very different from each other — showing a wide variety of types or kinds.' },
      { word: 'Ancestors', definition: 'Family members from the past — people in your family who lived long before you.' },
    ],
    questions: [
      { n: 1, q: 'Are there any indigenous groups in your country? What do you know about them?' },
      { n: 2, q: 'Why do you think indigenous peoples often have a strong connection to the land they come from?' },
      { n: 3, q: 'How do you think it would feel to have your language or culture banned by a government?' },
    ]
  },
  {
    number: 2, title: 'Language, Land and Tradition', emoji: '🌿', color: '#22c55e',
    text: `One of the most important parts of indigenous identity is language. Today, around 4,000 of the world's 7,000 languages are indigenous languages. Sadly, many of these languages are disappearing. When a language disappears, it takes with it stories, songs, knowledge and ways of seeing the world that cannot be replaced. In many indigenous cultures, knowledge is passed down orally — through speaking and storytelling — rather than through written books. When the last speaker of a language dies, that entire way of understanding the world is lost forever.\n\nLand is also central to indigenous life. For most indigenous communities, land is not simply a place to live or a thing to own. It is deeply connected to their identity, their history, their spiritual beliefs, and their relationship with nature. Many indigenous groups have been living on and caring for the same land for thousands of years. They often have detailed knowledge about the local plants, animals, seasons and weather — knowledge that scientists are only now beginning to recognise as valuable.\n\nTraditional festivals, art, music and ceremonies are also an important part of indigenous culture. These traditions help communities stay connected to their history and to each other. In many parts of the world, young indigenous people are working hard to keep these traditions alive — even while living in modern cities far from their ancestral lands.`,
    vocab: [
      { word: 'Identity', definition: 'Who you are — the qualities, beliefs and culture that make a person or group unique.' },
      { word: 'Orally', definition: 'By speaking rather than writing — passing on information through speech and storytelling.' },
      { word: 'Spiritual', definition: 'Connected to religion, the soul, or a deep inner feeling — not physical or material.' },
      { word: 'Ancestral', definition: 'Belonging to or coming from your ancestors — connected to the people in your family from long ago.' },
    ],
    questions: [
      { n: 4, q: 'Why is it important to protect languages that are disappearing? What do we lose when a language dies?' },
      { n: 5, q: 'How is the relationship between indigenous peoples and land different from how most modern people think about land?' },
      { n: 6, q: 'What traditions from your own culture do you think are important to keep alive? Why?' },
    ]
  },
  {
    number: 3, title: 'Challenges Facing Indigenous Communities', emoji: '⚠️', color: '#ef4444',
    text: `Despite growing awareness, indigenous peoples around the world still face serious challenges. One of the biggest is the loss of land. In many countries, indigenous communities have been forced off their traditional lands because of mining, farming, logging, or the building of cities and roads. Without their land, many communities struggle to maintain their culture, their food sources, and their way of life.\n\nDiscrimination is another major problem. In many countries, indigenous people have lower levels of education and healthcare than the rest of the population. They are often poorer, and they may face prejudice and unfair treatment from governments and other citizens. Indigenous children have sometimes been taken from their families and sent to schools where they were forbidden to speak their own language or practise their culture. This happened in Australia, Canada and many other countries during the 19th and 20th centuries — and the effects are still felt today.\n\nClimate change is also a serious threat. Many indigenous communities depend on healthy forests, rivers, oceans and wildlife to survive. As the environment changes, their food sources and livelihoods are at risk. However, indigenous peoples are also among the most active environmental defenders in the world. Many are fighting to protect their land — not just for themselves, but for everyone. Studies show that the world's biodiversity is often highest in areas managed by indigenous communities.`,
    vocab: [
      { word: 'Discrimination', definition: 'Treating someone unfairly because of who they are — for example, their race or culture.' },
      { word: 'Prejudice', definition: 'An unfair negative opinion about a person or group, often based on no good reason.' },
      { word: 'Livelihoods', definition: 'The ways people earn money or get food to support themselves and their families.' },
      { word: 'Biodiversity', definition: 'The variety of plants, animals and living things in a particular place or on Earth.' },
    ],
    questions: [
      { n: 7, q: 'Do you think governments should return land to indigenous communities? Why or why not?' },
      { n: 8, q: 'How do you think historical discrimination still affects indigenous peoples today?' },
      { n: 9, q: 'Why might indigenous communities be especially good at protecting the natural environment?' },
    ]
  },
  {
    number: 4, title: 'Recognition, Rights and the Future', emoji: '🕊️', color: '#8b5cf6',
    text: `In 2007, the United Nations passed the Declaration on the Rights of Indigenous Peoples. This important document says that indigenous peoples have the right to keep their culture, their language, and their land. It says that governments must consult with indigenous communities before making decisions that affect them. More than 140 countries voted in favour of this declaration — though putting it into practice has been difficult in many places.\n\nAround the world, there are positive signs of change. In New Zealand, the Maori language is now an official language, and Maori culture is celebrated in schools and public life. In Canada, there have been official government apologies for past treatment of indigenous peoples, and indigenous communities now have more control over their own lands and education. In many countries, indigenous art, music and food are gaining international recognition and appreciation.\n\nAt the same time, there is still much work to do. Indigenous voices need to be heard in government, in the media, and in classrooms. Young people — both indigenous and non-indigenous — have an important role to play. Learning about indigenous cultures with respect and an open mind is a good first step. Understanding that these cultures are not just part of history, but are living, changing and vibrant communities today, helps build a more equal and respectful world for everyone.`,
    vocab: [
      { word: 'Declaration', definition: 'An official statement or announcement — especially one made by a government or organisation.' },
      { word: 'Consult', definition: 'To ask someone for their opinion or advice before making a decision that affects them.' },
      { word: 'Apology', definition: 'A statement that you are sorry for something wrong that was done — an expression of regret.' },
      { word: 'Vibrant', definition: 'Full of life, energy and activity — lively and exciting.' },
    ],
    questions: [
      { n: 10, q: 'What do you think is the most important right that indigenous peoples should have? Why?' },
      { n: 11, q: 'How can ordinary people — not just governments — help to support indigenous communities?' },
      { n: 12, q: 'After reading this passage, has your view of indigenous peoples and their lives changed in any way?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang }: { question: string; color: string; translationLang: string }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise discussion skills. The reading topic is "Indigenous Peoples Around the World". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use simple, clear English suitable for B1 level. Always end with one natural follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." — only the most important error. Be warm and encouraging.`
...
export default function IndigenousPeoplesPage() {
    ...
    try {
      if (translationLang === 'none') {
        const res = await fetch('/api/chat', {
          ...
          body: JSON.stringify({
            system: isPhrase
              ...
              : `You are an English dictionary for B1 learners. Respond with ONLY one simple sentence (max 18 words) defining this word. No extra text.`,
        ...
        const res = await fetch('/api/chat', {
          method: 'POST', headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            system: `You are a language learning assistant for B1 English students. Respond ONLY with valid JSON (no markdown, no backticks): {"definition": "one simple English sentence max 18 words", "translation": "the word/phrase in ${translationLang} with a brief explanation in ${translationLang}, max 25 words"}`,
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(135deg, #431407 0%, #c2410c 50%, #f97316 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                <span style={{ background: '#f97316', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>B1 Intermediate</span>
                <span style={{ background: 'rgba(255,255,255,0.2)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Society & Culture</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Indigenous Peoples of the World</h1>
              <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Culture, Land and Identity — learn about the world's first peoples, how they live, the challenges they face, and why their cultures matter to all of us.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)}
                  style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#f97316' : '#e5e7eb', background: speed === s.value ? '#f97316' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>
                  {s.label}
                </button>
              ))}
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#f97316' : '#e5e7eb', background: translationLang !== 'none' ? '#fff7ed' : 'white', color: translationLang !== 'none' ? '#c2410c' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: `${part.color}10`, padding: '8px 28px', borderBottom: `1px solid ${part.color}20` }}>
              <span style={{ color: part.color, fontSize: '12px', fontWeight: '600' }}>
                ✍️ Highlight any word or phrase to hear it and see its meaning
                {translationLang !== 'none' && <span> + {currentLang?.label} translation</span>}
              </span>
            </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && (
                          <div style={{ marginTop: '8px', background: `${part.color}20`, border: `1px solid ${part.color}40`, borderRadius: '10px', padding: '10px 14px' }}>
      ...
      {selectedText && (
        <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 200, animation: 'slideUp 0.25s ease' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #fed7aa', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#fff7ed', color: '#c2410c', border: '2px solid #fed7aa', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#fff7ed', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fed7aa', color: '#9ca3af', fontSize: '15px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ background: '#fff7ed', borderRadius: '12px', padding: '14px 18px', border: '1px solid #fed7aa' }}>
                  <div style={{ color: '#c2410c', fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '6px' }}>📖 English Definition</div>
