...
const PARTS = [
  {
    number: 1, title: 'One Million People Flee', emoji: '🌀', color: '#dc2626',
    text: `On 11 August 2026, Typhoon Dolphin made landfall on the coast of southeastern China, bringing winds of more than 180 kilometres per hour and torrential rain that flooded entire cities. More than one million people were evacuated before the storm arrived — moved from their homes to emergency shelters in schools, stadiums, and government buildings.\n\nChina is no stranger to typhoons. The country is hit by an average of seven to eight major tropical storms every year, mostly between July and October. But Typhoon Dolphin was unusually powerful — one of the strongest storms to hit the region in the last decade. Forecasters warned days in advance, giving the government time to organise what was one of the largest peacetime evacuations in recent Chinese history.\n\nThe images from the affected areas were dramatic: streets turned into rivers, cars floating in floodwater, trees bent sideways by the wind, and waves crashing over seawalls. In several coastal cities, the storm surge — a wall of seawater pushed inland by the wind — flooded ground floors of buildings and destroyed boats in harbours.\n\nDespite the massive evacuation, at least 12 people were killed, mostly in rural areas where warnings arrived too late or where people refused to leave their homes and belongings. Rescue teams using boats and helicopters continued to search for stranded residents days after the storm passed.`,
    vocab: [
      { word: 'Typhoon', definition: 'A powerful tropical storm with very strong winds and heavy rain, common in Asia and the Pacific.' },
      { word: 'Landfall', definition: 'The moment a storm reaches land after travelling across the ocean.' },
      { word: 'Evacuated', definition: 'Moved from a dangerous place to somewhere safe before disaster strikes.' },
      { word: 'Storm surge', definition: 'A rise in sea level caused by a storm pushing water towards the coast — can flood coastal areas.' },
    ],
    questions: [
      { n: 1, q: 'One million people were evacuated before the typhoon hit. How do you organise moving that many people? What challenges would you face?' },
      { n: 2, q: 'Some people refused to leave their homes despite warnings. Why do you think people stay during a dangerous storm?' },
      { n: 3, q: 'Thailand also experiences severe flooding. How does your area prepare for storms and floods?' },
    ]
  },
  {
    number: 2, title: 'Are Storms Getting Worse?', emoji: '📊', color: '#b91c1c',
    text: `Scientists have been tracking a worrying trend: tropical storms around the world are becoming more intense. While the total number of typhoons and hurricanes each year has not changed significantly, the proportion that reach the highest categories — with the most destructive winds and heaviest rainfall — has increased.\n\nThe reason is straightforward. Tropical storms get their energy from warm ocean water. As climate change heats the oceans, there is more energy available to fuel storms. Warmer water means stronger winds, heavier rain, and higher storm surges. A typhoon that might have been a Category 3 in the 1990s could now become a Category 4 or 5 because the ocean is warmer.\n\nRainfall is also increasing. A warmer atmosphere holds more moisture — about 7% more for every degree Celsius of warming. This means that when a storm arrives, it dumps more rain than a similar storm would have produced decades ago. Typhoon Dolphin dropped more than 400 millimetres of rain in some areas in 24 hours — contributing to the severe flooding.\n\nSea level rise makes storm surges more damaging. As global sea levels rise — currently by about 3.6 millimetres per year — the baseline from which storm surges start is higher. A storm surge that would have caused minor flooding 50 years ago now pushes water further inland, affecting more homes and more people.\n\nFor countries like China, the Philippines, Japan, and Thailand — all of which are regularly hit by tropical storms — these trends mean that the storms of the future will be more dangerous than the storms of the past.`,
    vocab: [
      { word: 'Intense', definition: 'Very strong and powerful — greater in force, energy, or concentration.' },
      { word: 'Category', definition: 'A classification level for storms — higher categories mean stronger, more dangerous storms.' },
      { word: 'Baseline', definition: 'The starting point or normal level from which changes are measured.' },
      { word: 'Trends', definition: 'Patterns of change over time — the direction things are moving.' },
    ],
    questions: [
      { n: 4, q: 'Storms are not more frequent but they are stronger. Why is this distinction important?' },
      { n: 5, q: 'Warmer oceans fuel stronger storms. How does this connect to the bigger picture of climate change?' },
      { n: 6, q: 'Sea level rise makes storm surges worse. Which cities and countries are most at risk from this combination?' },
    ]
  },
  {
    number: 3, title: 'China Fights Back', emoji: '🏗️', color: '#991b1b',
    text: `China has invested heavily in disaster preparedness — and the response to Typhoon Dolphin showed both the strengths and weaknesses of its approach.\n\nThe strengths are impressive. China's early warning system for typhoons is among the best in the world. Satellites track storms from the moment they form over the open ocean. Supercomputers model their likely path days in advance. Warnings are sent to millions of phones simultaneously. And China's centralised government can mobilise resources at a speed and scale that few democracies can match — moving a million people in 48 hours requires coordination that only a powerful central authority can deliver.\n\nChina has also invested in physical infrastructure. Sea walls have been strengthened along vulnerable coastlines. Drainage systems have been upgraded in major cities. The "sponge city" programme — which uses green spaces and permeable surfaces to absorb rainwater — has been rolled out in more than 30 cities since 2015.\n\nBut weaknesses remain. Rural areas are far less protected than cities. Warning systems that work through smartphones are less effective in communities where older residents do not use mobile phones. Building standards in smaller towns are lower than in major cities. And the sheer length of China's coastline — more than 14,000 kilometres — makes it impossible to protect every community equally.\n\nThe biggest challenge is economic. Climate adaptation costs money — and the communities most at risk are often the poorest. Strengthening sea walls, upgrading drainage, and relocating vulnerable populations requires sustained investment over decades. China has the resources to do this, but the question of whether those resources reach the communities that need them most is a political one, not a technical one.`,
    vocab: [
      { word: 'Preparedness', definition: 'The state of being ready for something — having plans and resources in place before a disaster.' },
      { word: 'Centralised', definition: 'Controlled from one place — all decisions made by one central authority.' },
      { word: 'Permeable', definition: 'Allowing water to pass through rather than running off the surface.' },
      { word: 'Adaptation', definition: 'Changing how you live to deal with new conditions — adjusting to a different environment.' },
    ],
    questions: [
      { n: 7, q: 'China moved one million people in 48 hours. Could your country do this? What system of government makes it easier or harder?' },
      { n: 8, q: 'Sponge cities use green spaces to absorb water. Could this approach work where you live?' },
      { n: 9, q: 'Rural areas are less protected than cities. How can governments ensure that disaster protection reaches everyone, not just people in big cities?' },
    ]
  },
  {
    number: 4, title: 'Living on the Front Line', emoji: '🌏', color: '#7f1d1d',
    text: `For hundreds of millions of people across Asia, living with typhoons is a fact of life — not an emergency but a season. Every year from June to November, communities along the coasts of China, the Philippines, Japan, Vietnam, and Taiwan prepare for storms that can destroy in hours what took years to build.\n\nThe Philippines is particularly vulnerable. The country is hit by an average of 20 typhoons per year — more than any other country on Earth. Typhoon Haiyan in 2013 killed more than 6,000 people and displaced millions. Despite this, millions of Filipinos continue to live in coastal areas because that is where the jobs, the fishing, and the affordable housing are. Moving inland is not an option when your livelihood depends on the sea.\n\nIn Thailand, the memory of the 2011 floods — which affected 13 million people and caused more than 45 billion dollars in damage — remains fresh. While Thailand does not experience direct typhoon landfalls as frequently as the Philippines or China, it is highly vulnerable to the flooding that typhoons cause as they weaken and move inland, dropping enormous amounts of rain on river basins that are already near capacity.\n\nThe question for all of these countries is the same: how do you balance the economic benefits of living near the coast with the increasing risks? As storms become stronger and sea levels rise, the cost of living on the front line will continue to grow. For the millions of people who have no choice but to stay, the answer lies not in retreat but in better preparation, stronger buildings, and communities that can bend without breaking.`,
    vocab: [
      { word: 'Vulnerable', definition: 'At risk of being harmed — in a position where damage is likely.' },
      { word: 'Livelihood', definition: 'How someone earns money to live — their job or source of income.' },
      { word: 'River basins', definition: 'Large areas of land where all the water drains into the same river system.' },
      { word: 'Retreat', definition: 'To move back or withdraw from a position — to leave a place.' },
    ],
    questions: [
      { n: 10, q: 'The Philippines is hit by 20 typhoons a year but people still live on the coast. Why? What would you do in their situation?' },
      { n: 11, q: 'Thailand 2011 floods caused 45 billion dollars in damage. Is your area better prepared now than it was then?' },
      { n: 12, q: 'The passage says communities must bend without breaking. What does this mean? How can a community become more resilient to storms?' },
    ]
  },
]
...
export default function TyphoonDolphinPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Typhoon Dolphin Hits China</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Typhoon Dolphin hit China with 180km/h winds, forcing one million people to evacuate. Are storms getting worse, and how do you live on the front line?</p>
            </div>
          </div>
