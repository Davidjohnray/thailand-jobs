...
const PARTS = [
  {
    number: 1, title: 'On the Brink', emoji: '⚠️', color: '#dc2626',
    text: `On 2 August 2026, US President Donald Trump announced that he had cancelled a planned military strike against Iran. The strikes had been prepared and were reportedly just hours from being carried out when Trump said he received a request from Iran and "other Middle Eastern countries" to hold off and allow time for peace negotiations. According to Trump, the outline of a deal had already been agreed.\n\nThe announcement came after months of rising tension between the United States and Iran. The two countries have been adversaries for decades, but the situation had escalated sharply in recent months, with both sides exchanging threats, building up military forces in the region, and coming closer to direct conflict than at any point since the US assassination of Iranian General Qassem Soleimani in 2020.\n\nFor people watching from around the world, the news brought a mixture of relief and anxiety. Relief that a military strike had been avoided — at least for now. Anxiety about what might happen next. The Middle East is one of the most strategically important regions on Earth. A war between the United States and Iran would affect oil prices, global trade, and the safety of millions of people across the region.\n\nThe situation also raised important questions about how decisions about war and peace are made. A military strike that could have killed hundreds of people and triggered a wider conflict was apparently called off at the last minute because of a phone call. The speed and unpredictability of modern diplomacy — where a single decision can prevent or start a war — is both remarkable and deeply unsettling.`,
    vocab: [
      { word: 'Adversaries', definition: 'Enemies or opponents — countries or people who are against each other.' },
      { word: 'Escalated', definition: 'Become more serious, intense, or dangerous over time.' },
      { word: 'Strategically', definition: 'In a way that is important for achieving a long-term plan or goal.' },
      { word: 'Diplomacy', definition: 'The process of managing relationships between countries through negotiation rather than war.' },
    ],
    questions: [
      { n: 1, q: 'Trump cancelled a military strike just hours before it was due to happen. How does it feel to know that war and peace can depend on a last-minute decision?' },
      { n: 2, q: 'The US and Iran have been adversaries for decades. Do you know why? What do you think it would take for them to become allies?' },
      { n: 3, q: 'A war between the US and Iran would affect oil prices and global trade. How would this affect your country and your daily life?' },
    ]
  },
  {
    number: 2, title: 'Why Are the US and Iran Enemies?', emoji: '📜', color: '#b91c1c',
    text: `The conflict between the United States and Iran has deep historical roots that stretch back more than 70 years.\n\nIn 1953, the US and British intelligence services helped overthrow Iran's democratically elected prime minister, Mohammad Mosaddegh, and replaced him with the Shah — a monarch friendly to Western interests, particularly oil. For 26 years, the Shah ruled Iran with the support of the United States, while many ordinary Iranians lived under an authoritarian regime that suppressed political opposition.\n\nIn 1979, the Iranian Revolution overthrew the Shah and established an Islamic republic. The new government was deeply hostile to the United States, which it blamed for decades of interference. Iranian students stormed the US embassy in Tehran and held 52 American diplomats hostage for 444 days. The relationship between the two countries has never recovered.\n\nSince then, the US and Iran have been locked in a cycle of hostility. The US has imposed severe economic sanctions on Iran, restricting its ability to trade with the rest of the world. Iran has developed a nuclear programme that the US and its allies fear is aimed at building nuclear weapons — a claim Iran denies. Both countries have supported opposing sides in conflicts across the Middle East, including in Iraq, Syria, Yemen, and Lebanon.\n\nUnderstanding this history helps explain why the current tensions feel so dangerous. This is not a new disagreement — it is a conflict with decades of accumulated mistrust, grievance, and hostility on both sides. Finding a path to peace requires addressing not just the current crisis but the deep wounds of the past.`,
    vocab: [
      { word: 'Overthrow', definition: 'To remove a leader or government from power by force.' },
      { word: 'Authoritarian', definition: 'A government that controls everything and does not allow people to disagree or have political freedom.' },
      { word: 'Sanctions', definition: 'Punishments imposed by one country on another — usually restrictions on trade or finance.' },
      { word: 'Grievance', definition: 'A feeling of unfairness or injustice about something that has happened — a long-held complaint.' },
    ],
    questions: [
      { n: 4, q: 'The US helped overthrow Iran s elected leader in 1953. Do you think events from 70 years ago still matter today? Why?' },
      { n: 5, q: 'Economic sanctions are meant to pressure countries into changing their behaviour. Do you think sanctions work? Who suffers most — governments or ordinary people?' },
      { n: 6, q: 'The passage says finding peace requires addressing deep wounds from the past. Is this possible between countries that have been enemies for decades? How?' },
    ]
  },
  {
    number: 3, title: 'What a War Would Mean', emoji: '💥', color: '#991b1b',
    text: `If the cancelled strikes had gone ahead and led to a wider war, the consequences would have been felt far beyond the Middle East.\n\nIran controls one side of the Strait of Hormuz — a narrow waterway through which approximately 20% of the world's oil supply passes every day. If Iran closed the strait or attacked oil tankers passing through it — as it has threatened to do in the past — global oil prices would spike immediately, driving up the cost of petrol, food, transport, and manufacturing in every country on Earth. The economic impact would be felt from Bangkok to Berlin.\n\nA war would also destabilise the wider region. Iran has allies and proxy forces across the Middle East — in Lebanon, Iraq, Syria, and Yemen. A direct US attack on Iran could trigger retaliatory attacks by these groups against US allies and military bases across the region. Israel, Saudi Arabia, and the Gulf states would all be drawn into the conflict.\n\nThe humanitarian cost would be enormous. Iran has a population of more than 88 million people. Modern military strikes, even those described as "precision" attacks, inevitably cause civilian casualties. The experience of wars in Iraq, Afghanistan, and Syria has shown that the human cost of military intervention is always far higher than predicted, and that the consequences can last for decades.\n\nFor all of these reasons, the cancellation of the strikes was welcomed by governments around the world. But the underlying tensions remain. The situation between the US and Iran is not resolved — it is paused. And the question of whether diplomacy can succeed where decades of hostility have failed remains unanswered.`,
    vocab: [
      { word: 'Strait', definition: 'A narrow passage of water connecting two larger bodies of water.' },
      { word: 'Proxy forces', definition: 'Military groups that are supported and directed by a larger country to fight on their behalf.' },
      { word: 'Retaliatory', definition: 'Done as revenge or payback — attacking in response to an attack.' },
      { word: 'Humanitarian', definition: 'Concerned with the wellbeing and suffering of people — relating to human welfare.' },
    ],
    questions: [
      { n: 7, q: '20% of the world s oil passes through the Strait of Hormuz. How would a war that closed this waterway affect your daily life?' },
      { n: 8, q: 'Modern wars always cause more civilian casualties than predicted. Why do you think this is? Should this affect how countries decide whether to go to war?' },
      { n: 9, q: 'The situation is described as paused, not resolved. What is the difference? What needs to happen for it to be truly resolved?' },
    ]
  },
  {
    number: 4, title: 'War and Peace in the Modern World', emoji: '🕊️', color: '#7f1d1d',
    text: `The US-Iran crisis raises a question that is as old as human civilisation: when is war justified, and when should countries choose diplomacy instead?\n\nThroughout history, leaders have used many arguments to justify going to war — self-defence, protecting allies, preventing a greater threat, spreading democracy, or punishing aggression. Some of these wars have been widely supported. Others have been deeply controversial. The Iraq War of 2003, which was justified by claims about weapons of mass destruction that turned out to be false, severely damaged public trust in the arguments governments make for military action.\n\nThe United Nations was created after the Second World War with the specific goal of preventing future wars through diplomacy, negotiation, and international law. The UN Charter states that countries should only use military force in self-defence or with the approval of the Security Council. In practice, powerful countries have frequently ignored these rules when they found them inconvenient.\n\nFor ordinary people, wars are rarely a choice. They are something that happens to them — decided by leaders they may not have voted for, fought for reasons they may not understand, and paid for with their taxes, their homes, and sometimes their lives. The people most affected by the US-Iran crisis — ordinary Iranians and the millions of people living near potential conflict zones — had no say in the decisions being made about their futures.\n\nThis week, those decisions went in the direction of peace rather than war. Whether they continue to do so depends on choices that are still being made — in Washington, in Tehran, and in capitals around the world. Understanding these choices, and having the knowledge to form your own opinion about them, is one of the most important things you can do as a citizen of the world.`,
    vocab: [
      { word: 'Justified', definition: 'Having a good or acceptable reason for something — being able to explain why it was the right thing to do.' },
      { word: 'Controversial', definition: 'Causing strong disagreement between people with different opinions.' },
      { word: 'Security Council', definition: 'The most powerful part of the United Nations, responsible for maintaining international peace and security.' },
      { word: 'Conflict zones', definition: 'Areas where fighting or war is happening or likely to happen.' },
    ],
    questions: [
      { n: 10, q: 'When do you think war is justified? Are there situations where military force is the only option? Give an example.' },
      { n: 11, q: 'Ordinary people have no say in decisions about war. Is this acceptable in a democracy? Should citizens be asked before their country goes to war?' },
      { n: 12, q: 'This week, the decision went towards peace. What do you think needs to happen for the US and Iran to reach a lasting agreement?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>US and Iran Step Back from War</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Trump cancelled a military strike on Iran just hours before it was due to happen. Why are the US and Iran enemies, what would a war mean, and can diplomacy succeed?</p>
            </div>
          </div>
