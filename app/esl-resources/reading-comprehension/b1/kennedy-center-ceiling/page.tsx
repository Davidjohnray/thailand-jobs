...
const PARTS = [
  {
    number: 1, title: 'Falling Down', emoji: '💥', color: '#dc2626',
    text: `This week, part of the ceiling in the grand foyer of the John F. Kennedy Center for the Performing Arts in Washington, D.C., collapsed. Chunks of plaster and decorative material fell from the ceiling onto the floor below. Nobody was injured — the collapse happened early in the morning before the building opened to the public — but the incident has renewed urgent calls about the state of America crumbling public infrastructure.\n\nThe Kennedy Center is one of the most prestigious arts venues in the world. It hosts the National Symphony Orchestra, opera, ballet, theatre, and concerts. Presidents attend performances there. Foreign leaders are entertained there. It is, in many ways, the cultural face of the United States.\n\nAnd its ceiling just fell down.\n\nOfficials said the collapse was caused by decades of deferred maintenance — repairs that were needed but repeatedly postponed because of budget constraints. Water damage had weakened the plaster. Temperature changes had caused cracking. And warnings from engineers about the deteriorating condition of the ceiling had been acknowledged but not acted upon.\n\nThe Kennedy Center was built in 1971 and has not received a major structural renovation since. For 55 years, it has been patched, painted, and kept running with temporary fixes — but the underlying structure has been slowly deteriorating. This week, gravity won.`,
    vocab: [
      { word: 'Foyer', definition: 'A large entrance hall in a building — the main lobby where visitors arrive.' },
      { word: 'Prestigious', definition: 'Highly respected and admired — having a reputation for excellence.' },
      { word: 'Deferred maintenance', definition: 'Repairs that were needed but postponed — putting off essential work to save money.' },
      { word: 'Deteriorating', definition: 'Getting worse over time — gradually falling apart.' },
    ],
    questions: [
      { n: 1, q: 'The ceiling of America most famous arts venue collapsed. What does this say about how the country treats its public buildings?' },
      { n: 2, q: 'The building is 55 years old and has never been properly renovated. Why do governments delay maintenance on important buildings?' },
      { n: 3, q: 'Nobody was hurt because it happened early in the morning. What if it had happened during a performance?' },
    ]
  },
  {
    number: 2, title: 'America Is Falling Apart', emoji: '🌉', color: '#b91c1c',
    text: `The Kennedy Center ceiling is not an isolated incident. It is a symptom of a much larger problem: America public infrastructure is aging, underfunded, and increasingly dangerous.\n\nThe American Society of Civil Engineers gives US infrastructure a grade of C-minus — barely passing. Bridges, roads, water systems, schools, and public buildings across the country are in desperate need of repair or replacement. The society estimates that the US needs to spend 2.6 trillion dollars more than currently planned over the next decade just to bring infrastructure up to an acceptable standard.\n\nThe examples are everywhere. In 2021, a residential building in Surfside, Florida, collapsed, killing 98 people — caused by decades of ignored structural warnings. In 2023, a section of Interstate 95 in Philadelphia collapsed after a tanker fire, partly because the bridge structure was already weakened by age. Water systems in cities across the country deliver drinking water through pipes that are more than 100 years old — some still made of lead.\n\nThe problem is not that Americans do not know their infrastructure is crumbling. The problem is political. Infrastructure repair is expensive, unglamorous, and produces no immediate visible results. Politicians prefer to announce new projects — which generate headlines and ribbon-cutting ceremonies — rather than fund the boring but essential work of maintaining what already exists.`,
    vocab: [
      { word: 'Infrastructure', definition: 'The basic systems a country needs to function — roads, bridges, pipes, buildings, power lines.' },
      { word: 'Civil engineers', definition: 'Engineers who design and maintain public structures — bridges, roads, buildings, water systems.' },
      { word: 'Unglamorous', definition: 'Not exciting or attractive — boring and ordinary, even if important.' },
      { word: 'Ribbon-cutting', definition: 'A ceremony to celebrate the opening of a new building or project.' },
    ],
    questions: [
      { n: 4, q: 'US infrastructure gets a C-minus grade. Does this surprise you for the world richest country?' },
      { n: 5, q: '98 people died in a building collapse caused by ignored warnings. Who is responsible when maintenance is deferred?' },
      { n: 6, q: 'Politicians prefer new projects over repairs because repairs are boring. How do you make maintenance politically attractive?' },
    ]
  },
  {
    number: 3, title: 'The Hidden Cost of Neglect', emoji: '💰', color: '#991b1b',
    text: `There is a cruel irony in deferred maintenance: the longer you wait, the more expensive the repair becomes. A leaking roof that costs 10,000 dollars to fix this year will cost 100,000 dollars to fix in five years — because the water damage will have spread to the walls, the electrical system, and the foundation. Delaying maintenance does not save money. It borrows from the future at a terrible interest rate.\n\nThis principle applies to everything — from individual homes to national infrastructure. A bridge that needs 5 million dollars in repairs today will need 50 million in complete replacement if those repairs are delayed for a decade. A water pipe that costs 1 million to reline will cost 10 million to replace after it bursts and floods a neighbourhood.\n\nThe Kennedy Center ceiling collapse will cost far more to repair than it would have cost to maintain properly. The temporary closure of parts of the building will cost the arts organisations that perform there millions in lost revenue. And the reputational damage — the fact that America cultural showcase literally fell apart — is impossible to quantify.\n\nEvery country faces this challenge. Thailand, which built rapidly during its economic boom in the 1980s and 1990s, is now dealing with aging infrastructure of its own — bridges, flyovers, and public buildings that were built decades ago and need attention. The lesson from the Kennedy Center is universal: build it, maintain it, or watch it fall.`,
    vocab: [
      { word: 'Irony', definition: 'When the outcome is the opposite of what you would expect — often with a cruel or funny quality.' },
      { word: 'Reline', definition: 'To put a new lining inside something — like coating the inside of a pipe.' },
      { word: 'Reputational', definition: 'Relating to how others see you — affecting your public image and credibility.' },
      { word: 'Quantify', definition: 'To measure or express as a number — to put a value on something.' },
    ],
    questions: [
      { n: 7, q: 'Delaying repairs makes them more expensive. Why do people and governments still delay?' },
      { n: 8, q: 'Thailand built rapidly in the 80s and 90s. Are those buildings being maintained? What happens if they are not?' },
      { n: 9, q: 'Build it, maintain it, or watch it fall. Is this true for other things in life besides buildings?' },
    ]
  },
  {
    number: 4, title: 'What We Build Says Who We Are', emoji: '🎭', color: '#7f1d1d',
    text: `The Kennedy Center was named after President John F. Kennedy, who was assassinated in 1963. It was built as a living memorial — not a statue or a plaque, but a place where art would be performed and culture would thrive. The building itself was a statement: America believes in the arts, in beauty, in the life of the mind.\n\nWhen the ceiling of that building collapses because of decades of neglect, it sends a different statement: we built something beautiful and then stopped caring for it. The arts are important enough to build a centre for, but not important enough to maintain.\n\nThis tension — between what a country says it values and what it actually funds — exists everywhere. Countries build schools but do not pay teachers enough. They build hospitals but do not stock them with medicine. They build roads but do not repair them. The gap between aspiration and maintenance is where most public services fail.\n\nBut the Kennedy Center story also has a hopeful dimension. The collapse has generated enormous public attention and political pressure. Funding proposals that were stalled for years are suddenly moving. Engineers are being hired. Repairs are being planned. Sometimes, it takes a visible failure to create the political will for action.\n\nThe ceiling fell down. But perhaps, in falling, it will finally force the people with the power to fix things to do so. Sometimes the most useful thing a building can do is break — loudly, publicly, and embarrassingly enough that nobody can ignore it.`,
    vocab: [
      { word: 'Memorial', definition: 'Something built to honour and remember a person or event.' },
      { word: 'Aspiration', definition: 'A hope or ambition — what you want to achieve or become.' },
      { word: 'Stalled', definition: 'Stopped making progress — stuck and not moving forward.' },
      { word: 'Political will', definition: 'The determination of politicians to act — the motivation to do something even when it is difficult.' },
    ],
    questions: [
      { n: 10, q: 'The gap between what a country says it values and what it funds — can you see this in your own country?' },
      { n: 11, q: 'Sometimes things have to break before they get fixed. Why does it take a crisis to create action?' },
      { n: 12, q: 'What we build says who we are. What we maintain says what we truly value. Do you agree?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Kennedy Center Ceiling Collapses in Washington". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function KennedyCenterPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Kennedy Center Ceiling Collapses in Washington</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Part of the ceiling at America most famous arts venue fell down this week. Decades of neglect, crumbling infrastructure, and what happens when countries stop maintaining what they built.</p>
            </div>
          </div>
