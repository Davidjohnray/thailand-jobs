...
const PARTS = [
  {
    number: 1, title: 'Stolen Twice in One Weekend', emoji: '🖼️', color: '#dc2626',
    text: `This weekend, Italian police found themselves dealing with one of the strangest crime stories of the year. On Friday, officers in the northern city of Parma announced that they had recovered three paintings stolen from a museum near the city. By Saturday night — less than 24 hours later — thieves in Sicily, at the other end of the country, had stolen four more masterpieces from a completely different museum.\n\nTwo art thefts in two days, in two different parts of Italy. The coincidence was so remarkable that investigators initially wondered whether the crimes were connected. They were not — just a bizarre weekend that highlighted a problem Italy has been struggling with for decades: how do you protect one of the world's greatest collections of art when you have thousands of museums, churches, and archaeological sites, many of them with inadequate security?\n\nItaly has more UNESCO World Heritage Sites than any other country in the world — 59 in total. Its museums, churches, and galleries contain millions of artworks spanning more than 2,000 years of history. From Roman sculptures to Renaissance paintings to Baroque frescoes, Italy's cultural heritage is arguably the richest on Earth.\n\nBut protecting all of it is impossible. Many smaller museums operate with tiny budgets, minimal staff, and security systems that would not stop a determined thief. Churches that contain priceless medieval paintings are often unlocked during the day. Archaeological sites stretch across open countryside with no fences or guards. For art thieves, Italy is both the greatest treasure house and the easiest target in the world.`,
    vocab: [
      { word: 'Masterpieces', definition: 'Works of art that are considered among the finest ever created.' },
      { word: 'Heritage', definition: 'Things of value that are passed down from previous generations — history, culture, buildings, art.' },
      { word: 'Renaissance', definition: 'A period of European history (roughly 1400-1600) famous for extraordinary achievements in art, science, and culture.' },
      { word: 'Archaeological', definition: 'Relating to the study of ancient civilisations through their physical remains — ruins, tools, art.' },
    ],
    questions: [
      { n: 1, q: 'Two art thefts in two days in two different cities. Does this surprise you? What does it tell us about art security in Italy?' },
      { n: 2, q: 'Italy has more UNESCO World Heritage Sites than any country. Is this a blessing or a burden? Why?' },
      { n: 3, q: 'Many Italian churches with priceless art are unlocked. Should they be locked up, or does public access matter more than security?' },
    ]
  },
  {
    number: 2, title: 'The Art Crime Capital', emoji: '🔓', color: '#b91c1c',
    text: `Italy loses more artworks to theft than any other country. The Italian Carabinieri — the military police force — has an entire unit dedicated to art crime: the Tutela del Patrimonio Culturale, or Cultural Heritage Protection Command. It is the largest art crime unit in the world, with more than 300 officers.\n\nThe unit maintains a database of more than 1.3 million stolen artworks — paintings, sculptures, archaeological objects, rare books, and religious artefacts that have been stolen from Italian museums, churches, and private collections over the decades. Many have never been recovered. Some surface years later in private collections, auction houses, or museums in other countries. Others disappear forever.\n\nArt theft is often imagined as a glamorous crime — sophisticated thieves in black outfits, laser-dodging heists like in the movies. The reality is usually much simpler. Most art thefts involve breaking a window, cutting a painting from its frame, and driving away. Security at many Italian museums is so minimal that the main challenge is not getting in — it is knowing what to take.\n\nThe motivations vary. Some thefts are commissioned by wealthy private collectors who want artworks for their personal enjoyment and do not care that they were stolen. Some are carried out by organised crime groups who use stolen art as collateral for drug deals — a painting worth millions is easier to transport and hide than the equivalent amount of cash. And some thefts are opportunistic — someone sees a valuable painting in an unguarded church and simply takes it.`,
    vocab: [
      { word: 'Carabinieri', definition: 'Italy military police force — responsible for law enforcement and security.' },
      { word: 'Artefacts', definition: 'Objects made by humans in the past — often of historical or cultural value.' },
      { word: 'Collateral', definition: 'Something valuable given as a guarantee for a loan or deal — security for a transaction.' },
      { word: 'Opportunistic', definition: 'Taking advantage of a situation when it appears — acting on an unplanned chance.' },
    ],
    questions: [
      { n: 4, q: '1.3 million stolen artworks in Italy database. Why is art crime so common, and why is it so hard to stop?' },
      { n: 5, q: 'Movies show art theft as glamorous. The reality is usually a broken window. Why do we romanticise art crime?' },
      { n: 6, q: 'Criminals use stolen paintings as collateral for drug deals. Does this surprise you? Why would art be useful for this?' },
    ]
  },
  {
    number: 3, title: 'Why Art Matters', emoji: '🎨', color: '#991b1b',
    text: `When a painting is stolen from a museum, the loss is not just financial — it is cultural. Art connects people to their history, their identity, and their shared humanity in ways that few other things can.\n\nA painting by Caravaggio hanging in a Sicilian church is not just a valuable object. It is a link between the people of that community and the artist who created it 400 years ago. It is part of the identity of the place — something that generations have grown up seeing, that tourists travel across the world to visit, that scholars study and students learn from. When it is stolen, something irreplaceable is taken — not just from the museum, but from everyone who would have seen it.\n\nThis is why art crime is treated differently from other forms of theft. Stealing a television is a property crime. Stealing a Caravaggio is a crime against culture. Many countries have special laws that impose heavier sentences for art theft than for ordinary theft, recognising that the damage extends beyond the financial value of the object.\n\nThe same principle applies to archaeological looting — the illegal excavation and sale of ancient objects. Every year, thousands of artefacts are dug up illegally from archaeological sites around the world and sold to collectors and museums. Each object removed from its original context loses most of its scientific value — archaeologists can learn far more from an object found in place, surrounded by other objects, than from the same object sitting on a shelf in a private collection.\n\nThailand has experienced this problem too. Thousands of ancient artefacts from Thai archaeological sites have been illegally exported over the decades. The Thai government has been working to recover stolen artefacts from museums and collectors abroad — a slow, expensive, and often frustrating process.`,
    vocab: [
      { word: 'Irreplaceable', definition: 'Something so unique that it cannot be replaced if lost or destroyed.' },
      { word: 'Looting', definition: 'Stealing valuable items, especially from places of cultural or historical importance.' },
      { word: 'Context', definition: 'The circumstances or setting surrounding something — where and how an object was found.' },
      { word: 'Exported', definition: 'Sent or taken to another country — removed from the country of origin.' },
    ],
    questions: [
      { n: 7, q: 'The passage says stealing art is a crime against culture, not just property. Do you agree? What makes art different from other valuable objects?' },
      { n: 8, q: 'Thailand has lost thousands of artefacts to illegal export. Should museums that bought stolen artefacts return them? Is it always clear who owns ancient objects?' },
      { n: 9, q: 'An object removed from an archaeological site loses its scientific value. Why does context matter so much?' },
    ]
  },
  {
    number: 4, title: 'Can We Protect the Past?', emoji: '🛡️', color: '#7f1d1d',
    text: `The double art theft in Italy this weekend raises a question that every country with a rich cultural heritage must answer: how do you protect thousands of years of history when the resources are limited and the threats are constant?\n\nTechnology is helping. Many major museums now use advanced security systems — motion sensors, infrared cameras, GPS tracking devices embedded in frames, and even artificial intelligence that can detect unusual behaviour on security camera footage. Some museums have installed "smart glass" that becomes opaque if a painting is touched, and alarm systems that seal rooms automatically if a theft is detected.\n\nBut technology costs money, and most of the world's cultural heritage is not in major museums. It is in small churches, village museums, private collections, and archaeological sites spread across vast areas. Protecting all of it with high-tech security is financially impossible.\n\nSome experts argue that the best protection is not technology but community engagement. When local people feel ownership of their cultural heritage — when they see a medieval painting in their church not as a distant artwork but as part of their identity — they become its protectors. Community surveillance, local pride, and cultural education can be more effective than any alarm system.\n\nThe weekend's art thefts in Italy had a happy ending — police recovered the stolen paintings from Parma quickly, and investigators in Sicily are confident they will find the thieves. But for every theft that makes the news, dozens go unreported. And for every painting recovered, many more remain in private hands, unseen by the public, separated from the communities they belong to.\n\nArt belongs to everyone. Protecting it is a responsibility we all share.`,
    vocab: [
      { word: 'Opaque', definition: 'Not transparent — you cannot see through it.' },
      { word: 'Community engagement', definition: 'Involving local people in decisions and activities that affect their area.' },
      { word: 'Surveillance', definition: 'Watching and monitoring an area or activity, usually for security purposes.' },
      { word: 'Medieval', definition: 'From the Middle Ages — the period of European history roughly from the 500s to the 1400s.' },
    ],
    questions: [
      { n: 10, q: 'Technology can protect major museums, but most art is in small churches and villages. What other solutions exist?' },
      { n: 11, q: 'The passage says community pride protects art better than alarm systems. Do you agree? How can communities feel ownership of their heritage?' },
      { n: 12, q: 'Art belongs to everyone. Do you agree? Who should decide where artworks are kept and displayed?' },
    ]
  },
]
...
export default function ItalyArtPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Art Thieves Strike Twice in Italy</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Police recovered three stolen paintings on Friday. By Saturday, four more were stolen from another museum. Italy art crime problem and why protecting the past matters.</p>
            </div>
          </div>
