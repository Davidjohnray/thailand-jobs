...
const PARTS = [
  {
    number: 1, title: 'From Moscow to Kyiv', emoji: '✈️', color: '#dc2626',
    text: `In a dramatic diplomatic shuttle this weekend, US envoys Jared Kushner and Steve Witkoff flew from Moscow to Kyiv — meeting Russian President Vladimir Putin on Saturday and Ukrainian President Volodymyr Zelenskyy on Sunday. Both meetings were described as "substantive," and both sides agreed to temporary pauses in strikes on each other capitals while talks continue.\n\nThe visit is significant because it represents the first direct US diplomatic engagement with both sides of the Ukraine war during Trump second term. Previous attempts at negotiation had stalled over fundamental disagreements: Russia demands that Ukraine accept the loss of occupied territories and agree never to join NATO. Ukraine insists that any deal must respect its territorial integrity and sovereignty.\n\nKushner — Trump son-in-law and a controversial choice as envoy — has no formal diplomatic training. Critics have questioned whether he has the experience to negotiate between two leaders who have been at war for more than four years. Supporters argue that his unconventional approach and direct access to Trump give him leverage that career diplomats lack.\n\nThe temporary pause in capital strikes — if it holds — would be the first significant de-escalation of the war in months. But both sides have made clear that a pause is not a ceasefire, and that military operations continue across the rest of the front line.`,
    vocab: [
      { word: 'Envoys', definition: 'People sent by a government to represent it in another country — diplomatic messengers.' },
      { word: 'Shuttle diplomacy', definition: 'Travelling back and forth between two sides in a conflict to carry messages and negotiate.' },
      { word: 'Territorial integrity', definition: 'A country right to keep all of its territory — no land taken by force.' },
      { word: 'De-escalation', definition: 'Reducing the intensity of a conflict — stepping back from the edge of wider war.' },
    ],
    questions: [
      { n: 1, q: 'Kushner met Putin on Saturday and Zelenskyy on Sunday. What does this shuttle diplomacy tell us about the current moment?' },
      { n: 2, q: 'Kushner has no diplomatic training. Is this a strength or a weakness? Do fresh perspectives help in negotiations?' },
      { n: 3, q: 'Both sides agreed to pause strikes on capitals. Is this a meaningful step toward peace, or just a gesture?' },
    ]
  },
  {
    number: 2, title: 'What Each Side Wants', emoji: '🤝', color: '#b91c1c',
    text: `Understanding why peace in Ukraine is so difficult requires understanding what each side needs — and why those needs seem incompatible.\n\nRussia wants Ukraine to accept the reality on the ground: that Russia controls approximately 20% of Ukrainian territory, including Crimea and parts of four other regions. Russia also wants guarantees that Ukraine will never join NATO, and it wants Western sanctions lifted. For Putin, these are minimum conditions — the starting point, not the final offer.\n\nUkraine wants its territory back — all of it, including Crimea, which Russia has controlled since 2014. Ukraine wants security guarantees from Western nations — ideally NATO membership — to prevent future Russian aggression. And it wants Russia to be held accountable for the destruction and civilian deaths caused by the invasion.\n\nThe gap between these positions is enormous. Russia will not return territory it has fought and died for. Ukraine will not formally surrender land that is legally and constitutionally its own. And neither side trusts the other to honour any agreement — a problem that makes every proposed compromise fragile.\n\nThe US role is complicated. Trump has expressed admiration for Putin and scepticism about continued aid to Ukraine. Many Europeans fear that any deal brokered by Trump would favour Russia at Ukraine expense. Zelenskyy, meanwhile, cannot accept a deal that his own people would view as surrender — the political and moral costs would be devastating.`,
    vocab: [
      { word: 'Incompatible', definition: 'Unable to exist together — two things that cannot both be true or satisfied at the same time.' },
      { word: 'Guarantees', definition: 'Firm promises or assurances that something will happen — commitments backed by action.' },
      { word: 'Accountable', definition: 'Held responsible — required to answer for actions and face consequences.' },
      { word: 'Brokered', definition: 'Arranged or negotiated by a third party — a deal facilitated by someone not directly involved.' },
    ],
    questions: [
      { n: 4, q: 'Russia wants to keep territory. Ukraine wants it back. Is compromise possible when both sides feel strongly?' },
      { n: 5, q: 'Neither side trusts the other. How do you build trust between enemies during a war?' },
      { n: 6, q: 'Trump has expressed admiration for Putin. Should this worry Ukraine? How does the mediator own views affect negotiations?' },
    ]
  },
  {
    number: 3, title: 'The Cost of War', emoji: '💔', color: '#991b1b',
    text: `While diplomats negotiate, the human cost of the Ukraine war continues to grow.\n\nMore than four years of fighting have killed tens of thousands of soldiers on both sides. Civilian deaths are harder to count but are estimated in the tens of thousands as well. More than six million Ukrainians have fled the country as refugees. Entire cities — Mariupol, Bakhmut, parts of Kherson — have been reduced to rubble.\n\nThe economic damage is staggering. Ukraine infrastructure damage is estimated at more than 150 billion dollars. Farmland that once fed millions has been contaminated by mines and unexploded ordnance. Factories have been destroyed. Schools and hospitals have been bombed. The cost of rebuilding — whenever the war ends — will be borne by generations of Ukrainians.\n\nRussia has also paid a heavy price, though it is harder to measure because of Russian censorship. Western intelligence estimates suggest that more than 300,000 Russian soldiers have been killed or wounded. Russia economy, while propped up by oil revenues, is strained by sanctions, brain drain (hundreds of thousands of educated Russians have fled the country), and the enormous cost of sustaining a war effort.\n\nFor the soldiers on both sides — many of them young men who did not choose this fight — every day the war continues is another day of fear, exhaustion, injury, or death. Peace negotiations may be about politics and territory. But the urgency is about people.`,
    vocab: [
      { word: 'Ordnance', definition: 'Military weapons and ammunition — bombs, mines, and shells.' },
      { word: 'Censorship', definition: 'When a government controls and restricts what information is available to the public.' },
      { word: 'Brain drain', definition: 'When educated, skilled people leave a country — the loss of talent and expertise.' },
      { word: 'Sustaining', definition: 'Keeping something going over a long period — maintaining effort and resources.' },
    ],
    questions: [
      { n: 7, q: 'Tens of thousands dead on both sides. At what point does the cost of continuing a war exceed the cost of compromise?' },
      { n: 8, q: '300,000 Russian soldiers killed or wounded. Yet Russia continues fighting. Why?' },
      { n: 9, q: 'Rebuilding Ukraine will cost more than 150 billion dollars. Who should pay for it?' },
    ]
  },
  {
    number: 4, title: 'Is Peace Possible?', emoji: '🌅', color: '#7f1d1d',
    text: `The Kushner-Witkoff visit to Kyiv has generated cautious hope — but history teaches us to be careful with hope in the middle of a war.\n\nPeace talks have failed before. In March 2022, just weeks after the invasion began, negotiators from Russia and Ukraine met in Turkey and reportedly came close to a deal. That effort collapsed, and the war intensified. Since then, multiple attempts at negotiation have gone nowhere.\n\nBut several factors make this moment different. Both armies are exhausted after four years of fighting. Russia has made little territorial progress in recent months. Ukraine counter-offensive capabilities have been limited by ammunition shortages. And the Trump administration — whatever its motives — is actively engaged in a way that previous US diplomatic efforts were not.\n\nThe most realistic outcome is probably not the peace that either side wants. It is likely a frozen conflict — a ceasefire that stops the fighting without resolving the underlying territorial dispute. This is what happened in Korea in 1953 — the war ended, but the border was never agreed upon, and technically the two Koreas are still at war 73 years later.\n\nA frozen conflict is not justice. Ukraine would lose territory. Russia would face no consequences. And the people of both countries would be left to wonder whether it was worth it. But a frozen conflict saves lives. And at this point, after four years of destruction, saving lives may be the most that diplomacy can achieve.`,
    vocab: [
      { word: 'Cautious', definition: 'Careful and not too hopeful — avoiding excessive optimism.' },
      { word: 'Frozen conflict', definition: 'A war that stops without being resolved — fighting ends but the dispute remains.' },
      { word: 'Counter-offensive', definition: 'A military attack launched in response to an enemy attack — fighting back.' },
      { word: 'Diplomacy', definition: 'The art of negotiating between countries — managing relationships through talking rather than fighting.' },
    ],
    questions: [
      { n: 10, q: 'A frozen conflict like Korea — fighting stops but the dispute remains. Is this acceptable, or does it just delay the next war?' },
      { n: 11, q: 'Peace talks have failed before. What makes this time different — or does it?' },
      { n: 12, q: 'Saving lives may be the most diplomacy can achieve right now. Is that enough? What would true peace look like?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Kushner and Witkoff Visit Kyiv for Peace Talks". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function KushnerKyivPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Kushner and Witkoff Visit Kyiv for Peace Talks</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>After meeting Putin in Moscow, US envoys flew to Kyiv to meet Zelenskyy. Could this be the beginning of peace in Ukraine, or just another false start?</p>
            </div>
          </div>
