...
const PARTS = [
  {
    number: 1, title: 'Nine Days Underground', emoji: '🔦', color: '#dc2626',
    text: `Nine days after catastrophic floods struck Nepal on 26 August, rescuers achieved what many had given up hoping for: they pulled two workers alive from a hydropower tunnel that had been buried under tonnes of mud and rock.\n\nThe two men — construction workers who had been building a hydroelectric power plant when the floods hit — survived for more than 200 hours in darkness, trapped in a small air pocket deep inside the collapsed tunnel. They had no food. They had limited water — drinking from small streams of groundwater that seeped through the rubble. They had no light. And they had no way of knowing whether anyone was coming to save them.\n\nThe rescue operation was extraordinarily complex. The tunnel was blocked by more than 50 metres of debris. Heavy machinery could not reach the remote mountain location. Rescuers worked around the clock, digging by hand in some sections, using small drilling equipment in others. Aftershocks and continuing rain constantly threatened to cause further collapses.\n\nWhen the two men finally emerged — blinking in the sunlight, thin and exhausted but alive — the rescue team erupted in cheers. Videos of the moment, shared across Nepali social media, showed rescuers embracing the survivors, many with tears streaming down their faces. In a disaster that has killed more than 200 people and left thousands missing, this was a rare moment of pure joy.`,
    vocab: [
      { word: 'Hydropower', definition: 'Electricity generated by the force of flowing or falling water.' },
      { word: 'Air pocket', definition: 'A small space containing trapped air — allowing breathing in an otherwise blocked area.' },
      { word: 'Rubble', definition: 'Broken pieces of brick, stone, and concrete from a collapsed structure.' },
      { word: 'Aftershocks', definition: 'Smaller earthquakes or ground movements that follow a major disaster.' },
    ],
    questions: [
      { n: 1, q: 'Trapped for 9 days in darkness with no food. What do you think kept these men going mentally?' },
      { n: 2, q: 'Rescuers dug for 9 days without knowing if anyone was alive. What drives people to keep trying?' },
      { n: 3, q: 'In a disaster that killed hundreds, this rescue brought joy to a nation. Why do individual survival stories affect us so powerfully?' },
    ]
  },
  {
    number: 2, title: 'The Science of Survival', emoji: '💧', color: '#b91c1c',
    text: `How do you survive nine days underground with no food and almost no water? The answer involves both biology and psychology.\n\nBiologically, the human body can survive far longer without food than most people realise. A healthy adult can live for three to four weeks without eating, as the body burns through its stored energy — first glycogen in the liver, then fat, and finally muscle protein. The two Nepali workers were thin but not in critical condition after nine days — their bodies had adapted to starvation mode.\n\nWater is far more critical. Without water, most people die within three to five days. The workers survived because groundwater seeped through the rubble, giving them small amounts to drink. This water was probably not clean — but in a survival situation, contaminated water is better than no water at all.\n\nTemperature helped too. Inside the tunnel, the temperature was relatively stable — cooler than the surface during the day, warmer at night. The workers did not face the extreme heat or cold that kills many trapped survivors.\n\nBut perhaps the most important factor was psychological. Studies of disaster survivors consistently show that the will to live — the mental decision to keep fighting rather than give up — is one of the strongest predictors of survival. People who believe they will be rescued survive longer than those who lose hope, even when their physical conditions are identical. The mind, it turns out, has more power over survival than the body.`,
    vocab: [
      { word: 'Glycogen', definition: 'A form of sugar stored in the liver and muscles — the body first source of emergency energy.' },
      { word: 'Starvation mode', definition: 'When the body slows its metabolism to conserve energy during prolonged lack of food.' },
      { word: 'Contaminated', definition: 'Made impure or unsafe — water containing harmful bacteria or substances.' },
      { word: 'Predictors', definition: 'Factors that help forecast an outcome — things that indicate what will happen.' },
    ],
    questions: [
      { n: 4, q: 'The body can survive weeks without food but only days without water. Why is water so much more critical?' },
      { n: 5, q: 'People who believe they will be rescued survive longer. How does the mind affect the body physical ability to survive?' },
      { n: 6, q: 'In a survival situation, dirty water is better than no water. What other survival rules might surprise people?' },
    ]
  },
  {
    number: 3, title: 'The Rescuers', emoji: '⛑️', color: '#991b1b',
    text: `Behind every miracle rescue is a team of people who refused to stop digging.\n\nThe Nepal tunnel rescue involved soldiers, local volunteers, heavy equipment operators, and international advisors working in shifts around the clock for nine days. They worked in dangerous conditions — the tunnel could have collapsed further at any moment. They worked in monsoon rain that turned the ground to mud. And they worked without certainty that anyone was alive inside.\n\nThis last point is crucial. After the first 72 hours — the "golden period" when most trapped survivors are found — many experts advised that the chances of finding anyone alive were extremely low. The pressure to redirect resources to other rescue sites was intense. But the team leader refused to stop, reportedly telling his superiors: "Until we know they are dead, we dig."\n\nRescue work takes an enormous toll on the people who do it. Physical exhaustion is just the beginning. The psychological weight of searching for survivors — knowing that behind every rock could be a living person or a body — creates stress that accumulates over days and weeks. Many rescue workers develop post-traumatic stress from what they see and experience during operations.\n\nThe men and women who dug for nine days in Nepal will probably never be famous. Their names will not appear in history books. But for two construction workers who emerged alive from what should have been their tomb, the rescuers are the most important people in the world.`,
    vocab: [
      { word: 'Around the clock', definition: 'Continuously, 24 hours a day, without stopping.' },
      { word: 'Golden period', definition: 'The first 72 hours after a disaster when survivors are most likely to be found alive.' },
      { word: 'Toll', definition: 'The cost or damage caused by something — the physical and emotional price paid.' },
      { word: 'Tomb', definition: 'A place where dead people are buried — used here to describe the sealed tunnel.' },
    ],
    questions: [
      { n: 7, q: 'The team leader said: "Until we know they are dead, we dig." What kind of person says this and means it?' },
      { n: 8, q: 'Rescue workers often develop PTSD. How should we support people who do this work?' },
      { n: 9, q: 'The rescuers will never be famous. Should society do more to recognise everyday heroes?' },
    ]
  },
  {
    number: 4, title: 'Why We Never Stop Hoping', emoji: '🌅', color: '#7f1d1d',
    text: `The Nepal tunnel rescue is one of those rare stories that makes the entire world pause and feel something good.\n\nIn a news landscape dominated by war, disaster, political conflict, and economic anxiety, a story about two men pulled alive from the earth after nine days is medicine. It reminds us that human beings are capable of extraordinary things — not just extraordinary destruction, but extraordinary compassion, determination, and hope.\n\nRescue stories tap into something deep in human psychology. We are a social species — hardwired to care about the survival of others. When we hear that someone is trapped, our instinct is not to walk away but to help. This instinct exists across cultures, religions, and political boundaries. It is one of the few things that genuinely unites humanity.\n\nThe two workers will recover physically. They will need time to process what happened to them — nine days in darkness is a trauma that leaves marks. But they are alive. Their families, who had spent nine days not knowing, can hold them again. And the rescuers who dug through rubble without certainty can sleep tonight knowing that their refusal to give up saved two lives.\n\nNot every rescue attempt succeeds. Not every story has a happy ending. But the ones that do remind us why we keep trying — why we dig, why we search, why we refuse to accept that the worst has happened until we know for certain. Hope is not naive. Hope is human. And this week, in a tunnel in Nepal, hope was rewarded.`,
    vocab: [
      { word: 'Compassion', definition: 'Deep concern for the suffering of others — the desire to help people who are in pain.' },
      { word: 'Hardwired', definition: 'Built into us from birth — an instinct we are born with, not something we learn.' },
      { word: 'Trauma', definition: 'A deeply distressing experience that leaves lasting emotional effects.' },
      { word: 'Naive', definition: 'Too trusting or innocent — believing something unrealistic.' },
    ],
    questions: [
      { n: 10, q: 'Rescue stories make the whole world pause. Why do these stories affect us more than statistics about disasters?' },
      { n: 11, q: 'Helping trapped strangers is an instinct that crosses all cultures. What does this tell us about human nature?' },
      { n: 12, q: 'The passage says hope is not naive — hope is human. Do you agree? What keeps you hopeful in difficult times?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a thoughtful English conversation partner helping a B1 intermediate student practise discussion skills. The reading topic is "Two Workers Rescued from Nepal Tunnel After 9 Days". The current discussion question is: "${question}". Keep responses to 2-3 sentences. Use sophisticated but accessible B1-level English. End with one probing follow-up question. If the student makes a significant grammar error, gently correct it using "💡 Quick tip: ..." at the very end. Be intellectually engaging and encouraging.`
...
export default function NepalRescuePage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Two Workers Rescued from Nepal Tunnel After 9 Days</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Nine days after catastrophic floods buried a tunnel in Nepal, rescuers pulled two workers out alive. The miracle rescue, what kept them alive, and why we never stop hoping.</p>
            </div>
          </div>
