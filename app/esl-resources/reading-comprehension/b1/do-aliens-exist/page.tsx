...
const PARTS = [
  {
    number: 1, title: 'The Question That Has Always Fascinated Us', emoji: '🌌', color: '#6366f1',
    text: `For thousands of years, humans have looked up at the night sky and asked the same question: are we alone? Ancient civilisations drew pictures of strange beings in their art and told stories about visitors from the sky. The ancient Egyptians, the Mayans of Central America, and many other early cultures created images that some people today think look like astronauts or flying machines. Of course, most historians say these are simply the way those cultures drew gods and spirits — but the mystery still excites people's imaginations.\n\nIn the twentieth century, the question became more serious. Scientists began to understand how enormous the universe really is. Our planet Earth orbits one star — the Sun. But our galaxy, the Milky Way, contains over two hundred billion stars. And astronomers now believe there are more galaxies in the observable universe than there are grains of sand on all the beaches of Earth. With so many stars and so many planets, many scientists believe it would be very strange if Earth were the only place where life developed. As the famous Italian physicist Enrico Fermi once asked: if the universe is so big and old, where is everybody?`,
    vocab: [
      { word: 'Civilisations', definition: 'Advanced human societies with their own culture, history, and way of life.' },
      { word: 'Astronomers', definition: 'Scientists who study stars, planets, and everything in space.' },
      { word: 'Galaxy', definition: 'A very large group of stars held together by gravity — our galaxy is called the Milky Way.' },
      { word: 'Observable universe', definition: 'The part of space that we can see from Earth using telescopes and other instruments.' },
    ],
    questions: [
      { n: 1, q: 'Do you believe there is life somewhere else in the universe? Why or why not?' },
      { n: 2, q: 'Why do you think humans have always been fascinated by the idea of aliens?' },
      { n: 3, q: 'If the universe has billions of galaxies, does that change how you feel about the possibility of alien life?' },
    ]
  },
  {
    number: 2, title: 'UFOs, Roswell and the Age of Flying Saucers', emoji: '🛸', color: '#8b5cf6',
    text: `The modern story of UFOs — Unidentified Flying Objects — really began in 1947. In June of that year, an American pilot called Kenneth Arnold reported seeing nine bright objects flying at incredible speed near Mount Rainier in Washington State. He described them moving like a saucer if you skipped it across water, and newspapers quickly called them "flying saucers." The term became famous around the world almost immediately.\n\nJust weeks later, in July 1947, something crashed in the desert near Roswell, New Mexico. The US Army Air Force first announced they had recovered a "flying disc" — but the next day they changed the story and said it was just a weather balloon. This change of story made many people suspicious. For decades, people who believed in UFOs claimed that the US government had found a crashed alien spacecraft and kept it secret. The US government officially denied this. However, in 2021, the American government released a report about what it calls UAPs — Unidentified Aerial Phenomena — admitting that military pilots had recorded many objects in the sky that could not be easily explained. It was the most serious official statement about UFOs in history, and it changed the conversation completely.`,
    vocab: [
      { word: 'UFO', definition: 'Unidentified Flying Object — something seen in the sky that cannot be immediately explained.' },
      { word: 'Suspicious', definition: 'Having a feeling that something is wrong or that someone is not telling the truth.' },
      { word: 'Denied', definition: 'Said that something is not true — officially stated that something did not happen.' },
      { word: 'UAP', definition: 'Unidentified Aerial Phenomena — the official modern term used by governments instead of "UFO".' },
    ],
    questions: [
      { n: 4, q: 'Why do you think the US government changed its story about Roswell? Does this make you more or less suspicious?' },
      { n: 5, q: 'Do you think governments around the world might be hiding information about UFOs? Why?' },
      { n: 6, q: 'Does the fact that the US military released an official UFO report in 2021 surprise you? Why?' },
    ]
  },
  {
    number: 3, title: 'Science Searches for Life in Space', emoji: '🔭', color: '#0ea5e9',
    text: `While some people look for aliens in old photographs or UFO reports, scientists are searching in a very different way. NASA and other space agencies have sent rovers to Mars to look for signs that life may have existed there billions of years ago. Mars once had liquid water on its surface, and water is one of the key ingredients scientists believe life needs to develop. So far, no direct evidence of past or present life on Mars has been found — but the search continues.\n\nScientists have also discovered thousands of exoplanets — planets that orbit stars other than our Sun. Some of these planets are in what scientists call the "habitable zone" — the area around a star where the temperature is right for liquid water to exist. One programme called SETI — the Search for Extraterrestrial Intelligence — has been listening to radio signals from space since the 1960s, hoping to detect a message from another civilisation. In 1977, a radio telescope in Ohio picked up a strong, unusual signal from space that became known as the "Wow! Signal" — scientists have never been able to fully explain it. The search for intelligent life remains one of the most exciting scientific projects in human history.`,
    vocab: [
      { word: 'Rovers', definition: 'Small robotic vehicles sent to explore the surface of other planets.' },
      { word: 'Exoplanets', definition: 'Planets that exist outside our solar system, orbiting other stars.' },
      { word: 'Habitable zone', definition: 'The area around a star where conditions might allow liquid water and life to exist.' },
      { word: 'Extraterrestrial', definition: 'Coming from outside Earth — something that exists or originates beyond our planet.' },
    ],
    questions: [
      { n: 7, q: 'If scientists found evidence of past life on Mars, how would that change the way you think about the universe?' },
      { n: 8, q: 'Would you be excited or frightened if the SETI programme detected a message from another civilisation?' },
      { n: 9, q: 'Do you think we should be sending radio signals into space to try to contact alien civilisations? Could it be dangerous?' },
    ]
  },
  {
    number: 4, title: 'What Would Alien Life Actually Be Like?', emoji: '👽', color: '#22c55e',
    text: `Most people imagine aliens the way they appear in movies — with large heads, big eyes, and humanoid bodies. But scientists think this is very unlikely. Life on Earth took billions of years to develop, and it was shaped by very specific conditions on our planet. Life on another world would develop under completely different conditions, with different gravity, different chemicals, different temperature, and different light from a different star. It might look nothing like anything we have ever seen — or it might be so different from us that we would not even recognise it as life.\n\nMany scientists now believe that if we find life beyond Earth, it will most likely be microbial — extremely tiny, single-celled organisms similar to bacteria. This would still be one of the greatest discoveries in human history. But the possibility of intelligent life — beings that can think, communicate, and build technology — raises much bigger questions. How would we communicate with them? What would we say? And perhaps most importantly: would contact with another intelligent species be a wonderful moment of connection, or would it be dangerous? Some scientists, including the late Stephen Hawking, warned that it might be unwise to try to make contact — pointing out that when technologically advanced civilisations meet less advanced ones on Earth, it has rarely ended well for the less advanced group.`,
    vocab: [
      { word: 'Humanoid', definition: 'Having a shape or appearance similar to a human being.' },
      { word: 'Microbial', definition: 'Relating to microbes — extremely tiny living things that can only be seen with a microscope.' },
      { word: 'Organisms', definition: 'Living things — any form of life, from bacteria to plants to animals.' },
      { word: 'Species', definition: 'A group of living things that share the same characteristics and can reproduce together.' },
    ],
    questions: [
      { n: 10, q: 'Do you think alien life is more likely to be microbial (bacteria-like) or intelligent? Which discovery would be more exciting?' },
      { n: 11, q: 'Do you agree with Stephen Hawking that it might be dangerous to try to contact alien civilisations? Why or why not?' },
      { n: 12, q: 'If we made confirmed contact with an alien civilisation tomorrow, how do you think the world would react?' },
    ]
  },
]
...
function ConversationBox({ question, color, translationLang, speed }: { question: string; color: string; translationLang: string; speed: number }) {
  ...
  const SYSTEM = `You are a friendly English conversation partner helping a B1 level student practise English discussion skills. The reading topic is "Do Aliens Really Exist?". The current discussion question is: "${question}". Keep every response to 2-3 sentences maximum. Use clear, simple language suitable for B1 level. Always end with one natural follow-up question to keep the conversation going. If the student makes a significant grammar error, gently correct it at the very end using "💡 Quick tip: ..." — only the most important error. Be encouraging and warm.`
...
export default function DoAliensExistPage() {
  ...
  return (
    <main style={{ background: '#f4f6fa', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0a0a1a 0%, #1e1b4b 50%, #312e81 100%)', padding: '56px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '12px' }}>
                ...
                <span style={{ background: 'rgba(99,102,241,0.5)', color: 'white', fontSize: '12px', fontWeight: 'bold', padding: '4px 12px', borderRadius: '20px' }}>Science & Mystery</span>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Do Aliens Really Exist?</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>From Ancient Mysteries to Modern Science — explore the history of UFO sightings, what scientists are searching for, and what alien life might actually look like.</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              {SPEEDS.map(s => (
                <button key={s.value} onClick={() => setSpeed(s.value)}
                  style={{ padding: '4px 12px', borderRadius: '20px', border: '2px solid', borderColor: speed === s.value ? '#6366f1' : '#e5e7eb', background: speed === s.value ? '#6366f1' : 'white', color: speed === s.value ? 'white' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>
                  {s.label}
                </button>
              ))}
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <select value={translationLang} onChange={e => { setTranslationLang(e.target.value); setVocabTranslations({}); setQuestionTranslations({}) }}
                style={{ padding: '5px 12px', borderRadius: '20px', border: '2px solid', borderColor: translationLang !== 'none' ? '#6366f1' : '#e5e7eb', background: translationLang !== 'none' ? '#eef2ff' : 'white', color: translationLang !== 'none' ? '#4338ca' : '#555', fontWeight: '700', fontSize: '12px', cursor: 'pointer', outline: 'none' }}>
        ...
        {PARTS.map(part => (
          <div key={part.number} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ background: '#eef2ff', padding: '8px 28px', borderBottom: '1px solid #c7d2fe' }}>
              <span style={{ color: '#4338ca', fontSize: '12px', fontWeight: '600' }}>
                ✍️ Highlight any word or phrase to hear it and see its meaning
                {translationLang !== 'none' && <span style={{ color: '#6366f1' }}> + {currentLang?.label} translation</span>}
              </span>
            </div>
                    ...
                    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {questionTranslations[q.n] && (
                          <div style={{ marginTop: '8px', background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '10px', padding: '10px 14px' }}>
                            <span style={{ color: '#a5b4fc', fontSize: '10px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '3px' }}>{currentLang?.label}</span>
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto', background: 'white', borderRadius: '20px 20px 0 0', padding: '20px 24px 32px', boxShadow: '0 -8px 32px rgba(0,0,0,0.2)', border: '2px solid #c7d2fe', borderBottom: 'none' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button onClick={() => speakWord(selectedText)} style={{ background: '#eef2ff', color: '#4338ca', border: '2px solid #c7d2fe', padding: '6px 14px', borderRadius: '10px', fontWeight: '700', fontSize: '13px', cursor: 'pointer', flexShrink: 0 }}>🔊 Hear it</button>
              </div>
            ...
            {lookupLoading ? (
              <div style={{ background: '#eef2ff', borderRadius: '12px', padding: '14px 18px', border: '1px solid #c7d2fe', color: '#9ca3af', fontSize: '15px' }}>
