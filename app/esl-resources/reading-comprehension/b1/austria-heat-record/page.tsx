...
const PARTS = [
  {
    number: 1, title: 'The Hottest Days in History', emoji: '🌡️', color: '#dc2626',
    text: `On 5 and 6 August 2026, Austria broke its national heat record twice in two consecutive days. On Tuesday, the temperature in the eastern town of Hohenau reached 40.6 degrees Celsius — breaking the previous record of 40.5 set in 2013. On Wednesday, that new record was broken again when temperatures reached 41.1 degrees. Two records in two days.\n\nAustria is not a country people normally associate with extreme heat. It is a mountainous Alpine nation known for skiing, snow-covered peaks, and cool mountain air. When people think of Austria, they think of Mozart, Sound of Music, and hot chocolate by a fireplace — not dangerous heatwaves that keep people trapped indoors.\n\nBut Austria is not alone. Across Europe, summer 2026 has been punishingly hot. Wildfires have burned in Greece, where a new satellite detection system was tested this week to spot fires faster. Spain and Portugal have seen temperatures above 45 degrees. Italy issued health warnings for elderly residents. Even Scandinavia — which most people think of as cold — experienced unusual warmth.\n\nThe heatwave is not just uncomfortable — it is deadly. In the summer of 2023, more than 60,000 people died from heat-related causes across Europe. Most of them were elderly people whose bodies could not cope with sustained high temperatures. Heat kills more people in Europe than any other weather-related event — more than floods, storms, or cold. And the evidence shows clearly that heatwaves are becoming more frequent, more intense, and more dangerous.`,
    vocab: [
      { word: 'Consecutive', definition: 'Following each other in order without any gap — one after the other.' },
      { word: 'Alpine', definition: 'Relating to the Alps — the mountain range that runs through Austria, Switzerland, and other European countries.' },
      { word: 'Punishingly', definition: 'In a way that is extremely harsh and difficult to bear — causing suffering.' },
      { word: 'Sustained', definition: 'Continuing for a long time without stopping — maintained over a period.' },
    ],
    questions: [
      { n: 1, q: 'Austria broke its heat record twice in two days. Does this surprise you for a country known for skiing and mountains?' },
      { n: 2, q: '60,000 people died from heat in Europe in 2023. Why do you think heat is so deadly, and why is it not talked about more?' },
      { n: 3, q: 'How hot does it get where you live? How do you cope with extreme heat?' },
    ]
  },
  {
    number: 2, title: 'Why Heatwaves Are Getting Worse', emoji: '📈', color: '#b91c1c',
    text: `The science behind worsening heatwaves is straightforward. As greenhouse gases trap more heat in the atmosphere, the average global temperature rises. This does not just mean slightly warmer winters and summers — it means the extreme temperatures at the top of the scale are pushed higher too.\n\nThink of it like moving a bell curve. If the average temperature shifts up by just one or two degrees, the number of days that reach extreme temperatures increases dramatically. A temperature that used to be a one-in-fifty-year event becomes a one-in-ten-year event, then a one-in-five-year event. The records that Austria broke this week would have been virtually impossible in the climate of 100 years ago.\n\nCities are particularly vulnerable to heatwaves because of a phenomenon called the "urban heat island effect." Concrete, asphalt, and buildings absorb heat during the day and release it slowly at night, keeping cities several degrees warmer than the surrounding countryside. This means that even when the official temperature drops at night, cities do not cool down enough for people's bodies to recover. It is the lack of nighttime cooling, rather than the daytime peak temperature, that makes heatwaves deadly.\n\nAir conditioning can save lives during heatwaves, but it creates its own problems. Air conditioners use enormous amounts of electricity, which in many countries is still generated by burning fossil fuels — making climate change worse. They also pump heat from inside buildings to outside, making the urban heat island effect even stronger. The more air conditioning we use, the hotter our cities become for people who cannot afford it.`,
    vocab: [
      { word: 'Greenhouse gases', definition: 'Gases like carbon dioxide that trap heat in the atmosphere and cause global warming.' },
      { word: 'Bell curve', definition: 'A graph shaped like a bell that shows how common different values are — most results cluster in the middle.' },
      { word: 'Urban heat island', definition: 'The effect where cities are hotter than surrounding areas because concrete and buildings absorb and hold heat.' },
      { word: 'Fossil fuels', definition: 'Energy sources like coal, oil, and gas formed from ancient plants and animals.' },
    ],
    questions: [
      { n: 4, q: 'A small rise in average temperature makes extreme heat much more common. Why is this hard for people to understand?' },
      { n: 5, q: 'Cities are hotter than the countryside because of concrete and buildings. What could cities do to cool down?' },
      { n: 6, q: 'Air conditioning saves lives but makes climate change worse. How do we solve this problem?' },
    ]
  },
  {
    number: 3, title: 'Who Suffers Most?', emoji: '👵', color: '#991b1b',
    text: `Heatwaves do not affect everyone equally. Like most natural disasters, extreme heat hits the most vulnerable people hardest — and the gap between those who can protect themselves and those who cannot is growing.\n\nElderly people are the most at risk. As people age, their bodies become less efficient at regulating temperature. They sweat less, their circulation is weaker, and they are more likely to have medical conditions that make heat dangerous. Many elderly people live alone and may not realise they are becoming dangerously overheated until it is too late. In the 2003 European heatwave, which killed more than 70,000 people, the majority of victims were elderly people living alone.\n\nPoverty is another major factor. People who can afford air conditioning, who live in well-insulated homes, and who can take time off work during extreme heat are relatively safe. People who cannot afford cooling, who live in poorly built housing, or who work outdoors — construction workers, farmers, delivery drivers — face the full force of the heat with little protection.\n\nGeography matters too. Countries closer to the equator, which are already hot, will be pushed into temperatures that make outdoor life dangerous for significant parts of the year. Parts of South Asia, the Middle East, and sub-Saharan Africa could see regular "wet-bulb" temperatures — a measure that combines heat and humidity — above the level at which the human body can cool itself through sweating. Above this threshold, even a healthy young person sitting in the shade will die within hours without access to cooling.\n\nIn Thailand, where temperatures regularly exceed 35 degrees during the hot season, these concerns are not abstract — they are immediate and personal.`,
    vocab: [
      { word: 'Vulnerable', definition: 'Easily harmed or at risk — in a weak position where damage or suffering is more likely.' },
      { word: 'Regulating', definition: 'Controlling or maintaining something at the right level — keeping temperature stable.' },
      { word: 'Insulated', definition: 'Protected from heat or cold by a barrier — a well-insulated home stays cool in summer.' },
      { word: 'Threshold', definition: 'The point at which something changes or becomes dangerous — a limit or boundary.' },
    ],
    questions: [
      { n: 7, q: 'Elderly people living alone are most at risk during heatwaves. What can communities do to protect them?' },
      { n: 8, q: 'Outdoor workers face extreme heat with little protection. Should there be laws requiring employers to protect workers from heat? What would that look like?' },
      { n: 9, q: 'Parts of the world may become too hot for humans to survive outdoors. What would happen to the people who live in those areas?' },
    ]
  },
  {
    number: 4, title: 'Learning to Live with Heat', emoji: '🏗️', color: '#7f1d1d',
    text: `As heatwaves become more frequent and more dangerous, cities and countries around the world are developing new ways to cope with extreme heat.\n\nUrban design is one of the most effective tools. Planting trees provides shade and cools the air through evaporation — a single large tree can have the cooling effect of ten air conditioning units. "Cool roofs" and "cool pavements" — surfaces painted white or made from reflective materials — can reduce surface temperatures by up to 30 degrees compared to traditional dark surfaces. Green walls — plants growing on the sides of buildings — insulate against heat and improve air quality.\n\nSome cities are redesigning their public spaces with heat in mind. In Seville, Spain — one of the hottest cities in Europe — a network of shaded walkways, public fountains, and cool rooms in public buildings provides relief for residents during the worst heat. The city has even started naming heatwaves, like hurricanes, to raise public awareness and encourage people to take them seriously.\n\nEarly warning systems save lives. When meteorologists predict a dangerous heatwave, governments can issue alerts, open emergency cooling centres, check on vulnerable people, and advise employers to adjust working hours. Simple actions — drinking water, staying in shade, avoiding exercise during the hottest hours — can prevent many heat-related deaths.\n\nBut adaptation has limits. If greenhouse gas emissions continue to rise, heatwaves will become so severe that no amount of urban design or early warning can fully protect people. The ultimate solution to deadly heat is the same as the solution to wildfires, floods, and every other climate-related disaster: reducing the emissions that are making the planet warmer. Everything else is a temporary fix.`,
    vocab: [
      { word: 'Evaporation', definition: 'The process of water turning from liquid to gas — trees cool the air by releasing water vapour.' },
      { word: 'Reflective', definition: 'A surface that bounces light and heat away rather than absorbing it.' },
      { word: 'Meteorologists', definition: 'Scientists who study and predict weather — weather forecasters.' },
      { word: 'Adaptation', definition: 'Changing the way you live to deal with new conditions — adjusting to a different environment.' },
    ],
    questions: [
      { n: 10, q: 'A single tree has the cooling effect of ten air conditioners. Should cities plant millions more trees? What are the challenges?' },
      { n: 11, q: 'Seville names its heatwaves like hurricanes. Is this a good idea? Would naming heatwaves make people take them more seriously?' },
      { n: 12, q: 'The passage says adaptation has limits and the real solution is reducing emissions. Do you agree? Can we do both at the same time?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Austria Breaks Heat Record Twice in Two Days</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Austria broke its national heat record on Tuesday — then broke it again on Wednesday. Why heatwaves are getting worse, who suffers most, and how cities are fighting back.</p>
            </div>
          </div>
