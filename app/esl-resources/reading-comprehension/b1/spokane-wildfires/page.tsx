...
const PARTS = [
  {
    number: 1, title: 'A City on Fire', emoji: '🔥', color: '#dc2626',
    text: `On 1 August 2026, residents of Spokane, Washington — a city of more than 230,000 people in the northwestern United States — woke to the smell of smoke and a terrifying message on their phones: "Leave NOW. This may be your only notice." At least three separate wildfires had broken out in and around the city, driven by extreme heat, dry conditions, and strong winds. Thousands of people were forced to evacuate their homes with almost no warning.\n\nWildfires are not unusual in the western United States during summer. But fires burning inside a major city — forcing evacuations from residential neighbourhoods, destroying homes, and closing roads — represent a dangerous escalation of a problem that has been growing worse for decades. The Spokane fires are the latest in a series of devastating wildfire seasons that have affected communities across the American West, Canada, southern Europe, and Australia.\n\nThe images from Spokane were dramatic: orange skies, burned vehicles, families loading belongings into cars as flames approached. Emergency services worked around the clock to contain the fires and protect lives. Air quality in the city dropped to hazardous levels, and residents who could not evacuate were told to stay indoors with windows and doors sealed.\n\nFor many people watching from around the world, the Spokane fires raised a familiar and uncomfortable question: is this the new normal? Are wildfires becoming more frequent, more intense, and more dangerous — and if so, what can be done about it?`,
    vocab: [
      { word: 'Evacuate', definition: 'To leave a dangerous place quickly for safety — to move away from danger.' },
      { word: 'Escalation', definition: 'A situation becoming more serious, more intense, or more dangerous over time.' },
      { word: 'Hazardous', definition: 'Dangerous to health or safety — something that could cause harm.' },
      { word: 'Contain', definition: 'To stop something from spreading further — to keep it under control.' },
    ],
    questions: [
      { n: 1, q: 'Imagine receiving a message on your phone saying "Leave NOW." How would you react? What would you take with you?' },
      { n: 2, q: 'Wildfires inside a city are described as a dangerous escalation. Why are urban fires different from fires in forests or countryside?' },
      { n: 3, q: 'The passage asks whether this is "the new normal." What do you think? Are extreme weather events becoming more common where you live?' },
    ]
  },
  {
    number: 2, title: 'Why Wildfires Are Getting Worse', emoji: '🌡️', color: '#b91c1c',
    text: `Scientists have been warning for years that climate change would make wildfires more frequent and more severe. The evidence now shows they were right. Global temperatures have risen significantly over the past century, and warmer temperatures create the perfect conditions for fire: drier vegetation, lower humidity, and longer fire seasons.\n\nIn the western United States, the fire season has extended by nearly three months compared to the 1970s. Snowpack — the snow that covers mountains during winter and melts slowly during spring and summer, keeping soil and vegetation moist — is melting earlier and faster than before. By the time summer arrives, the landscape is drier than it used to be, and dry vegetation burns more easily and more intensely.\n\nBut climate change is only part of the story. The way humans have managed forests and built communities has also contributed to the problem. For much of the 20th century, fire departments in the United States followed a policy of suppressing all wildfires as quickly as possible. This seemed logical at the time, but it had an unintended consequence: dead wood and dry brush accumulated on the forest floor for decades, creating enormous quantities of fuel. When a fire does start in these conditions, it burns hotter and faster than it would in a naturally maintained forest.\n\nUrban sprawl has made the problem worse. As cities have expanded into areas surrounded by forests and grasslands — known as the wildland-urban interface — more people and more homes are exposed to fire risk. In the United States, an estimated 44 million homes are now in the wildland-urban interface, and this number is growing every year.`,
    vocab: [
      { word: 'Vegetation', definition: 'Plants, trees, and other green growth covering an area of land.' },
      { word: 'Snowpack', definition: 'The layer of snow that builds up on mountains during winter and melts slowly in warmer months.' },
      { word: 'Suppressing', definition: 'Stopping or preventing something from happening — putting out fires before they spread.' },
      { word: 'Urban sprawl', definition: 'The spreading of a city outwards into surrounding countryside and natural areas.' },
    ],
    questions: [
      { n: 4, q: 'The fire season in the western US is now three months longer than in the 1970s. What does this tell us about how the climate is changing?' },
      { n: 5, q: 'Putting out all fires for decades actually made the problem worse. Why? What lesson does this teach about interfering with nature?' },
      { n: 6, q: '44 million US homes are in areas at risk of wildfire. Should people be allowed to build homes in these areas? Who is responsible when they burn?' },
    ]
  },
  {
    number: 3, title: 'The Human Impact', emoji: '🏠', color: '#991b1b',
    text: `Behind every wildfire statistic is a human story. Losing your home to fire is one of the most devastating experiences a person can go through. Unlike a flood or a storm, where damaged belongings can sometimes be cleaned or repaired, fire destroys everything completely — photographs, documents, clothing, furniture, and irreplaceable personal items are reduced to ash in minutes.\n\nThe psychological impact of wildfire can be long-lasting. Research shows that people who have lost homes to fire frequently experience post-traumatic stress, anxiety, depression, and a persistent sense of insecurity. Children are particularly vulnerable — the experience of being evacuated from their home, watching their neighbourhood burn, and losing familiar surroundings can affect their mental health for years.\n\nThe economic costs are staggering. The 2023 wildfire that destroyed the town of Lahaina in Hawaii caused an estimated 5.5 billion dollars in damage and killed 102 people — the deadliest US wildfire in more than a century. Insurance companies are responding to increasing wildfire risk by raising premiums or withdrawing coverage entirely from high-risk areas, leaving homeowners unable to afford protection or unable to sell their homes.\n\nAir quality is another major concern. Wildfire smoke contains fine particles that can penetrate deep into the lungs and enter the bloodstream. During severe fire seasons, smoke from wildfires in the western United States has drifted thousands of kilometres, affecting air quality in cities as far away as New York and Washington, D.C. In 2023, wildfire smoke from Canada turned the sky over New York City orange — an image that shocked the world.\n\nThe health effects of wildfire smoke exposure include respiratory problems, heart disease, and increased hospital admissions. Children, elderly people, and those with existing health conditions are most at risk.`,
    vocab: [
      { word: 'Irreplaceable', definition: 'Something so special or unique that it cannot be replaced if lost or destroyed.' },
      { word: 'Post-traumatic stress', definition: 'A mental health condition caused by experiencing or witnessing a terrifying event.' },
      { word: 'Premiums', definition: 'Regular payments made to an insurance company in exchange for protection against loss or damage.' },
      { word: 'Respiratory', definition: 'Relating to breathing and the lungs.' },
    ],
    questions: [
      { n: 7, q: 'Fire destroys everything — photographs, documents, personal items. What possession would you find hardest to lose? Why?' },
      { n: 8, q: 'Insurance companies are raising prices or refusing to cover homes in fire-risk areas. Is this fair? What should happen to people who cannot get insurance?' },
      { n: 9, q: 'Wildfire smoke from Canada turned the sky over New York orange. What does this tell us about how connected environmental problems are across borders?' },
    ]
  },
  {
    number: 4, title: 'Can We Live with Fire?', emoji: '🌲', color: '#7f1d1d',
    text: `The question facing communities around the world is no longer whether wildfires will happen, but how to live with them. Scientists, firefighters, and urban planners are developing new approaches that acknowledge fire as a permanent part of the landscape rather than a temporary emergency.\n\nOne of the most promising approaches is prescribed burning — deliberately setting small, controlled fires to burn away the dead wood and brush that fuels larger, uncontrollable fires. Indigenous peoples in Australia, North America, and other regions have used this technique for thousands of years to manage landscapes and reduce fire risk. Modern fire management is increasingly adopting these traditional practices, recognising that preventing all fires leads to bigger and more dangerous fires later.\n\nBuilding codes are also being updated. In fire-prone areas, new homes can be built with fire-resistant materials — metal roofs instead of wooden shingles, tempered glass windows, and non-flammable exterior walls. Creating defensible space around homes — clearing vegetation within 30 metres of the building — dramatically reduces the chance of a home catching fire during a wildfire.\n\nEarly warning systems have improved significantly. Satellite technology can now detect fires within minutes of ignition, and AI-powered systems can predict how a fire will spread based on weather conditions, terrain, and vegetation. These tools give emergency services and residents more time to respond — though as the Spokane fires showed, even with modern technology, the speed and unpredictability of wildfires can overwhelm even the best-prepared communities.\n\nUltimately, the most important response to the wildfire crisis is addressing its root cause: climate change. As long as global temperatures continue to rise, fire seasons will continue to lengthen, and fires will continue to intensify. Technology and better planning can reduce the damage, but only reducing greenhouse gas emissions can address the underlying problem.`,
    vocab: [
      { word: 'Prescribed burning', definition: 'Deliberately setting small, controlled fires to remove dead vegetation and reduce the risk of bigger fires.' },
      { word: 'Fire-resistant', definition: 'Made of materials that do not catch fire easily or that can withstand high temperatures.' },
      { word: 'Defensible space', definition: 'An area around a building that has been cleared of vegetation to protect it from approaching fire.' },
      { word: 'Ignition', definition: 'The moment something catches fire — the start of a fire.' },
    ],
    questions: [
      { n: 10, q: 'Indigenous peoples have used prescribed burning for thousands of years. Why do you think modern societies stopped doing this? Should we start again?' },
      { n: 11, q: 'Should homes in fire-prone areas be required to use fire-resistant materials? Who should pay for this — homeowners or governments?' },
      { n: 12, q: 'The passage says the root cause of worse wildfires is climate change. Do you agree? What is the single most important thing we should do about it?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Wildfires Force Thousands to Evacuate</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>Three fires broke out in Spokane, Washington this week, forcing thousands to flee. Why are wildfires getting worse, and can we learn to live with fire?</p>
            </div>
          </div>
