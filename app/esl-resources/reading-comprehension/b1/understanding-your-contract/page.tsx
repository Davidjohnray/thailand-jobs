...
const PARTS = [
  {
    number: 1, title: 'Why Your Contract Matters', emoji: '📄', color: '#f59e0b',
    text: `When you start a new job, your employer will usually give you a contract — a written document that describes the terms and conditions of your employment. Many people sign their contract without reading it carefully, either because they are excited about the new job, because the document looks long and complicated, or because they feel it would be rude to ask questions. This is a mistake. Your contract is the single most important document in your working life, and understanding it is essential.\n\nA contract is a legal agreement between you and your employer. It sets out what you have agreed to do, what your employer has agreed to provide, and what happens if either side breaks the agreement. Once you sign it, you are legally bound by its terms — which is why you should never sign anything you do not fully understand.\n\nIn many countries, including Thailand, employers are required by law to provide certain basic protections to employees — minimum wage, maximum working hours, annual leave, and notice periods. Your contract should reflect these legal requirements, but it may also include additional terms that go beyond the legal minimum — or, in some cases, terms that are less favourable than you expected.\n\nThe key point is that a contract is not just a formality — it is a negotiation. Before you sign, you have the right to read every word, to ask questions about anything you do not understand, and to request changes to terms you are not happy with. After you sign, changing the terms becomes much more difficult. Taking the time to understand your contract before signing it is one of the most important professional skills you can develop.`,
    vocab: [
      { word: 'Terms and conditions', definition: 'The rules and requirements that both sides agree to follow in a contract.' },
      { word: 'Legally bound', definition: 'Required by law to follow the terms of an agreement you have signed.' },
      { word: 'Notice period', definition: 'The amount of time you must give your employer before you leave your job, or they must give you before ending your employment.' },
      { word: 'Formality', definition: 'Something done as a routine procedure rather than for an important reason.' },
    ],
    questions: [
      { n: 1, q: 'Have you ever signed a document without reading it carefully? Why do people do this, and what could go wrong?' },
      { n: 2, q: 'The passage says a contract is a negotiation, not a formality. Do you think most employees feel confident enough to negotiate? Why or why not?' },
      { n: 3, q: 'Why do you think understanding your contract is described as one of the most important professional skills?' },
    ]
  },
  {
    number: 2, title: 'What Your Contract Should Include', emoji: '📝', color: '#d97706',
    text: `While contracts vary between companies, industries, and countries, most employment contracts include the same core sections. Understanding what each section means will help you evaluate any contract you are offered.\n\nJob title and description: This section tells you what your role is and what you are expected to do. Pay attention to how specific the description is. A very vague job description — like "and any other duties as required" — gives the employer flexibility to ask you to do things that were not part of the original agreement. If your job description is too vague, ask for it to be made more specific.\n\nSalary and benefits: This section states how much you will be paid, how often, and what additional benefits you receive — such as health insurance, bonuses, transport allowances, or housing support. Make sure you understand whether the salary figure is before or after tax, and whether bonuses are guaranteed or dependent on performance.\n\nWorking hours and location: This tells you when and where you are expected to work. Check whether overtime is paid or unpaid, whether you are expected to work weekends or holidays, and whether the employer can change your working location without your agreement.\n\nLeave and holidays: This section specifies how many days of annual leave you receive, how sick leave works, and what happens with public holidays. In Thailand, employees are legally entitled to a minimum of six days of annual leave per year after one year of service, plus at least 13 public holidays.\n\nTermination and notice: This is often the section people forget to read — but it is one of the most important. How much notice must you give if you want to leave? How much notice must the employer give if they want to end your employment? Under what circumstances can you be dismissed immediately? Understanding these terms before you need them is far better than discovering them during a crisis.`,
    vocab: [
      { word: 'Evaluate', definition: 'To examine something carefully and judge how good, useful, or fair it is.' },
      { word: 'Allowances', definition: 'Extra money paid by an employer to cover specific costs like transport, housing, or meals.' },
      { word: 'Overtime', definition: 'Hours worked beyond your normal working hours — often paid at a higher rate.' },
      { word: 'Termination', definition: 'The ending of employment — when you leave or are asked to leave a job.' },
    ],
    questions: [
      { n: 4, q: 'The phrase "and any other duties as required" appears in many contracts. Why might this be a problem? What would you do about it?' },
      { n: 5, q: 'Many people do not read the termination section of their contract. Why is this section so important?' },
      { n: 6, q: 'In Thailand, employees get a minimum of six days annual leave. How does this compare to your country? Is it enough?' },
    ]
  },
  {
    number: 3, title: 'The Hidden Clauses', emoji: '🔍', color: '#b45309',
    text: `Some of the most important parts of a contract are the ones that people are least likely to read carefully. These clauses may seem like minor details, but they can have significant consequences for your career and your rights.\n\nProbationary period: Many contracts include a probation period — typically one to six months — during which your employment can be ended more easily than after the probation is complete. During probation, your notice period may be shorter and your protections may be reduced. Make sure you understand how long your probation lasts and what you need to do to pass it.\n\nNon-compete clause: Some contracts include a clause that prevents you from working for a competitor or starting a competing business for a certain period after you leave the company. These clauses can restrict your career options significantly. If your contract includes a non-compete clause, make sure you understand exactly what it prevents you from doing and for how long.\n\nConfidentiality clause: This clause requires you to keep company information secret — both during and after your employment. This is reasonable for genuinely sensitive business information, but some confidentiality clauses are written so broadly that they could prevent you from discussing your own salary or working conditions with other people.\n\nIntellectual property: If your job involves creating things — writing, design, software, inventions — your contract may state that everything you create during your employment belongs to the company, not to you. Some contracts go further and claim ownership of things you create in your own time if they are related to the company\'s business. This is particularly important for creative professionals and anyone who works on personal projects outside of work.\n\nIf you encounter any clause you do not understand, ask for an explanation. If the explanation does not satisfy you, consider seeking legal advice before signing. A small investment in legal advice at the start of a job can prevent enormous problems later.`,
    vocab: [
      { word: 'Probationary period', definition: 'A trial period at the start of a new job during which your employer decides whether to keep you.' },
      { word: 'Non-compete clause', definition: 'A contract term that stops you from working for a rival company for a certain time after you leave.' },
      { word: 'Confidentiality', definition: 'Keeping information secret and private — not sharing it with anyone outside the company.' },
      { word: 'Intellectual property', definition: 'Things created by the mind — writing, designs, inventions, software — that can be legally owned.' },
    ],
    questions: [
      { n: 7, q: 'Non-compete clauses can stop you working for a competitor after you leave. Is this fair to employees? When might it be justified?' },
      { n: 8, q: 'Some contracts say the company owns everything you create, even in your own time. Do you think this is reasonable? Where should the line be drawn?' },
      { n: 9, q: 'The passage says to get legal advice if you do not understand your contract. How many people do you think actually do this? Why or why not?' },
    ]
  },
  {
    number: 4, title: 'Know Your Rights', emoji: '⚖️', color: '#92400e',
    text: `Understanding your contract is important, but it is equally important to understand that a contract cannot override the law. In every country, there are legal protections for employees that apply regardless of what your contract says. If a term in your contract contradicts the law, the law takes priority.\n\nIn Thailand, the Labour Protection Act provides several key protections. Employees cannot be required to work more than eight hours per day or 48 hours per week in most industries. Overtime must be paid at 1.5 times the normal rate. Employees who have worked for one year are entitled to a minimum of six days of annual leave. Pregnant women are entitled to 98 days of maternity leave. And employers must give advance notice or pay in lieu of notice before terminating employment — the amount depends on how long the employee has worked there.\n\nThese protections exist because the relationship between employer and employee is inherently unequal. The employer has more power — they control the job, the salary, and the working conditions. Employment law exists to balance this power by setting minimum standards that all employers must meet, regardless of what individual contracts say.\n\nKnowing your legal rights gives you confidence. If an employer asks you to sign a contract with terms that fall below the legal minimum — or if your working conditions do not match what your contract promises — you have the right to raise this with your employer, with your country\'s labour department, or with a lawyer. Many employees do not exercise these rights because they do not know they have them.\n\nYour contract is the foundation of your professional relationship with your employer. Reading it carefully, understanding it fully, and knowing your legal rights are not acts of distrust — they are acts of professionalism. The best employers welcome employees who take their contracts seriously, because it shows they take their work seriously too.`,
    vocab: [
      { word: 'Override', definition: 'To be more powerful or important than something else — to replace or cancel it.' },
      { word: 'In lieu of', definition: 'Instead of — used when one thing replaces another.' },
      { word: 'Inherently', definition: 'By its very nature — something that is a basic, permanent part of how things are.' },
      { word: 'Exercise', definition: 'To use or put into practice a right or power that you have.' },
    ],
    questions: [
      { n: 10, q: 'A contract cannot override the law. Why do some employers still include illegal terms in contracts? What should you do if you find one?' },
      { n: 11, q: 'Many employees do not know their legal rights. Why is this, and what could be done to change it?' },
      { n: 12, q: 'The passage says knowing your rights is an act of professionalism, not distrust. Do you agree? Would you feel comfortable questioning your contract with a new employer?' },
    ]
  },
]
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>Understanding Your Contract</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>What the key parts of a job contract mean, the hidden clauses most people miss, and why you should never sign anything you do not fully understand.</p>
            </div>
          </div>
