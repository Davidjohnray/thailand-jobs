...
const PARTS = [
  {
    number: 1, title: 'The Longest Deployment', emoji: '🚢', color: '#dc2626',
    text: `The USS Abraham Lincoln — one of the most powerful warships in the world — is finally heading home. The nuclear-powered aircraft carrier and its crew of more than 5,000 sailors have been deployed in the Middle East for a record-breaking period since the US-Iran conflict began.\n\nAn aircraft carrier is a floating military base, 333 metres long, carrying approximately 60 aircraft. It can operate for 20 years without refuelling. Behind the statistics are human beings — 5,000 men and women sleeping in bunks stacked three high, working 12-hour shifts, spending months without seeing their families.\n\nWhen President Trump was asked whether the deployment had gone on too long, he said "No, not nearly long enough" — angering many military families separated from loved ones for months.\n\nThe ship is expected to arrive at San Diego within days. For sailors who missed birthdays, anniversaries, and first steps, the homecoming cannot come soon enough.`,
    vocab: [
      { word: 'Deployment', definition: 'Sending military forces to a specific location for a mission.' },
      { word: 'Nuclear-powered', definition: 'Using energy from nuclear reactions — allowing years of operation without refuelling.' },
      { word: 'Aircraft carrier', definition: 'A large warship that carries and launches military aircraft.' },
      { word: 'Homecoming', definition: 'The return home after a long absence.' },
    ],
    questions: [
      { n: 1, q: '5,000 people live on this ship for months. What would be the hardest part of living in such a confined space?' },
      { n: 2, q: 'Trump said the deployment had not gone on long enough. How do you think military families reacted?' },
      { n: 3, q: 'Sailors miss birthdays and family milestones. Is this sacrifice worth it?' },
    ]
  },
  {
    number: 2, title: 'Life at Sea', emoji: '⚓', color: '#b91c1c',
    text: `Life aboard a carrier is nothing like life on land. Everything is structured and shared. Privacy barely exists. Personal space is measured in centimetres.\n\nSailors work 12 hours on, 12 hours off. They maintain aircraft, monitor radar, cook 18,000 meals daily, operate weapons systems, and clean corridors. Off-duty, they sleep, exercise in cramped gyms, or video-call families when satellite allows.\n\nMental health is a growing concern. Extended deployments cause isolation, monotony, and stress. The Navy has increased mental health support, but stigma around seeking help remains strong. Many sailors suffer in silence.\n\nDespite hardships, crew members describe a deep bond with shipmates — a shared purpose and mutual dependence difficult to replicate in civilian life. The Lincoln is not just a ship — it is a community of 5,000 people who depend on each other every day.`,
    vocab: [
      { word: 'Monotony', definition: 'Lack of variety — doing the same things every day becomes boring and tiring.' },
      { word: 'Stigma', definition: 'A feeling of shame associated with something — a negative mark.' },
      { word: 'Shipmates', definition: 'Other people serving on the same ship — colleagues at sea.' },
      { word: 'Replicate', definition: 'To copy or create the same experience.' },
    ],
    questions: [
      { n: 4, q: '18,000 meals per day on a ship. What challenges would this involve?' },
      { n: 5, q: 'Many sailors struggle with mental health but fear seeking help. How can this stigma be changed?' },
      { n: 6, q: 'Why do difficult shared experiences create strong relationships?' },
    ]
  },
  {
    number: 3, title: 'Why Aircraft Carriers Matter', emoji: '✈️', color: '#991b1b',
    text: `The US has 11 nuclear carriers — more than every other country combined. This dominance is the foundation of American military power.\n\nA carrier projects power anywhere in the world within days. It carries its own air force and supplies for months. When a crisis erupts, the US response is almost always: send a carrier.\n\nBut carriers are extraordinarily expensive. One costs 13 billion dollars to build, 2-3 billion per year to operate. A carrier strike group represents more than 30 billion dollars.\n\nCritics argue carriers are becoming vulnerable to new missiles developed by China and Russia. A missile costing millions could sink a ship worth 13 billion. This asymmetry has led analysts to question whether carriers will remain useful in future conflicts.\n\nFor the 5,000 sailors heading home, these debates are abstract. Their world is the ship, their concern is their families, and their future is the pier where loved ones are already gathering.`,
    vocab: [
      { word: 'Project power', definition: 'To show military strength in a distant location.' },
      { word: 'Strike group', definition: 'A carrier plus its escort ships — a complete naval combat force.' },
      { word: 'Asymmetry', definition: 'An imbalance where one side has an advantage the other cannot match.' },
      { word: 'Abstract', definition: 'Theoretical rather than practical — not directly affecting your daily life.' },
    ],
    questions: [
      { n: 7, q: 'The US has 11 carriers and no other country has more than 3. Why this investment in naval power?' },
      { n: 8, q: 'A cheap missile could sink an expensive carrier. Does this make carriers obsolete?' },
      { n: 9, q: 'When a crisis happens, the US sends a carrier. Is this helpful or does it escalate tensions?' },
    ]
  },
  {
    number: 4, title: 'Coming Home', emoji: '🏠', color: '#7f1d1d',
    text: `Thousands of family members gather at the pier — holding signs, wearing matching t-shirts, trying to spot their loved one among thousands of sailors on deck.\n\nParents meet babies born while they were at sea. Children run to parents they have not seen in months. These moments are genuine and deeply moving — whatever your views on military policy.\n\nBut homecoming begins a difficult transition. After months of structured, high-stress life, returning to normal is disorienting. The house feels quiet. Daily decisions feel overwhelming after months when every hour was scheduled. Relationships must be rebuilt.\n\nStudies show military families experience higher rates of divorce and conflict — not because military people are different, but because repeated separations place extraordinary stress on relationships. The USS Lincoln is coming home. But for many sailors, the hardest part is not the months at sea — it is the weeks after, as they try to rebuild normal lives that service took away.`,
    vocab: [
      { word: 'Transition', definition: 'Changing from one situation to another — adjusting to new circumstances.' },
      { word: 'Disorienting', definition: 'Making you feel confused about where you are or what to do.' },
      { word: 'Vulnerability', definition: 'Being open to the possibility of being hurt — emotional risk.' },
      { word: 'Service', definition: 'Time spent serving in the military — duty to your country.' },
    ],
    questions: [
      { n: 10, q: 'Parents meet babies born while they were away. How does missing these moments affect families?' },
      { n: 11, q: 'Why is the transition home sometimes harder than the deployment itself?' },
      { n: 12, q: 'What more should governments do to support military families?' },
    ]
  },
]
...
export default function USSLincolnPage() {
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <h1 style={{ color: 'white', fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px', lineHeight: '1.3' }}>USS Lincoln Finally Comes Home</h1>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', margin: 0, lineHeight: '1.6' }}>After a record deployment, 5,000 sailors are heading home. Life at sea, why carriers matter, and why coming home is sometimes the hardest part.</p>
            </div>
          </div>
