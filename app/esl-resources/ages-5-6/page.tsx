  ...
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f8f9fa', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginTop: '20px' }}>
            ...
            <div>
              ...
              <p style={{ opacity: 0.8, fontSize: '14px', margin: 0 }}>Vocabulary, guided practice, and speaking activities. No reading required.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        {/* PRICING BANNER */}
        <div style={{ background: 'linear-gradient(135deg, #f3eeff, #fff3ed)', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px' }}>
  ...
  return (
    <Link href={`/esl-resources/${plan.slug}`} style={{ textDecoration: 'none' }}>
      <div style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', cursor: 'pointer' }}>
        <div style={{ height: '140px', background: 'linear-gradient(135deg, #f3eeff, #fff3ed)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '52px', position: 'relative' }}>
