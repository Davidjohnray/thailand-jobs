...
const LEVEL_META: Record<string, { label: string; title: string; emoji: string; gradient: string; who: string; prev?: string; next?: string }> = {
  a1: { label: 'A1', title: 'Starter',           emoji: '🌱', gradient: 'linear-gradient(135deg, #16a34a, #22c55e)', who: 'Complete beginners',    next: 'a2' },
  a2: { label: 'A2', title: 'Elementary',         emoji: '🌿', gradient: 'linear-gradient(135deg, #0891b2, #06b6d4)', who: 'Early learners',        prev: 'a1', next: 'b1' },
  b1: { label: 'B1', title: 'Pre-Intermediate',   emoji: '📗', gradient: 'linear-gradient(135deg, #2D6BE4, #4f8ef7)', who: 'Developing learners',   prev: 'a2', next: 'b2' },
  b2: { label: 'B2', title: 'Intermediate',       emoji: '📘', gradient: 'linear-gradient(135deg, #7C3AED, #9f67f5)', who: 'Confident learners',    prev: 'b1', next: 'c1' },
  c1: { label: 'C1', title: 'Upper-Intermediate', emoji: '🔥', gradient: 'linear-gradient(135deg, #d97706, #f59e0b)', who: 'Advanced learners',     prev: 'b2', next: 'c2' },
  c2: { label: 'C2', title: 'Advanced',           emoji: '🏆', gradient: 'linear-gradient(135deg, #E85D26, #f97316)', who: 'Near-native speakers',  prev: 'c1' },
}
