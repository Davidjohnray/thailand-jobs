  ...
  return (
    <main style={{ background: '#f9f9f9', minHeight: '100vh', padding: '40px 24px' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        {/* ESL ORDER SECTION */}
        {prefillMessage ? (
          <div style={{ background: 'white', borderRadius: '16px', padding: '40px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', marginBottom: '24px' }}>
            <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1a1a2e', marginBottom: '8px' }}>Your ESL Order</h1>
            <p style={{ color: '#666', fontSize: '14px', marginBottom: '24px' }}>
              Send us the message below via your member account and we will reply with bank transfer details.
            </p>

            {/* ORDER SUMMARY BOX */}
            <div style={{ background: '#f3eeff', borderRadius: '10px', padding: '16px', marginBottom: '24px', border: '1px solid #e5e7eb' }}>
              <pre style={{ margin: 0, fontFamily: 'sans-serif', fontSize: '14px', color: '#1a1a2e', whiteSpace: 'pre-wrap', lineHeight: '1.7' }}>
                {prefillMessage}
              </pre>
            </div>

            <p style={{ color: '#888', fontSize: '13px', marginBottom: '20px' }}>
              Log in or create a free account, then paste this message to us. We will confirm your order and send bank transfer details within a few hours.
            </p>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <Link href={`/account/login?redirect=/account/dashboard`}
                style={{ display: 'block', background: '#7C3AED', color: 'white', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px', textAlign: 'center' }}>
                Login & Message Us →
              </Link>
              <Link href={`/account/register`}
                style={{ display: 'block', background: 'white', color: '#1a1a2e', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px', border: '1px solid #ddd', textAlign: 'center' }}>
                Create Free Account →
              </Link>
            </div>
          </div>
          ...
          <div style={{ background: 'white', borderRadius: '16px', padding: '48px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', textAlign: 'center' }}>
            ...
            <p style={{ color: '#666', fontSize: '15px', lineHeight: '1.7', marginBottom: '32px' }}>
              To contact us, please create a free member account or log in. You can send us a message directly through your account and we will reply there.
            </p>
            ...
            <div style={{ background: '#f9f9f9', borderRadius: '12px', padding: '20px', marginBottom: '32px', textAlign: 'left' }}>
              ...
              {[
                ...
                'Ask about jobs, visa sponsorship and more',
                '100% free to join',
              ].map(item => (
