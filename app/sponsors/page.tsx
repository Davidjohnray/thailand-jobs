...
export const metadata: Metadata = {
  ...
  description: 'Trusted services for expats and teachers in Thailand.',
}
  ...
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f8f9fa', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px' }}>
        <a href="/sponsors/duke-language" style={{ textDecoration: 'none', display: 'block', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.10)', border: '2px solid #3b5bdb', display: 'flex', alignItems: 'center', gap: '32px', padding: '32px' }}>
            ...
            <div>
              <div style={{ background: '#3b5bdb', color: 'white', fontSize: '11px', fontWeight: 'bold', padding: '3px 10px', borderRadius: '20px', display: 'inline-block', marginBottom: '10px' }}>Sponsor</div>
              <h2 style={{ fontSize: '22px', fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 8px' }}>Duke Language School</h2>
              <p style={{ color: '#666', fontSize: '15px', margin: '0 0 16px', lineHeight: '1.6' }}>Learn Thai in Thailand! Professional Thai language courses designed for expats and teachers.</p>
