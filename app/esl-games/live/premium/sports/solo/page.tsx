      ...
      <div style={{ maxWidth: '680px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <span style={{ background: '#eff6ff', color: COLOR, padding: '6px 14px', borderRadius: '20px', fontSize: '14px', fontWeight: '600' }}>Q{current + 1}/{questions.length}</span>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '28px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <span style={{ color: '#888', fontSize: '14px' }}>🏅 Sports & Games — {ageGroup}</span>
          ...
          <div style={{ background: '#eff6ff', borderRadius: '12px', padding: '18px', marginBottom: '20px', borderLeft: `4px solid ${COLOR}` }}>
