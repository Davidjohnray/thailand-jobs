...
const MODES = [
  { id: 'solo', emoji: '👤', label: 'Solo Play', desc: 'Play on your own!', color: '#ef4444' },
  { id: 'tv', emoji: '📺', label: 'TV Mode', desc: 'Play on the big screen!', color: '#f59e0b' },
]

export default function FoodFruitPage() {
  ...
  if (!authed) return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef2f2 0%, #fffbeb 50%, #f0fdf4 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ background: 'white', borderRadius: '32px', padding: '48px', maxWidth: '420px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #fca5a5' }}>
        <div style={{ fontSize: '64px', marginBottom: '12px' }}>🍎</div>
        <h1 style={{ fontSize: '26px', fontWeight: '900', color: '#1e1b4b', marginBottom: '8px' }}>Food & Fruit</h1>
        ...
        <button onClick={handleLogin} disabled={logging}
          style={{ width: '100%', background: logging ? '#e5e7eb' : 'linear-gradient(135deg, #ef4444, #f59e0b)', color: 'white', padding: '14px', borderRadius: '12px', border: 'none', fontWeight: '900', fontSize: '16px', cursor: logging ? 'not-allowed' : 'pointer', boxShadow: '0 6px 20px rgba(239,68,68,0.3)' }}>
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef2f2 0%, #fffbeb 50%, #f0fdf4 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'system-ui, sans-serif', position: 'relative', overflow: 'hidden' }}>
      <style>{`
      ...
      <div style={{ background: 'white', borderRadius: '32px', padding: '48px 40px', maxWidth: '480px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #fca5a5', position: 'relative', zIndex: 1 }}>
        <div style={{ fontSize: '80px', marginBottom: '8px', animation: 'bounce 2s ease-in-out infinite' }}>🍎</div>
        <h1 style={{ fontSize: '32px', fontWeight: '900', color: '#1e1b4b', margin: '0 0 6px' }}>Food & Fruit!</h1>
        <p style={{ color: '#6b7280', fontSize: '16px', marginBottom: '32px' }}>Can you name the food or fruit? 🌟</p>
        ...
        <button onClick={() => mode && router.push(`/esl-games/live/premium/food-fruit/${mode}`)} disabled={!mode}
          style={{ width: '100%', padding: '18px', borderRadius: '16px', border: 'none', background: mode ? 'linear-gradient(135deg, #ef4444, #f59e0b)' : '#e5e7eb', color: mode ? 'white' : '#9ca3af', fontWeight: '900', fontSize: '20px', cursor: mode ? 'pointer' : 'not-allowed', boxShadow: mode ? '0 8px 24px rgba(239,68,68,0.4)' : 'none', transition: 'all 0.2s' }}>
          {mode ? '🍎 Let\'s Eat!' : 'Choose a mode first!'}
        </button>
