      ...
      <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3, #fdf2f8, #eff6ff)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '32px', padding: '48px', maxWidth: '420px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #fde68a', animation: 'popIn 0.5s ease' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
            ...
            <Link href="/esl-games/live/premium/emotions" style={{ background: '#fffbeb', color: '#78350f', padding: '14px 24px', borderRadius: '16px', textDecoration: 'none', fontWeight: '700', fontSize: '16px' }}>← Back</Link>
          </div>
        </div>
      </main>
    )
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3 0%, #fdf2f8 50%, #eff6ff 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
      <style>{`
        ...
        @keyframes emoBounce{0%,100%{transform:scale(1)}50%{transform:scale(1.15)}}
      ...
      <div style={{ width: '100%', maxWidth: '560px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
          <Link href="/esl-games/live/premium/emotions" style={{ background: 'white', padding: '8px 16px', borderRadius: '20px', textDecoration: 'none', color: '#6b7280', fontWeight: '700', fontSize: '14px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>← Exit</Link>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '10px 16px', marginBottom: '14px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          {timerRunning && <button onClick={() => setTimerRunning(false)} style={{ background: '#fffbeb', color: '#f59e0b', border: 'none', padding: '8px 12px', borderRadius: '10px', fontWeight: '800', fontSize: '13px', cursor: 'pointer' }}>⏸</button>}
        </div>
        <div style={{ background: 'white', borderRadius: '28px', padding: '28px', textAlign: 'center', marginBottom: '14px', boxShadow: '0 8px 32px rgba(0,0,0,0.1)', border: '3px solid #fde68a' }}>
          ...
          <div style={{ fontSize: '100px', marginBottom: '10px', animation: 'emoBounce 2s ease-in-out infinite' }}>{q.emoji}</div>
...
export default function EmotionsSoloPage() {
  return (
