...
import { emotionsQuestions } from '../questions'
...
function EmotionsTVInner() {
  const qs = emotionsQuestions
  ...
  if (!authed) return <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3, #fdf2f8)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Link href="/esl-games/live/premium/emotions" style={{ color: '#f59e0b', fontWeight: 'bold' }}>← Please log in first</Link></main>
  ...
  if (phase === 'setup') return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3, #fdf2f8, #eff6ff)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ background: 'white', borderRadius: '32px', padding: '48px 40px', maxWidth: '520px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #fde68a' }}>
        ...
        <p style={{ color: '#f59e0b', fontSize: '15px', marginBottom: '32px', fontWeight: '700' }}>😊 Emotions — {qs.length} questions</p>
      ...
      <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3, #fdf2f8, #eff6ff)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div style={{ background: 'white', borderRadius: '32px', padding: '48px', maxWidth: '560px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #fde68a' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', marginTop: '24px' }}>
            ...
            <Link href="/esl-games/live/premium/emotions" style={{ background: '#fffbeb', color: '#78350f', padding: '14px 24px', borderRadius: '16px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>← Back</Link>
          </div>
        </div>
      </main>
    )
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #fef9c3 0%, #fdf2f8 50%, #eff6ff 100%)', display: 'flex', flexDirection: 'column', padding: '16px', gap: '12px' }}>
      <style>{`@keyframes emoBounce{0%,100%{transform:scale(1)}50%{transform:scale(1.15)}}`}</style>
      ...
      <div style={{ background: 'white', borderRadius: '28px', padding: '24px', textAlign: 'center', boxShadow: '0 8px 32px rgba(0,0,0,0.1)', border: '3px solid #fde68a', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontSize: '120px', animation: 'emoBounce 2s ease-in-out infinite', marginBottom: '12px' }}>{q.emoji}</div>
      ...
      <div style={{ display: 'flex', gap: '10px', justifyContent: 'center' }}>
        ...
        <Link href="/esl-games/live/premium/emotions" style={{ background: 'white', color: '#f59e0b', padding: '14px 20px', borderRadius: '16px', textDecoration: 'none', fontWeight: '700', fontSize: '15px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>Exit</Link>
      </div>
    </main>
  )
}

export default function EmotionsTVPage() {
  return (
