...
function RoomsSoloInner() {
  ...
  if (finished) {
    ...
    return (
      <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0f9ff, #f5f3ff, #f0fdf4)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '32px', padding: '48px', maxWidth: '420px', width: '100%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.12)', border: '3px solid #7dd3fc', animation: 'popIn 0.5s ease' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
            <button onClick={restart} style={{ background: 'linear-gradient(135deg, #0ea5e9, #8b5cf6)', color: 'white', padding: '14px 32px', borderRadius: '16px', border: 'none', fontWeight: '900', fontSize: '18px', cursor: 'pointer' }}>🔄 Again!</button>
            <Link href="/esl-games/live/premium/rooms" style={{ background: '#f0f9ff', color: '#0c4a6e', padding: '14px 24px', borderRadius: '16px', textDecoration: 'none', fontWeight: '700', fontSize: '16px' }}>← Back</Link>
          </div>
        </div>
      </main>
    )
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0f9ff 0%, #f5f3ff 50%, #f0fdf4 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
      <style>{`
      ...
      <div style={{ width: '100%', maxWidth: '560px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
          <Link href="/esl-games/live/premium/rooms" style={{ background: 'white', padding: '8px 16px', borderRadius: '20px', textDecoration: 'none', color: '#6b7280', fontWeight: '700', fontSize: '14px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>← Exit</Link>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '10px 16px', marginBottom: '14px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ flex: 1, background: '#f0f9ff', borderRadius: '8px', height: '10px', overflow: 'hidden' }}>
            <div style={{ background: timerRunning || timeLeft < TOTAL_TIME ? timerColor : '#7dd3fc', height: '10px', borderRadius: '8px', width: `${timerPct}%`, transition: 'width 1s linear, background 0.3s' }} />
          </div>
          ...
          {timerRunning && <button onClick={() => setTimerRunning(false)} style={{ background: '#f0f9ff', color: '#0ea5e9', border: 'none', padding: '8px 12px', borderRadius: '10px', fontWeight: '800', fontSize: '13px', cursor: 'pointer' }}>⏸</button>}
        </div>
        <div style={{ background: 'white', borderRadius: '28px', padding: '28px', textAlign: 'center', marginBottom: '14px', boxShadow: '0 8px 32px rgba(0,0,0,0.1)', border: '3px solid #7dd3fc' }}>
          ...
          <div style={{ fontSize: '100px', marginBottom: '10px', animation: 'houseBounce 2.5s ease-in-out infinite' }}>{q.emoji}</div>
...
export default function RoomsSoloPage() {
  return (
