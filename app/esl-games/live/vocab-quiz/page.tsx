  ...
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f8f9fa', minHeight: '100vh' }}>
      <div style={{ background: 'linear-gradient(135deg, #1a1a2e, #2d2d4e)', padding: '52px 24px', color: 'white', textAlign: 'center' }}>
        ...
        <p style={{ opacity: 0.85, fontSize: '16px', margin: 0 }}>Choose your topic and how you want to play</p>
      </div>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <Link href={`/esl-games/live/vocab-quiz/solo?topic=${selectedTopic}`} style={{ textDecoration: 'none' }}>
          ...
          <Link href={`/esl-games/live/vocab-quiz/host?topic=${selectedTopic}`} style={{ textDecoration: 'none' }}>
            <div style={{ background: 'white', borderRadius: '16px', padding: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', display: 'flex', gap: '20px', alignItems: 'center', cursor: 'pointer', border: '2px solid transparent', transition: 'border-color 0.2s' }}
          ...
          <Link href={`/esl-games/live/vocab-quiz/tv?topic=${selectedTopic}`} style={{ textDecoration: 'none' }}>
            <div style={{ background: 'white', borderRadius: '16px', padding: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', display: 'flex', gap: '20px', alignItems: 'center', cursor: 'pointer', border: '2px solid transparent', transition: 'border-color 0.2s' }}
