...
export const mlBank: Record<string, MLQuestion[]> = {
  Animals: [
    ...
    { word: 'ELEPHANT', hint: 'A large grey animal with a trunk', missingIndexes: [2, 6], options: ['E', 'A', 'I', 'O'], difficulty: 'hard', category: 'Animals' },
    { word: 'GIRAFFE', hint: 'The tallest animal in the world', missingIndexes: [1, 5], options: ['I', 'A', 'O', 'E'], difficulty: 'hard', category: 'Animals' },
    { word: 'PENGUIN', hint: 'A bird that cannot fly', missingIndexes: [1, 4], options: ['E', 'U', 'A', 'I'], difficulty: 'hard', category: 'Animals' },
    { word: 'DOLPHIN', hint: 'A smart sea mammal', missingIndexes: [1, 5], options: ['O', 'I', 'A', 'E'], difficulty: 'hard', category: 'Animals' },
    { word: 'CHEETAH', hint: 'The fastest land animal', missingIndexes: [2, 5], options: ['E', 'A', 'I', 'O'], difficulty: 'hard', category: 'Animals' },
    { word: 'GORILLA', hint: 'A large powerful ape', missingIndexes: [1, 5], options: ['O', 'I', 'A', 'E'], difficulty: 'hard', category: 'Animals' },
    { word: 'LEOPARD', hint: 'A spotted big cat', missingIndexes: [1, 4], options: ['E', 'A', 'I', 'O'], difficulty: 'hard', category: 'Animals' },
    { word: 'HAMSTER', hint: 'A small furry pet that runs on a wheel', missingIndexes: [1, 4], options: ['A', 'E', 'I', 'O'], difficulty: 'hard', category: 'Animals' },
    { word: 'OSTRICH', hint: 'The biggest bird in the world', missingIndexes: [1, 4], options: ['S', 'R', 'T', 'N'], difficulty: 'hard', category: 'Animals' },
    { word: 'CROCODILE', hint: 'A large reptile with sharp teeth', missingIndexes: [2, 6], options: ['O', 'I', 'A', 'E'], difficulty: 'hard', category: 'Animals' },
  ],
  Food: [
    // Easy
    ...
    { word: 'CHOCOLATE', hint: 'A sweet brown treat made from cocoa', missingIndexes: [2, 7], options: ['O', 'A', 'E', 'I'], difficulty: 'hard', category: 'Food' },
    { word: 'PINEAPPLE', hint: 'A tropical fruit with spiky skin', missingIndexes: [1, 6], options: ['I', 'A', 'O', 'E'], difficulty: 'hard', category: 'Food' },
    { word: 'AVOCADO', hint: 'A green creamy fruit', missingIndexes: [1, 4], options: ['V', 'O', 'A', 'E'], difficulty: 'hard', category: 'Food' },
    { word: 'CUCUMBER', hint: 'A long green vegetable eaten in salads', missingIndexes: [2, 5], options: ['C', 'U', 'A', 'O'], difficulty: 'hard', category: 'Food' },
  ...
  School: [
    ...
    // Hard
    { word: 'LIBRARY', hint: 'A place full of books to borrow', missingIndexes: [1, 5], options: ['I', 'A', 'O', 'E'], difficulty: 'hard', category: 'School' },
    ...
    { word: 'CALCULATOR', hint: 'A device used to do maths', missingIndexes: [1, 6], options: ['A', 'U', 'O', 'E'], difficulty: 'hard', category: 'School' },
    { word: 'TIMETABLE', hint: 'A schedule showing when classes happen', missingIndexes: [2, 7], options: ['M', 'A', 'T', 'E'], difficulty: 'hard', category: 'School' },
    { word: 'PRINCIPAL', hint: 'The head teacher of a school', missingIndexes: [1, 6], options: ['R', 'I', 'A', 'O'], difficulty: 'hard', category: 'School' },
    ...
    { word: 'GRADUATION', hint: 'A ceremony where you receive your qualification', missingIndexes: [1, 6], options: ['R', 'A', 'T', 'O'], difficulty: 'hard', category: 'School' },
  ],
  Nature: [
    // Easy
    ...
    // Hard
    { word: 'VOLCANO', hint: 'A mountain that can erupt with lava', missingIndexes: [1, 5], options: ['O', 'A', 'E', 'I'], difficulty: 'hard', category: 'Nature' },
    { word: 'RAINBOW', hint: 'Coloured arc in the sky after rain', missingIndexes: [1, 5], options: ['A', 'O', 'E', 'I'], difficulty: 'hard', category: 'Nature' },
    ...
    { word: 'MOUNTAIN', hint: 'A very high piece of land', missingIndexes: [2, 6], options: ['O', 'A', 'U', 'I'], difficulty: 'hard', category: 'Nature' },
    { word: 'WATERFALL', hint: 'Water flowing over the edge of a cliff', missingIndexes: [1, 6], options: ['A', 'T', 'E', 'R'], difficulty: 'hard', category: 'Nature' },
    { word: 'THUNDERSTORM', hint: 'A storm with lightning and loud noise', missingIndexes: [2, 8], options: ['H', 'O', 'U', 'E'], difficulty: 'hard', category: 'Nature' },
    { word: 'PENINSULA', hint: 'A piece of land almost surrounded by water', missingIndexes: [2, 7], options: ['N', 'I', 'A', 'E'], difficulty: 'hard', category: 'Nature' },
    { word: 'AVALANCHE', hint: 'A mass of snow sliding down a mountain', missingIndexes: [1, 6], options: ['V', 'N', 'A', 'C'], difficulty: 'hard', category: 'Nature' },
  ...
  Sports: [
    ...
    // Hard
    { word: 'FOOTBALL', hint: 'The most popular sport in the world', missingIndexes: [2, 6], options: ['O', 'A', 'E', 'U'], difficulty: 'hard', category: 'Sports' },
    { word: 'SWIMMING', hint: 'A competitive sport done in a pool', missingIndexes: [1, 5], options: ['W', 'I', 'M', 'N'], difficulty: 'hard', category: 'Sports' },
    ...
    { word: 'BASKETBALL', hint: 'Throwing a ball through a hoop', missingIndexes: [1, 7], options: ['A', 'E', 'T', 'B'], difficulty: 'hard', category: 'Sports' },
    { word: 'BADMINTON', hint: 'Hitting a shuttlecock over a net', missingIndexes: [1, 6], options: ['A', 'N', 'D', 'I'], difficulty: 'hard', category: 'Sports' },
    { word: 'VOLLEYBALL', hint: 'Hitting a ball over a high net', missingIndexes: [1, 7], options: ['O', 'A', 'L', 'E'], difficulty: 'hard', category: 'Sports' },
    { word: 'GYMNASTICS', hint: 'Performing flips and balances', missingIndexes: [1, 6], options: ['Y', 'A', 'S', 'T'], difficulty: 'hard', category: 'Sports' },
    { word: 'TRIATHLON', hint: 'A race combining swimming cycling and running', missingIndexes: [2, 6], options: ['I', 'A', 'T', 'H'], difficulty: 'hard', category: 'Sports' },
    { word: 'ARCHERY', hint: 'Shooting arrows at a target', missingIndexes: [1, 4], options: ['R', 'E', 'C', 'H'], difficulty: 'hard', category: 'Sports' },
  ...
  Travel: [
    ...
    // Hard
    { word: 'PASSPORT', hint: 'The document you need to travel abroad', missingIndexes: [1, 5], options: ['A', 'O', 'P', 'S'], difficulty: 'hard', category: 'Travel' },
    ...
    { word: 'SOUVENIR', hint: 'A gift bought to remember a place', missingIndexes: [1, 5], options: ['O', 'E', 'U', 'N'], difficulty: 'hard', category: 'Travel' },
    { word: 'CURRENCY', hint: 'The money used in a country', missingIndexes: [1, 5], options: ['U', 'R', 'E', 'N'], difficulty: 'hard', category: 'Travel' },
    { word: 'ITINERARY', hint: 'A planned schedule for a trip', missingIndexes: [1, 6], options: ['T', 'N', 'I', 'A'], difficulty: 'hard', category: 'Travel' },
    { word: 'DEPARTURE', hint: 'Leaving a place on a journey', missingIndexes: [1, 6], options: ['E', 'A', 'P', 'T'], difficulty: 'hard', category: 'Travel' },
  ...
  Technology: [
    ...
    // Hard
    { word: 'KEYBOARD', hint: 'You type on this to use a computer', missingIndexes: [1, 5], options: ['E', 'O', 'A', 'B'], difficulty: 'hard', category: 'Technology' },
    { word: 'INTERNET', hint: 'A global network connecting computers', missingIndexes: [1, 6], options: ['N', 'T', 'E', 'R'], difficulty: 'hard', category: 'Technology' },
    { word: 'SOFTWARE', hint: 'Programs that run on a computer', missingIndexes: [1, 6], options: ['O', 'A', 'S', 'W'], difficulty: 'hard', category: 'Technology' },
    { word: 'DOWNLOAD', hint: 'To copy a file from the internet', missingIndexes: [1, 6], options: ['O', 'A', 'W', 'D'], difficulty: 'hard', category: 'Technology' },
    { word: 'PASSWORD', hint: 'A secret word used to log in', missingIndexes: [1, 6], options: ['A', 'O', 'S', 'W'], difficulty: 'hard', category: 'Technology' },
    ...
    { word: 'PROCESSOR', hint: 'The brain of a computer', missingIndexes: [1, 6], options: ['R', 'O', 'C', 'E'], difficulty: 'hard', category: 'Technology' },
    ...
    { word: 'MICROPHONE', hint: 'A device that picks up sound', missingIndexes: [1, 7], options: ['I', 'O', 'M', 'C'], difficulty: 'hard', category: 'Technology' },
    { word: 'ALGORITHM', hint: 'A set of rules a computer follows', missingIndexes: [1, 6], options: ['L', 'I', 'A', 'T'], difficulty: 'hard', category: 'Technology' },
  ],
  Countries: [
    // Easy
    ...
    // Hard
    { word: 'THAILAND', hint: 'A country in Southeast Asia famous for temples', missingIndexes: [2, 6], options: ['A', 'I', 'L', 'N'], difficulty: 'hard', category: 'Countries' },
    { word: 'AUSTRALIA', hint: 'A country and continent', missingIndexes: [1, 6], options: ['U', 'A', 'T', 'R'], difficulty: 'hard', category: 'Countries' },
    { word: 'GERMANY', hint: 'A European country famous for cars', missingIndexes: [1, 5], options: ['E', 'A', 'R', 'M'], difficulty: 'hard', category: 'Countries' },
    { word: 'COLOMBIA', hint: 'A South American country famous for coffee', missingIndexes: [1, 5], options: ['O', 'A', 'L', 'M'], difficulty: 'hard', category: 'Countries' },
    { word: 'MALAYSIA', hint: 'A Southeast Asian country', missingIndexes: [1, 5], options: ['A', 'L', 'Y', 'S'], difficulty: 'hard', category: 'Countries' },
    { word: 'PORTUGAL', hint: 'A country in southwestern Europe', missingIndexes: [1, 6], options: ['O', 'A', 'R', 'T'], difficulty: 'hard', category: 'Countries' },
    { word: 'ARGENTINA', hint: 'A South American country famous for tango', missingIndexes: [1, 6], options: ['R', 'N', 'A', 'T'], difficulty: 'hard', category: 'Countries' },
    { word: 'INDONESIA', hint: 'The worlds largest archipelago nation', missingIndexes: [1, 6], options: ['N', 'O', 'D', 'S'], difficulty: 'hard', category: 'Countries' },
    { word: 'SINGAPORE', hint: 'A tiny wealthy city state in Southeast Asia', missingIndexes: [1, 6], options: ['I', 'A', 'N', 'G'], difficulty: 'hard', category: 'Countries' },
    { word: 'VENEZUELA', hint: 'A South American country famous for Angel Falls', missingIndexes: [1, 7], options: ['E', 'A', 'N', 'Z'], difficulty: 'hard', category: 'Countries' },
  ],
}
