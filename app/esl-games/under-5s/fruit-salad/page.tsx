...
export default function FruitSaladGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Fruit Salad</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children are assigned a fruit word. When it is called they swap seats.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['apple', 'banana', 'mango', 'grape', 'orange', 'watermelon'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Chairs in a circle (one fewer than students)', 'Fruit flashcards to assign roles'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Arrange chairs in a circle — one fewer chair than students.',
              'Assign each child a fruit name by giving them a flashcard — apple, banana, mango, or orange.',
              'One child stands in the middle — they are "it".',
              'The child in the middle calls a fruit — "BANANA!"',
              'All children assigned banana must jump up and swap seats.',
              'The child in the middle races to steal a seat too.',
              'Whoever is left standing is the new caller.',
              'When the caller shouts "FRUIT SALAD!" — everyone must swap seats!',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'Keep chairs close together so children do not run too fast — safety first.',
            'Pre-teach all fruit vocabulary before playing.',
            'Use 3-4 fruits maximum for Under 5s — too many categories is confusing.',
            'This game works with ANY vocabulary category — animals, colours, numbers.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Use animals instead of fruits — "LION!" all lions swap seats.',
            'Use colours — assign children a colour flashcard.',
