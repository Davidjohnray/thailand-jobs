...
export default function MusicalStatuesGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Musical Statues</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children dance then freeze like a statue when the music stops.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['action words', 'freeze', 'dance', 'move', 'stop', 'statue', 'still'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Music player', 'Open space in the classroom'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Clear space in the classroom so children can move freely.',
              'Tell children: "When the music plays, dance! When it stops, freeze like a statue!"',
              'Play music and let children dance around freely.',
              'Stop the music suddenly — children must freeze completely still.',
              'Walk around and look at the statues. Anyone still moving sits out for one round.',
              'Before restarting the music, ask one child: "What are you?" — they say "A statue!"',
              'Play again. Last child standing wins.',
              'For younger children, skip elimination and just enjoy freezing together.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'When the music stops, call out a pose — "Freeze like a LION!" or "Freeze like a TREE!"',
            'This is a great warm-up game at the start of any lesson.',
            'Use songs from the lesson topic — animal songs, colour songs, number songs.',
            'Take photos of the funny statue poses to show parents!',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Call a vocabulary word when the music stops — children freeze AND touch that thing.',
            'Children freeze in the shape of a letter from the alphabet.',
            'Use slow and fast music — children must move slowly or quickly to match.',
