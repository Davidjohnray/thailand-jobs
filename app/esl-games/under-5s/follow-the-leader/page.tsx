...
export default function FollowTheLeaderGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Follow the Leader</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children copy the leader's actions and words around the classroom.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['action verbs', 'jump', 'hop', 'clap', 'stomp', 'spin', 'crawl', 'tiptoe'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['No materials needed', 'Optional: music for atmosphere'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Teacher is the leader. Children line up behind in a long snake.',
              'The leader walks around the room doing actions and saying them aloud — "JUMPING!"',
              'All children copy the action and repeat the word.',
              'Leader changes action every 10-15 seconds — "STOMPING!"',
              'Children copy and say "STOMPING!"',
              'After a few rounds, choose a child to be the new leader.',
              'The new leader decides the actions and calls them out.',
              'Continue swapping leaders so every child gets a turn.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'Call out each action clearly and wait for children to repeat before moving on.',
            'Use silly or unexpected actions to keep children laughing and engaged.',
            'This is perfect for teaching action verbs in a physical, memorable way.',
            'Shy children love this game because they just follow — no pressure to perform alone.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Leader walks like an animal — children guess the animal and copy.',
            'Combine two actions — "Jump AND clap!"',
            'Play to music and change the leader each time the song changes.',
