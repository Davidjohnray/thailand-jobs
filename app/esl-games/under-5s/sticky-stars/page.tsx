...
export default function StickyStarsGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Sticky Stars</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children earn a sticky star on the board every time they say a word correctly.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['any lesson vocabulary', 'numbers', 'colours', 'animals', 'food', 'shapes'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Gold or coloured star stickers', 'Whiteboard with each child\'s name'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Write each child\'s name on the whiteboard in a column.',
              'Hold up a flashcard and point to a child.',
              'If they say the word correctly they come up and stick a star next to their name.',
              'Continue around the class giving everyone a turn.',
              'Count stars together at the end — everyone who earned a star gets a round of applause.',
              'For extra challenge ask children to use the word in a sentence for a bonus star.',
              'Keep a running total across multiple lessons to build motivation.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'Children this age love stickers — this simple reward system creates huge engagement.',
            'Never remove a star — only add them. Keep the experience positive.',
            'Give every child a chance to earn at least one star per lesson.',
            'Use different coloured stars for different difficulty levels.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Team stars — put stars on a team chart instead of individual names.',
            'Mystery star — one child wins a special gold star for the best effort.',
            'Star chart — keep the chart up all week and count at the end of Friday.',
