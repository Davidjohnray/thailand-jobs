...
export default function ClapAndSayGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Clap and Say</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Clap a rhythm and say a vocabulary word on the beat. Great for phonics.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['any lesson vocabulary', 'phonics words', 'numbers', 'animals', 'colours'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['No materials needed', 'Optional: flashcards to prompt words'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              ...
              'Establish a simple clapping rhythm — clap, clap, click, click (repeat).',
              'Practise the rhythm together until everyone is in sync.',
              'Teacher starts — on the "click click" beats, say a vocabulary word: "AP-PLE"',
              'The next child must say a different vocabulary word on the next "click click".',
              'Anyone who misses the beat or repeats a word is out.',
              'Keep going around the circle — getting faster as children improve.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'Start with a slow rhythm — speed up gradually as children gain confidence.',
            'Clap to the syllables of the word to reinforce phonemic awareness.',
            'This is brilliant for phonics — use CVC words like "cat", "dog", "red".',
            'Play without elimination for very young children — just enjoy the rhythm.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Clap the number of syllables in the word instead of a fixed rhythm.',
            'Use categories — all words must be animals, or colours, or food.',
            'Add stomping or tapping knees for a more complex rhythm pattern.',
