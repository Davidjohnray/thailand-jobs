...
export default function GiantSmallGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Giant and Small</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children stand tall for big things and crouch small for little things teacher names.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['big', 'small', 'giant', 'tiny', 'tall', 'short', 'large', 'little'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['No materials needed', 'Optional: pictures of big and small things'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Teach the two actions — stand on tiptoes with arms up for BIG, crouch down small for SMALL.',
              'Practise together a few times.',
              'Teacher calls out an object — "An ELEPHANT!"',
              'Children must decide — is an elephant big or small?',
              'Children perform the correct action.',
              'Confirm together — "Yes! An elephant is BIG!"',
              'Continue with a mix of big and small things — ant, house, apple, mountain.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'This teaches size vocabulary through total physical response — very effective for this age.',
            'Use objects from the lesson vocabulary wherever possible.',
            'Add MEDIUM as a third option for more advanced groups.',
            'Children love the physical contrast between the giant stretch and tiny crouch.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Fast and slow — stand tall for fast things, crouch for slow things.',
            'Hot and cold — hug yourself for cold, fan face for hot.',
            'Happy and sad — smile big for happy things, frown for sad things.',
