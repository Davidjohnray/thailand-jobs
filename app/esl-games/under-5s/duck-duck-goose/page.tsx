      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Duck Duck Goose</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Classic game with a vocabulary twist — say words instead of duck and goose.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['any two contrasting words', 'hot/cold', 'big/small', 'cat/dog', 'red/blue'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Open floor space', 'No materials needed'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              ...
              'Choose two vocabulary words — for example "CAT" and "DOG".',
              'One child walks around the outside of the circle tapping heads gently.',
              'For each tap they say the first word — "cat... cat... cat..."',
              'When they tap a child and say the second word — "DOG!" — that child must jump up.',
              'The tapper runs around the circle trying to reach the empty space before being caught.',
              'If caught, the tapper goes again. If safe, the new child becomes the tapper.',
              'Change the vocabulary words every few rounds.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'Use vocabulary from the current lesson — animals, colours, food, shapes.',
            'Make sure the circle is large enough for safe running.',
            'Let shy children go last so they feel more confident watching first.',
            'This game works brilliantly as a warm-up or energy release activity.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Use three words — the third word means everyone must stand up and swap.',
            'Tapper must say a full sentence — "I like cats... I like cats... I like DOGS!"',
            'Play with numbers — tap and count, when you reach a target number the child jumps up.',
