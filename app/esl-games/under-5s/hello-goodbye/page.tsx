...
export default function HelloGoodbyeGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Hello Goodbye</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Children practise greetings by walking around saying hello and goodbye to each other.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['hello', 'hi', 'goodbye', 'bye bye', 'see you later', 'nice to meet you', 'how are you'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Open floor space', 'Music optional — stop music to signal goodbye'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Children walk around the room freely.',
              'When they meet another child they must say "Hello!" and wave.',
              'The other child replies "Hello!"',
              'Teacher calls "GOODBYE!" — children must say goodbye to the person they are near.',
              'Children then find a new person to say hello to.',
              'Continue switching between hello and goodbye rounds.',
              'Extend by adding "How are you?" and "I am fine thank you!"',
              'End the game with everyone saying goodbye to the teacher.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'This is perfect for the very first lesson — teaches essential social English immediately.',
            'Encourage different greetings — Hi, Hello, Hey — to build variety.',
            'Model the greeting with a child before starting so everyone understands.',
            'Use this game at the start of every lesson as a warm up routine.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Add a handshake, high five or bow for each greeting.',
            'Children must say each other\'s names — "Hello Nong!"',
            'Use different languages — hello in Thai, Japanese, French to compare.',
