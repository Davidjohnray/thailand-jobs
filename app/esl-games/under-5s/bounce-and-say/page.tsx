...
export default function BounceAndSayGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #f97316, #fb923c)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Bounce and Say</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Bounce a ball and say a word for each bounce — great for counting and vocab.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['numbers 1-10', 'counting', 'any vocabulary words', 'colours', 'animals'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['A soft bouncy ball', 'Open floor space'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              ...
              'Teacher bounces the ball and counts each bounce — "One... two... three..."',
              'Children join in counting together with each bounce.',
              'Stop at a random number — children must say what number comes next.',
              'For vocabulary drilling — say one word per bounce.',
              'Example: bounce "cat" bounce "dog" bounce "bird" bounce "fish"',
              'Pass the ball to a child — they bounce it and say a vocabulary word each time.',
              'If they cannot think of a word they pass to the next child.',
        ...
        <div style={{ background: '#fff3ed', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(249,115,22,0.2)' }}>
          ...
          {[
            'The physical action of bouncing helps children remember vocabulary through movement.',
            'Use a soft foam ball so it is safe indoors.',
            'This works brilliantly for number practice combined with any vocabulary topic.',
            'Let shy children just count the bounces without having to say a new word.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Partner bounce — children work in pairs passing the ball and taking turns saying words.',
            'Category bounce — all words must be from the same category.',
            'Stop and freeze — when teacher says freeze everyone stops and holds their position.',
