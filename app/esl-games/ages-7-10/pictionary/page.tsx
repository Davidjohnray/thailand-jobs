      ...
      <div style={{ background: 'linear-gradient(135deg, #0891b2, #06b6d4)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Pictionary</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Draw a vocabulary word on the board — no letters, no speaking. Team guesses.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['nouns', 'verbs', 'adjectives', 'lesson vocabulary', 'topic words'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Whiteboard and marker', 'Word cards for the drawer', 'Timer (60 seconds per turn)'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              ...
              'One student from a team comes to the board — they are the drawer.',
              'Teacher shows the drawer a word card — they must NOT show their team.',
              'The drawer has 60 seconds to draw the word on the board.',
              'No letters, numbers, or speaking allowed — only drawing!',
              'Their team shouts out guesses.',
              'If the team guesses correctly in time, they earn a point.',
              'If time runs out, the other team gets one guess to steal the point.',
        ...
        <div style={{ background: '#e0f7fa', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(8,145,178,0.2)' }}>
          ...
          {[
            'Use nouns and verbs — they are much easier to draw than adjectives.',
            'Let weaker students draw simpler words — adjust difficulty per child.',
            'The guessing team must shout the EXACT target word to earn the point.',
            'Even bad artists make this game fun — the worse the drawing, the more the class laughs.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Two drawers compete at the same time — one from each team draws the same word.',
            'Play in pairs at their desks using mini whiteboards or paper.',
            'Draw a scene from the lesson story rather than a single word.',
