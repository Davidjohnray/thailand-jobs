...
export default function GrammarAuctionGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #0891b2, #06b6d4)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Grammar Auction</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Teams bid on sentences they think are correct. Wrong bids lose points.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['grammar structures', 'tense usage', 'sentence correction', 'lesson grammar points'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['10-15 sentences (mix of correct and incorrect)', 'Fake money or points for each team', 'Whiteboard to display sentences'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Prepare 10-15 sentences — some grammatically correct, some with errors.',
              'Give each team 100 points to spend as their budget.',
              'Display each sentence on the board one at a time.',
              'Teams discuss quietly — is this sentence correct or incorrect?',
              'Teams bid points on sentences they believe are CORRECT.',
              'After all bids, reveal whether the sentence was correct.',
              'Teams who bid on a correct sentence keep their bid and gain the same amount.',
              'Teams who bid on an incorrect sentence lose their bid.',
        ...
        <div style={{ background: '#e0f7fa', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(8,145,178,0.2)' }}>
          ...
          {[
            'Use grammar points from the current lesson — past tense, articles, prepositions.',
            'Make some sentences obviously correct and some obviously wrong — mix difficulty.',
            'After revealing the answer, always explain WHY the sentence is correct or incorrect.',
            'This game teaches critical thinking alongside grammar — students must justify their bids.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Teams must also correct the wrong sentences to earn bonus points.',
            'Individual play — each student has their own budget.',
            'Use vocabulary instead of grammar — bid on correct definitions.',
