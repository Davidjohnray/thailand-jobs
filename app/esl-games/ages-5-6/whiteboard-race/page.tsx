...
export default function WhiteboardRaceGame() {
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f8f9fa', minHeight: '100vh' }}>
      <div style={{ background: 'linear-gradient(135deg, #7C3AED, #9f67f5)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Whiteboard Race</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Teams race to write the correct answer on mini whiteboards and hold them up first.</p>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              {['⏱ 10-15 min', '⚡ Medium energy', '👥 2-4 teams'].map((t, i) => (
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          ...
          <p style={{ color: '#444', fontSize: '15px', lineHeight: '1.7', margin: 0 }}>One mini whiteboard and marker per team, or per child if you have enough. Alternatively use A4 paper in a plastic sleeve with a dry-erase marker. A list of questions prepared in advance.</p>
        </div>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          ...
          {[
            ...
            'One writer per team comes to the front — they will write the answer for their team.',
            'Teacher asks a question or shows a picture — teams discuss quietly and the writer writes the answer.',
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          ...
          {[
            'Make all teams reveal at the same time — covering boards until you say "show me" prevents copying.',
            'Accept phonetic spelling for younger learners — the goal is vocabulary not perfect spelling.',
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          ...
          {[
            'Individual boards — every child has their own board and writes simultaneously for no team pressure.',
            'Draw it — instead of writing, children draw the vocabulary word they hear.',
            'Sentence race — teams must write a full sentence using the word, not just the word itself.',
            'Category write — teacher names a category and teams write as many words as possible in 30 seconds.',
          ].map((v, i) => (
            <div key={i} style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
              <span style={{ color: '#7C3AED', fontWeight: 'bold', flexShrink: 0 }}>→</span>
