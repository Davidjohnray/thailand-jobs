...
export default function StandUpSitDownGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #7C3AED, #9f67f5)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Stand Up Sit Down</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Stand up if the answer is yes, sit down if no. Fast and easy vocabulary check.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['true or false statements', 'yes or no questions', 'vocabulary definitions', 'grammar rules'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['No materials needed', 'Optional: question list prepared in advance'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'All children start seated.',
              'Teacher explains: "Stand up if the answer is YES. Stay sitting if the answer is NO."',
              'Teacher makes a true or false statement — "A dog can fly."',
              'Children stand or stay seated based on whether it is true or false.',
              'Teacher confirms: "No — a dog cannot fly! Stay sitting!"',
              'Anyone who stood up must sit back down.',
              'Keep going with new statements.',
              'Add a points system — award points for correct answers.',
        ...
        <div style={{ background: '#fdf4ff', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {[
            'This is the fastest vocabulary check game in this collection — use it as a warm-up.',
            'Make some statements funny or silly to keep children engaged.',
            'Use statements that directly relate to the lesson vocabulary.',
            'Speed it up — fire questions quickly for a more exciting game.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Use thumbs up and thumbs down instead of standing.',
            'Add a third option — hands on head means "I\'m not sure."',
            'Let children take turns making the true or false statements.',
