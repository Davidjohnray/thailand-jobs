      ...
      <div style={{ background: 'linear-gradient(135deg, #7C3AED, #9f67f5)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Hangman</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Guess the hidden word one letter at a time before the drawing is complete.</p>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              ...
              <span style={{ background: 'rgba(255,255,255,0.25)', padding: '6px 14px', borderRadius: '20px', fontSize: '13px', fontWeight: 'bold' }}>👥 Whole class or pairs</span>
            </div>
          </div>
        </div>
      </div>
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['spelling practice', 'any lesson vocabulary', 'topic words', 'high frequency words'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Whiteboard and marker', 'Vocabulary word list'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Teacher thinks of a vocabulary word and draws a blank line for each letter on the board.',
              'Draw a simple gallows shape beside the blanks.',
              'Children take turns guessing one letter at a time.',
              'If the letter is in the word, write it in the correct blank.',
              'If the letter is not in the word, draw one part of the body on the gallows.',
              'Parts drawn in order: head, body, left arm, right arm, left leg, right leg.',
              'Children win if they guess the word before the body is complete.',
              'Children lose if the drawing is completed before they guess the word.',
        ...
        <div style={{ background: '#fdf4ff', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {[
            'Give a category clue before starting — "This is an animal" or "This is a colour."',
            'Let children take turns being the teacher and choosing the word.',
            'Use only words from the current lesson for maximum vocabulary reinforcement.',
            'For younger children draw a simple smiley face instead of a gallows figure.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Play in teams — teams take turns guessing, first to solve wins the point.',
            'Play in pairs at their desks on paper.',
            'Use a phrase instead of a single word for more advanced students.',
