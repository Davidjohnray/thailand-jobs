...
export default function WordSnapGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #7C3AED, #9f67f5)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>Word Snap</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Flip cards one at a time — shout SNAP when two matching cards appear.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['any lesson vocabulary', 'word and picture pairs', 'matching words', 'colours', 'animals'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['Two matching sets of vocabulary cards', 'Flat desk space'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Shuffle two identical sets of vocabulary cards together into one deck.',
              'Deal cards equally between 2-4 players — keep them face down.',
              'Players take turns flipping their top card onto a central pile.',
              'Each time they flip a card, they must say the word on it aloud.',
              'When two matching cards appear on top of the pile, shout "SNAP!"',
              'The first player to shout "SNAP!" takes the whole pile.',
              'Play continues until one player has all the cards.',
              'If a player shouts "SNAP!" incorrectly, they give 3 cards to each other player.',
        ...
        <div style={{ background: '#fdf4ff', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {[
            'Insist every child says the word aloud when they flip their card — that is the learning.',
            'Use word and picture matching — snap when a word card matches a picture card.',
            'Print and laminate two sets of your lesson flashcards to make a permanent snap deck.',
            'This works brilliantly as a fast finisher activity for early finishers.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Snap when a word matches its category — snap when two animals appear.',
            'Play snap with opposites — hot and cold is a match.',
            'Whole class version — teacher flips cards on the board, first to shout wins a point.',
