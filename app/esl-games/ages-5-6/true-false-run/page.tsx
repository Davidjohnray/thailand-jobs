...
export default function TrueFalseRunGame() {
  return (
      ...
      <div style={{ background: 'linear-gradient(135deg, #7C3AED, #9f67f5)', padding: '52px 24px', color: 'white' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <h1 style={{ fontSize: '36px', fontWeight: 'bold', margin: '0 0 10px' }}>True or False Run</h1>
            <p style={{ opacity: 0.9, fontSize: '16px', margin: '0 0 16px' }}>Teacher says a sentence — children run to the TRUE or FALSE side of the room.</p>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['true', 'false', 'correct', 'wrong', 'any lesson content', 'review statements'].map(v => <div key={v} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {v}</div>)}
          </div>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            <h3 style={{ fontWeight: 'bold', color: '#1a1a2e', margin: '0 0 12px', fontSize: '15px' }}>🛠 Materials</h3>
            {['TRUE sign on one wall', 'FALSE sign on the opposite wall', 'Prepared statements'].map(m => <div key={m} style={{ color: '#555', fontSize: '13px', marginBottom: '4px' }}>• {m}</div>)}
          </div>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '20px' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: '20px' }}>
            {[
              'Put a TRUE sign on one wall and a FALSE sign on the opposite wall.',
              'Children stand in the middle of the room.',
              'Teacher says a statement — "A cat is a fish."',
              'Children run to the TRUE or FALSE wall depending on their answer.',
              'Confirm the answer — "False! A cat is NOT a fish — it is an animal!"',
              'Children who ran to the wrong wall sit out for one round.',
              'Continue with new statements.',
              'Use statements from the lesson content for maximum learning value.',
        ...
        <div style={{ background: '#fdf4ff', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {[
            'Make some statements deliberately funny to keep energy high.',
            'Always explain why the answer is true or false after each round.',
            'This is brilliant as a lesson review — covers all content in minutes.',
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Children write their own true/false statements for the class.',
            'Use three zones — TRUE, FALSE, NOT SURE — for more nuanced responses.',
