      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['any lesson vocabulary', 'nouns', 'animals', 'food', 'adjectives'].map(v => (
          ...
          <div style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
            ...
            {['A chair facing away from the board', 'Vocabulary words on the board or flashcards'].map(m => (
        ...
        <div style={{ background: '#fdf4ff', borderRadius: '12px', padding: '28px', marginBottom: '20px', border: '1px solid rgba(124,58,237,0.2)' }}>
          ...
          {[
            'Teach describing language first — "It is an animal... it is big... it eats meat..."',
            'Allow simpler clues for younger or weaker children — "It has four legs."',
            'Play in teams to keep everyone engaged and competing.',
            'Use recently taught vocabulary to reinforce the lesson.',
          ].map((tip, i) => (
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
          ...
          {[
            'Two children in hot seats at once — teams race to make their player guess first.',
            'Child in hot seat can ask YES/NO questions — class can only answer yes or no.',
            'Play in pairs — one child describes to their partner across the table.',
          ].map((v, i) => (
            <div key={i} style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
              <span style={{ color: '#7C3AED', fontWeight: 'bold', flexShrink: 0 }}>→</span>
